...
symptoms:
  - "OSPF neighbors stuck INIT/EXSTART/2-WAY, never FULL"
  - "EXSTART"
  - "all GigE/10GigE interfaces show OSPF cost 1"
  - "OSPF router ID changes and full re-flood after an interface flap"
  - "MOSPF.*Type-6 LSA"
  - "%OSPF"

...
type: reference
domain: sharepoint
slug: technical-reference-verify-that-oauth-is-configured-correctly-for-the-machine-translation-service-ap
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/verify-that-oauth-is-configured-correctly-for-the-machine-translation-service-ap
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Verify that OAuth is configured correctly for the Machine Translation Service application proxy, for SharePoint Server."
---

# Verify that OAuth is configured correctly for the Machine Translation Service application proxy (SharePoint Server) - SharePoint Server

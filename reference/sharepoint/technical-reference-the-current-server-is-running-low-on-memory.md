---
title: "The current server is running low on memory (SharePoint Server) - SharePoint Server"
type: reference
domain: sharepoint
slug: technical-reference-the-current-server-is-running-low-on-memory
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/the-current-server-is-running-low-on-memory
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: The current server is running low on memory, for SharePoint Server."
---

# The current server is running low on memory (SharePoint Server) - SharePoint Server

...
type: reference
domain: sharepoint
slug: governance-configure-the-managed-metadata-service
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/configure-the-managed-metadata-service
family: governance
documentKind: "how-to"
abstract: "Learn how to configure a Managed Metadata service application in SharePoint Server."
---

# Configure the Managed Metadata service - SharePoint Server

...
type: reference
domain: sharepoint
slug: technical-reference-application-pools-recycle-when-memory-limits-are-exceeded
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/application-pools-recycle-when-memory-limits-are-exceeded
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Application pools recycle when memory limits are exceeded, for SharePoint Server."
---

# Application pools recycle when memory limits are exceeded (SharePoint Server) - SharePoint Server

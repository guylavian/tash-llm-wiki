...
type: reference
domain: sharepoint
slug: administration-overview-of-microsoft-identity-manager-synchronization-service-in-sharepoint-ser
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/overview-of-microsoft-identity-manager-synchronization-service-in-sharepoint-ser
family: administration
documentKind: "overview"
abstract: "Learn about the MIM Synchronization service that is used in a SharePoint Server farm."
---

# Overview of Microsoft Identity Manager Synchronization Service in SharePoint Server - SharePoint Server

---
title: "Export and import customized search configuration settings in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: search-export-and-import-customized-search-configuration-settings
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/export-and-import-customized-search-configuration-settings
family: search
documentKind: "how-to"
abstract: "Learn how to export and import customized search configuration settings."
---

# Export and import customized search configuration settings in SharePoint Server - SharePoint Server
...
If you want to transfer all **Master Page Gallery** files, use the **Design Manager**. If you want to transfer a whole site, use **Save site as template**. If you want to export or import customized search settings programmatically, see Exporting and importing search configuration settings in SharePoint on MSDN.
...
Before you begin this operation, review the information in Overview of customized search configuration settings that can be exported and imported and ensure:
...
Verify that the user account that is performing this procedure has **Full control** permission level at the site collection.

In the site collection, on the **Settings** menu, select **Site settings**.

On the **Site Settings** page, in the **Site Collection Administration** section, select **Search Configuration Export**.

In the dialog box, select **Save**.
...
Verify that the user account that is performing this procedure has **Full control** permission level at the site.

On the site, on the **Settings** menu, select **Site settings**.

On the **Site Settings** page, in the **Search** section, select **Configuration Export**.
...
In the site collection, in the **Settings** menu, select **Site settings**.

On the **Site Settings** page, in the **Site Collection Administration** section, select **Search Configuration Import**.

On the **Import Search Configuration** page, either enter the name and location of the search configuration file to import, or select **Browse**, and select the file name and location of the search configuration file to import. Then, select **Import**.

On the **Search Config List** page, verify that:
...
On the **Site Settings** page, in the **Search** section, select **Configuration Import**.

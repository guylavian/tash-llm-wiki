---
title: "Replace the STS certificate for SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-replace-the-sts-certificate
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/replace-the-sts-certificate
family: administration
documentKind: "how-to"
abstract: "Learn how to replace the STS certificate with a new certificate from a public authority."
---

# Replace the STS certificate for SharePoint Server - SharePoint Server

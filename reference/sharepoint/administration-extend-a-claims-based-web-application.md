...
type: reference
domain: sharepoint
slug: administration-extend-a-claims-based-web-application
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/extend-a-claims-based-web-application
family: administration
documentKind: "how-to"
abstract: "Learn how to extend an existing claims-based SharePoint Server web application into a new zone to surface content to different types of users."
---

# Extend claims-based web applications in SharePoint - SharePoint Server

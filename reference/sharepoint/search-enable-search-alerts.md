...
type: reference
domain: sharepoint
slug: search-enable-search-alerts
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/enable-search-alerts
family: search
documentKind: "how-to"
abstract: "Learn how to enable or disable search alerts."
---

# Enable search alerts in SharePoint Server - SharePoint Server

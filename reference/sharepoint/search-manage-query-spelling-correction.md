...
type: reference
domain: sharepoint
slug: search-manage-query-spelling-correction
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/manage-query-spelling-correction
family: search
documentKind: "how-to"
abstract: "Learn how to include single words in or exclude single words from query spelling corrections to help correct spelling errors in queries."
---

# Manage query spelling correction in SharePoint Server - SharePoint Server

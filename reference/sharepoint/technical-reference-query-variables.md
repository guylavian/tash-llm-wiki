...
type: reference
domain: sharepoint
slug: technical-reference-query-variables
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/query-variables
family: technical-reference
documentKind: "reference"
abstract: "Learn about the query variables that you can use when you configure a query."
---

# Query variables in SharePoint Server - SharePoint Server

...
type: reference
domain: sharepoint
slug: technical-reference-infopath-form-library-forms-cannot-be-filled-out-in-a-web-browser
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/infopath-form-library-forms-cannot-be-filled-out-in-a-web-browser
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: InfoPath form library forms cannot be filled out in a Web browser, for SharePoint Server."
---

# InfoPath form library forms cannot be filled out in a Web browser (SharePoint Server) - SharePoint Server

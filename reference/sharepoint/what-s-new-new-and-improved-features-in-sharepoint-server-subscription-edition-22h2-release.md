---
title: "New and improved features in SharePoint Server Subscription Edition Version 22H2 - SharePoint Server"
type: reference
domain: sharepoint
slug: what-s-new-new-and-improved-features-in-sharepoint-server-subscription-edition-22h2-release
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/what-s-new/new-and-improved-features-in-sharepoint-server-subscription-edition-22h2-release
family: what-s-new
documentKind: "overview"
abstract: "Learn about the new features and updates to existing features in SharePoint Server Subscription Edition Version 22H2."
---

# New and improved features in SharePoint Server Subscription Edition Version 22H2 - SharePoint Server
...
| --- | --- | --- |
| **Feature release rings** | Standard release | For more information, see Feature release rings. |
| **AMSI integration** | Standard release | For more information, see AMSI integration. |
| **Copy and move improvement in modern document library** | Early release | For more information, see Copy and move improvement in modern document library. |
| **Bulk editing in modern lists** | Early release | For more information, see Bulk editing in modern lists. |
| **Column formatting enhancement** | Early release | For more information, see Column formatting enhancement. |
| **Button web part** | Early release | For more information, see Button web part. |
| **Choose the default site language in the modern self-service site creation pane** | Early release | For more information, see Choose the default site language in the modern self-service site creation pane. |
| **New SharePoint RESTful ListData.svc implementation** | Early release | For more information, see New SharePoint RESTful ListData.svc implementation. |
...
To learn more about this feature, see Feature release rings.
...
Antimalware Scan Interface (AMSI). AMSI is a versatile standard that allows applications and services to integrate with any AMSI-capable anti-malware product present on a computer.
...
To learn more about this feature, see Configure AMSI integration with SharePoint Server.
...
To learn more about this feature, see Move or copy files in SharePoint.
...
To learn more about this feature, see Bulk edit list item properties.
...
To learn more about this feature, see Use column formatting to customize SharePoint.
...
To learn more about this feature, see Use the Button web part.

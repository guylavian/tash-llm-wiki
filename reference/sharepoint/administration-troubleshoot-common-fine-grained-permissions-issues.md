...
type: reference
domain: sharepoint
slug: administration-troubleshoot-common-fine-grained-permissions-issues
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/troubleshoot-common-fine-grained-permissions-issues
family: administration
documentKind: "troubleshooting-general"
---

# Troubleshoot common fine-grained permissions issues for SharePoint Server - SharePoint Server

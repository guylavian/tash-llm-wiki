...
type: reference
domain: sharepoint
slug: administration-configure-exchange-task-synchronization
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-exchange-task-synchronization
family: administration
documentKind: "how-to"
abstract: "Configuring Exchange Server 2016 and SharePoint Server for task synchronization by using the SharePoint Server Task Synchronization feature."
---

# Configure Exchange task synchronization in SharePoint Server 2013 - SharePoint Server

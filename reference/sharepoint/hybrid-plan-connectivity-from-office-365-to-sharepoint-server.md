---
title: "Plan connectivity from Microsoft 365 to SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: hybrid-plan-connectivity-from-office-365-to-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/hybrid/plan-connectivity-from-office-365-to-sharepoint-server
family: hybrid
documentKind: "article"
abstract: "Plan and prepare to configure inbound connectivity from Microsoft 365 to SharePoint Server hybrid environment."
---

# Plan connectivity from Microsoft 365 to SharePoint Server - SharePoint Server
...
**Worksheet.** During the planning process, you have to collect information and files. It is important to use the SharePoint hybrid worksheet to track planning and deployment information for reference and to share with other members of your deployment team. We can't stress enough the importance of using this worksheet to organize your information before you begin the configuration process.
...
For more information about claims-based web applications, see Create claims-based web applications in SharePoint Server.

For more information about how to extend a web application, see Extend claims-based web applications in SharePoint.
...
Integrated Windows authentication using NTLM is required for web applications that are deployed in scenarios that support server-to-server authentication and app authentication. For more information, see Plan for server-to-server authentication in SharePoint Server.
...
For more information about how to create a host-named site collection, see Host-named site collection architecture and deployment in SharePoint Server.
...
|  | Record the following information on the worksheet:  
  ...
  If you are using an existing host-named site collection, record the URL of the top-level site collection in the **Host-named site collection URL** row in Table 5a. |
...
For more information on how SSL certificates are used in SharePoint hybrid environments, see SharePoint 2013 Hybrid Topology: Certificate and Authentication Model.
...
At this point, you should have completed filling out the required worksheet for inbound connectivity and be ready to start the configuration process. Your next step is to choose a configuration roadmap.

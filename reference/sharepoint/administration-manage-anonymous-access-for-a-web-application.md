...
type: reference
domain: sharepoint
slug: administration-manage-anonymous-access-for-a-web-application
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/manage-anonymous-access-for-a-web-application
family: administration
documentKind: "how-to"
abstract: "Learn how to grant or deny anonymous access to a web application in SharePoint Server."
---

# Manage anonymous access for a web application in SharePoint Server - SharePoint Server

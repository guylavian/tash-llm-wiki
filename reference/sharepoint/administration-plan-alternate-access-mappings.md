---
title: "Plan alternate access mappings for SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-plan-alternate-access-mappings
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-alternate-access-mappings
family: administration
documentKind: "how-to"
abstract: "Learn how to plan for alternate access mappings in SharePoint Server."
---

# Plan alternate access mappings for SharePoint Server - SharePoint Server
...
For additional information about how to plan for host-named site collections, see Host-named site collection architecture and deployment in SharePoint Server.
...
On the **Authentication Providers** page, select your web application, which is listed in the **Web Application** box.

Click the name of the zone whose authentication configuration you want to change.
...
On the **Edit Authentication** page, in the **Claims Authentication Types** section, select the authentication type that you want to use for this zone:
...
Change any other authentication configuration settings that you want to change, and click **Save**.

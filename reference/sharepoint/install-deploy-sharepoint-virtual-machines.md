...
type: reference
domain: sharepoint
slug: install-deploy-sharepoint-virtual-machines
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/deploy-sharepoint-virtual-machines
family: install
documentKind: "install-set-up-deploy"
abstract: "Learn about deploying and managing virtual machines for SharePoint Server."
---

# Deploying SharePoint Server on virtual machines - SharePoint Server

---
title: "Variations overview in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-variations-overview
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/variations-overview
family: administration
documentKind: "concept-article"
abstract: "Learn about variations and the benefits and scenarios for using variations to create multilingual sites in SharePoint Server or SharePoint in Microsoft 365."
---

# Variations overview in SharePoint Server - SharePoint Server
...
- If you're using modern communication sites in SharePoint, we recommend that you use the modern multilingual sites and pages feature instead of the variations feature.
...
For info about how to specify variations settings, see Create a multi-language website.
...
For info about how to create variation source pages and how to work with content on variation target pages, see Create a multi-language website.
...
For more info, see Plan the logical architecture for cross-site publishing in SharePoint Server.

---
title: "Overview of themes in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-themes-overview
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/themes-overview
family: sites
documentKind: "concept-article"
abstract: "Learn about the themes in SharePoint Server and how to use them to customize the look and feel of sites."
---

# Overview of themes in SharePoint Server - SharePoint Server
...
The SharePoint Server 2019 modern experience includes new Team and Communication sites. These modern sites contain visually compelling web parts that you can customize. For more information, see What is a SharePoint team site? and What is a SharePoint communication site?

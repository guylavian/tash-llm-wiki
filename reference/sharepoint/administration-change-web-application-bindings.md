...
type: reference
domain: sharepoint
slug: administration-change-web-application-bindings
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/change-web-application-bindings
family: administration
documentKind: "article"
abstract: "Learn how to change a web application binding for SharePoint Server."
---

# Update a web application URL and IIS bindings for SharePoint Server Subscription Edition - SharePoint Server

...
type: reference
domain: sharepoint
slug: search-configure-time-out-values-for-crawler-connections
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/configure-time-out-values-for-crawler-connections
family: search
documentKind: "how-to"
abstract: "Change how long the SharePoint Server search crawler will wait for a connection to a content repository or for a response to a connection attempt."
---

# Configure time-out values for crawler connections in SharePoint Server - SharePoint Server

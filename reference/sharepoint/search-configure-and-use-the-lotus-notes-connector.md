...
type: reference
domain: sharepoint
slug: search-configure-and-use-the-lotus-notes-connector
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/configure-and-use-the-lotus-notes-connector
family: search
documentKind: "how-to"
abstract: "Learn about the administrative roles, required software, user accounts, and processes that are required to install and operate the Lotus Notes Client and the Lotus Notes Connector to work with SharePoint Server search."
---

# Configure and use the Lotus Notes connector for SharePoint Server - SharePoint Server

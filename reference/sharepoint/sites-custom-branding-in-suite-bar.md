...
type: reference
domain: sharepoint
slug: sites-custom-branding-in-suite-bar
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/custom-branding-in-suite-bar
family: sites
documentKind: "overview"
abstract: "Learn about the Custom Branding feature, which is one of the newly introduced features in SharePoint Server Subscription Edition Version 23H2."
---

# Custom branding in Suite Navigation Bar - SharePoint Server

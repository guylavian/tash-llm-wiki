...
type: reference
domain: sharepoint
slug: administration-back-up-a-user-profile-service-application
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/back-up-a-user-profile-service-application
family: administration
documentKind: "how-to"
abstract: "Learn how to back up the User Profile Service service application in SharePoint Server."
---

# Back up User Profile service applications in SharePoint Server - SharePoint Server

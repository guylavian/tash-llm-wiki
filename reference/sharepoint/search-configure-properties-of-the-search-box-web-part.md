...
type: reference
domain: sharepoint
slug: search-configure-properties-of-the-search-box-web-part
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/configure-properties-of-the-search-box-web-part
family: search
documentKind: "how-to"
abstract: "Learn how to configure properties of the Search Box Web Part."
---

# Configure properties of the Search Box Web Part in SharePoint Server - SharePoint Server

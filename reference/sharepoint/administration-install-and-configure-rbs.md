...
type: reference
domain: sharepoint
slug: administration-install-and-configure-rbs
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/install-and-configure-rbs
family: administration
documentKind: "install-set-up-deploy"
abstract: "Learn how to use the FILESTREAM provider to enable Remote BLOB Storage (RBS) in a SharePoint Server farm."
---

# Install and configure RBS with FILESTREAM in a SharePoint Server farm - SharePoint Server

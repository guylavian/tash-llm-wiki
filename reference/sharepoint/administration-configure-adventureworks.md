...
type: reference
domain: sharepoint
slug: administration-configure-adventureworks
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-adventureworks
family: administration
documentKind: "how-to"
abstract: "Configure the AdventureWorks sample data for use with Excel, Excel Services in SharePoint Server 2013, and PerformancePoint Services business intelligence scenarios."
---

# Configure AdventureWorks for Business Intelligence solutions - SharePoint Server

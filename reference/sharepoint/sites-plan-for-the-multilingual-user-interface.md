---
title: "Plan for the multilingual user interface in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-plan-for-the-multilingual-user-interface
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/plan-for-the-multilingual-user-interface
family: sites
documentKind: "how-to"
abstract: "Learn about the multilingual user interface feature, how it works, and how to plan to use it in SharePoint Server and SharePoint in Microsoft 365."
---

# Plan for the multilingual user interface in SharePoint Server - SharePoint Server
...
For info about how to plan for multilingual sites, see Plan for multilingual sites in SharePoint Server.
...
If the User Profile service application is started on the SharePoint Server farm, the language preferences stored in the user profile are used. For info about how to add a list of languages to user profile settings in SharePoint Server, see Add, edit, or delete custom properties in SharePoint Server user profiles. For information about how to add a list of languages to user profile settings in SharePoint Admin Center, see Add and edit user profile properties.

If no language preference is defined in the user profile, the language preferences stored in the user's language settings for the site collection are used.
...
For more detailed information about the user interface elements that are not supported by the MUI feature, see Limitations of the multilingual user interface.

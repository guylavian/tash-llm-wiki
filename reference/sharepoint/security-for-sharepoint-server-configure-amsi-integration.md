---
title: "Configure AMSI integration with SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: security-for-sharepoint-server-configure-amsi-integration
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/security-for-sharepoint-server/configure-amsi-integration
family: security-for-sharepoint-server
documentKind: "integration"
abstract: "Learn to secure environments and respond to associated threats from the attacks through AMSI."
---
...
- Install the September 2023 security updates for SharePoint Server 2016/2019 or the Version 23H2 feature update for SharePoint Server Subscription Edition.

- Run the SharePoint Products Configuration Wizard.

- Follow the standard steps to disable the AMSI integration feature in your web applications.
...
- Open **SharePoint Central Administration**, and select **Application Management**.

- Under **Web Applications**, select **Manage web applications**.

- Select the web application for which you want to enable the AMSI integration, and select **Manage Features** in the toolbar.

- On the **SharePoint Server Antimalware Scanning** screen, select **Deactivate** to switch off AMSI integration, or select **Activate** to switch on AMSI integration.
...
Select **AMSI Configuration**.

On the AMSI Scan Configuration page, select the desired web application.

Next, you can choose to enable or disable the AMSI scan feature by selecting the appropriate option.
...
After enabling, select the Request Body Scan mode for scanning the request body according to your specific requirements from the following available options:
...
Specify the endpoints that should be included or excluded from the body scan as per the mode you selected and click **Add**.
...
After making the necessary changes, select **OK** to apply them effectively.
...
By default, Microsoft Defender Antivirus (MDAV), an AMSI-capable solution, is automatically enabled and installed on endpoints and devices that are running Windows 10, Windows Server 2016, and later. If you haven't installed an antivirus/anti-malware application, SharePoint Server AMSI integration works with MDAV. If you install and enable another antivirus/anti-malware application, MDAV automatically turns off. If you uninstall the other app, MDAV automatically turns back on, and the SharePoint Server integration will work with MDAV.

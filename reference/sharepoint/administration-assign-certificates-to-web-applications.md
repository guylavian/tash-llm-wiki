...
type: reference
domain: sharepoint
slug: administration-assign-certificates-to-web-applications
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/assign-certificates-to-web-applications
family: administration
documentKind: "article"
abstract: "Learn how to assign SharePoint-managed certificates.."
---

# Assign certificates to web applications - SharePoint Server

---
title: "Create and deploy a thesaurus in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: search-create-and-deploy-a-thesaurus
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/create-and-deploy-a-thesaurus
family: search
documentKind: "install-set-up-deploy"
abstract: "Learn how to create and deploy a thesaurus to expand queries with synonyms."
---

# Create and deploy a thesaurus in SharePoint Server - SharePoint Server

---
title: "Manage unused site collections in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-manage-unused-site-collections
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/manage-unused-site-collections
family: sites
documentKind: "how-to"
abstract: "How to manage unused site collections and how to delete site collections automatically in SharePoint Server."
---

# Manage unused site collections in SharePoint Server - SharePoint Server
...
To send email notifications, you must configure outgoing email settings. For more information, see Configure outgoing email for a SharePoint Server farm.
...
In Central Administration, on the **Application Management** page, in the **Site Collections** section, click **Confirm site use and deletion**.
...
In the **Select Web Application** dialog, click the web application that you want to configure.

---
title: "Understanding result sources for search in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: search-understanding-result-sources-for-search
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/understanding-result-sources-for-search
family: search
documentKind: "concept-article"
abstract: "Use a result source in SharePoint Server to specify a provider to get search results from for the classic search experience, and optionally to narrow a search to a subset of those results."
---

# Understanding result sources for search in SharePoint Server - SharePoint Server
...
You can click **New Result Source**. For more information, see Configure result sources for search in SharePoint Server.

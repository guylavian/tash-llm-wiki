...
type: reference
domain: sharepoint
slug: administration-service-deployment-planning
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/service-deployment-planning
family: administration
documentKind: "install-set-up-deploy"
abstract: "Learn about the services on the Services on Server page in the SharePoint Central Administration website and deployment guidance for these services. Many of these services are associated with service applications."
---

# Plan service deployment in SharePoint Server - SharePoint Server

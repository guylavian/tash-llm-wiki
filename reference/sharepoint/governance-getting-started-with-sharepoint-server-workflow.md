---
title: "Getting started with SharePoint Server workflow - SharePoint Server"
type: reference
domain: sharepoint
slug: governance-getting-started-with-sharepoint-server-workflow
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/getting-started-with-sharepoint-server-workflow
family: governance
documentKind: "get-started"
abstract: "Learn about the two workflow platforms available in SharePoint Server and the tools for working with them."
---

# Getting started with SharePoint Server workflow - SharePoint Server

---
title: "Customize search result types in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: search-customize-search-result-types
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/customize-search-result-types
family: search
documentKind: "how-to"
abstract: "Create and configure custom search result types in SharePoint Server so that users can readily distinguish and preview different kinds of items in a list of search results."
---

# Customize search result types in SharePoint Server - SharePoint Server

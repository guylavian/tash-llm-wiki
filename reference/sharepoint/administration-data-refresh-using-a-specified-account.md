...
type: reference
domain: sharepoint
slug: administration-data-refresh-using-a-specified-account
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/data-refresh-using-a-specified-account
family: administration
documentKind: "how-to"
abstract: "Learn to configure scheduled data refresh in Power Pivot for SharePoint by using an account that you specify."
---

# Configure scheduled data refresh for Power Pivot by using a specified account (SharePoint Server 2013) - SharePoint Server

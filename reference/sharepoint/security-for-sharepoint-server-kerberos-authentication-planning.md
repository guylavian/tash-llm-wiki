---
title: "Plan for Kerberos authentication in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: security-for-sharepoint-server-kerberos-authentication-planning
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/security-for-sharepoint-server/kerberos-authentication-planning
family: security-for-sharepoint-server
documentKind: "article"
abstract: "Learn how to plan for Kerberos authentication in SharePoint Server and claims-based authentication."
---

# Plan for Kerberos authentication in SharePoint Server - SharePoint Server

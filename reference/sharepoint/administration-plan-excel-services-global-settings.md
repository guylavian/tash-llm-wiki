...
type: reference
domain: sharepoint
slug: administration-plan-excel-services-global-settings
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-excel-services-global-settings
family: administration
documentKind: "article"
abstract: "Learn how to choose authorization (impersonation or process account) and encryption (IPsec or SSL) options for Excel Services in SharePoint Server."
---

# Plan Excel Services Global Settings in SharePoint Server 2013 - SharePoint Server

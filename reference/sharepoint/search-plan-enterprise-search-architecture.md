...
type: reference
domain: sharepoint
slug: search-plan-enterprise-search-architecture
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/plan-enterprise-search-architecture
family: search
documentKind: "how-to"
abstract: "Learn how to plan an enterprise search architecture."
---

# Plan enterprise search architecture in SharePoint Server - SharePoint Server

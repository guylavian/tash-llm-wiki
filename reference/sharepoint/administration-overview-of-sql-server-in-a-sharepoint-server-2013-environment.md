...
type: reference
domain: sharepoint
slug: administration-overview-of-sql-server-in-a-sharepoint-server-2013-environment
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/overview-of-sql-server-in-a-sharepoint-server-2013-environment
family: administration
documentKind: "concept-article"
abstract: "Learn about the SharePoint Server relationship with SQL Server 2008 R2 with Service Pack 1 (SP1), SQL Server 2012, and SQL Server 2014 and how you can interact with the databases."
---

# Overview of SQL Server in a SharePoint Server 2013 environment - SharePoint Server

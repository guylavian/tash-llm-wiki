...
type: reference
domain: sharepoint
slug: administration-set-certificate-default-settings
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/set-certificate-default-settings
family: administration
documentKind: "article"
abstract: "Learn how SharePoint supports farm-wide default settings for certificate management by creating, renewing certificates, and certificate health rule thresholds."
---

# Set certificate default settings - SharePoint Server

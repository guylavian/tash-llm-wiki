...
type: reference
domain: sharepoint
slug: search-configure-proxy-server-settings-for-search
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/configure-proxy-server-settings-for-search
family: search
documentKind: "how-to"
abstract: "Specify a proxy server to send requests to crawl content or query federated content repositories."
---

# Configure proxy server settings for Search in SharePoint Server - SharePoint Server

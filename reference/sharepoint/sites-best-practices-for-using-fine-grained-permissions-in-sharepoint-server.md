---
title: "Best practices for using fine-grained permissions in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-best-practices-for-using-fine-grained-permissions-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/best-practices-for-using-fine-grained-permissions-in-sharepoint-server
family: sites
documentKind: "best-practice"
abstract: "Learn about best practices for fine-grained permissions and how to use them within your organization when you use SharePoint Server."
---

# Best practices for using fine-grained permissions in SharePoint Server - SharePoint Server

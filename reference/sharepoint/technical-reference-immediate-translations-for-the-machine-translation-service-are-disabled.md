...
type: reference
domain: sharepoint
slug: technical-reference-immediate-translations-for-the-machine-translation-service-are-disabled
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/immediate-translations-for-the-machine-translation-service-are-disabled
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule:Immediate translations for the Machine Translation service are disabled, for SharePoint Server."
---

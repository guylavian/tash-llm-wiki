---
title: "Install SharePoint 2013 across multiple servers for a three-tier farm - SharePoint Server"
type: reference
domain: sharepoint
slug: install-multiple-servers-for-a-three-tier-farm
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/multiple-servers-for-a-three-tier-farm
family: install
documentKind: "install-set-up-deploy"
abstract: "Learn how to install SharePoint to create a server farm that includes web servers, an application server, and a database server."
---

# Install SharePoint 2013 across multiple servers for a three-tier farm - SharePoint Server
...
For additional information about DBA databases, see Database types and descriptions in SharePoint Server, Storage and SQL Server capacity planning and configuration (SharePoint Server), and Databases that support SharePoint 2013.
...
When the Setup program is finished, a dialog prompts you to complete the configuration of your server. Clear the **Run the SharePoint Products and Technologies Configuration Wizard now** check box.
...
On the server that will host Central Administration (the application server), click **Start**, point to **All Programs**, and then click **SharePoint 2013 Products**, and then click **SharePoint 2013 Products Configuration Wizard**. If the **User Account Control** dialog appears, click **Continue**.

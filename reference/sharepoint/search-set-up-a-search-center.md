---
title: "Set up a Search Center in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: search-set-up-a-search-center
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/set-up-a-search-center
family: search
documentKind: "install-set-up-deploy"
abstract: "Learn how to set up a Search Center in SharePoint Server."
---

# Set up a Search Center in SharePoint Server - SharePoint Server
...
Our content is stored in SharePoint lists and libraries. We use site columns to store metadata about each item.
...
A related series, How to change the way search results are displayed in SharePoint Server, enhances the example Search Center developed in this series. In this related series, we show you how you can change the appearance of your search results.

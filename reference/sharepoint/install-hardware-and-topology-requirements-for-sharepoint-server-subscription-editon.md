---
title: "Hardware and topology requirements for SharePoint Server Subscription Edition - SharePoint Server"
type: reference
domain: sharepoint
slug: install-hardware-and-topology-requirements-for-sharepoint-server-subscription-editon
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/hardware-and-topology-requirements-for-sharepoint-server-subscription-editon
family: install
documentKind: "interactive-tutorial"
abstract: "Find out the minimum hardware requirements that you need for installing and running SharePoint Server Subscription Edition."
---

# Hardware and topology requirements for SharePoint Server Subscription Edition - SharePoint Server
...
| SharePoint server in a multi-tier farm | Pilot, user acceptance test, or production installation running all available services. | 64-bit, 4 cores | 16 GB | 80 GB for system drive  

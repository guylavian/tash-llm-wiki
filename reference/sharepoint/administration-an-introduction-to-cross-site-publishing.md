---
title: "An introduction to cross-site publishing in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-an-introduction-to-cross-site-publishing
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/an-introduction-to-cross-site-publishing
family: administration
documentKind: "article"
abstract: "Get an introduction to cross-site publishing."
---

# An introduction to cross-site publishing in SharePoint Server - SharePoint Server
...
You crawl the content in your catalog-enabled libraries and lists. This adds the catalog content to the search index.

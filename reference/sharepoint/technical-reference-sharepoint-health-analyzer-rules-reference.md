...
type: reference
domain: sharepoint
slug: technical-reference-sharepoint-health-analyzer-rules-reference
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/sharepoint-health-analyzer-rules-reference
family: technical-reference
documentKind: "landing-page"
abstract: "Learn how to troubleshoot problems in SharePoint Server using SharePoint Health Analyzer rules."
---

# SharePoint Health Analyzer rules reference for SharePoint Server 2016 - SharePoint Server

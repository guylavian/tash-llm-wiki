---
title: "Document management in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: governance-document-management-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/document-management-in-sharepoint-server
family: governance
documentKind: "how-to"
abstract: "Learn about the elements of a document management solution and the document management planning process in SharePoint Server."
---

# Document management in SharePoint Server - SharePoint Server
...
Learn about Collaboration governance for SharePoint in Microsoft 365.
...
**Plan content types** Use content types to organize information about documents, such as metadata, document templates, and workflow processes. Implementing this method is an important step to help you organize your documents and enforce consistency across your organization.

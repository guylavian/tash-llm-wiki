---
title: "Video series Install and configure Workflow in SharePoint Server 2013 - SharePoint Server"
type: reference
domain: sharepoint
slug: governance-video-series-install-and-configure-workflow-in-sharepoint-server-2013
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/video-series-install-and-configure-workflow-in-sharepoint-server-2013
family: governance
documentKind: "install-set-up-deploy"
abstract: "Videos that demonstrate the installation and configuration of workflow in SharePoint Server."
---

# Video series Install and configure Workflow in SharePoint Server 2013 - SharePoint Server

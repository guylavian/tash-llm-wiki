---
title: "Plan authoring sites for cross-site publishing in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-plan-sharepoint-authoring-sites-for-cross-site-publishing
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-sharepoint-authoring-sites-for-cross-site-publishing
family: administration
documentKind: "article"
abstract: "Learn how to plan authoring site collections for a SharePoint Server cross-site publishing solution."
---

# Plan authoring sites for cross-site publishing in SharePoint Server - SharePoint Server
...
For information about security, see Permissions planning for sites and content in SharePoint Server.
...
For information about authoring web pages, see SharePoint page model overview, Plan content types and workflows in SharePoint 2013, Plan Web pages (SharePoint Server 2010) and Plan Web page authoring (SharePoint Server 2010).
...
For information about creating term sets for tagging content, see "Create and manage term sets for tagging content on authoring sites" in Configure cross-site publishing in SharePoint Server.
...
For information about how to enable a library or list as a catalog, see "Share a library or list as a catalog" in Configure cross-site publishing in SharePoint Server.
...
For more information, see Plan Web pages (SharePoint Server 2010), and Plan for large Pages libraries (SharePoint Server 2010).
...
| Item Number | Single line of text |
| Group Number | Single line of text |
| Language Tag | Choice |
...
For performance considerations, see Designing large lists and maximizing list performance (SharePoint Server 2010).
...
For more information about how to plan for asset libraries, see Plan digital asset libraries in SharePoint Server 2013.

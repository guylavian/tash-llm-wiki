...
type: reference
domain: sharepoint
slug: security-for-sharepoint-server-plan-server-to-server-authentication
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/security-for-sharepoint-server/plan-server-to-server-authentication
family: security-for-sharepoint-server
documentKind: "article"
abstract: "Learn how to plan for server-to-server authentication in SharePoint Server."
---

# Plan for server-to-server authentication in SharePoint Server - SharePoint Server

---
title: "Redesign enterprise search topology for more content and users in SharePoint - SharePoint Server"
type: reference
domain: sharepoint
slug: search-redesign-topology-for-more-content-and-users
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/redesign-topology-for-more-content-and-users
family: search
documentKind: "how-to"
abstract: "Learn how to redesign the topology of your enterprise search architecture for growth in content, growth in number of users, or both."
---

# Redesign enterprise search topology for more content and users in SharePoint - SharePoint Server

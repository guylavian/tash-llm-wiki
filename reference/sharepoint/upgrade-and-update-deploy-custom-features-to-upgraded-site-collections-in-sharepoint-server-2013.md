...
type: reference
domain: sharepoint
slug: upgrade-and-update-deploy-custom-features-to-upgraded-site-collections-in-sharepoint-server-2013
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/upgrade-and-update/deploy-custom-features-to-upgraded-site-collections-in-sharepoint-server-2013
family: upgrade-and-update
documentKind: "install-set-up-deploy"
abstract: "Learn supported scenarios for deploying custom features to upgraded site collections in a SharePoint Server 2013 farm that has been upgraded from SharePoint Server 2010."
---

# Deploy custom features to upgraded site collections in SharePoint Server 2013 - SharePoint Server

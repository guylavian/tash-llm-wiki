---
title: "Plan for managed metadata in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: governance-managed-metadata-planning
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/managed-metadata-planning
family: governance
documentKind: "article"
abstract: "Learn about the decisions you need to make when planning for the managed metadata service in SharePoint Server."
---

# Plan for managed metadata in SharePoint Server - SharePoint Server
...
Before you configure managed metadata, it's important to understand what managed metadata is and how it works in SharePoint. Before you read this article, be sure to read Introduction to managed metadata.
...
For the SharePoint in Microsoft 365 version of this article, see Introduction to managed metadata.

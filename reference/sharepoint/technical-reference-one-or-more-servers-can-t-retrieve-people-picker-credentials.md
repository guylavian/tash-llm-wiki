...
type: reference
domain: sharepoint
slug: technical-reference-one-or-more-servers-can-t-retrieve-people-picker-credentials
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/one-or-more-servers-can-t-retrieve-people-picker-credentials
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: One or more servers can't retrieve People Picker credentials, for SharePoint Server."
---

# One or more servers can't retrieve People Picker credentials (SharePoint Server 2019) - SharePoint Server

...
type: reference
domain: sharepoint
slug: administration-integrate-multiple-viva-engage-networks-into-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/integrate-multiple-viva-engage-networks-into-sharepoint-server
family: administration
documentKind: "integration"
abstract: "Learn how to integrate multiple active Viva Engage networks together with your SharePoint Server environment."
---

# Integrate multiple Viva Engage networks into SharePoint Server - SharePoint Server

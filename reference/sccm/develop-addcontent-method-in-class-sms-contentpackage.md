...
type: reference
domain: sccm
slug: develop-addcontent-method-in-class-sms-contentpackage
tier: reference
...
abstract: "Learn how to add content to the SMS_ContentPackage Server WMI Class content package using AddContent."
---

...
type: reference
domain: sccm
slug: core-deployment-monitoring-tool
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/support/deployment-monitoring-tool
family: core
documentKind: "install-set-up-deploy"
abstract: "Use the Deployment Monitoring Tool to troubleshoot software deployments on a Configuration Manager client."
---

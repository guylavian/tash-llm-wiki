...
type: reference
domain: sccm
slug: core-run-discovery
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/run-discovery
family: core
documentKind: "article"
abstract: "Read an overview of the discovery process and discovery data records."
---

# Discover device and user resources

...
type: reference
domain: sccm
slug: develop-how-to-create-an-application-with-the-script-deployment-type
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/apps/how-to-create-an-application-with-the-script-deployment-type
family: develop
documentKind: "how-to"
abstract: "Use the SDK to create an app with the script deployment type."
---

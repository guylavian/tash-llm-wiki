...
type: reference
domain: sccm
slug: develop-setsourcesite-method-in-class-sms-bootimagepackage
tier: reference
...
abstract: "A Windows Management Instrumentation class method that sets the code of the source site for the boot image package."
---

# SetSourceSite Method in SMS_BootImagePackage

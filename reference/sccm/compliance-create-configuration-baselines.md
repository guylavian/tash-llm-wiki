...
type: reference
domain: sccm
slug: compliance-create-configuration-baselines
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/create-configuration-baselines
family: compliance
documentKind: "how-to"
abstract: "Create configuration baselines in Configuration Manager that you can deploy to a collection."
---

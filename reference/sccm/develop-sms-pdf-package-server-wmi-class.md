...
type: reference
domain: sccm
slug: develop-sms-pdf-package-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_PDF_Package Windows Management Instrumentation class is an SMS Provider server class that represents a package definition file template from which to create an initialized package."
---

# SMS_PDF_Package Class

...
type: reference
domain: sccm
slug: develop-sms-machinesettings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_machinesettings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_MachineSettings WMI class describes attributes that are specific to a single computer that is managed by Configuration Manager."
---

# SMS_MachineSettings Class

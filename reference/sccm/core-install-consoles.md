...
type: reference
domain: sccm
slug: core-install-consoles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/install-consoles
family: core
documentKind: "how-to"
abstract: "Install the Configuration Manager console to connect to a central administration site or primary site."
---

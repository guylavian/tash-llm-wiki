...
type: reference
domain: sccm
slug: develop-sms-appdeploymentrequirementsnotmetstatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_appdeploymentrequirementsnotmetstatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_AppDeploymentRequirementsNotMetStatus WMI class is an SMS Provider server class that represents the status of application deployment where requirements are not met."
---

# SMS_AppDeploymentRequirementsNotMetStatus Class

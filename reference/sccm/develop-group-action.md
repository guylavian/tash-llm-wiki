...
type: reference
domain: sccm
slug: develop-group-action
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/group-action
family: develop
documentKind: "article"
abstract: "Learn how to use the group action in configuration manager to create a submenu for related actions."
---

...
type: reference
domain: sccm
slug: core-supported-configurations-2
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/configs/supported-configurations
family: core
documentKind: "overview"
abstract: "Identify key configurations and requirements so you can plan, deploy, and maintain a functional Configuration Manager deployment."
---

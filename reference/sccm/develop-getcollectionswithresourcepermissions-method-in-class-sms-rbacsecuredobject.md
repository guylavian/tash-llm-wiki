...
type: reference
domain: sccm
slug: develop-getcollectionswithresourcepermissions-method-in-class-sms-rbacsecuredobject
tier: reference
...
abstract: "In Configuration Manager, the GetCollectionsWithResourcePermissions WMI class method gets the list of collection identifiers for which the user has the specified permissions. The collection must contain the specified resource."
---

# GetCollectionsWithResourcePermissions Method

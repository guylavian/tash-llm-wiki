...
type: reference
domain: sccm
slug: protect-endpoint-protection-configure-client
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-protection-configure-client
family: protect
documentKind: "how-to"
abstract: "Learn how to configure custom client settings for Endpoint Protection."
---

# Endpoint Protection client settings

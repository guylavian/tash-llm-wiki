...
type: reference
domain: sccm
slug: develop-sms-ch-settings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/status/sms_ch_settings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how the SMS_CH_Settings class is an SMS Provider server class, in Configuration Manager, that represents client status settings."
---

# SMS_CH_Settings Class

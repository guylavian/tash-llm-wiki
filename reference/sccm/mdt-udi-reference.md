...
type: reference
domain: sccm
slug: mdt-udi-reference
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdt/udi-reference
family: mdt
documentKind: "reference"
abstract: "Reference details for Microsoft Deployment Toolkit (MDT) UDI Reference"
---

# Toolkit reference - Microsoft Deployment Toolkit (MDT) UDI Reference

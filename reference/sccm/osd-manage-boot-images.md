...
type: reference
domain: sccm
slug: osd-manage-boot-images
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/manage-boot-images
family: osd
documentKind: "how-to"
abstract: "In Configuration Manager, learn to manage the Windows PE boot images that you use during an OS deployment."
---

...
type: reference
domain: sccm
slug: develop-runauthliststatussummarization-method-in-class-sms-authorizationlist
tier: reference
...
abstract: "Learn how to use Configuration Manager RunAuthListStatusSummarization Windows Management Instrumentation (WMI) class method to update summarized results for a particular update group."
---

# RunAuthListStatusSummarization Method

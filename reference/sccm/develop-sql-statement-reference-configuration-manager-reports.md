...
type: reference
domain: sccm
slug: develop-sql-statement-reference-configuration-manager-reports
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/sql-statement-reference-configuration-manager-reports
family: develop
documentKind: "reference"
abstract: "Information about SQL Server statements that can be used when creating Configuration�Manager reports."
---

# SQL statement reference for reports

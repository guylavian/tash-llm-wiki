...
type: reference
domain: sccm
slug: develop-advanced-exercise-1-create-new-report-compliance-settings-configuration-manager
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Create a Configuration Manager report that displays the name and description of the configuration baselines."
---

# Advanced exercise 1: Create a new report for compliance settings

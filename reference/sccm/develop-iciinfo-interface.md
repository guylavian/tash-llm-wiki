...
type: reference
domain: sccm
slug: develop-iciinfo-interface
tier: reference
...
abstract: "ICIINFO can represent a configuration item which has been downloaded and stored by the Desired Configuration Management client or a baseline configuration item in a Desired Configuration Management Agent job in the client data store."
---

...
type: reference
domain: sccm
slug: develop-sms-driver-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_driver-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_Driver Windows Management Instrumentation class is an SMS Provider server class that represents device drivers in the driver catalog that can be installed as part of a task sequence in an operating system deployment."
---

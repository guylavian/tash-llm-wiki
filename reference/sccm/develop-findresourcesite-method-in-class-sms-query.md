...
type: reference
domain: sccm
slug: develop-findresourcesite-method-in-class-sms-query
tier: reference
...
abstract: "Article describing how to use FindResourceSite in Configuration Manager to get site code information for resources from SQL."
---

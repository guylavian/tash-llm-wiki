...
type: reference
domain: sccm
slug: core-content-library-cleanup-tool
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/hierarchy/content-library-cleanup-tool
family: core
documentKind: "how-to"
abstract: "Use the content library cleanup tool to remove orphaned content no longer associated with a Configuration Manager deployment."
---

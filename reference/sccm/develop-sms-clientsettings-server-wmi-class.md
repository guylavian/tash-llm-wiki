...
type: reference
domain: sccm
slug: develop-sms-clientsettings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_clientsettings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent the settings that apply to the clients which belong to a specified collection using SMS_ClientSettings class."
---

# SMS_ClientSettings Class

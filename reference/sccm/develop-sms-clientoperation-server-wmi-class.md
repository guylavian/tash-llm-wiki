...
type: reference
domain: sccm
slug: develop-sms-clientoperation-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/protect/sms_clientoperation-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that represents a set of client actions."
---

# SMS_ClientOperation Class

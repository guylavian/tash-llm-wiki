...
type: reference
domain: sccm
slug: apps-creating-windows-embedded-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/get-started/creating-windows-embedded-applications
family: apps
documentKind: "article"
abstract: "See which considerations you must take into account when you create and deploy applications for Windows Embedded devices."
---

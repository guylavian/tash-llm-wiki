...
type: reference
domain: sccm
slug: develop-sms-g-system-softwarefile-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_g_system_softwarefile-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_G_System_SoftwareFile class is an SMS Provider server class that contains information about all software files that were inventoried on the client computer."
---

# SMS_G_System_SoftwareFile Class

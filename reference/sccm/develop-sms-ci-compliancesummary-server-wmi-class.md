...
type: reference
domain: sccm
slug: develop-sms-ci-compliancesummary-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_ci_compliancesummary-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn about the simplified syntax, methods, properties, and requirements of the SMS_CI_ComplianceSummary server class."
---

# SMS_CI_ComplianceSummary Class

...
type: reference
domain: sccm
slug: protect-use-device-guard-with-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/use-device-guard-with-configuration-manager
family: protect
documentKind: "how-to"
abstract: "Learn how to use Configuration Manager to manage Windows Defender Application Control."
---

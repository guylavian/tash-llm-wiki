...
type: reference
domain: sccm
slug: develop-getdependent-method-in-class-sms-collection
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/collections/getdependent-method-in-class-sms_collection
family: develop
documentKind: "reference"
abstract: "Get the collection relationship info which depends on the input collection."
---

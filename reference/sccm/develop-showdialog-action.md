...
type: reference
domain: sccm
slug: develop-showdialog-action
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/showdialog-action
family: develop
documentKind: "article"
abstract: "In Configuration Manager, the ShowDialog action opens a property sheet or regular dialog box in the console. With the ShowDialog action, you can display existing dialog boxes or extension dialog boxes that you create."
---

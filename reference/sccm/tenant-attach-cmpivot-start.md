...
type: reference
domain: sccm
slug: tenant-attach-cmpivot-start
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/cmpivot-start
family: tenant-attach
documentKind: "how-to"
abstract: "Launch CMPivot for Microsoft Intune tenant attached devices."
---

# Launch tenant attached CMPivot

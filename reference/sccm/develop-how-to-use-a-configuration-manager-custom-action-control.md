...
type: reference
domain: sccm
slug: develop-how-to-use-a-configuration-manager-custom-action-control
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-use-a-configuration-manager-custom-action-control
family: develop
documentKind: "how-to"
abstract: "The custom action control is used to configure a custom action that you have defined. The custom action then becomes a step in the task sequence you are editing."
---

# Use a Custom Action Control

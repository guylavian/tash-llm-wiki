...
type: reference
domain: sccm
slug: develop-how-to-create-form-xml-for-a-configuration-manager-property-sheet
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-create-form-xml-for-a-configuration-manager-property-sheet
family: develop
documentKind: "how-to"
abstract: "Learn how to create an XML file that describes an SmsFormData class using a Create Form XML for a Configuration Manager property sheet."
---

# Create Form XML for a Property Sheet

...
type: reference
domain: sccm
slug: develop-initializedata-method-in-class-sms-replicationgroup
tier: reference
...
abstract: "Learn how to reinitialize a specific replication group between two specified sites using InitializeData class method."
---

...
type: reference
domain: sccm
slug: develop-sms-termsandconditionssettings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_termsandconditionssettings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that represents Terms and Conditions settings."
---

# SMS_TermsAndConditionsSettings Class

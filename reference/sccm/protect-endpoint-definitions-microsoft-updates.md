...
type: reference
domain: sccm
slug: protect-endpoint-definitions-microsoft-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-definitions-microsoft-updates
family: protect
documentKind: "article"
abstract: "Learn how to enable the download of Endpoint Protection malware definitions from Microsoft Updates for Configuration Manager."
---

# Download definitions from Microsoft

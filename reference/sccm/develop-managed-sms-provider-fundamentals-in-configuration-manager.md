...
type: reference
domain: sccm
slug: develop-managed-sms-provider-fundamentals-in-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/managed-sms-provider-fundamentals-in-configuration-manager
family: develop
documentKind: "article"
abstract: "The managed SMS Provider library is a .NET Framework library that wraps the System.Management classes, provides a Configuration Manager-centric object model, and provides a wrapper for accessing the Configuration Manager site control file."
---

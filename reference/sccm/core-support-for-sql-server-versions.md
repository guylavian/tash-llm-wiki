...
type: reference
domain: sccm
slug: core-support-for-sql-server-versions
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/configs/support-for-sql-server-versions
family: core
documentKind: "reference"
abstract: "Get SQL Server version and configuration requirements for hosting a Configuration Manager site database."
---

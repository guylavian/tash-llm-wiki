...
type: reference
domain: sccm
slug: develop-sms-collectionruleincludecollection-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents an inclusion rule that's added as a rule to the `SMS_Collection` instance."
---

# SMS_CollectionRuleIncludeCollection Class

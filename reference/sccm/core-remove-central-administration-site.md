...
type: reference
domain: sccm
slug: core-remove-central-administration-site
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/remove-central-administration-site
family: core
documentKind: "how-to"
abstract: "Remove the central administration site (CAS) to simplify your Configuration Manager infrastructure to a single, standalone primary site."
---

...
type: reference
domain: sccm
slug: sum-install-updates-publisher
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/tools/install-updates-publisher
family: sum
documentKind: "install-set-up-deploy"
abstract: "Install System Center Updates Publisher in your environment"
---

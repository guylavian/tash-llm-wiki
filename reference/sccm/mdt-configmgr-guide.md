...
type: reference
domain: sccm
slug: mdt-configmgr-guide
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdt/configmgr-guide
family: mdt
documentKind: "quickstart"
abstract: "A quickstart guide for Microsoft Deployment Toolkit (MDT) with System Center 2012 R2 Configuration Manager for the zero-touch installation (ZTI)"
---

...
type: reference
domain: sccm
slug: develop-sms-appdeploymenterrorassetdetails-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_appdeploymenterrorassetdetails-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class, in Configuration Manager, that represents error details of application deployment at the asset level."
---

# SMS_AppDeploymentErrorAssetDetails Class

...
type: reference
domain: sccm
slug: core-support-center-quickstart
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/support/support-center-quickstart
family: core
documentKind: "quickstart"
abstract: "Quickly capture the state of a Configuration Manager client for troubleshooting."
---

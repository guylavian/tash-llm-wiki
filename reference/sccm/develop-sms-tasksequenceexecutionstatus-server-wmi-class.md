...
type: reference
domain: sccm
slug: develop-sms-tasksequenceexecutionstatus-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, The SMS_TaskSequenceExecutionStatus WMI class is an SMS Provider server class that represents the status of an execution of a task sequence."
---

# SMS_TaskSequenceExecutionStatus Class

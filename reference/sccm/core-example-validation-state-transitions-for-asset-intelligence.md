...
type: reference
domain: sccm
slug: core-example-validation-state-transitions-for-asset-intelligence
tier: reference
...
abstract: "See examples of validation state transitions for Asset Intelligence in Configuration Manager."
---

...
type: reference
domain: sccm
slug: develop-sms-g-system-workstation-status-server-wmi-class
tier: reference
...
abstract: "In the Configuration Manager, the SMS_G_System_WORKSTATION_STATUS Windows Management Instrumentation class is an SMS Provider server class that contains information about the last time inventory was collected on a client computer."
---

# SMS_G_System_WORKSTATION_STATUS Class

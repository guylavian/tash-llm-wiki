...
type: reference
domain: sccm
slug: core-prepare-to-deploy-mac-clients
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/prepare-to-deploy-mac-clients
family: core
documentKind: "install-set-up-deploy"
abstract: "Configuration tasks prior to deploying the Configuration Manager client to Macs."
---

# Prepare to deploy the client to Macs

...
type: reference
domain: sccm
slug: protect-endpoint-definitions-network
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-definitions-network
family: protect
documentKind: "how-to"
abstract: "Learn how to manually download the latest definition updates from Microsoft and then configure clients to download these definitions."
---

# Download definitions from a network share

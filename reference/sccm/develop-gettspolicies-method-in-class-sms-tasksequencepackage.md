...
type: reference
domain: sccm
slug: develop-gettspolicies-method-in-class-sms-tasksequencepackage
tier: reference
...
abstract: "The GetTsPolicies WMI class method gets all policies associated with the specified task sequence."
---

# GetTsPolicies Method

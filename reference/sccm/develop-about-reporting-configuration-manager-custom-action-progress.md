...
type: reference
domain: sccm
slug: develop-about-reporting-configuration-manager-custom-action-progress
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/about-reporting-configuration-manager-custom-action-progress
family: develop
documentKind: "concept-article"
abstract: "A custom action can report progress information that is used to display a progress indicator."
---

# Report Custom Action Progress

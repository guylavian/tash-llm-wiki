...
type: reference
domain: sccm
slug: develop-getautoupgradeconfigs-method-in-class-sms-site
tier: reference
...
abstract: "A Windows Management Instrumentation class method that gets configurations for autoupgrade settings."
---

# GetAutoUpgradeConfigs Method

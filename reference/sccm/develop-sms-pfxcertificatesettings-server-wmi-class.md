...
type: reference
domain: sccm
slug: develop-sms-pfxcertificatesettings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_pfxcertificatesettings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Article outlining how to use the SMS_PfxCertificateSettings in Configuration Manager to represent personal information exchange (PFX) certificate settings."
---

# SMS_PfxCertificateSettings Class

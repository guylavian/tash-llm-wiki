...
type: reference
domain: sccm
slug: apps-simulate-application-deployments
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/simulate-application-deployments
family: apps
documentKind: "install-set-up-deploy"
abstract: "Evaluate the detection method, requirements, and dependencies for a deployment type without installing the application."
---

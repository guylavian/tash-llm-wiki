...
type: reference
domain: sccm
slug: apps-create-and-deploy-an-application
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/get-started/create-and-deploy-an-application
family: apps
documentKind: "how-to"
abstract: "Create and deploy an application containing a line-of-business app and learn how to manage apps effectively."
---

...
type: reference
domain: sccm
slug: develop-how-to-assign-an-advertisement-to-a-collection-of-computers
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-assign-an-advertisement-to-a-collection-of-computers
family: develop
documentKind: "how-to"
abstract: "Learn how to use the SMS_Advertisement class to assign an advertisement to a collection of computers."
---

# Assign an Advertisement to a Collection of Computers

...
type: reference
domain: sccm
slug: develop-how-to-configure-remote-tools-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/remote-control/how-to-configure-remote-tools-settings
family: develop
documentKind: "how-to"
abstract: "Learn how to use the Remote Tools Client Agent settings by modifying the necessary site control file settings."
---

...
type: reference
domain: sccm
slug: protect-monitor-certificate-profiles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/monitor-certificate-profiles
family: protect
documentKind: "how-to"
abstract: "Learn how to monitor the compliance status of Configuration Manager certificate profiles."
---

...
type: reference
domain: sccm
slug: apps-monitor-app-usage-with-software-metering
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/monitor-app-usage-with-software-metering
family: apps
documentKind: "how-to"
abstract: "Learn about operations that are available in Configuration Manager software metering."
---

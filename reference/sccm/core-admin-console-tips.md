...
type: reference
domain: sccm
slug: core-admin-console-tips
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/admin-console-tips
family: core
documentKind: "reference"
abstract: "Learn about changes to the Configuration Manager console and tips for using it."
---

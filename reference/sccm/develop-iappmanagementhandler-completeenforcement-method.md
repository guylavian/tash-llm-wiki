...
type: reference
domain: sccm
slug: develop-iappmanagementhandler-completeenforcement-method
tier: reference
...
abstract: "In Configuration Manager, the IAppManagementHandler::CompleteEnforcement method completes the installation of a specific application. This method will be called only when the handler returned valid reconnection data in the EnforceApp call."
---

# IAppManagementHandler::CompleteEnforcement

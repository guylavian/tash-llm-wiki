...
type: reference
domain: sccm
slug: develop-sms-tasksequencereferencedps-server-wmi-class
tier: reference
...
abstract: "Learn about the simplified syntax, methods, properties, and requirements of the SMS_TaskSequenceReferenceDps server class."
---

# SMS_TaskSequenceReferenceDps Class

...
type: reference
domain: sccm
slug: core-about-client-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/about-client-settings
family: core
documentKind: "reference"
abstract: "Learn about the default and custom settings for controlling client behaviors"
---

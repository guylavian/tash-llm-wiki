...
type: reference
domain: sccm
slug: sum-software-update-point-ssl
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/get-started/software-update-point-ssl
family: sum
documentKind: "tutorial"
abstract: "Tutorial - Configure Windows Server Update Services (WSUS) servers and the software update points to use TLS/SSL with a PKI certificate."
---

# Configure a software update point to use TLS/SSL with a PKI certificate tutorial

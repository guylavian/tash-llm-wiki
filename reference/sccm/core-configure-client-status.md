...
type: reference
domain: sccm
slug: core-configure-client-status
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/configure-client-status
family: core
documentKind: "how-to"
abstract: "Select client status settings in Configuration Manager."
---

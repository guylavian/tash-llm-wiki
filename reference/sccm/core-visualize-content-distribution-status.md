...
type: reference
domain: sccm
slug: core-visualize-content-distribution-status
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/visualize-content-distribution-status
family: core
documentKind: "how-to"
abstract: "Monitor content distribution path and status in a graphical format, to help you more easily understand the status of your content package distribution."
---

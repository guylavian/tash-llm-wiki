...
type: reference
domain: sccm
slug: tenant-attach-cmpivot-overview-attached
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/cmpivot-overview-attached
family: tenant-attach
documentKind: "reference"
abstract: "CMPivot usage overview for Microsoft Intune tenant attached devices."
---

# Tenant attached CMPivot usage overview

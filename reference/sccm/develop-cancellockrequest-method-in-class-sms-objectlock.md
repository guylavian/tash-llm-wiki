...
type: reference
domain: sccm
slug: develop-cancellockrequest-method-in-class-sms-objectlock
tier: reference
...
abstract: "The CancelLockRequest Windows Management Instrumentation (WMI) class method cancels a lock request."
---

# CancelLockRequest Method

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-preparesmsclientaction-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_preparesmsclientaction-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent a task sequence action that prepares the Configuration Manager client on the reference computer for capture."
---

# SMS_TaskSequence_PrepareSMSClientAction Class

...
type: reference
domain: sccm
slug: develop-sms-g-system-current-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_g_system_current-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent the current client state at the time of the last hardware inventory using SMS_G_System_Current as an abstract base class."
---

# SMS_G_System_Current Class

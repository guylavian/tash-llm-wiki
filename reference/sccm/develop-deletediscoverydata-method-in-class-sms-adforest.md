...
type: reference
domain: sccm
slug: develop-deletediscoverydata-method-in-class-sms-adforest
tier: reference
...
abstract: "In Configuration Manager, the DeleteDiscoveryData WMI class method removes information gathered by the forest discovery process."
---

# DeleteDiscoveryData Method

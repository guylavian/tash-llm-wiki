...
type: reference
domain: sccm
slug: tenant-attach-software-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/software-updates
family: tenant-attach
documentKind: "how-to"
abstract: "Software updates for Configuration Manager devices from the admin center"
---

# Software updates in the admin center

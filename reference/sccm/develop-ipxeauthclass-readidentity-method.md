...
type: reference
domain: sccm
slug: develop-ipxeauthclass-readidentity-method
tier: reference
...
abstract: "Learn how to use the Configuration Manager with the CreateIdentity method to create a PXE certificate identity that is used in the client configuration file."
---

# IPxeAuthClass::ReadIdentity

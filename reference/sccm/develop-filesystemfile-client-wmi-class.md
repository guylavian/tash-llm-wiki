...
type: reference
domain: sccm
slug: develop-filesystemfile-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/filesystemfile-client-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the FileSystemFile Class to represent local file information."
---

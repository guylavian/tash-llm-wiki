...
type: reference
domain: sccm
slug: protect-deploy-wifi-vpn-email-cert-profiles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/deploy-wifi-vpn-email-cert-profiles
family: protect
documentKind: "install-set-up-deploy"
abstract: "Learn how to deploy Wi-Fi, VPN, and certificate profiles in Configuration Manager."
---

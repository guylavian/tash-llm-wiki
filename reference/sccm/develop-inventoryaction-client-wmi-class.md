...
type: reference
domain: sccm
slug: develop-inventoryaction-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/inventoryaction-client-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to associate a set of queries with reporting details, tying together the item to report and the destination of the report."
---

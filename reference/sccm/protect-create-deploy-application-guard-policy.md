...
type: reference
domain: sccm
slug: protect-create-deploy-application-guard-policy
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/create-deploy-application-guard-policy
family: protect
documentKind: "install-set-up-deploy"
abstract: "Learn how to create and deploy Microsoft Defender Application Guard policies"
---

...
type: reference
domain: sccm
slug: sum-surface-drivers
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/surface-drivers
family: sum
documentKind: "how-to"
abstract: "Configuration Manager synchronizes Surface driver updates for deployment to Surface devices."
---

# Managing Surface driver updates

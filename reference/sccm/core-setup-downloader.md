...
type: reference
domain: sccm
slug: core-setup-downloader
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/setup-downloader
family: core
documentKind: "install-set-up-deploy"
abstract: "Use the standalone tool to download current versions of key installation files for setup."
---

# Setup downloader tool
...
> [!NOTE]
> Microsoft ODBC Driver for SQL Server should be installed before invoking download through either the user interface or a command prompt. For more information, see [Download ODBC Driver for SQL Server](/sql/connect/odbc/download-odbc-driver-for-sql-server) in the SQL Server documentation. 

...
type: reference
domain: sccm
slug: core-command-line-script-file
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/command-line-script-file
family: core
documentKind: "reference"
abstract: "Specify the keys and values in the INI installation script file for an unattended setup of Configuration Manager."
---

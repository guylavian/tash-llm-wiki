...
type: reference
domain: sccm
slug: osd-debug-task-sequence
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/debug-task-sequence
family: osd
documentKind: "how-to"
abstract: "Use the task sequence debugging tool to troubleshoot a task sequence."
---

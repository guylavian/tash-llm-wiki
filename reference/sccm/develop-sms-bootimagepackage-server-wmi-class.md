...
type: reference
domain: sccm
slug: develop-sms-bootimagepackage-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_bootimagepackage-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_BootImagePackage WMI class is an SMS Provider server class, in Configuration Manager, that serves as the unit of distribution for boot image source files."
---

# SMS_BootImagePackage Class

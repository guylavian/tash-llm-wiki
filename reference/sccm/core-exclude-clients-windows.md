...
type: reference
domain: sccm
slug: core-exclude-clients-windows
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/upgrade/exclude-clients-windows
family: core
documentKind: "how-to"
abstract: "Learn how to exclude Windows clients from getting upgraded in Configuration Manager."
---

# Exclude client upgrades for Windows

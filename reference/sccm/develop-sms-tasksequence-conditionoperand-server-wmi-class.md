...
type: reference
domain: sccm
slug: develop-sms-tasksequence-conditionoperand-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that's the abstract base class for operators and expressions used by task sequence steps."
---

# SMS_TaskSequence_ConditionOperand Class

...
type: reference
domain: sccm
slug: develop-ccm-requestedapppolicyactivation-client-wmi-class
tier: reference
...
abstract: "Learn how the CCM_RequestedAppPolicy Activation class represents a requested application policy activation."
---

# CCM_RequestedAppPolicyActivation Class

...
type: reference
domain: sccm
slug: develop-how-to-add-a-windows-driver-to-a-configuration-manager-boot-image-package
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you add a Windows driver to an operating system deployment boot image package by adding a reference to the required driver in the SMS_BootImagePackage Server WMI Class ReferencedDrivers array property."
---

# Add a Windows Driver to a Boot Image Package

...
type: reference
domain: sccm
slug: develop-getting-started-with-configuration-manager-programming
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/getting-started-with-configuration-manager-programming
family: develop
documentKind: "get-started"
abstract: "Learn the basics of programming and automation with the Configuration Manager software development kit (SDK)."
---

# Configuration Manager programming

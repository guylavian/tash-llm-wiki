...
type: reference
domain: sccm
slug: develop-sms-productfileinfo-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_productfileinfo-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_ProductFileInfo WMI class represents a combination of file and product information for inventory and metering."
---

# SMS_ProductFileInfo Class

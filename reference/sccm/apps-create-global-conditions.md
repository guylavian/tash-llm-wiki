...
type: reference
domain: sccm
slug: apps-create-global-conditions
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/create-global-conditions
family: apps
documentKind: "how-to"
abstract: "Create global conditions to specify how an application is provided and deployed to client devices."
---

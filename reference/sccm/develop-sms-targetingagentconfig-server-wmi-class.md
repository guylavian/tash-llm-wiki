...
type: reference
domain: sccm
slug: develop-sms-targetingagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_targetingagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_TargetingAgentConfig Windows Management Instrumentation class is an SMS Provider server class that represents how the client is configured for user and device affinity."
---

# SMS_TargetingAgentConfig Class

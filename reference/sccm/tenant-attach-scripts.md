...
type: reference
domain: sccm
slug: tenant-attach-scripts
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/scripts
family: tenant-attach
documentKind: "how-to"
abstract: "Run scripts for Configuration Manager devices from the admin center."
---

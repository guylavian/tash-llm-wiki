...
type: reference
domain: sccm
slug: sum-software-updates-icons
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/understand/software-updates-icons
family: sum
documentKind: "article"
abstract: "The Configuration Manager console contains icons that indicate a state for the synchronized update or software update group."
---

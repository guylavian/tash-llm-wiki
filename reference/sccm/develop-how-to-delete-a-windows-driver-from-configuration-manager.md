...
type: reference
domain: sccm
slug: develop-how-to-delete-a-windows-driver-from-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-delete-a-windows-driver-from-configuration-manager
family: develop
documentKind: "how-to"
abstract: "You delete a Windows driver from the operating system deployment driver catalog, in Configuration Manager, by deleting its SMS_Driver Server WMI Class object."
---

# Delete a Windows Driver

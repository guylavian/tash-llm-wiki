...
type: reference
domain: sccm
slug: develop-date-and-time-formats
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/date-and-time-formats
family: develop
documentKind: "article"
abstract: "When you write queries or compose reports from information that is stored in the Configuration Manager site database, you can express the date and time in any valid SQL format."
---

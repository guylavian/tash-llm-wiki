...
type: reference
domain: sccm
slug: develop-how-to-reorder-an-operating-system-deployment-task-sequence
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you can reorder the steps (an action or a group) in a task sequence or group by rearranging the step sequence in the [Steps] property array."
---

# Reorder an OS Deployment Task Sequence

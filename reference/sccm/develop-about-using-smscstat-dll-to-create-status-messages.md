...
type: reference
domain: sccm
slug: develop-about-using-smscstat-dll-to-create-status-messages
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/manage/about-using-smscstat.dll-to-create-status-messages
family: develop
documentKind: "how-to"
abstract: "Smscstat.dll is a library of 32-bit C APIs for reporting Configuration Manager status messages from an application that is running on either client computer."
---

# Use SMSCSTAT.DLL to Create Status Messages

...
type: reference
domain: sccm
slug: develop-sms-devicesettingitem-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/mdm/sms_devicesettingitem-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_DeviceSettingItem WMI class provides the functionality to create a device setting configuration item in the database."
---

# SMS_DeviceSettingItem Class

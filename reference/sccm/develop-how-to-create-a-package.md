...
type: reference
domain: sccm
slug: develop-how-to-create-a-package
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-create-a-package
family: develop
documentKind: "how-to"
abstract: "Learn how to create a package in Configuration Manager by using the SMS_Package class and class properties."
---

...
type: reference
domain: sccm
slug: core-test-database-upgrade
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/test-database-upgrade
family: core
documentKind: "how-to"
abstract: "Test upgrade the site database when installing updates for Configuration Manager."
---

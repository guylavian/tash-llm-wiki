...
type: reference
domain: sccm
slug: protect-bitlocker-keys-sql-always-on
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/bitlocker/bitlocker-keys-sql-always-on
family: protect
documentKind: "how-to"
abstract: "Describes how to use SQL Always On when BitLocker recovery data is encrypted in the database"
---

# Using SQL Always On when BitLocker recovery data is encrypted in the database

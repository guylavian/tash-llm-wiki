...
type: reference
domain: sccm
slug: develop-sample-queries-client-deployment-configuration-manager
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Sample queries that show how to join the most common client deployment views to other views."
---

# Sample queries for client deployment

...
type: reference
domain: sccm
slug: develop-sms-imageservicingschedule-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_imageservicingschedule-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn about the simplified syntax, methods, properties, and requirements of the SMS_ImageServicingSchedule server class."
---

# SMS_ImageServicingSchedule Class

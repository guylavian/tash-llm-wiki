...
type: reference
domain: sccm
slug: develop-how-to-set-operating-system-deployment-branding-information
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-set-operating-system-deployment-branding-information
family: develop
documentKind: "how-to"
abstract: "Learn how to set operating system deployment branding information in the configuration manager by changing the property of the client agent component section."
---

# Set Operating System Deployment Branding Information

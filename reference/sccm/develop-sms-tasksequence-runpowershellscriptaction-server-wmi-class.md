...
type: reference
domain: sccm
slug: develop-sms-tasksequence-runpowershellscriptaction-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_runpowershellscriptaction-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The `SMS_TaskSequence_RunPowerShellScriptAction` WMI class is an SMS Provider server class in Configuration Manager. It represents a task sequence action that runs a user-specified Windows PowerShell script."
---

# SMS_TaskSequence_RunPowerShellScriptAction Class

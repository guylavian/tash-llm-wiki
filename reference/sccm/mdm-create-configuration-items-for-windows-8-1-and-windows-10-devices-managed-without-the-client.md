...
type: reference
domain: sccm
slug: mdm-create-configuration-items-for-windows-8-1-and-windows-10-devices-managed-without-the-client
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/deploy-use/create-configuration-items-for-windows-8.1-and-windows-10-devices-managed-without-the-client
family: mdm
documentKind: "how-to"
abstract: "Create configuration items to manage settings for Windows 10 computers with on-premises mobile device management (MDM) in Configuration Manager."
---

# Create configuration items for Windows

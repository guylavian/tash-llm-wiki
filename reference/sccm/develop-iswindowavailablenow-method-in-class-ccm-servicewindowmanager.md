...
type: reference
domain: sccm
slug: develop-iswindowavailablenow-method-in-class-ccm-servicewindowmanager
tier: reference
...
abstract: "Learn how to determine if a service window of a specified type and duration is available to run using IsWindowAvailableNow."
---

# IsWindowAvailableNow Method

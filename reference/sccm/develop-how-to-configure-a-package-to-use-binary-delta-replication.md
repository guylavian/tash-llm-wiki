...
type: reference
domain: sccm
slug: develop-how-to-configure-a-package-to-use-binary-delta-replication
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to configure an existing package to use binary delta replication in Configuration Manager."
---

# Configure a Package to Use Binary Delta Replication

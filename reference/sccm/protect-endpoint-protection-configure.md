...
type: reference
domain: sccm
slug: protect-endpoint-protection-configure
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-protection-configure
family: protect
documentKind: "how-to"
abstract: "Learn how to set up Configuration Manager to update and distribute malware definitions for Windows Defender."
---

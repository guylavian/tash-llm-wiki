...
type: reference
domain: sccm
slug: develop-createsmsstatusmessage-function
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/createsmsstatusmessage-function
family: develop
documentKind: "reference"
abstract: "Learn how the CreateSMSStatusMessage function allocates a status message object, initializes it, and retrieves a handle to it."
---

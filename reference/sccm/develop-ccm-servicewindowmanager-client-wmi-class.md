...
type: reference
domain: sccm
slug: develop-ccm-servicewindowmanager-client-wmi-class
tier: reference
...
abstract: "Article detailing how to use CCM_ServiceWindowManager in Configuration Manager to manage service windows on the client computer."
---

# CCM_ServiceWindowManager Class

...
type: reference
domain: sccm
slug: apps-app-approval
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/app-approval
family: apps
documentKind: "how-to"
abstract: "Learn about the settings and behaviors for application approval in Configuration Manager."
---

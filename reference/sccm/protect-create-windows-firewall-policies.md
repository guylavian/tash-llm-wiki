...
type: reference
domain: sccm
slug: protect-create-windows-firewall-policies
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/create-windows-firewall-policies
family: protect
documentKind: "install-set-up-deploy"
abstract: "Learn how to create and deploy firewall policies for Endpoint Protection in System Center 2012 Configuration Manager."
---

# Windows Firewall policies for Endpoint Protection

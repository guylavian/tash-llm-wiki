...
type: reference
domain: sccm
slug: develop-geteula-method-in-class-sms-configurationitem
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/geteula-method-in-class-sms_configurationitem
family: develop
documentKind: "reference"
abstract: "Learn how to get the localized Microsoft Software License Terms text of the configuration item using GetEULA class method."
---

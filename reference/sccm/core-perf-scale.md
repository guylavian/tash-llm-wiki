...
type: reference
domain: sccm
slug: core-perf-scale
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/cmg/perf-scale
family: core
documentKind: "article"
abstract: "Plan how the design the cloud management gateway (CMG) for the best performance at the appropriate scale."
---

...
type: reference
domain: sccm
slug: develop-addsitesystem-method-in-class-sms-boundarygroup
tier: reference
...
abstract: "Learn how to add a site system to a boundary group in Configuration Manager using the AddSiteSystem class."
---

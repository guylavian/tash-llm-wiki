...
type: reference
domain: sccm
slug: develop-getclientscountbycollections-method-in-class-sms-migrationcollectioninfo
tier: reference
...
abstract: "A Windows Management Instrumentation class method that retrieves the number of clients in the specified collections."
---

# GetClientsCountByCollections Method

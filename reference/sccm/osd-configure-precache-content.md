...
type: reference
domain: sccm
slug: osd-configure-precache-content
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/configure-precache-content
family: osd
documentKind: "how-to"
abstract: "Learn how clients can download OS deployment content before a user installs the task sequence."
---

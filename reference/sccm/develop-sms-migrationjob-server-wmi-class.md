...
type: reference
domain: sccm
slug: develop-sms-migrationjob-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/migration/sms_migrationjob-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_MigrationJob WMI class is an SMS Provider server class that represents a migration job."
---

# SMS_MigrationJob Class

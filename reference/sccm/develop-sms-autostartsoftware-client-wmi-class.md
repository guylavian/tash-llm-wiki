...
type: reference
domain: sccm
slug: develop-sms-autostartsoftware-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/sms_autostartsoftware-client-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_AutoStartSoftware class is a client Windows Management Instrumentation (WMI) class that enumerates software that starts automatically with the operating system."
---

# SMS_AutoStartSoftware Class

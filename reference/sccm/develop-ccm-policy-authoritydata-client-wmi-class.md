...
type: reference
domain: sccm
slug: develop-ccm-policy-authoritydata-client-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the CCM_Policy_AuthorityData class is a client WMI class that stores information about policy from a particular authority."
---

# CCM_Policy_AuthorityData Class

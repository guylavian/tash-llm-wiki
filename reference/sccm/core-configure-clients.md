...
type: reference
domain: sccm
slug: core-configure-clients
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/cmg/configure-clients
family: core
documentKind: "how-to"
abstract: "Understand how to configure clients to use the cloud management gateway (CMG)."
---

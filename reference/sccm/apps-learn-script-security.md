...
type: reference
domain: sccm
slug: apps-learn-script-security
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/learn-script-security
family: apps
documentKind: "article"
abstract: "Resources to help learn about PowerShell script security."
---

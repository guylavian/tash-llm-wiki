...
type: reference
domain: sccm
slug: develop-cleanuphierarchydata-method-in-class-sms-migrationsitemapping
tier: reference
...
abstract: "The CleanupHierarchyData Windows Management Instrumentation (WMI) class method cleans up hierarchy data."
---

# CleanupHierarchyData Method

...
type: reference
domain: sccm
slug: core-checklist-for-installing-update-2309
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/checklist-for-installing-update-2309
family: core
documentKind: "checklist"
abstract: "Learn about actions to take before updating to Configuration Manager version 2309."
---
...
## About installing update 2309

### Sites

Install update 2309 at the top-level site of your hierarchy. Start the installation from your central administration site (CAS) or from your stand-alone primary site. After the update is installed at the top-level site, child sites have the following update behavior:
...
1. Run the **EnableEarlyUpdateRing2309.ps1** script, using the following syntax:

    `EnableEarlyUpdateRing2309.ps1 <SiteServer_Name> | SiteServer_IP>`

    Where `SiteServer` refers to the central administration site or standalone primary site server. For example, `EnableEarlyUpdateRing2309.ps1 cmprimary01`

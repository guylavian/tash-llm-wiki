...
type: reference
domain: sccm
slug: develop-how-to-define-the-client-side-handler
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/apps/how-to-define-the-client-side-handler
family: develop
documentKind: "how-to"
abstract: "The custom client-side handler needs to implement a public COM interface and methods. The below methods will be called by the Configuration Manager client framework."
---

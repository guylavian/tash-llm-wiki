...
type: reference
domain: sccm
slug: osd-preprovision-bitlocker-in-windows-pe
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/preprovision-bitlocker-in-windows-pe
family: osd
documentKind: "how-to"
abstract: "The Preprovision BitLocker task in Configuration Manager enables BitLocker from the Windows Preinstallation Environment before operating system deployment."
---

...
type: reference
domain: sccm
slug: develop-configuration-manager-schema-view-mapping
tier: reference
...
abstract: "Learn how the SQL Server schema of the Configuration Manager site database maps to the WMI schema."
---

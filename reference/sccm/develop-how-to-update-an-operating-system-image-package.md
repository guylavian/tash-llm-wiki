...
type: reference
domain: sccm
slug: develop-how-to-update-an-operating-system-image-package
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-update-an-operating-system-image-package
family: develop
documentKind: "how-to"
abstract: "Update an operating system using a Windows Image file that is associated with the operating system package in Configuration Manager."
---

# Update an OS Image Package

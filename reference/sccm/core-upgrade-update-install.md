...
type: reference
domain: sccm
slug: core-upgrade-update-install
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/understand/upgrade-update-install
family: core
documentKind: "concept-article"
abstract: "Learn the difference between the terms Install, Update, and Upgrade, when managing Configuration Manager infrastructure."
---

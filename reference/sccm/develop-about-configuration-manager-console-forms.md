...
type: reference
domain: sccm
slug: develop-about-configuration-manager-console-forms
tier: reference
...
abstract: "Learn how you can extend the Configuration Manager console with new Windows forms like adding form based dialog boxes and property sheets."
---

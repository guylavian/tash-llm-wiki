...
type: reference
domain: sccm
slug: develop-sms-clientcommunicationconfig-server-wmi-class
tier: reference
...
abstract: "Learn how to control how Windows 8 client computers communicate with Configuration Manager sites when they use metered Internet connections."
---

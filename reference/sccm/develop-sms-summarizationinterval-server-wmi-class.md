...
type: reference
domain: sccm
slug: develop-sms-summarizationinterval-server-wmi-class
tier: reference
...
abstract: "The SMS_SummarizationInterval WMI class represents the months that have been summarized by a monthly usage summary."
---

# SMS_SummarizationInterval Class

...
type: reference
domain: sccm
slug: develop-removesource-method-in-class-sms-usermachinerelationship
tier: reference
...
abstract: "Article describing how to use RemoveSource in Configuration Manager to remove a source for the relationship between a user and a device."
---

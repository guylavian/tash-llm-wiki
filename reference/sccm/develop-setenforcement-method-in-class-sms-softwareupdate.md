...
type: reference
domain: sccm
slug: develop-setenforcement-method-in-class-sms-softwareupdate
tier: reference
...
abstract: "Learn how to set policy enforcement rules for software updates by editing the 'SetEnforcement' class method in the Configuration Manager."
---

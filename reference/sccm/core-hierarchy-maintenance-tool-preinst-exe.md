...
type: reference
domain: sccm
slug: core-hierarchy-maintenance-tool-preinst-exe
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/hierarchy-maintenance-tool-preinst.exe
family: core
documentKind: "article"
abstract: "Understand what the hierarchy maintenance tool does, and why you might use it. Includes command-line options reference."
---

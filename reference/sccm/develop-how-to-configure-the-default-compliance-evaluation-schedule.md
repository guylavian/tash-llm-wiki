...
type: reference
domain: sccm
slug: develop-how-to-configure-the-default-compliance-evaluation-schedule
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, the site control file maintains configuration for the configuration of the site."
---

# Configure the Default Compliance Evaluation Schedule

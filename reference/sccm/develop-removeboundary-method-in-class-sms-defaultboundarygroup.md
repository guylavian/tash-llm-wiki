...
type: reference
domain: sccm
slug: develop-removeboundary-method-in-class-sms-defaultboundarygroup
tier: reference
...
abstract: "In Configuration Manager, the RemoveBoundary WMI class method removes one or more boundaries from a default boundary group."
---

...
type: reference
domain: sccm
slug: develop-how-to-create-action-xml-for-a-configuration-manager-dialog-box
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-create-action-xml-for-a-configuration-manager-dialog-box
family: develop
documentKind: "how-to"
abstract: "Learn how to create action XML for dialog boxes."
---

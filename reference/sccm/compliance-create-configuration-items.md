...
type: reference
domain: sccm
slug: compliance-create-configuration-items
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/create-configuration-items
family: compliance
documentKind: "how-to"
abstract: "Create and deploy configurations to devices that are managed by Configuration Manager and enrolled with Microsoft Intune."
---

# How to create configuration items

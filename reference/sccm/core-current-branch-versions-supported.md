...
type: reference
domain: sccm
slug: core-current-branch-versions-supported
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/current-branch-versions-supported
family: core
documentKind: "article"
abstract: "Review the Configuration Manager version history, and learn about the phases of service offered."
---

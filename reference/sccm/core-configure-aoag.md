...
type: reference
domain: sccm
slug: core-configure-aoag
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/configure-aoag
family: core
documentKind: "how-to"
abstract: "Set up and manage a SQL Server Always On availability group for the Configuration Manager site database."
---

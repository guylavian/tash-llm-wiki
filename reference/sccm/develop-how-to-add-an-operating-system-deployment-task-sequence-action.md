...
type: reference
domain: sccm
slug: develop-how-to-add-an-operating-system-deployment-task-sequence-action
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Add an OS deployment task sequence action to a task sequence by creating an instance of an SMS_TaskSequence_Action derived class, and then add it to the steps of the task sequence."
---

# Add an OS Deployment Task Sequence Action

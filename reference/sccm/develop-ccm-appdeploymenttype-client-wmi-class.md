...
type: reference
domain: sccm
slug: develop-ccm-appdeploymenttype-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/ccm_appdeploymenttype-client-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that represents an application deployment type."
---

# CCM_AppDeploymentType Class

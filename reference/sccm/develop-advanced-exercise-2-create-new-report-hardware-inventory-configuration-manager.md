...
type: reference
domain: sccm
slug: develop-advanced-exercise-2-create-new-report-hardware-inventory-configuration-manager
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Create a Configuration Manager report that displays hardware inventory information."
---

# Advanced exercise 2: Create a new report for hardware inventory

...
type: reference
domain: sccm
slug: core-planning-a-migration-job-strategy
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/migration/planning-a-migration-job-strategy
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Use migration jobs to configure data that you want to migrate to your Configuration Manager current branch environment."
---

# Migration job planning

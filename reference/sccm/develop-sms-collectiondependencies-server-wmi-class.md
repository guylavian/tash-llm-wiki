...
type: reference
domain: sccm
slug: develop-sms-collectiondependencies-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class used to query dependency relationships between collections, specifically the composable collection rules, inclusion and exclusion, and the limiting collection."
---

# SMS_CollectionDependencies Class

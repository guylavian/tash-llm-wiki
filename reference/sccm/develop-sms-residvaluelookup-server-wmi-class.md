...
type: reference
domain: sccm
slug: develop-sms-residvaluelookup-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_residvaluelookup-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_ResIDValueLookup WMI class is an SMS Provider server class that maps integers to localized text strings found in a resource DLL."
---

# SMS_ResIDValueLookup Class

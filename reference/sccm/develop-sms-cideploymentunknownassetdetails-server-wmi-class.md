...
type: reference
domain: sccm
slug: develop-sms-cideploymentunknownassetdetails-server-wmi-class
tier: reference
...
abstract: "The SMS_CIDeploymentUnknownAssetDetails WMI class represents the asset-level status of a configuration item deployment for unknown status."
---

# SMS_CIDeploymentUnknownAssetDetails Class

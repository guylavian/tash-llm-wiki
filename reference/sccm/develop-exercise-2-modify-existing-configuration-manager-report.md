...
type: reference
domain: sccm
slug: develop-exercise-2-modify-existing-configuration-manager-report
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/exercise-2-modify-existing-configuration-manager-report
family: develop
documentKind: "how-to"
abstract: "Modify a Configuration Manager report and then run the modified report."
---

# Exercise 2: Modify an existing report

...
type: reference
domain: sccm
slug: core-upgrade-an-evaluation-install-to-a-full-install
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/upgrade-an-evaluation-install-to-a-full-install
family: core
documentKind: "how-to"
abstract: "Learn how to upgrade an evaluation installation to a full installation of Configuration Manager."
---

# Upgrade evaluation installs

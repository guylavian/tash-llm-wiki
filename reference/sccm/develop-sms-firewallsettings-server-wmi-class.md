...
type: reference
domain: sccm
slug: develop-sms-firewallsettings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/protect/sms_firewallsettings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_FirewallSettings class is an SMS Provider server class that represents the firewall configuration setting definitions used to define configuration rules."
---

# SMS_FirewallSettings Class

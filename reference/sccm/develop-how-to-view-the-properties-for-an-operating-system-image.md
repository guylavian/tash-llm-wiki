...
type: reference
domain: sccm
slug: develop-how-to-view-the-properties-for-an-operating-system-image
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to view an image file's properties in XML format using a Microsoft operating system's image package."
---

# View the Properties for an OS Image

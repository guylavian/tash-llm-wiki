...
type: reference
domain: sccm
slug: develop-getlockinformation-method-in-class-sms-objectlock
tier: reference
...
abstract: "Learn how to use Configuration Manager GetLockInformation Windows Management Instrumentation (WMI) class method to get current lock information."
---

# GetLockInformation Method

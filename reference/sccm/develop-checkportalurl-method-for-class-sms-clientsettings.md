...
type: reference
domain: sccm
slug: develop-checkportalurl-method-for-class-sms-clientsettings
tier: reference
...
abstract: "Learn how to check if the default application catalog website point in the client agent settings is set to portalUrl."
---

# CheckPortalUrl Method

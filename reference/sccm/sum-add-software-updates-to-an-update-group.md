...
type: reference
domain: sccm
slug: sum-add-software-updates-to-an-update-group
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/add-software-updates-to-an-update-group
family: sum
documentKind: "how-to"
abstract: "Manually or automatically add software updates to a software update group in your environment."
---

# Add updates to an update group

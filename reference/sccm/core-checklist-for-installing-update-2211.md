...
type: reference
domain: sccm
slug: core-checklist-for-installing-update-2211
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/checklist-for-installing-update-2211
family: core
documentKind: "checklist"
abstract: "Learn about actions to take before updating to Configuration Manager version 2211."
---
...
- When the update is listed as **Available**, the update is ready to install. Before installing version 2211, review the following information [about installing update 2211](#about-installing-update-2211) and the [pre-update checklist](#pre-update-checklist) for configurations to make before starting the update.

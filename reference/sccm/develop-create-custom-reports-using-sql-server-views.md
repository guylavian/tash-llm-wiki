...
type: reference
domain: sccm
slug: develop-create-custom-reports-using-sql-server-views
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/create-custom-reports-using-sql-server-views
family: develop
documentKind: "reference"
abstract: "Information about how to create reports directly from the Configuration Manager console."
---

# Creating custom reports by using SQL Server views

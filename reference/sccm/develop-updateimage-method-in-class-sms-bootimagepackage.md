...
type: reference
domain: sccm
slug: develop-updateimage-method-in-class-sms-bootimagepackage
tier: reference
...
abstract: "The UpdateImage Windows Management Instrumentation (WMI) class method, in Configuration Manager, creates a copy of the current boot image source .wim file and updates the copy with the most current operating system deployment binaries."
---

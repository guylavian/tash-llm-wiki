...
type: reference
domain: sccm
slug: develop-createccrs-method-in-class-sms-collection
tier: reference
...
abstract: "Article describing the use of CreateCCRs in Configuration Manager to generate client configuration requests for the computers in the collection."
---

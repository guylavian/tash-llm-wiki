...
type: reference
domain: sccm
slug: develop-ccm-program-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/ccm_program-client-wmi-class
family: develop
documentKind: "reference"
abstract: "A client class, in Configuration Manager, that represents a legacy software distribution program on the client."
---

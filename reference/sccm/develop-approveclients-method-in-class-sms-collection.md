...
type: reference
domain: sccm
slug: develop-approveclients-method-in-class-sms-collection
tier: reference
...
abstract: "In Configuration Manager, the ApproveClients WMI class method approves specified client computers to join the site."
---

# ApproveClients Method

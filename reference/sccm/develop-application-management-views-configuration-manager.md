...
type: reference
domain: sccm
slug: develop-application-management-views-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/application-management-views-configuration-manager
family: develop
documentKind: "reference"
abstract: "Information about application management views and application management status views."
---

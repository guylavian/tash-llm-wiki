...
type: reference
domain: sccm
slug: develop-sms-objectcontentextrainfo-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents Application or Package Content Information."
---

# SMS_ObjectContentExtraInfo Class

...
type: reference
domain: sccm
slug: core-setup-wizard-secondary
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/setup-wizard-secondary
family: core
documentKind: "how-to"
abstract: "Use the Configuration Manager setup wizard to install a new secondary site."
---

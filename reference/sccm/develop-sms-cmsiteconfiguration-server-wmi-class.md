...
type: reference
domain: sccm
slug: develop-sms-cmsiteconfiguration-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_cmsiteconfiguration-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to retrieve the site's monitored configuration status, such as the SQL Server port, SQL Server Service Broker port, and SQL Server Firewall port."
---

# SMS_CMSiteConfiguration Class

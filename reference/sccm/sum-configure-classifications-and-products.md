...
type: reference
domain: sccm
slug: sum-configure-classifications-and-products
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/get-started/configure-classifications-and-products
family: sum
documentKind: "how-to"
abstract: "Follow these steps to configure software update classifications and products to synchronize in the Configuration Manager console."
---

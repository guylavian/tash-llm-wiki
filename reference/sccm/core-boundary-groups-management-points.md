...
type: reference
domain: sccm
slug: core-boundary-groups-management-points
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/boundary-groups-management-points
family: core
documentKind: "article"
abstract: "Understand how clients and management points behave with boundary groups."
---

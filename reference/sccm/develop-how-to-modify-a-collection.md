...
type: reference
domain: sccm
slug: develop-how-to-modify-a-collection
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/collections/how-to-modify-a-collection
family: develop
documentKind: "how-to"
abstract: "How to modify a collection by using the collection ID provided. The example property values are modified using the name and comment values."
---

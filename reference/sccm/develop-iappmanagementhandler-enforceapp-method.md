...
type: reference
domain: sccm
slug: develop-iappmanagementhandler-enforceapp-method
tier: reference
...
abstract: "A method that starts the installation of a specific application."
---

# IAppManagementHandler::EnforceApp

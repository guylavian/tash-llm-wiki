...
type: reference
domain: sccm
slug: develop-sms-g-system-exthistory-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_g_system_exthistory-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to create an abstract base class representing operating system extended history for a client computer using SMS_G_System_ExtHistory."
---

# SMS_G_System_ExtHistory Class

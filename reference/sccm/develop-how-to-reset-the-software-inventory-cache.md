...
type: reference
domain: sccm
slug: develop-how-to-reset-the-software-inventory-cache
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to reset the software inventory cache by connecting to the inventory agent namespace and deleting the inventory action status instance for software inventory."
---

# Reset the Software Inventory Cache

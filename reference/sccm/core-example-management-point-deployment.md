...
type: reference
domain: sccm
slug: core-example-management-point-deployment
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/example-management-point-deployment
family: core
documentKind: "install-set-up-deploy"
abstract: "Follow a step-by-step example to learn how to install a Configuration Manager management point on a server in an untrusted Active Directory domain."
---

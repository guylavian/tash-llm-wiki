...
type: reference
domain: sccm
slug: core-high-availability-options
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/high-availability-options
family: core
documentKind: "article"
abstract: "Learn how to deploy Configuration Manager by using options that maintain a high level of available service."
---

...
type: reference
domain: sccm
slug: cloud-attach-overview
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/cloud-attach/overview
family: cloud-attach
documentKind: "overview"
abstract: "Cloud attach for Configuration Manager overview"
---

# Cloud attach overview
...
:::image type="content" source="../../endpoint-analytics/media/work-from-anywhere/overall-score.png" alt-text="Screenshot of endpoint analytics work from anywhere report in Intune admin center." lightbox="../../endpoint-analytics/media/work-from-anywhere/overall-score.png":::
...
:::image type="content" source="../../endpoint-analytics/media/adoption-score/startup-performance-metrics.png" alt-text="Screenshot of endpoint analytics startup performance report in Intune admin center." lightbox="../../endpoint-analytics/media/adoption-score/startup-performance-metrics.png":::
...
:::image type="content" source="../../endpoint-analytics/media/adoption-score/application-reliability.png" alt-text="Screenshot of endpoint analytics application reliability report in Intune admin center." lightbox="../../endpoint-analytics/media/adoption-score/application-reliability.png":::
...
:::image type="content" source="../../endpoint-analytics/media/startup-performance/restart-frequency.png" alt-text="Screenshot of endpoint analytics restart frequency report in Intune admin center." lightbox="../../endpoint-analytics/media/startup-performance/restart-frequency.png":::

...
type: reference
domain: sccm
slug: osd-create-an-image-for-an-oem-in-factory-or-a-local-depot
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-an-image-for-an-oem-in-factory-or-a-local-depot
family: osd
documentKind: "how-to"
abstract: "Use prestaged media deployments to reduce network traffic while you deploy an OS to a computer that isn't fully provisioned."
---

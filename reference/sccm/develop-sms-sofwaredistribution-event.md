...
type: reference
domain: sccm
slug: develop-sms-sofwaredistribution-event
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_sofwaredistribution_event
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_SofwareDistribution_Event class to create other advertisement status-message classes."
---

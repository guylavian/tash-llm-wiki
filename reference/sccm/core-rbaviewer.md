...
slug: core-rbaviewer
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/support/rbaviewer
family: core
documentKind: "how-to"
abstract: "Use the role-based administration and auditing tool to model and audit security roles and scopes in Configuration Manager."
---

# Role-based administration tool

...
type: reference
domain: sccm
slug: develop-refresh-method-in-class-sms-siteinstallmap
tier: reference
...
abstract: "Learn how to reload the install map from the database, which repopulates the classes using Refresh class method."
---

...
type: reference
domain: sccm
slug: develop-sms-embeddedproperty-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_embeddedproperty-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider that represents a general-purpose embedded property. The property is used by the site control file to define the properties of a site control item."
---

# SMS_EmbeddedProperty Class

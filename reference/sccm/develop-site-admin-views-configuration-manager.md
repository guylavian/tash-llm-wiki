...
type: reference
domain: sccm
slug: develop-site-admin-views-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/site-admin-views-configuration-manager
family: develop
documentKind: "reference"
abstract: "Information such as the site code, Configuration Manager version, and the location of the SMS provider."
---

# Site administration views

...
type: reference
domain: sccm
slug: develop-console-management-class-xml
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/console-management-class-xml
family: develop
documentKind: "how-to"
abstract: "The MyClass node is a subclass of the SMS_SiteControlItem management class, which is defined in ManagementClassDescriptions.xml."
---

# Console Management Class XML

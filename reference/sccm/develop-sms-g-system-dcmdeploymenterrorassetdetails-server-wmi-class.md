...
type: reference
domain: sccm
slug: develop-sms-g-system-dcmdeploymenterrorassetdetails-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_g_system_dcmdeploymenterrorassetdetails-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class, in Configuration Manager, that represents the asset details for a deployment error."
---

# SMS_G_SYSTEM_DCMDeploymentErrorAssetDetails Class

...
type: reference
domain: sccm
slug: develop-how-to-create-action-xml-for-a-configuration-manager-property-sheet
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-create-action-xml-for-a-configuration-manager-property-sheet
family: develop
documentKind: "how-to"
abstract: "Learn how to use Create Action XML for a Property Sheet to you create a ShowDialog action. Like other actions, the ShowDialog action defines a context menu and action pane action that the user selects to show the dialog box."
---

# Create Action XML for a Property Sheet

...
type: reference
domain: sccm
slug: core-scenarios-to-streamline-your-installation
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/scenarios-to-streamline-your-installation
family: core
documentKind: "how-to"
abstract: "Learn techniques for installing a new Configuration Manager hierarchy when you update or upgrade a site."
---

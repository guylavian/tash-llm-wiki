...
type: reference
domain: sccm
slug: develop-sms-clientdatasourcescontentstats-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_ClientDataSourcesContentStats WMI class is an SMS Provider server class that represents client content data sources per package."
---

# SMS_ClientDataSourcesContentStats Class

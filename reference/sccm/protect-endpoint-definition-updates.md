...
type: reference
domain: sccm
slug: protect-endpoint-definition-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-definition-updates
family: protect
documentKind: "how-to"
abstract: "Learn how to select and configure methods with Endpoint Protection in Configuration Manager to keep antimalware definitions up to date on client computers."
---

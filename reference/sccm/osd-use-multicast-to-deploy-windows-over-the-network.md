...
type: reference
domain: sccm
slug: osd-use-multicast-to-deploy-windows-over-the-network
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/use-multicast-to-deploy-windows-over-the-network
family: osd
documentKind: "how-to"
abstract: "Use multicast in your Configuration Manager environment so that multiple computers can simultaneously download the OS image."
---

...
type: reference
domain: sccm
slug: develop-sms-g-system-softwareproduct-server-wmi-class
tier: reference
...
abstract: "The SMS_G_System_SoftwareProduct class is an SMS Provider server class that provides software product information for software files that contain resource strings."
---

# SMS_G_System_SoftwareProduct Class

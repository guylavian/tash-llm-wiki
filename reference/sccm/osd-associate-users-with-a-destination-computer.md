...
type: reference
domain: sccm
slug: osd-associate-users-with-a-destination-computer
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/associate-users-with-a-destination-computer
family: osd
documentKind: "article"
abstract: "Configure Configuration Manager to associate users with destination computers when deploying operating systems."
---

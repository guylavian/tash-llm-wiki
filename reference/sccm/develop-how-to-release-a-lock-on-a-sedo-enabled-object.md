...
type: reference
domain: sccm
slug: develop-how-to-release-a-lock-on-a-sedo-enabled-object
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-release-a-lock-on-a-sedo-enabled-object
family: develop
documentKind: "how-to"
abstract: "Learn about how to release a locked SEDO-enabled object using its object path by creating a ReleaseLock method."
---

# Release a Lock on a SEDO-Enabled Object

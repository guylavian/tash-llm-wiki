...
type: reference
domain: sccm
slug: develop-sms-appfailedvesdata-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_appfailedvesdata-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_AppFailedVEsData Windows Management Instrumentation (WMI) class is an SMS Provider server class in Configuration Manager."
---

# SMS_AppFailedVEsData Class

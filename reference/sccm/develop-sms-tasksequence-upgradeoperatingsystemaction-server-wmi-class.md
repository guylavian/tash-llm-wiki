...
type: reference
domain: sccm
slug: develop-sms-tasksequence-upgradeoperatingsystemaction-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_upgradeoperatingsystemaction-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Details of the SMS_TaskSequence_UpgradeOperatingSystemAction server WMI class."
---

# SMS_TaskSequence_UpgradeOperatingSystemAction class

...
type: reference
domain: sccm
slug: develop-resetpolicy-method-in-class-sms-client
tier: reference
...
abstract: "Learn how to reset the policy on a client resulting in the next policy request receiving a full policy in Configuration Manager."
---

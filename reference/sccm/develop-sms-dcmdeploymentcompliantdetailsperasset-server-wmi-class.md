...
type: reference
domain: sccm
slug: develop-sms-dcmdeploymentcompliantdetailsperasset-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_dcmdeploymentcompliantdetailsperasset-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_DCMDeploymentCompliantDetailsPerAsset class in Configuration Manager set compliant asset details for a deployment."
---

# SMS_DCMDeploymentCompliantDetailsPerAsset Class

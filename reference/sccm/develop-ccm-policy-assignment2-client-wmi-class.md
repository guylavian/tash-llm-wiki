...
type: reference
domain: sccm
slug: develop-ccm-policy-assignment2-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/ccm_policy_assignment2-client-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the CCM_Policy_Assignment2 class to represent a policy assignment in Configuration Manager."
---

# CCM_Policy_Assignment2 Class

...
type: reference
domain: sccm
slug: develop-ccm-softwarebase-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/ccm_softwarebase-client-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the CCM_SoftwareBase class to represent the base class for management entities like software updates."
---

# CCM_SoftwareBase Class

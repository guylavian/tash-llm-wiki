...
type: reference
domain: sccm
slug: develop-how-to-change-the-maximum-run-time-for-a-program
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-change-the-maximum-run-time-for-a-program
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, the following example shows how to modify a program by using the SMS_Package and SMS_Program classes and properties."
---

# Change the Maximum Run Time for a Program

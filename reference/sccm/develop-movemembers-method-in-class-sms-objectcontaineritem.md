...
type: reference
domain: sccm
slug: develop-movemembers-method-in-class-sms-objectcontaineritem
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/console/movemembers-method-in-class-sms_objectcontaineritem
family: develop
documentKind: "reference"
abstract: "Learn how to use Configuration Manager MoveMembers Windows Management Instrumentation (WMI) class method to move folder items to another folder."
---

...
type: reference
domain: sccm
slug: mdt-support-files
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdt/support-files
family: mdt
documentKind: "reference"
abstract: "Reference details for Microsoft Deployment Toolkit (MDT) Support Files"
---

# Toolkit reference - Microsoft Deployment Toolkit (MDT) Support Files

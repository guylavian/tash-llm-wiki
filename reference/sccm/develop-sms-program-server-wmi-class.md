...
type: reference
domain: sccm
slug: develop-sms-program-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_program-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent a program or command to run when software is distributed to a client computer using SMS_Program class."
---

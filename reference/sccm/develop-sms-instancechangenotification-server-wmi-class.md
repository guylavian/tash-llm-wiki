...
type: reference
domain: sccm
slug: develop-sms-instancechangenotification-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/console/sms_instancechangenotification-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to notify the administrator console that an alert has changed its status with SMS_InstanceChangeNotification class."
---

# SMS_InstanceChangeNotification Class

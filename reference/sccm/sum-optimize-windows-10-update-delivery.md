...
type: reference
domain: sccm
slug: sum-optimize-windows-10-update-delivery
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/optimize-windows-10-update-delivery
family: sum
documentKind: "how-to"
abstract: "Learn how to use Configuration Manager to manage update content to stay current with Windows."
---

...
type: reference
domain: sccm
slug: develop-about-configuration-manager-status-messages
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/manage/about-configuration-manager-status-messages
family: develop
documentKind: "concept-article"
abstract: "Learn about status messages in Configuration Manager"
---

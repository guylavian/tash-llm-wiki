...
type: reference
domain: sccm
slug: tenant-attach-troubleshoot-software-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/troubleshoot-software-updates
family: tenant-attach
documentKind: "troubleshooting"
abstract: "Troubleshooting software updates for Intune tenant attach"
---

# Troubleshoot software updates for devices uploaded to the admin center

...
type: reference
domain: sccm
slug: develop-sms-componentsummarizer-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_componentsummarizer-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_ComponentSummarizer WMI class is an SMS Provider server class that represents a component summarizer that reports on the health of individual components."
---

# SMS_ComponentSummarizer Class

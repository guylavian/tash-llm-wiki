...
type: reference
domain: sccm
slug: osd-customize-operating-system-images
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/customize-operating-system-images
family: osd
documentKind: "how-to"
abstract: "Use capture-and-build task sequences, manual configuration, or a combination of both to customize an operating system image."
---

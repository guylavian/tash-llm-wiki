...
type: reference
domain: sccm
slug: develop-sms-collectionruledirect-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents a resource. The resource is to be made an unconditional member of the collection."
---

# SMS_CollectionRuleDirect Class

...
type: reference
domain: sccm
slug: develop-refreshpkgsource-method-in-class-sms-package
tier: reference
...
abstract: "A Windows Management Instrumentation class method that refreshes the package source at all distribution points."
---

...
type: reference
domain: sccm
slug: develop-sms-sitecontrolfile-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_SiteControlFile class which represents the site control file and methods to maintain version control of the site control file."
---

# SMS_SiteControlFile Class

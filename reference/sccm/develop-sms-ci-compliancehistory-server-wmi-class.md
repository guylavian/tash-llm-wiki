...
type: reference
domain: sccm
slug: develop-sms-ci-compliancehistory-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_ci_compliancehistory-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_CI_ComplianceHistory class in Configuration Manager to get the compliance history for both configuration items and configuration baselines."
---

# SMS_CI_ComplianceHistory Class

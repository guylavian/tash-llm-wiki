...
type: reference
domain: sccm
slug: develop-sms-summarizersitestatus-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_SummarizerSiteStatus class to represent summarizer for the overall health of each site."
---

# SMS_SummarizerSiteStatus Class

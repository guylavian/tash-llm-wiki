...
type: reference
domain: sccm
slug: develop-sms-apprelation-flat-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_apprelation_flat-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Details of the SMS_AppRelation_Flat WMI class"
---

# SMS_AppRelation_Flat Class

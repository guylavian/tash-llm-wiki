...
type: reference
domain: sccm
slug: develop-how-to-delete-updates-from-a-deployment-package
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/how-to-delete-updates-from-a-deployment-package
family: develop
documentKind: "how-to"
abstract: "Remove update content from the existing software updates management package by using the RemoveContent method."
---

# Delete Updates from a Deployment Package

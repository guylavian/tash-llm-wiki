...
type: reference
domain: sccm
slug: mdt-user-driven-installation-developers-guide
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdt/user-driven-installation-developers-guide
family: mdt
documentKind: "article"
abstract: "Developers guide for user driven installation (UDI) of Microsoft Deployment Toolkit (MDT)"
---
...
- **Custom wizard page editors**. You use wizard page editors to configure the behavior of your custom wizard page. The custom wizard page editors are implemented as DLLs that the UDI Wizard Designer reads. You create wizard page editors using:
  ...
  - [Microsoft Unity Application Block](/previous-versions/msp-n-p/ff647202(v=pandp.10)?redirectedfrom=MSDN) (Unity) version 2.1

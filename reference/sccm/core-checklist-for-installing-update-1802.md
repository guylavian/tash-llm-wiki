...
type: reference
domain: sccm
slug: core-checklist-for-installing-update-1802
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/checklist-for-installing-update-1802
family: core
documentKind: "checklist"
abstract: "Learn about actions to take before updating to Configuration Manager version 1802."
---
...
**Ensure that all sites run a version of Configuration Manager that supports update to 1802:**
Each site server in the hierarchy must run the same version of Configuration Manager before you can start the installation of update 1802. To update to 1802, you must use version 1702, 1706, or 1710.
...
<!--SCCMdocs#587-->
If you extend Configuration Manager with other products from Microsoft or Microsoft partners, confirm that those products support version 1802. Check with the product vendor for this information. For example, see the Microsoft Deployment Toolkit [release notes](../../../mdt/release-notes.md).

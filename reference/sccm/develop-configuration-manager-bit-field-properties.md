...
type: reference
domain: sccm
slug: develop-configuration-manager-bit-field-properties
tier: reference
...
abstract: "Some Configuration Manager object properties are implemented as bit fields, where individual binary bits of an integer (usually a uint32 data type) are used as Boolean flags to store information"
---

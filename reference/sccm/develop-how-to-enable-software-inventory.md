...
type: reference
domain: sccm
slug: develop-how-to-enable-software-inventory
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/inventory/how-to-enable-software-inventory
family: develop
documentKind: "how-to"
abstract: "Learn how to enable or disable the Software Inventory Client Agent, in Configuration Manager, by modifying the site control file settings."
---

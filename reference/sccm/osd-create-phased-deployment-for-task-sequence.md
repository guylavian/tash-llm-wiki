...
type: reference
domain: sccm
slug: osd-create-phased-deployment-for-task-sequence
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-phased-deployment-for-task-sequence
family: osd
documentKind: "how-to"
abstract: "Use phased deployments to automate the rollout of software to several collections."
---

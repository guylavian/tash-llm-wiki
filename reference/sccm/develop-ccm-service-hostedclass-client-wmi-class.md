...
type: reference
domain: sccm
slug: develop-ccm-service-hostedclass-client-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the CCM_Service_HostedClass class is a client Windows Management Instrumentation class that configures a COM class to be hosted in the CCMEXEC service."
---

# CCM_Service_HostedClass Class

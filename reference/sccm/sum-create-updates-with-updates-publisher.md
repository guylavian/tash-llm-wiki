...
type: reference
domain: sccm
slug: sum-create-updates-with-updates-publisher
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/tools/create-updates-with-updates-publisher
family: sum
documentKind: "how-to"
abstract: "Create and bundle software updates with System Center Updates Publisher"
---

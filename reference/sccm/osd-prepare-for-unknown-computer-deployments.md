...
type: reference
domain: sccm
slug: osd-prepare-for-unknown-computer-deployments
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/prepare-for-unknown-computer-deployments
family: osd
documentKind: "install-set-up-deploy"
abstract: "Learn how to deploy operating systems to computers that aren't managed by Configuration Manager in your Configuration Manager environment."
---

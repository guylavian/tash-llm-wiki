...
type: reference
domain: sccm
slug: develop-how-to-read-the-tally-intervals-for-a-configuration-manager-site
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you can read the available tally intervals for a site by inspecting the site control file SMS_COMPONENT_STATUS_SUMMARIZER object Summary_Intervals embedded property list."
---

# Read the Tally Intervals for a Site

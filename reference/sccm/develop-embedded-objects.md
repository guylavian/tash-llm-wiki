...
type: reference
domain: sccm
slug: develop-embedded-objects
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/embedded-objects
family: develop
documentKind: "article"
abstract: "You cannot use Windows Management Instrumentation (WMI) to enumerate, query, get, or put embedded objects. You can only retrieve and store embedded objects through the parent instance."
---

...
type: reference
domain: sccm
slug: develop-iappmanagementhandler-enumerateapps-method
tier: reference
...
abstract: "Learn how to run a synchronous discovery operation for the provided synclet in Configuration Manager."
---

# IAppManagementHandler::EnumerateApps

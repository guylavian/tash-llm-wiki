...
type: reference
domain: sccm
slug: develop-sms-g-system-collectedfile-server-wmi-class
tier: reference
...
abstract: "Learn how to use SMS_G_System_CollectedFile class which contains information about a file copied from the client computer to the site server."
---

# SMS_G_System_CollectedFile Class

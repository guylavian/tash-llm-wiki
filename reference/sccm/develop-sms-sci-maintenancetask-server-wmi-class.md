...
type: reference
domain: sccm
slug: develop-sms-sci-maintenancetask-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_SCI_MaintenanceTask class to represent a site control item maintenance task."
---

# SMS_SCI_MaintenanceTask Class

...
type: reference
domain: sccm
slug: develop-sms-windows8applicationuserinfo-client-wmi-class
tier: reference
...
abstract: "Learn how to define user information of an application in Configuration Manager with SMS_Windows8ApplicationUserInfo."
---

# SMS_Windows8ApplicationUserInfo Class

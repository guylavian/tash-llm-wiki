...
type: reference
domain: sccm
slug: develop-getclientconfigpolicies-method-in-class-sms-tasksequencepackage
tier: reference
...
abstract: "The GetClientConfigPolicies WMI class method gets all site-wide client configuration policies and their corresponding policy assignments."
---

# GetClientConfigPolicies Method

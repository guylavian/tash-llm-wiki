...
type: reference
domain: sccm
slug: develop-addchangenotification-method-in-class-sms-bootimagepackage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/addchangenotification-method-in-class-sms_bootimagepackage
family: develop
documentKind: "reference"
abstract: "Learn how to add a boot image package change notification using AddChangeNotification class in Configuration Manager."
---

# AddChangeNotification Method in SMS_BootImagePackage

...
type: reference
domain: sccm
slug: develop-how-to-configure-mobile-device-client-agent-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/mdm/how-to-configure-mobile-device-client-agent-settings
family: develop
documentKind: "how-to"
abstract: "How to Configure Mobile Device Client Agent Settings"
---

# Configure Mobile Device Client Agent Settings

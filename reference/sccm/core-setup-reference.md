...
type: reference
domain: sccm
slug: core-setup-reference
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/setup-reference
family: core
documentKind: "reference"
abstract: "Review this reference to help you prepare to install a Configuration Manager site or hierarchy."
---

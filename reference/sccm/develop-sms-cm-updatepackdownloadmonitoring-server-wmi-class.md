...
type: reference
domain: sccm
slug: develop-sms-cm-updatepackdownloadmonitoring-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_cm_updatepackdownloadmonitoring-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to get the update package download status per site in Configuration Manager using SMS_CM_UpdatePackDownloadMonitoring."
---

# SMS_CM_UpdatePackDownloadMonitoring Class

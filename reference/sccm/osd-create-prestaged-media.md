...
type: reference
domain: sccm
slug: osd-create-prestaged-media
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-prestaged-media
family: osd
documentKind: "how-to"
abstract: "Use prestaged media in Configuration Manager to simplify deployment of Windows in several scenarios."
---

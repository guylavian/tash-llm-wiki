...
type: reference
domain: sccm
slug: develop-postponeupdatestononbusinesshours-method-in-class-ccm-softwareupdatesmanager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/postponeupdatestononbusinesshours-method-in-class-ccm_softwareupdatesmanager
family: develop
documentKind: "reference"
abstract: "Learn how to postpone a set of software updates to automatically install in specified non-business hours."
---

# PostponeUpdatesToNonBusinessHours Method

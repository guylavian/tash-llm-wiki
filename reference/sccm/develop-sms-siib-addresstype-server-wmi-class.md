...
type: reference
domain: sccm
slug: develop-sms-siib-addresstype-server-wmi-class
tier: reference
...
abstract: "Learn how to represent the sender address type used by the Configuration Manager console with the SMS_SIIB_AddressType class."
---

# SMS_SIIB_AddressType Class

...
type: reference
domain: sccm
slug: develop-how-to-create-a-mof-file-for-a-configuration-manager-custom-action
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "A custom task sequence action, its properties and its user interface controls are defined by creating a managed object format (MOF) file to describe the class."
---

# Create a MOF File for a Custom Action

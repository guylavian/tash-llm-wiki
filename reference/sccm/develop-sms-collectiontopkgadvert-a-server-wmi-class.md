...
type: reference
domain: sccm
slug: develop-sms-collectiontopkgadvert-a-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_CollectionToPkgAdvert_a association WMI class is an SMS Provider server class that uses the CollectionID property to relate an SMS_Advertisement Server WMI Class object with its target SMS_Collection Server WMI Class object."
---

# SMS_CollectionToPkgAdvert_a Class

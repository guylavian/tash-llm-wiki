...
type: reference
domain: sccm
slug: develop-sms-collectionsettings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/collections/sms_collectionsettings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how the SMS_CollectionSettings class is an SMS Provider server class that represents settings for an SMS_Collection Server WMI Class object."
---

# SMS_CollectionSettings Class

...
type: reference
domain: sccm
slug: develop-sms-client-reg-multistring-list-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents a list of client registry multi-string items from the site control file."
---

# SMS_Client_Reg_MultiString_List Class

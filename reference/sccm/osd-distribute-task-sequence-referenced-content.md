...
type: reference
domain: sccm
slug: osd-distribute-task-sequence-referenced-content
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/distribute-task-sequence-referenced-content
family: osd
documentKind: "how-to"
abstract: "Before clients run a task sequence that references content, distribute that content to distribution points."
---

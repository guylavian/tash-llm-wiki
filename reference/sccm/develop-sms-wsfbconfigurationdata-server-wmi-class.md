...
type: reference
domain: sccm
slug: develop-sms-wsfbconfigurationdata-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class, in Configuration Manager, that represents Microsoft Store for Business configuration data."
---

# SMS_WSfBConfigurationData Class

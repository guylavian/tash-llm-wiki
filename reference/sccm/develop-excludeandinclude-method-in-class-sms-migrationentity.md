...
type: reference
domain: sccm
slug: develop-excludeandinclude-method-in-class-sms-migrationentity
tier: reference
...
abstract: "In Configuration Manager, the ExcludeAndInclude WMI class method marks the entities as excluded or included."
---

# ExcludeAndInclude Method

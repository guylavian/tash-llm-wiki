...
type: reference
domain: sccm
slug: develop-sms-cm-updatepackdetailedprereqmonitoring-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_cm_updatepackdetailedprereqmonitoring-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_CM_UpdatePackDetailedPrereqMonitoring WMI class is an SMS Provider server class that is used to get detailed update package prerequisite status per site."
---

# SMS_CM_UpdatePackDetailedPrereqMonitoring Class

...
type: reference
domain: sccm
slug: develop-how-to-create-a-schedule-token
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-create-a-schedule-token
family: develop
documentKind: "how-to"
abstract: "Create a schedule token in Configuration Manager by creating and populating an instance of the appropriate SMS_ST_ schedule token class."
---

...
type: reference
domain: sccm
slug: develop-sms-g-system-history-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_g_system_history-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_G_System_History class is an SMS Provider server class that serves as an abstract base class representing hardware component state history for a client computer."
---

# SMS_G_System_History Class

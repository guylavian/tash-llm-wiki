...
type: reference
domain: sccm
slug: core-pki-certificate-requirements
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/network/pki-certificate-requirements
family: core
documentKind: "reference"
abstract: "Find requirements for PKI certificates that you might need for Configuration Manager."
---

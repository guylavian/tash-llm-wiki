...
type: reference
domain: sccm
slug: develop-how-to-enumerate-updates-matching-a-specific-criteria
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/how-to-enumerate-updates-matching-a-specific-criteria
family: develop
documentKind: "how-to"
abstract: "Enumerate software updates that match specific criteria in Configuration Manager by building a query and then using the ExecuteQuery method of the QueryProcessor class to run the query."
---

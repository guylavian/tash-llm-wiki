...
type: reference
domain: sccm
slug: develop-unlock-method-in-class-sms-softwareupdatespackage
tier: reference
...
abstract: "The Unlock Windows Management Instrumentation (WMI) class method, in Configuration Manager, sets the source site to the current site, unlocking the software updates package."
---

# Unlock Method in SMS_SoftwareUpdatesPackage

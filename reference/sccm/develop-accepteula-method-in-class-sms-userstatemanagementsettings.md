...
type: reference
domain: sccm
slug: develop-accepteula-method-in-class-sms-userstatemanagementsettings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/accepteula-method-in-class-sms_userstatemanagementsettings
family: develop
documentKind: "reference"
abstract: "Learn how the AcceptEULA Windows Management Instrumentation (WMI) class method, in Configuration Manager, accepts or declines the Microsoft Software License Terms of a configuration item."
---

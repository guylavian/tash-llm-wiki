...
type: reference
domain: sccm
slug: develop-raiseerrorstatusmsg-method-in-class-sms-statusmessage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/raiseerrorstatusmsg-method-in-class-sms_statusmessage
family: develop
documentKind: "reference"
abstract: "Learn how to create an error status message using RaiseErrorStatusMsg class method in Configuration Manager."
---

# RaiseErrorStatusMsg Method

...
type: reference
domain: sccm
slug: develop-sms-adsubnet-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_adsubnet-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use SMS_ADSubnet class as an SMS Provider server class that contains Active Directory subnets discovered by CM Forest Discovery."
---

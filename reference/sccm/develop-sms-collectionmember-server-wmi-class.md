...
type: reference
domain: sccm
slug: develop-sms-collectionmember-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/collections/sms_collectionmember-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use SMS_CollectionMember class that serves as the abstract base class for the member classes for each collection."
---

# SMS_CollectionMember Class

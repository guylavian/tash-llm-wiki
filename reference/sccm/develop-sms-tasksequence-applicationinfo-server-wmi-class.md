...
type: reference
domain: sccm
slug: develop-sms-tasksequence-applicationinfo-server-wmi-class
tier: reference
...
abstract: "The SMS_TaskSequence_ApplicationInfo WMI class represents application information for the application that is installed by using a task sequence."
---

# SMS_TaskSequence_ApplicationInfo Class

...
type: reference
domain: sccm
slug: develop-sms-stateinformation-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_stateinformation-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_StateInformation WMI class provides information about a state message."
---

# SMS_StateInformation Class

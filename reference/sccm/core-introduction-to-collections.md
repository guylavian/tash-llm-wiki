...
type: reference
domain: sccm
slug: core-introduction-to-collections
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/collections/introduction-to-collections
family: core
documentKind: "article"
abstract: "Get an introduction to using collections in Configuration Manager."
---

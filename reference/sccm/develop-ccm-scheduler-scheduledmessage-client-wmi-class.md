...
type: reference
domain: sccm
slug: develop-ccm-scheduler-scheduledmessage-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/ccm_scheduler_scheduledmessage-client-wmi-class
family: develop
documentKind: "reference"
abstract: "A client Windows Management Instrumentation class that represents the configuration for a scheduled message."
---

# CCM_Scheduler_ScheduledMessage Class

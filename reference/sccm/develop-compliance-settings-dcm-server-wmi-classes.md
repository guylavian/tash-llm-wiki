...
type: reference
domain: sccm
slug: develop-compliance-settings-dcm-server-wmi-classes
tier: reference
...
abstract: "Assists you in assessing computer compliance. You can also use these classes to check for compliance with software updates and security settings."
---

# Compliance settings classes

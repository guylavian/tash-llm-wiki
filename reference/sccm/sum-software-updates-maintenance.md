...
type: reference
domain: sccm
slug: sum-software-updates-maintenance
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/software-updates-maintenance
family: sum
documentKind: "article"
abstract: "To maintain updates in Configuration Manager, you can schedule the WSUS cleanup task, or you can run it manually."
---

...
type: reference
domain: sccm
slug: develop-sms-virtualenvironment-server-wmi-classes
tier: reference
...
abstract: "Learn how to track the history of a request each time a request is updated using SMS_VirtualEnvironment in Configuration Manager."
---

# SMS_VirtualEnvironment Classes

...
type: reference
domain: sccm
slug: develop-operating-system-configuration-item-example-1
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/operating-system-configuration-item-example-1
family: develop
documentKind: "article"
abstract: "Example 1 for Operating System Configuration Item"
---

# OS Configuration Item Example 1

...
type: reference
domain: sccm
slug: develop-clienteditions-method-in-class-sms-collection
tier: reference
...
abstract: "Learn how to retrieve a list of client editions and whether the DeviceOwner property may be edited using CLientEditions class method."
---

# ClientEditions Method

...
type: reference
domain: sccm
slug: develop-about-configuration-manager-queries
tier: reference
...
abstract: "Create and run the queries that are accessible in the Configuration Manager console under Queries."
---
...
Each query has a unique identifier assigned to it by the SMS Provider and can be used to get a specific query. For information about running a query, see [How to Run a Configuration Manager Query](../../../develop/core/understand/how-to-run-a-query.md).

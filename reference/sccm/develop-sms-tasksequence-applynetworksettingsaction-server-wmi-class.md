...
type: reference
domain: sccm
slug: develop-sms-tasksequence-applynetworksettingsaction-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_applynetworksettingsaction-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Represent a task sequence action that specifies the network or workgroup configuration information for the target computer."
---

# SMS_TaskSequence_ApplyNetworkSettingsAction Class

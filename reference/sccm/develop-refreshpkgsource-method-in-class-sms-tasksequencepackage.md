...
type: reference
domain: sccm
slug: develop-refreshpkgsource-method-in-class-sms-tasksequencepackage
tier: reference
...
abstract: "The RefreshPkgSource class method refreshes the package source at all distribution points when the package properties haven't changed."
---

# RefreshPkgSource Method in SMS_TaskSequencePackage

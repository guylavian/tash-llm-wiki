...
type: reference
domain: sccm
slug: develop-iappcontentext-getexcludedfilelist
tier: reference
...
abstract: "Learn how to get the excluded file list for application content used to support selective file download with IAppContentExt::GetExcludedFileList method."
---

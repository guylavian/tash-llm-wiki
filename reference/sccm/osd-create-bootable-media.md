...
type: reference
domain: sccm
slug: osd-create-bootable-media
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-bootable-media
family: osd
documentKind: "how-to"
abstract: "Use bootable media in Configuration Manager to install a new version of Windows or replace a computer."
---

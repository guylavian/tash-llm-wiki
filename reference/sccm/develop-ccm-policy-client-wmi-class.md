...
type: reference
domain: sccm
slug: develop-ccm-policy-client-wmi-class
tier: reference
...
abstract: "Learn how to use CCM_Policy Client Windows Management Instrumentation class in Configuration Manager to represent a client policy."
---

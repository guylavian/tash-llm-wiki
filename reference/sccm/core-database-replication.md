...
type: reference
domain: sccm
slug: core-database-replication
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/hierarchy/database-replication
family: core
documentKind: "article"
abstract: "Learn how Configuration Manager database replication uses SQL Server to transfer data in the hierarchy."
---

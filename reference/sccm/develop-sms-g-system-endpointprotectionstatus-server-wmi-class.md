...
type: reference
domain: sccm
slug: develop-sms-g-system-endpointprotectionstatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/protect/sms_g_system_endpointprotectionstatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_G_System_EndpointProtectionStatus class to represent the status of Endpoint Protection."
---

# SMS_G_System_EndpointProtectionStatus Class

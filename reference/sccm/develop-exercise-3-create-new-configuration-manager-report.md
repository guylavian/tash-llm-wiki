...
type: reference
domain: sccm
slug: develop-exercise-3-create-new-configuration-manager-report
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/exercise-3-create-new-configuration-manager-report
family: develop
documentKind: "how-to"
abstract: "Create a simple report and configure the report properties."
---

# Exercise 3: Create a new report

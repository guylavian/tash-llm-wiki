...
type: reference
domain: sccm
slug: develop-addmembershiprule-method-in-class-sms-collection
tier: reference
...
abstract: "Learn how to add a new rule to the CollectionRules property of the SMS_Collection Server WMI Class in Configuration Manager."
---

# AddMembershipRule Method

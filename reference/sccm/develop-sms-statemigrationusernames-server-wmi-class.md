...
type: reference
domain: sccm
slug: develop-sms-statemigrationusernames-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class in Configuration Manager that represents a localized username during state migration."
---

# SMS_StateMigrationUserNames Class

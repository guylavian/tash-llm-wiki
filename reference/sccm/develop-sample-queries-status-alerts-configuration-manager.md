...
type: reference
domain: sccm
slug: develop-sample-queries-status-alerts-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/sample-queries-status-alerts-configuration-manager
family: develop
documentKind: "how-to"
abstract: "Sample queries that show how to join some of the most commonly used status message views to other views."
---

# Sample queries for status and alerts

...
type: reference
domain: sccm
slug: develop-how-to-create-a-deployment-template
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/how-to-create-a-deployment-template
family: develop
documentKind: "how-to"
abstract: "Create a software updates deployment template in Configuration Manager by creating an instance of the SMS_Template class and populating the properties."
---

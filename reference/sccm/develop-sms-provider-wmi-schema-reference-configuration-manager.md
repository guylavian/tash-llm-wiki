...
type: reference
domain: sccm
slug: develop-sms-provider-wmi-schema-reference-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/sms-provider-wmi-schema-reference-configuration-manager
family: develop
documentKind: "reference"
abstract: "How Configuration�Manager uses Windows Management Instrumentation (WMI) to manage its objects."
---

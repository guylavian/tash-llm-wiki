...
type: reference
domain: sccm
slug: develop-sendnotifyerrortoctm-method
tier: reference
...
abstract: "Learn how to notify Content Transfer Manager of errors using the SendNotifyErrorToCTM method, in Configuration Manager."
---

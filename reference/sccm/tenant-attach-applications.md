...
type: reference
domain: sccm
slug: tenant-attach-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/applications
family: tenant-attach
documentKind: "install-set-up-deploy"
abstract: "Install applications for uploaded Configuration Manager devices from the admin center."
---

# Tenant attach - Applications in the admin center

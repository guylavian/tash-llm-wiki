...
type: reference
domain: sccm
slug: develop-how-to-create-a-configuration-manager-property-sheet
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-create-a-configuration-manager-property-sheet
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, to create a console property sheet, you first create a NET Framework assembly that inherits from the SMSPageControl class."
---

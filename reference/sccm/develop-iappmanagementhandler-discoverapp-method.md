...
type: reference
domain: sccm
slug: develop-iappmanagementhandler-discoverapp-method
tier: reference
...
abstract: "Learn how to run a synchronous discovery operation for the provided synclet using IAppManagementHandler::DiscoveryApp."
---

# IAppManagementHandler::DiscoverApp

...
type: reference
domain: sccm
slug: develop-how-to-read-a-task-sequence-from-a-task-sequence-package
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Read a task sequence from a task sequence package, in Configuration Manager, by calling the SMS_TaskSequencePackage method."
---

# Read a Task Sequence from a Task Sequence Package

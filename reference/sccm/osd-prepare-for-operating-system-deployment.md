...
type: reference
domain: sccm
slug: osd-prepare-for-operating-system-deployment
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/prepare-for-operating-system-deployment
family: osd
documentKind: "install-set-up-deploy"
abstract: "Learn about how to prepare for operating system deployments in Configuration Manager"
---

...
type: reference
domain: sccm
slug: apps-user-notifications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/plan-design/user-notifications
family: apps
documentKind: "article"
abstract: "Learn about the configurations to manage notifications to users about application deployments."
---

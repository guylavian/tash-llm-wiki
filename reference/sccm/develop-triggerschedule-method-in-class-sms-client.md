...
type: reference
domain: sccm
slug: develop-triggerschedule-method-in-class-sms-client
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/triggerschedule-method-in-class-sms_client
family: develop
documentKind: "reference"
abstract: "Trigger the client to run a specific schedule."
---

# TriggerSchedule Method

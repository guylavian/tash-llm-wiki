...
type: reference
domain: sccm
slug: osd-in-place-upgrade-recommendations
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/understand/in-place-upgrade-recommendations
family: osd
documentKind: "reference"
abstract: "Recommended steps for using the task sequence to upgrade Windows."
---

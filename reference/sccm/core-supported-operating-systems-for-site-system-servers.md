...
type: reference
domain: sccm
slug: core-supported-operating-systems-for-site-system-servers
tier: reference
...
abstract: "Learn which Windows versions you can use to host a Configuration Manager site or site system role."
---

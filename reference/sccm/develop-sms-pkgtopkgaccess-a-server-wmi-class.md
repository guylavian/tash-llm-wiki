...
type: reference
domain: sccm
slug: develop-sms-pkgtopkgaccess-a-server-wmi-class
tier: reference
...
abstract: "Learn how to relate an SMS Package Server class object with the SMS PackageAccessByUsers Server class object used to access its distribution points."
---

# SMS_PkgToPkgAccess_a Class

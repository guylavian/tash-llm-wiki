...
type: reference
domain: sccm
slug: develop-sms-cm-updatepackagefeatures-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_CM_UpdatePackageFeatures class in Configuration Manager to update feature extensions."
---

# SMS_CM_UpdatePackageFeatures Class

...
type: reference
domain: sccm
slug: develop-operating-system-deployment-views-configuration-manager
tier: reference
...
abstract: "Information about boot image packages, computer association state migrations, and operating system image packages."
---

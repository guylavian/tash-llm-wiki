...
type: reference
domain: sccm
slug: develop-requestlocks-method-in-class-sms-objectlock
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/misc/requestlocks-method-in-class-sms_objectlock
family: develop
documentKind: "reference"
abstract: "The RequestLocks Windows Management Instrumentation (WMI) class method, in Configuration Manager, synchronously acquires locks to edit multiple global objects."
---

...
type: reference
domain: sccm
slug: develop-operating-system-deployment-task-sequences-overview
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/operating-system-deployment-task-sequences-overview
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, a task sequence is a series of one or more task steps that can be advertised to Configuration Manager clients to run user-specified actions."
---

# OS Deployment Task Sequences Overview

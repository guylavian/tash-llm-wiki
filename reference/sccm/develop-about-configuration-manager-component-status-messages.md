...
type: reference
domain: sccm
slug: develop-about-configuration-manager-component-status-messages
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/manage/about-configuration-manager-component-status-messages
family: develop
documentKind: "concept-article"
abstract: "The message text for both the Configuration Manager components and the raw user-defined messages is contained in message DLLs."
---

# About Component Status Messages

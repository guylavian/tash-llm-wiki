...
type: reference
domain: sccm
slug: develop-createfromoem-method-in-class-sms-driver
tier: reference
...
abstract: "Creates a set of mass-storage SMS_Driver Server WMI Class objects referenced by the specified Txtsetup.oem file."
---

# CreateFromOEM Method

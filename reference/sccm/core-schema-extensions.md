...
type: reference
domain: sccm
slug: core-schema-extensions
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/network/schema-extensions
family: core
documentKind: "concept-article"
abstract: "Understand the benefits of extending the Active Directory schema to support Configuration Manager."
---

...
type: reference
domain: sccm
slug: develop-how-to-add-a-step-to-an-operating-system-deployment-group
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Add the step to the SMS_TaskSequenceGroup.Steps array property in Configuration Manager."
---

# Add a Step to an OS Deployment Group

...
type: reference
domain: sccm
slug: osd-using-task-sequence-variables
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/understand/using-task-sequence-variables
family: osd
documentKind: "how-to"
abstract: "Learn about how to use the variables in a Configuration Manager task sequence."
---

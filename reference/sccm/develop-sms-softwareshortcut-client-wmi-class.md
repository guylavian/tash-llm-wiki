...
type: reference
domain: sccm
slug: develop-sms-softwareshortcut-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/sms_softwareshortcut-client-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_SoftwareShortcut class is a client Windows Management Instrumentation class that defines a shortcut to executable files or a shortcut in a common system location."
---

# SMS_SoftwareShortcut Class

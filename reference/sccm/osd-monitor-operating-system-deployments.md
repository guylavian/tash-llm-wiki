...
type: reference
domain: sccm
slug: osd-monitor-operating-system-deployments
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/monitor-operating-system-deployments
family: osd
documentKind: "how-to"
abstract: "To help you to monitor operating system deployment objects, the Configuration Manager console provides alerts, reports, and various status indicators."
---

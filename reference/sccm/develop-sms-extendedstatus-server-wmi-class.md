...
type: reference
domain: sccm
slug: develop-sms-extendedstatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/misc/sms_extendedstatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The technical details of the SMS_ExtendedStatus server WMI class."
---

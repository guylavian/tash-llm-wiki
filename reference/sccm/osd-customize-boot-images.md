...
type: reference
domain: sccm
slug: osd-customize-boot-images
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/customize-boot-images
family: osd
documentKind: "how-to"
abstract: "Learn several ways to use Configuration Manager or the Deployment Image Servicing and Management (DISM) command-line tool to customize a boot image."
---

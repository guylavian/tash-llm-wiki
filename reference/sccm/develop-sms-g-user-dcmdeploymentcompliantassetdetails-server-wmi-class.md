...
type: reference
domain: sccm
slug: develop-sms-g-user-dcmdeploymentcompliantassetdetails-server-wmi-class
tier: reference
...
abstract: "The SMS_G_USER_DCMDeploymentCompliantAssetDetails Windows Management Instrumentation (WMI) class is an SMS Provider server class, in Configuration Manager, that represents compliant asset details for a deployment."
---

# SMS_G_USER_DCMDeploymentCompliantAssetDetails Class

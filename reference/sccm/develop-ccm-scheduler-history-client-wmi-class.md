...
type: reference
domain: sccm
slug: develop-ccm-scheduler-history-client-wmi-class
tier: reference
...
abstract: "A client Windows Management Instrumentation class that represents the history for a schedule."
---

# CCM_Scheduler_History Class

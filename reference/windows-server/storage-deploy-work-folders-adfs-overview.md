...
slug: storage-deploy-work-folders-adfs-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/work-folders/deploy-work-folders-adfs-overview
family: storage
documentKind: "install-set-up-deploy"
abstract: "Learn more about: Deploy Work Folders with AD FS and Web Application Proxy: Overview"
---

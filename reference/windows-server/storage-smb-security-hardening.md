...
slug: storage-smb-security-hardening
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/file-server/smb-security-hardening
family: storage
documentKind: "concept-article"
abstract: "Learn about SMB security enhancements that help harden your Windows Server 2025 environment and Windows 11 client devices."
---

# SMB security hardening in Windows Server and Windows Client

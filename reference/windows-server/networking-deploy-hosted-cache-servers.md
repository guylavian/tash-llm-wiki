...
slug: networking-deploy-hosted-cache-servers
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/branchcache/deploy/deploy-hosted-cache-servers
family: networking
documentKind: "how-to"
abstract: "Learn how to install and configure BranchCache hosted cache servers that are located in branch offices where you want to deploy BranchCache hosted cache mode."
---

...
slug: administration-set-context
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/set-context
family: administration
documentKind: "reference"
abstract: "Reference article for the set context command, which sets the context for shadow copy creation."
---

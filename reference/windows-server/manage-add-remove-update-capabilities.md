...
slug: manage-add-remove-update-capabilities
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/system-insights/add-remove-update-capabilities
family: manage
documentKind: "how-to"
abstract: "Learn how to add, remove, and update capabilities in System Insights to manage data collection and prediction features. Discover platform support and best practices."
---

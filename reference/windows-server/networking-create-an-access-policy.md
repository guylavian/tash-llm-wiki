...
slug: networking-create-an-access-policy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/ipam/Create-an-Access-Policy
family: networking
documentKind: "how-to"
abstract: "Learn how to create an access policy in the IPAM client console."
---

...
slug: networking-deploy-network-controller-failover-clustering
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/deploy/deploy-network-controller-failover-clustering
family: networking
documentKind: "how-to"
abstract: "Learn how to deploy Network Controller with Failover Clustering using SDN Express on Windows Server and Azure Local."
---

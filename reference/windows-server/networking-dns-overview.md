...
slug: networking-dns-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/dns-overview
family: networking
documentKind: "overview"
abstract: "Discover the role of DNS in Windows Server, from Active Directory integration to hosting public lookup zones, ensuring efficient name resolution."
---

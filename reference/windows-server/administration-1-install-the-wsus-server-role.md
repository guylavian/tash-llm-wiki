...
slug: administration-1-install-the-wsus-server-role
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-server-update-services/deploy/1-install-the-wsus-server-role
family: administration
documentKind: "how-to"
abstract: "Windows Server Update Service (WSUS) topic - Describes how to install the server role using Server Manager"
---

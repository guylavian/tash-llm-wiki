...
slug: manage-manage-virtualization-mode-virtual-machines
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/manage-virtualization-mode-virtual-machines
family: manage
documentKind: "how-to"
abstract: "Learn how to create, locate, view, power on, and live migrate virtual machines across Hyper-V hosts in Windows Admin Center Virtualization Mode."
---

# Manage virtual machines in Windows Admin Center Virtualization Mode (preview)

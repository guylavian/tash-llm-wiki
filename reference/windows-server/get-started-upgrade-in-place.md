...
slug: get-started-upgrade-in-place
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/upgrade-in-place
family: get-started
documentKind: "how-to"
abstract: "Learn how to upgrade Windows Server in place using installation media or Windows Update. Keep settings, server roles, and data intact."
---

# Upgrade Windows Server in Place

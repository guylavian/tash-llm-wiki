...
slug: storage-define-file-groups-for-screening
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/define-file-groups-for-screening
family: storage
documentKind: "how-to"
abstract: "This article describes how to define file groups to create a namespace for file screen, file screen exception, or files by file group storage reports"
---

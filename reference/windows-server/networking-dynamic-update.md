...
slug: networking-dynamic-update
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/dynamic-update
family: networking
documentKind: "concept-article"
abstract: "Learn about dynamic DNS updates in Windows and Windows Server, including how client and server computers update their DNS names, how secure dynamic update works, and how to resolve name conflicts."
---

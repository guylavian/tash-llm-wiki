...
slug: administration-add
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/add
family: administration
documentKind: "reference"
abstract: "Reference article for the add command, which adds volumes to the set of volumes that are to be shadow copied, or adds aliases to the alias environment."
---

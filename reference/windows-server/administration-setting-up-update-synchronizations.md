...
slug: administration-setting-up-update-synchronizations
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-server-update-services/manage/setting-up-update-synchronizations
family: administration
documentKind: "how-to"
abstract: "Windows Server Update Service (WSUS) topic - How to setup and configure Update Synchronizations"
---

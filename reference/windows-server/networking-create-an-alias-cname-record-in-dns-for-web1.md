...
slug: networking-create-an-alias-cname-record-in-dns-for-web1
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/server-certs/Create-an-Alias-CNAME-Record-in-DNS-for-WEB1
family: networking
documentKind: "how-to"
abstract: "Learn how to add an Alias canonical name (CNAME) resource record for your Web server to a zone in DNS on your domain controller."
---

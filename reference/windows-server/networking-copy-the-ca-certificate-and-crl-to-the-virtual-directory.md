...
slug: networking-copy-the-ca-certificate-and-crl-to-the-virtual-directory
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/server-certs/Copy-the-CA-Certificate-and-CRL-to-the-Virtual-Directory
family: networking
documentKind: "how-to"
abstract: "Learn how to copy the Certificate Revocation List and Enterprise root CA certificate from your certification authority to a virtual directory on your Web server, and to ensure that AD CS is configured correctly."
---

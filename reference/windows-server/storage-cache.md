...
slug: storage-cache
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/cache
family: storage
documentKind: "concept-article"
abstract: "How to read and write caching works to accelerate performance in Storage Spaces Direct."
---

# Understanding the storage pool cache in Azure Local and Windows Server clusters

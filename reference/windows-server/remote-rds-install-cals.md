...
slug: remote-rds-install-cals
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/rds-install-cals
family: remote
documentKind: "how-to"
abstract: "Learn how to install Remote Desktop Services client access licenses (CALs), ready to license your session hosts."
---

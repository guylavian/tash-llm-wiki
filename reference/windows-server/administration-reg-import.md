...
slug: administration-reg-import
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/reg-import
family: administration
documentKind: "reference"
abstract: "Reference article for the reg import command, which copies the contents of a file that contains exported registry subkeys, entries, and values into the registry of the local computer."
---

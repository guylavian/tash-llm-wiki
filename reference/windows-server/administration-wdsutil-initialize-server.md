...
slug: administration-wdsutil-initialize-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wdsutil-initialize-server
family: administration
documentKind: "reference"
abstract: "Reference article for wdsutil initialize-server, which configures a Windows Deployment Services server for initial use after the server role has been installed."
---

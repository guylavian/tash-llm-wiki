...
slug: get-started-get-started-with-windows-server-insiders-preview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/get-started-with-windows-server-insiders-preview
family: get-started
documentKind: "get-started"
abstract: "This article describes how users can become Windows Server Insiders members and test Windows Server Insiders Preview release builds."
---

...
slug: networking-qos-policy-errors
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/qos/qos-policy-errors
family: networking
documentKind: "error-reference"
abstract: "This topic provides a list of error and event messages for Quality of Service (QoS) Policy in Windows Server 2016."
---

...
slug: administration-wdsutil-add-drivergroup
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wdsutil-add-drivergroup
family: administration
documentKind: "reference"
abstract: "Reference article for the wdsutil add-drivergroup command, which adds a driver group to the server."
---

...
slug: networking-use-network-virtual-appliances-on-a-vn
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/manage/Use-Network-Virtual-Appliances-on-a-VN
family: networking
documentKind: "how-to"
abstract: "In this topic, you learn how to deploy network virtual appliances on tenant virtual networks. You can add network virtual appliances to networks that perform user-defined routing and port mirroring functions."
---

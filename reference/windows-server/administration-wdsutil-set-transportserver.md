...
slug: administration-wdsutil-set-transportserver
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wdsutil-set-transportserver
family: administration
documentKind: "reference"
abstract: "Reference article for Subcommand set-TransportServer, which sets configuration settings for a Transport Server."
---

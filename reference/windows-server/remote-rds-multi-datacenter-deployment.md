...
slug: remote-rds-multi-datacenter-deployment
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/rds-multi-datacenter-deployment
family: remote
documentKind: "how-to"
abstract: "Learn how to create an RDS deployment that uses multiple data centers to provide high availability across geographic locations."
---

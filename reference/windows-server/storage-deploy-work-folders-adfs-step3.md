...
slug: storage-deploy-work-folders-adfs-step3
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/work-folders/deploy-work-folders-adfs-step3
family: storage
documentKind: "install-set-up-deploy"
abstract: "Learn more about: Deploy Work Folders with AD FS and Web Application Proxy: Step 3, Set-up Work Folders"
---

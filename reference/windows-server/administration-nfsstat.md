...
slug: administration-nfsstat
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/nfsstat
family: administration
documentKind: "reference"
abstract: "Reference article for the nfsstat command, which displays statistical info about the Network File System (NFS) and Remote Procedure Call (RPC) calls."
---

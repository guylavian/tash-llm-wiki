...
slug: manage-use-azure-network-adapter
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/azure/use-azure-network-adapter
family: manage
documentKind: "how-to"
abstract: "This article provides requirements and steps on how to use Azure Network Adapter to connect a server to an Azure Virtual Network."
---

# Connect server to Azure Virtual Network - Azure Network Adapter

...
slug: administration-logman-create-api
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/logman-create-api
family: administration
documentKind: "reference"
abstract: "Reference article for the logman create api command, which creates an API-tracing data collector."
---

...
slug: administration-ksetup-addkpasswd
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/ksetup-addkpasswd
family: administration
documentKind: "reference"
abstract: "Reference article for the ksetup addkpasswd command, which adds a Kerberos password (kpasswd) server address for a realm."
---

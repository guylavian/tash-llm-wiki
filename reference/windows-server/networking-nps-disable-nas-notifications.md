...
slug: networking-nps-disable-nas-notifications
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-disable-nas-notifications
family: networking
documentKind: "how-to"
abstract: "Learn how to disable the forwarding of start and stop messages from network access servers to members of a remote RADIUS server group configured in NPS."
---

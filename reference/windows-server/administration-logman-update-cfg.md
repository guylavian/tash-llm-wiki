...
slug: administration-logman-update-cfg
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/logman-update-cfg
family: administration
documentKind: "reference"
abstract: "Reference article for the logman update cfg command, which updates the properties of an existing configuration data collector."
---

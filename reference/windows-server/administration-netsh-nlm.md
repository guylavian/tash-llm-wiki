...
slug: administration-netsh-nlm
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netsh-nlm
family: administration
documentKind: "reference"
abstract: "The netsh nlm command manages the Network Location Manager (NLM) settings to override network connection quality classification in Windows."
---

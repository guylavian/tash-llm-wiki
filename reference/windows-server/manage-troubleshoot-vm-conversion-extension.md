...
slug: manage-troubleshoot-vm-conversion-extension
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/use/troubleshoot-vm-conversion-extension
family: manage
documentKind: "troubleshooting"
abstract: "Resolve VMware to Hyper-V migration problems using the VM Conversion Extension. Diagnose and fix errors, stuck migrations, and network configuration problems."
---

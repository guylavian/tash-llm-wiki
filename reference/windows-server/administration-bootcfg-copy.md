...
slug: administration-bootcfg-copy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/bootcfg-copy
family: administration
documentKind: "reference"
abstract: "Reference article for the bootcfg copy command, which makes a copy of an existing boot entry, to which you can add command-line options."
---

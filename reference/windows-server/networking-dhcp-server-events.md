...
slug: networking-dhcp-server-events
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/dhcp/dhcp-server-events
family: networking
documentKind: "troubleshooting-general"
abstract: "View a summary of DHCP server events for operational, administrative, system, filter, and audit events."
---

# DHCP server events in Windows Server

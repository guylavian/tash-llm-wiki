...
slug: administration-setspn
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/setspn
family: administration
documentKind: "reference"
abstract: "The setspn command reads, modifies, and deletes the Service Principal Names (SPN) directory property for an Active Directory service account."
---

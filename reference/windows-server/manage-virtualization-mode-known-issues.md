...
slug: manage-virtualization-mode-known-issues
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/virtualization-mode-known-issues
family: manage
documentKind: "troubleshooting-known-issue"
abstract: "Track current known issues, limitations, causes, and workarounds for Windows Admin Center Virtualization Mode during preview."
---

# Known issues for Windows Admin Center Virtualization Mode (preview)

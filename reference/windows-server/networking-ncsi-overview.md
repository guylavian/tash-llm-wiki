...
slug: networking-ncsi-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/ncsi/ncsi-overview
family: networking
documentKind: "concept-article"
abstract: "The Network Connectivity Status Indicator (NCSI) helps to detect network connectivity and troubleshoot via network probing and passive polling."
---

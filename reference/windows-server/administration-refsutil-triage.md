...
slug: administration-refsutil-triage
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/refsutil-triage
family: administration
documentKind: "reference"
abstract: "Reference article for the refsutil triage tool, which ensures data integrity and consistency by scrubbing the directory contents or global tables on a ReFS (Resilient File System) volume in Windows."
---

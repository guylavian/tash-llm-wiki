...
slug: networking-nps-manage-export
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-manage-export
family: networking
documentKind: "how-to"
abstract: "You can use this topic to learn how to export a Network Policy Server configuration in Windows Server 2016."
---

...
slug: troubleshoot-dynamic-host-configuration-protocol-basics
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/troubleshoot/dynamic-host-configuration-protocol-basics
family: troubleshoot
documentKind: "troubleshooting"
abstract: "Learn more about: DHCP (Dynamic Host Configuration Protocol) Basics"
---

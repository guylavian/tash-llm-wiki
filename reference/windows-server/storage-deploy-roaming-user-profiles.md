...
slug: storage-deploy-roaming-user-profiles
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/folder-redirection/deploy-roaming-user-profiles
family: storage
documentKind: "install-set-up-deploy"
abstract: "Learn how to deploy roaming user profiles so that users receive the same operating system and application settings on multiple computers."
---

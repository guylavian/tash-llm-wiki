...
slug: administration-refsutil-streamsnapshot
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/refsutil-streamsnapshot
family: administration
documentKind: "reference"
abstract: "Reference article for the refsutil streamsnapshot tool, which manages Resilient File System (ReFS) data stream snapshots where you can create, delete, list, or compare snapshots in Windows."
---

...
slug: administration-rem
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/rem
family: administration
documentKind: "reference"
abstract: "Reference article for the rem command, which records comments in a script, batch, or config.sys file."
---

...
slug: administration-express-update-delivery-isv-support
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-server-update-services/deploy/express-update-delivery-isv-support
family: administration
documentKind: "how-to"
abstract: "Windows Server Update Service (WSUS) article - How Independent Software Vendors (ISV) can configure Express update delivery using WSUS"
---

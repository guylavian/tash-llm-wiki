...
slug: networking-add-a-dns-resource-record
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/ipam/Add-a-DNS-Resource-Record
family: networking
documentKind: "how-to"
abstract: "Learn how to add one or more new DNS resource records by using the IPAM client console."
---

...
slug: administration-winsat-mem
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/winsat-mem
family: administration
documentKind: "reference"
abstract: "Reference article for winsat mem command that tests system memory bandwidth using a process similar to the large memory-to-memory buffer copies in multimedia processing."
---

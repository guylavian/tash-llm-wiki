...
slug: administration-dcpromo
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/dcpromo
family: administration
documentKind: "reference"
abstract: "Learn about using the dcpromo command to install, promote, demote, and remove Active Directory Domain Services (AD DS) from a Windows Server."
---

# dcpromo in Windows Server

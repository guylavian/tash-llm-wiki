...
slug: manage-update-certificate
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/configure/update-certificate
family: manage
documentKind: "how-to"
abstract: "Learn how to update the HTTPS certificate used by Windows Admin Center, including PowerShell commands and steps to apply and activate the new certificate."
---

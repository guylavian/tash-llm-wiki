...
slug: administration-quser
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/quser
family: administration
documentKind: "reference"
abstract: "Reference article for the quser command, which displays information about user sessions on a Remote Desktop Session Host server."
---
...
- [query user command](query-user.md)

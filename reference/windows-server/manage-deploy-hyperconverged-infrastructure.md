...
slug: manage-deploy-hyperconverged-infrastructure
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/use/deploy-hyperconverged-infrastructure
family: manage
documentKind: "install-set-up-deploy"
abstract: "Learn how to deploy a hyperconverged infrastructure by using Windows Admin Center."
---
...
> [!IMPORTANT]
> Windows Admin Center doesn't support Azure Stack HCI OS deployment. To learn about deploying Azure Local infrastructure, see the [Azure Local documentation](/azure/azure-local/deploy/create-cluster).

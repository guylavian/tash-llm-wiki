...
slug: networking-aging-scavenging
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/aging-scavenging
family: networking
documentKind: "concept-article"
abstract: "Learn about DNS aging and scavenging in Windows Server, including prerequisites, terminology, and the aging and scavenging process for a sample record."
---

# DNS Aging and Scavenging in Windows Server

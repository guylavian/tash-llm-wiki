...
slug: failover-clustering-failover-cluster-accounts-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/failover-cluster-accounts-overview
family: failover-clustering
documentKind: "concept-article"
abstract: "Learn about the Active Directory accounts in Windows Server failover clusters, including cluster name objects, clustered services, permissions, and best management practices."
---

...
slug: storage-create-quota-template
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/create-quota-template
family: storage
documentKind: "how-to"
abstract: "This article describes how to create a quota template to define a storage space limit"
---

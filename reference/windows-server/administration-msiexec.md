...
slug: administration-msiexec
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/msiexec
family: administration
documentKind: "reference"
abstract: "Reference article for the msiexec command, which provides the means to install, modify, and perform operations on Windows Installer from the command line."
---

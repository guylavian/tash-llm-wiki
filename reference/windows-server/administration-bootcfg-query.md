...
slug: administration-bootcfg-query
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/bootcfg-query
family: administration
documentKind: "reference"
abstract: "Reference article for the bootcfg query command, which queries and displays the boot loader and operating system section entries from Boot.ini."
---

...
slug: storage-create-custom-file-management-task
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/create-custom-file-management-task
family: storage
documentKind: "how-to"
abstract: "This article describes how to create a custom file management task and custom tasks."
---

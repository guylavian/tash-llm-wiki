...
slug: networking-create-a-tenant-vm
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/manage/Create-a-Tenant-VM
family: networking
documentKind: "how-to"
abstract: "In this topic, we show you how to create a tenant VM and connect it to either a virtual network that you created with Hyper-V Network Virtualization or to a virtual Local Area Network (VLAN)."
---

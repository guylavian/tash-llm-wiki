...
slug: storage-folder-redirection-using-group-policy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/folder-redirection/folder-redirection-using-group-policy
family: storage
documentKind: "how-to"
abstract: "Learn how to configure Folder Redirection with Group Policy in Windows and Windows Server to manage user data efficiently"
---

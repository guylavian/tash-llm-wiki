...
slug: administration-scwcmd-configure
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/scwcmd-configure
family: administration
documentKind: "reference"
abstract: "Reference article for the scwcmd configure command, which applies a Security Configuration Wizard (SCW)-generated security policy to a computer."
---

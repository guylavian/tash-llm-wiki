...
slug: storage-create-classification-property
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/create-classification-property
family: storage
documentKind: "how-to"
abstract: "This article describes classification properties used to assign values to files within a specified folder or volume."
---

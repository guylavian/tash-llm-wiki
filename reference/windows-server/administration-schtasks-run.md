...
slug: administration-schtasks-run
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/schtasks-run
family: administration
documentKind: "reference"
abstract: "Reference article for the schtasks run command, which"
---

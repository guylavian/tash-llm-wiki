...
slug: manage-install
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/deploy/install
family: manage
documentKind: "install-set-up-deploy"
abstract: "Learn how to install Windows Admin Center on a Windows PC or on a server so that multiple users can access Windows Admin Center by using a web browser."
---

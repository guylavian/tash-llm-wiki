...
slug: storage-change-a-drive-letter
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/disk-management/change-a-drive-letter
family: storage
documentKind: "how-to"
abstract: "Change or assign a Windows drive letter to a drive by using the Change Drive Letter and Paths feature with the Disk Management utility in Windows."
---

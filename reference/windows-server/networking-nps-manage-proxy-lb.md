...
slug: networking-nps-manage-proxy-lb
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-manage-proxy-lb
family: networking
documentKind: "concept-article"
abstract: "Learn about NPS proxy server load balancing and the methods you can use to balance the load of connection requests sent to your NPSs."
---

...
slug: administration-netsh-bridge
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netsh-bridge
family: administration
documentKind: "reference"
abstract: "The netsh bridge command manages network adapter bridge settings to combine two or more network segments as one network in Windows."
---

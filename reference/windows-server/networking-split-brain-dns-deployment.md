...
slug: networking-split-brain-dns-deployment
tier: reference
...
abstract: "Learn how to configure DNS policy in Windows Server 2016 for split-brain DNS deployments, where there are two versions of a single zone - one for the internal users on your organization intranet, and one for the external users, who are typically users on the Internet."
---

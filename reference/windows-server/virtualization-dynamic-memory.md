...
slug: virtualization-dynamic-memory
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/dynamic-memory
family: virtualization
documentKind: "concept-article"
abstract: "Provides an overview of Dynamic Memory for Hyper-V virtual machines, including how it works and best practices."
---

# Dynamic Memory for Hyper-V Virtual Machines

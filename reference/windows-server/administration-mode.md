...
slug: administration-mode
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/mode
family: administration
documentKind: "reference"
abstract: "Reference article for the mode command, which displays system status, changes system settings, or reconfigures ports or devices."
---

...
slug: administration-netdom-verify
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netdom-verify
family: administration
documentKind: "reference"
abstract: "Netdom verify is a command-line utility that verifies the secure channel between a specified computer and a domain controller in Windows Server."
---

...
slug: administration-wbadmin-delete-catalog
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wbadmin-delete-catalog
family: administration
documentKind: "reference"
abstract: "Reference article for the wbadmin delete catalog command, which deletes the backup catalog that is stored on the local computer."
---

...
slug: administration-reg-load
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/reg-load
family: administration
documentKind: "reference"
abstract: "Reference article for the reg load command, which writes saved subkeys and entries into a different subkey in the registry."
---

...
slug: manage-create-azure-vms
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/azure/create-azure-vms
family: manage
documentKind: "install-set-up-deploy"
abstract: "Deploying Azure virtual machines with Windows Admin Center. Configuring Azure virtual machines as part of Windows Admin Center-managed scenarios."
---

# Deploy Azure Virtual Machines using Windows Admin Center

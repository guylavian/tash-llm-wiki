...
slug: storage-edit-quota-template-properties
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/edit-quota-template-properties
family: storage
documentKind: "how-to"
abstract: "This article describes how to edit quota template properties to extend changes to quotas created from the original quota template"
---

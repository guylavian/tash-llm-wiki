...
slug: administration-filter-sort-and-query-data-in-server-manager-tiles
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-manager/filter-sort-and-query-data-in-server-manager-tiles
family: administration
documentKind: "how-to"
abstract: "Learn how to use tiles in Server Manager to filter and sort data, and create and save custom queries."
---

...
slug: networking-create-a-user-role-for-access-control
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/ipam/Create-a-User-Role-for-Access-Control
family: networking
documentKind: "how-to"
abstract: "Learn how to create a new Access Control user role in the IPAM client console."
---

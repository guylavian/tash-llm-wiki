...
slug: administration-color
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/color
family: administration
documentKind: "reference"
abstract: "Reference article for the color command, which changes the foreground and background colors in the Command Prompt window for the current session."
---

...
slug: storage-storage-spaces-direct-in-vm
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/storage-spaces-direct-in-vm
family: storage
documentKind: "best-practice"
abstract: "How to deploy Storage Spaces Direct in a virtual machine guest cluster - for example, in Microsoft Azure."
---

# Using Storage Spaces Direct in a virtual machine

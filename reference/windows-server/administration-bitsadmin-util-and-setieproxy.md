...
slug: administration-bitsadmin-util-and-setieproxy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/bitsadmin-util-and-setieproxy
family: administration
documentKind: "reference"
abstract: "Reference article for the bitsadmin util and setieproxy command, which sets the proxy settings to use when transferring files using a service account."
---

...
slug: storage-create-a-dfs-namespace
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/dfs-namespaces/create-a-dfs-namespace
family: storage
documentKind: "how-to"
abstract: "Use"
---

# Create a DFS Namespace in Windows Server

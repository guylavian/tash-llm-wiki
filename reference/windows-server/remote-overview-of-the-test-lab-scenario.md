...
slug: remote-overview-of-the-test-lab-scenario
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/tlg-otp-securid/Overview-of-the-Test-Lab-Scenario
family: remote
documentKind: "concept-article"
abstract: "Learn about extending the Demonstrate DirectAccess Single Server Setup with Mixed IPv4 and IPv6 test lab guide to demonstrate a Remote Access one-time password (OTP) configuration."
---

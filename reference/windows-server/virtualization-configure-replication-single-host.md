...
slug: virtualization-configure-replication-single-host
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/configure-replication-single-host
family: virtualization
documentKind: "how-to"
abstract: "Learn how to configure replication for virtual machines going to single Hyper-V hosts using Hyper-V Replica."
---

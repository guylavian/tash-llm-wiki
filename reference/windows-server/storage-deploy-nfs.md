...
slug: storage-deploy-nfs
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/nfs/deploy-nfs
family: storage
documentKind: "install-set-up-deploy"
abstract: "Step-by-step guide to deploying NFS on Windows Server, including installation, authentication methods, and file share creation."
---

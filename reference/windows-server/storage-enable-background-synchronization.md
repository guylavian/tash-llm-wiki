...
slug: storage-enable-background-synchronization
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/folder-redirection/enable-background-synchronization
family: storage
documentKind: "how-to"
abstract: "Step-by-step guide to configured file synchronization on costed networks and optimize synchronization while roaming or near bandwidth limits."
---

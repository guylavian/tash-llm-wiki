...
slug: remote-tutorial-aovpn-deploy-create-certificates
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/tutorial-aovpn-deploy-create-certificates
family: remote
documentKind: "tutorial"
abstract: "Learn how to create certificate templates and enroll and validate certificates for users, VPN server, and NPS server to use with Always On VPN connections."
---

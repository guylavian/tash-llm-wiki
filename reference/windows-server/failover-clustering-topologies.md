...
slug: failover-clustering-topologies
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/topologies
family: failover-clustering
documentKind: "concept-article"
abstract: "Learn about the different failover cluster topologies available in Windows Server, including single rack, campus, stretch, and multi-cluster configurations."
---

...
slug: administration-create-and-manage-server-groups
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-manager/create-and-manage-server-groups
family: administration
documentKind: "how-to"
abstract: "Learn how to create custom, user-defined groups of servers in Server Manager in Windows Server."
---

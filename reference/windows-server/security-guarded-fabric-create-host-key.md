...
slug: security-guarded-fabric-create-host-key
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-create-host-key
family: security
documentKind: "how-to"
abstract: "Learn more about: Create a host key and add it to HGS"
---

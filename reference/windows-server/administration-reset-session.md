...
slug: administration-reset-session
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/reset-session
family: administration
documentKind: "reference"
abstract: "Reference article for reset session command, which enables you to reset a session on a Remote Desktop Session Host server."
---

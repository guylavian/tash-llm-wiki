...
slug: security-tls-registry-settings
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/tls/tls-registry-settings
family: security
documentKind: "how-to"
abstract: "Learn about supported registry setting information for the Windows implementation of the Transport Layer Security (TLS) protocol."
---

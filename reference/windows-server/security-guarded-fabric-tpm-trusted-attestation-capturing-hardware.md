...
slug: security-guarded-fabric-tpm-trusted-attestation-capturing-hardware
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-tpm-trusted-attestation-capturing-hardware
family: security
documentKind: "how-to"
abstract: "Learn more about: Authorize guarded hosts using TPM-based attestation"
---

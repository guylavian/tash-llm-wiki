...
slug: networking-understanding-usage-of-virtual-networks-and-vlans
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/manage/Understanding-Usage-of-Virtual-Networks-and-VLANs
family: networking
documentKind: "concept-article"
abstract: "In this topic, you learn about Hyper-V network virtualization virtual networks and how they differ from virtual local area networks (VLANs). With Hyper-V network virtualization, you create overlay virtual networks, also called virtual networks."
---

...
slug: administration-logman-create-alert
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/logman-create-alert
family: administration
documentKind: "reference"
abstract: "Reference article for the logman create alert command, which creates an alert data collector."
---

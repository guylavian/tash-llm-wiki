...
slug: administration-list
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/list
family: administration
documentKind: "reference"
abstract: "Reference article for the list command, which displays a list of disks, of partitions in a disk, of volumes in a disk, or of virtual hard disks (VHDs)."
---

...
slug: networking-core-network-guide
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/Core-Network-Guide
family: networking
documentKind: "how-to"
abstract: "This guide provides instructions on how to plan and deploy the core components required for a fully functioning network and a new Active Directory domain in a new forest with Windows Server 2016"
---

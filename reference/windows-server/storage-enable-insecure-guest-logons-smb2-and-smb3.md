...
slug: storage-enable-insecure-guest-logons-smb2-and-smb3
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/file-server/enable-insecure-guest-logons-smb2-and-smb3
family: storage
documentKind: "how-to"
abstract: "This article describes how to enable guest logons policy in SMB2 and SMB3 for Windows client and Windows Server devices using Group Policy and PowerShell."
---

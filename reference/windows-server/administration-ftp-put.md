...
slug: administration-ftp-put
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/ftp-put
family: administration
documentKind: "reference"
abstract: "Reference article for the ftp put command, which copies a local file to the remote computer using the current file transfer type."
---

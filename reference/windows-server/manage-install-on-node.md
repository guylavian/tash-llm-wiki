...
slug: manage-install-on-node
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/extend/guides/install-on-node
family: manage
documentKind: "install-set-up-deploy"
abstract: "Instructions about how to install extension payload on a managed node"
---

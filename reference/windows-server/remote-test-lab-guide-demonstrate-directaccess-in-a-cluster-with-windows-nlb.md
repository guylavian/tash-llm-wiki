...
slug: remote-test-lab-guide-demonstrate-directaccess-in-a-cluster-with-windows-nlb
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/tlg-cluster-nlb/Test-Lab-Guide-Demonstrate-DirectAccess-in-a-Cluster-with-Windows-NLB
family: remote
documentKind: "how-to"
abstract: "Learn how to extend the Demonstrate DirectAccess Single Server Setup with Mixed IPv4 and IPv6 test lab guide to demonstrate DirectAccess Network Load Balancing and cluster configuration."
---

...
slug: administration-reg-query
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/reg-query
family: administration
documentKind: "reference"
abstract: "Reference article for the reg query command, which returns a list of the next tier of subkeys and entries that are located under a specified subkey in the registry."
---

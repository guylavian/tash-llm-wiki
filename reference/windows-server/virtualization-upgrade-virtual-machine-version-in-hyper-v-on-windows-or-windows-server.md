...
slug: virtualization-upgrade-virtual-machine-version-in-hyper-v-on-windows-or-windows-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/deploy/Upgrade-virtual-machine-version-in-Hyper-V-on-Windows-or-Windows-Server
family: virtualization
documentKind: "upgrade-and-migration-article"
abstract: "Gives instructions and considerations for upgrading the version of a virtual machine"
---

...
slug: administration-autochk
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/autochk
family: administration
documentKind: "reference"
abstract: "Reference article for the autochk command, which runs when the computer is started and prior to Windows Server starting to verify the logical integrity of a file system."
---

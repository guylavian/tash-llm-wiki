...
slug: administration-inactive
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/inactive
family: administration
documentKind: "reference"
abstract: "Reference article for the inactive command, which marks the system partition or boot partition with focus as inactive on basic master boot record (MBR) disks."
---

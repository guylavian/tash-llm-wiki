...
slug: remote-step-5-configure-dc1
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/tlg-multisite/STEP-5-Configure-DC1
family: remote
documentKind: "how-to"
abstract: "Learn how to configure the default gateway on the domain controller, create security groups for Windows 7 DirectAccess clients on DC1, and add a new AD DS site."
---

...
slug: administration-auditpol-set
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/auditpol-set
family: administration
documentKind: "reference"
abstract: "Reference article for the auditpol set command, which sets the per-user audit policy, system audit policy, or auditing options."
---

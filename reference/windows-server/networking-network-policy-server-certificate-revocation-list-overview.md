...
slug: networking-network-policy-server-certificate-revocation-list-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/network-policy-server-certificate-revocation-list-overview
family: networking
documentKind: "concept-article"
abstract: "This article provides information about Certificate Revocation handling by the NPS (Network Policy Server) in a Windows Server environment."
---

# Network Policy Server Certificate Revocation List overview in Windows Server

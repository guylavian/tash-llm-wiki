...
slug: manage-extension-release-notes
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/azure/extension-release-notes
family: manage
documentKind: "overview"
abstract: "This article has release notes for the Windows Admin Center agent for Windows Admin Center in Azure."
---
...
- Fixed an issue where expected fields like filename or script name aren't logged in event logs, even though the action itself is recorded.

...
slug: manage-high-availability
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/deploy/high-availability
family: manage
documentKind: "install-set-up-deploy"
abstract: "Deploy Windows Admin Center with high availability (Project Honolulu)."
---

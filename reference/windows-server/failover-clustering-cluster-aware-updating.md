...
slug: failover-clustering-cluster-aware-updating
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/cluster-aware-updating
family: failover-clustering
documentKind: "overview"
abstract: "Cluster-Aware Updating (CAU) automates software update installation on clusters running Windows Server."
---

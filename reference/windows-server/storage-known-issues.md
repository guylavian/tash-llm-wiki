...
slug: storage-known-issues
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-migration-service/known-issues
family: storage
documentKind: "troubleshooting-known-issue"
abstract: "Known issues and troubleshooting support for Storage Migration Service, such as how to collect logs for Microsoft Support."
---

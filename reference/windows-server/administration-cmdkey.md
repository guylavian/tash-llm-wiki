...
slug: administration-cmdkey
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/cmdkey
family: administration
documentKind: "reference"
abstract: "Reference article for the cmdkey command, which creates, lists, and deletes stored user names and passwords or credentials."
---

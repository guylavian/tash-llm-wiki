...
slug: remote-da-basic-configure-s2-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/single-server-wizard/da-basic-configure-s2-server
family: remote
documentKind: "how-to"
abstract: "Learn how to configure the client and server settings required for a basic DirectAccess deployment."
---

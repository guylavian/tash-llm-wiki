...
slug: virtualization-supported-linux-and-freebsd-virtual-machines-for-hyper-v-on-windows
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/Supported-Linux-and-FreeBSD-virtual-machines-for-Hyper-V-on-Windows
family: virtualization
documentKind: "concept-article"
abstract: "Lists the Linux and FreeBSD integration services and features included in each version."
---

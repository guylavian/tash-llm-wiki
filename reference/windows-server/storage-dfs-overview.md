...
slug: storage-dfs-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/dfs-namespaces/dfs-overview
family: storage
documentKind: "overview"
abstract: "This article describes DFS Namespaces, which is a role service in Windows Server enabling you to group shared folders located on different servers into one or more logically structured namespaces."
---

# DFS Namespaces overview in Windows Server

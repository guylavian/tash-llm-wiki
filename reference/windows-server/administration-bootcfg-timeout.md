...
slug: administration-bootcfg-timeout
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/bootcfg-timeout
family: administration
documentKind: "reference"
abstract: "Reference article for the bootcfg timeout command, which changes the operating system time-out value."
---

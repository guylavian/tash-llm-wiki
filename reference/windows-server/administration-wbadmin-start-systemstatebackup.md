...
slug: administration-wbadmin-start-systemstatebackup
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wbadmin-start-systemstatebackup
family: administration
documentKind: "reference"
abstract: "Reference article for the wbadmin start systemstatebackup command, which creates a system state backup of the local computer and stores it on the location specified."
---

...
slug: networking-manage-role-based-access-control-with-windows-powershell
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/ipam/Manage-Role-Based-Access-Control-with-Windows-PowerShell
family: networking
documentKind: "concept-article"
abstract: "Learn how to use IPAM to manage role based access control with Windows PowerShell."
---

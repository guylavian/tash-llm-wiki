...
slug: storage-iscsi-target-server-limits
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/iscsi/iscsi-target-server-limits
family: storage
documentKind: "limits-and-quotas"
abstract: "Learn more about: iSCSI Target Server Scalability Limits"
---

...
slug: administration-bitsadmin-examples
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/bitsadmin-examples
family: administration
documentKind: "reference"
abstract: "Examples showing how to use the bitsadmin tool to perform the most common tasks."
---

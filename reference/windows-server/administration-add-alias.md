...
slug: administration-add-alias
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/add-alias
family: administration
documentKind: "reference"
abstract: "Reference article for the add alias command, which adds aliases to the alias environment."
---

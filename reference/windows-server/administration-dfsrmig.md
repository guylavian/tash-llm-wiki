...
slug: administration-dfsrmig
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/dfsrmig
family: administration
documentKind: "reference"
abstract: "Reference article for the dfsrmig command, which migrates SYSvol replication from FRS to DFS Replication, provides information about the progress of the migration, and modifies AD DS objects to support the migration."
---

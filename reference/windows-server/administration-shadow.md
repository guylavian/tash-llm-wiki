...
slug: administration-shadow
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/shadow
family: administration
documentKind: "reference"
abstract: "Reference article for the shadow command, which enables you to remotely control an active session of another user on a Remote Desktop Session Host server."
---

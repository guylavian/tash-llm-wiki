...
slug: virtualization-integration-services-data-exchange
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/integration-services-data-exchange
family: virtualization
documentKind: "how-to"
abstract: "Learn how the Hyper-V Data Exchange (KVP) integration service lets you share small bits of metadata between a virtual machine and the Hyper-V host using key-value pairs."
---

...
slug: networking-enable-dns-over-https-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/enable-dns-over-https-server
family: networking
documentKind: "how-to"
abstract: "Secure DNS traffic with DNS over HTTPS (DoH) for DNS Server on Windows Server. Learn how to configure and verify DoH in this guide."
---

# Enable DNS over HTTPS in DNS Server on Windows Server

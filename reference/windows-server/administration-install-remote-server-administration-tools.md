...
slug: administration-install-remote-server-administration-tools
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/install-remote-server-administration-tools
family: administration
documentKind: "install-set-up-deploy"
abstract: "Learn about the available Remote Server Administration Tools (RSAT) and how to install, enable, and use RSAT on Windows Server and Windows 10 or 11 clients"
---

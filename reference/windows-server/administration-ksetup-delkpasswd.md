...
slug: administration-ksetup-delkpasswd
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/ksetup-delkpasswd
family: administration
documentKind: "reference"
abstract: "Reference article for the ksetup delkpasswd command, which removes a Kerberos password server (kpasswd) for a realm."
---

...
slug: storage-cluster-to-cluster-azure-one-region
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-replica/cluster-to-cluster-azure-one-region
family: storage
documentKind: "how-to"
abstract: "Learn how to use cluster-to-cluster Storage Replica in Windows Server for storage replication in the same region in Azure."
---

# Cluster-to-Cluster Replication in the Same Azure Region

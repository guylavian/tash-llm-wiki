...
slug: security-guarded-fabric-create-a-shielded-vm-template
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-create-a-shielded-vm-template
family: security
documentKind: "how-to"
abstract: "Learn more about: Create a Windows shielded VM template disk"
---

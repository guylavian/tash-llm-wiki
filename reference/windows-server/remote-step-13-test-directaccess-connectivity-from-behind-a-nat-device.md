...
slug: remote-step-13-test-directaccess-connectivity-from-behind-a-nat-device
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/tlg-multisite/STEP-13-Test-DirectAccess-Connectivity-from-Behind-a-NAT-Device
family: remote
documentKind: "how-to"
abstract: "Learn how to test Teredo connectivity and IP-HTTPS connectivity on both client computers."
---

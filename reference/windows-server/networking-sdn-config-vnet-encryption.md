...
slug: networking-sdn-config-vnet-encryption
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/vnet-encryption/sdn-config-vnet-encryption
family: networking
documentKind: "how-to"
abstract: "Learn how to create the encryption certificate, create the certificate credential, and configuring a virtual network for encryption."
---

# Configure Encryption for a Virtual Network

...
slug: get-started-whats-new-windows-server-2025
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/whats-new-windows-server-2025
family: get-started
documentKind: "whats-new"
abstract: "Learn about the features and enhancements in Windows Server 2025 that help to improve security, performance, and flexibility."
---

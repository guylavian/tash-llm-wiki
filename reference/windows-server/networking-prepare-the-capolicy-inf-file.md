...
slug: networking-prepare-the-capolicy-inf-file
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/server-certs/Prepare-the-CAPolicy-inf-File
family: networking
documentKind: "how-to"
abstract: "The CAPolicy.inf contains various settings that are used when installing the Active Directory Certification Service (AD CS) or when renewing the CA certificate."
---

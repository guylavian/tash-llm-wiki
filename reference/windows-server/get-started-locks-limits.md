...
slug: get-started-locks-limits
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/locks-limits
family: get-started
documentKind: "product-comparison"
abstract: "In this article, you can compare the operating system locks and limits across the different editions of Windows Server."
---

# Locks and limits in Windows Server

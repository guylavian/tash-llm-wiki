...
slug: administration-tasklist
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/tasklist
family: administration
documentKind: "reference"
abstract: "Reference article for the tasklist command, which displays a list of the processes running on the local or remote computer."
---

...
type: reference
domain: openshift
slug: nodes-4-22-nodes-nodes-managing-max-pods
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-nodes-managing-max-pods
version: 4.22
family: nodes
...
[role="_abstract"]
In OpenShift Container Platform, you can configure the number of pods that can run on a node based on the number of

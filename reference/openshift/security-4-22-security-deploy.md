...
type: reference
domain: openshift
slug: security-4-22-security-deploy
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/security-deploy
version: 4.22
family: security
...
The OpenShift Container Platform API manages signatures that use the `atomic` transport type.
...
as passwords, OpenShift Container Platform client configuration files, `dockercfg` files,

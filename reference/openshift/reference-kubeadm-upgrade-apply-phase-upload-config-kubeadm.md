...
type: reference
domain: openshift
slug: reference-kubeadm-upgrade-apply-phase-upload-config-kubeadm
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_upgrade/kubeadm_upgrade_apply_phase_upload-config_kubeadm
family: reference
documentKind: "doc"
---

...
type: reference
domain: openshift
slug: nodes-4-22-nodes-containers-port-forwarding
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-containers-port-forwarding
version: 4.22
family: nodes

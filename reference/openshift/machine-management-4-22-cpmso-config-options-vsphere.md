...
type: reference
domain: openshift
slug: machine-management-4-22-cpmso-config-options-vsphere
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/machine_management/cpmso-config-options-vsphere
version: 4.22
...
* Configuring {vmw-full} features for control plane machines
* Specifying multiple regions and zones for your cluster on {vmw-short}

...
type: reference
domain: openshift
slug: windows-containers-4-22-creating-windows-machineset-nutanix
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/windows_containers/creating-windows-machineset-nutanix
version: 4.22
...
* Understanding UEFI, Secure Boot, and TPM in the Virtualized Environment (Nutanix documenation)

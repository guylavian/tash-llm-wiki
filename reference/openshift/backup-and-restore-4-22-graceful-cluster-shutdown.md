...
type: reference
domain: openshift
slug: backup-and-restore-4-22-graceful-cluster-shutdown
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/backup_and_restore/graceful-cluster-shutdown
version: 4.22

...
type: reference
domain: openshift
slug: web-console-4-22-dynamic-plugin-example
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/web_console/dynamic-plugin-example
version: 4.22
family: web_console

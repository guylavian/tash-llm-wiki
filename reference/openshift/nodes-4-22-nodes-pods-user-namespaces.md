...
type: reference
domain: openshift
slug: nodes-4-22-nodes-pods-user-namespaces
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-pods-user-namespaces
version: 4.22
family: nodes
...
To check user namespaces support for storage options, see CSI drivers supported by OpenShift Container Platform.

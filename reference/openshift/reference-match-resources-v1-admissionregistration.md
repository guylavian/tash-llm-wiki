...
type: reference
domain: openshift
slug: reference-match-resources-v1-admissionregistration
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/definitions/match-resources-v1-admissionregistration
family: reference
documentKind: "doc"

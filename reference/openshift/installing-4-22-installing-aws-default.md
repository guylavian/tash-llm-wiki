...
type: reference
domain: openshift
slug: installing-4-22-installing-aws-default
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-aws-default
version: 4.22
family: installing
...
* Configuration and credential file settings ({aws-short} documentation)

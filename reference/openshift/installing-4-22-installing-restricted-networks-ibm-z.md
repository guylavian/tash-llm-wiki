---
title: "Installing a cluster with z/VM on {ibm-z-title} and {ibm-linuxone-title} in a disconnected environment"
type: reference
domain: openshift
slug: installing-4-22-installing-restricted-networks-ibm-z
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-restricted-networks-ibm-z
version: 4.22
family: installing

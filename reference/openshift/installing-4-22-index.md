---
title: "{product-title} installation overview"
type: reference
domain: openshift
slug: installing-4-22-index
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/index
version: 4.22
family: installing
...
An installer similar to the {ai-full}, but you must download the Agent-based Installer first. The Agent-based Installer is ideal for disconnected environments.
Bootstrap node::

---
title: "Configuring {gcp-full} features for control plane machines"
type: reference
domain: openshift
slug: machine-management-4-22-cpmso-supported-features-gcp
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/machine_management/cpmso-supported-features-gcp
version: 4.22
...
* What is Shielded VM? ({gcp-short} documentation)
* Secure Boot ({gcp-short} documentation)
* Virtual Trusted Platform Module (vTPM) ({gcp-short} documentation)
* Integrity monitoring ({gcp-short} documentation)

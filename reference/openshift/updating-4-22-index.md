---
title: "Updating clusters overview"
type: reference
domain: openshift
slug: updating-4-22-index
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/updating/index
version: 4.22
family: updating
...
With update channels, you can choose an update strategy. Update channels are specific to a minor version of OpenShift Container Platform. Update channels only control release selection and do not impact the version of the cluster that you install. The `openshift-install` binary file for a specific version of the OpenShift Container Platform always installs that minor version.

...
type: reference
domain: openshift
slug: backup-and-restore-4-22-overriding-kopia-algorithms
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/backup_and_restore/overriding-kopia-algorithms
version: 4.22

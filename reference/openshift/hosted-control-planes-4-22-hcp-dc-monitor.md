...
type: reference
domain: openshift
slug: hosted-control-planes-4-22-hcp-dc-monitor
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/hosted_control_planes/hcp-dc-monitor
version: 4.22
...
[role="_abstract"]
If you installed {mce-short} on OpenShift Container Platform clusters that are not connected to the internet, when you try to run the user workload monitoring feature, it might fail with an error.

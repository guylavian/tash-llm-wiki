...
type: reference
domain: openshift
slug: reference-serversidefieldvalidation
tier: reference
source: https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/ServerSideFieldValidation
family: reference
documentKind: "doc"
---

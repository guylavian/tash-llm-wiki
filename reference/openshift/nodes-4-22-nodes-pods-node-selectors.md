...
type: reference
domain: openshift
slug: nodes-4-22-nodes-pods-node-selectors
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-pods-node-selectors
version: 4.22
family: nodes

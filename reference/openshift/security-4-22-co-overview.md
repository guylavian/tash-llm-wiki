...
type: reference
domain: openshift
slug: security-4-22-co-overview
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/co-overview
version: 4.22
family: security
...
The OpenShift Container Platform Compliance Operator assists users by automating the
...
Compliance
Operator release notes. For more information on compliance support for all Red{nbsp}Hat products, see Product Compliance.

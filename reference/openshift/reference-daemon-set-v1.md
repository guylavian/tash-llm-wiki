...
type: reference
domain: openshift
slug: reference-daemon-set-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/apps/daemon-set-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>conditions</code><br/><em><a href="{{< ref "#DaemonSetCondition" >}}">DaemonSetCondition array</a></em><br/><em>patch strategy: merge on key <code>type</code></em></td>

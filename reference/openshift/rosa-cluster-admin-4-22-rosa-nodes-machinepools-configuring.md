---
title: "Configuring machine pools in Local Zones"
type: reference
domain: openshift
slug: rosa-cluster-admin-4-22-rosa-nodes-machinepools-configuring
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/rosa_cluster_admin/rosa-nodes-machinepools-configuring
version: 4.22
...
This document describes how to configure Local Zones in machine pools with OpenShift Container Platform.
...
[IMPORTANT]
====
AWS Local Zones are supported on OpenShift Container Platform 4.12. See the Red{nbsp}Hat Knowledgebase article for information on how to enable Local Zones.
====
.Prerequisites

* OpenShift Container Platform is generally available in the parent region of choice. See the AWS generally available locations list to determine the Local Zone available to specific AWS regions.
* The OpenShift Container Platform cluster was initially built in an existing Amazon VPC (BYO-VPC).
* The maximum transmission unit (MTU) for the OpenShift Container Platform cluster is set at 1200.
+
[IMPORTANT]
====
Generally, the Maximum Transmission Unit (MTU) between an Amazon EC2 instance in a Local Zone and an Amazon EC2 instance in the Region is 1300. See How Local Zones work in the AWS documentation.

...
type: reference
domain: openshift
slug: disconnected-4-22-index-2
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/disconnected/index
version: 4.22
family: disconnected
...
This section covers mirroring OpenShift Container Platform images, managing an OpenShift Update Service, and performing cluster updates in a disconnected environment.

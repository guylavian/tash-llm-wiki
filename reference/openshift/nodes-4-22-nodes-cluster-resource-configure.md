...
type: reference
domain: openshift
slug: nodes-4-22-nodes-cluster-resource-configure
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-cluster-resource-configure
version: 4.22
family: nodes

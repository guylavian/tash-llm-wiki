...
type: reference
domain: openshift
slug: observability-4-22-cluster-logging-configuring
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/cluster-logging-configuring
version: 4.22

---
title: "Introduction to OpenShift Container Platform"
type: reference
domain: openshift
slug: welcome-4-22-ocp-overview
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/welcome/ocp-overview
version: 4.22
family: welcome
...
OpenShift Container Platform utilises a number of computing resources, known as nodes. A node has a lightweight, secure operating system based on {op-system-base-full}, known as {op-system-first}.

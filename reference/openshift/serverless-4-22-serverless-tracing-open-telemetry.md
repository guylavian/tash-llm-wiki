---
title: "Using Red Hat OpenShift distributed tracing"
type: reference
domain: openshift
slug: serverless-4-22-serverless-tracing-open-telemetry
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/serverless-tracing-open-telemetry
version: 4.22
family: serverless
...
* You have installed {DTProductName} by following the OpenShift Container Platform "Installing distributed tracing" documentation.

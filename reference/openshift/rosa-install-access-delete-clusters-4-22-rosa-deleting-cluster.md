...
type: reference
domain: openshift
slug: rosa-install-access-delete-clusters-4-22-rosa-deleting-cluster
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/rosa_install_access_delete_clusters/rosa-deleting-cluster
version: 4.22
...
[role="_abstract"]
Delete a OpenShift Container Platform cluster using the {rosa-cli}.

---
title: "Connecting an application to a service using the Developer perspective"
type: reference
domain: openshift
slug: applications-4-22-odc-connecting-an-application-to-a-service-using-the-developer-perspective
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/applications/odc-connecting-an-application-to-a-service-using-the-developer-perspective
version: 4.22
family: applications

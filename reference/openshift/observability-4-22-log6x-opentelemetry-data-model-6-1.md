...
type: reference
domain: openshift
slug: observability-4-22-log6x-opentelemetry-data-model-6-1
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/log6x-opentelemetry-data-model-6.1
version: 4.22

---
title: "Configuring metrics for user workload monitoring"
type: reference
domain: openshift
slug: observability-4-22-configuring-metrics-uwm
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/configuring-metrics-uwm
version: 4.22
...
* PodMonitor API
* ServiceMonitor API
* Scrape Prometheus metrics using TLS in ServiceMonitor configuration (Red{nbsp}Hat Customer Portal)

...
type: reference
domain: openshift
slug: authentication-4-22-configuring-internal-oauth
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/authentication/configuring-internal-oauth
version: 4.22
...
`spec.tokenConfig.accessTokenInactivityTimeout`:: Specifies the token inactivity timeout with appropriate units, for example `400s` for 400 seconds, or `30m` for 30 minutes. The minimum allowed timeout value is `300s`.
...
authentication   .0    True        False         False      145m
----
...
----
NAME             VERSION   AVAILABLE   PROGRESSING   DEGRADED   SINCE
kube-apiserver   .0     True        False         False      145m
----
+

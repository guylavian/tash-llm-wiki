...
type: reference
domain: openshift
slug: nodes-4-22-nodes-cma-autoscaling-custom-trigger
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-cma-autoscaling-custom-trigger
version: 4.22
family: nodes

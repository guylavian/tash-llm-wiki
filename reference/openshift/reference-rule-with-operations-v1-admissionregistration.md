...
type: reference
domain: openshift
slug: reference-rule-with-operations-v1-admissionregistration
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/definitions/rule-with-operations-v1-admissionregistration
family: reference
documentKind: "doc"

---
title: "Tutorial: Using AWS Controllers for Kubernetes on {product-title}"
type: reference
domain: openshift
slug: cloud-experts-tutorials-4-22-cloud-experts-using-aws-ack
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/cloud_experts_tutorials/cloud-experts-using-aws-ack
version: 4.22
...
= Tutorial: Using AWS Controllers for Kubernetes on OpenShift Container Platform

[role="_abstract"]
AWS Controllers for Kubernetes (ACK) lets you define and use AWS service resources directly from OpenShift Container Platform. With ACK, you can take advantage of AWS-managed services for your applications without needing to define resources outside of the cluster or run services that provide supporting capabilities such as databases or message queues within the cluster.

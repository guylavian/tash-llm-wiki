...
type: reference
domain: openshift
slug: security-4-22-zero-trust-manager-spire-federation
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/zero-trust-manager-spire-federation
version: 4.22
family: security
...
* You have installed the {cert-manager-operator}. For more information, see cert-manager Operator for Red Hat OpenShift.

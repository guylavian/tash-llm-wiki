...
type: reference
domain: openshift
slug: networking-4-22-about-ptp
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/networking/about-ptp
version: 4.22
family: networking
...
= Overview of linuxptp and gpsd in OpenShift Container Platform nodes

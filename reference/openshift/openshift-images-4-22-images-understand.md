---
title: "Understanding containers, images, and image streams"
type: reference
domain: openshift
slug: openshift-images-4-22-images-understand
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/openshift_images/images-understand
version: 4.22
...
[role="_abstract"]
Containers, images, and image streams are core concepts in OpenShift Container Platform that you must understand when creating and managing containerized software.
...
Registries contain a collection of one or more image repositories, which contain one or more tagged images. Red{nbsp}Hat provides a registry at registry.redhat.io for subscribers. OpenShift Container Platform can also supply its own {product-registry} for managing custom container images.

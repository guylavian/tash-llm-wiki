...
type: reference
domain: openshift
slug: security-4-22-security-registries
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/security-registries
version: 4.22
family: security
...
See the Red Hat Product Security Center for details on security updates and vulnerabilities related to Red Hat software. Check out Red Hat Security Advisories
...
OpenShift Container Platform also supports integration with other private registries that you might already be using, such as {quay}.
...
Ongoing integration of {quay} with OpenShift Container Platform continues,

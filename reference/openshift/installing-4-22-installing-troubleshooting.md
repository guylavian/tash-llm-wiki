...
type: reference
domain: openshift
slug: installing-4-22-installing-troubleshooting
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-troubleshooting
version: 4.22
family: installing
...
[NOTE]
====
If your OpenShift Container Platform installation fails and the debug output or logs contain network timeouts or other connectivity errors, review the guidelines "Configuring your firewall" in the _Additional resources_ section. By gathering logs from your firewall and load balancer, you can diagnose network-related errors.
====
...
[IMPORTANT]
====
By default, SSH access to the OpenShift Container Platform nodes is disabled on the {rh-openstack-first} based installations.
====
...
. Follow the procedure for installing a new OpenShift Container Platform cluster.

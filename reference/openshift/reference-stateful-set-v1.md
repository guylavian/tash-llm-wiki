...
type: reference
domain: openshift
slug: reference-stateful-set-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/apps/stateful-set-v1
family: reference
documentKind: "doc"
abstract: "StatefulSet represents a set of pods with consistent identities. Identities are defined as:\\n - Network: A single stable DNS and hostname.\\n - Storage: As many VolumeClaims as requested.\\n\\nThe StatefulSet guarantees that a given network identity will always map to the same storage identity."
---

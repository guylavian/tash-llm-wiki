...
type: reference
domain: openshift
slug: backup-and-restore-4-22-oadp-usecase-enable-ca-cert
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/backup_and_restore/oadp-usecase-enable-ca-cert
version: 4.22

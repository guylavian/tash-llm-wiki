...
type: reference
domain: openshift
slug: reference-storage-class-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/storage/storage-class-v1
family: reference
documentKind: "doc"
abstract: "StorageClass describes the parameters for a class of storage for which PersistentVolumes can be dynamically provisioned.\\n\\nStorageClasses are non-namespaced; the name of the storage class according to etcd is in ObjectMeta.Name."
---
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>allowedTopologies</code><br/><em><a href="{{< ref "#TopologySelectorTerm" >}}">TopologySelectorTerm array</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "storage-class-v1#StorageClass" >}}">StorageClass array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>matchLabelExpressions</code><br/><em><a href="{{< ref "#TopologySelectorLabelRequirement" >}}">TopologySelectorLabelRequirement array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "storage-class-v1#StorageClass" >}}">StorageClass</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "storage-class-v1#StorageClassList" >}}">StorageClassList</a></em></td>
    </tr>
  </tbody>
</table>

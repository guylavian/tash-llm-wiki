...
type: reference
domain: openshift
slug: reference-kubeadm-upgrade-apply-phase-upload-config-all
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_upgrade/kubeadm_upgrade_apply_phase_upload-config_all
family: reference
documentKind: "doc"
---

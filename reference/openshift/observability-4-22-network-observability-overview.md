...
type: reference
domain: openshift
slug: observability-4-22-network-observability-overview
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/network-observability-overview
version: 4.22
...
AMQ Streams Operator:: Kafka provides scalability, resiliency and high availability in the OpenShift Container Platform cluster for large scale deployments.
+
[NOTE]
====

...
type: reference
domain: openshift
slug: nodes-4-22-nodes-cluster-worker-latency-profiles
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-cluster-worker-latency-profiles
version: 4.22
family: nodes

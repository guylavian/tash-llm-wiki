...
type: reference
domain: openshift
slug: observability-4-22-network-observability-operator-release-notes
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/network-observability-operator-release-notes
version: 4.22
...
* RHSA-2026:24473 Network Observability Operator 1.12

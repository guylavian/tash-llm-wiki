---
title: "Creating a compute machine set on {ibm-power-server-title}"
type: reference
domain: openshift
slug: machine-management-4-22-creating-machineset-ibm-power-vs
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/machine_management/creating-machineset-ibm-power-vs
version: 4.22

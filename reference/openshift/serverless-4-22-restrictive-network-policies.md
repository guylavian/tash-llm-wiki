---
title: "Restrictive network policies"
type: reference
domain: openshift
slug: serverless-4-22-restrictive-network-policies
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/restrictive-network-policies
version: 4.22
family: serverless

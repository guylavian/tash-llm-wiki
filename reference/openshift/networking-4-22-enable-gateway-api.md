...
type: reference
domain: openshift
slug: networking-4-22-enable-gateway-api
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/networking/enable-gateway-api
version: 4.22
family: networking

---
title: "Using Jaeger distributed tracing"
type: reference
domain: openshift
slug: serverless-4-22-serverless-tracing-jaeger
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/serverless-tracing-jaeger
version: 4.22
family: serverless
...
If you do not want to install all of the components of {DTProductName}, you can still use distributed tracing on OpenShift Container Platform with {ServerlessProductName}.

...
type: reference
domain: openshift
slug: reference-kubeadm-init-phase-upload-config
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_init/kubeadm_init_phase_upload-config
family: reference
documentKind: "doc"
---

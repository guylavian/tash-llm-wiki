...
type: reference
domain: openshift
slug: extensions-4-22-crd-upgrade-safety
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/extensions/crd-upgrade-safety
version: 4.22
family: extensions

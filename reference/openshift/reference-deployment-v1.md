...
type: reference
domain: openshift
slug: reference-deployment-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/apps/deployment-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>status</code><br/><em><a href="{{< ref "#DeploymentStatus" >}}">DeploymentStatus</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>strategy</code><br/><em><a href="{{< ref "deployment-v1#DeploymentStrategy" >}}">DeploymentStrategy</a></em><br/><em>patch strategy: retainKeys</em></td>
      <td>The deployment strategy to use to replace existing pods with new ones.</td>
    </tr>
    <tr>
      <td><code>strategy.rollingUpdate</code><br/><em><a href="{{< ref "deployment-v1#RollingUpdateDeployment" >}}">RollingUpdateDeployment</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>conditions</code><br/><em><a href="{{< ref "#DeploymentCondition" >}}">DeploymentCondition array</a></em><br/><em>patch strategy: merge on key <code>type</code></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "deployment-v1#Deployment" >}}">Deployment array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "deployment-v1#Deployment" >}}">Deployment</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "deployment-v1#DeploymentList" >}}">DeploymentList</a></em></td>
    </tr>
  </tbody>
</table>

...
type: reference
domain: openshift
slug: disconnected-4-22-about
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/disconnected/about
version: 4.22
family: disconnected
...
OpenShift Container Platform is designed to perform many automatic functions that depend on an internet connection, such as retrieving release images from a registry or retrieving update paths and recommendations for the cluster.
...
Although it is used throughout the OpenShift Container Platform documentation, _disconnected environment_ is a broad term that can refer to environments with various levels of internet connectivity.

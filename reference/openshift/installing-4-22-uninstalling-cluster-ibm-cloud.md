---
title: "Uninstalling a cluster on {ibm-cloud-title}"
type: reference
domain: openshift
slug: installing-4-22-uninstalling-cluster-ibm-cloud
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/uninstalling-cluster-ibm-cloud
version: 4.22
family: installing

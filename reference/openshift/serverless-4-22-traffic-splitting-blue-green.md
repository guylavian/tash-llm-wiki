---
title: "Rerouting traffic using blue-green strategy"
type: reference
domain: openshift
slug: serverless-4-22-traffic-splitting-blue-green
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/traffic-splitting-blue-green
version: 4.22
family: serverless

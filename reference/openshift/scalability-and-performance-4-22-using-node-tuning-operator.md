...
type: reference
domain: openshift
slug: scalability-and-performance-4-22-using-node-tuning-operator
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/scalability_and_performance/using-node-tuning-operator
version: 4.22
...
node-tuning   .1    True        False         True       60m     1/5 Profiles with bootcmdline conflict
----
+
...
// Note the issues with including profiles sharing the same ancestor: see BZ#1825882

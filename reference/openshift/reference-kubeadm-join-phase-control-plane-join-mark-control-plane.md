...
type: reference
domain: openshift
slug: reference-kubeadm-join-phase-control-plane-join-mark-control-plane
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_join/kubeadm_join_phase_control-plane-join_mark-control-plane
family: reference
documentKind: "doc"
---

...
type: reference
domain: openshift
slug: observability-4-22-network-observability-network-policy
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/network-observability-network-policy
version: 4.22

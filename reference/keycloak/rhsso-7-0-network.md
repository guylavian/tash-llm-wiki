---
title: "Chapter 6. Network Setup - Red Hat Single Sign-On 7.0 Server Installation and Configuration Guide"
type: reference
domain: keycloak
slug: rhsso-7-0-network
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.0/html/server_installation_and_configuration_guide/network
...
# Chapter 6. Network Setup - Red Hat Single Sign-On 7.0 Server Installation and Configuration Guide
...
There’s a lot more nifty options when setting up interface
definitions. See the the network interface chapter of the JBoss EAP Configuration Guide.
...
There’s a lot more nifty options when setting up socket-binding-group
definitions. See the the socket binding group chapter of the JBoss EAP Configuration Guide.
...
(it’s a child element of subsystem xmlns="urn:jboss:domain:undertow:
) and add:

---
title: "Chapter 3. Upgrading the Red Hat build of Keycloak server - Red Hat build of Keycloak 26.2 Upgrading Guide"
type: reference
domain: keycloak
slug: rhbk-26-2-upgrading
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.2/html/upgrading_guide/upgrading
...
Procedure
Download and extract rhbk-26.2.15.zip from the Red Hat build of Keycloak website.

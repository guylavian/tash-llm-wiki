---
title: "Chapter 3. Using operating modes - Red Hat Single Sign-On 7.6 Server Installation and Configuration Guide"
type: reference
domain: keycloak
slug: rhsso-7-6-operating-mode
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.6/html/server_installation_and_configuration_guide/operating-mode
...
Windows
> ...\bin\standalone.bat
In order to use Java SE 17 to run Red Hat Single Sign-On in standalone mode the configuration should be modified executing the bundled script enable-elytron-se17.cli
.
Linux/Unix
...
In order to use Java SE 17 to run Red Hat Single Sign-On in standalone clustered mode the configuration should be modified executing the bundled script enable-elytron-se17.cli
.
Linux/Unix
...
switch.
In order to use Java SE 17 to run Red Hat Single Sign-On in domain mode the configuration should be modified executing the bundled script enable-keycloak-se17-domain.cli
.
Linux/Unix

---
title: "Appendix A. Service and StatefulSet YAML configuration for Red Hat build of Keycloak - Red Hat Trusted Artifact Signer 1 Deployment Guide"
type: reference
domain: keycloak
slug: doc-service-and-statefulset-yaml-configuration-for-rhbk-deploy-4
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_trusted_artifact_signer/1/html/deployment_guide/service-and-statefulset-yaml-configuration-for-rhbk_deploy
...
# Appendix A. Service and StatefulSet YAML configuration for Red Hat build of Keycloak - Red Hat Trusted Artifact Signer 1 Deployment Guide

---
title: "Chapter 23. KafkaAuthorizationKeycloak schema reference - Red Hat Streams for Apache Kafka 3.2 Streams for Apache Kafka API Reference"
type: reference
domain: keycloak
slug: doc-type-kafkaauthorizationkeycloak-reference-6
tier: reference
...
The type KafkaAuthorizationKeycloak
has been deprecated. Please use KafkaAuthorizationCustom
instead.
Used in: KafkaClusterSpec
The type KafkaAuthorizationKeycloak is supported only in the Streams for Apache Kafka API version(s) v1beta2.
The type

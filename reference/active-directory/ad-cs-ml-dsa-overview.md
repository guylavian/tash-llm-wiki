...
slug: ad-cs-ml-dsa-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/ml-dsa-overview
family: ad-cs
documentKind: "overview"
abstract: "Learn about ML-DSA support in Active Directory Certificate Services (AD CS), including supported parameter sets, scenarios, and configuration guidance."
---

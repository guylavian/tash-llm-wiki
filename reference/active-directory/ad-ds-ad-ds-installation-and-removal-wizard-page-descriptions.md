...
slug: ad-ds-ad-ds-installation-and-removal-wizard-page-descriptions
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/deploy/AD-DS-Installation-and-Removal-Wizard-Page-Descriptions
family: ad-ds
documentKind: "concept-article"
abstract: "Find out about the Active Directory Domain Services Configuration Wizard pages that you use to promote a server to a domain controller and to demote a server."
---

# AD DS Configuration Wizard Page Descriptions

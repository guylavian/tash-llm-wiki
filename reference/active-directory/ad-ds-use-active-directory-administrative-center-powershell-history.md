...
slug: ad-ds-use-active-directory-administrative-center-powershell-history
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/get-started/adac/use-active-directory-administrative-center-powershell-history
family: ad-ds
documentKind: "how-to"
abstract: "Learn how to use the Windows PowerShell History Viewer in Active Directory Administrative Center to construct Windows PowerShell scripts."
---

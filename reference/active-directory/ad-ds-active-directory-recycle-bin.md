...
slug: ad-ds-active-directory-recycle-bin
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/get-started/adac/active-directory-recycle-bin
family: ad-ds
documentKind: "how-to"
abstract: "Learn how to enable Active Directory Recycle Bin and restore deleted objects in Active Directory Domain Services on Windows Server."
---

# Enable Active Directory Recycle Bin in Windows Server

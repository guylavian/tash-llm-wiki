...
slug: laps-laps-scenarios-windows-server-active-directory
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/laps/laps-scenarios-windows-server-active-directory
family: laps
documentKind: "how-to"
abstract: "See how to get started with Windows Local Administrator Password Solution (Windows LAPS) and Windows Server Active Directory."
---

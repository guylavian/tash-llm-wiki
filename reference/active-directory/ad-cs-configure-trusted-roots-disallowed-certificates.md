...
slug: ad-cs-configure-trusted-roots-disallowed-certificates
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/configure-trusted-roots-disallowed-certificates
family: ad-cs
documentKind: "how-to"
abstract: "Guidance on how to configure individual software updates for automatic daily Root Certificate Updates, including certificate trust lists (CTLs)"
---

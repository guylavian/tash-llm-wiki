...
slug: software-restriction-policies-determine-allow-deny-list-and-application-inventory-for-software-restriction-policies
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/software-restriction-policies/determine-allow-deny-list-and-application-inventory-for-software-restriction-policies
family: software-restriction-policies
documentKind: "concept-article"
abstract: "Learn how to create an allow and deny list for applications to be managed by Software Restriction Policies (SRP) beginning with Windows Server 2008 and Windows Vista."
---

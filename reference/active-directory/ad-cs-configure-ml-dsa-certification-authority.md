...
slug: ad-cs-configure-ml-dsa-certification-authority
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/configure-ml-dsa-certification-authority
family: ad-cs
documentKind: "how-to"
abstract: "Learn how to set up ML-DSA post-quantum certification authorities with AD CS in Windows Server 2025, including Root CA and Subordinate CA configuration."
---

# Configure a certification authority to use ML-DSA in Windows Server

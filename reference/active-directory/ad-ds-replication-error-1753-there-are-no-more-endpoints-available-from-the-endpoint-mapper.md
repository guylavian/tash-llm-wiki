...
slug: ad-ds-replication-error-1753-there-are-no-more-endpoints-available-from-the-endpoint-mapper
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/Replication-error-1753-There-are-no-more-endpoints-available-from-the-endpoint-mapper
family: ad-ds
documentKind: "troubleshooting-error-codes"
abstract: "Learn more about: Replication error 1753 There are no more endpoints available from the endpoint mapper"
---

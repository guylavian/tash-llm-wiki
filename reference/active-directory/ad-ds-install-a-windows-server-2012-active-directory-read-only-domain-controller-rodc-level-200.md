...
slug: ad-ds-install-a-windows-server-2012-active-directory-read-only-domain-controller-rodc-level-200
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/deploy/RODC/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-
family: ad-ds
documentKind: "install-set-up-deploy"
abstract: "This article explains how to create a staged RODC account and then attach a server to that account during RODC installation. This article also explains how to install an RODC without performing a staged installation."
---

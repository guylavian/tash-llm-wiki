...
slug: ad-ds-support-for-using-hyper-v-replica-for-virtualized-domain-controllers
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/get-started/virtual-dc/Support-for-using-Hyper-V-Replica-for-virtualized-domain-controllers
family: ad-ds
documentKind: "concept-article"
abstract: "Learn more about: Support for using Hyper-V Replica for virtualized domain controllers"
---

...
slug: ad-ds-understand-service-accounts
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/understand-service-accounts
family: ad-ds
documentKind: "concept-article"
abstract: "Learn about sMSA, gMSA, dMSA, and virtual accounts in Windows Server Active Directory."
---

# Service Accounts in Windows Server

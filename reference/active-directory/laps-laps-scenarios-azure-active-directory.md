...
slug: laps-laps-scenarios-azure-active-directory
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/laps/laps-scenarios-azure-active-directory
family: laps
documentKind: "get-started"
abstract: "Learn how to get started with Windows Local Administrator Password Solution (Windows LAPS) and Microsoft Entra ID."
---

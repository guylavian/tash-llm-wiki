...
slug: ad-ds-ad-forest-recovery-raise-rid-pool
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/forest-recovery-guide/ad-forest-recovery-raise-rid-pool
family: ad-ds
documentKind: "how-to"
abstract: "Learn more about: AD Forest Recovery - Raising the value of available RID pools"
---

# AD Forest Recovery - Raising RID pools

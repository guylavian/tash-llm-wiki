...
slug: ad-ds-manage-group-managed-service-accounts
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/group-managed-service-accounts/group-managed-service-accounts/manage-group-managed-service-accounts
family: ad-ds
documentKind: "how-to"
abstract: "Learn how to manage and use Group Managed Service Accounts (gMSA) in Windows Server."
---

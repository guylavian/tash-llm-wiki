...
type: reference
domain: powershell
slug: odps-remove-onpremisesorganization
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-OnPremisesOrganization
family: odps
documentKind: "doc"
---
...
## DESCRIPTION
Removing an OnPremisesOrganization object should only be used in circumstances where the hybrid deployment state is corrupt and under the direction and supervision of Microsoft Customer Service and Support. After removing the OnPremisesOrganization object, any related hybrid deployment configured with this object aren't functional and need to be re-created and reconfigured.

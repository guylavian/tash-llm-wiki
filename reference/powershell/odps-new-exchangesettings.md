...
type: reference
domain: powershell
slug: odps-new-exchangesettings
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-ExchangeSettings
family: odps
documentKind: "doc"
---
...
```
New-ExchangeSettings [-Name] <String>
 [-Confirm]
...
### Example 1
```powershell
New-ExchangeSettings -Name Audit
```

This example creates a new Exchange settings object for the Audit configuration schema. After you create the Exchange settings object, use the Set-ExchangeSettings cmdlet to define the settings.

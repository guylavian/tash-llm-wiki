...
type: reference
domain: powershell
slug: odps-new-fileplanpropertycategory
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-FilePlanPropertyCategory
family: odps
documentKind: "doc"
---
...
Use the New-FilePlanPropertyCategory cmdlet to create file plan property categories.
...
```
New-FilePlanPropertyCategory [-Name] <String>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
### Example 1
```powershell
New-FilePlanPropertyCategory -Name "Contoso Category"
```

This example creates a new file plan property category named Contoso Category.

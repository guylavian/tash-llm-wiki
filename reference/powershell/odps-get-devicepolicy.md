...
type: reference
domain: powershell
slug: odps-get-devicepolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-DevicePolicy
family: odps
documentKind: "doc"
---
...
Use the Get-DevicePolicy cmdlet to view all types of Basic Mobility and Security policies in Microsoft 365.
...
```
Get-DevicePolicy [[-Identity] <PolicyIdParameter>]
 [<CommonParameters>]
```

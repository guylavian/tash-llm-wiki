...
type: reference
domain: powershell
slug: odps-set-clientaccessarray
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-ClientAccessArray
family: odps
documentKind: "doc"
---

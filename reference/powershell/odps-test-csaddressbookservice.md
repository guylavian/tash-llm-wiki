...
type: reference
domain: powershell
slug: odps-test-csaddressbookservice
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/skype/skype-ps/SkypeForBusiness/Test-CsAddressBookService
family: odps
documentKind: "doc"
---
...
```yaml
Type: String
Parameter Sets: ClientPlatform, TargetUri, ServerPlatform
Aliases: ua

...
type: reference
domain: powershell
slug: odps-get-emailaddresspolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-EmailAddressPolicy
family: odps
documentKind: "doc"
---

---
title: "Remove-AddressBookPolicy"
type: reference
domain: powershell
slug: odps-remove-addressbookpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-AddressBookPolicy
family: odps
documentKind: "doc"
---
...
Use the Remove-AddressBookPolicy cmdlet to delete an address book policy. You can't remove the address book policy if it's still assigned to a user's mailbox.
...
```
Remove-AddressBookPolicy [-Identity] <MailboxPolicyIdParameter>
 [-Confirm]

...
type: reference
domain: powershell
slug: odps-set-clientaccessserver
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-ClientAccessServer
family: odps
documentKind: "doc"
---

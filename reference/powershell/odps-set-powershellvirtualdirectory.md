...
type: reference
domain: powershell
slug: odps-set-powershellvirtualdirectory
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-PowerShellVirtualDirectory
family: odps
documentKind: "doc"
---
...
Use the Set-PowerShellVirtualDirectory cmdlet to modify existing Windows PowerShell virtual directories that are used in Internet Information Services (IIS) on Exchange servers.
...
- $true: TLS encryption is required to connect to the virtual directory. This value is the default.

---
title: "Remove-OutlookProvider"
type: reference
domain: powershell
slug: odps-remove-outlookprovider
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-OutlookProvider
family: odps
documentKind: "doc"
---
...
```
Remove-OutlookProvider [-Identity] <OutlookProviderIdParameter>
 [-Confirm]

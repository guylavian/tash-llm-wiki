...
type: reference
domain: powershell
slug: odps-remove-sensitiveinformationscan
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-SensitiveInformationScan
family: odps
documentKind: "doc"
---
...
```
Remove-SensitiveInformationScan [-Identity] <PolicyIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
### Example 1
```powershell
Remove-SensitiveInformationScan -Identity "HR Department"
```

This example removes the specified sensitive information scan.
...
The Identity parameter specifies the sensitive information scan that you want to remove. You can use any value that uniquely identifies the scan. For example:

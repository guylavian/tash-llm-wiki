...
type: reference
domain: powershell
slug: odps-add-mailboxpermission
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Add-MailboxPermission
family: odps
documentKind: "doc"
---

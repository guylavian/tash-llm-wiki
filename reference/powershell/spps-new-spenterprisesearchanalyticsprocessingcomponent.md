...
type: reference
domain: powershell
slug: spps-new-spenterprisesearchanalyticsprocessingcomponent
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-ps/Microsoft.SharePoint.Powershell/New-SPEnterpriseSearchAnalyticsProcessingComponent
family: spps
documentKind: "doc"
---
...
New-SPEnterpriseSearchAnalyticsProcessingComponent -SearchTopology $topology -SearchServiceInstance $si -SearchApplication $ssa
```

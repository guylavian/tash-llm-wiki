...
type: reference
domain: powershell
slug: spps-set-sppassphrase-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Set-SPPassPhrase
family: spps
documentKind: "doc"
---

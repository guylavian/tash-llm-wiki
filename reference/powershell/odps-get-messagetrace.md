...
type: reference
domain: powershell
slug: odps-get-messagetrace
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-MessageTrace
family: odps
documentKind: "doc"
---
...
If you enter a start date that is older than 10 days, you get an error and the command returns no results.
...
By default, this cmdlet returns a maximum of 1000 results, and times out on very large queries. If your query returns too many results, consider splitting it up using smaller StartDate and EndDate intervals.

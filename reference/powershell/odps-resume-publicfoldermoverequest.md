...
type: reference
domain: powershell
slug: odps-resume-publicfoldermoverequest
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Resume-PublicFolderMoveRequest
family: odps
documentKind: "doc"
---
...
Use the Resume-PublicFolderMoveRequest cmdlet to resume a public folder move request that is suspended or has failed.
...
```
Resume-PublicFolderMoveRequest [-Identity] <PublicFolderMoveRequestIdParameter>
 [-Confirm]

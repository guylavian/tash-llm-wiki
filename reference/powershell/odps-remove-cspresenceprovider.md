...
type: reference
domain: powershell
slug: odps-remove-cspresenceprovider
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/skype/skype-ps/SkypeForBusiness/Remove-CsPresenceProvider
family: odps
documentKind: "doc"
---
...
### None
The `Remove-CsPresenceProvider` cmdlet does not return a value or object.

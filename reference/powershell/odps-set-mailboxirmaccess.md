...
type: reference
domain: powershell
slug: odps-set-mailboxirmaccess
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-MailboxIRMAccess
family: odps
documentKind: "doc"
---

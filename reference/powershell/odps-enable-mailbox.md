...
type: reference
domain: powershell
slug: odps-enable-mailbox
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-Mailbox
family: odps
documentKind: "doc"
---
...
Use this switch only if you plan to migrate legacy Exchange 2010 public folders to Exchange 2016. If you use this switch but don't have legacy public folders to migrate, you can't create any public folders.

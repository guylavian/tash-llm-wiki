...
type: reference
domain: powershell
slug: odps-new-hostedcontentfilterpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-HostedContentFilterPolicy
family: odps
documentKind: "doc"
---
...
- Default: This value is the default. Currently, this value is the same as HighConfidencePhish.
- HighConfidencePhish
...
- Quarantine: Move the message to the quarantine. This value is the default. The quarantined message is available to the intended recipients (as of April, 2020) and admins.

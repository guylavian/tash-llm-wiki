...
type: reference
domain: powershell
slug: odps-new-mapivirtualdirectory
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-MapiVirtualDirectory
family: odps
documentKind: "doc"
---
...
This setting enforces the Transport Layer Security (TLS) protocol and uses the default TLS port. This parameter uses the syntax: `https://<Domain Name>/mapi`. For example, `https://external.contoso.com/mapi`.
...
This setting enforces the Transport Layer Security (TLS) protocol and uses the default TLS port. This parameter uses the syntax: `https://<Domain Name>/mapi`. For example, `https://internal.contoso.com/mapi`.

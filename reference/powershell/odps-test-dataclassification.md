...
type: reference
domain: powershell
slug: odps-test-dataclassification
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Test-DataClassification
family: odps
documentKind: "doc"
---
...
This parameter is available only in cloud-based environments.

{{ Fill DiagnosticPlatform Description }}
...
{{ Fill DiagnosticPurpose Description }}

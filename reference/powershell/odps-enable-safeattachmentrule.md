...
type: reference
domain: powershell
slug: odps-enable-safeattachmentrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-SafeAttachmentRule
family: odps
documentKind: "doc"
---
...
```
Enable-SafeAttachmentRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

...
type: reference
domain: powershell
slug: odps-enable-addresslistpaging
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-AddressListPaging
family: odps
documentKind: "doc"
---
...
```
Enable-AddressListPaging [-Confirm]

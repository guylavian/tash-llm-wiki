...
type: reference
domain: powershell
slug: odps-enable-transportrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-TransportRule
family: odps
documentKind: "doc"
---
...
```
Enable-TransportRule [-Identity] <RuleIdParameter>
 [-Confirm]
...
If you don't use this parameter, the value already set in the rule is persevered.

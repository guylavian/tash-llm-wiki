...
type: reference
domain: powershell
slug: odps-new-omeconfiguration
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-OMEConfiguration
family: odps
documentKind: "doc"
---
...
The Image parameter identifies and uploads an image that's displayed in the email message and in the Microsoft 365 admin center.

...
type: reference
domain: powershell
slug: odps-disable-pushnotificationproxy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Disable-PushNotificationProxy
family: odps
documentKind: "doc"
---
...
```
Disable-PushNotificationProxy [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

...
type: reference
domain: powershell
slug: odps-get-clientaccessserver
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-ClientAccessServer
family: odps
documentKind: "doc"
---

...
type: reference
domain: powershell
slug: odps-enable-safelinksrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-SafeLinksRule
family: odps
documentKind: "doc"
---
...
```
Enable-SafeLinksRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

---
title: "Remove-HostedOutboundSpamFilterRule"
type: reference
domain: powershell
slug: odps-remove-hostedoutboundspamfilterrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-HostedOutboundSpamFilterRule
family: odps
documentKind: "doc"
---
...
```
Remove-HostedOutboundSpamFilterRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
### Example 1
```powershell
Remove-HostedOutboundSpamFilterRule -Identity "Contoso Executives"
```

This example removes the outbound spam filter rule named Contoso Executives.
...
The Identity parameter specifies the outbound spam filter rule that you want to remove. You can use any value that uniquely identifies the rule. For example:

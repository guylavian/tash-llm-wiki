...
type: reference
domain: powershell
slug: odps-remove-supervisoryreviewpolicyv2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-SupervisoryReviewPolicyV2
family: odps
documentKind: "doc"
---
...
Use the Remove-SupervisoryReviewPolicyV2 cmdlet to remove supervisory review policies from the Microsoft Purview compliance portal.
...
```
Remove-SupervisoryReviewPolicyV2 [-Identity] <PolicyIdParameter>
 [-Confirm]
 [-ForceDeletion]
 [-WhatIf]
 [<CommonParameters>]

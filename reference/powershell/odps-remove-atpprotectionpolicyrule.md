...
type: reference
domain: powershell
slug: odps-remove-atpprotectionpolicyrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-ATPProtectionPolicyRule
family: odps
documentKind: "doc"
---
...
**Note**: Use this cmdlet to remove a rule only if you plan to immediately recreate the rule using the New-ATPProtectionPolicyRule cmdlet. The affected preset security policy doesn't function without a corresponding rule.

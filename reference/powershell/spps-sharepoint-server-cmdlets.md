...
type: reference
domain: powershell
slug: spps-sharepoint-server-cmdlets
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/docs-conceptual/sharepoint-server/sharepoint-server-cmdlets
family: spps
documentKind: "doc"
abstract: "Learn about the Microsoft.SharePoint.Powershell module, which contains cmdlets for managing SharePoint Server."
---

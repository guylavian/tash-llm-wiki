...
type: reference
domain: powershell
slug: odps-set-quarantinepolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-QuarantinePolicy
family: odps
documentKind: "doc"
---
...
- $false: Organization branding is disabled. The default Microsoft logo is used in quarantine notifications. This value is the default.

...
type: reference
domain: powershell
slug: odps-app-only-auth-powershell-v2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/app-only-auth-powershell-v2
family: odps
documentKind: "article"
abstract: "Learn how to configure app-only authentication (also known as certificate based authentication or CBA) using the Exchange Online PowerShell V3 module in scripts and other long-running tasks."
---

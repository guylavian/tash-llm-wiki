...
type: reference
domain: powershell
slug: spps-set-sploglevel-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Set-SPLogLevel
family: spps
documentKind: "doc"
---

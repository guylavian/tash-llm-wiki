...
type: reference
domain: powershell
slug: odps-connect-to-exchange-online-powershell
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/connect-to-exchange-online-powershell
family: odps
documentKind: "article"
abstract: "Learn how to use the Exchange Online PowerShell V3 module to connect to Exchange Online PowerShell with modern authentication and/or multifactor authentication (MFA)."
---

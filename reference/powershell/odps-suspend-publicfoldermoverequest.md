...
type: reference
domain: powershell
slug: odps-suspend-publicfoldermoverequest
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Suspend-PublicFolderMoveRequest
family: odps
documentKind: "doc"
---
...
```
Suspend-PublicFolderMoveRequest [-Identity] <PublicFolderMoveRequestIdParameter>
 [-Confirm]

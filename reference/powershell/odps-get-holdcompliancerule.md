...
type: reference
domain: powershell
slug: odps-get-holdcompliancerule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-HoldComplianceRule
family: odps
documentKind: "doc"
---
...
**Note**: The Get-HoldComplianceRule cmdlet is replaced by the Get-RetentionComplianceRule cmdlet. If you have scripts that use Get-HoldComplianceRule, update them to use Get-RetentionComplianceRule.

---
title: "Remove-OutlookProtectionRule"
type: reference
domain: powershell
slug: odps-remove-outlookprotectionrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-OutlookProtectionRule
family: odps
documentKind: "doc"
---
...
```
Remove-OutlookProtectionRule [-Identity] <RuleIdParameter>
 [-Confirm]
...
## DESCRIPTION
Outlook protection rules use an Active Directory Rights Management Services (AD RMS) rights template to automatically apply Information Rights Management (IRM) protection to messages before they're sent. For more information, see [Outlook protection rules](https://learn.microsoft.com/exchange/outlook-protection-rules-exchange-2013-help).

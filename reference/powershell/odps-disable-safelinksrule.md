...
type: reference
domain: powershell
slug: odps-disable-safelinksrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Disable-SafeLinksRule
family: odps
documentKind: "doc"
---
...
```
Disable-SafeLinksRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

...
type: reference
domain: powershell
slug: odps-set-deviceconfigurationpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-DeviceConfigurationPolicy
family: odps
documentKind: "doc"
---
...
Use the Set-DeviceConfigurationPolicy cmdlet to modify mobile device configuration policies in Basic Mobility and Security in Microsoft 365.
...
The Identity parameter specifies the mobile device configuration policy that you want to modify. You can use any value that uniquely identifies the policy. For example:

...
type: reference
domain: powershell
slug: odps-remove-clientaccessarray
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-ClientAccessArray
family: odps
documentKind: "doc"
---
...
```
Remove-ClientAccessArray [-Identity] <ClientAccessArrayIdParameter>
 [-Confirm]

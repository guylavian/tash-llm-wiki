---
title: "Active directory migration using ADMT trust relationship.Scenario: Windows active directory forest having multiple subdomain and tree. Forest Doman name is “company.com” and the sub domain name is NA.Company.com, AP.company.com and so on."
type: source
tier: community-qa
source: https://learn.microsoft.com/en-us/answers/questions/365726/active-directory-migration-using-admt-trust-relati
question_id: 365726
fetched: 2026-07-25
answer_count: 3
...
---
# Active directory migration using ADMT trust relationship.Scenario: Windows active directory forest having multiple subdomain and tree. Forest Doman name is “company.com” and the sub domain name is NA.Company.com, AP.company.com and so on.

> **Community Q&A (upstream).** Microsoft Q&A thread, not a Microsoft support statement.
> Accepted answers are frequently version-stale or wrong. Cite as
> `web:https://learn.microsoft.com/en-us/answers/questions/365726/active-directory-migration-using-admt-trust-relati (fetched 2026-07-25)` and verify against vendor documentation before relying on it.

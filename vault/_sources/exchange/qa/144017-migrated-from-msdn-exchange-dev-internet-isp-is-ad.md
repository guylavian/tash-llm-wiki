---
title: "[Migrated from MSDN Exchange Dev]internet ISP is added"
type: source
tier: community-qa
source: https://learn.microsoft.com/en-us/answers/questions/144017/migrated-from-msdn-exchange-dev-internet-isp-is-ad
question_id: 144017
fetched: 2026-07-25
answer_count: 1
...
---
# [Migrated from MSDN Exchange Dev]internet ISP is added

> **Community Q&A (upstream).** Microsoft Q&A thread, not a Microsoft support statement.
> Accepted answers are frequently version-stale or wrong. Cite as
> `web:https://learn.microsoft.com/en-us/answers/questions/144017/migrated-from-msdn-exchange-dev-internet-isp-is-ad (fetched 2026-07-25)` and verify against vendor documentation before relying on it.
...
therefore should we update the real IP for the second ISP somewhere to solve this problem , pls advise    

---
title: "Generate mail traffic Exchange Server 2016 from script"
type: source
tier: community-qa
source: https://learn.microsoft.com/en-us/answers/questions/217686/generate-mail-traffic-exchange-server-2016-from-sc
question_id: 217686
fetched: 2026-07-25
answer_count: 0
...
qa_tags: []
---
# Generate mail traffic Exchange Server 2016 from script

> **Community Q&A (upstream).** Microsoft Q&A thread, not a Microsoft support statement.
> Accepted answers are frequently version-stale or wrong. Cite as
> `web:https://learn.microsoft.com/en-us/answers/questions/217686/generate-mail-traffic-exchange-server-2016-from-sc (fetched 2026-07-25)` and verify against vendor documentation before relying on it.

## Question

Hello,  

I'm trying to generate some traffics inside my Exchange Organization. I'm learning Exchange.
...
$dllfolderpath = "C:\Program Files\Microsoft\Exchange\Web Services\2.2\Microsoft.Exchange.WebServices.dll"
...
$service = New-Object Microsoft.Exchange.WebServices.Data.ExchangeService("Exchange2013")
#$service.AutodiscoverUrl($user.Properties.mail)
$service.Url = "https://mail.mxexchange.com/EWS/Exchange.asmx"
...
From my understanding it is an error with ews authentification.  

I read the documentation but it didn't help me much.

I checked the authentification on EWS:  

"Integrated Windows Authentification" and "Basic authentification" are on.

As I said I'm new to the world of Exchange Server I'm learning.  

So my setup is very basic:  

-  1 AD Server - DNS - DHCP - ADCS  

-  1 Exchange Server 2016  

-  1 workstation

I've got around 500 test users.

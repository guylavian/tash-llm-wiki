---
title: "Edit existing web parts in SharePoint Server - SharePoint Server"
...
The SharePoint Server 2019 modern experience includes the Team, Community, and Communication sites. These pages are pre-populated with unique web parts, like the Hero, News, Events, and Documents web parts. For more information, see Classic and modern web part experiences and Using web parts on SharePoint pages.
...
Move your mouse over the upper right corner of the web part you will edit.
...
The editable properties for the selected web part are available by selecting **Web Part Properties**, from the **Web Part** tab in the Ribbon, or **Edit Web Part** from the drop-down arrow.

That's it. You're editing a SharePoint Server web part.

When you've completed editing, to save your work and return to the normal page view, select the **Page** tab in the Ribbon, and then click **Save**. This will save your work and exit the edit mode and return you to your normal page view.

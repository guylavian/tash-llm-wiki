---
title: "SharePoint Server in Microsoft Azure - SharePoint Server"
...
To create a single-server farm running in Azure for demonstration, evaluation, or application testing, see Single-server SharePoint Server farm in Azure.

To simulate the user experience and administration of an intranet SharePoint Server farm running in Azure, see Intranet SharePoint Server in Azure dev/test environment.

Design and planning

## Design and planning

To design the elements of Azure infrastructure services to host a custom dev/test environment, a production farm, or a disaster recovery farm, see Designing a SharePoint Server farm in Azure.

Deployment

## Deployment

See Deploying SharePoint Server with SQL Server Always On Availability Groups in Azure for step-by-step instructions on how to build out this high-availability intranet production farm in Azure.

...
type: reference
domain: sccm
slug: develop-softdistdownloadfailedevent
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/softdistdownloadfailedevent
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SoftDistDownloadFailedEvent message is raised when a download for a package fails. It appears in Package Status in the Configuration Manager console."
---

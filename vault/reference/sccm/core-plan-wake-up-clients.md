...
type: reference
domain: sccm
slug: core-plan-wake-up-clients
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/plan/plan-wake-up-clients
family: core
documentKind: "how-to"
abstract: "Plan how to wake up clients in Configuration Manager using Wake On LAN (WOL)."
---

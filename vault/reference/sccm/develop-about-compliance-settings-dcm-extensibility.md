...
type: reference
domain: sccm
slug: develop-about-compliance-settings-dcm-extensibility
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/about-compliance-settings--dcm--extensibility
family: develop
documentKind: "concept-article"
abstract: "The content in this section provides information about extending the functionality of desired configuration management configuration items in Configuration Manager."
---

# About Compliance Settings Extensibility

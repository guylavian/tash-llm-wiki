...
type: reference
domain: sccm
slug: develop-how-to-enable-and-disable-remote-tools
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/remote-control/how-to-enable-and-disable-remote-tools
family: develop
documentKind: "how-to"
abstract: "Learn how to enable and disable the Remote Tools Client Agent."
---

# Enable and Disable Remote Tools

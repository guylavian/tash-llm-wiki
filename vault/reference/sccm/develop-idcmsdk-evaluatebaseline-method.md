...
type: reference
domain: sccm
slug: develop-idcmsdk-evaluatebaseline-method
tier: reference
...
abstract: "The IDCMSDK::EvaluateBaseline method, in Configuration Manager, runs the discover operation for the specified baseline configuration item."
---

# IDCMSDK::EvaluateBaseline

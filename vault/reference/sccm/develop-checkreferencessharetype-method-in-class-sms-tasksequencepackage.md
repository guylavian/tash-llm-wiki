...
type: reference
domain: sccm
slug: develop-checkreferencessharetype-method-in-class-sms-tasksequencepackage
tier: reference
...
abstract: "In Configuration Manager, the CheckReferencesShareType WMI class method checks all referred packages for this task sequence and returns all packages that aren't shared."
---

...
type: reference
domain: sccm
slug: core-use-a-command-line-to-install-sites
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/use-a-command-line-to-install-sites
family: core
documentKind: "concept-article"
abstract: "Learn how to run Configuration Manager setup at a command prompt for different kinds of site installations."
---

...
type: reference
domain: sccm
slug: core-prepare-windows-servers
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/network/prepare-windows-servers
family: core
documentKind: "article"
abstract: "Make sure that a computer meets prerequisites for use as a site server or a site system server for Configuration Manager."
---

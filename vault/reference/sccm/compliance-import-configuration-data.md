...
type: reference
domain: sccm
slug: compliance-import-configuration-data
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/import-configuration-data
family: compliance
documentKind: "how-to"
abstract: "Import configuration data if it's contained in a cabinet file format and adheres to the supported Service Modeling Language schema."
---

...
type: reference
domain: sccm
slug: develop-about-configuration-manager-errors
tier: reference
...
abstract: "In Configuration Manager, when a Configuration Manager error occurs it's either a Windows Management Instrumentation (WMI) or an SMS Provider error."
---

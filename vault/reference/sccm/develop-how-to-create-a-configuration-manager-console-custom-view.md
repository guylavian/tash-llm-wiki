...
type: reference
domain: sccm
slug: develop-how-to-create-a-configuration-manager-console-custom-view
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-create-a-configuration-manager-console-custom-view
family: develop
documentKind: "how-to"
abstract: "Learn how to create a view that displays a custom control. In this example, the view displays the string content of a label control."
---

# Create a Console Custom View

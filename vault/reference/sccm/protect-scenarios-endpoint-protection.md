...
type: reference
domain: sccm
slug: protect-scenarios-endpoint-protection
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/scenarios-endpoint-protection
family: protect
documentKind: "how-to"
abstract: "Learn how to implement Endpoint Protection in Configuration Manager to protect computers from malware attacks."
---

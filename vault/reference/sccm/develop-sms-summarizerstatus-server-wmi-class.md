...
type: reference
domain: sccm
slug: develop-sms-summarizerstatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_summarizerstatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how the SMS_SummarizerStatus class is an SMS Provider server class that identifies registered summarizers, without defining any specific status information."
---

# SMS_SummarizerStatus Class

...
type: reference
domain: sccm
slug: core-use-the-update-registration-tool-to-import-hotfixes
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/use-the-update-registration-tool-to-import-hotfixes
family: core
documentKind: "how-to"
abstract: "Find out when and how to use the update registration tool to manually import an update to the Configuration Manager console."
---

...
type: reference
domain: sccm
slug: develop-how-to-create-a-maintenance-window-for-a-collection
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-create-a-maintenance-window-for-a-collection
family: develop
documentKind: "how-to"
abstract: "Your application can create a Configuration Manager maintenance window by using the SMS_CollectionSettings Server WMI Class and SMS_ServiceWindow Server WMI Classes and properties."
---

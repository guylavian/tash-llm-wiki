...
type: reference
domain: sccm
slug: develop-uninstall-method-in-class-ccm-application
tier: reference
...
abstract: "Learn how to uninstall an application using the Uninstall Windows Management Instrumentation (WMI) class method."
---

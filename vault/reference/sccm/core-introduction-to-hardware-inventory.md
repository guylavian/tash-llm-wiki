...
type: reference
domain: sccm
slug: core-introduction-to-hardware-inventory
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/inventory/introduction-to-hardware-inventory
family: core
documentKind: "overview"
abstract: "Understand the basics of hardware inventory in Configuration Manager."
---

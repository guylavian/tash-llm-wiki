...
type: reference
domain: sccm
slug: apps-management-tasks-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/management-tasks-applications
family: apps
documentKind: "how-to"
abstract: "Manage Configuration Manager applications and deployment types."
---

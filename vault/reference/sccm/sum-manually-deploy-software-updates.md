...
type: reference
domain: sccm
slug: sum-manually-deploy-software-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/manually-deploy-software-updates
family: sum
documentKind: "install-set-up-deploy"
abstract: "Manually create software deployments to get your clients up-to-date with required software updates, or to deploy out-of-band updates."
---

...
type: reference
domain: sccm
slug: develop-how-to-add-a-configuration-manager-context-qualifier-by-using-managed-code
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "To add a context qualifier by using the managed SMS Provider, use the Context property which is a Dictionary object that holds context qualifiers."
---

# Add a Context Qualifier by Using Managed Code

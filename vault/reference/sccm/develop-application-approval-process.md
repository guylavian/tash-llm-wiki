...
type: reference
domain: sccm
slug: develop-application-approval-process
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/apps/application-approval-process
family: develop
documentKind: "article"
abstract: "Learn about the application approval process. See scenarios with code examples and view known issues."
---

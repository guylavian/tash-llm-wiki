...
type: reference
domain: sccm
slug: comanage-tutorial-co-manage-new-devices
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/comanage/tutorial-co-manage-new-devices
family: comanage
documentKind: "tutorial"
abstract: "Learn how to configure co-management for new internet-based Windows devices by using Configuration Manager and Microsoft Intune."
---

# Tutorial - Enable co-management for internet devices

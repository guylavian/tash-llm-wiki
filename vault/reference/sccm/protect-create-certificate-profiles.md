...
type: reference
domain: sccm
slug: protect-create-certificate-profiles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/create-certificate-profiles
family: protect
documentKind: "how-to"
abstract: "Learn how to use certificate profiles to provision managed devices with the certificates they need"
---

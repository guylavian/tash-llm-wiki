...
type: reference
domain: sccm
slug: develop-sms-ampolicysummary-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/protect/sms_ampolicysummary-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_AmPolicySummary Windows Management Instrumentation class is an SMS Provider server class in Configuration Manager."
---

# SMS_AmPolicySummary Class

...
type: reference
domain: sccm
slug: develop-client-development-requirements
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/reqs/client-development-requirements
family: develop
documentKind: "reference"
abstract: "The Configuration Manager client can be programmed by using programming languages that follow."
---

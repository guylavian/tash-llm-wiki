...
type: reference
domain: sccm
slug: develop-sms-cm-updatepackages-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_cm_updatepackages-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class, in Configuration Manager, that represents update packages."
---

# SMS_CM_UpdatePackages Class

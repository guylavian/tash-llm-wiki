...
type: reference
domain: sccm
slug: protect-migration-considerations
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/bitlocker/migration-considerations
family: protect
documentKind: "upgrade-and-migration-article"
abstract: "Understand the considerations when migrating from Microsoft BitLocker Administration and Monitoring (MBAM) to BitLocker management in Configuration Manager."
---

...
type: reference
domain: sccm
slug: develop-addattributetosmsstatusmessage-function
tier: reference
...
abstract: "Learn to use AddAttributeToSMSStatusMessage to add a single optional status message attribute id-value pair to a status message object."
---

...
type: reference
domain: sccm
slug: develop-addassociation-method-in-class-sms-statemigration
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/addassociation-method-in-class-sms_statemigration
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the AddAssociation WMI class method adds the computer association between two system resources used in state migration."
---

...
type: reference
domain: sccm
slug: core-configure-discovery-methods
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/configure-discovery-methods
family: core
documentKind: "how-to"
abstract: "Configure discovery methods to find resources to manage from your network, Active Directory, and Microsoft Entra ID."
---

...
type: reference
domain: sccm
slug: develop-movefolders-method-in-class-sms-objectcontainernode
tier: reference
...
abstract: "Learn how the MoveFolders Windows Management (WMI) class method, in Configuration Manager, moves folders to another folder location."
---

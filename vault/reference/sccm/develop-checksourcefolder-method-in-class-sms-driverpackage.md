...
type: reference
domain: sccm
slug: develop-checksourcefolder-method-in-class-sms-driverpackage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/checksourcefolder-method-in-class-sms_driverpackage
family: develop
documentKind: "reference"
abstract: "Learn how to check the state of an empty driver source folder with CheckSourceFolder class im Configuration Manager."
---

# CheckSourceFolder Method

...
type: reference
domain: sccm
slug: develop-sms-policyagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_policyagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Details of the SMS_PolicyAgentConfig server WMI class"
---

# SMS_PolicyAgentConfig class

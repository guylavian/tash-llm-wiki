...
type: reference
domain: sccm
slug: develop-sms-inventoryreportclass-server-wmi-class
tier: reference
...
abstract: "The SMS_InventoryReportClass WMI class is an SMS Provider server class embedded in SMS_InventoryReport that represents the classes that are enabled to be collected in this inventory report."
---

# SMS_InventoryReportClass Class

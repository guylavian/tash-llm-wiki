...
type: reference
domain: sccm
slug: hotfix-37426535
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/hotfix/2603/37426535
family: hotfix
documentKind: "reference"
abstract: "Article listing changes in Configuration Manager current branch, version 2603"
---
...
- Version 2603 is available as an in-console update that can be installed at the top-tier site in a hierarchy.
- For installation information, see [Checklist for installing update 2603 for Configuration Manager](../../core/servers/manage/checklist-for-installing-update-2603.md).
- For more information about the changes that are included in version 2603, see [What's new in version 2603 of Configuration Manager current branch](../../core/plan-design/changes/whats-new-in-version-2603.md).
...
<!-- MISE MP internet access -->
- The management point now uses Microsoft Identity Service Essentials (MISE) for Microsoft Entra token validation. In environments that support Microsoft Entra joined users and devices, the management point server requires internet access to reach Azure authentication endpoints. For more information, see [Management point requires internet access for Microsoft Entra token validation](../../core/plan-design/changes/whats-new-in-version-2603.md#management-point-requires-internet-access-for-microsoft-entra-token-validation).
...
- KB [35877153](../2509/35877153.md): Summary of changes in Configuration Manager current branch, version 2509
- KB [33247081](../2509/33247081.md): Microsoft Connected Cache update for Configuration Manager
- KB [36419072](../2509/36419072.md): Feedback for Configuration Manager
- KB [36495448](../2509/36495448.md): Software update management client fix for Configuration Manager versions 2503 and 2509
- KB [37447175](../2503/37447175.md): Security update for Microsoft Configuration Manager
- KB [37172183](../2503/37172183.md): Software Center client fix for Configuration Manager

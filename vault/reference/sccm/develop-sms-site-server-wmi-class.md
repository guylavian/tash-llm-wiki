...
type: reference
domain: sccm
slug: develop-sms-site-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents identification and status data for a Configuration Manager site installation."
---

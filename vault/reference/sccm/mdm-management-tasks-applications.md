...
type: reference
domain: sccm
slug: mdm-management-tasks-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/deploy-use/management-tasks-applications
family: mdm
documentKind: "article"
abstract: "Manage applications for on-premises mobile device management (MDM) in Configuration Manager."
---

# Manage apps for on-premises MDM

...
type: reference
domain: sccm
slug: develop-ccm-instanceevent-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/ccm_instanceevent-client-wmi-class
family: develop
documentKind: "reference"
abstract: "The CCM_InstanceEvent Windows Management Instrumentation class is an SMS Provider server class, in Configuration Manager, that represents an instance event."
---

# CCM_InstanceEvent Class

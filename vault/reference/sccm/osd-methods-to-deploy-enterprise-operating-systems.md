...
type: reference
domain: sccm
slug: osd-methods-to-deploy-enterprise-operating-systems
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/methods-to-deploy-enterprise-operating-systems
family: osd
documentKind: "install-set-up-deploy"
abstract: "Learn about the methods that you can use to deploy operating systems in your Configuration Manager environment."
---

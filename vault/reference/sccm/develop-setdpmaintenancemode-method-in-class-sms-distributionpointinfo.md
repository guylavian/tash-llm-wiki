...
type: reference
domain: sccm
slug: develop-setdpmaintenancemode-method-in-class-sms-distributionpointinfo
tier: reference
...
abstract: "Learn how to set a distribution point in maintenance mode using SetDPMaintenanceMode class method in Configuration Manager."
---

# SetDPMaintenanceMode method

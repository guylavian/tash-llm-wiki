...
type: reference
domain: sccm
slug: develop-how-to-add-a-category-to-a-windows-driver
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-add-a-category-to-a-windows-driver
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you add a category to a Windows driver by adding the unique identifier for the category to the SMS_Driver Server WMI Class CategoryInstance_UniqueIDs array property."
---

# Add a Category to a Windows Driver

...
type: reference
domain: sccm
slug: compliance-create-configuration-items-for-mac-os-x-devices-managed-with-the-client
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/create-configuration-items-for-mac-os-x-devices-managed-with-the-client
family: compliance
documentKind: "how-to"
abstract: "Use the Configuration Manager macOS X configuration item to manage settings for macOS devices."
---

# Create configuration items for macOS

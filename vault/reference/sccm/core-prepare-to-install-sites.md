...
type: reference
domain: sccm
slug: core-prepare-to-install-sites
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/prepare-to-install-sites
family: core
documentKind: "install-set-up-deploy"
abstract: "If you're planning to install multiple Configuration Manager sites, read this information to help you save time, and to prevent errors."
---

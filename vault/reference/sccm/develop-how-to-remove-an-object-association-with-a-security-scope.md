...
type: reference
domain: sccm
slug: develop-how-to-remove-an-object-association-with-a-security-scope
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Remove a security scope from an object by using an SMS_SecuredCategoryMembership class instance."
---

# Remove an Object Association with a Security Scope

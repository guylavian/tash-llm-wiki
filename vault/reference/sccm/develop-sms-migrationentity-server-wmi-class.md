...
type: reference
domain: sccm
slug: develop-sms-migrationentity-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/migration/sms_migrationentity-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent the gathered object entities from the Configuration Manager 2007 hierarchy using SMS_MigrationEntity."
---

# SMS_MigrationEntity Class

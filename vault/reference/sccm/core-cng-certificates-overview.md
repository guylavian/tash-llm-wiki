...
type: reference
domain: sccm
slug: core-cng-certificates-overview
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/network/cng-certificates-overview
family: core
documentKind: "concept-article"
abstract: "Learn about support for Cryptography Next Generation (CNG) v3 certificates for Configuration Manager clients and servers."
---

...
type: reference
domain: sccm
slug: apps-error-messages
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/pcm/error-messages
family: apps
documentKind: "reference"
abstract: "Learn about the error messages from Package Conversion Manager."
---

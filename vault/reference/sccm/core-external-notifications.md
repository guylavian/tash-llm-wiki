...
type: reference
domain: sccm
slug: core-external-notifications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/external-notifications
family: core
documentKind: "how-to"
abstract: "Enable the site to send notifications to an external system or application."
---

...
type: reference
domain: sccm
slug: apps-prerequisites-deploy-user-available-apps
tier: reference
...
abstract: "When you deploy apps as Available to user collections, there are other requirements for some types of clients."
---

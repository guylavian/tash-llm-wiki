...
type: reference
domain: sccm
slug: develop-how-to-add-a-property-page-to-an-existing-configuration-manager-property-sheet
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-add-a-property-page-to-an-existing-configuration-manager-property-sheet
family: develop
documentKind: "how-to"
abstract: "Learn how to add a property page to an existing property sheet, in Configuration Manager."
---

# Add a Property Page to an Existing Property Sheet

...
type: reference
domain: sccm
slug: develop-sms-configurationbaselineinfo-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents a baseline configuration item."
---

# SMS_ConfigurationBaselineInfo Class

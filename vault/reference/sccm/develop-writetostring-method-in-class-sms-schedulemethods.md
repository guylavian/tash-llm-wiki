...
type: reference
domain: sccm
slug: develop-writetostring-method-in-class-sms-schedulemethods
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/writetostring-method-in-class-sms_schedulemethods
family: develop
documentKind: "reference"
abstract: "The WriteToString Windows Management Instrumentation (WMI) class method, in Configuration Manager, writes an interval string from objects."
---

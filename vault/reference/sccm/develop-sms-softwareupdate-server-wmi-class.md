...
type: reference
domain: sccm
slug: develop-sms-softwareupdate-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_softwareupdate-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_SoftwareUpdate WMI class exposes software update information available on a site and serves as the core class for software updates."
---

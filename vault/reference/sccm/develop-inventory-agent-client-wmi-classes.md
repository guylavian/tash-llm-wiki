...
type: reference
domain: sccm
slug: develop-inventory-agent-client-wmi-classes
tier: reference
...
abstract: "In Configuration Manager, the inventory client agent classes can be broken into three categories."
---

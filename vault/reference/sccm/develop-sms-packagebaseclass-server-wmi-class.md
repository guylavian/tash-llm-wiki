...
type: reference
domain: sccm
slug: develop-sms-packagebaseclass-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_packagebaseclass-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, WMI class is an SMS Provider server class that serves as the abstract base class for all packages."
---

# SMS_PackageBaseclass Class

...
type: reference
domain: sccm
slug: develop-reportsmsstatusmessage-function
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/reportsmsstatusmessage-function
family: develop
documentKind: "reference"
abstract: "The ReportSMSStatusMessage function submits a status message object to the Configuration Manager status system and then deallocates the object."
---

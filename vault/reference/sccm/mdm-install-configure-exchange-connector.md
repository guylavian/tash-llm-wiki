...
type: reference
domain: sccm
slug: mdm-install-configure-exchange-connector
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/deploy-use/install-configure-exchange-connector
family: mdm
documentKind: "install-set-up-deploy"
abstract: "Install and configure the Exchange connector for Configuration Manager to manage mobile devices via ActiveSync."
---

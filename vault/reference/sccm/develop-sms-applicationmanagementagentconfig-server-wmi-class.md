...
type: reference
domain: sccm
slug: develop-sms-applicationmanagementagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_applicationmanagementagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_ApplicationManagementAgentConfig WMI class is an SMS Provider server class that contains the configuration of Application Management client agent settings."
---

# SMS_ApplicationManagementAgentConfig Class

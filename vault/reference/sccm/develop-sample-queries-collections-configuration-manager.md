...
type: reference
domain: sccm
slug: develop-sample-queries-collections-configuration-manager
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Sample queries that show how to join some of the most commonly used collection views to other views."
---

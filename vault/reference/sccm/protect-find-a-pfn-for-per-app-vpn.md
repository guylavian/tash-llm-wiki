...
type: reference
domain: sccm
slug: protect-find-a-pfn-for-per-app-vpn
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/find-a-pfn-for-per-app-vpn
family: protect
documentKind: "how-to"
abstract: "Learn about the two ways to find a package family name so that you can configure a per-app VPN."
---

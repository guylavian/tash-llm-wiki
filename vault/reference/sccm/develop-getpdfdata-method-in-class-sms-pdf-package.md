...
type: reference
domain: sccm
slug: develop-getpdfdata-method-in-class-sms-pdf-package
tier: reference
...
abstract: "Learn how to produce SMS Package and Program Server class objects from a loaded package with GetPDFData."
---

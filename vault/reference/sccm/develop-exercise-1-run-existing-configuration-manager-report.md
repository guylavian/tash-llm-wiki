...
type: reference
domain: sccm
slug: develop-exercise-1-run-existing-configuration-manager-report
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/exercise-1-run-existing-configuration-manager-report
family: develop
documentKind: "how-to"
abstract: "Run an existing Configuration Manager report and review specific report elements."
---

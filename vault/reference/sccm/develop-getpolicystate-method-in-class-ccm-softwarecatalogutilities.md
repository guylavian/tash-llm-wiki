...
type: reference
domain: sccm
slug: develop-getpolicystate-method-in-class-ccm-softwarecatalogutilities
tier: reference
...
abstract: "A Windows Management Instrumentation (WMI) class method that returns the state of a policy object."
---

# GetPolicyState Method

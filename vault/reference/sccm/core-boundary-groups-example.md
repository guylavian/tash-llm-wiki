...
type: reference
domain: sccm
slug: core-boundary-groups-example
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/boundary-groups-example
family: core
documentKind: "article"
abstract: "Use this boundary group example to help understand how clients locate and download content from a distribution point."
---

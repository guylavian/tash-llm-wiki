...
type: reference
domain: sccm
slug: develop-sms-tasksequence-osconditiongroup-server-wmi-class
tier: reference
...
abstract: "Learn how to use Configuration Manager SMS_TaskSequence_OSConditionGroup Windows Management Instrumentation (WMI) class to represent an evaluation of a group of operating system platforms."
---

# SMS_TaskSequence_OSConditionGroup Class

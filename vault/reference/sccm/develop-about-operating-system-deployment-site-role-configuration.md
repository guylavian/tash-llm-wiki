...
type: reference
domain: sccm
slug: develop-about-operating-system-deployment-site-role-configuration
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/about-operating-system-deployment-site-role-configuration
family: develop
documentKind: "concept-article"
abstract: "Learn about the different operating system deployment site roles and how to configure these roles by using the SMS_SiteControlFile class."
---

# OS Deployment Site Role Configuration

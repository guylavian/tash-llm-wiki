...
type: reference
domain: sccm
slug: develop-sms-meteredfiles-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_meteredfiles-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent metered files and implement the matching between the meter rule and the file information in Configuration Manager."
---

# SMS_MeteredFiles Class

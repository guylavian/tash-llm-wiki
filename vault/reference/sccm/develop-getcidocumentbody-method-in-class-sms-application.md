...
type: reference
domain: sccm
slug: develop-getcidocumentbody-method-in-class-sms-application
tier: reference
...
abstract: "In Configuration Manager, the GetCIDocumentBody WMI class method gets the configuration item document body."
---

# GetCIDocumentBody Method

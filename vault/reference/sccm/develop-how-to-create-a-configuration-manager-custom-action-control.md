...
type: reference
domain: sccm
slug: develop-how-to-create-a-configuration-manager-custom-action-control
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-create-a-configuration-manager-custom-action-control
family: develop
documentKind: "how-to"
abstract: "Learn how to create a custom action control in Configuration Manager."
---

# Create a Custom Action Control

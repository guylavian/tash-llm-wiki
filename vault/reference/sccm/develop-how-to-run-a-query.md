...
type: reference
domain: sccm
slug: develop-how-to-run-a-query
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-run-a-query
family: develop
documentKind: "how-to"
abstract: "Run an SMS_Query based query by getting the query instance and then by running WQL query in the SMS_Query object Expression property."
---

...
type: reference
domain: sccm
slug: core-configure-client-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/configure-client-settings
family: core
documentKind: "how-to"
abstract: "Learn how to configure client settings in Configuration Manager."
---

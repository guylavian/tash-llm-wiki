...
type: reference
domain: sccm
slug: core-boundaries
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/boundaries
family: core
documentKind: "how-to"
abstract: "Understand how to define network locations on your intranet that can contain devices you want to manage."
---

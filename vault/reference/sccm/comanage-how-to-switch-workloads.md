...
type: reference
domain: sccm
slug: comanage-how-to-switch-workloads
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/comanage/how-to-switch-workloads
family: comanage
documentKind: "how-to"
abstract: "Learn how to switch workloads currently managed by Configuration Manager to Microsoft Intune."
---

# Switch co-management workloads

...
type: reference
domain: sccm
slug: develop-gettallyintervals-method-in-class-sms-summarizerrootstatus
tier: reference
...
abstract: "Learn how to use the GetTallyIntervals method to get an array of tally intervals and the default interval."
---

# GetTallyIntervals Method

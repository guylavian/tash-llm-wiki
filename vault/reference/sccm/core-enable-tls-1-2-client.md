...
type: reference
domain: sccm
slug: core-enable-tls-1-2-client
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/security/enable-tls-1-2-client
family: core
documentKind: "how-to"
abstract: "Information about how to enable TLS 1.2 for Configuration Manager clients."
---

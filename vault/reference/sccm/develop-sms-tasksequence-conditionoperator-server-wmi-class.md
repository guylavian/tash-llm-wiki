...
type: reference
domain: sccm
slug: develop-sms-tasksequence-conditionoperator-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents an operator to use when evaluating task sequence condition operands."
---

# SMS_TaskSequence_ConditionOperator Class

...
type: reference
domain: sccm
slug: develop-sms-sumdeploymentassetdetails-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_sumdeploymentassetdetails-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class, in Configuration Manager, that represents per-asset details for SUM deployments in-console monitoring."
---

# SMS_SUMDeploymentAssetDetails Class

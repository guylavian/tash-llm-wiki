...
type: reference
domain: sccm
slug: core-maintenance-tasks
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/maintenance-tasks
family: core
documentKind: "article"
abstract: "Understand what maintenance tasks to perform for Configuration Manager sites and hierarchies and when to perform them."
---

...
type: reference
domain: sccm
slug: develop-sms-packageaccessbyusers-server-wmi-class
tier: reference
...
abstract: "The SMS_PackageAccessByUsers WMI class is an SMS Provider server class, in Configuration Manager, that controls which users are granted access rights to a package folder or to distribution points."
---

# SMS_PackageAccessByUsers Class

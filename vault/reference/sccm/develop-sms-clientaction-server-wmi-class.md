...
type: reference
domain: sccm
slug: develop-sms-clientaction-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/protect/sms_clientaction-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_ClientAction Windows Management Instrumentation (WMI) class is an SMS Provider server class, in Configuration Manager, that represents the client action."
---

# SMS_ClientAction Class

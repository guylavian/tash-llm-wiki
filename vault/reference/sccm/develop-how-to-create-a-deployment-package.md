...
type: reference
domain: sccm
slug: develop-how-to-create-a-deployment-package
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/how-to-create-a-deployment-package
family: develop
documentKind: "how-to"
abstract: "A software updates deployment package initiated by creating an instance of the SMS_SoftwareUpdatesPackage class and populating the properties."
---

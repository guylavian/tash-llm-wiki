...
type: reference
domain: sccm
slug: develop-how-to-connect-to-an-sms-provider-in-configuration-manager-by-using-wmi
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-connect-to-an-sms-provider-in-configuration-manager-by-using-wmi
family: develop
documentKind: "how-to"
abstract: "Connect to the SMS Provider on a Configuration Manager site server by using the WMI SWbemLocator object or by using the Windows Script Host GetObject method."
---

# Connect to an SMS Provider by Using WMI

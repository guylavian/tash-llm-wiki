...
type: reference
domain: sccm
slug: develop-how-to-track-operating-system-deployment-migrations
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-track-operating-system-deployment-migrations
family: develop
documentKind: "how-to"
abstract: "The StoreCreationDate, StoreDeletionDate, and StoreReleaseDate properties can be used to identify the current state of the migration."
---

# Track OS Deployment Migrations

...
type: reference
domain: sccm
slug: develop-sms-sci-clientcomp-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_SCI_ClientComp WMI class is an SMS Provider server class that represents the component to install on a client computer."
---

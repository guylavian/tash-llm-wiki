...
type: reference
domain: sccm
slug: core-planning-to-complete-migration
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/migration/planning-to-complete-migration
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Learn how to finish migration to a Configuration Manager current branch destination hierarchy after a source hierarchy no longer has data."
---

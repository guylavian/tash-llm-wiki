...
type: reference
domain: sccm
slug: core-planning-a-content-deployment-migration-strategy
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/migration/planning-a-content-deployment-migration-strategy
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Use distribution points to manage content while you migrate data to a Configuration Manager current branch destination hierarchy."
---

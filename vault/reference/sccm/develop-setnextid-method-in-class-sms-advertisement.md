...
type: reference
domain: sccm
slug: develop-setnextid-method-in-class-sms-advertisement
tier: reference
...
abstract: "Learn how the SetNextID Windows Management Instrumentation (WMI) class method, in Configuration Manager, sets the ID number that will be used for the next advertisement created."
---

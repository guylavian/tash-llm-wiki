...
type: reference
domain: sccm
slug: develop-sms-classicdeploymentassetdetails-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_classicdeploymentassetdetails-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent asset level details about classic software distribution deployments using SMS_ClassicDeploymentAssetDetails class."
---

# SMS_ClassicDeploymentAssetDetails Class

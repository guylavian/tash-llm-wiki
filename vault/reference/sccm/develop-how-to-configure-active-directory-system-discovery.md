...
type: reference
domain: sccm
slug: develop-how-to-configure-active-directory-system-discovery
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-configure-active-directory-system-discovery
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you configure the Active Directory System Discovery settings by modifying the necessary site control file settings."
---

...
type: reference
domain: sccm
slug: develop-submitregistrationrecord-method-in-class-sms-site
tier: reference
...
abstract: "A Windows Management Instrumentation class method that submits a registration record."
---

# SubmitRegistrationRecord Method

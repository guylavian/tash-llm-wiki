...
type: reference
domain: sccm
slug: core-boundary-group-options
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/boundary-group-options
family: core
documentKind: "article"
abstract: "Configure boundary group options to control policy and content distribution."
---

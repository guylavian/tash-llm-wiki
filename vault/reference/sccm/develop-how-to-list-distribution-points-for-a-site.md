...
type: reference
domain: sccm
slug: develop-how-to-list-distribution-points-for-a-site
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "How to assign a distribution point to a package by using the SMS_DistributionPoint Server WMI Class and class properties in Configuration Manager."
---

# List Distribution Points for a Site

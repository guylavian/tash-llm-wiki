...
type: reference
domain: sccm
slug: develop-sms-siib-generic-configuration-server-wmi-class
tier: reference
...
abstract: "Learn how to represent the generic configuration for Configuration Manager components with SMS_SIIB_Generic_Configuration."
---

# SMS_SIIB_Generic_Configuration Class

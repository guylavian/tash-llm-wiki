...
type: reference
domain: sccm
slug: develop-how-to-create-a-new-security-role
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-create-a-new-security-role
family: develop
documentKind: "how-to"
abstract: "Learn how the administrative assignments for a user or security group are defined by the roles and security scopes assigned to that user or security group."
---

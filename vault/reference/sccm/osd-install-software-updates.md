...
type: reference
domain: sccm
slug: osd-install-software-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/understand/install-software-updates
family: osd
documentKind: "troubleshooting"
abstract: "Recommendations for using the task sequence step Install Software Updates in Configuration Manager."
---

...
type: reference
domain: sccm
slug: core-get-install-media
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/get-install-media
family: core
documentKind: "article"
abstract: "Where to find installation media for new Configuration Manager installations."
---

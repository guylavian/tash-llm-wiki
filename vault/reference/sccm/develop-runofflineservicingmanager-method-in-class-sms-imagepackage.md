...
type: reference
domain: sccm
slug: develop-runofflineservicingmanager-method-in-class-sms-imagepackage
tier: reference
...
abstract: "The RunOfflineServicingManager WMI class method updates the site control file of the offline servicing manager."
---

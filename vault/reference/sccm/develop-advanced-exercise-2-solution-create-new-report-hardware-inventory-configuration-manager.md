...
type: reference
domain: sccm
slug: develop-advanced-exercise-2-solution-create-new-report-hardware-inventory-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/advanced-exercise-2-solution-create-new-report-hardware-inventory-configuration-manager
family: develop
documentKind: "how-to"
abstract: "Create the report for Advanced Exercise 2"
---

# Advanced exercise 2 solution: Create a new report for hardware inventory

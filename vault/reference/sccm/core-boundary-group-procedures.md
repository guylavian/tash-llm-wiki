...
type: reference
domain: sccm
slug: core-boundary-group-procedures
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/boundary-group-procedures
family: core
documentKind: "how-to"
abstract: "Configure boundary groups to logically organize related network locations called boundaries."
---

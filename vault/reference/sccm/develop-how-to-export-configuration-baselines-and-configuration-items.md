...
type: reference
domain: sccm
slug: develop-how-to-export-configuration-baselines-and-configuration-items
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "You can export a configuration baseline or configuration item by using Configuration Manager SDK and reading the relevant SMS_ConfigurationItem instance and writing the SDMPackageXML property (string) to a file."
---

# Export Configuration Baselines and Items

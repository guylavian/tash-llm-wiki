...
type: reference
domain: sccm
slug: develop-sms-collectionpermission-server-wmi-class
tier: reference
...
abstract: "Article outlining the use of SMS_CollectionPermission in Configuration Manager to query and define which collection scopes are associated to an RBAC role."
---

# SMS_CollectionPermission Class

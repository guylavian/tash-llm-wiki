...
type: reference
domain: sccm
slug: core-interoperability-client
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/understand/interoperability-client
family: core
documentKind: "how-to"
abstract: "Learn about using the extended interoperability client for long-term support of a static Configuration Manager client with a current branch site."
---

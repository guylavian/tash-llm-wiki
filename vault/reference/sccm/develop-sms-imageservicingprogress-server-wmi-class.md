...
type: reference
domain: sccm
slug: develop-sms-imageservicingprogress-server-wmi-class
tier: reference
...
abstract: "The SMS_ImageServicingProgress WMI class is an SMS Provider server class that represents software update installation status in offline servicing image."
---

# SMS_ImageServicingProgress Class

...
type: reference
domain: sccm
slug: develop-removecontent-method-in-class-sms-softwareupdatespackage
tier: reference
...
abstract: "In Configuration Manager, the RemoveContent Windows Management Instrumentation class method removes old or unnecessary content from the software updates package."
---

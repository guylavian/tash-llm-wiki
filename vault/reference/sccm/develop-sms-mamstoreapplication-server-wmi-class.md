...
type: reference
domain: sccm
slug: develop-sms-mamstoreapplication-server-wmi-class
tier: reference
...
abstract: "The SMS_MAMStoreApplication WMI class is an SMS Provider server class that represents mobile application management store application lists."
---

# SMS_MAMStoreApplication Class

...
type: reference
domain: sccm
slug: mdm-enroll-devices-on-premises-mdm
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/deploy-use/enroll-devices-on-premises-mdm
family: mdm
documentKind: "article"
abstract: "Learn about methods to enroll devices for on-premises mobile device management (MDM) in Configuration Manager."
---

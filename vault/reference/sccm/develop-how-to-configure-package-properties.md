...
type: reference
domain: sccm
slug: develop-how-to-configure-package-properties
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-configure-package-properties
family: develop
documentKind: "how-to"
abstract: "Learn how the following example shows how to configure the properties of an existing package, in Configuration Manager, by using the SMS_Package class."
---

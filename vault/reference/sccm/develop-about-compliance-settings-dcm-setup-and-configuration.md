...
type: reference
domain: sccm
slug: develop-about-compliance-settings-dcm-setup-and-configuration
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/about-compliance-settings--dcm--setup-and-configuration
family: develop
documentKind: "concept-article"
abstract: "Learn about how to configure compliance settings and the custom configuration requirements using the Configuration Manager site."
---

# About Compliance Settings Setup and Configuration

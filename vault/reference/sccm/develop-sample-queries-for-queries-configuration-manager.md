...
type: reference
domain: sccm
slug: develop-sample-queries-for-queries-configuration-manager
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Sample queries that show how the query view can be joined to a security view."
---

# Sample queries for the query view

...
type: reference
domain: sccm
slug: develop-how-to-enable-hardware-inventory
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/inventory/how-to-enable-hardware-inventory
family: develop
documentKind: "how-to"
abstract: "Modify the site control file settings to enable or disable the Hardware Inventory Client Agent in Configuration Manager."
---

# Enable Hardware Inventory

# How to Enable Hardware Inventory
You enable or disable the Hardware Inventory Client Agent, in Configuration Manager, by modifying the site control file settings.  

...
type: reference
domain: sccm
slug: develop-how-to-delete-a-security-scope
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-delete-a-security-scope
family: develop
documentKind: "how-to"
abstract: "Learn how to delete a security scope in Configuration Manager by using the SMS_SecuredCategory class."
---

# Delete a Security Scope

...
type: reference
domain: sccm
slug: develop-rebuildpackage-method-in-class-sms-softwareupdatespackage
tier: reference
...
abstract: "The RebuildPackage WMI class method brings the software updates package to its expected state if files are found to be corrupt or have been deleted."
---

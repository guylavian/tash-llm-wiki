...
type: reference
domain: sccm
slug: core-powerbi-report-server
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/powerbi-report-server
family: core
documentKind: "how-to"
abstract: "Integrate Power BI Report Server with Configuration Manager reporting for modern visualization and better performance."
---

...
type: reference
domain: sccm
slug: develop-updateoptionalcomponents-method-in-class-sms-bootimagepackage
tier: reference
...
abstract: "The UpdateOptionalComponents WMI class method updates all specified optional components to the boot image package."
---

# UpdateOptionalComponents Method

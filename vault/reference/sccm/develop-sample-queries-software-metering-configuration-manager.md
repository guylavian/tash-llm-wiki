...
type: reference
domain: sccm
slug: develop-sample-queries-software-metering-configuration-manager
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Sample queries that show how to join the most common software metering views to other views."
---

# Sample queries for software metering

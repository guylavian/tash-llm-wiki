...
type: reference
domain: sccm
slug: core-install-the-ltsb
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/understand/install-the-ltsb
family: core
documentKind: "install-set-up-deploy"
abstract: "Install or upgrade to the LTSB for System Center Configuration Manager."
---

# Install a site using the 1606 baseline media

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-step-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_step-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_TaskSequence_Step WMI class is an SMS Provider server class. This class serves as an abstract base class that represents a single step in a task sequence."
---

# SMS_TaskSequence_Step Class

...
type: reference
domain: sccm
slug: develop-how-to-import-a-windows-driver-described-by-a-txtsetup-oem-file
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-import-a-windows-driver-described-by-a-txtsetup-oem-file
family: develop
documentKind: "how-to"
abstract: "Use the CreateFromOEM Method in Class SMS_Driver to import a Windows driver that is described by a Txtsetup.oem file in Configuration Manager."
---

# Import a Windows Driver Described by a Txtsetup.oem File

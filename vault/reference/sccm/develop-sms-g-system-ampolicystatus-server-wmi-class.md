...
type: reference
domain: sccm
slug: develop-sms-g-system-ampolicystatus-server-wmi-class
tier: reference
...
abstract: "The SMS_G_SYSTEM_AmPolicyStatus Windows Management Instrumentation class is an SMS Provider server class in Configuration Manager."
---

# SMS_G_SYSTEM_AmPolicyStatus Class

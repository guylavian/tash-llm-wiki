...
type: reference
domain: sccm
slug: develop-sms-inventoryreport-server-wmi-class
tier: reference
...
abstract: "The SMS_InventoryReport WMI class is an SMS Provider server class that represents the classes and properties that are enabled to be collected."
---

# SMS_InventoryReport Class

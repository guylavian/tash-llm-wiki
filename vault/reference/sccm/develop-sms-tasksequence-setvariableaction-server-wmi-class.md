...
type: reference
domain: sccm
slug: develop-sms-tasksequence-setvariableaction-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents a task sequence action. It sets the value of a task sequence environment variable."
---

# SMS_TaskSequence_SetVariableAction class

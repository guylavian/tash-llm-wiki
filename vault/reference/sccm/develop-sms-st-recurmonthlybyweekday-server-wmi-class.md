...
type: reference
domain: sccm
slug: develop-sms-st-recurmonthlybyweekday-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a schedule token for events that occur for a specific time interval using SMS_ST_RecurMonthlyByWeekday class."
---

# SMS_ST_RecurMonthlyByWeekday Class

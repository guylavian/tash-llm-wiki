...
type: reference
domain: sccm
slug: develop-sms-inventoryclass-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_InventoryClass Windows Management Instrumentation class is an SMS Provider server class that represents inventory classes that exist in the system."
---

# SMS_InventoryClass Class

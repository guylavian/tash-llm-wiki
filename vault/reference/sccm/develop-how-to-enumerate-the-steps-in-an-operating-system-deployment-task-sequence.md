...
type: reference
domain: sccm
slug: develop-how-to-enumerate-the-steps-in-an-operating-system-deployment-task-sequence
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "You enumerate an operating system deployment task sequence, in Configuration Manager, by using a recursive method to scan through the task sequence steps and groups."
---

# Enumerate the Steps in an OS Deployment Task Sequence

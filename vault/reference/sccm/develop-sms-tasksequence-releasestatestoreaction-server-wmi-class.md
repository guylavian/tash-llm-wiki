...
type: reference
domain: sccm
slug: develop-sms-tasksequence-releasestatestoreaction-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents a task sequence action. It notifies the state migration point of completion of a capture or restore action."
---

# SMS_TaskSequence_ReleaseStateStoreAction Class

...
type: reference
domain: sccm
slug: develop-sms-objectcontaineritem-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that contains information about a Configuration Manager console folder item."
---

# SMS_ObjectContainerItem Class

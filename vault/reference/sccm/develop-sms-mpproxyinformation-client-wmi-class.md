...
type: reference
domain: sccm
slug: develop-sms-mpproxyinformation-client-wmi-class
tier: reference
...
abstract: "A client Windows Management Instrumentation class that represents information about a proxy management point."
---

# SMS_MPProxyInformation Class

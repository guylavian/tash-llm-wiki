...
type: reference
domain: sccm
slug: apps-import-export-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/import-export-applications
family: apps
documentKind: "how-to"
abstract: "Learn how to import and export applications in Configuration Manager to share between separate hierarchies."
---

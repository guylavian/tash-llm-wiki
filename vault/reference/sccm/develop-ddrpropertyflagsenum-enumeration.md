...
type: reference
domain: sccm
slug: develop-ddrpropertyflagsenum-enumeration
tier: reference
...
abstract: "Learn how to use the DDRPropertyFlagsEnum enumeration in Configuration Manager which specifies flags that are used by ISMSResGen."
---

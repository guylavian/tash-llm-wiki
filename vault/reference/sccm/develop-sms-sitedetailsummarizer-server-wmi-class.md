...
type: reference
domain: sccm
slug: develop-sms-sitedetailsummarizer-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_sitedetailsummarizer-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Article detailing the use of SMS_SiteDetailSummarizer to provide per-site status of components and the system."
---

# SMS_SiteDetailSummarizer Class

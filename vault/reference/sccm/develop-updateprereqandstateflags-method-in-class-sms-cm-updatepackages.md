...
type: reference
domain: sccm
slug: develop-updateprereqandstateflags-method-in-class-sms-cm-updatepackages
tier: reference
...
abstract: "In Configuration Manager, the UpdatePrereqAndStateFlags Windows Management Instrumentation class method updates the installation state of update packages."
---

# UpdatePrereqAndStateFlags Method

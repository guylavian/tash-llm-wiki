...
type: reference
domain: sccm
slug: develop-sms-cirelation-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_cirelation-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn about the SMS_CIRelation Server Windows Management Instrumentation (WMI) Class."
---

# SMS_CIRelation Class

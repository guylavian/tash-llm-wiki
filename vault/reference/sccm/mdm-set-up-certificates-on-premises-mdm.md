...
type: reference
domain: sccm
slug: mdm-set-up-certificates-on-premises-mdm
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/get-started/set-up-certificates-on-premises-mdm
family: mdm
documentKind: "install-set-up-deploy"
abstract: "Set up certificates for trusted communications with on-premises mobile device management (MDM) in Configuration Manager."
---

# Certificates for on-premises MDM

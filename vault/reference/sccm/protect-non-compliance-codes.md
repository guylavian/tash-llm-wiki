...
type: reference
domain: sccm
slug: protect-non-compliance-codes
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/tech-ref/bitlocker/non-compliance-codes
family: protect
documentKind: "reference"
abstract: "A technical reference for the possible codes from a Configuration Manager client that's not compliant with BitLocker policy"
---

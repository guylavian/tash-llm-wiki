...
type: reference
domain: sccm
slug: develop-how-to-set-the-deletion-policy-for-a-state-migration-point
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-set-the-deletion-policy-for-a-state-migration-point
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, configure the state migration point deletion policy by updating the embedded properties of SMPStoreDeletionDelayTimeInMinutes and SMPStoreDeletionCycleTimeInMinutes."
---

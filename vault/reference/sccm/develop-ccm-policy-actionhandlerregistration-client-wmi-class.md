...
type: reference
domain: sccm
slug: develop-ccm-policy-actionhandlerregistration-client-wmi-class
tier: reference
...
abstract: "A class that supports the Configuration Manager 2007 infrastructure and isn't intended to be used directly from your code."
---

# CCM_Policy_ActionHandlerRegistration Class

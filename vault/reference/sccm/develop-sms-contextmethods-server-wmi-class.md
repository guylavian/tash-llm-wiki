...
type: reference
domain: sccm
slug: develop-sms-contextmethods-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/misc/sms_contextmethods-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_ContextMethods Windows Management Instrumentation (WMI) class is an abstract class in Configuration Manager that contains methods for caching WMI context qualifiers with the SMS Provider."
---

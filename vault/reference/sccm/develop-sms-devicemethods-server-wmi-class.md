...
type: reference
domain: sccm
slug: develop-sms-devicemethods-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/mdm/sms_devicemethods-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_DeviceMethods WMI class is an SMS Provider server class that provides access to actions that you can take on mobile devices and Microsoft Exchange ActiveSync devices."
---

# SMS_DeviceMethods Class

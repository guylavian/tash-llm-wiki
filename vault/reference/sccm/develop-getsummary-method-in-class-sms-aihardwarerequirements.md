...
type: reference
domain: sccm
slug: develop-getsummary-method-in-class-sms-aihardwarerequirements
tier: reference
...
abstract: "In Configuration Manager, the GetSummary WMI class method provides a summary count of validated and user-defined state items in the SMS_AIHardwareRequirements class."
---

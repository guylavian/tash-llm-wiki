...
type: reference
domain: sccm
slug: develop-how-to-handle-configuration-manager-synchronous-errors-by-using-wmi
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Handle synchronous errors by using the SWbemLastError object when an error occurs."
---

# Handle Synchronous Errors by Using WMI

...
type: reference
domain: sccm
slug: develop-about-software-distribution-deployments
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/about-software-distribution-deployments
family: develop
documentKind: "concept-article"
abstract: "In Configuration Manager, after a software distribution package has been created, with programs to tell client computers what to do with the package, you need to advertise the program."
---

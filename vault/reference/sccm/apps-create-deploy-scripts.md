...
type: reference
domain: sccm
slug: apps-create-deploy-scripts
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/create-deploy-scripts
family: apps
documentKind: "how-to"
abstract: "Create and run PowerShell scripts on client devices."
---

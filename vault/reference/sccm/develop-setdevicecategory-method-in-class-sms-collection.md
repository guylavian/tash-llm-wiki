...
type: reference
domain: sccm
slug: develop-setdevicecategory-method-in-class-sms-collection
tier: reference
...
abstract: "A Windows Management Instrumentation (WMI) class method, in Configuration Manager, assigns a category to a set of devices."
---

# SetDeviceCategory Method

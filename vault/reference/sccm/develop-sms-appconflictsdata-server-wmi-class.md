...
type: reference
domain: sccm
slug: develop-sms-appconflictsdata-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_appconflictsdata-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_AppConflictsData Windows Management Instrumentation (WMI) class is an SMS Provider server class, in Configuration Manager, that represents the conflict of an application deployment configuration."
---

# SMS_AppConflictsData Class

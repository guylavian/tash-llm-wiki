...
type: reference
domain: sccm
slug: develop-status-alert-views-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/status-alert-views-configuration-manager
family: develop
documentKind: "reference"
abstract: "Information about Configuration Manager component behavior and data flow."
---

# Status and alert views

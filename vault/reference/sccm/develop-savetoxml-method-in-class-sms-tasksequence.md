...
type: reference
domain: sccm
slug: develop-savetoxml-method-in-class-sms-tasksequence
tier: reference
...
abstract: "In Configuration Manager, the SaveToXml WMI class method serializes a task sequence from WMI objects to XML."
---

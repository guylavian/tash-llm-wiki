...
type: reference
domain: sccm
slug: develop-sms-dcmdeploymentcompliantassetdetails-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_dcmdeploymentcompliantassetdetails-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent compliant asset details for a deployment using SMS_DCMDeploymentCompliantAssetDetails class."
---

# SMS_DCMDeploymentCompliantAssetDetails Class

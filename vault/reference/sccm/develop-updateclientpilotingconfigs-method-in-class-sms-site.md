...
type: reference
domain: sccm
slug: develop-updateclientpilotingconfigs-method-in-class-sms-site
tier: reference
...
abstract: "UpdateClientPilotingConfigs, in Configuration Manager, updates the configurations for client piloting settings."
---

# UpdateClientPilotingConfigs Method

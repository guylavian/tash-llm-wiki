...
type: reference
domain: sccm
slug: develop-sms-admin-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_admin-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Details of the SMS_Admin server WMI class"
---

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-downloadpackagecontentaction-server-wmi-class
tier: reference
...
abstract: "Represents a task sequence action that downloads the contents of a package."
---

# SMS_TaskSequence_DownloadPackageContentAction Class

...
type: reference
domain: sccm
slug: osd-high-impact-task-sequence-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/high-impact-task-sequence-settings
family: osd
documentKind: "how-to"
abstract: "Configure a task sequence as high-impact and customize the messages that users receive when they run the task sequence."
---

...
type: reference
domain: sccm
slug: compliance-create-child-configuration-items
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/create-child-configuration-items
family: compliance
documentKind: "how-to"
abstract: "Create child configuration items in Configuration Manager."
---

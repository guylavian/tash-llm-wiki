...
type: reference
domain: sccm
slug: develop-refreshpkgsource-method-in-class-sms-operatingsysteminstallpackage
tier: reference
...
abstract: "The RefreshPkgSource class method, in Configuration Manager, refreshes the package source at all distribution points."
---

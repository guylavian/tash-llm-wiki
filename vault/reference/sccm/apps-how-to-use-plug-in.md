...
type: reference
domain: sccm
slug: apps-how-to-use-plug-in
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/pcm/how-to-use-plug-in
family: apps
documentKind: "how-to"
abstract: "Use the Package Conversion Manager plug-in to customize the analysis and conversion processes."
---

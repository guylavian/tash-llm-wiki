...
type: reference
domain: sccm
slug: osd-create-a-task-sequence-to-upgrade-an-operating-system
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-a-task-sequence-to-upgrade-an-operating-system
family: osd
documentKind: "how-to"
abstract: "Use a task sequence to automatically upgrade Windows to a later version"
---

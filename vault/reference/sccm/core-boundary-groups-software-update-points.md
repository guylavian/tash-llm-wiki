...
type: reference
domain: sccm
slug: core-boundary-groups-software-update-points
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/boundary-groups-software-update-points
family: core
documentKind: "article"
abstract: "Understand how clients and software update points behave with boundary groups."
---

...
type: reference
domain: sccm
slug: develop-how-to-create-a-configuration-manager-object-by-using-managed-code
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to create a configuration manager object by using managed code, with included examples and links."
---

# Create an Object by Using Managed Code

...
type: reference
domain: sccm
slug: develop-how-to-add-new-properties-to-an-existing-resource-type
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-add-new-properties-to-an-existing-resource-type
family: develop
documentKind: "how-to"
abstract: "Learn how to add a property to the resource class when the Data Discovery Manager detects that your data discovery record contains a property that doesn't exist."
---

# Add New Properties to an Existing Resource Type

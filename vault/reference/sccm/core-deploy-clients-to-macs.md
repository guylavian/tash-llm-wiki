...
type: reference
domain: sccm
slug: core-deploy-clients-to-macs
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/deploy-clients-to-macs
family: core
documentKind: "install-set-up-deploy"
abstract: "Learn how to deploy clients to Mac computers in Configuration Manager."
---

...
type: reference
domain: sccm
slug: develop-configuration-manager-action-xml
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/configuration-manager-action-xml
family: develop
documentKind: "article"
abstract: "Article describing the use of ActionDescription XML element in Configuration Manager to display the action, action type, and conditional tests made."
---

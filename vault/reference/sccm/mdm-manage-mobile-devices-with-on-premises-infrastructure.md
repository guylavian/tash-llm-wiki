...
type: reference
domain: sccm
slug: mdm-manage-mobile-devices-with-on-premises-infrastructure
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/understand/manage-mobile-devices-with-on-premises-infrastructure
family: mdm
documentKind: "article"
abstract: "Learn about on-premises mobile device management (MDM) in Configuration Manager"
---

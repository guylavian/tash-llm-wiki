...
type: reference
domain: sccm
slug: core-monitor-client-deployment-status
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/monitor-client-deployment-status
family: core
documentKind: "install-set-up-deploy"
abstract: "Monitor client deployment status in Configuration Manager."
---

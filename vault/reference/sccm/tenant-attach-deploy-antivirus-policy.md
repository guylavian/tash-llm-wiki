...
type: reference
domain: sccm
slug: tenant-attach-deploy-antivirus-policy
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/deploy-antivirus-policy
family: tenant-attach
documentKind: "install-set-up-deploy"
abstract: "Create and deploy Antivirus policies from the Microsoft Intune admin center and for Configuration Manager collections."
---
...
1. On the **Configuration settings** page, configure the settings you want to manage with this profile. When your done configuring settings, select **Next**. For more information about available policies, see [Antivirus policy settings for tenant attached devices](../../device-configuration/endpoint-security/ref-antivirus-defender-settings-windows-tenant-attach.md?toc=/mem/configmgr/tenant-attach/toc.json&bc=/mem/configmgr/tenant-attach/breadcrumb/toc.json).
...
- [Antivirus policy settings for tenant attached devices](../../device-configuration/endpoint-security/ref-antivirus-defender-settings-windows-tenant-attach.md?toc=/mem/configmgr/tenant-attach/toc.json&bc=/mem/configmgr/tenant-attach/breadcrumb/toc.json)

...
type: reference
domain: sccm
slug: develop-how-to-use-objects-passed-to-a-configuration-manager-form
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-use-objects-passed-to-a-configuration-manager-form
family: develop
documentKind: "how-to"
abstract: "Learn how to use the SmsPageControl.PropertyManager object to access objects selected in the Configuration Manager console."
---

# Use Objects Passed to a Form

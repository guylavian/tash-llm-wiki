...
type: reference
domain: sccm
slug: apps-deploy-edge
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/deploy-edge
family: apps
documentKind: "install-set-up-deploy"
abstract: "How to deploy and update Microsoft Edge, version 77 and later with Configuration Manager"
---

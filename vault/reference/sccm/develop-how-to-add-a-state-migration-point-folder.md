...
type: reference
domain: sccm
slug: develop-how-to-add-a-state-migration-point-folder
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-add-a-state-migration-point-folder
family: develop
documentKind: "how-to"
abstract: "Add an operating system deployment state migration point folder by adding the folder description to the Directories embedded property list."
---

# Add a State Migration Point Folder

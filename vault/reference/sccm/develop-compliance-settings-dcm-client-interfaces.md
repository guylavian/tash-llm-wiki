...
type: reference
domain: sccm
slug: develop-compliance-settings-dcm-client-interfaces
tier: reference
...
abstract: "Learn about the configuration management COM automation classes and related types used by client applications to manage configuration items on the client computer."
---

# Compliance Settings Client Interfaces

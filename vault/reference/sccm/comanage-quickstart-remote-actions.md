...
type: reference
domain: sccm
slug: comanage-quickstart-remote-actions
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/comanage/quickstart-remote-actions
family: comanage
documentKind: "article"
abstract: "Run remote actions from Intune for co-managed devices"
---
...
For more information, see [Sync devices to get the latest policies and actions with Intune](../../device-management/actions/sync.md).
...
For more information, see [Remotely restart devices with Intune](../../device-management/actions/restart.md).
...
For more information, see [Use Fresh Start to reset Windows devices with Intune](../../device-management/actions/fresh-start.md).

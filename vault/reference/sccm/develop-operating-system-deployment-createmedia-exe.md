...
type: reference
domain: sccm
slug: develop-operating-system-deployment-createmedia-exe
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/operating-system-deployment-createmedia.exe
family: develop
documentKind: "reference"
abstract: "Create OS deployment media from the command-line or through a script."
---

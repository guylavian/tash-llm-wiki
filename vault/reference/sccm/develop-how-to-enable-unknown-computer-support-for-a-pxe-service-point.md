...
type: reference
domain: sccm
slug: develop-how-to-enable-unknown-computer-support-for-a-pxe-service-point
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-enable-unknown-computer-support-for-a-pxe-service-point
family: develop
documentKind: "how-to"
abstract: "Learn about how to set an operating system deployment response to PXE service requests from unknown computers."
---

# Enable Unknown Computer Support for a PXE Service Point

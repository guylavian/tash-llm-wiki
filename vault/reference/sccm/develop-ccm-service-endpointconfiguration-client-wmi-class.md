...
type: reference
domain: sccm
slug: develop-ccm-service-endpointconfiguration-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/ccm_service_endpointconfiguration-client-wmi-class
family: develop
documentKind: "reference"
abstract: "Article outlining the use of CCM_Service_EndpointConfiguration class that supports endpoint configuration for the CCMEXEC service."
---

# CCM_Service_EndpointConfiguration Class

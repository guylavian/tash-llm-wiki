...
type: reference
domain: sccm
slug: develop-sms-ch-checksummary-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/status/sms_ch_checksummary-server-wmi-class
family: develop
documentKind: "reference"
abstract: "A provider server class that represents the client check summary."
---

# SMS_CH_CheckSummary Class

...
type: reference
domain: sccm
slug: core-introduction-to-remote-control
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/remote-control/introduction-to-remote-control
family: core
documentKind: "article"
abstract: "Get an introduction to remote control in Configuration Manager."
---

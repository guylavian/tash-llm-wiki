...
type: reference
domain: sccm
slug: develop-how-to-set-the-pxe-service-point-response-to-all-network-interfaces
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-set-the-pxe-service-point-response-to-all-network-interfaces
family: develop
documentKind: "how-to"
abstract: "Learn how to set the PXE service point response to all network interfaces by setting the BindPolicy embedded property."
---

# Set the PXE Service Point Response to All Network Interfaces

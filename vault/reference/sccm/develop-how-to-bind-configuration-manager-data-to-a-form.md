...
type: reference
domain: sccm
slug: develop-how-to-bind-configuration-manager-data-to-a-form
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-bind-configuration-manager-data-to-a-form
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, to bind console data to a property sheet, you use the DataBindings property of the property sheet's control class."
---

# Bind Configuration Manager Data to a Form

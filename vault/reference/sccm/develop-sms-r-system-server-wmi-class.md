...
type: reference
domain: sccm
slug: develop-sms-r-system-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_r_system-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_R_System WMI class is an SMS Provider server class that is generated dynamically at SMS Provider run time and contains discovery data for all discovered system resources."
---

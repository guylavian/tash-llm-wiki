...
type: reference
domain: sccm
slug: core-plan-client-authentication
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/cmg/plan-client-authentication
family: core
documentKind: "article"
abstract: "Plan for how clients authenticate to the cloud management gateway (CMG)."
---

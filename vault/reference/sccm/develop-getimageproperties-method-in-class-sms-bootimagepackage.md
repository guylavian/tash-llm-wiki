...
type: reference
domain: sccm
slug: develop-getimageproperties-method-in-class-sms-bootimagepackage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/getimageproperties-method-in-class-sms_bootimagepackage
family: develop
documentKind: "reference"
abstract: "The GetImageProperties WMI class method reads all metadata from the specified .wim source file for a boot image to an XML string."
---

# GetImageProperties Method in SMS_BootImagePackage

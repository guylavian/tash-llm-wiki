...
type: reference
domain: sccm
slug: develop-requirements-of-idmif-files
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/inventory/requirements-of-idmif-files
family: develop
documentKind: "article"
abstract: "Two delta header comments are required for an IDMIF file, the name of the architecture you want to create or modify and a unique ID for the instance."
---

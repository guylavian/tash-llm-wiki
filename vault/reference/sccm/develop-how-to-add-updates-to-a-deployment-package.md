...
type: reference
domain: sccm
slug: develop-how-to-add-updates-to-a-deployment-package
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/how-to-add-updates-to-a-deployment-package
family: develop
documentKind: "how-to"
abstract: "You add updates to a software updates deployment package, in Configuration Manager, by obtaining an instance of the SMS_SoftwareUpdatesPackage class and by using the AddUpdateContent method."
---

# Add Updates to a Deployment Package

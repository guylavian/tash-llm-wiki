...
type: reference
domain: sccm
slug: develop-how-to-set-the-distribute-on-demand-flag
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-set-the-distribute-on-demand-flag
family: develop
documentKind: "how-to"
abstract: "The following example shows how to set the \"distribute on demand\" flag property of an existing package by using the SMS_Package Server WMI Class class in Configuration Manager."
---

# Set the Distribute on Demand Flag

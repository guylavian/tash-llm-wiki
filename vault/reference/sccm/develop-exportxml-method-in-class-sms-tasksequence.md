...
type: reference
domain: sccm
slug: develop-exportxml-method-in-class-sms-tasksequence
tier: reference
...
abstract: "Learn how the ExportXml Method exports task sequence XML in a format that is suitable to use on another site."
---

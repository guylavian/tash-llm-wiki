...
type: reference
domain: sccm
slug: develop-sms-hardwareinventoryagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_hardwareinventoryagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_HardwareInventoryAgentConfig Windows Management Instrumentation class is an SMS Provider server class that specifies hardware inventory settings for client computers."
---

# SMS_HardwareInventoryAgentConfig Class

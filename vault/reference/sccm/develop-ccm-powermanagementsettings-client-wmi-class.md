...
type: reference
domain: sccm
slug: develop-ccm-powermanagementsettings-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/ccm_powermanagementsettings-client-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the CCM_PowerManagementSettings Windows Management Instrumentation class is an SMS Provider server class that contains methods to help manage client power management settings."
---

# CCM_PowerManagementSettings Class

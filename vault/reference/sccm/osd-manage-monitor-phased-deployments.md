...
type: reference
domain: sccm
slug: osd-manage-monitor-phased-deployments
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/manage-monitor-phased-deployments
family: osd
documentKind: "how-to"
abstract: "Understand how to manage and monitor phased deployments for software in Configuration Manager."
---

# Manage & monitor phased deployments

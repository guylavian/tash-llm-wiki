...
type: reference
domain: sccm
slug: core-reference-for-maintenance-tasks
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/reference-for-maintenance-tasks
family: core
documentKind: "reference"
abstract: "Details for each of the Configuration Manager site maintenance tasks"
---

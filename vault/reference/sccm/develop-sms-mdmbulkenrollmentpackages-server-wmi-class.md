...
type: reference
domain: sccm
slug: develop-sms-mdmbulkenrollmentpackages-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/mdm/sms_mdmbulkenrollmentpackages-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_MDMBulkEnrollmentPackages WMI class is an SMS Provider server class that represents on-premises Mobile Device Management bulk enrollment packages."
---

# SMS_MDMBulkEnrollmentPackages Class

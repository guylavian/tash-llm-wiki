...
type: reference
domain: sccm
slug: develop-clearlastnbsadvformachines-method-in-class-sms-collection
tier: reference
...
abstract: "The ClearLastNBSAdvForMachines Windows Management Instrumentation class method, in Configuration Manager, clears the last Network Boot advertisement for selected client computers."
---

# ClearLastNBSAdvForMachines Method

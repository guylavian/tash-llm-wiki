...
type: reference
domain: sccm
slug: apps-creating-mac-computer-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/get-started/creating-mac-computer-applications
family: apps
documentKind: "how-to"
abstract: "See which considerations you must take into account when you create and deploy applications for Mac computers."
---

...
type: reference
domain: sccm
slug: hotfix-37864969
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/hotfix/2509/37864969
family: hotfix
documentKind: "reference"
abstract: "Second update rollup for Configuration Manager 2509"
---
...
- **Security update for importing console extensions**

   This update enhances security in Configuration Manager for importing console extensions. For more information, see [KB 38232642](../2603/38232642.md).
...
- **Cloud Management Gateway virtual machine scale set image updated to remove end-of-life .NET 6**

   The Cloud Management Gateway (CMG) virtual machine scale set image is updated to use a new SKU that doesn't include .NET 6, which has reached end of life. For more information, see [KB 37942646](../2603/37942646.md).
...
- Cloud Management Gateway virtual machine scale set image updated to remove end-of-life .NET 6. For more information, see [KB 37942646](../2603/37942646.md).
- Security update for importing console extensions. For more information, see [KB 38232642](../2603/38232642.md).
...
- [KB 38232642](../2603/38232642.md): Security update for importing console extensions
- [KB 37942646](../2603/37942646.md): CMG virtual machine scale set image update

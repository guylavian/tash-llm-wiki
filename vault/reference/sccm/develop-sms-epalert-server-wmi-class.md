...
type: reference
domain: sccm
slug: develop-sms-epalert-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_epalert-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent System Center Endpoint Protection alerts using SMS_EPAlert in Configuration Manager."
---

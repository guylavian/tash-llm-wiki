...
type: reference
domain: sccm
slug: sum-example-scenario-deploy-monitor-monthly-security-updates
tier: reference
...
abstract: "How to use software updates in Configuration Manager to deploy and monitor monthly software updates."
---

# Example scenario to deploy and monitor updates

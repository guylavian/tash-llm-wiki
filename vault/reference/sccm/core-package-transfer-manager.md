...
type: reference
domain: sccm
slug: core-package-transfer-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/hierarchy/package-transfer-manager
family: core
documentKind: "concept-article"
abstract: "Understand how Package Transfer Manager in Configuration Manager transfers content from a site server to remote distribution points."
---

...
type: reference
domain: sccm
slug: tenant-attach-deploy-asr-policy
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/deploy-asr-policy
family: tenant-attach
documentKind: "install-set-up-deploy"
abstract: "Create and deploy Attack surface reduction policies from the Microsoft Intune admin center and for Configuration Manager collections."
---

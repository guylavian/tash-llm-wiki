...
type: reference
domain: sccm
slug: core-deploy-clients-to-windows-computers
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/deploy-clients-to-windows-computers
family: core
documentKind: "how-to"
abstract: "Learn how to deploy the Configuration Manager client to Windows computers."
---

# Deploy clients to Windows

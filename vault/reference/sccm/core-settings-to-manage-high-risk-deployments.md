...
type: reference
domain: sccm
slug: core-settings-to-manage-high-risk-deployments
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/settings-to-manage-high-risk-deployments
family: core
documentKind: "install-set-up-deploy"
abstract: "Configure deployment verification site settings in Configuration Manager to warn admins if they create a high-risk deployment."
---

...
type: reference
domain: sccm
slug: develop-sms-ch-summaryhistory-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_CH_SummaryHistory class to represent client summary histories."
---

# SMS_CH_SummaryHistory Class

...
type: reference
domain: sccm
slug: develop-sms-updategroupassignment-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a deployment of an update group in Configuration Manager using SMS_UpdateGroupAssignment."
---

# SMS_UpdateGroupAssignment Class

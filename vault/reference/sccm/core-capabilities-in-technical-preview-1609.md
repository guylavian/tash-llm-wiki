...
type: reference
domain: sccm
slug: core-capabilities-in-technical-preview-1609
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/get-started/capabilities-in-technical-preview-1609
family: core
documentKind: "whats-new"
abstract: "Learn about features available in the Technical Preview for Configuration Manager, version 1609."
---
...
If you need help with any of these settings, open [Manage settings and features on your devices with Microsoft Intune policies](../../../device-configuration/overview.md) and then select the settings subtopic for the platform you want.

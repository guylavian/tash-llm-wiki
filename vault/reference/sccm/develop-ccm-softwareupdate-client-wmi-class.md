...
type: reference
domain: sccm
slug: develop-ccm-softwareupdate-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/ccm_softwareupdate-client-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how enumerating the CCM_SoftwareUpdate Client WMI Class gives all the updates that are applicable and need to be installed."
---

# CCM_SoftwareUpdate Class

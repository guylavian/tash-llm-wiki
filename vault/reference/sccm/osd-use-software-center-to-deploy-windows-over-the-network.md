...
type: reference
domain: sccm
slug: osd-use-software-center-to-deploy-windows-over-the-network
tier: reference
...
family: osd
documentKind: "how-to"
abstract: "Deploy an OS from Software Center to refresh an existing computer with a new version of Windows or to upgrade Windows to the latest version."
---

...
type: reference
domain: sccm
slug: develop-ccm-service-systemtaskconfiguration-client-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the CCM_Service_SystemTaskConfiguration class is a client WMI class that supports system task configuration for the CCMEXEC service."
---

# CCM_Service_SystemTaskConfiguration Class

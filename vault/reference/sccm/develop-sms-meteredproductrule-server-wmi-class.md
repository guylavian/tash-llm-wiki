...
type: reference
domain: sccm
slug: develop-sms-meteredproductrule-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_meteredproductrule-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_MeteredProductRule WMI class is an SMS Provider server class that represents the rules that describe which files to meter."
---

# SMS_MeteredProductRule Class

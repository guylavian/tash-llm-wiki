...
type: reference
domain: sccm
slug: develop-sms-mdmbulkenrollmentprofiles-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/mdm/sms_mdmbulkenrollmentprofiles-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent On-premises Mobile Device Management (MDM) bulk enrollment profiles using SMS_BulkEnrollmentProfiles class."
---

# SMS_MDMBulkEnrollmentProfiles Class

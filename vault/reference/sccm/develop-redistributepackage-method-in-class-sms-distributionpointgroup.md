...
type: reference
domain: sccm
slug: develop-redistributepackage-method-in-class-sms-distributionpointgroup
tier: reference
...
abstract: "In Configuration Manager, The ReDistributePackage WMI class method redistributes a package to all of the member distribution points."
---

# ReDistributePackage Method

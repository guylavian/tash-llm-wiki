...
type: reference
domain: sccm
slug: develop-sms-ch-evalresult-server-wmi-class
tier: reference
...
abstract: "The SMS_CH_EvalResult Windows Management Instrumentation class is an SMS Provider server class, in Configuration Manager, that represents client evaluation results."
---

# SMS_CH_EvalResult Class

...
type: reference
domain: sccm
slug: develop-getadvertisements-method-in-class-sms-advertisement
tier: reference
...
abstract: "A Windows Management Instrumentation class method that gets the advertisement ID for a computer."
---

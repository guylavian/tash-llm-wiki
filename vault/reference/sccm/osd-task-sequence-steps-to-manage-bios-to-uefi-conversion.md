...
type: reference
domain: sccm
slug: osd-task-sequence-steps-to-manage-bios-to-uefi-conversion
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/task-sequence-steps-to-manage-bios-to-uefi-conversion
family: osd
documentKind: "how-to"
abstract: "Learn how to customize an OS deployment task sequence to prepare a FAT32 partition for transition to UEFI."
---

...
type: reference
domain: sccm
slug: develop-about-authoring-configuration-baselines-and-configuration-items
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/about-authoring-configuration-baselines-and-configuration-items
family: develop
documentKind: "concept-article"
abstract: "Learn about how to configure data through the Configuration Manager console or directly editing the DCM Digest XML file."
---

# Author configuration baselines and items

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-captureuserstateaction-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_TaskSequence_CaptureUserStateAction class in Configuration Manager to set a task sequence action that uses the User State Migration Tool (USMT) to capture user state and settings from the target computer."
---

# SMS_TaskSequence_CaptureUserStateAction Class

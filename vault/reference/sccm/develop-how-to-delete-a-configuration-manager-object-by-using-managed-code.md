...
type: reference
domain: sccm
slug: develop-how-to-delete-a-configuration-manager-object-by-using-managed-code
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to create a Configuration Manager object by using the managed SMS Provider with WqlConnectionManager.CreateInstance method."
---

# Delete an Object by Using Managed Code

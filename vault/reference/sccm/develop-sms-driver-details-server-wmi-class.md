...
type: reference
domain: sccm
slug: develop-sms-driver-details-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_driver_details-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to describe the list of drivers that have been added to the boot image with SMS_Driver_Details embedded class."
---

# SMS_Driver_Details Class

...
type: reference
domain: sccm
slug: develop-how-to-connect-to-an-sms-provider-by-using-managed-code
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-connect-to-an-sms-provider-by-using-managed-code
family: develop
documentKind: "how-to"
abstract: "To connect to an SMS Provider, use WqlConnectionManager.Connect."
---

# Connect to an SMS Provider by Using Managed Code

...
type: reference
domain: sccm
slug: core-monitor-hierarchy
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/monitor-hierarchy
family: core
documentKind: "article"
abstract: "Learn how to monitor your infrastructure in Configuration Manager by using the Monitoring workspace in the console."
---

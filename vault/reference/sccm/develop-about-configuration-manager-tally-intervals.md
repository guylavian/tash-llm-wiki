...
type: reference
domain: sccm
slug: develop-about-configuration-manager-tally-intervals
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/manage/about-configuration-manager-tally-intervals
family: develop
documentKind: "concept-article"
abstract: "The Configuration Manager is configured with 16 default tally intervals, which are maintained in the site control file shown in the following table."
---

# Configuration Manager Tally Intervals

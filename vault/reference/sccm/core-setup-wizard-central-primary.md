...
type: reference
domain: sccm
slug: core-setup-wizard-central-primary
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/setup-wizard-central-primary
family: core
documentKind: "how-to"
abstract: "Use the Configuration Manager setup wizard to install a new central administration site (CAS) or primary site."
---

# Install a CAS or primary site

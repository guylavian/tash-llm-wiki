...
type: reference
domain: sccm
slug: core-assign-clients-to-a-site
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/assign-clients-to-a-site
family: core
documentKind: "how-to"
abstract: "Before you can manage a client, it needs to assign to a primary site."
---

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-partitionsettings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_partitionsettings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_TaskSequence_PartitionSettings WMI class is an SMS Provider server class, in Configuration Manager, that specifies the settings to use when creating and formatting a partition on a hard drive."
---

# SMS_TaskSequence_PartitionSettings Class

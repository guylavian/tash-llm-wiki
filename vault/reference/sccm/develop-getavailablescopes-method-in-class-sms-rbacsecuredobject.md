...
type: reference
domain: sccm
slug: develop-getavailablescopes-method-in-class-sms-rbacsecuredobject
tier: reference
...
abstract: "The GetAvailableScopes Windows Management Instrumentation class method, in Configuration Manager, returns the secured scopes, which current user has the permission to grant to other accounts."
---

...
type: reference
domain: sccm
slug: osd-create-a-task-sequence-to-capture-an-operating-system
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-a-task-sequence-to-capture-an-operating-system
family: osd
documentKind: "how-to"
abstract: "A build-and-capture task sequence builds a reference computer that can include specific drivers and software updates along with the OS."
---

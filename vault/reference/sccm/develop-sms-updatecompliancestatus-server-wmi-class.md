...
type: reference
domain: sccm
slug: develop-sms-updatecompliancestatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_updatecompliancestatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent the client computer compliance status for software updates using SMS_UpdateComplianceStatus class."
---

# SMS_UpdateComplianceStatus Class

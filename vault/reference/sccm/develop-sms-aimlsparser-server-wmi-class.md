...
type: reference
domain: sccm
slug: develop-sms-aimlsparser-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_AIMLSParser Windows Management Instrumentation class imports license data."
---

# SMS_AIMLSParser Class

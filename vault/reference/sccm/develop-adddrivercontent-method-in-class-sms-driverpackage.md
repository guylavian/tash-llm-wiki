...
type: reference
domain: sccm
slug: develop-adddrivercontent-method-in-class-sms-driverpackage
tier: reference
...
abstract: "In Configuration Manager, the AddDriverContent Windows Management Instrumentation class method adds a driver to the driver package and replicates the driver content to distribution points."
---

# AddDriverContent Method

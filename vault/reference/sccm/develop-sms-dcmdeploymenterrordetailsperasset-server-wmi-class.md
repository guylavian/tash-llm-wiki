...
type: reference
domain: sccm
slug: develop-sms-dcmdeploymenterrordetailsperasset-server-wmi-class
tier: reference
...
abstract: "The SMS_DCMDeploymentErrorDetailsPerAsset WMI class is an SMS Provider server class that represents asset details per asset for a deployment error."
---

# SMS_DCMDeploymentErrorDetailsPerAsset Class

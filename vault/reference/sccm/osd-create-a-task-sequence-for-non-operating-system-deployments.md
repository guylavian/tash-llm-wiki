...
type: reference
domain: sccm
slug: osd-create-a-task-sequence-for-non-operating-system-deployments
tier: reference
...
abstract: "Create task sequences that aren't for deploying an OS, such as distributing software or automating tasks"
---

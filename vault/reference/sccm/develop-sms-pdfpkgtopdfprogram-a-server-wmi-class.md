...
type: reference
domain: sccm
slug: develop-sms-pdfpkgtopdfprogram-a-server-wmi-class
tier: reference
...
abstract: "Learn how to use SMS_PDFPkgToPDFProgram class to relate a SMS PDF Packager Server class object with an SMS PDF Program Server class object."
---

# SMS_PDFPkgToPDFProgram_a Class

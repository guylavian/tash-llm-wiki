...
type: reference
domain: sccm
slug: sum-office-365-dashboard
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/office-365-dashboard
family: sum
documentKind: "article"
abstract: "Review Microsoft 365 Apps client information from the Office 365 Client Management dashboard"
---

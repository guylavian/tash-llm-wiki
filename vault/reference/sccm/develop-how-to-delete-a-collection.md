...
type: reference
domain: sccm
slug: develop-how-to-delete-a-collection
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/collections/how-to-delete-a-collection
family: develop
documentKind: "how-to"
abstract: "Learn how your application can delete a collection in Configuration Manager by using the SMS_Collection Server WMI Class and class properties."
---

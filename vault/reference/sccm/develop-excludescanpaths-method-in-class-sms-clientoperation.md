...
type: reference
domain: sccm
slug: develop-excludescanpaths-method-in-class-sms-clientoperation
tier: reference
...
abstract: "Learn how to exclude scan paths from all members in a specified collection using the ExcludeScanPaths class method in Configuration Manager."
---

# ExcludeScanPaths Method

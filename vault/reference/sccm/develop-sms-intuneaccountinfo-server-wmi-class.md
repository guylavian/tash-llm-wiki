...
type: reference
domain: sccm
slug: develop-sms-intuneaccountinfo-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/mdm/sms_intuneaccountinfo-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_IntuneAccountInfo WMI class is an SMS Provider server class that represents Microsoft Intune account information."
---

# SMS_IntuneAccountInfo Class

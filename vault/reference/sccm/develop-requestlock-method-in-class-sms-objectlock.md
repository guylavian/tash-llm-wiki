...
type: reference
domain: sccm
slug: develop-requestlock-method-in-class-sms-objectlock
tier: reference
...
abstract: "Learn how to use the RequestLock method in Configuration Manager to synchronously acquire a lock to edit a global object."
---

...
type: reference
domain: sccm
slug: core-determine-whether-to-migrate-data
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/migration/determine-whether-to-migrate-data
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Learn which data you can migrate and which data you can't migrate to Configuration Manager current branch."
---

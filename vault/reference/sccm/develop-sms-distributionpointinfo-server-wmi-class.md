...
type: reference
domain: sccm
slug: develop-sms-distributionpointinfo-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_distributionpointinfo-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that provides information about a specific SMS_DistributionPoint server WMI class object."
---

# SMS_DistributionPointInfo class

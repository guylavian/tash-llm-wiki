...
type: reference
domain: sccm
slug: develop-sms-tasksequence-setupwindowsandsmsaction-server-wmi-class
tier: reference
...
abstract: "Learn how to use Configuration Manager SMS_TaskSequence_SetupWindowsAndSMSAction Windows Management Instrumentation (WMI) class to represent a task sequence action that specifies the additional installation properties."
---

# SMS_TaskSequence_SetupWindowsAndSMSAction Class

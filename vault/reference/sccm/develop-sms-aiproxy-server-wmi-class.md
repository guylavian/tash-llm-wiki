...
type: reference
domain: sccm
slug: develop-sms-aiproxy-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/asset-intelligence/sms_aiproxy-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Details of SMS_AIProxy server WMI class"
---

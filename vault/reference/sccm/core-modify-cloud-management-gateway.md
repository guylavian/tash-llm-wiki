...
type: reference
domain: sccm
slug: core-modify-cloud-management-gateway
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/cmg/modify-cloud-management-gateway
family: core
documentKind: "how-to"
abstract: "If you need to change the configuration, you can modify the cloud management gateway (CMG)."
---
...
> [!IMPORTANT]
>
> - Review the prerequisites for [virtual machine scale sets](plan-cloud-management-gateway.md#virtual-machine-scale-sets). For example, make sure that you register the necessary [Azure resource providers](configure-azure-ad.md#configure-azure-resource-providers) in the subscription<!-- memdocs#2434 -->. You also need both [Azure subscription Owner](/azure/role-based-access-control/built-in-roles#privileged) permission to the associated subscription and [Microsoft Entra Global Administrator](/entra/identity/role-based-access-control/permissions-reference#global-administrator) permissions for the associated tenant.

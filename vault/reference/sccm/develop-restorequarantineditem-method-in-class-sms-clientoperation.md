...
type: reference
domain: sccm
slug: develop-restorequarantineditem-method-in-class-sms-clientoperation
tier: reference
...
abstract: "The RestoreQuarantinedItem WMI class method that restores quarantined items to all members in a collection infected by specified threat."
---

# RestoreQuarantinedItem Method

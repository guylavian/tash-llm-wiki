...
type: reference
domain: sccm
slug: develop-how-to-get-the-unique-identifier-value-for-a-client
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-get-the-unique-identifier-value-for-a-client
family: develop
documentKind: "how-to"
abstract: "When you discover system resource data for a client, in Configuration Manager, you must specify the client's unique identifier value in the data discovery record (DDR)."
---

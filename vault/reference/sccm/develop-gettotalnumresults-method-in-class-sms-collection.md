...
type: reference
domain: sccm
slug: develop-gettotalnumresults-method-in-class-sms-collection
tier: reference
...
abstract: "The GetTotalNumResults Windows Management Instrumentation class method gets a count of all members in a collection, including subcollections."
---

# GetTotalNumResults Method

...
type: reference
domain: sccm
slug: tenant-attach-troubleshoot
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/troubleshoot
family: tenant-attach
documentKind: "troubleshooting"
abstract: "Troubleshoot tenant attach and device actions for Configuration Manager."
---

# Troubleshoot tenant attach and device actions

...
type: reference
domain: sccm
slug: develop-how-to-create-a-collection-variable
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-create-a-collection-variable
family: develop
documentKind: "how-to"
abstract: "Add instances of SMS_CollectionVariable Server WMI Class to the CollectionVariables property of SMS_CollectionSettings Server WMI Class."
---

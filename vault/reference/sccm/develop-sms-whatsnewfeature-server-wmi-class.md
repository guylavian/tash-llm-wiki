...
type: reference
domain: sccm
slug: develop-sms-whatsnewfeature-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/misc/sms_whatsnewfeature-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The following syntax is simplified from Managed Object Format (MOF) code and includes all inherited properties."
---

# SMS_WhatsNewFeature Class

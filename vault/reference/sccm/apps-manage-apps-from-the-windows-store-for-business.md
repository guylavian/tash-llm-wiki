...
type: reference
domain: sccm
slug: apps-manage-apps-from-the-windows-store-for-business
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/manage-apps-from-the-windows-store-for-business
family: apps
documentKind: "how-to"
abstract: "Manage and deploy apps from the Microsoft Store for Business and Education with Configuration Manager."
---

...
type: reference
domain: sccm
slug: develop-sms-sci-filedefinition-server-wmi-class
tier: reference
...
abstract: "Learn how to represent the basic properties of the site control file in Configuration Manager using SMS_SCI_FileDefinition."
---

# SMS_SCI_FileDefinition Class

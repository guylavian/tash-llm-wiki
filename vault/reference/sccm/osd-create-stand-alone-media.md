...
type: reference
domain: sccm
slug: osd-create-stand-alone-media
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-stand-alone-media
family: osd
documentKind: "how-to"
abstract: "Use stand-alone media to deploy the OS on a computer without a network connection."
---

...
type: reference
domain: sccm
slug: develop-sms-baselineassignment-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_BaselineAssignment Windows Management Instrumentation class is an SMS Provider server class that contains information about how a baseline is targeted."
---

# SMS_BaselineAssignment Class

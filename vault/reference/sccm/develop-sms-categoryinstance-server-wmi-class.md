...
type: reference
domain: sccm
slug: develop-sms-categoryinstance-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents a category instance for replicating information about a category, for example, a product or a classification, to all child sites."
---

# SMS_CategoryInstance Class

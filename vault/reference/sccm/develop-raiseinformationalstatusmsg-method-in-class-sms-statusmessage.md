...
type: reference
domain: sccm
slug: develop-raiseinformationalstatusmsg-method-in-class-sms-statusmessage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/raiseinformationalstatusmsg-method-in-class-sms_statusmessage
family: develop
documentKind: "reference"
abstract: "Learn how to create an informational status message in Configuration Manager using RaiseInformationalStatusMsg class."
---

# RaiseInformationalStatusMsg Method

...
type: reference
domain: sccm
slug: develop-sms-siteinstallmap-server-wmi-class
tier: reference
...
abstract: "Learn how to represent the site install map, which describes the layout of all installed features in Configuration Manager."
---

# SMS_SiteInstallMap Class

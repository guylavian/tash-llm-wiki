...
type: reference
domain: sccm
slug: develop-evaluateautodeployment-method-in-class-sms-autodeployment
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/evaluateautodeployment-method-in-class-sms_autodeployment
family: develop
documentKind: "reference"
abstract: "The EvaluateAutoDeployment WMI class method evaluates an automatic deployment."
---

# EvaluateAutoDeployment Method

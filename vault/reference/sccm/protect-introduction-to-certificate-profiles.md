...
type: reference
domain: sccm
slug: protect-introduction-to-certificate-profiles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/introduction-to-certificate-profiles
family: protect
documentKind: "article"
abstract: "Learn how certificate profiles in Configuration Manager work with Active Directory Certificate Services."
---

...
type: reference
domain: sccm
slug: protect-endpoint-protection-group-policies
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-protection-group-policies
family: protect
documentKind: "how-to"
abstract: "Learn how to manage Endpoint Protection using Group Policies."
---

# Manage Endpoint Protection using Group Policies

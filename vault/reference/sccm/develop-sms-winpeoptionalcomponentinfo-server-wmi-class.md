...
type: reference
domain: sccm
slug: develop-sms-winpeoptionalcomponentinfo-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_winpeoptionalcomponentinfo-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Represents WinPE optional components information."
---

# SMS_WinPEOptionalComponentInfo Class

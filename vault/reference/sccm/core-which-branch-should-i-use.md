...
type: reference
domain: sccm
slug: core-which-branch-should-i-use
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/understand/which-branch-should-i-use
family: core
documentKind: "article"
abstract: "Learn the differences between available branches of Configuration Manager."
---

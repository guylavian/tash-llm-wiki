...
type: reference
domain: sccm
slug: develop-sms-monthlyusagesummary-server-wmi-class
tier: reference
...
abstract: "The SMS_MonthlyUsageSummary WMI class is an SMS Provider server class that represents a monthly usage summary for a particular file."
---

# SMS_MonthlyUsageSummary Class

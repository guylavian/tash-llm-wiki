...
type: reference
domain: sccm
slug: develop-movemembersex-method-in-class-sms-objectcontaineritem
tier: reference
...
abstract: "Learn how the MoveMembersEx Windows Management Instrumentation (WMI) class method, in Configuration Manager, moves folder items to another folder."
---

# MoveMembersEx Method

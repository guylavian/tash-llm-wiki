...
type: reference
domain: sccm
slug: develop-sms-azureservice-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_azureservice-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_AzureService WMI class is an SMS Provider server class in Configuration Manager, that represents a Microsoft Azure service that is a cloud distribution point for Configuration Manager."
---

# SMS_AzureService class

...
type: reference
domain: sccm
slug: develop-sms-featureextension-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_featureextension-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_FeatureExtension class to represent feature extensions."
---

# SMS_FeatureExtension Class

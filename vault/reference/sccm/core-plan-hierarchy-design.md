...
type: reference
domain: sccm
slug: core-plan-hierarchy-design
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/cmg/plan-hierarchy-design
family: core
documentKind: "article"
abstract: "Design how to use a cloud management gateway (CMG) in your Configuration Manager hierarchy."
---

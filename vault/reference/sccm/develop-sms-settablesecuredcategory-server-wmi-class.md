...
type: reference
domain: sccm
slug: develop-sms-settablesecuredcategory-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_settablesecuredcategory-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Article outlining the use of SMS_SettableSecuredCategory class to assign secured categories to select objects."
---

# SMS_SettableSecuredCategory Class

...
type: reference
domain: sccm
slug: develop-sms-packagestatusrootsummarizer-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_packagestatusrootsummarizer-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_PackageStatusRootSummarizer Windows Management Instrumentation class is an SMS Provider server class, in Configuration Manager, that lists the distribution summary for a given package."
---

# SMS_PackageStatusRootSummarizer Class

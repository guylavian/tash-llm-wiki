...
type: reference
domain: sccm
slug: core-use-the-service-connection-tool
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/use-the-service-connection-tool
family: core
documentKind: "how-to"
abstract: "Learn about this tool that enables you to connect to the Configuration Manager cloud service to manually upload usage information."
---

...
type: reference
domain: sccm
slug: develop-import-method-in-class-sms-aimlsparser
tier: reference
...
abstract: "A Windows Management Instrumentation class method that imports the MLS statement as specified by the MLSFilepath parameter into the Configuration Manager database."
---

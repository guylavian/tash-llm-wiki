...
type: reference
domain: sccm
slug: develop-sms-adverttosourcesite-a-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_adverttosourcesite_a-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to relate an SMS Advertisement Server class object with the SMS Site Server class object that created the advertisement."
---

# SMS_AdvertToSourceSite_a Class

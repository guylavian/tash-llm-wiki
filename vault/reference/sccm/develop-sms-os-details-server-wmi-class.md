...
type: reference
domain: sccm
slug: develop-sms-os-details-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that describes the supported platforms, such as, operating system, architecture, and versions, on which a program can run."
---

# SMS_OS_Details Class

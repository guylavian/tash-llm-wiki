...
type: reference
domain: sccm
slug: develop-requestlockasync-method-in-class-sms-objectlock
tier: reference
...
abstract: "Learn how to use the RequestLockAsync method in Configuration Manager to asynchronously acquire a lock to edit global objects."
---

# RequestLockAsync Method

...
type: reference
domain: sccm
slug: tenant-attach-device-sync-actions
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/device-sync-actions
family: tenant-attach
documentKind: "how-to"
abstract: "Upload your Configuration Manager devices to the cloud service and take actions from the admin center."
---

# Enable Microsoft Intune tenant attach

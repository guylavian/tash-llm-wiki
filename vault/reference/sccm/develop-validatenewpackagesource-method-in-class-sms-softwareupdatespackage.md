...
type: reference
domain: sccm
slug: develop-validatenewpackagesource-method-in-class-sms-softwareupdatespackage
tier: reference
...
abstract: "Learn how to use the ValidateNewPackageSource class method to validate a new package source location for a software update."
---

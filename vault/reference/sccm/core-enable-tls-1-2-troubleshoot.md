...
type: reference
domain: sccm
slug: core-enable-tls-1-2-troubleshoot
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/security/enable-tls-1-2-troubleshoot
family: core
documentKind: "troubleshooting"
abstract: "Describes common issues when enabling Transport Layer Security (TLS) 1.2"
---

...
type: reference
domain: sccm
slug: develop-how-to-import-a-windows-driver-described-by-an-inf-file
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-import-a-windows-driver-described-by-an-inf-file
family: develop
documentKind: "how-to"
abstract: "You can import a Windows driver that is described by an information (.inf) file, in Configuration Manager, by using the CreateFromINF Method in Class SMS_Driver."
---

# Import a Windows Driver Described by an INF File

...
type: reference
domain: sccm
slug: develop-about-software-updates-deployments
tier: reference
...
abstract: "Learn about how to create software update deployments using the Configuration Manager SDK interfaces to deliver updates to client computers."
---

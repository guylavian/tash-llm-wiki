...
type: reference
domain: sccm
slug: compliance-browser-profiles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/browser-profiles
family: compliance
documentKind: "how-to"
abstract: "Configure settings for the Microsoft Edge Legacy web browser on Windows 10 clients"
---

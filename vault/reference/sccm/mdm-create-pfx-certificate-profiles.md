...
type: reference
domain: sccm
slug: mdm-create-pfx-certificate-profiles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/deploy-use/create-pfx-certificate-profiles
family: mdm
documentKind: "how-to"
abstract: "Learn how to use PFX files in Configuration Manager to generate user-specific certificates that support encrypted data exchange."
---

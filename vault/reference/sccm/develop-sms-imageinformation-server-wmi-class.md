...
type: reference
domain: sccm
slug: develop-sms-imageinformation-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_imageinformation-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent all image information in boot image, operating system image, and operating system installer using SMS_ImageInformation."
---

# SMS_ImageInformation Class

...
type: reference
domain: sccm
slug: develop-platformapplicabilitycondition
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/platformapplicabilitycondition
family: develop
documentKind: "reference"
abstract: "Learn how to specify one supported platform for an operating system deployment driver in Configuration Manager using PlatformApplicabilityCondition."
---

...
type: reference
domain: sccm
slug: core-use-the-hotfix-installer-to-install-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/use-the-hotfix-installer-to-install-updates
family: core
documentKind: "how-to"
abstract: "Find out when and how to install updates via the Hotfix Installer for Configuration Manager."
---

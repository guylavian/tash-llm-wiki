...
type: reference
domain: sccm
slug: develop-how-to-define-the-create-application-wizard-xml-file
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/apps/how-to-define-the-create-application-wizard-xml-file
family: develop
documentKind: "how-to"
abstract: "How to create a custom deployment technology XML File for the Create Application Wizard/."
---

...
type: reference
domain: sccm
slug: develop-how-to-create-an-operating-system-deployment-task-sequence-package
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "creates an instance of the SMS_TaskSequencePackage class. It is advertised to clients who can then run the task sequence."
---

# Create an OS Deployment Task Sequence Package

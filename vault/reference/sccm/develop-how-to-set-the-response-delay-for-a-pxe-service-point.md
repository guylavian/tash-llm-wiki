...
type: reference
domain: sccm
slug: develop-how-to-set-the-response-delay-for-a-pxe-service-point
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-set-the-response-delay-for-a-pxe-service-point
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you set the operating system deployment PXE service point response delay by updating the ResponseDelay embedded property."
---

# Set the Response Delay for a PXE Service Point

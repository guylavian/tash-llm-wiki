...
type: reference
domain: sccm
slug: develop-itsenvclass-interface
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/itsenvclass-interface
family: develop
documentKind: "reference"
abstract: "Learn how to represent the operating system deployment task sequencing environment with ITSEnvClass."
---

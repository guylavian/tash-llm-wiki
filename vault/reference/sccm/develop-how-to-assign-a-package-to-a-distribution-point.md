...
type: reference
domain: sccm
slug: develop-how-to-assign-a-package-to-a-distribution-point
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-assign-a-package-to-a-distribution-point
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, the following example shows how to assign a distribution point to a package by using the SMS_DistributionPoint and SMS_SystemResourceList classes."
---

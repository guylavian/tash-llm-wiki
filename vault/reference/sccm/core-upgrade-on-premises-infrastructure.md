...
type: reference
domain: sccm
slug: core-upgrade-on-premises-infrastructure
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/upgrade-on-premises-infrastructure
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Learn how to upgrade infrastructure, such as SQL Server and the OS of site systems."
---
...
- If you're upgrading the central administration site server or the primary site server, then [run a site reset](modify-your-infrastructure.md#bkmk_reset).

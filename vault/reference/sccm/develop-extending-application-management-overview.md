...
type: reference
domain: sccm
slug: develop-extending-application-management-overview
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/apps/extending-application-management-overview
family: develop
documentKind: "article"
abstract: "Partners that must continue to use a specific deployment technology not natively supported by Configuration Manager, can extend the Application Management model to support a custom deployment type."
---

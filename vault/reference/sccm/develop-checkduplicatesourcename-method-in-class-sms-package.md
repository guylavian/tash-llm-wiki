...
type: reference
domain: sccm
slug: develop-checkduplicatesourcename-method-in-class-sms-package
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/checkduplicatesourcename-method-in-class-sms_package
family: develop
documentKind: "reference"
abstract: "The CheckDuplicateSourceName Windows Management Instrumentation (WMI) class method determines if the specified source name is used by another package."
---

# CheckDuplicateSourceName Method

...
type: reference
domain: sccm
slug: develop-report-action
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/report-action
family: develop
documentKind: "article"
abstract: "Learn how to use report action in the configuration manager to display reports in the configuration manager console."
---

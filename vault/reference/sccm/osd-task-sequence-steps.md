...
type: reference
domain: sccm
slug: osd-task-sequence-steps
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/understand/task-sequence-steps
family: osd
documentKind: "reference"
abstract: "Learn about the steps that you can add to a Configuration Manager task sequence."
---

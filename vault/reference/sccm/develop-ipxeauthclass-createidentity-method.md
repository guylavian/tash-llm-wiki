...
type: reference
domain: sccm
slug: develop-ipxeauthclass-createidentity-method
tier: reference
...
abstract: "Learn how to use the CreateIdentity method to create a new self-signed certificate."
---

# IPxeAuthClass::CreateIdentity

...
type: reference
domain: sccm
slug: develop-sms-dcmdeploymentnoncompliantstatus-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents non-compliant status for a deployment."
---

# SMS_DCMDeploymentNonCompliantStatus Class

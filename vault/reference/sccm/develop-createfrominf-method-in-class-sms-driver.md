...
type: reference
domain: sccm
slug: develop-createfrominf-method-in-class-sms-driver
tier: reference
...
abstract: "Learn how to use the CreateFromINF method to create an SMS_Driver Server WMI class object based on information from the specified Microsoft Windows .inf file."
---

# CreateFromINF Method

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-disablebitlockeraction-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents a task sequence action, which disables the BitLocker encryption on the specified drive."
---

# SMS_TaskSequence_DisableBitLockerAction class

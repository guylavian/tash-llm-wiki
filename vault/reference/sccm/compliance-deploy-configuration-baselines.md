...
type: reference
domain: sccm
slug: compliance-deploy-configuration-baselines
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/deploy-configuration-baselines
family: compliance
documentKind: "install-set-up-deploy"
abstract: "Deploy configuration baselines to define configuration baseline deployments and to add or remove configuration baselines from deployments."
---

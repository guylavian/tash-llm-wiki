...
type: reference
domain: sccm
slug: develop-how-to-read-and-write-to-the-site-control-file-by-using-managed-code
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-read-and-write-to-the-site-control-file-by-using-managed-code
family: develop
documentKind: "how-to"
abstract: "To write to the Configuration Manager site control file by using the managed SMS Provider, get the site definition file by querying for the required resource or component."
---

# Read and Write to the Site Control File by Using Managed Code

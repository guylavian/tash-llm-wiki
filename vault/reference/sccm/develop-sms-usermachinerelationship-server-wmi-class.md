...
type: reference
domain: sccm
slug: develop-sms-usermachinerelationship-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_usermachinerelationship-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Use this server WMI class to manage user device affinity."
---

# SMS_UserMachineRelationship class

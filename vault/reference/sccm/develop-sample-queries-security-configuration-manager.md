...
type: reference
domain: sccm
slug: develop-sample-queries-security-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/sample-queries-security-configuration-manager
family: develop
documentKind: "how-to"
abstract: "Sample queries that show how to join security views to other views."
---

# Sample queries for security

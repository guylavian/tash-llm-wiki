...
type: reference
domain: sccm
slug: develop-getproviderversion-method-in-class-sms-identification
tier: reference
...
abstract: "In Configuration Manager, the GetProviderVersion Windows Management Instrumentation class method gets the product version string from the version resources of the SMS Provider DLL."
---

...
type: reference
domain: sccm
slug: protect-windows-hello-for-business-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/windows-hello-for-business-settings
family: protect
documentKind: "article"
abstract: "Learn how to integrate Windows Hello for Business with Configuration Manager."
---

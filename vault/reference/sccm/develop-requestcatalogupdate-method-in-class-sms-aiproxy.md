...
type: reference
domain: sccm
slug: develop-requestcatalogupdate-method-in-class-sms-aiproxy
tier: reference
...
abstract: "Learn how to synchronize the Asset Intelligence catalog with the System Center Online service using the RequestCatalogUpdate class."
---

# RequestCatalogUpdate Method

...
type: reference
domain: sccm
slug: develop-sms-settingsdefinitionbase-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_settingsdefinitionbase-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent the base class for settings definition in Configuration Manager using SMS_SettingsDefinitionBase class."
---

# SMS_SettingsDefinitionBase Class

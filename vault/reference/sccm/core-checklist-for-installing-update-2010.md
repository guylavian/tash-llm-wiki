...
type: reference
domain: sccm
slug: core-checklist-for-installing-update-2010
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/checklist-for-installing-update-2010
family: core
documentKind: "checklist"
abstract: "Learn about actions to take before updating to Configuration Manager version 2010."
---
...
<!--
At this time, version 2010 is released for the early update ring. To install this update, you need to opt-in. The following PowerShell script adds your hierarchy or standalone primary site to the early update ring for version 2010:

[Version 2010 opt-in script](https://go.microsoft.com/fwlink/?linkid=2099733) <!-- This fwlink points to the script package on the Download Center, don't change the link here! Make any changes to the fwlink target --<!--

Microsoft digitally signs the script, and bundles it inside a signed self-extracting executable.

> [!NOTE]
> The version 2010 update is only applicable to sites running version 1906 or later.
...
1. Run the **EnableEarlyUpdateRing2010.ps1** script, using the following syntax:

    `EnableEarlyUpdateRing2010.ps1 <SiteServer_Name> | SiteServer_IP>`

    Where `SiteServer` refers to the central administration site or standalone primary site server. For example, `EnableEarlyUpdateRing2010.ps1 cmprimary01`

1. Check for updates. For more information, see [Get available updates](install-in-console-updates.md#get-available-updates).

The version 2010 update should now be available in the console.

> [!IMPORTANT]
> This script only adds your site to the early update ring for version 2010. It's not a permanent change.
-->

...
type: reference
domain: sccm
slug: develop-insertmultipleresourceids-method-in-class-sms-mdmdeviceenrollmentmanagers
tier: reference
...
abstract: "WMI class method, in Configuration Manager, inserts multiple resource IDs."
---

# InsertMultipleResourceIds Method

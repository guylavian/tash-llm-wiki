...
type: reference
domain: sccm
slug: develop-how-to-list-all-programs-and-their-maximum-run-time-value
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-list-all-programs-and-their-maximum-run-time-value
family: develop
documentKind: "how-to"
abstract: "Learn how to list all programs with their maximum run time values by using the SMS_Package and SMS_Program classes and class properties."
---

# List All Programs and Their Maximum Run Time Value

...
type: reference
domain: sccm
slug: develop-geteula-method-in-class-sms-settingsdefinitionbase
tier: reference
...
abstract: "Learn how to get the localized Microsoft Software License Terms text of the configuration item using the GetEULA class method."
---

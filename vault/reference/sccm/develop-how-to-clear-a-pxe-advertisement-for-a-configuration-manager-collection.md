...
type: reference
domain: sccm
slug: develop-how-to-clear-a-pxe-advertisement-for-a-configuration-manager-collection
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "To clear a PXE advertisement for a Configuration Manager collection, you call the ClearLastNBSAdvForCollection Method in Class SMS_Collection"
---

# Clear a PXE Advertisement For a Collection

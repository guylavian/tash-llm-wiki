...
type: reference
domain: sccm
slug: core-introduction-to-queries
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/introduction-to-queries
family: core
documentKind: "article"
abstract: "Create and run queries to locate objects in a Configuration Manager hierarchy that match your query criteria."
---

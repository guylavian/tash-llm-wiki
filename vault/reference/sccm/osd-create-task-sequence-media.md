...
type: reference
domain: sccm
slug: osd-create-task-sequence-media
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-task-sequence-media
family: osd
documentKind: "article"
abstract: "Create task sequence media to deploy an OS to a destination computer in your Configuration Manager environment."
---

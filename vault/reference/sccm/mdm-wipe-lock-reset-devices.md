...
type: reference
domain: sccm
slug: mdm-wipe-lock-reset-devices
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/deploy-use/wipe-lock-reset-devices
family: mdm
documentKind: "how-to"
abstract: "Protect device data with full wipe, selective wipe, remote lock, or passcode reset by using Configuration Manager on-premises mobile device management (MDM)."
---

# Manage devices with on-premises MDM

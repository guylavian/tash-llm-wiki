...
type: reference
domain: sccm
slug: develop-sms-summarizationsettings-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class, in Configuration Manager, that represents the site summarization settings for a site."
---

# SMS_SummarizationSettings Class

...
type: reference
domain: sccm
slug: develop-how-to-disable-a-pxe-service-point-role
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-disable-a-pxe-service-point-role
family: develop
documentKind: "how-to"
abstract: "You disable the PXE Service Point role, in Configuration Manager, by getting an instance of a specific distribution point and setting the IsPXE value to 0."
---

# Disable a PXE Service Point Role

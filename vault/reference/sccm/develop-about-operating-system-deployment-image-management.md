...
type: reference
domain: sccm
slug: develop-about-operating-system-deployment-image-management
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/about-operating-system-deployment-image-management
family: develop
documentKind: "concept-article"
abstract: "There are several package types that Configuration Manager uses to manage reference computer operating system images."
---

# OS Deployment Image Management

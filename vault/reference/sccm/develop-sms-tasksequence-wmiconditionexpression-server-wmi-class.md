...
type: reference
domain: sccm
slug: develop-sms-tasksequence-wmiconditionexpression-server-wmi-class
tier: reference
...
abstract: "Represents a condition expression to check for the existence of results of a WMI query."
---

# SMS_TaskSequence_WMIConditionExpression Class

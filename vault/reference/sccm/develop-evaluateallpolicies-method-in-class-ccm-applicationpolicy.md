...
type: reference
domain: sccm
slug: develop-evaluateallpolicies-method-in-class-ccm-applicationpolicy
tier: reference
...
abstract: "A Windows Management Instrumentation class method that evaluates all policies."
---

# EvaluateAllPolicies Method

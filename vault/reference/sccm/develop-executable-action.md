...
type: reference
domain: sccm
slug: develop-executable-action
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/executable-action
family: develop
documentKind: "article"
abstract: "The executable action runs a program or opens a file by using the program registered with Windows for that file type."
---

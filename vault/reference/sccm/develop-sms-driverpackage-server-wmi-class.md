...
type: reference
domain: sccm
slug: develop-sms-driverpackage-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_driverpackage-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that represents the package, which is the unit of distribution of program binaries with which one or more device drivers are associated."
---

# SMS_DriverPackage Class

...
type: reference
domain: sccm
slug: develop-how-to-enable-or-disable-the-software-updates-client-agent
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "You enable or disable the Software Updates Client Agent, in Configuration Manager, by modifying the site control file settings."
---

# Enable or Disable the Software Updates Client Agent

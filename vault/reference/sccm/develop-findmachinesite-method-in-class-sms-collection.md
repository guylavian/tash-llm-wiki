...
type: reference
domain: sccm
slug: develop-findmachinesite-method-in-class-sms-collection
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/collections/findmachinesite-method-in-class-sms_collection
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the FindMachineSite Windows Management Instrumentation class method gets site code information for a specific resource."
---

# FindMachineSite Method

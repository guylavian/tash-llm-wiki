...
type: reference
domain: sccm
slug: develop-loadiconforpdf-method-in-class-sms-pdf-package
tier: reference
...
abstract: "In Configuration Manager, the LoadIconForPDF Windows Management Instrumentation class method imports a required icon for a package definition file."
---

# LoadIconForPDF Method

...
type: reference
domain: sccm
slug: develop-how-to-deploy-a-site-system-role-example-fallback-status-point
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-deploy-a-site-system-role--example---fallback-status-point-
family: develop
documentKind: "how-to"
abstract: "The features and capabilities of a site are determined by the site roles applied to it. Configuring a site is performed through Windows Management Instrumentation (WMI) classes."
---

# Deploy a Site System Role

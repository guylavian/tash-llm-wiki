...
type: reference
domain: sccm
slug: core-monitor-clients-cloud-management-gateway
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/cmg/monitor-clients-cloud-management-gateway
family: core
documentKind: "how-to"
abstract: "Monitor clients and network traffic through the cloud management gateway (CMG)."
---

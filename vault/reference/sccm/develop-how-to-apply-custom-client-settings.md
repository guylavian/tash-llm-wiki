...
type: reference
domain: sccm
slug: develop-how-to-apply-custom-client-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/programming/how-to-apply-custom-client-settings
family: develop
documentKind: "how-to"
abstract: "Use the SDK to apply custom client settings."
---

# Apply custom client settings

...
type: reference
domain: sccm
slug: core-migrate-data-between-hierarchies
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/migration/migrate-data-between-hierarchies
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Learn how to transfer data from a source hierarchy to a Configuration Manager destination hierarchy."
---

...
type: reference
domain: sccm
slug: develop-operating-system-deployment-task-sequence-object-model
tier: reference
...
abstract: "In Configuration Manager, operating system deployment task sequences are created and edited by using a Windows Management Instrumentation (WMI) class-based object model."
---

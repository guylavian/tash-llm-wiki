...
type: reference
domain: sccm
slug: develop-how-to-add-an-operating-system-image-package-in-configuration-manager
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Add an operating system image package by creating an instance of the SMS_ImagePackage class."
---

# Add an OS Image Package

...
type: reference
domain: sccm
slug: develop-exportdefaultbootimage-method-in-class-sms-bootimagepackage
tier: reference
...
abstract: "The ExportDefaultBootImage WMI class method finalizes a boot image and then exports the image from the specified source to the specified location."
---

# ExportDefaultBootImage Method

...
type: reference
domain: sccm
slug: osd-deploy-task-sequence-over-internet
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/deploy-task-sequence-over-internet
family: osd
documentKind: "how-to"
abstract: "Use this information to deploy a task sequence to remote computers."
---

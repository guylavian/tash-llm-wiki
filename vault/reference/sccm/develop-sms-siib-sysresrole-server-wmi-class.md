...
type: reference
domain: sccm
slug: develop-sms-siib-sysresrole-server-wmi-class
tier: reference
...
abstract: "Learn how to use SMS_SIIB_SysResRole to represent a system role associated with a console property page resource."
---

# SMS_SIIB_SysResRole Class

...
type: reference
domain: sccm
slug: develop-sms-tasksequencepackagereference-flat-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequencepackagereference_flat-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_TaskSequencePackageReference_Flat WMI class represents all classic package or application references for a task sequence."
---

# SMS_TaskSequencePackageReference_Flat Class

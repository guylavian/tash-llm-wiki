...
type: reference
domain: sccm
slug: comanage-how-to-monitor
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/comanage/how-to-monitor
family: comanage
documentKind: "how-to"
abstract: "Use the co-management dashboard to review information about co-managed devices."
---
...
| Error | Description |
|---------|---------|
| 2147549183 (0x8000FFFF) | MDM enrollment hasn't been configured yet on Microsoft Entra ID, or the enrollment URL isn't expected.<br><br>[Enable automatic enrollment](../../device-enrollment/windows/enable-automatic-mdm.md) |
| 2149056536 (0x80180018)<br>MENROLL_E_USERLICENSE | License of user is in bad state blocking enrollment<br><br>[Assign licenses to users](../../fundamentals/assign-licenses.md) |

...
type: reference
domain: sccm
slug: develop-how-to-perform-a-synchronous-configuration-manager-query-by-using-wmi
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you perform a synchronous query for Configuration Manager objects by calling the SWbemServices object ExecQuery method and passing a WQL query."
---

# Perform a Synchronous Query by Using WMI

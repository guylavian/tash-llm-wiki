...
type: reference
domain: sccm
slug: develop-how-to-assign-configuration-baselines
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/how-to-assign-configuration-baselines
family: develop
documentKind: "how-to"
abstract: "Learn how to assign a configuration baseline to a collection by creating an assignment instance, populated with a minimum set of required values, and saving."
---

# Assign Configuration Baselines

...
type: reference
domain: sccm
slug: core-fundamental-concepts-for-content-management
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/hierarchy/fundamental-concepts-for-content-management
family: core
documentKind: "concept-article"
abstract: "Use tools and options in Configuration Manager to manage the content that you deploy."
---
...
For more information, see [Microsoft Connected Cache with Configuration Manager](microsoft-connected-cache.md).

...
type: reference
domain: sccm
slug: core-configure-role-based-administration
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/configure-role-based-administration
family: core
documentKind: "how-to"
abstract: "Combine security roles, security scopes, and assigned collections to define the administrative scope for each administrative user."
---

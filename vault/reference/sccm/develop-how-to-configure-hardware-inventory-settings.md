...
type: reference
domain: sccm
slug: develop-how-to-configure-hardware-inventory-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/inventory/how-to-configure-hardware-inventory-settings
family: develop
documentKind: "how-to"
abstract: "Set the Hardware Inventory Client Agent settings by modifying the necessary site control file settings."
---

# Configure Hardware Inventory Settings

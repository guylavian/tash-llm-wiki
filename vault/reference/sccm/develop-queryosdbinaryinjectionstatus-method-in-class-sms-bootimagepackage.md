...
type: reference
domain: sccm
slug: develop-queryosdbinaryinjectionstatus-method-in-class-sms-bootimagepackage
tier: reference
...
abstract: "The QueryOSDBinaryInjectionStatus WMI class method, in Configuration Manager, queries the current status of the injection of operating system deployment binaries into a boot image."
---

# QueryOSDBinaryInjectionStatus Method

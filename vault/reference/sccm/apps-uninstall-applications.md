...
type: reference
domain: sccm
slug: apps-uninstall-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/uninstall-applications
family: apps
documentKind: "how-to"
abstract: "Uninstall an application by using Configuration Manager"
---

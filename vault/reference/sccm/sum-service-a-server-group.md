...
type: reference
domain: sccm
slug: sum-service-a-server-group
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/service-a-server-group
family: sum
documentKind: "how-to"
abstract: "Server groups have been replaced by orchestration groups"
---

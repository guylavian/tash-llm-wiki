...
type: reference
domain: sccm
slug: develop-how-to-configure-advertised-programs-client-agent-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-configure-advertised-programs-client-agent-settings
family: develop
documentKind: "how-to"
abstract: "Learn how to configure software distribution advertised programs client agent settings in the site control file."
---

# Configure Advertised Programs Client Agent Settings

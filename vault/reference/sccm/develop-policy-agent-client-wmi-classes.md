...
type: reference
domain: sccm
slug: develop-policy-agent-client-wmi-classes
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/policy-agent-client-wmi-classes
family: develop
documentKind: "reference"
abstract: "Describe the classes used, in Configuration Manager, to manage policy on client computers and devices."
---

...
type: reference
domain: sccm
slug: develop-unlock-method-in-class-sms-devicesettingpackage
tier: reference
...
abstract: "Sets the source site to the current site, unlocking the device setting package in Configuration Manager."
---

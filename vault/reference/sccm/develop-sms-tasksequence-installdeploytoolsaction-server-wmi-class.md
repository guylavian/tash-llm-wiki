...
type: reference
domain: sccm
slug: develop-sms-tasksequence-installdeploytoolsaction-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents a task sequence action to specify the Sysprep package for use with the operating system. The Sysprep package captures the reference computer settings."
---

# SMS_TaskSequence_InstallDeployToolsAction Class

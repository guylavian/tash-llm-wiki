...
type: reference
domain: sccm
slug: develop-about-configuration-manager-console-views
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/about-configuration-manager-console-views
family: develop
documentKind: "concept-article"
abstract: "Configuration Manager console views are displayed in the results pane of the Configuration Manager console."
---

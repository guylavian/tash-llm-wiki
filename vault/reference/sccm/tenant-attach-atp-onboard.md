...
type: reference
domain: sccm
slug: tenant-attach-atp-onboard
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/atp-onboard
family: tenant-attach
documentKind: "how-to"
abstract: "Deploy Microsoft Defender for Endpoint Detection and Response (EDR) onboarding policies to Configuration Manager managed clients from the admin center."
---

# Tenant attach - Onboard Configuration Manager clients to Microsoft Defender for Endpoint from the Microsoft Intune admin center

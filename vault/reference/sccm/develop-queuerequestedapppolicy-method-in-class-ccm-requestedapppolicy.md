...
type: reference
domain: sccm
slug: develop-queuerequestedapppolicy-method-in-class-ccm-requestedapppolicy
tier: reference
...
abstract: "In Configuration Manager, the QueueRequestedAppPolicy Windows Management Instrumentation class method that queues an application policy request."
---

# QueueRequestedAppPolicy Method

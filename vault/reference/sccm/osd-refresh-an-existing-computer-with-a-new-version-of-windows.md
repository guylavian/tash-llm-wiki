...
type: reference
domain: sccm
slug: osd-refresh-an-existing-computer-with-a-new-version-of-windows
tier: reference
...
family: osd
documentKind: "how-to"
abstract: "You can use several methods in Configuration Manager to partition and format an existing computer and install a new OS on the computer."
---

# Refresh an existing computer's OS

...
type: reference
domain: sccm
slug: develop-loadfromxml-method-in-class-sms-tasksequence
tier: reference
...
abstract: "In Configuration Manager, the LoadFromXml WMI class method loads a task sequence into WMI objects from task sequence XML."
---

...
type: reference
domain: sccm
slug: core-azure-template
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/get-started/azure-template
family: core
documentKind: "how-to"
abstract: "Automate the creation of a Configuration Manager technical preview lab or current branch evaluation lab using Azure templates"
---

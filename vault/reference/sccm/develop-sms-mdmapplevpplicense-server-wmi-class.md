...
type: reference
domain: sccm
slug: develop-sms-mdmapplevpplicense-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/mdm/sms_mdmapplevpplicense-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_MDMAppleVppLicense WMI class represents an Apple Volume Purchase Program (VPP) licensed application."
---

# SMS_MDMAppleVppLicense Class

...
type: reference
domain: sccm
slug: sum-updates-publisher-applicability-rules
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/tools/updates-publisher-applicability-rules
family: sum
documentKind: "how-to"
abstract: "Manage applicability rules for System Center Updates Publisher"
---

...
type: reference
domain: sccm
slug: develop-raiserawstatusmsg-method-in-class-sms-statusmessage
tier: reference
...
abstract: "The RaiseRawStatusMsg Windows Management Instrumentation (WMI) class method creates a status message from an external message DLL."
---

# RaiseRawStatusMsg Method

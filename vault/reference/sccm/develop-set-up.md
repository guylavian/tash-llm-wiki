...
slug: develop-set-up
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/adminservice/set-up
family: develop
documentKind: "how-to"
abstract: "Use the steps in this article to set up the administration service on your SMS Provider"
---

# How to set up the admin service

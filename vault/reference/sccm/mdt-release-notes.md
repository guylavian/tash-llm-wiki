...
type: reference
domain: sccm
slug: mdt-release-notes
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdt/release-notes
family: mdt
documentKind: "release-notes"
abstract: "Understand supported platforms, prerequisites, and limitations of the Microsoft Deployment Toolkit (MDT)."
---

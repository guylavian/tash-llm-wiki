...
type: reference
domain: sccm
slug: develop-sms-ci-localizedeulas-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class in Configuration Manager. It contains the localized Microsoft Software License Terms information for a configuration item."
---

# SMS_CI_LocalizedEulas Class

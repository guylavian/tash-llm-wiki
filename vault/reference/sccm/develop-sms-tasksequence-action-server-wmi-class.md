...
type: reference
domain: sccm
slug: develop-sms-tasksequence-action-server-wmi-class
tier: reference
...
abstract: "Learn how to use SMS_TaskSequence_Action class which serves as the abstract base class for all task sequence actions in Configuration Manager."
---

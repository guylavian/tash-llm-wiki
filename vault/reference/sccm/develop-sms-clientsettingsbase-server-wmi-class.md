...
type: reference
domain: sccm
slug: develop-sms-clientsettingsbase-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_clientsettingsbase-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_ClientSettingsBase WMI class is an SMS Provider server class, in Configuration Manager, that represents the base class used by several client settings related classes."
---

# SMS_ClientSettingsBase Class

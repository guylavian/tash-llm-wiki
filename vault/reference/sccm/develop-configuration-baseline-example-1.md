...
type: reference
domain: sccm
slug: develop-configuration-baseline-example-1
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/configuration-baseline-example-1
family: develop
documentKind: "article"
abstract: "This Baseline Configuration Item Instance example references an application configuration item that checks whether the Configuration Manager client and Notepad are installed on systems that are running Windows XP SP2."
---

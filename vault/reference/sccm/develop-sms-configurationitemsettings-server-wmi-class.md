...
type: reference
domain: sccm
slug: develop-sms-configurationitemsettings-server-wmi-class
tier: reference
...
abstract: "Learn how to represent configuration item settings using the SMS_ConfigurationItemSettings class in Configuration Manager."
---

# SMS_ConfigurationItemSettings Class

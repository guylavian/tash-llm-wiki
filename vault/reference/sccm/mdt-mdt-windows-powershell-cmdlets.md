...
type: reference
domain: sccm
slug: mdt-mdt-windows-powershell-cmdlets
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdt/mdt-windows-powershell-cmdlets
family: mdt
documentKind: "reference"
abstract: "Reference details for Microsoft Deployment Toolkit (MDT) Windows PowerShell Cmdlets"
---

# Toolkit reference - Microsoft Deployment Toolkit (MDT) Windows PowerShell Cmdlets

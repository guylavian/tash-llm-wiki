...
type: reference
domain: sccm
slug: develop-sms-remotetoolsagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_remotetoolsagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how the SMS_RemoteToolsAgentConfig class is an SMS Provider server class that specifies the Remote Control settings on client computers."
---

# SMS_RemoteToolsAgentConfig Class

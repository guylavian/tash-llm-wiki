...
type: reference
domain: sccm
slug: develop-how-to-enable-or-disable-the-advertised-programs-client-agent
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to enable or disable the Software Distribution Advertised Programs Client Agent setting in the site control file."
---

# Enable or Disable the Advertised Programs Client Agent

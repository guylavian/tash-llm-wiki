...
type: reference
domain: sccm
slug: sum-manage-office-365-proplus-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/manage-office-365-proplus-updates
family: sum
documentKind: "how-to"
abstract: "Configuration Manager synchronizes Microsoft 365 Apps client updates from the WSUS catalog to the site server to make updates available to deploy to clients."
---

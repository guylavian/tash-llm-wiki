...
type: reference
domain: sccm
slug: develop-idcmsdk-getassignedbaselines-method
tier: reference
...
abstract: "In Configuration Manager, the IDCMSDK::GetAssignedBaselines method enumerates assigned baseline configuration items."
---

# IDCMSDK::GetAssignedBaselines

...
type: reference
domain: sccm
slug: develop-how-to-perform-a-synchronous-configuration-manager-query-by-using-managed-code
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "To perform a synchronous query by using the managed SMS Provider, you use *WqlConnectionManager.QueryProcessor.ExecuteQuery* method."
---

# Perform a Synchronous Query by Using Managed Code

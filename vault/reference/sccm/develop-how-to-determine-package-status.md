...
type: reference
domain: sccm
slug: develop-how-to-determine-package-status
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/manage/how-to-determine-package-status
family: develop
documentKind: "how-to"
abstract: "Learn multiple ways to determine package status using package summarizer classes during the software distribution process."
---

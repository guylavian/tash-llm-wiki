...
type: reference
domain: sccm
slug: develop-sms-advertisement-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_advertisement-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_Advertisement Windows Management Instrumentation (WMI) class is an SMS Provider server class, in Configuration Manager, that represents an advertisement."
---

# SMS_Advertisement Class

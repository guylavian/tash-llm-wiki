...
type: reference
domain: sccm
slug: core-install-in-console-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/install-in-console-updates
family: core
documentKind: "how-to"
abstract: "Install updates to Configuration Manager from the Microsoft cloud."
---

...
type: reference
domain: sccm
slug: osd-create-a-task-sequence-to-install-an-operating-system
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-a-task-sequence-to-install-an-operating-system
family: osd
documentKind: "how-to"
abstract: "Use task sequences in Configuration Manager to automatically install an OS image and other content on a destination computer."
---

...
type: reference
domain: sccm
slug: mdt-tables-views-mdt-db
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdt/tables-views-mdt-db
family: mdt
documentKind: "reference"
abstract: "Reference details for Microsoft Deployment Toolkit (MDT) Tables and Views in the MDT DB"
---

# Toolkit reference - Microsoft Deployment Toolkit (MDT) Tables and Views in the MDT DB

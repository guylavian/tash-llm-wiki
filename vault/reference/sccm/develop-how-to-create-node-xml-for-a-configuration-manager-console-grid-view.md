...
type: reference
domain: sccm
slug: develop-how-to-create-node-xml-for-a-configuration-manager-console-grid-view
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-create-node-xml-for-a-configuration-manager-console-grid-view
family: develop
documentKind: "how-to"
abstract: "Learn how to create the node XML for the Configuration Manager console default grid view by creating an XML file describing a RootNodeDescription element."
---

# How to Create Node XML for a Grid View

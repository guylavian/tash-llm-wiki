...
type: reference
domain: sccm
slug: develop-ccm-clientagentsettings-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/ccm_clientagentsettings-client-wmi-class
family: develop
documentKind: "reference"
abstract: "A client class, in Configuration Manager, that contains common client agent settings."
---

# CCM_ClientAgentSettings Class

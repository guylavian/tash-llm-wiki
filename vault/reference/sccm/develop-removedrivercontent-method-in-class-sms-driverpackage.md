...
type: reference
domain: sccm
slug: develop-removedrivercontent-method-in-class-sms-driverpackage
tier: reference
...
abstract: "In Configuration Manager, the RemoveDriverContent WMI class method removes the specified driver from the driver package."
---

# RemoveDriverContent Method

...
type: reference
domain: sccm
slug: develop-iccmalternatedowloadprovider-interface
tier: reference
...
abstract: "Learn how to use the ICcmAlternateDownloadProvider Interface to define the interface for an alternative download provider to be invoked by Content Transfer Manager to download packages."
---

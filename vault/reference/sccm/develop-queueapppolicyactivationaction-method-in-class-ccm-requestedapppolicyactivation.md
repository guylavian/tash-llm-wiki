...
type: reference
domain: sccm
slug: develop-queueapppolicyactivationaction-method-in-class-ccm-requestedapppolicyactivation
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/queueapppolicyactivationaction-method-in-class-ccm_requestedapppolicyactivation
family: develop
documentKind: "reference"
abstract: "The QueueAppPolicyActivationAction WMI class method queues an application policy activation action."
---

# QueueAppPolicyActivationAction Method

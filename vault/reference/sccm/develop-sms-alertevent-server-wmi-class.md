...
type: reference
domain: sccm
slug: develop-sms-alertevent-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_alertevent-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that represents the event data for an alert."
---

# SMS_AlertEvent Class

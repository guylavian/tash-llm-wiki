...
type: reference
domain: sccm
slug: develop-sms-objectcontentinfo-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/console/sms_objectcontentinfo-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_ObjectContentInfo class in Configuration Manager to set application or package content information."
---

# SMS_ObjectContentInfo Class

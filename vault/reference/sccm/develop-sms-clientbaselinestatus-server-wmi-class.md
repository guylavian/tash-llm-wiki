...
type: reference
domain: sccm
slug: develop-sms-clientbaselinestatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/deploy/sms_clientbaselinestatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_ClientBaselineStatus WMI class is an SMS Provider server class, in Configuration Manager, that represents a client deployment baseline status."
---

# SMS_ClientBaselineStatus Class

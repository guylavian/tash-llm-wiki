...
type: reference
domain: sccm
slug: develop-sms-tasksequence-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent an operating system deployment task sequence using SMS_TaskSequence class in Configuration Manager."
---

# SMS_TaskSequence Class

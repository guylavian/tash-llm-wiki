...
type: reference
domain: sccm
slug: develop-sms-replicationgroup-server-wmi-class
tier: reference
...
abstract: "Learn how to classify replication group data in Configuration Manager using SMS_ReplicationGroup WMI class."
---

# SMS_ReplicationGroup Class

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-rebootaction-server-wmi-class
tier: reference
...
abstract: "Learn about the simplified syntax, methods, properties, and requirements of the SMS_TaskSequence_RebootAction server class."
---

# SMS_TaskSequence_RebootAction Class

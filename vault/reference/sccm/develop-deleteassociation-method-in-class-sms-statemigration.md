...
type: reference
domain: sccm
slug: develop-deleteassociation-method-in-class-sms-statemigration
tier: reference
...
abstract: "Delete the computer association between two system resources used in state migration."
---

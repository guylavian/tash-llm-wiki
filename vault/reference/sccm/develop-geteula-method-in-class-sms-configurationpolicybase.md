...
type: reference
domain: sccm
slug: develop-geteula-method-in-class-sms-configurationpolicybase
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/geteula-method-in-class-sms_configurationpolicybase
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the `GetEULA` Windows Management Instrumentation (WMI) class method gets the localized Microsoft Software License Terms text of the configuration item."
---

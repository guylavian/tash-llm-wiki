...
type: reference
domain: sccm
slug: develop-sms-collectioninfoinincrementalevaluationqueue-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/collections/sms_collectioninfoinincrementalevaluationqueue-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Show collection info from incremental evaluation queue."
---

# SMS_CollectionInfoInIncrementalEvaluationQueue class

...
type: reference
domain: sccm
slug: develop-how-to-read-a-configuration-manager-object-by-using-managed-code
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "The GetInstance method takes a string that identifies a specific object instance and returns an IResultObject that is used to access the object."
---

# Read an Object by Using Managed Code

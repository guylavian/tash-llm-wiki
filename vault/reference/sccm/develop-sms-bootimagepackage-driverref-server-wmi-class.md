...
type: reference
domain: sccm
slug: develop-sms-bootimagepackage-driverref-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents the association between a boot image package and a referenced driver."
---

# SMS_BootImagePackage_DriverRef Class

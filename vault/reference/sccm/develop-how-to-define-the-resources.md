...
type: reference
domain: sccm
slug: develop-how-to-define-the-resources
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/apps/how-to-define-the-resources
family: develop
documentKind: "how-to"
abstract: "To support the Installer, a custom XML schema should be included as part of the assembly and the schema XSD file must be included as a resource in the assembly."
---

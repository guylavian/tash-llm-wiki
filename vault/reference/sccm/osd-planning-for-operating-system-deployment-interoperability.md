...
type: reference
domain: sccm
slug: osd-planning-for-operating-system-deployment-interoperability
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/plan-design/planning-for-operating-system-deployment-interoperability
family: osd
documentKind: "install-set-up-deploy"
abstract: "Understand interoperability issues when different Configuration Manager sites in a single hierarchy use different versions."
---

# OS deployment interoperability

...
type: reference
domain: sccm
slug: develop-how-to-import-a-new-computer-into-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-import-a-new-computer-into-configuration-manager
family: develop
documentKind: "how-to"
abstract: "Add a new computer directly to the Configuration Manager database by calling the ImportMachineEntry Method in Class SMS_Site."
---

# Import a New Computer

...
type: reference
domain: sccm
slug: develop-how-to-change-the-deployment-package-source
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/how-to-change-the-deployment-package-source
family: develop
documentKind: "how-to"
abstract: "You change the deployment package source for a software updates deployment package in Configuration Manager by obtaining an instance of the SMS_SoftwareUpdatesPackage class and using the ValidateNewPackageSource method."
---

# Change the Deployment Package Source

...
type: reference
domain: sccm
slug: develop-sms-g-user-dcmdeploymenterrorassetdetails-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_g_user_dcmdeploymenterrorassetdetails-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_G_USER_DCMDeploymentErrorAssetDetails class in Configuration Manager to set the asset details for deployment errors."
---

# SMS_G_USER_DCMDeploymentErrorAssetDetails Class

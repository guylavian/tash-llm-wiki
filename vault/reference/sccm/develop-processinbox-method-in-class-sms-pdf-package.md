...
type: reference
domain: sccm
slug: develop-processinbox-method-in-class-sms-pdf-package
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/processinbox-method-in-class-sms_pdf_package
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the ProcessInBox Windows Management Instrumentation class method imports package definition files from the package definition file inbox."
---

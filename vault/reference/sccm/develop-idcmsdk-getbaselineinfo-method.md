...
type: reference
domain: sccm
slug: develop-idcmsdk-getbaselineinfo-method
tier: reference
...
abstract: "Learn how to retrieve the baseline info for the specified configuration item using IDCMSDK::GetBaselineInfo method."
---

# IDCMSDK::GetBaselineInfo

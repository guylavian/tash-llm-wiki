...
type: reference
domain: sccm
slug: osd-manage-windows-as-a-service
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/manage-windows-as-a-service
family: osd
documentKind: "how-to"
abstract: "View the state of Windows as a Service (WaaS) using Configuration Manager, create servicing plans to form deployment rings, and view alerts when Windows clients are near end of support."
---

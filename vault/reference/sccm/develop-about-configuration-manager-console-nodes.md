...
type: reference
domain: sccm
slug: develop-about-configuration-manager-console-nodes
tier: reference
...
abstract: "Learn how to use XML to define nodes and their content, which you see in the Configuration Manager console."
---

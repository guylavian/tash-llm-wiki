...
type: reference
domain: sccm
slug: develop-sms-tasksequence-registryconditionexpression-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a condition expression to check for the existence of a registry key and compare it to data."
---

# SMS_TaskSequence_RegistryConditionExpression Class

...
type: reference
domain: sccm
slug: develop-sms-applicationassignment-server-wmi-class
tier: reference
...
abstract: "The SMS_ApplicationAssignment WMI class represents the assignment of an application to a collection."
---

# SMS_ApplicationAssignment Class

...
type: reference
domain: sccm
slug: develop-how-to-reset-the-hardware-inventory-cache
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you reset the hardware inventory cache by connecting to the inventory agent namespace and deleting the inventory action status instance for hardware inventory."
---

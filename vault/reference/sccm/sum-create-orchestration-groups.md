...
type: reference
domain: sccm
slug: sum-create-orchestration-groups
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/create-orchestration-groups
family: sum
documentKind: "how-to"
abstract: "Create, edit, and use orchestration groups."
---

...
type: reference
domain: sccm
slug: develop-removepackages-method-in-class-sms-distributionpointgroup
tier: reference
...
abstract: "In Configuration Manager, the RemovePackages WMI class method removes a set of packages from this distribution point group."
---

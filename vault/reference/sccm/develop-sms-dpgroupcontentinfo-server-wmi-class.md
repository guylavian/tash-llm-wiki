...
type: reference
domain: sccm
slug: develop-sms-dpgroupcontentinfo-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that describes package information for a given distribution point group."
---

# SMS_DPGroupContentInfo Class

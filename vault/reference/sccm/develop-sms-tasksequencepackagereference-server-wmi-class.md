...
type: reference
domain: sccm
slug: develop-sms-tasksequencepackagereference-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class, in Configuration Manager, that represents a Configuration Manager application or package in the task sequence."
---

# SMS_TaskSequencePackageReference Class

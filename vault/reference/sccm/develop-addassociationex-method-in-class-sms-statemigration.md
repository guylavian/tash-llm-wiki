...
type: reference
domain: sccm
slug: develop-addassociationex-method-in-class-sms-statemigration
tier: reference
...
abstract: "Adds the computer association between two system resources used in state migration."
---

# AddAssociationEx Method

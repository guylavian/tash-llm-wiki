...
type: reference
domain: sccm
slug: core-prerequisites-for-installing-sites
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/prerequisites-for-installing-sites
family: core
documentKind: "article"
abstract: "Learn about prerequisites for installing the different types of Configuration Manager sites."
---

# Prerequisites for sites

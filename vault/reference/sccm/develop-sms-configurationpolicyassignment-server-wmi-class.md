...
type: reference
domain: sccm
slug: develop-sms-configurationpolicyassignment-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_ConfigurationPolicyAssignment to represent the deployment of an instance of SMS_ConfigurationPolicy in Configuration Manager."
---

# SMS_ConfigurationPolicyAssignment Class

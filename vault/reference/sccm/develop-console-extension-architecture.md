...
type: reference
domain: sccm
slug: develop-console-extension-architecture
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/console-extension-architecture
family: develop
documentKind: "article"
abstract: "The Configuration Manager console architecture is built on the following four distinct layers."
---

# Console Extension Architecture

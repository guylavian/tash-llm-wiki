...
type: reference
domain: sccm
slug: develop-sms-tasksequence-fileconditionexpression-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_fileconditionexpression-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_TaskSequence_FileConditionExpression class to represent a condition expression to check for the existence of a file and its creation time."
---

# SMS_TaskSequence_FileConditionExpression Class

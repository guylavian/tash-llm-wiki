...
type: reference
domain: sccm
slug: develop-sms-packagetosourcesite-a-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SiteCode property to relate an SMS_Package Server class object to the SMS_Site Server class object for the site that created the package."
---

# SMS_PackageToSourceSite_a Class

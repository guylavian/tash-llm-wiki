...
type: reference
domain: sccm
slug: develop-sms-tasksequence-runcommandlineaction-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_runcommandlineaction-server-wmi-class
family: develop
documentKind: "reference"
abstract: "an SMS Provider server class in Configuration Manager. It represents a task sequence action that runs a user-specified command line."
---

# SMS_TaskSequence_RunCommandLineAction class

...
type: reference
domain: sccm
slug: develop-how-to-configure-and-deploy-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/how-to-configure-and-deploy-updates
family: develop
documentKind: "how-to"
abstract: "Learn how to use the Configuration Manager SDK to configure and deploy software updates"
---

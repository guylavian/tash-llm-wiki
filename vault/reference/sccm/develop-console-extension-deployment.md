...
type: reference
domain: sccm
slug: develop-console-extension-deployment
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/console-extension-deployment
family: develop
documentKind: "install-set-up-deploy"
abstract: "The deployment of a typical Configuration Manager extension has to account for actions, forms, views, management classes and node extensions."
---

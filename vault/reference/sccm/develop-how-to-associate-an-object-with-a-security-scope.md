...
type: reference
domain: sccm
slug: develop-how-to-associate-an-object-with-a-security-scope
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "To assign multiple objects to a scope, use the AddMemberships Method in Class SMS_SecuredCategoryMembership."
---

# Associate an Object with a Security Scope

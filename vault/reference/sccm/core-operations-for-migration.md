...
type: reference
domain: sccm
slug: core-operations-for-migration
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/migration/operations-for-migration
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Create and run jobs to migrate data and clients to Configuration Manager current branch."
---

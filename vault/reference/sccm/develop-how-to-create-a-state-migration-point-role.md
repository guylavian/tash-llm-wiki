...
type: reference
domain: sccm
slug: develop-how-to-create-a-state-migration-point-role
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-create-a-state-migration-point-role
family: develop
documentKind: "how-to"
abstract: "You create the state migration point role, in Configuration Manager, by creating an instance of SMS_SCI_SysResUse Server WMI Class and providing the property values in the following table."
---

# Create a State Migration Point Role

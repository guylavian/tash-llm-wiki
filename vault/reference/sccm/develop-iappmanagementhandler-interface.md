...
type: reference
domain: sccm
slug: develop-iappmanagementhandler-interface
tier: reference
...
abstract: "Learn how to define functions to interact with the handler in Configuration Manager using IAppManagementHandler."
---

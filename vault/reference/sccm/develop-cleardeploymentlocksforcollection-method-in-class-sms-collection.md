...
type: reference
domain: sccm
slug: develop-cleardeploymentlocksforcollection-method-in-class-sms-collection
tier: reference
...
abstract: "Article describing the use of ClearDeploymentLocksForCollection class method in Configuration Manager."
---

# ClearDeploymentLocksForCollection Method

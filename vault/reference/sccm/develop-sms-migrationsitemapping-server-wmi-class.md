...
type: reference
domain: sccm
slug: develop-sms-migrationsitemapping-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/migration/sms_migrationsitemapping-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The technical details of the SMS_MigrationSiteMapping server WMI class."
---

# SMS_MigrationSiteMapping class

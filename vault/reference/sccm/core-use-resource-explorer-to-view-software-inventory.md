...
type: reference
domain: sccm
slug: core-use-resource-explorer-to-view-software-inventory
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/inventory/use-resource-explorer-to-view-software-inventory
family: core
documentKind: "how-to"
abstract: "Use Resource Explorer to view software inventory in Configuration Manager."
---

# View software inventory with Resource Explorer

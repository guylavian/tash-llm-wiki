...
type: reference
domain: sccm
slug: develop-discovery-views-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/discovery-views-configuration-manager
family: develop
documentKind: "reference"
abstract: "System resource objects, which include any resources that were discovered on the network."
---

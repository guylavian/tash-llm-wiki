...
type: reference
domain: sccm
slug: develop-sms-resourcemap-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_resourcemap-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_ResourceMap Windows Management Instrumentation (WMI) class is an SMS Provider server class, in Configuration Manager, that maps a resource type to its resource class name and display name."
---

# SMS_ResourceMap Class

...
type: reference
domain: sccm
slug: core-removed-and-deprecated-server
tier: reference
...
abstract: "Learn about the products and operating systems that Configuration Manager no longer supports for site servers and database servers."
---

# Deprecated for site servers

...
type: reference
domain: sccm
slug: develop-getsdmdefinition-method-in-class-sms-configurationitem
tier: reference
...
abstract: "Learn how to retrieve the System Definition Model (SDM) definition of the configuration item in XML format using GetSDMDefinition class method."
---

# GetSDMDefinition Method

...
type: reference
domain: sccm
slug: develop-ccm-powermanagementclientoptoutsetting-client-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the CCM_PowerManagementClientOptoutSetting Windows Management Instrumentation class is an SMS Provider server class that represents the settings that allow users to exclude their device from power management."
---

# CCM_PowerManagementClientOptoutSetting Class

...
type: reference
domain: sccm
slug: develop-how-to-call-a-wmi-class-method-by-using-system-management
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/programming/how-to-call-a-wmi-class-method-by-using-system.management
family: develop
documentKind: "how-to"
abstract: "To call a client Windows Management Instrumentation (WMI) class method, call the InvokeMethod of the WMI class's ManagementClass."
---

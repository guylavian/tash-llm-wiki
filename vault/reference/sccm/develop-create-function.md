...
type: reference
domain: sccm
slug: develop-create-function
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/create-function
family: develop
documentKind: "reference"
abstract: "The Create function creates a status MIF file that Configuration Manager uses to correlate the install status for an advertisement."
---

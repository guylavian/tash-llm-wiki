...
type: reference
domain: sccm
slug: develop-sms-pxecertificateinfo-server-wmi-class
tier: reference
...
abstract: "Learn how to define a media certificate that is registered by Configuration Manager and used by PXE clients to communicate with a management point."
---

# SMS_PXECertificateInfo Class

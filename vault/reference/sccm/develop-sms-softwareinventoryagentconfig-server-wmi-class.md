...
type: reference
domain: sccm
slug: develop-sms-softwareinventoryagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_softwareinventoryagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to specify how client computers retrieve software inventory in Configuration Manager using SMS_SoftwareInventoryAgentConfig."
---

# SMS_SoftwareInventoryAgentConfig Class

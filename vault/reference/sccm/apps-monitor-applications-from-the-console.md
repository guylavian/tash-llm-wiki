...
type: reference
domain: sccm
slug: apps-monitor-applications-from-the-console
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/monitor-applications-from-the-console
family: apps
documentKind: "how-to"
abstract: "Monitor deployment applications with the Monitoring workspace in Configuration Manager."
---

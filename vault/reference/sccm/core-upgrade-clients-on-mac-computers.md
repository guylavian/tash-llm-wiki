...
type: reference
domain: sccm
slug: core-upgrade-clients-on-mac-computers
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/upgrade/upgrade-clients-on-mac-computers
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Upgrade the Configuration Manager client on Mac computers."
---

# Upgrade macOS clients

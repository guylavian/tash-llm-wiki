...
type: reference
domain: sccm
slug: develop-how-to-create-a-program
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-create-a-program
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, the following example shows how to create a program by using the SMS_Program class and class properties."
---

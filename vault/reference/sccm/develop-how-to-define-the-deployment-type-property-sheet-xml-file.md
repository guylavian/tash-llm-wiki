...
type: reference
domain: sccm
slug: develop-how-to-define-the-deployment-type-property-sheet-xml-file
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/apps/how-to-define-the-deployment-type-property-sheet-xml-file
family: develop
documentKind: "how-to"
abstract: "Learn how to create and define the custom deployment type property page XML file for use within Configuration Manager."
---

# Define the Deployment Type Property Sheet XML File

...
type: reference
domain: sccm
slug: develop-how-to-read-user-defined-status-messages
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you can read user-defined status messages, on the site server, by querying the SMS Provider."
---

# Read User-Defined Status Messages

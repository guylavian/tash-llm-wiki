...
type: reference
domain: sccm
slug: develop-how-to-enumerate-the-administrative-assignments-for-a-user-or-security-group
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-enumerate-the-administrative-assignments-for-a-user-or-security-group
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, the administrative assignments for a user or security group are defined by the roles and security scopes assigned to that user or security group."
---

# Enumerate Administrative Assignments

...
type: reference
domain: sccm
slug: develop-how-to-delete-a-maintenance-window-for-a-collection
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to delete a maintenance window for a collection in Configuration Manager with the following example."
---

# Delete a Maintenance Window for a Collection

...
type: reference
domain: sccm
slug: core-add-site-system-roles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/add-site-system-roles
family: core
documentKind: "overview"
abstract: "Understand Configuration Manager site system roles and how to add them to extend the functionality and capacity of your site."
---

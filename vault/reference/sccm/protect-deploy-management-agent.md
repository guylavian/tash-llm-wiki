...
type: reference
domain: sccm
slug: protect-deploy-management-agent
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/bitlocker/deploy-management-agent
family: protect
documentKind: "how-to"
abstract: "Deploy the BitLocker management agent to Configuration Manager clients and the recovery service to management points"
---
...
- [Use device encryption with Intune](../../../../device-configuration/endpoint-security/encrypt-bitlocker-windows.md)

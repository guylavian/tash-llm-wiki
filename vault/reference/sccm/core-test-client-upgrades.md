...
type: reference
domain: sccm
slug: core-test-client-upgrades
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/upgrade/test-client-upgrades
family: core
documentKind: "how-to"
abstract: "Test client upgrades in a pre-production collection in Configuration Manager."
---

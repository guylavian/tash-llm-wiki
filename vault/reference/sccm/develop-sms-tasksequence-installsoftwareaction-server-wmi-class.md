...
type: reference
domain: sccm
slug: develop-sms-tasksequence-installsoftwareaction-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_installsoftwareaction-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_TaskSequence_InstallSoftwareAction class to represent task sequence actions that install software."
---

# SMS_TaskSequence_InstallSoftwareAction Class

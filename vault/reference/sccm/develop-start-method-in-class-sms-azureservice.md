...
type: reference
domain: sccm
slug: develop-start-method-in-class-sms-azureservice
tier: reference
...
abstract: "In Configuration Manager, The Start WMI class method is invoked to start a Microsoft Azure service that represents a cloud distribution point for Configuration Manager."
---

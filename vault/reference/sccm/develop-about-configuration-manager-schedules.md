...
type: reference
domain: sccm
slug: develop-about-configuration-manager-schedules
tier: reference
...
abstract: "The SMS_ScheduleToken WMI class is an abstract parent class for the SMS_ST_ schedule token classes that handle the scheduling of events with differing frequencies."
---

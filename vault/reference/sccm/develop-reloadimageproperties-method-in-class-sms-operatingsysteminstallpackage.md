...
type: reference
domain: sccm
slug: develop-reloadimageproperties-method-in-class-sms-operatingsysteminstallpackage
tier: reference
...
abstract: "Learn how to use the ReloadImageProperties method in class SMS_OperatingSystemInstallPackage reload metadata from the source .wim file and synchronize the metadata with the database."
---

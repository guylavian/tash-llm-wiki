...
type: reference
domain: sccm
slug: develop-sms-query-server-wmi-class
tier: reference
...
abstract: "The SMS_Query Windows Management Instrumentation (WMI) class is an SMS Provider server class. It serves as a container for predefined queries."
---

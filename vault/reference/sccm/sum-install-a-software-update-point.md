...
type: reference
domain: sccm
slug: sum-install-a-software-update-point
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/get-started/install-a-software-update-point
family: sum
documentKind: "how-to"
abstract: "Primary sites require a software update point on the central administration site for software updates compliance assessment and to deploy software updates to clients."
---

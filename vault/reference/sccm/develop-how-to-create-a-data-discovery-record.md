...
type: reference
domain: sccm
slug: develop-how-to-create-a-data-discovery-record
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-create-a-data-discovery-record
family: develop
documentKind: "how-to"
abstract: "Specify the resource type, the discovery process, the site that discovered the resource, and the resource properties."
---

# Create a Data Discovery Record

...
type: reference
domain: sccm
slug: develop-changeownership-method-in-class-sms-collection
tier: reference
...
abstract: "Learn how the ChangeOwnership Windows Management Instrumentation (WMI) class method, in Configuration Manager, changes ownership of the devices."
---

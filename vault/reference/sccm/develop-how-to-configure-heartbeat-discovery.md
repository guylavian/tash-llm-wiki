...
type: reference
domain: sccm
slug: develop-how-to-configure-heartbeat-discovery
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-configure-heartbeat-discovery
family: develop
documentKind: "how-to"
abstract: "Learn how to configure the Heartbeat Discovery settings by modifying the necessary site control file settings in Configuration Manager."
---

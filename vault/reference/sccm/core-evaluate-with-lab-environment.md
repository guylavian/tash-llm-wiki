...
type: reference
domain: sccm
slug: core-evaluate-with-lab-environment
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/get-started/evaluate-with-lab-environment
family: core
documentKind: "article"
abstract: "Create a lab environment to evaluate Configuration Manager for use in your organization."
---

# Evaluate in a lab environment

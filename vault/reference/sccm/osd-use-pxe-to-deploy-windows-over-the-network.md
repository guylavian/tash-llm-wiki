...
type: reference
domain: sccm
slug: osd-use-pxe-to-deploy-windows-over-the-network
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/use-pxe-to-deploy-windows-over-the-network
family: osd
documentKind: "how-to"
abstract: "Use PXE-initiated OS deployments to refresh a computer's operating system or to install a new version of Windows on a new computer."
---

# Use PXE for OSD over the network

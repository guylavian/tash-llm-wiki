...
type: reference
domain: sccm
slug: mdm-user-enroll-devices-on-premises-mdm
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/deploy-use/user-enroll-devices-on-premises-mdm
family: mdm
documentKind: "article"
abstract: "Understand how users enroll devices with on-premises mobile device management (MDM) in Configuration Manager."
---

# How users enroll devices

...
type: reference
domain: sccm
slug: develop-release-notes
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/adminservice/release-notes
family: develop
documentKind: "release-notes"
abstract: "Information about changes to the administration service with each Configuration Manager release"
---

# Admin service release notes

...
type: reference
domain: sccm
slug: develop-sms-browserhelperobject-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/sms_browserhelperobject-client-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_BrowserHelperObject class is a client Windows Management Instrumentation class that enumerates all browser helper objects on a computer."
---

# SMS_BrowserHelperObject Class

...
type: reference
domain: sccm
slug: sum-integrate-windows-update-for-business-windows-10
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/integrate-windows-update-for-business-windows-10
family: sum
documentKind: "integration"
abstract: "Use Windows Update client policies to keep Windows up-to-date for devices connected to the Windows Update service."
---

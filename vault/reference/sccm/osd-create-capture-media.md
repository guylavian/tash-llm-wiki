...
type: reference
domain: sccm
slug: osd-create-capture-media
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-capture-media
family: osd
documentKind: "how-to"
abstract: "Use capture media in Configuration Manager to capture an OS image from a reference computer."
---

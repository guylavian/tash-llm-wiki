...
type: reference
domain: sccm
slug: core-extend-the-active-directory-schema
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/network/extend-the-active-directory-schema
family: core
documentKind: "how-to"
abstract: "Extend the Active Directory schema for Configuration Manager to simplify the process of deploying and configuring clients."
---

# Publishing and the Active Directory schema

...
type: reference
domain: sccm
slug: develop-how-to-create-an-operating-system-deployment-task-sequence-group
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-create-an-operating-system-deployment-task-sequence-group
family: develop
documentKind: "how-to"
abstract: "An operating system deployment task sequence group can be added to a task sequence by creating an instance of the SMS_TaskSequence_Group class."
---

# Create an OS Deployment Task Sequence Group

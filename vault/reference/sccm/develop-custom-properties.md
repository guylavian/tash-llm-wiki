...
type: reference
domain: sccm
slug: develop-custom-properties
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/adminservice/custom-properties
family: develop
documentKind: "how-to"
abstract: "Use the administration service to set custom property data on devices, for reporting or collections."
---

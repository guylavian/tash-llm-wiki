...
type: reference
domain: sccm
slug: develop-how-to-modify-advertisement-properties
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-modify-advertisement-properties
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, the following example shows how to modify an existing advertisement by using the SMS_Advertisement class and class properties."
---

# Modify Advertisement Properties

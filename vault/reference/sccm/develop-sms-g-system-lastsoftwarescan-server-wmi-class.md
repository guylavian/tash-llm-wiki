...
type: reference
domain: sccm
slug: develop-sms-g-system-lastsoftwarescan-server-wmi-class
tier: reference
...
abstract: "The SMS_G_System_LastSoftwareScan WMI class is an SMS Provider server class that represents information about the most recent software inventory scan on the client computer."
---

# SMS_G_System_LastSoftwareScan Class

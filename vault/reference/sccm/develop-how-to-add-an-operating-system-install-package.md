...
type: reference
domain: sccm
slug: develop-how-to-add-an-operating-system-install-package
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-add-an-operating-system-install-package
family: develop
documentKind: "how-to"
abstract: "Creates and populates an instance of SMS_OperatingSystemInstallPackage."
---

# Add an OS Install Package

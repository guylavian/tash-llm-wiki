...
type: reference
domain: sccm
slug: osd-manage-operating-system-upgrade-packages
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/manage-operating-system-upgrade-packages
family: osd
documentKind: "how-to"
abstract: "Learn how to manage OS upgrade packages in Configuration Manager."
---

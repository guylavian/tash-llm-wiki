...
type: reference
domain: sccm
slug: develop-sms-deploymentsummary-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_DeploymentSummary Windows Management Instrumentation class is an SMS Provider server class that represents an application, SUM or classic program deployment summary."
---

# SMS_DeploymentSummary Class

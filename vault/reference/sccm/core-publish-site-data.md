...
type: reference
domain: sccm
slug: core-publish-site-data
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/publish-site-data
family: core
documentKind: "how-to"
abstract: "Learn how to publish Configuration Manager sites to Active Directory Domain Services."
---

...
type: reference
domain: sccm
slug: develop-sms-dcmdeploymentcompliantstatus-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_DCMDeploymentCompliantStatus class in Configuration Manager to set the compliant status of a deployment."
---

# SMS_DCMDeploymentCompliantStatus Class

...
type: reference
domain: sccm
slug: develop-mdm-genericappconfiguration-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/mdm/mdm_genericappconfiguration-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn about the simplified syntax, methods, properties, and requirements of the MDM_GenericAppConfiguration Server class."
---

# MDM_GenericAppConfiguration Class

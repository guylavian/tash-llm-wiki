...
type: reference
domain: sccm
slug: develop-requestmachinepolicy-method-in-class-sms-client
tier: reference
...
abstract: "In Configuration Manager, the RequestMachinePolicy method initiates a request for machine policy."
---

# RequestMachinePolicy Method

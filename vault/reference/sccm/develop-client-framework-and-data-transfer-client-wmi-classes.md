...
type: reference
domain: sccm
slug: develop-client-framework-and-data-transfer-client-wmi-classes
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/client-framework-and-data-transfer-client-wmi-classes
family: develop
documentKind: "reference"
abstract: "This section describes the CCM framework and data transfer classes in Configuration Manager for the client."
---

# Client Framework and Data Transfer Classes

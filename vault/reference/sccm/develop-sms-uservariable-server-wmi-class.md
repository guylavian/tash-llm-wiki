...
type: reference
domain: sccm
slug: develop-sms-uservariable-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_uservariable-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_UserVariable Windows Management Instrumentation (WMI) class defines the settings of a specific user."
---

# SMS_UserVariable Class

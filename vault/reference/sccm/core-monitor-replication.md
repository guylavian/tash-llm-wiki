...
type: reference
domain: sccm
slug: core-monitor-replication
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/monitor-replication
family: core
documentKind: "how-to"
abstract: "Learn how to monitor SQL Server replication in your Configuration Manager hierarchy."
---

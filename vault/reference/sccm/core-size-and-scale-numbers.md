...
type: reference
domain: sccm
slug: core-size-and-scale-numbers
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/configs/size-and-scale-numbers
family: core
documentKind: "article"
abstract: "Determine the number of site system roles and sites that you'll need to support the devices in your environment."
---

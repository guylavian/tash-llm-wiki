...
type: reference
domain: sccm
slug: develop-ccm-softwareupdatesmanager-client-wmi-class
tier: reference
...
abstract: "The CCM_SoftwareUpdatesManager WMI class is a client class that exposes methods to install, schedule and other actions on set of software updates."
---

# CCM_SoftwareUpdatesManager Class

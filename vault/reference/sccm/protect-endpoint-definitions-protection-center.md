...
type: reference
domain: sccm
slug: protect-endpoint-definitions-protection-center
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-definitions-protection-center
family: protect
documentKind: "article"
abstract: "Configure Configuration Manager clients to download Endpoint Protection definition updates from the Microsoft Malware Protection Center (MMPC)."
---

# Download definitions from MMPC

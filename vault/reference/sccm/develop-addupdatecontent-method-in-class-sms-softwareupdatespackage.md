...
type: reference
domain: sccm
slug: develop-addupdatecontent-method-in-class-sms-softwareupdatespackage
tier: reference
...
abstract: "In Configuration Manager, the AddUpdateContent WMI class method downloads content to a software update package and replicates the content to distribution points."
---

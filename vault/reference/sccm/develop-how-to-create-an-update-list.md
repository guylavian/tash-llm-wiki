...
type: reference
domain: sccm
slug: develop-how-to-create-an-update-list
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/how-to-create-an-update-list
family: develop
documentKind: "how-to"
abstract: "You create an update list that contains a set of software updates, in Configuration Manager, by creating an instance of the SMS_AuthorizationList class and populating the properties."
---

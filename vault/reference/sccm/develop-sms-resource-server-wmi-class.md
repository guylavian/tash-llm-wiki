...
type: reference
domain: sccm
slug: develop-sms-resource-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_Resource WMI class is an SMS Provider server class that serves as an abstract base class for all discovery resource classes."
---

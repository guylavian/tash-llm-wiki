...
type: reference
domain: sccm
slug: develop-sms-distributionpointdriveinfo-server-wmi-class
tier: reference
...
abstract: "The SMS_DistributionPointDriveInfo WMI class is an SMS Provider server class that represents the basic information about the drives on a distribution point site system role."
---

# SMS_DistributionPointDriveInfo Class

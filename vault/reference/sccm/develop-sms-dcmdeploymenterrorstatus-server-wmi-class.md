...
type: reference
domain: sccm
slug: develop-sms-dcmdeploymenterrorstatus-server-wmi-class
tier: reference
...
abstract: "The SMS_DCMDeploymentErrorStatus WMI class is an SMS Provider server class that represents error status for a deployment."
---

# SMS_DCMDeploymentErrorStatus Class

...
type: reference
domain: sccm
slug: develop-sms-healthattestationdetails-server-wmi-class
tier: reference
...
abstract: "The SMS_HealthAttestationDetails Windows Management Instrumentation class is an SMS Provider server class, in Configuration Manager, that represents Health Attestation details."
---

# SMS_HealthAttestationDetails Class

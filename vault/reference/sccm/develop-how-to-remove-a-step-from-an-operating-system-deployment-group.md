...
type: reference
domain: sccm
slug: develop-how-to-remove-a-step-from-an-operating-system-deployment-group
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-remove-a-step-from-an-operating-system-deployment-group
family: develop
documentKind: "how-to"
abstract: "Deletes a step from an operating system deployment task sequence group by deleting the step from the group's list of task sequence steps."
---

# Remove a Step from an OS Deployment Group

...
type: reference
domain: sccm
slug: develop-how-to-delete-an-operating-system-deployment-task-sequence-action
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-delete-an-operating-system-deployment-task-sequence-action
family: develop
documentKind: "how-to"
abstract: "Learn about how to remove an action from an operating system deployment task sequence to delete the action from the sequence."
---

# Delete an OS Deployment Task Sequence Action

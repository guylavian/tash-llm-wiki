...
type: reference
domain: sccm
slug: develop-enable-method-in-class-sms-supportedplatforms
tier: reference
...
abstract: "The Enable Windows Management Instrumentation (WMI) class method, in Configuration Manager, enables or disables the platforms."
---

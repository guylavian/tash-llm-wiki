...
type: reference
domain: sccm
slug: develop-sms-aisoftwarelist-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/asset-intelligence/sms_aisoftwarelist-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to access all known software titles in the Asset Inteligence catalog using SMS_AISoftwareList."
---

# SMS_AISoftwareList Class

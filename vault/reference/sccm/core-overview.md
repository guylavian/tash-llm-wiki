...
slug: core-overview
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/cmg/overview
family: core
documentKind: "overview"
abstract: "Learn about managing internet-based clients with Configuration Manager by using the cloud management gateway (CMG) service in Azure."
---

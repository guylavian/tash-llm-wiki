...
type: reference
domain: sccm
slug: develop-about-operating-system-deployment-driver-management
tier: reference
...
abstract: "In Configuration Manager, the driver catalog helps manage the cost and complexity of deploying an operating system in an environment that contains different types of computers and devices."
---

# OS Deployment Driver Management

...
type: reference
domain: sccm
slug: develop-how-to-add-a-configuration-manager-context-qualifier-by-using-wmi
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Add context qualifiers to a connection (SWbemServices) or object (SWbemObject) by creating a SWbemNamedValueSet value set to hold the context qualifiers."
---

# Add a Context Qualifier by Using WMI

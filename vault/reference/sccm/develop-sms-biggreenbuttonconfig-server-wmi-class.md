...
type: reference
domain: sccm
slug: develop-sms-biggreenbuttonconfig-server-wmi-class
tier: reference
...
abstract: "Learn how to stop clients from connecting to the client notification server with SMS_BigGreenButtonConfig."
---

# SMS_BigGreenButtonConfig Class

...
type: reference
domain: sccm
slug: core-configure-client-computers-to-find-management-points-by-using-dns-publishing
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/configure-client-computers-to-find-management-points-by-using-dns-publishing
family: core
documentKind: "how-to"
abstract: "Configure Configuration Manager client computers to find management points by using DNS publishing."
---

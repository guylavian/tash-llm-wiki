...
type: reference
domain: sccm
slug: develop-sms-sii-property-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_SII_Property WMI class is an SMS Provider server class that represents a general-purpose storage object for property data that can be represented as a single integer or two strings."
---

# SMS_SII_Property Class

...
type: reference
domain: sccm
slug: core-install-site-system-roles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/install-site-system-roles
family: core
documentKind: "install-set-up-deploy"
abstract: "Add site system roles to an existing or new site system server in the site."
---

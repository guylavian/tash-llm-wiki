...
type: reference
domain: sccm
slug: develop-sms-softwaremeteringagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_softwaremeteringagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_SoftwareMeteringAgentConfig class to specify how client computers retrieve data about the software they use."
---

# SMS_SoftwareMeteringAgentConfig Class

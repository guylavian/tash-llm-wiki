...
type: reference
domain: sccm
slug: develop-ccm-servicewindow-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/ccm_servicewindow-client-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to list instances of service windows in Configuration Manager using CCM_ServiceWindow class."
---

# CCM_ServiceWindow Class

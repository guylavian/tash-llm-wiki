...
type: reference
domain: sccm
slug: develop-sms-appdeploymenterrorstatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_appdeploymenterrorstatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_AppDeploymentErrorStatus class in Configuration Manager to represent application deployment error status."
---

# SMS_AppDeploymentErrorStatus Class

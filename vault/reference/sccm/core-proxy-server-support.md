...
type: reference
domain: sccm
slug: core-proxy-server-support
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/network/proxy-server-support
family: core
documentKind: "how-to"
abstract: "Learn how Configuration Manager systems use proxy servers."
---

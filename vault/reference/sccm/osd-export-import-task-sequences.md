...
type: reference
domain: sccm
slug: osd-export-import-task-sequences
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/export-import-task-sequences
family: osd
documentKind: "how-to"
abstract: "Export and import task sequences with or without their related objects."
---

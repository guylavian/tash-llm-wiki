...
type: reference
domain: sccm
slug: develop-how-to-configure-the-software-update-point
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/how-to-configure-the-software-update-point
family: develop
documentKind: "how-to"
abstract: "You configure the software update point, in Configuration Manager, by modifying the site control file settings."
---

...
type: reference
domain: sccm
slug: develop-sms-boundarygroup-server-wmi-class
tier: reference
...
abstract: "The SMS_BoundaryGroup WMI class is an SMS Provider server class that represents a boundary group defined in the site hierarchy."
---

# SMS_BoundaryGroup Class

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-autoapplyaction-server-wmi-class
tier: reference
...
abstract: "The SMS_TaskSequence_AutoApplyAction WMI class represents a task sequence action that matches and installs device drivers as part of an operating system deployment."
---

# SMS_TaskSequence_AutoApplyAction Class

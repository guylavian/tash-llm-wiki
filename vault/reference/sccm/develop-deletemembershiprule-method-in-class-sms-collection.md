...
type: reference
domain: sccm
slug: develop-deletemembershiprule-method-in-class-sms-collection
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/collections/deletemembershiprule-method-in-class-sms_collection
family: develop
documentKind: "reference"
abstract: "The DeleteMembershipRule Windows Management Instrumentation class method, in Configuration Manager, deletes a membership rule from the collection."
---

# DeleteMembershipRule Method

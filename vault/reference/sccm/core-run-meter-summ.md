...
type: reference
domain: sccm
slug: core-run-meter-summ
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/support/run-meter-summ
family: core
documentKind: "article"
abstract: "Use the Run Meter Summarization Tool to trigger the software metering summarization tasks in Configuration Manager."
---

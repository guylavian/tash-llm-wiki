...
type: reference
domain: sccm
slug: develop-how-to-set-the-pxe-service-point-response-to-pxe-requests
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you set the distribution point response to incoming PXE requests by setting the IsActive embedded property."
---

# Set the PXE Service Point Response to PXE Requests

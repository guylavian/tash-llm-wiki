...
type: reference
domain: sccm
slug: develop-addlicense-method-in-class-sms-deploymenttypelicenseassociation
tier: reference
...
abstract: "The AddLicense Windows Management Instrumentation (WMI) class method adds license information to an application deployment type."
---

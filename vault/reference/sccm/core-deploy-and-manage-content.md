...
type: reference
domain: sccm
slug: core-deploy-and-manage-content
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/deploy-and-manage-content
family: core
documentKind: "how-to"
abstract: "After you install distribution points for Configuration Manager, here's how you can begin to deploy content to them."
---

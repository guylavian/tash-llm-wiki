...
type: reference
domain: sccm
slug: develop-sms-statmsg-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_statmsg-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_StatMsg WMI class is a high-performance version of SMS_StatusMessage Server WMI Class."
---

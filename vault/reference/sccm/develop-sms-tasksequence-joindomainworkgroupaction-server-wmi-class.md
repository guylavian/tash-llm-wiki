...
type: reference
domain: sccm
slug: develop-sms-tasksequence-joindomainworkgroupaction-server-wmi-class
tier: reference
...
abstract: "The SMS_TaskSequence_JoinDomainWorkgroupAction WMI class is an SMS Provider server class that represents a task sequence action that joins a Windows domain or a Windows workgroup."
---

# SMS_TaskSequence_JoinDomainWorkgroupAction Class

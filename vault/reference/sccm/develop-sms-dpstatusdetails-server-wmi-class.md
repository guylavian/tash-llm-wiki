...
type: reference
domain: sccm
slug: develop-sms-dpstatusdetails-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_dpstatusdetails-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_DPStatusDetails WMI class is an SMS Provider server class that represents distribution point status details."
---

# SMS_DPStatusDetails Class

...
type: reference
domain: sccm
slug: develop-hardware-inventory-views-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/hardware-inventory-views-configuration-manager
family: develop
documentKind: "reference"
abstract: "Information about the computer hardware scanned on Configuration Manager client computers."
---

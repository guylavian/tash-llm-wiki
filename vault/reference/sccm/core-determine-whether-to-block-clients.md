...
type: reference
domain: sccm
slug: core-determine-whether-to-block-clients
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/plan/determine-whether-to-block-clients
family: core
documentKind: "article"
abstract: "Block client access for system security by using Configuration Manager."
---

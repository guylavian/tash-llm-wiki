...
type: reference
domain: sccm
slug: develop-isfuturewindowavailable-method-in-class-ccm-servicewindowmanager
tier: reference
...
abstract: "A Windows Management Instrumentation class method that determines whether a service window of a specified type and the given duration is going to be available."
---

# IsFutureWindowAvailable Method

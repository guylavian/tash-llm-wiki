...
type: reference
domain: sccm
slug: develop-ismsresgen-interface
tier: reference
...
abstract: "Learn how to use the ISMSResGen Interface to enable the creation of Data Discovery Records (DDR). This interface inherits from IDispatch."
---

...
type: reference
domain: sccm
slug: core-power-viewer-tool
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/support/power-viewer-tool
family: core
documentKind: "how-to"
abstract: "Use the Power Viewer Tool to view the status of the power management feature on a Configuration Manager client."
---

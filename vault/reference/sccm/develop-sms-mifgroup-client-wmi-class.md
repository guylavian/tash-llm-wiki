...
type: reference
domain: sccm
slug: develop-sms-mifgroup-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/sms_mifgroup-client-wmi-class
family: develop
documentKind: "reference"
abstract: "A client Windows Management Instrumentation class that serves as a dynamic instance provider class allowing WMI reporting of Management Information Format files that extend the client inventory."
---

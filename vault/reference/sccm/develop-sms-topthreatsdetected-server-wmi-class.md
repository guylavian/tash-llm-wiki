...
type: reference
domain: sccm
slug: develop-sms-topthreatsdetected-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/protect/sms_topthreatsdetected-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_TopThreatsDetected class summarizes the top threats found in the last 24 hours per collection."
---

# SMS_TopThreatsDetected Class

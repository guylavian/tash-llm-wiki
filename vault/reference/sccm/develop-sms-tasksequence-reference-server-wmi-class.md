...
type: reference
domain: sccm
slug: develop-sms-tasksequence-reference-server-wmi-class
tier: reference
...
abstract: "The SMS_TaskSequence_Reference Windows Management Instrumentation class is an SMS Provider server class, in Configuration Manager, that represents the package ID and optional program name."
---

# SMS_TaskSequence_Reference Class

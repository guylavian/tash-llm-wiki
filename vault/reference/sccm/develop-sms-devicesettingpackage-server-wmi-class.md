...
type: reference
domain: sccm
slug: develop-sms-devicesettingpackage-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents a device setting package in the database."
---

# SMS_DeviceSettingPackage Class

...
type: reference
domain: sccm
slug: core-install-and-configure-distribution-points
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/install-and-configure-distribution-points
family: core
documentKind: "how-to"
abstract: "Use distribution points to host the content that you deploy to devices and users."
---

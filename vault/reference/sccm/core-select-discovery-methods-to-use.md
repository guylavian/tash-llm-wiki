...
type: reference
domain: sccm
slug: core-select-discovery-methods-to-use
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/select-discovery-methods-to-use
family: core
documentKind: "concept-article"
abstract: "Review considerations for which methods to use and at which sites to run them."
---

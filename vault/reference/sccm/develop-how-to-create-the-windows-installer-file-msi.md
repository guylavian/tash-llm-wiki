...
type: reference
domain: sccm
slug: develop-how-to-create-the-windows-installer-file-msi
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/apps/how-to-create-the-windows-installer-file-msi
family: develop
documentKind: "how-to"
abstract: "After the Deployment Type Extension file (*.cmdtx) is created, you're expected to generate a Windows Installer file (\\*.msi) which contains the \\*.cmdtx file and the UX files."
---

# How to Create the Windows Installer File

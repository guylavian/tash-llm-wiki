...
type: reference
domain: sccm
slug: core-convert-to-current-branch
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/understand/convert-to-current-branch
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Learn how to convert a long-term servicing branch (LTSB) site to a current branch site."
---

# Upgrade the LTSB to current branch

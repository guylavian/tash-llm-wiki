...
type: reference
domain: sccm
slug: develop-sms-g-system-resourceclientsettingsassignment-server-wmi-class
tier: reference
...
abstract: "Learn how to represent resource-specific client agent settings assignments in Configuration Manager."
---

# SMS_G_SYSTEM_ResourceClientSettingsAssignment Class

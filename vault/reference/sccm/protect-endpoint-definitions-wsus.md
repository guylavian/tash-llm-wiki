...
type: reference
domain: sccm
slug: protect-endpoint-definitions-wsus
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-definitions-wsus
family: protect
documentKind: "how-to"
abstract: "Learn how to configure Windows Server Updates Services to auto-approve definition updates."
---

# Endpoint Protection malware definitions from WSUS

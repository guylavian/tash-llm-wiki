...
type: reference
domain: sccm
slug: develop-ccm-policyagent-configuration-client-wmi-class
tier: reference
...
abstract: "A Windows Management Instrumentation class that represents the Policy Agent configuration for a given authority."
---

# CCM_PolicyAgent_Configuration Class

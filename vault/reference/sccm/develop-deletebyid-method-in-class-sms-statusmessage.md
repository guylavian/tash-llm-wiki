...
type: reference
domain: sccm
slug: develop-deletebyid-method-in-class-sms-statusmessage
tier: reference
...
abstract: "Learn how the DeleteByID Windows Management Instrumentation (WMI) class method deletes a group of up to 256 status messages."
---

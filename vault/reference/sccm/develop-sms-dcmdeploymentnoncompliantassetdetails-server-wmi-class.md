...
type: reference
domain: sccm
slug: develop-sms-dcmdeploymentnoncompliantassetdetails-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_DCMDeploymentNonCompliantAssetDetails class to represent non-compliant asset details for a deployment."
---

# SMS_DCMDeploymentNonCompliantAssetDetails Class

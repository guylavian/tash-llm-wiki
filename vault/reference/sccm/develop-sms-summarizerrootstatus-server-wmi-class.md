...
type: reference
domain: sccm
slug: develop-sms-summarizerrootstatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_summarizerrootstatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_SummarizerRootStatus Windows Management Instrumentation class is an SMS Provider server class that represents a summarizer for the overall health of the entire site hierarchy."
---

# SMS_SummarizerRootStatus Class

...
type: reference
domain: sccm
slug: core-surface-device-dashboard
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/surface-device-dashboard
family: core
documentKind: "how-to"
abstract: "Review information about Surface devices using the dashboard."
---

...
type: reference
domain: sccm
slug: develop-sms-imagepackage-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_imagepackage-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that serves as the unit of distribution for image source files. The image source files are used to deploy a valid operating system."
---

# SMS_ImagePackage Class

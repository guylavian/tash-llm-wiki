...
type: reference
domain: sccm
slug: develop-sms-endpointprotectionthreatdata-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents Microsoft official threats. It's a metadata table and all data is extracted from the signature update."
---

# SMS_EndpointProtectionThreatData Class

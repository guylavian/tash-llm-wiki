...
type: reference
domain: sccm
slug: osd-prepare-site-system-roles-for-operating-system-deployments
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/prepare-site-system-roles-for-operating-system-deployments
family: osd
documentKind: "install-set-up-deploy"
abstract: "Configure the site system roles before you deploy operating systems in Configuration Manager."
---

# Prepare site system roles for OSD

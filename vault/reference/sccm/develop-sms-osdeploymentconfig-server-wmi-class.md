...
type: reference
domain: sccm
slug: develop-sms-osdeploymentconfig-server-wmi-class
tier: reference
...
abstract: "Learn how to represent all OSD-related constants and settings with their ADK-specific values using SMS_OSDeploymentConfig class."
---

# SMS_OSDeploymentConfig Class

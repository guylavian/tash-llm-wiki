...
type: reference
domain: sccm
slug: develop-sms-packagetoadvert-a-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_packagetoadvert_a-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_PackageToAdvert_a WMI class is an SMS Provider server class that relates an SMS_Advertisement Server WMI Class object to the SMS_Package Server WMI Class object that it advertises."
---

# SMS_PackageToAdvert_a Class

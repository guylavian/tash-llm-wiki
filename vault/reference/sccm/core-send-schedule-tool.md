...
type: reference
domain: sccm
slug: core-send-schedule-tool
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/support/send-schedule-tool
family: core
documentKind: "article"
abstract: "Use the Send Schedule Tool to trigger a schedule on a Configuration Manager client."
---

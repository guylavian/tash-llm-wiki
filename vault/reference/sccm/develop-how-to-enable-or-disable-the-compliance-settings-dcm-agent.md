...
type: reference
domain: sccm
slug: develop-how-to-enable-or-disable-the-compliance-settings-dcm-agent
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/how-to-enable-or-disable-the-compliance-settings--dcm--agent
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you enable or disable the Desired Configuration Management Client Agent by modifying the site control file settings."
---

# Enable or Disable the Compliance Settings Agent

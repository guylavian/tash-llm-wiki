...
type: reference
domain: sccm
slug: develop-getassignedsite-method-in-class-sms-client
tier: reference
...
abstract: "Learn how to use the GetAssignedSite method to get the current assigned site of the client in Configuration Manager."
---

# GetAssignedSite Method

...
type: reference
domain: sccm
slug: develop-checklockrequest-method-in-class-sms-objectlock
tier: reference
...
abstract: "The CheckLockRequest Windows Management Instrumentation (WMI) class method checks a lock request."
---

# CheckLockRequest Method

...
type: reference
domain: sccm
slug: osd-user-experience
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/understand/user-experience
family: osd
documentKind: "install-set-up-deploy"
abstract: "Learn about user experiences like the task sequence progress and media wizard for operating system deployment in Configuration Manager."
---

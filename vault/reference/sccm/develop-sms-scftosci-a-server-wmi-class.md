...
type: reference
domain: sccm
slug: develop-sms-scftosci-a-server-wmi-class
tier: reference
...
abstract: "The SMS_SCFToSCI_a Windows Management Instrumentation class is an SMS Provider server class, in Configuration Manager, that relates a WMI class object."
---

# SMS_SCFToSCI_a Class

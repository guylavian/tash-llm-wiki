...
type: reference
domain: sccm
slug: develop-about-reporting-status-messages-from-configuration-manager-clients
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/manage/about-reporting-status-messages-from-configuration-manager-clients
family: develop
documentKind: "concept-article"
abstract: "You can raise Configuration Manager client status messages in the Windows event log by using a compiled Managed Object Format (MOF) file on client computers."
---

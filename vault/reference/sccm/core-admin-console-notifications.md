...
type: reference
domain: sccm
slug: core-admin-console-notifications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/admin-console-notifications
family: core
documentKind: "article"
abstract: "Learn about notifications from the Configuration Manager console."
---

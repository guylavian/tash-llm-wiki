...
type: reference
domain: sccm
slug: protect-endpoint-protection
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-protection
family: protect
documentKind: "overview"
abstract: "Learn how to manage antimalware policies and Windows Defender Firewall security for clients."
---

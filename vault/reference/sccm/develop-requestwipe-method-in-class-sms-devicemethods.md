...
type: reference
domain: sccm
slug: develop-requestwipe-method-in-class-sms-devicemethods
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/mdm/requestwipe-method-in-class-sms_devicemethods
family: develop
documentKind: "reference"
abstract: "Learn how to use Configuration Manager RequestWipe Windows Management Instrumentation (WMI) class method to remove Microsoft Exchange and Configuration Manager software from the mobile device or Exchange ActiveSync device."
---

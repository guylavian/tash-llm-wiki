...
type: reference
domain: sccm
slug: develop-client-resource-conditions
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/programming/client-resource-conditions
family: develop
documentKind: "article"
abstract: "Learn how to utilize Configuration Manager's ability to be aware of system resources state and act accordingly using the LaunchConditions class."
---

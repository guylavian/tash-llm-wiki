...
type: reference
domain: sccm
slug: develop-sms-mdmcorpowneddevices-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/mdm/sms_mdmcorpowneddevices-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_MDMCorpOwnedDevices WMI class represents On-premises Mobile Device Management (MDM) corporate owned devices."
---

# SMS_MDMCorpOwnedDevices Class

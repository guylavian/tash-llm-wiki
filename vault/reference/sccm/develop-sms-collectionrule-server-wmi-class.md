...
type: reference
domain: sccm
slug: develop-sms-collectionrule-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a collection rule using SMS_CollectionRule class in Configuration Manager."
---

# SMS_CollectionRule Class

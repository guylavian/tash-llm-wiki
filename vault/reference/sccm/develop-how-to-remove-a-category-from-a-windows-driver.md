...
type: reference
domain: sccm
slug: develop-how-to-remove-a-category-from-a-windows-driver
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-remove-a-category-from-a-windows-driver
family: develop
documentKind: "how-to"
abstract: "Learn about how to remove a category from a Windows driver by modifying the CategoryInstance_UniqueIDs array property."
---

# Remove a Category from a Windows Driver

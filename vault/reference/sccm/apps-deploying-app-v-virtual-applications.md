...
type: reference
domain: sccm
slug: apps-deploying-app-v-virtual-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/get-started/deploying-app-v-virtual-applications
family: apps
documentKind: "install-set-up-deploy"
abstract: "See which considerations you must take into account when you create and deploy virtual applications."
---
...
|Create applications to replace your existing App-V packages.|See [Introduction to application management](/previous-versions/troubleshoot/configmgr/introduction-to-application-management) and [Create applications](../../apps/deploy-use/create-applications.md).|

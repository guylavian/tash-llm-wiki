...
type: reference
domain: sccm
slug: develop-sms-serviceplan-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_serviceplan-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_ServicePlan Windows Management Instrumentation class is an SMS Provider server class in Configuration Manager that represents a service plan."
---

# SMS_ServicePlan Class

...
type: reference
domain: sccm
slug: develop-sms-template-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_template-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to create a deployment template available to deploy a software update on the site directly versus using the Configuration Manager console."
---

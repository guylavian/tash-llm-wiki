...
type: reference
domain: sccm
slug: apps-package-conversion-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/pcm/package-conversion-manager
family: apps
documentKind: "overview"
abstract: "Learn about Package Conversion Manager to convert packages to applications in Configuration Manager."
---

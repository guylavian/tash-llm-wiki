...
type: reference
domain: sccm
slug: core-upgrade-readiness
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/upgrade-readiness
family: core
documentKind: "integration"
abstract: "Integrate Upgrade Readiness with Configuration Manager to access Windows upgrade compatibility data and target devices for upgrade or remediation."
---

...
type: reference
domain: sccm
slug: develop-how-to-add-a-condition-to-an-operating-system-deployment-task-sequence-step
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "How to Add a Condition to an Operating System Deployment Task Sequence Step"
---

# Add a Condition to an OS Deployment Task Sequence Step

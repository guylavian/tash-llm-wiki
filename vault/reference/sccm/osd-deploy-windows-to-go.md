...
type: reference
domain: sccm
slug: osd-deploy-windows-to-go
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/deploy-windows-to-go
family: osd
documentKind: "how-to"
abstract: "Learn how to provision Windows To Go in Configuration Manager to create a Windows To Go workspace that boots from an external drive."
---

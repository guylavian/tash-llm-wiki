...
type: reference
domain: sccm
slug: develop-sms-deploymenttypelicenseassociation-server-wmi-class
tier: reference
...
abstract: "Learn about the simplified syntax, methods, properties, and requirements of the SMS_DeploymentTypeLicenseAssociation server class."
---

# SMS_DeploymentTypeLicenseAssociation Class

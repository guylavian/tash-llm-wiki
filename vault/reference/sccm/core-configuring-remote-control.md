...
type: reference
domain: sccm
slug: core-configuring-remote-control
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/remote-control/configuring-remote-control
family: core
documentKind: "how-to"
abstract: "Set up remote control in Configuration Manager."
---

...
type: reference
domain: sccm
slug: tenant-attach-endpoint-security-get-started
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/endpoint-security-get-started
family: tenant-attach
documentKind: "get-started"
abstract: "Create and deploy endpoint security policies from the Microsoft Intune admin center and for Configuration Manager collections."
---

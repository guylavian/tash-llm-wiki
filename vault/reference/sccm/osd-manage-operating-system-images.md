...
type: reference
domain: sccm
slug: osd-manage-operating-system-images
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/manage-operating-system-images
family: osd
documentKind: "how-to"
abstract: "Learn the methods to manage OS images stored in Windows image (WIM) files."
---

...
type: reference
domain: sccm
slug: develop-adddistributionpoints-method-in-class-sms-package
tier: reference
...
abstract: "Learn how to use the AddDistributionPoints method in Class SMS_Package to add distribution points for the package."
---

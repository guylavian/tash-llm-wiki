...
type: reference
domain: sccm
slug: sum-deploy-software-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/deploy-software-updates
family: sum
documentKind: "install-set-up-deploy"
abstract: "Learn how to manually or automatically deploy software updates in the Configuration Manager console."
---

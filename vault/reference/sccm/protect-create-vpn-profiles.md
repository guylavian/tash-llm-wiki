...
type: reference
domain: sccm
slug: protect-create-vpn-profiles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/create-vpn-profiles
family: protect
documentKind: "how-to"
abstract: "Learn how to create VPN profiles in Configuration Manager."
---

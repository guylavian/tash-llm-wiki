...
type: reference
domain: sccm
slug: apps-share-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/share-applications
family: apps
documentKind: "how-to"
abstract: "Share a link to an application in the Software Center in Configuration Manager."
---

# Share applications in the Software Center

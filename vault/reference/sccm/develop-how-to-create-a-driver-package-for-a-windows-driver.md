...
type: reference
domain: sccm
slug: develop-how-to-create-a-driver-package-for-a-windows-driver
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-create-a-driver-package-for-a-windows-driver
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, to create a package for an operating system deployment driver, first create a SMS_DriverPackage Server WMI Class object. To add a driver to the package, call the AddDriverContent Method in Class SMS_DriverPackage."
---

# Create a Driver Package for a Windows Driver

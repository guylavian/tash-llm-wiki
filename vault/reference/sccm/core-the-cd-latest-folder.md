...
type: reference
domain: sccm
slug: core-the-cd-latest-folder
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/the-cd.latest-folder
family: core
documentKind: "article"
abstract: "Learn about the process that delivers updates to the product from within the Configuration Manager console."
---

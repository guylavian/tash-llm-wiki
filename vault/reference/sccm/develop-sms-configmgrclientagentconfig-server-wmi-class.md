...
type: reference
domain: sccm
slug: develop-sms-configmgrclientagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_configmgrclientagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to specify the general settings for communication between server and client using SMS_COnfigMgrClientAgentConfig."
---

# SMS_ConfigMgrClientAgentConfig Class

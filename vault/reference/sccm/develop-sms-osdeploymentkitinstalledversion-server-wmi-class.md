...
type: reference
domain: sccm
slug: develop-sms-osdeploymentkitinstalledversion-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a mapping of server names to an installed Assessment and Deployment Kit (ADK) version using SMS_OSDeploymentKitInstalledVersion class."
---

# SMS_OSDeploymentKitInstalledVersion Class

...
type: reference
domain: sccm
slug: develop-ccm-policy-operator-client-wmi-class
tier: reference
...
abstract: "Learn how to store a compound expression that evaluates to either true or false in Configuration Manager using CCM_Policy_Operator."
---

# CCM_Policy_Operator Class

...
type: reference
domain: sccm
slug: core-configuration-manager-and-windows-as-service
tier: reference
...
abstract: "Get basic information on adopting Configuration Manager current branch to support Windows as a service."
---
...
| [Integrate Windows Update client policies (optional)](../../sum/deploy-use/integrate-windows-update-for-business-windows-10.md) | Explains how to define and deploy Windows Update client policies using Configuration Manager. |
| [Use co-management with Microsoft Intune and Windows Update client policies (optional)](../../comanage/overview.md) | Provides an overview of co-management. |

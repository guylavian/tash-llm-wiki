...
type: reference
domain: sccm
slug: develop-how-to-modify-program-properties
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-modify-program-properties
family: develop
documentKind: "how-to"
abstract: "Learn how the following will modify a program, in Configuration Manager, by using the SMS_Package and SMS_Program classes and properties."
---

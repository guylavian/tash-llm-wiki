...
type: reference
domain: sccm
slug: develop-getremctrlsettings-method-in-class-ccm-remotecontrolmanager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/getremctrlsettings-method-in-class-ccm_remotecontrolmanager
family: develop
documentKind: "reference"
abstract: "The GetRemCtrlSettings Windows Management Instrumentation (WMI) class method in Configuration Manager that gets the remote control settings on a client computer."
---

# GetRemCtrlSettings Method

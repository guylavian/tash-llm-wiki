...
type: reference
domain: sccm
slug: osd-prestart-commands-for-task-sequence-media
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/understand/prestart-commands-for-task-sequence-media
family: osd
documentKind: "how-to"
abstract: "Create a script to use for the prestart command, distribute the content associated with the prestart command, and configure the prestart command in media."
---

...
type: reference
domain: sccm
slug: develop-how-to-create-an-operating-system-deployment-task-sequence
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "You create a Configuration Manager operating system deployment task sequence by creating an instance of the SMS_TaskSequence class."
---

# Create an OS Deployment Task Sequence

...
type: reference
domain: sccm
slug: develop-how-to-create-a-new-security-scope
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-create-a-new-security-scope
family: develop
documentKind: "how-to"
abstract: "Learn how to create a new security scope and that All security scopes are defined by the SMS_SecuredCategory Windows Management Instrumentation (WMI) class."
---

# Create a New Security Scope

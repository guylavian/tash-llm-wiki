...
type: reference
domain: sccm
slug: develop-smsevent-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/smsevent-class
family: develop
documentKind: "reference"
abstract: "The SmsEvent class represents a Configuration Manager event on the client. The class implements the ICcmEvent interface."
---

...
type: reference
domain: sccm
slug: develop-setsourcesite-method-in-class-sms-operatingsysteminstallpackage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/setsourcesite-method-in-class-sms_operatingsysteminstallpackage
family: develop
documentKind: "reference"
abstract: "The SetSourceSite Windows Management Instrumentation class method, in Configuration Manager, sets the code of the source site for the operating system install package."
---

...
type: reference
domain: sccm
slug: develop-sms-cm-updatepackageshistory-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_cm_updatepackageshistory-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_CM_UpdatePackagesHistory WMI class is used to get a list of all update packages."
---

# SMS_CM_UpdatePackagesHistory Class

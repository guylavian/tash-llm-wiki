...
type: reference
domain: sccm
slug: core-use-a-sql-server-cluster-for-the-site-database
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/use-a-sql-server-cluster-for-the-site-database
family: core
documentKind: "how-to"
abstract: "Use a SQL Server Always On failover cluster instance to host the Configuration Manager site database"
---

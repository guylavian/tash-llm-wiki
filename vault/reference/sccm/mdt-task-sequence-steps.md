...
type: reference
domain: sccm
slug: mdt-task-sequence-steps
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdt/task-sequence-steps
family: mdt
documentKind: "reference"
abstract: "Reference details for Microsoft Deployment Toolkit (MDT) Task Sequence Steps"
---

# Toolkit reference - Microsoft Deployment Toolkit (MDT) Task Sequence Steps

...
type: reference
domain: sccm
slug: protect-bitlocker-management
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/plan-design/bitlocker-management
family: protect
documentKind: "article"
abstract: "Plan for managing BitLocker Drive Encryption with Configuration Manager."
---
...
> [!TIP]
> To manage encryption on co-managed Windows 10 or later devices using the Microsoft Intune cloud service, switch the [**Endpoint Protection** workload](../../comanage/workloads.md#endpoint-protection) to Intune. For more information on using Intune, see [Windows Encryption](../../../device-configuration/endpoint-security/ref-endpoint-protection-settings-windows.md#windows-encryption).

...
type: reference
domain: sccm
slug: develop-sms-st-recurmonthlybydate-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a schedule token for events that occur on designated days at designated monthly intervals using SMS_ST_RecurMonthlyByDate class."
---

# SMS_ST_RecurMonthlyByDate Class

...
type: reference
domain: sccm
slug: osd-manage-task-sequences-to-automate-tasks
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/manage-task-sequences-to-automate-tasks
family: osd
documentKind: "overview"
abstract: "Configure the settings of task sequences."
---

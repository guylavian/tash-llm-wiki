...
type: reference
domain: sccm
slug: develop-use-query-designer-write-configuration-manager-report-sql-statements
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/use-query-designer-write-configuration-manager-report-sql-statements
family: develop
documentKind: "article"
abstract: "Information about using query designer to write report SQL statements for Configuration Manager reports."
---

# Using query designer to write report SQL statements

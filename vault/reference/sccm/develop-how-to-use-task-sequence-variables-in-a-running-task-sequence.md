...
type: reference
domain: sccm
slug: develop-how-to-use-task-sequence-variables-in-a-running-task-sequence
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-use-task-sequence-variables-in-a-running-task-sequence
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you can create, get, and set task sequence variables in a running task sequence by using the task sequence environment COM automation object."
---

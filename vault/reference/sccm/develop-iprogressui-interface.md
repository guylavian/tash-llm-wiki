...
type: reference
domain: sccm
slug: develop-iprogressui-interface
tier: reference
...
abstract: "IProgressUI represents the user interface that allows custom actions to report progress to the OS deployment task sequencing environment."
---

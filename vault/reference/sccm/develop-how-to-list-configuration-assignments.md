...
type: reference
domain: sccm
slug: develop-how-to-list-configuration-assignments
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/how-to-list-configuration-assignments
family: develop
documentKind: "how-to"
abstract: "The following code examples show how to list the current configuration baseline assignments and a specific set of properties for each assignment in Configuration Manager."
---

# List Configuration Assignments

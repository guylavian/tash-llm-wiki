...
type: reference
domain: sccm
slug: develop-about-package-definition-files
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/about-package-definition-files
family: develop
documentKind: "concept-article"
abstract: "Learn how to use Configuration Manager to help automate package creation using package definition files."
---

...
type: reference
domain: sccm
slug: develop-sms-metereduser-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_metereduser-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to list users that have used metered applications in Configuration Manager with SMS_MeteredUser."
---

# SMS_MeteredUser Class

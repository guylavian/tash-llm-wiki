...
type: reference
domain: sccm
slug: develop-sms-tasksequence-prestartcheckaction-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_prestartcheckaction-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent a task sequence action to check the readiness of the target computer using SMS_TaskSequence_PrestartCheckAction class."
---

# SMS_TaskSequence_PrestartCheckAction class

...
type: reference
domain: sccm
slug: core-service-windows
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/service-windows
family: core
documentKind: "how-to"
abstract: "Use service windows to control when Configuration Manager sites install updates."
---

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-prepareosaction-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a task sequence action that specifies the Sysprep options to use when capturing Windows settings from the reference computer."
---

# SMS_TaskSequence_PrepareOSAction class

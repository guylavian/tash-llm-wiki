...
type: reference
domain: sccm
slug: develop-submitcertificate-method-in-class-sms-certificatedata
tier: reference
...
abstract: "The SubmitCertificate Windows Management Instrumentation (WMI) class method in Configuration Manager submits the specified certificate."
---

...
type: reference
domain: sccm
slug: develop-sms-activesyncconnecteddevice-client-wmi-class
tier: reference
...
abstract: "Learn how to represent a device connected to the ActiveSyn service using SMS_ActiveSyncConnectedDevice class."
---

# SMS_ActiveSyncConnectedDevice Class

...
type: reference
domain: sccm
slug: develop-importrole-method-in-class-sms-role
tier: reference
...
abstract: "The ImportRole Windows Management Instrumentation (WMI) class method imports a role defined by an XML string to the database."
---

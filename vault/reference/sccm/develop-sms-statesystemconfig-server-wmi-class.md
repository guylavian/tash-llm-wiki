...
type: reference
domain: sccm
slug: develop-sms-statesystemconfig-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_StateSystemConfig WMI class is an SMS Provider server class that specifies how client computers report state messages."
---

# SMS_StateSystemConfig Class

...
type: reference
domain: sccm
slug: develop-sms-clientdatasourcespolicy-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/deploy/sms_clientdatasourcespolicy-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent client policy data sources in Configuration Manager using SMS_ClientDataSourcesPolicy class."
---

# SMS_ClientDataSourcesPolicy Class

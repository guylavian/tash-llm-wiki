...
type: reference
domain: sccm
slug: develop-sms-collectionrulequery-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_CollectionRuleQuery Windows Management Instrumentation class is an SMS Provider server class that represents a member of a collection based on the results of a query."
---

# SMS_CollectionRuleQuery Class

...
type: reference
domain: sccm
slug: develop-validatenewpackagesource-method-in-class-sms-driverpackage
tier: reference
...
abstract: "Learn how to validate a new location for a driver update using ValidateNewPackageSource class in Configuration Manager."
---

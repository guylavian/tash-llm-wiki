...
type: reference
domain: sccm
slug: develop-install-method-in-class-ccm-application
tier: reference
...
abstract: "Learn how to install an application using the Install Windows Management Instrumentation (WMI) class method."
---

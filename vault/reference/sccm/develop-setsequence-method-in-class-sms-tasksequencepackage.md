...
type: reference
domain: sccm
slug: develop-setsequence-method-in-class-sms-tasksequencepackage
tier: reference
...
abstract: "The SetSequence Windows Management Instrumentation (WMI) class method, in Configuration Manager, updates the task sequence package with the specified task sequence."
---

...
type: reference
domain: sccm
slug: core-client-health-checks
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/client-health-checks
family: core
documentKind: "reference"
abstract: "The checks that the Configuration Manager client runs regularly to keep healthy."
---

...
type: reference
domain: sccm
slug: develop-sms-client-client-wmi-class
tier: reference
...
abstract: "Article describing the use of SMS_CLient class in Configuration Manager to represent the client and facilitate manipulation and retrieval of client information."
---

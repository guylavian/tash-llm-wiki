...
type: reference
domain: sccm
slug: develop-sms-lastpxeadvertisement-server-wmi-class
tier: reference
...
abstract: "Learn how to represent the last PXE advertisement using the SMS_LastPXEAdvertisement class in Configuration Manager."
---

# SMS_LastPXEAdvertisement Class

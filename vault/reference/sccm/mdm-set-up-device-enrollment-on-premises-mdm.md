...
type: reference
domain: sccm
slug: mdm-set-up-device-enrollment-on-premises-mdm
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/get-started/set-up-device-enrollment-on-premises-mdm
family: mdm
documentKind: "install-set-up-deploy"
abstract: "Grant users permission to enroll their devices for on-premises mobile device management (MDM) in Configuration Manager."
---

# Set up enrollment for on-premises MDM

...
type: reference
domain: sccm
slug: core-sql-server-alwayson-for-a-highly-available-site-database
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/sql-server-alwayson-for-a-highly-available-site-database
family: core
documentKind: "how-to"
abstract: "Plan to use a SQL Server Always On availability group for the Configuration Manager site database."
---

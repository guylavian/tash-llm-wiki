...
type: reference
domain: sccm
slug: develop-sms-appdtdeploymentsummary-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_AppDTDeploymentSummary class to represent the deployment type-level summary of application deployment."
---

# SMS_AppDTDeploymentSummary Class

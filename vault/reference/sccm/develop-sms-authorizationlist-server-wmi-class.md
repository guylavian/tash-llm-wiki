...
type: reference
domain: sccm
slug: develop-sms-authorizationlist-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_authorizationlist-server-wmi-class
family: develop
documentKind: "reference"
abstract: "A collection of SMS_SoftwareUpdate objects for the software updates available on the site and authorized for deployment."
---

# SMS_AuthorizationList Class

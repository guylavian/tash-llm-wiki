...
type: reference
domain: sccm
slug: develop-sms-tasksequence-capturenetworksettingsaction-server-wmi-class
tier: reference
...
abstract: "Details of the SMS_TaskSequence_CaptureNetworkSettingsAction server WMI class"
---

# SMS_TaskSequence_CaptureNetworkSettingsAction class

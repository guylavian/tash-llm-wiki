...
type: reference
domain: sccm
slug: develop-sms-ci-localizedproperties-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_CI_LocalizedProperties class in Configuration Manager that contains the localized properties for a configuration item."
---

# SMS_CI_LocalizedProperties Class

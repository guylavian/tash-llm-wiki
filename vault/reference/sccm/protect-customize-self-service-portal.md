...
type: reference
domain: sccm
slug: protect-customize-self-service-portal
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/bitlocker/customize-self-service-portal
family: protect
documentKind: "how-to"
abstract: "Add custom organization-specific information to the BitLocker management self-service portal"
---

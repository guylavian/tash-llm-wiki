...
type: reference
domain: sccm
slug: develop-setenforcement-method-in-class-sms-configurationitem
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/setenforcement-method-in-class-sms_configurationitem
family: develop
documentKind: "reference"
abstract: "Learn how to use the SetEnforcement method in class SMS_ConfigurationItem to set the enforcement and the enforcement date for a configuration item."
---

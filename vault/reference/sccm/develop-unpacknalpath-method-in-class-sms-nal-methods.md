...
type: reference
domain: sccm
slug: develop-unpacknalpath-method-in-class-sms-nal-methods
tier: reference
...
abstract: "Decodes a network abstraction layer (NAL) path into its components."
---

# UnPackNALPath Method

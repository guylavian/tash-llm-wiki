...
type: reference
domain: sccm
slug: develop-how-to-create-a-configuration-manager-dialog-box
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-create-a-configuration-manager-dialog-box
family: develop
documentKind: "how-to"
abstract: "These procedures show you how to create a modeless dialog box assembly, in Configuration Manager, by using Visual Studio."
---

...
type: reference
domain: sccm
slug: develop-sms-appdeploymentstatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_appdeploymentstatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_AppDeploymentStatus Windows Management Instrumentation class is an SMS Provider server class, in Configuration Manager, that represents application deployment status."
---

# SMS_AppDeploymentStatus Class

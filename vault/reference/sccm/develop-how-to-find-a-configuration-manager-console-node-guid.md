...
type: reference
domain: sccm
slug: develop-how-to-find-a-configuration-manager-console-node-guid
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-find-a-configuration-manager-console-node-guid
family: develop
documentKind: "how-to"
abstract: "Learn how to determine the correct Globally Unique Identifiers (GUIDs) for a Configuration Manager console node."
---

# Find a Console Node GUID

...
type: reference
domain: sccm
slug: osd-manage-drivers
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/manage-drivers
family: osd
documentKind: "how-to"
abstract: "Use the Configuration Manager driver catalog to import device drivers, group drivers in packages, and distribute those packages to distribution points."
---

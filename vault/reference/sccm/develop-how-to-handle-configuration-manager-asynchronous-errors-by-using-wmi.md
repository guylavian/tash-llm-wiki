...
type: reference
domain: sccm
slug: develop-how-to-handle-configuration-manager-asynchronous-errors-by-using-wmi
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-handle-configuration-manager-asynchronous-errors-by-using-wmi
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, when an error occurs in an asynchronous call, the error object is passed as the second parameter to the `OnCompleted` method."
---

# Handle Asynchronous Errors by Using WMI

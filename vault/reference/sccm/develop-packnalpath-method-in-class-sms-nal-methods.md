...
type: reference
domain: sccm
slug: develop-packnalpath-method-in-class-sms-nal-methods
tier: reference
...
abstract: "Encode a network abstraction layer (NAL) path from its components. A NAL path is an abstract representation of a network path or a user account."
---

...
type: reference
domain: sccm
slug: develop-filecollectionaction-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/filecollectionaction-client-wmi-class
family: develop
documentKind: "reference"
abstract: "A client Windows Management Instrumentation class that associates a set of file collection rules with reporting details, tying together files to collect with the destination of the report."
---

...
type: reference
domain: sccm
slug: develop-how-to-delete-a-state-migration-point-role
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-delete-a-state-migration-point-role
family: develop
documentKind: "how-to"
abstract: "You delete the state migration point role, in Configuration Manager, by deleting the role's SMS_SCI_SysResUse Server WMI Class object."
---

# Delete a State Migration Point Role

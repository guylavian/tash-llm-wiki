...
type: reference
domain: sccm
slug: sum-synchronize-software-updates-disconnected
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/get-started/synchronize-software-updates-disconnected
family: sum
documentKind: "how-to"
abstract: "Run software updates synchronization on the top-level software update point that is disconnected from the Internet."
---

# Synchronize updates with no Internet connection

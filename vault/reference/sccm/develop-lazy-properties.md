...
type: reference
domain: sccm
slug: develop-lazy-properties
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/lazy-properties
family: develop
documentKind: "article"
abstract: "Learn how to use lazy properties, which are properties that exist and contain data, but the data isn't available through the SMS Administrator console."
---

# SMS object lazy properties

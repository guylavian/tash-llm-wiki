...
type: reference
domain: sccm
slug: develop-how-to-call-a-configuration-manager-object-class-method-by-using-managed-code
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-call-a-configuration-manager-object-class-method-by-using-managed-code
family: develop
documentKind: "how-to"
abstract: "To call a SMS Provider class method in Configuration Manager, use the ExecuteMethod method."
---

# Call an Object Class Method by Using Managed Code

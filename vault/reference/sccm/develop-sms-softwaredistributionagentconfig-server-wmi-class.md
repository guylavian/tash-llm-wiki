...
type: reference
domain: sccm
slug: develop-sms-softwaredistributionagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_softwaredistributionagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to specify how client computers deploy software in Configuration Manager using SMS_SoftwareDistributionAgentConfig."
---

# SMS_SoftwareDistributionAgentConfig Class

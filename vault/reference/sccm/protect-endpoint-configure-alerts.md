...
type: reference
domain: sccm
slug: protect-endpoint-configure-alerts
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-configure-alerts
family: protect
documentKind: "how-to"
abstract: "Learn how to configure Endpoint Protection alerts in Configuration Manager."
---

# Configure Endpoint Protection alerts

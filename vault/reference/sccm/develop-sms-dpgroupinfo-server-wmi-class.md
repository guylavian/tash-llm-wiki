...
type: reference
domain: sccm
slug: develop-sms-dpgroupinfo-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_dpgroupinfo-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that describes a distribution point group."
---

# SMS_DPGroupInfo Class

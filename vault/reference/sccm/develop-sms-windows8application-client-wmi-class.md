...
type: reference
domain: sccm
slug: develop-sms-windows8application-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/sms_windows8application-client-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to define a Windows 8 style application or a Windows Store application in Configuration Manager."
---

# SMS_Windows8Application Class

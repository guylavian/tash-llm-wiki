...
type: reference
domain: sccm
slug: develop-sms-ci-currentcompliancestatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_ci_currentcompliancestatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Represents the compliance status for a baseline configuration item."
---

# SMS_CI_CurrentComplianceStatus Class

...
type: reference
domain: sccm
slug: develop-ccm-policy-action-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/ccm_policy_action-client-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the CCM_Policy_Action class is a client Windows Management Instrumentation class that represents settings for a policy action."
---

# CCM_Policy_Action Class

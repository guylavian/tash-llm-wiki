...
type: reference
domain: sccm
slug: develop-sms-advertisementstatusinformation-server-wmi-class
tier: reference
...
abstract: "Learn how to represent the state and description for a software distribution or software update status message in Configuration Manager."
---

# SMS_AdvertisementStatusInformation Class

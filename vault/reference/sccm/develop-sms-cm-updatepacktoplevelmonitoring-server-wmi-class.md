...
type: reference
domain: sccm
slug: develop-sms-cm-updatepacktoplevelmonitoring-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that gets the top-level installation stages and status per site."
---

# SMS_CM_UpdatePackTopLevelMonitoring Class

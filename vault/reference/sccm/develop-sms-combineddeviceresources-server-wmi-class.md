...
type: reference
domain: sccm
slug: develop-sms-combineddeviceresources-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/collections/sms_combineddeviceresources-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Details of the SMS_CombinedDeviceResources WMI class"
---

# SMS_CombinedDeviceResources Class

...
type: reference
domain: sccm
slug: develop-sms-poweragentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_poweragentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_PowerAgentConfig Windows Management Instrumentation class is an SMS Provider server class, in Configuration Manager, that specifies power management settings on client computers."
---

# SMS_PowerAgentConfig Class

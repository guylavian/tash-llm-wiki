...
type: reference
domain: sccm
slug: compliance-create-custom-configuration-items-for-windows-desktop-and-server-computers-managed-with-the-client
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/create-custom-configuration-items-for-windows-desktop-and-server-computers-managed-with-the-client
family: compliance
documentKind: "how-to"
abstract: "Manage settings for Windows computers and servers with a custom configuration item for Windows desktops and servers"
---

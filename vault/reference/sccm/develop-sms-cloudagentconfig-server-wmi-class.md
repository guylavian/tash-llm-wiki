...
type: reference
domain: sccm
slug: develop-sms-cloudagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_cloudagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_CloudAgentConfig WMI class is an SMS Provider server class in Configuration Manager."
---

# SMS_CloudAgentConfig Class

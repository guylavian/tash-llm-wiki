...
type: reference
domain: sccm
slug: core-enable-tls-1-2-server
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/security/enable-tls-1-2-server
family: core
documentKind: "how-to"
abstract: "Information about how to enable Transport Layer Security (TLS) 1.2 for Configuration Manager site servers and remote site systems."
---

...
type: reference
domain: sccm
slug: develop-how-to-run-configuration-manager-reports
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/how-to-run-configuration-manager-reports
family: develop
documentKind: "how-to"
abstract: "Information about how to access reports in the Configuration Manager console or by using Report Manager."
---

...
type: reference
domain: sccm
slug: develop-unlock-method-in-class-sms-operatingsysteminstallpackage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/unlock-method-in-class-sms_operatingsysteminstallpackage
family: develop
documentKind: "reference"
abstract: "Set the source site to the current site, unlocking the operating system install package."
---

# Unlock Method in SMS_OperatingSystemInstallPackage

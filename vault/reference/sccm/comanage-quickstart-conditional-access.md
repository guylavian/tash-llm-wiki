...
type: reference
domain: sccm
slug: comanage-quickstart-conditional-access
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/comanage/quickstart-conditional-access
family: comanage
documentKind: "article"
abstract: "Control user access to organizational resources based on compliance rules from Intune"
---

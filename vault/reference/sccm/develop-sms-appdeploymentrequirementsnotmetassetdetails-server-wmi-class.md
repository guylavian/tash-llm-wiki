...
type: reference
domain: sccm
slug: develop-sms-appdeploymentrequirementsnotmetassetdetails-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_AppDeploymentRequirementsNotMetAssetDetails class to represent asset-level details of application deployments where requirements are not met."
---

# SMS_AppDeploymentRequirementsNotMetAssetDetails Class

...
type: reference
domain: sccm
slug: develop-iccmalternatedownloadprovider-modifyjobsource-method
tier: reference
...
abstract: "Learn how to instruct the provider to modify the source location for a given job in Configuration Manager."
---

# ICcmAlternateDownloadProvider: ModifyJobSource

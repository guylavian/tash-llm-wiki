...
type: reference
domain: sccm
slug: develop-how-to-move-a-step-to-a-different-task-sequence-group
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-move-a-step-to-a-different-task-sequence-group
family: develop
documentKind: "how-to"
abstract: "Move a step from one operating system deployment task sequence group to another by adding the step to the target group."
---

# Move a Step to a Different OS Deployment Task Sequence Group

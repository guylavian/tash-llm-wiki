...
type: reference
domain: sccm
slug: develop-sms-securedcategorymembership-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_securedcategorymembership-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_SecuredCategoryMembership class in Configuration Manager."
---

# SMS_SecuredCategoryMembership Class

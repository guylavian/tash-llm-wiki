...
type: reference
domain: sccm
slug: develop-how-to-perform-an-asynchronous-query-by-using-managed-code
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Use the ProcessQuery method to perform an asynchronous query by using the managed SMS Provider in Configuration Manager."
---

# Perform an Asynchronous Query by Using Managed Code

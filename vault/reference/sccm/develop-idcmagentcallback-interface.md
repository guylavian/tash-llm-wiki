...
type: reference
domain: sccm
slug: develop-idcmagentcallback-interface
tier: reference
...
abstract: "Learn how to use the IDCMAgentCallback interface to represent the callback for the desired configuration management agent. This interface inherits from IUnknown."
---

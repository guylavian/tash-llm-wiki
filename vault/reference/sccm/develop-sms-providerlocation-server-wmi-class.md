...
type: reference
domain: sccm
slug: develop-sms-providerlocation-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/misc/sms_providerlocation-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_ProviderLocation Windows Management Instrumentation (WMI) class, in Configuration Manager, identifies the location of the SMS Provider for a site."
---

...
type: reference
domain: sccm
slug: develop-about-synchronizing-the-software-update-point
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/about-synchronizing-the-software-update-point
family: develop
documentKind: "concept-article"
abstract: "In Configuration Manager, software updates must be synchronized before the update information is available in the Configuration Manager console."
---

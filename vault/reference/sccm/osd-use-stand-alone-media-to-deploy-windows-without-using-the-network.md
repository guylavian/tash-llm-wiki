...
type: reference
domain: sccm
slug: osd-use-stand-alone-media-to-deploy-windows-without-using-the-network
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/use-stand-alone-media-to-deploy-windows-without-using-the-network
family: osd
documentKind: "how-to"
abstract: "Use standalone media in Configuration Manager to deploy Windows where bandwidth is limited as an option to refresh, install, or upgrade computers."
---

# Use standalone media to deploy Windows

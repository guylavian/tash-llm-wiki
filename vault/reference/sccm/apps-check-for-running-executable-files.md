...
type: reference
domain: sccm
slug: apps-check-for-running-executable-files
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/check-for-running-executable-files
family: apps
documentKind: "how-to"
abstract: "Configure an app deployment to check if certain executable files are running on the client."
---

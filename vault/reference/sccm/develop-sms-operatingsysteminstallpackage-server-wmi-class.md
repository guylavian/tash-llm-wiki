...
type: reference
domain: sccm
slug: develop-sms-operatingsysteminstallpackage-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_operatingsysteminstallpackage-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Serves as the unit of distribution for source files. The source files are used in a scripted installation of a valid operating system."
---

# SMS_OperatingSystemInstallPackage Class

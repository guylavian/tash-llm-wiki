...
type: reference
domain: sccm
slug: develop-iccmalternatedownloadprovider-modifyjobtimeout-method
tier: reference
...
abstract: "Learn how to use ICcmAlternateDownloadProvider::ModifyJobTimeout method to instruct the provider to modify the timeout for a given job."
---

# ICcmAlternateDownloadProvider : ModifyJobTimeout

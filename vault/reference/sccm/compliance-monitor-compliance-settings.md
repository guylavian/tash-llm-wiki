...
type: reference
domain: sccm
slug: compliance-monitor-compliance-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/monitor-compliance-settings
family: compliance
documentKind: "how-to"
abstract: "Use one or more of the procedures in this topic to display the compliance status of the configuration baseline."
---

...
type: reference
domain: sccm
slug: develop-how-to-customize-advertisement-branding-information
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-customize-advertisement-branding-information
family: develop
documentKind: "how-to"
abstract: "You set the software distribution branding information for the Configuration Manager client by changing the SWDBrandingSubTitle property of the client agent component section in the site control file."
---

# Customize Advertisement Branding Information

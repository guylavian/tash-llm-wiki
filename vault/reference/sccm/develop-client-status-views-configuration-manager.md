...
type: reference
domain: sccm
slug: develop-client-status-views-configuration-manager
tier: reference
...
abstract: "Information about the client status components on Configuration Manager client computers."
---

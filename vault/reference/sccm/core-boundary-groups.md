...
type: reference
domain: sccm
slug: core-boundary-groups
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/boundary-groups
family: core
documentKind: "concept-article"
abstract: "Help clients find site systems by using boundary groups to logically organize related network locations."
---

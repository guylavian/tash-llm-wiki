...
type: reference
domain: sccm
slug: develop-sms-pdf-program-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_pdf_program-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_PDF_Program WMI class is an SMS Provider server class that represents a package definition file (PDF) template from which to create an initialized program."
---

# SMS_PDF_Program Class

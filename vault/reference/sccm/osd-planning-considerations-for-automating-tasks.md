...
type: reference
domain: sccm
slug: osd-planning-considerations-for-automating-tasks
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/plan-design/planning-considerations-for-automating-tasks
family: osd
documentKind: "article"
abstract: "Plan before you create task sequences to automate tasks with Configuration Manager."
---

# Plan for automating tasks

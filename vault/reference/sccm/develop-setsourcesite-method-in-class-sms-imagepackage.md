...
type: reference
domain: sccm
slug: develop-setsourcesite-method-in-class-sms-imagepackage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/setsourcesite-method-in-class-sms_imagepackage
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SetSourceSite WMI class method sets the code of the source site for the image package."
---

# SetSourceSite Method in SMS_ImagePackage

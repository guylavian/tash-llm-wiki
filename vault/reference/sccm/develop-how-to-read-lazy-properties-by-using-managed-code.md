...
type: reference
domain: sccm
slug: develop-how-to-read-lazy-properties-by-using-managed-code
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "To read a lazy property from a Configuration Manager object returned in a query, you get the object instance, which retrieves any lazy object properties from the SMS Provider."
---

# Lazy Properties by Using Managed Code

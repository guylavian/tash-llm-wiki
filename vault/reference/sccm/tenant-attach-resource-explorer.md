...
type: reference
domain: sccm
slug: tenant-attach-resource-explorer
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/resource-explorer
family: tenant-attach
documentKind: "how-to"
abstract: "View hardware inventory for uploaded Configuration Manager devices using resource explorer in the admin center."
---

# Tenant attach - Resource explorer the admin center

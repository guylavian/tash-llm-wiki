...
type: reference
domain: sccm
slug: develop-gettestsmtpconnectionresult-method-in-class-sms-subscription
tier: reference
...
abstract: "Learn how the GetTestSmtpConnectionResult Windows Management Instrumentation (WMI) class method, in Configuration Manager, gets the test SMTP connection result."
---

# GetTestSmtpConnectionResult Method

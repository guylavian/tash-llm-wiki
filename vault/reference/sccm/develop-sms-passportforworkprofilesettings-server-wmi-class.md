...
type: reference
domain: sccm
slug: develop-sms-passportforworkprofilesettings-server-wmi-class
tier: reference
...
abstract: "Learn how to represent Windows Hello for Business profile settings in Configuration Manager using SMS_PassportForWorkProfileSettings."
---

# SMS_PassportForWorkProfileSettings Class

...
type: reference
domain: sccm
slug: develop-how-to-delete-status-messages
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/manage/how-to-delete-status-messages
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you delete status messages by calling the SMS_StatusMessage class DeleteByID method and supplying an array of status message RecordID identifiers."
---

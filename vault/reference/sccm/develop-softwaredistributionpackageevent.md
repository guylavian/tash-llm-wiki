...
type: reference
domain: sccm
slug: develop-softwaredistributionpackageevent
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/softwaredistributionpackageevent
family: develop
documentKind: "reference"
abstract: "Learn how to set the base class for all software distribution package related status messages using SoftWareDistributionPackageEvent."
---

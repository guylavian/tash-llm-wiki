...
type: reference
domain: sccm
slug: develop-about-configuration-manager-custom-actions
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/about-configuration-manager-custom-actions
family: develop
documentKind: "concept-article"
abstract: "You can create custom actions that can be used with existing Configuration Manager actions."
---

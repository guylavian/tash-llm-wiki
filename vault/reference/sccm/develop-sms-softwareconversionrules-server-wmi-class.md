...
type: reference
domain: sccm
slug: develop-sms-softwareconversionrules-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_softwareconversionrules-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use SMS_SoftwareConversionRules to describe rules to convert the company or product name resource string into a standard name."
---

# SMS_SoftwareConversionRules Class

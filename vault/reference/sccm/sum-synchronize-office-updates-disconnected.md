...
type: reference
domain: sccm
slug: sum-synchronize-office-updates-disconnected
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/get-started/synchronize-office-updates-disconnected
family: sum
documentKind: "how-to"
abstract: "Synchronize Microsoft 365 Apps updates on the top-level software update point that is disconnected from the Internet."
---

# Synchronize Microsoft 365 Apps updates with no Internet connection

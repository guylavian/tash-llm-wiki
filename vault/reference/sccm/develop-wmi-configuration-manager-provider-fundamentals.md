...
type: reference
domain: sccm
slug: develop-wmi-configuration-manager-provider-fundamentals
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/wmi-configuration-manager-provider-fundamentals
family: develop
documentKind: "article"
abstract: "Windows Script Host-based applications and scripts work in Windows Management Instrumentation (WMI) through the WMI Object Model, which defines the programming interface to WMI."
---

# WMI Provider Fundamentals

...
type: reference
domain: sccm
slug: develop-getclasseswithdata-method-in-class-sms-resourcemap
tier: reference
...
abstract: "Learn how the GetClassesWithData Windows Management Instrumentation (WMI) class method gets the names of the classes that have inventory data for a resource."
---

# GetClassesWithData Method

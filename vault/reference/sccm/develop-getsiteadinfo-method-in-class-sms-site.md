...
type: reference
domain: sccm
slug: develop-getsiteadinfo-method-in-class-sms-site
tier: reference
...
abstract: "Learn how to use the GetSiteADInfo method to get Active Directory information of the site server."
---

# GetSiteADInfo Method

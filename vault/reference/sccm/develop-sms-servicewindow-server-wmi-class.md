...
type: reference
domain: sccm
slug: develop-sms-servicewindow-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_servicewindow-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_ServiceWindow class to represent a window of time called a maintenance window, in which a program is allowed to execute on a group of computers."
---

# SMS_ServiceWindow Class

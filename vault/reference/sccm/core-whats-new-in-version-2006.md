...
type: reference
domain: sccm
slug: core-whats-new-in-version-2006
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/changes/whats-new-in-version-2006
family: core
documentKind: "whats-new"
abstract: "Get details about changes and new capabilities introduced in version 2006 of Configuration Manager current branch."
---
...
For more information, see [Configure Endpoint analytics data collection in Configuration Manager](../../../../endpoint-analytics/configure.md?pivots=cm).

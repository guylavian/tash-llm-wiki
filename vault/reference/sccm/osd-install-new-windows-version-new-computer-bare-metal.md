...
type: reference
domain: sccm
slug: osd-install-new-windows-version-new-computer-bare-metal
tier: reference
...
family: osd
documentKind: "how-to"
abstract: "Use Configuration Manager to install an operating system on a new computer (bare metal) by using PXE, OEM, or stand-alone media."
---

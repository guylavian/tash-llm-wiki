...
type: reference
domain: sccm
slug: core-file-based-replication
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/hierarchy/file-based-replication
family: core
documentKind: "article"
abstract: "Learn how Configuration Manager uses file-based replication to transfer data between sites in your hierarchy"
---

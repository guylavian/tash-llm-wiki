...
type: reference
domain: sccm
slug: develop-getdeviceid-method-in-class-ccm-softwarecatalogutilities
tier: reference
...
abstract: "Learn how to use the GetDeviceId method to return the device (client) identifier."
---

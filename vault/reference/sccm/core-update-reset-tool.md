...
type: reference
domain: sccm
slug: core-update-reset-tool
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/update-reset-tool
family: core
documentKind: "article"
abstract: "Use the update reset tool for in-console updates for Configuration Manager."
---

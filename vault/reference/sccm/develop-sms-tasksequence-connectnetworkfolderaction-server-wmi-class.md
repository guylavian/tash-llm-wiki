...
type: reference
domain: sccm
slug: develop-sms-tasksequence-connectnetworkfolderaction-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a task sequence action that makes a connection to a network share with SMS_TaskSequence_ConnectNetworkFolderAction."
---

# SMS_TaskSequence_ConnectNetworkFolderAction Class

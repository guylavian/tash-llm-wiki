...
type: reference
domain: sccm
slug: core-uninstall-sites-and-hierarchies
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/uninstall-sites-and-hierarchies
family: core
documentKind: "install-set-up-deploy"
abstract: "A guide for removing roles, and uninstalling sites and hierarchies"
---

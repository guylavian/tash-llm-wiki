...
type: reference
domain: sccm
slug: develop-sms-machinevariable-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_machinevariable-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_MachineVariable WMI class defines the settings of a task sequence variable that is unique to a specific computer."
---

# SMS_MachineVariable Class

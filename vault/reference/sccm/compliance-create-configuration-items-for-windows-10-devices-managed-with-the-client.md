...
type: reference
domain: sccm
slug: compliance-create-configuration-items-for-windows-10-devices-managed-with-the-client
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/create-configuration-items-for-windows-10-devices-managed-with-the-client
family: compliance
documentKind: "how-to"
abstract: "Use a configuration item to manage settings for Windows 10 or later computers that are managed by the Configuration Manager client."
---

# Create configuration items for Windows 10 or later

...
type: reference
domain: sccm
slug: develop-sms-activesyncservice-client-wmi-class
tier: reference
...
abstract: "Learn how the SMS_ActiveSyncService class is a client Windows Management Instrumentation (WMI) class that represents the ActiveSync service on the client."
---

# SMS_ActiveSyncService Class

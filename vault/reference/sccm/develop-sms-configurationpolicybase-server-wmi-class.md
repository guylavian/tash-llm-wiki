...
type: reference
domain: sccm
slug: develop-sms-configurationpolicybase-server-wmi-class
tier: reference
...
abstract: "The SMS_ConfigurationPolicyBase WMI class represents the base class for configuration policy."
---

# SMS_ConfigurationPolicyBase Class

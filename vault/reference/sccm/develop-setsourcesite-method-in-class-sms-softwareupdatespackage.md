...
type: reference
domain: sccm
slug: develop-setsourcesite-method-in-class-sms-softwareupdatespackage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/setsourcesite-method-in-class-sms_softwareupdatespackage
family: develop
documentKind: "reference"
abstract: "Learn how to set the source site for the software updates package using SetSourceSite class method."
---

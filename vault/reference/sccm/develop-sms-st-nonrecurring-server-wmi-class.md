...
type: reference
domain: sccm
slug: develop-sms-st-nonrecurring-server-wmi-class
tier: reference
...
abstract: "A Windows Management Instrumentation class that that represents a schedule token for non-recurring events."
---

# SMS_ST_NonRecurring Class

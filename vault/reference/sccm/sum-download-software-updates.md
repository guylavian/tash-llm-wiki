...
type: reference
domain: sccm
slug: sum-download-software-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/download-software-updates
family: sum
documentKind: "how-to"
abstract: "Use the Download Software Updates Wizard to download software updates and distribute them to distribution points so they are ready to deploy to clients."
---

...
type: reference
domain: sccm
slug: develop-how-to-create-form-xml-for-a-configuration-manager-dialog-box
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-create-form-xml-for-a-configuration-manager-dialog-box
family: develop
documentKind: "how-to"
abstract: "To create the form XML for a Configuration Manager dialog box, you create an XML file that describes an SmsFormData."
---

# Create Form XML for a Dialog Box

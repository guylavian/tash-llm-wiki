...
type: reference
domain: sccm
slug: develop-how-to-set-an-operating-system-deployment-task-sequence-variable
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you create an operating system deployment task sequence variable by creating an instance of the SMS_TaskSequence_SetVariableAction class, adding to a task sequence."
---

# Set an OS Deployment Task Sequence Variable

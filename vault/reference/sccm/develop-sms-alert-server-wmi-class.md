...
type: reference
domain: sccm
slug: develop-sms-alert-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_alert-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_Alert class is an SMS Provider server class that represents general alerts, which exclude client status alerts and System Center Endpoint Protection alerts."
---

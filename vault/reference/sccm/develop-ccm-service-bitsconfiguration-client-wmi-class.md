...
type: reference
domain: sccm
slug: develop-ccm-service-bitsconfiguration-client-wmi-class
tier: reference
...
abstract: "Learn how to use CCM_ServiceBITSConfiguration class which supports BITS-related settings used by CCMEXEC for uploading and downloading message payloads."
---

# CCM_Service_BITSConfiguration Class

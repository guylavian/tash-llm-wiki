...
type: reference
domain: sccm
slug: develop-iccmevent-rawevent-property
tier: reference
...
abstract: "In Configuration Manager, ICcmEvent::RawEvent is a read-only property that indicates information to add to a raw event."
---

...
type: reference
domain: sccm
slug: develop-geteula-method-in-class-sms-configurationpolicy
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/geteula-method-in-class-sms_configurationpolicy
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the GetEULA Windows Management Instrumentation class method gets the localized Microsoft Software License Terms text of the configuration item."
---

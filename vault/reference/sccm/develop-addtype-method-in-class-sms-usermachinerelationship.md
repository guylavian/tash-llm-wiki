...
type: reference
domain: sccm
slug: develop-addtype-method-in-class-sms-usermachinerelationship
tier: reference
...
abstract: "Learn how to add the type of relationship between a user and a device in Configuration Manager using AddType."
---

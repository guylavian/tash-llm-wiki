...
type: reference
domain: sccm
slug: apps-create-app-v-virtual-environments
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/create-app-v-virtual-environments
family: apps
documentKind: "how-to"
abstract: "Create virtual environments with Microsoft Application Virtualization so apps can share data with each other."
---

# Create App-V virtual environments

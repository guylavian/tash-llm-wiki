...
type: reference
domain: sccm
slug: develop-adddistributionpoints-method-in-class-sms-imagepackage
tier: reference
...
abstract: "AddDistributionPoints Windows Management Instrumentation (WMI) class method adds the list of distribution points for the image package."
---

# AddDistributionPoints Method in SMS_ImagePackage

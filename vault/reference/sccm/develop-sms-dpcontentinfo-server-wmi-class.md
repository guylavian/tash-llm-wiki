...
type: reference
domain: sccm
slug: develop-sms-dpcontentinfo-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_DPContentInfo class in Configuration Manager to describe package information for a given distribution point."
---

# SMS_DPContentInfo Class

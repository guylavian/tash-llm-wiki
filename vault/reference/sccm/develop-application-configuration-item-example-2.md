...
type: reference
domain: sccm
slug: develop-application-configuration-item-example-2
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/application-configuration-item-example-2
family: develop
documentKind: "article"
abstract: "In Configuration Manager, the following Application Configuration Item Instance example determines whether Notepad.exe is installed."
---

...
type: reference
domain: sccm
slug: core-deploy-clients-cmg-token
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/deploy-clients-cmg-token
family: core
documentKind: "article"
abstract: "Register a client on the internal network for a unique token or create a bulk registration token for internet-based devices."
---

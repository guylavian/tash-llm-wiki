...
type: reference
domain: sccm
slug: core-content-library-transfer
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/support/content-library-transfer
family: core
documentKind: "article"
abstract: "Use the Content Library Transfer tool to transfer content from one disk drive to another on a Configuration Manager distribution point."
---

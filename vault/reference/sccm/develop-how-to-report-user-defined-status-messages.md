...
type: reference
domain: sccm
slug: develop-how-to-report-user-defined-status-messages
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to report user-defined informational, warning, and error status messages, on the site server using methods defined in the SMS_StatusMessage class."
---

# Report User-Defined Status Messages

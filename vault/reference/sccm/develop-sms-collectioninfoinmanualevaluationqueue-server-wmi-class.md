...
type: reference
domain: sccm
slug: develop-sms-collectioninfoinmanualevaluationqueue-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/collections/sms_collectioninfoinmanualevaluationqueue-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Show collection info from manual evaluation queue."
---

# SMS_CollectionInfoInManualEvaluationQueue class

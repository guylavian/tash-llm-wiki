...
type: reference
domain: sccm
slug: sum-updates-publisher-options
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/tools/updates-publisher-options
family: sum
documentKind: "how-to"
abstract: "Configure options for using System Center Updates Publisher"
---

...
type: reference
domain: sccm
slug: develop-how-to-create-configuration-manager-reports
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/how-to-create-configuration-manager-reports
family: develop
documentKind: "how-to"
abstract: "Information about how to create two types of reports directly from the Configuration Manager console."
---

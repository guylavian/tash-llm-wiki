...
type: reference
domain: sccm
slug: develop-sms-g-system-softwareusagedata-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_g_system_softwareusagedata-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Provides a view of raw metering data that combines file and user information with the raw data."
---

# SMS_G_System_SoftwareUsageData Class

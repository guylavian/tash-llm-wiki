...
type: reference
domain: sccm
slug: compliance-management-tasks-for-configuration-data
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/management-tasks-for-configuration-data
family: compliance
documentKind: "article"
abstract: "After you create configuration items and baselines in Configuration Manager, you can use other commands to perform various actions."
---

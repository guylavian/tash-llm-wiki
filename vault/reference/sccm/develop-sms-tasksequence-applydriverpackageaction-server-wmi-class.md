...
type: reference
domain: sccm
slug: develop-sms-tasksequence-applydriverpackageaction-server-wmi-class
tier: reference
...
abstract: "The SMS Provider server class represents an action used in a task sequence to make all device drivers in a driver package available for use by Windows setup."
---

# SMS_TaskSequence_ApplyDriverPackageAction class

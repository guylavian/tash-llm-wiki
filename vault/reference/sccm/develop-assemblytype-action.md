...
type: reference
domain: sccm
slug: develop-assemblytype-action
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/assemblytype-action
family: develop
documentKind: "article"
abstract: "Learn how the AssemblyType action defines the type and assembly for a method that is called by the Configuration Manager console."
---

...
type: reference
domain: sccm
slug: develop-how-to-perform-a-synchronous-query-by-using-system-management
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/programming/how-to-perform-a-synchronous-query-by-using-system.management
family: develop
documentKind: "how-to"
abstract: "Learn how to run a synchronous query in Configuration Manager using ManagementObjectSearcher object."
---

# Perform a Synchronous Query by Using System.Management

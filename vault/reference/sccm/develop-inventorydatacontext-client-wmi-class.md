...
type: reference
domain: sccm
slug: develop-inventorydatacontext-client-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the InventoryDataContext class is a client WMI class that represents the WMI context qualifiers to be used with inventory client agent WMI queries built from InventoryDataItem Client WMI class objects."
---

# InventoryDataContext Class

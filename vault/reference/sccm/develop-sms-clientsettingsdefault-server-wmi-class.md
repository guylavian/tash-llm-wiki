...
type: reference
domain: sccm
slug: develop-sms-clientsettingsdefault-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_clientsettingsdefault-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that represents simple read-only default client settings properties."
---

# SMS_ClientSettingsDefault Class

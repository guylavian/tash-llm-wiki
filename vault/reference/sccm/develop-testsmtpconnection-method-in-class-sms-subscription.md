...
type: reference
domain: sccm
slug: develop-testsmtpconnection-method-in-class-sms-subscription
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/testsmtpconnection-method-in-class-sms_subscription
family: develop
documentKind: "reference"
abstract: "A Windows Management Instrumentation class method that tests the SMTP connection."
---

# TestSmtpConnection Method

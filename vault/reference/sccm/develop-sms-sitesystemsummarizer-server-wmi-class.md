...
type: reference
domain: sccm
slug: develop-sms-sitesystemsummarizer-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_sitesystemsummarizer-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent a site system summarizer using the SMS_SiteSystemSummarizer class in Configuration Manager."
---

# SMS_SiteSystemSummarizer Class

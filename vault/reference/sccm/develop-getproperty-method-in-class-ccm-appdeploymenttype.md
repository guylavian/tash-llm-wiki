...
type: reference
domain: sccm
slug: develop-getproperty-method-in-class-ccm-appdeploymenttype
tier: reference
...
abstract: "Learn how to retrieve an application deployment type property using GetProperty class in Configuration Manager."
---

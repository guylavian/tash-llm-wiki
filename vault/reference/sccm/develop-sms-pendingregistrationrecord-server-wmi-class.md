...
type: reference
domain: sccm
slug: develop-sms-pendingregistrationrecord-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_pendingregistrationrecord-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_PendingRegistrationRecord Windows Management Instrumentation (WMI) class, in Configuration Manager, that describes hardware conflicts between two computers."
---

# SMS_PendingRegistrationRecord Class

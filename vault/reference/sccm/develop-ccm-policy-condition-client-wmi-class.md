...
type: reference
domain: sccm
slug: develop-ccm-policy-condition-client-wmi-class
tier: reference
...
abstract: "Learn how to represent a policy condition in Configuration Manager using CCM_Policy_Condition."
---

# CCM_Policy_Condition Class

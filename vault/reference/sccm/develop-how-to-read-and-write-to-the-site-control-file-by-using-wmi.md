...
type: reference
domain: sccm
slug: develop-how-to-read-and-write-to-the-site-control-file-by-using-wmi
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-read-and-write-to-the-site-control-file-by-using-wmi
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you write to the site control file using Windows Management Instrumentation (WMI) by using the `SMS_SiteControlFile` class methods."
---

# Read and Write to the Site Control File by Using WMI

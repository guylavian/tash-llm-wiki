...
type: reference
domain: sccm
slug: develop-how-to-modify-a-configuration-manager-object-by-using-managed-code
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to modify a configuration manager object by using managed code with the provided examples and links."
---

# Modify an Object by Using Managed Code

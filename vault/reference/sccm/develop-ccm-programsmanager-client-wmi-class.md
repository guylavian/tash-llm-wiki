...
type: reference
domain: sccm
slug: develop-ccm-programsmanager-client-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the CCM_ProgamsManager WMI class is a public client class that manages a specified software distribution program."
---

# CCM_ProgramsManager Class

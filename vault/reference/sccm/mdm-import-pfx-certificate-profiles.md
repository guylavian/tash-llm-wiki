...
type: reference
domain: sccm
slug: mdm-import-pfx-certificate-profiles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/deploy-use/import-pfx-certificate-profiles
family: mdm
documentKind: "how-to"
abstract: "Learn how to import PFX files in Configuration Manager to generate user-specific certificates that support encrypted data exchange."
---

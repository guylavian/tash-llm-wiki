...
type: reference
domain: sccm
slug: core-configuring-source-hierarchies-and-source-sites-for-migration
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/migration/configuring-source-hierarchies-and-source-sites-for-migration
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Configure a source hierarchy and source sites so you can migrate data to your Configuration Manager current branch environment."
---

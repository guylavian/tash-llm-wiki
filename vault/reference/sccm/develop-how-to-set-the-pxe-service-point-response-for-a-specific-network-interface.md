...
type: reference
domain: sccm
slug: develop-how-to-set-the-pxe-service-point-response-for-a-specific-network-interface
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-set-the-pxe-service-point-response-for-a-specific-network-interface
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you set the operating system deployment to respond to a specific set of network addresses by adding the required media access control (MAC) addresses to the BindExcept embedded property list."
---

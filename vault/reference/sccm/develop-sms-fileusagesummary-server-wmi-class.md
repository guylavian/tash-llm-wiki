...
type: reference
domain: sccm
slug: develop-sms-fileusagesummary-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_fileusagesummary-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn about the simplified syntax, methods, properties and requirements of the SMS_FileUsageSummary server class."
---

# SMS_FileUsageSummary Class

...
type: reference
domain: sccm
slug: develop-idcmsdk-getbaselinecompliancereport-method
tier: reference
...
abstract: "Learn how to use the IDCMSDK::GetBaselineComplianceReport method to retrieve the cached discovery report for the specified configuration item baseline."
---

# IDCMSDK::GetBaselineComplianceReport

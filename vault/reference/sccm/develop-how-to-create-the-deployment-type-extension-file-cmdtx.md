...
type: reference
domain: sccm
slug: develop-how-to-create-the-deployment-type-extension-file-cmdtx
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/apps/how-to-create-the-deployment-type-extension-file-cmdtx
family: develop
documentKind: "how-to"
abstract: "Creating a Deployment Type Extension File is the first step in installing the application management extension files. The application management extension must be installed on each Configuration Manager administrator console computer that will create a custom deployment technology."
---

# How to Create the Deployment Type Extension File

...
type: reference
domain: sccm
slug: develop-blockcertificate-method-in-class-sms-certificateinfo
tier: reference
...
abstract: "The BlockCertificate Windows Management Instrumentation (WMI) class method, in Configuration Manager, blocks or unblocks the specified certificate."
---

# BlockCertificate Method

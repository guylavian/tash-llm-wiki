...
type: reference
domain: sccm
slug: develop-how-to-create-a-package-by-using-a-package-definition-file-template
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-create-a-package-by-using-a-package-definition-file-template
family: develop
documentKind: "how-to"
abstract: "The following example shows how to create a package and program by using a package definition file template in Configuration Manager."
---

# Create a Package Using a Package Definition File Template

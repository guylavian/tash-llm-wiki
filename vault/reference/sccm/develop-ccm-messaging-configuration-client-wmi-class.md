...
type: reference
domain: sccm
slug: develop-ccm-messaging-configuration-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/ccm_messaging_configuration-client-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the CCM_Messaging_Configuration class is a client WMI class that supports messaging-related settings that are exposed to administrators."
---

# CCM_Messaging_Configuration Class

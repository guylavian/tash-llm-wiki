...
type: reference
domain: sccm
slug: develop-sms-tasksequence-installupdateaction-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class in configuration Manager. It represents a task sequence that installs software updates on a target computer."
---

# SMS_TaskSequence_InstallUpdateAction Class

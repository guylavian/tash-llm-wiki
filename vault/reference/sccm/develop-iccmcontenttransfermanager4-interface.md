...
type: reference
domain: sccm
slug: develop-iccmcontenttransfermanager4-interface
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/iccmcontenttransfermanager4-interface
family: develop
documentKind: "reference"
abstract: "Learn how to invoke the Content Transfer Manager using the ICcmContentTransferManager4 interface and the associated parameters."
---

...
type: reference
domain: sccm
slug: develop-how-to-create-a-computer-variable
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-create-a-computer-variable
family: develop
documentKind: "how-to"
abstract: "Create a computer variable for a computer that is running Configuration Manager by adding instances of SMS_MachineVariable to the SMS_MachineSettings class MachineVariables array property."
---

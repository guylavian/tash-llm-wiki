...
type: reference
domain: sccm
slug: core-scenario-health
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/scenario-health
family: core
documentKind: "how-to"
abstract: "Use Configuration Manager to monitor the health of end-to-end scenarios."
---

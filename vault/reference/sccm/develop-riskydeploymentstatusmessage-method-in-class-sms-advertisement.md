...
type: reference
domain: sccm
slug: develop-riskydeploymentstatusmessage-method-in-class-sms-advertisement
tier: reference
...
abstract: "Learn how to use the RiskyDeploymentStatusMessage method to send a warning status message about a user deployment to a risky collection."
---

# RiskyDeploymentStatusMessage Method

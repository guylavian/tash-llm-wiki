...
type: reference
domain: sccm
slug: develop-sms-statattr-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a high performance version of SMS StatMsgAttributes Server class with SMS_StatAttr."
---

...
type: reference
domain: sccm
slug: develop-sms-adrdeploymentsettings-server-wmi-class
tier: reference
...
abstract: "Learn how to represent Automatic Deployment Rule (ADR) deployment settings in Configuration Manager."
---

# SMS_ADRDeploymentSettings Class

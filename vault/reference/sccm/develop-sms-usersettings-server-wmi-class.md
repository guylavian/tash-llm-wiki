...
type: reference
domain: sccm
slug: develop-sms-usersettings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_usersettings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_UserSettings class describes attributes that are specific to a single user that is managed by Configuration Manager."
---

# SMS_UserSettings Class

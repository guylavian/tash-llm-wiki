...
type: reference
domain: sccm
slug: core-custom-locations-for-site-database-files
tier: reference
...
abstract: "Learn how to specify custom locations for SQL Server database files."
---

# Custom database file locations

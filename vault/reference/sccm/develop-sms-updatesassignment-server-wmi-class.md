...
type: reference
domain: sccm
slug: develop-sms-updatesassignment-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/sum/sms_updatesassignment-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_UpdatesAssignment WMI class is an SMS Provider server class that represents a deployment."
---

...
type: reference
domain: sccm
slug: core-choose-a-device-management-solution
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/choose-a-device-management-solution
family: core
documentKind: "article"
abstract: "Learn about the solutions that Microsoft offers for managing PCs, servers, and devices."
---

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-variableconditionexpression-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_variableconditionexpression-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_TaskSequence_VariableConditionExpression WMI class is an SMS Provider server class, in Configuration Manager, that represents a condition expression to check for the existence of a variable."
---

# SMS_TaskSequence_VariableConditionExpression Class

...
type: reference
domain: sccm
slug: develop-sms-g-system-appclientstate-server-wmi-class
tier: reference
...
abstract: "The `SMS_G_System_AppClientState` Windows Management Instrumentation (WMI) class is an SMS Provider server class, in Configuration Manager, that represents application state."
---

# SMS_G_System_AppClientState Class

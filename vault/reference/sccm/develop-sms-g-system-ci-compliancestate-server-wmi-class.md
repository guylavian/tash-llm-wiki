...
type: reference
domain: sccm
slug: develop-sms-g-system-ci-compliancestate-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_g_system_ci_compliancestate-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_G_System_CI_ComplianceState Windows Management Instrumentation class is an SMS Provider server class that represents hardware inventory class objects for the compliance state of a configuration item."
---

# SMS_G_System_CI_ComplianceState Class

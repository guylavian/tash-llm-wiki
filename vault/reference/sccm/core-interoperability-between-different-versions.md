...
type: reference
domain: sccm
slug: core-interoperability-between-different-versions
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/hierarchy/interoperability-between-different-versions
family: core
documentKind: "article"
abstract: "Learn how to avoid conflicts between multiple Configuration Manager hierarchies on the same network."
---

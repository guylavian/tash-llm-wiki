...
type: reference
domain: sccm
slug: develop-sms-systemconsoleuser-client-wmi-class
tier: reference
...
abstract: "The SMS_SystemConsoleUser class is a client Windows Management Instrumentation class, in Configuration Manager, that defines usage data about users, based on the Windows security event log."
---

# SMS_SystemConsoleUser Class

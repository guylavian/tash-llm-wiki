...
type: reference
domain: sccm
slug: develop-sms-sci-component-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a Configuration Manager server component installed on one or more servers at a site."
---

# SMS_SCI_Component Class

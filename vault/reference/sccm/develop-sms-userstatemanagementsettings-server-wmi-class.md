...
type: reference
domain: sccm
slug: develop-sms-userstatemanagementsettings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_userstatemanagementsettings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the SMS_UserStateManagementSettings WMI class is an SMS Provider server class that represents the user state management settings definitions used to define configuration rules."
---

# SMS_UserStateManagementSettings Class

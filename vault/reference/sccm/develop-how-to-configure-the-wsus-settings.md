...
type: reference
domain: sccm
slug: develop-how-to-configure-the-wsus-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/sum/how-to-configure-the-wsus-settings
family: develop
documentKind: "how-to"
abstract: "Windows Server Update Services (WSUS) component settings are configured in Configuration Manager by modifying the site control file."
---

# Configure the WSUS Settings

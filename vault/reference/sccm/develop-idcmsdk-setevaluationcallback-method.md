...
type: reference
domain: sccm
slug: develop-idcmsdk-setevaluationcallback-method
tier: reference
...
abstract: "In Configuration Manager, the IDCMSDK::SetEvaluationCallback method associates a callback object with an existing evaluation job specified by job ID."
---

# IDCMSDK::SetEvaluationCallback

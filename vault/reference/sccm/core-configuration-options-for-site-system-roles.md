...
type: reference
domain: sccm
slug: core-configuration-options-for-site-system-roles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/configuration-options-for-site-system-roles
family: core
documentKind: "article"
abstract: "Consult this article for details about Configuration Manager site system roles that are not necessarily self-explanatory."
---

# Site system role options

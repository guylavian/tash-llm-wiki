...
type: reference
domain: sccm
slug: develop-sms-siib-sendertype-server-wmi-class
tier: reference
...
abstract: "Article outlining the use of SMS_SIIB_SenderType in Configuration Manager to represent the sender type in Configuration Manager property pages."
---

# SMS_SIIB_SenderType Class

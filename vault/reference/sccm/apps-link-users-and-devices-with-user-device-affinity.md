...
type: reference
domain: sccm
slug: apps-link-users-and-devices-with-user-device-affinity
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/link-users-and-devices-with-user-device-affinity
family: apps
documentKind: "how-to"
abstract: "Link users and devices with user device affinity and automatically deploy apps to all devices associated with a user."
---

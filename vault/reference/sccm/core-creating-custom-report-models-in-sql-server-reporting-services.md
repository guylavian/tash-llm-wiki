...
type: reference
domain: sccm
slug: core-creating-custom-report-models-in-sql-server-reporting-services
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/creating-custom-report-models-in-sql-server-reporting-services
family: core
documentKind: "how-to"
abstract: "Define report models to meet your business requirements, and then deploy the report models to Configuration Manager."
---

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-group-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a group of steps in a task sequence using SMS_TaskSequence_Group class in Configuration Manager."
---

# SMS_TaskSequence_Group Class

...
type: reference
domain: sccm
slug: develop-raisewarningstatusmsg-method-in-class-sms-statusmessage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/raisewarningstatusmsg-method-in-class-sms_statusmessage
family: develop
documentKind: "reference"
abstract: "Learn how to use the RaiseWarningStatusMsg method in Configuration Manager to create a warning status message."
---

# RaiseWarningStatusMsg Method

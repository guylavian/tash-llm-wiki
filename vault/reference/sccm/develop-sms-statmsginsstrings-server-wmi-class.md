...
type: reference
domain: sccm
slug: develop-sms-statmsginsstrings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_statmsginsstrings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent insertion strings in the status message using SMS_StatMsgInsStrings class in Configuration Manager."
---

# SMS_StatMsgInsStrings Class

...
type: reference
domain: sccm
slug: develop-sms-clientpfxcertificate-server-wmi-class
tier: reference
...
abstract: "The SMS_ClientPfxCertificate Windows Management Instrumentation class is an SMS Provider server class, in Configuration Manager, that contains an imported Pfx certificate."
---

# SMS_ClientPfxCertificate Class

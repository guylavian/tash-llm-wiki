...
type: reference
domain: sccm
slug: develop-how-to-create-a-new-administrator
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-create-a-new-administrator
family: develop
documentKind: "how-to"
abstract: "Learn how administrative assignments for a user or security group are defined by the roles and security scopes assigned to that user or security group."
---

...
type: reference
domain: sccm
slug: develop-sms-tasksequence-requeststatestoreaction-server-wmi-class
tier: reference
...
abstract: "The SMS_TaskSequence_RequestStateStoreAction class represents a task sequence action that requests access to a state migration point when capturing a state from a computer or restoring a state to a computer."
---

# SMS_TaskSequence_RequestStateStoreAction Class

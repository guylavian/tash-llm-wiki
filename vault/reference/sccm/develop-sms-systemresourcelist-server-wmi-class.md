...
type: reference
domain: sccm
slug: develop-sms-systemresourcelist-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_systemresourcelist-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to map network abstraction layer (NAL) paths, resource types, site codes, and role names for system resources located on site servers."
---

# SMS_SystemResourceList Class

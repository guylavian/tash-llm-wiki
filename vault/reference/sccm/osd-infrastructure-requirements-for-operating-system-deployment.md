...
type: reference
domain: sccm
slug: osd-infrastructure-requirements-for-operating-system-deployment
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/plan-design/infrastructure-requirements-for-operating-system-deployment
family: osd
documentKind: "install-set-up-deploy"
abstract: "Learn the external and product dependencies and requirements for OS deployment in Configuration Manager"
---

# OSD infrastructure requirements

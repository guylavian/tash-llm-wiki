...
type: reference
domain: sccm
slug: develop-sms-tasksequence-restoreuserstateaction-server-wmi-class
tier: reference
...
abstract: "Learn about the simplified syntax, methods, properties, and requirements of the SMS_TaskSequence_RestoreUserStateAction server class."
---

# SMS_TaskSequence_RestoreUserStateAction Class

...
type: reference
domain: sccm
slug: develop-sms-deploymentinfoflat-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_deploymentinfoflat-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how the SMS_DeploymentInfoFlat Windows Management Instrumentation (WMI) class is an SMS Provider server class."
---

# SMS_DeploymentInfoFlat Class

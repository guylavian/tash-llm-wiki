...
type: reference
domain: sccm
slug: develop-how-to-handle-configuration-manager-asynchronous-errors-by-using-managed-code
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/how-to-handle-configuration-manager-asynchronous-errors-by-using-managed-code
family: develop
documentKind: "how-to"
abstract: "To handle a Configuration Manager error raised during an asynchronous query, test the RunWorkerCompletedEventArgs parameter Error Exception property passed to the SmsBackgroundWorker.QueryProcessorCompleted event handler."
---

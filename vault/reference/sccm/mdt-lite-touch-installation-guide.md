...
type: reference
domain: sccm
slug: mdt-lite-touch-installation-guide
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdt/lite-touch-installation-guide
family: mdt
documentKind: "quickstart"
abstract: "A quickstart guide for Microsoft Deployment Toolkit (MDT) lite-touch installation (LTI)"
---

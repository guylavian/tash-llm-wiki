...
type: reference
domain: sccm
slug: develop-ddraddstringarray
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/ddraddstringarray
family: develop
documentKind: "reference"
abstract: "Learn how the DDRAddStringArray function, in Configuration Manager, adds a string array property to the data discovery record."
---

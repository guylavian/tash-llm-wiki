...
type: reference
domain: sccm
slug: osd-replace-an-existing-computer-and-transfer-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/replace-an-existing-computer-and-transfer-settings
family: osd
documentKind: "how-to"
abstract: "In Configuration Manager, choose from deployment methods, such as bootable media, multicast, or Software Center, to replace an existing computer with a new computer."
---

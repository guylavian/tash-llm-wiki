...
type: reference
domain: sccm
slug: develop-sms-roleinobjecttype-server-wmi-class
tier: reference
...
abstract: "Learn how to map a role and its associated object types in Configuration Manager using the SMS_RoleInObjectType class."
---

# SMS_RoleInObjectType Class

...
type: reference
domain: sccm
slug: develop-sms-statinsstr-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_StatInsStr Class to represent a high-performance version of SMS_StatMsgInsStrings Server WMI class."
---

# SMS_StatInsStr Class

...
type: reference
domain: sccm
slug: develop-sms-group-server-wmi-class
tier: reference
...
abstract: "Learn how to represent a resource group that serves as the abstract base class for SMS_G_System Server WMI Class using SMS_Group class."
---

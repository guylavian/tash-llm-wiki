...
type: reference
domain: sccm
slug: develop-sms-statmsgmodulenames-server-wmi-class
tier: reference
...
abstract: "Learn how to map module names to the message DLL containing the status message text using SMS_StatMsgModuleNames."
---

# SMS_StatMsgModuleNames Class

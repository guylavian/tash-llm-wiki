...
type: reference
domain: sccm
slug: develop-iciinfo-getlastevaltime-method
tier: reference
...
abstract: "In Configuration Manager, the ICIINFO::GetLastEvalTime method gets the last evaluation time for the configuration item."
---

# ICIINFO::GetLastEvalTime

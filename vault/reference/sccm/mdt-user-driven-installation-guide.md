...
type: reference
domain: sccm
slug: mdt-user-driven-installation-guide
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdt/user-driven-installation-guide
family: mdt
documentKind: "quickstart"
abstract: "A quickstart guide for using Microsoft Deployment Toolkit (MDT) for user-driven installations (UDI)"
---

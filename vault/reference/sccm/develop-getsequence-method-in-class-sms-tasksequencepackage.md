...
type: reference
domain: sccm
slug: develop-getsequence-method-in-class-sms-tasksequencepackage
tier: reference
...
abstract: "The GetSequence Windows Management Instrumentation (WMI) class method gets a task sequence (SMS_TaskSequence Server WMI Class) from a task sequence package (SMS_TaskSequencePackage Server WMI Class.)"
---

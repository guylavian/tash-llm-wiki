...
type: reference
domain: sccm
slug: develop-sms-tasksequence-applydataimageaction-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_applydataimageaction-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that represents a task sequence action to apply an existing data image to a target computer."
---

# SMS_TaskSequence_ApplyDataImageAction Class

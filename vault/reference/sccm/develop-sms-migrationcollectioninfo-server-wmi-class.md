...
type: reference
domain: sccm
slug: develop-sms-migrationcollectioninfo-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/migration/sms_migrationcollectioninfo-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_MigrationCollectionInfo WMI class is an SMS Provider server class that represents the collections created on the current active 2007 hierarchy."
---

# SMS_MigrationCollectionInfo Class

...
type: reference
domain: sccm
slug: osd-manage-user-state
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/get-started/manage-user-state
family: osd
documentKind: "how-to"
abstract: "Configuration Manager uses the User State Migration Tool to capture and restore user state data in OS deployment scenarios."
---

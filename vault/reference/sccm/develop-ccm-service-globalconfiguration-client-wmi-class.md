...
type: reference
domain: sccm
slug: develop-ccm-service-globalconfiguration-client-wmi-class
tier: reference
...
abstract: "Learn how the CCM_Service_GlobalConfiguration class is a client Windows Management Instrumentation (WMI) class that supports global configuration for the CCMEXEC service."
---

# CCM_Service_GlobalConfiguration Class

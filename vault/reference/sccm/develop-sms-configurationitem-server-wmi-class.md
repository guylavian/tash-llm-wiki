...
type: reference
domain: sccm
slug: develop-sms-configurationitem-server-wmi-class
tier: reference
...
abstract: "The SMS_ConfigurationItem Windows Management Instrumentation (WMI) class is an SMS Provider server class, in Configuration Manager, that represents a configuration item."
---

# SMS_ConfigurationItem Class

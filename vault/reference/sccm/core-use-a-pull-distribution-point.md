...
type: reference
domain: sccm
slug: core-use-a-pull-distribution-point
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/hierarchy/use-a-pull-distribution-point
family: core
documentKind: "how-to"
abstract: "Learn about configurations and limitations for using a pull-distribution point with Configuration Manager."
---

...
type: reference
domain: sccm
slug: core-use-status-system
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/use-status-system
family: core
documentKind: "how-to"
abstract: "Use the status system to understand the state of your Configuration Manager environment."
---

...
type: reference
domain: sccm
slug: mdm-bulk-enroll-devices-on-premises-mdm
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/deploy-use/bulk-enroll-devices-on-premises-mdm
family: mdm
documentKind: "how-to"
abstract: "Bulk-enroll devices in an automated way with on-premises mobile device management (MDM) in Configuration Manager."
---

# How to bulk-enroll devices

...
type: reference
domain: sccm
slug: core-planning-a-source-hierarchy-strategy
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/migration/planning-a-source-hierarchy-strategy
family: core
documentKind: "article"
abstract: "Configure a source hierarchy and gather data from a source site before you configure a Configuration Manager migration job."
---

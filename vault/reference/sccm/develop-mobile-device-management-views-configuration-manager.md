...
type: reference
domain: sccm
slug: develop-mobile-device-management-views-configuration-manager
tier: reference
...
abstract: "Information about the mobile device configuration items and configuration packages."
---

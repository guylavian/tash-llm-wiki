...
type: reference
domain: sccm
slug: core-prerequisite-checker
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/prerequisite-checker
family: core
documentKind: "article"
abstract: "Learn how to use prerequisite checker to identify and fix problems that might block a site or site system role installation."
---

...
type: reference
domain: sccm
slug: compliance-upgrade-windows-version
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/upgrade-windows-version
family: compliance
documentKind: "upgrade-and-migration-article"
abstract: "Use Configuration Manager to automatically upgrade Windows 11 and Windows 10 devices to a different Windows edition."
---

# Upgrade Windows devices to a different version
...
- [Upgrade Windows 10 editions or switch out of S mode on devices using Microsoft Intune](../../../device-configuration/templates/configure-edition-upgrade-windows.md)

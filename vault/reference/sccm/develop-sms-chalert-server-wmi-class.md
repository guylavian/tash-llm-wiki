...
type: reference
domain: sccm
slug: develop-sms-chalert-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_chalert-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that represents client status alerts."
---

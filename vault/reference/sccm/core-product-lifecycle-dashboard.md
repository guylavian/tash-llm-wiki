...
type: reference
domain: sccm
slug: core-product-lifecycle-dashboard
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/asset-intelligence/product-lifecycle-dashboard
family: core
documentKind: "how-to"
abstract: "View the Microsoft Lifecycle Policy with the product lifecycle dashboard in Configuration Manager."
---

...
type: reference
domain: sccm
slug: develop-how-to-initiate-a-one-time-membership-evaluation-for-a-collection
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Initiate a One-time Membership Evaluation for a Collection. Get a specific collection instance by using the collection ID provided."
---

# Initiate a One-time Membership Evaluation for a Collection

...
type: reference
domain: sccm
slug: core-configure-alerts
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/configure-alerts
family: core
documentKind: "how-to"
abstract: "Configure alerts to understand the state of your Configuration Manager environment."
---

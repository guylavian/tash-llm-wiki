...
type: reference
domain: sccm
slug: develop-deny-method-in-class-sms-userapplicationrequest
tier: reference
...
abstract: "The Deny Windows Management Instrumentation (WMI) class method, in Configuration Manager, denies user application requests."
---

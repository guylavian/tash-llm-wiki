...
type: reference
domain: sccm
slug: develop-sms-tasksequence-conditionexpression-server-wmi-class
tier: reference
...
abstract: "The SMS_TaskSequence_ConditionExpression WMI class is an SMS Provider server class that is the abstract base class for all condition expressions."
---

# SMS_TaskSequence_ConditionExpression Class

...
type: reference
domain: sccm
slug: develop-sms-systemconsoleusage-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/sms_systemconsoleusage-client-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_SystemConsoleUsage class to define usage data about devices based on the Windows security event log."
---

# SMS_SystemConsoleUsage Class

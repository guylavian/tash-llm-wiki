...
type: reference
domain: sccm
slug: develop-conditional-actions
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/conditional-actions
family: develop
documentKind: "article"
abstract: "Learn how to display Configuration Manager actions by specified conditions such as regular expressions, method calls, or security permissions."
---

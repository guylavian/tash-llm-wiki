...
type: reference
domain: sccm
slug: develop-how-to-create-a-configuration-manager-console-node
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/how-to-create-a-configuration-manager-console-node
family: develop
documentKind: "how-to"
abstract: "Learn how to create and start a configuration manager console node that displays available collections."
---

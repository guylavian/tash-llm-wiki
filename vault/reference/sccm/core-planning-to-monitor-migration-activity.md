...
type: reference
domain: sccm
slug: core-planning-to-monitor-migration-activity
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/migration/planning-to-monitor-migration-activity
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Learn how to use the Configuration Manager console to monitor the progress and success of migration jobs."
---

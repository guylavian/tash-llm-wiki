...
type: reference
domain: sccm
slug: develop-getfilebinary-method-in-class-sms-identification
tier: reference
...
abstract: "Learn how to use the GetFileBinary Method to get the binary user interface for a feature."
---

# GetFileBinary Method

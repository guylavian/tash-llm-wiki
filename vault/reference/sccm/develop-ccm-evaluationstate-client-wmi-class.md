...
type: reference
domain: sccm
slug: develop-ccm-evaluationstate-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/ccm_evaluationstate-client-wmi-class
family: develop
documentKind: "reference"
abstract: "The CCM_EvaluationState WMI class is an SMS Provider server class in Configuration Manager."
---

# CCM_EvaluationState Class

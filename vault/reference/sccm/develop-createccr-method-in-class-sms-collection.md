...
type: reference
domain: sccm
slug: develop-createccr-method-in-class-sms-collection
tier: reference
...
abstract: "Learn how to create a client configuration request (CCR) for a particular resource in Configuration Manager."
---

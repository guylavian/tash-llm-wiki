...
type: reference
domain: sccm
slug: develop-how-to-perform-an-asynchronous-configuration-manager-query-by-using-wmi
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to perform a synchronous query for Configuration Manager objects and implement a sink method to handle query results."
---

# Perform an Asynchronous Query by Using WMI

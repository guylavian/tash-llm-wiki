...
type: reference
domain: sccm
slug: core-site-components
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/configure/site-components
family: core
documentKind: "how-to"
abstract: "Learn how to configure site components to modify the behavior of site system roles and site status reporting."
---

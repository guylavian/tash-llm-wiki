...
type: reference
domain: sccm
slug: osd-create-a-task-sequence-to-capture-and-restore-user-state
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/create-a-task-sequence-to-capture-and-restore-user-state
family: osd
documentKind: "how-to"
abstract: "Use Configuration Manager task sequences to capture and restore the user state data in OS deployment scenarios."
---

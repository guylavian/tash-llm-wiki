...
type: reference
domain: sccm
slug: core-planning-a-client-migration-strategy
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/migration/planning-a-client-migration-strategy
family: core
documentKind: "upgrade-and-migration-article"
abstract: "Learn about the tasks that migrate clients from a source hierarchy to a Configuration Manager current branch destination hierarchy."
---

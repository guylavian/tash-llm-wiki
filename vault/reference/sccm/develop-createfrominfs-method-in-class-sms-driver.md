...
type: reference
domain: sccm
slug: develop-createfrominfs-method-in-class-sms-driver
tier: reference
...
abstract: "In Configuration Manager, the CreateFromINFs Windows Management Instrumentation class method creates SMS_Driver Server WMI Class objects."
---

# CreateFromINFs Method

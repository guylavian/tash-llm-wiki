...
type: reference
domain: sccm
slug: develop-sms-azureservicestask-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_azureservicestask-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that represents a Microsoft Azure specific operation that can be performed on the specified Microsoft Azure service. This class can be used to initiate an operation and monitor the results of the operation."
---

# SMS_AzureServicesTask Class

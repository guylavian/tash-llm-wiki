...
type: reference
domain: sccm
slug: develop-sms-sci-clientconfig-server-wmi-class
tier: reference
...
abstract: "Learn how to represent general configuration information that can be used by more than one client component using SMS_SCI_ClientConfig class."
---

# SMS_SCI_ClientConfig Class

...
type: reference
domain: sccm
slug: develop-validatequery-method-in-class-sms-collectionrulequery
tier: reference
...
abstract: "Learn how to verify that the query collection rule is a valid WQL or Extended WQL statement using ValidateQuery class method."
---

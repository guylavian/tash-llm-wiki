...
type: reference
domain: sccm
slug: develop-sms-package-server-wmi-class
tier: reference
...
abstract: "The SMS_Package Windows Management Instrumentation class is an SMS Provider server class, in Configuration Manager, that contains information about Configuration Manager packages."
---

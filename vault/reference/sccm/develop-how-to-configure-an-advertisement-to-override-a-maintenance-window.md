...
type: reference
domain: sccm
slug: develop-how-to-configure-an-advertisement-to-override-a-maintenance-window
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/how-to-configure-an-advertisement-to-override-a-maintenance-window
family: develop
documentKind: "how-to"
abstract: "Configure an advertisement to override maintenance windows using the SMS_Advertisement class and the AdvertFlags class property in Configuration Manager."
---

# Configure an Advertisement to Override a Maintenance Window

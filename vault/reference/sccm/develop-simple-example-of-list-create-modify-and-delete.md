...
type: reference
domain: sccm
slug: develop-simple-example-of-list-create-modify-and-delete
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/simple-example-of-list--create--modify--and-delete
family: develop
documentKind: "article"
abstract: "Learn how to use the SMS_Package class to list, create, modify and delete operations using the SMS Provider."
---

# Example of List, Create, Modify, and Delete

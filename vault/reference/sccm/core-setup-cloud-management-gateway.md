...
type: reference
domain: sccm
slug: core-setup-cloud-management-gateway
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/cmg/setup-cloud-management-gateway
family: core
documentKind: "how-to"
abstract: "Use this step-by-step process for setting up a cloud management gateway (CMG)."
---

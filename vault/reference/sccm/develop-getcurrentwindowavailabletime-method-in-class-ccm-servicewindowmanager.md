...
type: reference
domain: sccm
slug: develop-getcurrentwindowavailabletime-method-in-class-ccm-servicewindowmanager
tier: reference
...
abstract: "Learn how the GetCurrentWindowAvailableTime WMI class method, in Configuration Manager, gets the time remaining in a currently active service window for a specified type."
---

# GetCurrentWindowAvailableTime Method

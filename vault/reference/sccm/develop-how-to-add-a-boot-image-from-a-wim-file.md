...
type: reference
domain: sccm
slug: develop-how-to-add-a-boot-image-from-a-wim-file
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-add-a-boot-image-from-a-wim-file
family: develop
documentKind: "how-to"
abstract: "You add a boot image from a Windows Image (WIM) file to Configuration Manager by creating an instance of SMS_BootImagePackage."
---

# Add a Boot Image from a WIM File

...
type: reference
domain: sccm
slug: develop-refreshpkgsource-method-in-class-sms-driverpackage
tier: reference
...
abstract: "The RefreshPkgSource Windows Management Instrumentation (WMI) class method, in Configuration Manager, refreshes the package source at all distribution points. The following syntax is simplified from Managed Object Format (MOF) code and defines the method."
---

# RefreshPkgSource Method in SMS_DriverPackage

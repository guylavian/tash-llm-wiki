...
type: reference
domain: sccm
slug: develop-getcategorizationrequesttext-method-in-class-sms-aisoftwarelist
tier: reference
...
abstract: "The GetCategorizationRequestText retrieves the XML that is sent to System Center Online for categorization."
---

# GetCategorizationRequestText Method

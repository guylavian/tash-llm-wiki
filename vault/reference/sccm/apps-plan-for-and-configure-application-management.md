...
type: reference
domain: sccm
slug: apps-plan-for-and-configure-application-management
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/plan-design/plan-for-and-configure-application-management
family: apps
documentKind: "how-to"
abstract: "Implement and configure the necessary dependencies for deploying applications in Configuration Manager."
---

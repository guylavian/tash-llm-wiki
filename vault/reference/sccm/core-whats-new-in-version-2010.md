...
type: reference
domain: sccm
slug: core-whats-new-in-version-2010
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/changes/whats-new-in-version-2010
family: core
documentKind: "whats-new"
abstract: "Get details about changes and new capabilities introduced in version 2010 of Configuration Manager current branch."
---
...
For more information, see [Enable data sharing](../../../../device-updates/windows/monitor-compatibility.md).
...
For more information, see [Desktop Analytics prerequisites](../../../../device-updates/windows/monitor-compatibility.md)

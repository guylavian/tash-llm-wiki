...
type: reference
domain: sccm
slug: develop-how-to-check-if-a-user-has-permissions-for-a-resource
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Check whether a user has permission for a resource using the GetCollectionsWithResourcePermissions method in the SMS_RbacSecuredObject class."
---

# Check if a User Has Permissions for a Resource

...
type: reference
domain: sccm
slug: develop-sql-server-views-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/sql-server-views-configuration-manager
family: develop
documentKind: "reference"
abstract: "A Microsoft SQL Server view is a virtual table whose contents are based on the result from a SQL query."
---

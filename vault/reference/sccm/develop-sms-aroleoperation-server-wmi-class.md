...
type: reference
domain: sccm
slug: develop-sms-aroleoperation-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_aroleoperation-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that SMS_Role embeds, and this class describes the operation granted to this role."
---

# SMS_ARoleOperation Class

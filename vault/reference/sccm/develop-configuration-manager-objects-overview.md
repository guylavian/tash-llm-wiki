...
type: reference
domain: sccm
slug: develop-configuration-manager-objects-overview
tier: reference
...
abstract: "The Configuration Manager objects are instances of Configuration Manager-specific WMI classes managed by the SMS Provider."
---

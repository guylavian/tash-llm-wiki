...
type: reference
domain: sccm
slug: protect-create-wifi-profiles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/create-wifi-profiles
family: protect
documentKind: "how-to"
abstract: "Learn how to use Wi-Fi profiles in Configuration Manager to deploy wireless network settings to users in your organization."
---

# How to create Wi-Fi profiles

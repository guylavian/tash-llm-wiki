...
type: reference
domain: sccm
slug: develop-sms-r-ipnetwork-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_r_ipnetwork-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_R_IPNetwork WMI class is an SMS Provider server class, in Configuration Manager, that is generated dynamically and contains data for resources discovered by the Network Discovery Agent."
---

# SMS_R_IPNetwork Class

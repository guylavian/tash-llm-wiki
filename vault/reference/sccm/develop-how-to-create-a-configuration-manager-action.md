...
type: reference
domain: sccm
slug: develop-how-to-create-a-configuration-manager-action
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "Learn how to create a console action by creating an XML file that populates an ActionDescription XML element for the action."
---

# Create a Configuration Manager Action

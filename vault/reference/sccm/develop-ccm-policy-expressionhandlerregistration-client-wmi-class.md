...
type: reference
domain: sccm
slug: develop-ccm-policy-expressionhandlerregistration-client-wmi-class
tier: reference
...
abstract: "Learn how to describe a registered expression handler for a policy with CCM_Policy_ExpressionHandlerRegistration."
---

# CCM_Policy_ExpressionHandlerRegistration Class

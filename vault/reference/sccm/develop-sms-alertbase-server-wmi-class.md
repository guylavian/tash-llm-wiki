...
type: reference
domain: sccm
slug: develop-sms-alertbase-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_alertbase-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent the base class for SMS_Alert, SMS_EPAlert, and SMS_SCHALert using SMS_AlertBase class."
---

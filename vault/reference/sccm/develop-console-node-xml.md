...
type: reference
domain: sccm
slug: develop-console-node-xml
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/console-node-xml
family: develop
documentKind: "concept-article"
abstract: "Learn how to use the Configuration Manager Console Node XML to cause a grid view to appear in the view panel displaying the RoleName and SiteCode properties."
---

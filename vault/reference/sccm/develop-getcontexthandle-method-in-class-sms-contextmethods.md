...
type: reference
domain: sccm
slug: develop-getcontexthandle-method-in-class-sms-contextmethods
tier: reference
...
abstract: "The GetContextHandle method, in Configuration Manager, stores context objects on the server."
---

# GetContextHandle Method

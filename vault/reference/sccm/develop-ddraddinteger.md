...
type: reference
domain: sccm
slug: develop-ddraddinteger
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/ddraddinteger
family: develop
documentKind: "reference"
abstract: "Learn how to add an integer property to the data discovery record (DDR) using DDRAddInteger function."
---

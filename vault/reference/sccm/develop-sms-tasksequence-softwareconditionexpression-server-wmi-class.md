...
type: reference
domain: sccm
slug: develop-sms-tasksequence-softwareconditionexpression-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequence_softwareconditionexpression-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that represents a condition expression to verify if a specified product is installed on the destination computer."
---

# SMS_TaskSequence_SoftwareConditionExpression Class

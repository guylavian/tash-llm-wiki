...
type: reference
domain: sccm
slug: develop-sms-applicationlatest-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_applicationlatest-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent an application in Configuration Manager using SMS_ApplicationLatest class."
---

# SMS_ApplicationLatest Class

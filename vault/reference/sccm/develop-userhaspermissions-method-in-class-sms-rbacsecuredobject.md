...
type: reference
domain: sccm
slug: develop-userhaspermissions-method-in-class-sms-rbacsecuredobject
tier: reference
...
abstract: "In Configuration Manager, the UserHasPermissions Windows Management Instrumentation class method determines whether the current user has the requested permissions for the specified object."
---

# UserHasPermissions Method

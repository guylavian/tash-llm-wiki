...
type: reference
domain: sccm
slug: develop-sms-certificateinfo-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_certificateinfo-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_CertificateInfo WMI class is an SMS Provider server class, in Configuration Manager, that defines a media certificate registered by Configuration Manager."
---

# SMS_CertificateInfo Class

...
type: reference
domain: sccm
slug: develop-software-metering-views-configuration-manager
tier: reference
...
abstract: "Information such as the software metering rules that are created in the Configuration Manager hierarchy."
---

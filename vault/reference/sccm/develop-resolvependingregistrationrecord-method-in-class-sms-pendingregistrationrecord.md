...
type: reference
domain: sccm
slug: develop-resolvependingregistrationrecord-method-in-class-sms-pendingregistrationrecord
tier: reference
...
abstract: "The ResolvePendingRegistrationRecord Windows Management Instrumentation (WMI) class method resolves any conflicts for the pending registration records."
---

# ResolvePendingRegistrationRecord Method

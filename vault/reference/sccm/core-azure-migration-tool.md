...
type: reference
domain: sccm
slug: core-azure-migration-tool
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/support/azure-migration-tool
family: core
documentKind: "how-to"
abstract: "Learn about how to use the migration tool to programmatically create Azure virtual machines for Configuration Manager."
---

...
type: reference
domain: sccm
slug: core-capabilities-in-technical-preview-1707
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/get-started/capabilities-in-technical-preview-1707
family: core
documentKind: "whats-new"
abstract: "Learn about features available in the Technical Preview version 1707 for Configuration Manager."
---

# Technical Preview 1707
...
You can find more information about how to specify network definitions in the [Windows Information Protection documentation](/windows/security/information-protection/windows-information-protection/create-wip-policy-using-configmgr).

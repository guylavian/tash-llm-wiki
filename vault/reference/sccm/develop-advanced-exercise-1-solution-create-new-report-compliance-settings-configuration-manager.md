...
type: reference
domain: sccm
slug: develop-advanced-exercise-1-solution-create-new-report-compliance-settings-configuration-manager
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/advanced-exercise-1-solution-create-new-report-compliance-settings-configuration-manager
family: develop
documentKind: "how-to"
abstract: "Procedure to create the report in Advanced Exercise 1."
---

# Advanced exercise 1 solution: Create a new report for compliance settings

...
type: reference
domain: sccm
slug: develop-postponeprogramstononbusinesshours-method-in-class-ccm-programsmanager
tier: reference
...
abstract: "In Configuration Manager, the PostponeProgramsToNonBusinessHours WMI class method schedules legacy software distribution programs to run in the next available user defined service window."
---

# PostponeProgramsToNonBusinessHours Method

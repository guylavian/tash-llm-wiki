...
type: reference
domain: sccm
slug: develop-sms-tasksequencereferencesinfo-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/sms_tasksequencereferencesinfo-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_TaskSequenceReferencesInfo class associates a task sequence with its package."
---

# SMS_TaskSequenceReferencesInfo Class

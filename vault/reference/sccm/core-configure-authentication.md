...
type: reference
domain: sccm
slug: core-configure-authentication
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/cmg/configure-authentication
family: core
documentKind: "how-to"
abstract: "Configure authentication methods for clients to use a cloud management gateway (CMG)."
---

# Configure CMG client authentication

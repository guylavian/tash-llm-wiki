...
type: reference
domain: sccm
slug: develop-sms-tasksequence-pointer-server-wmi-class
tier: reference
...
abstract: "The SMS_TaskSequence_Pointer WMI class is an SMS provider server class that represents information about an operating system deployment task sequence."
---

# SMS_TaskSequence_Pointer Class

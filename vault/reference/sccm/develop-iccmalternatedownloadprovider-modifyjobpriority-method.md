...
type: reference
domain: sccm
slug: develop-iccmalternatedownloadprovider-modifyjobpriority-method
tier: reference
...
abstract: "A method that tells the provider to modify the priority for a given job."
---

# ICcmAlternateDownloadProvider : ModifyJobPriority

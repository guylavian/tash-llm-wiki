...
type: reference
domain: sccm
slug: develop-how-to-handle-configuration-manager-synchronous-errors-by-using-managed-code
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "To handle a Configuration Manager error raised in a synchronous query, catch the SmsQueryException exception."
---

# Handle Synchronous Errors by Using Managed Code

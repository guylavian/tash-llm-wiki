...
type: reference
domain: sccm
slug: develop-how-to-configure-software-inventory-settings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/inventory/how-to-configure-software-inventory-settings
family: develop
documentKind: "how-to"
abstract: "Set the Software Inventory Client Agent settings, in Configuration Manager, by modifying the necessary site control file settings."
---

# Configure Software Inventory Settings

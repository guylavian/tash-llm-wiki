...
type: reference
domain: sccm
slug: develop-sms-cm-updatepackagesitestatus-server-wmi-class
tier: reference
...
abstract: "The `SMS_CM_UpdatePackageSiteStatus` Windows Management Instrumentation (WMI) class is an SMS Provider server class, in Configuration Manager, that is used to get the update package installation status per site."
---

# SMS_CM_UpdatePackageSiteStatus Class

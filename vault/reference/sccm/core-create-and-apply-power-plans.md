...
type: reference
domain: sccm
slug: core-create-and-apply-power-plans
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/power/create-and-apply-power-plans
family: core
documentKind: "how-to"
abstract: "Create and apply power plans in Configuration Manager."
---

# Create and apply power plans

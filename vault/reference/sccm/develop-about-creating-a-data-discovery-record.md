...
type: reference
domain: sccm
slug: develop-about-creating-a-data-discovery-record
tier: reference
...
abstract: "Learn how to create data discovery records (DDRs), using the SMSRsGenCtl.dll and other functions."
---

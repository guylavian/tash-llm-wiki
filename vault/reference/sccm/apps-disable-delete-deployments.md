...
type: reference
domain: sccm
slug: apps-disable-delete-deployments
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/disable-delete-deployments
family: apps
documentKind: "how-to"
abstract: "If you want to stop the deployment of an application, you can either disable it temporarily or delete it entirely."
---

# Disable and delete app deployments

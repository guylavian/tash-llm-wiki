...
type: reference
domain: sccm
slug: develop-wmi-namespaces-classes-configuration-manager-reports
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sqlviews/wmi-namespaces-classes-configuration-manager-reports
family: develop
documentKind: "reference"
abstract: "Configuration Manager WMI namespaces and classes for Configuration Manager reports"
---

# WMI namespaces and classes for reports

...
type: reference
domain: sccm
slug: apps-package-definition-files
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/package-definition-files
family: apps
documentKind: "how-to"
abstract: "Learn about using package definition files to create packages and programs in Configuration Manager"
---

...
type: reference
domain: sccm
slug: develop-sms-supportedplatforms-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_supportedplatforms-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent the platforms that Configuration Manager supports using the SMS_SupportedPlatforms."
---

# SMS_SupportedPlatforms Class

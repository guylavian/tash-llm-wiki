...
type: reference
domain: sccm
slug: develop-how-to-create-an-association-between-two-computers-in-configuration-manager
tier: reference
...
family: develop
documentKind: "how-to"
abstract: "You create an association between a reference and destination computer, in Configuration Manager, by calling the AddAssociation Method in Class SMS_StateMigration"
---

# Create an Association Between Two Computers

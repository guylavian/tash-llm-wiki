...
type: reference
domain: sccm
slug: osd-task-sequence-performance
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/task-sequence-performance
family: osd
documentKind: "how-to"
abstract: "To improve the overall speed of the task sequence, run it with the Windows high-performance power plan."
---

...
type: reference
domain: sccm
slug: sum-prepare-for-software-updates-management
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/get-started/prepare-for-software-updates-management
family: sum
documentKind: "how-to"
abstract: "To prepare to manage updates, complete these tasks to display compliance assessment data in the Configuration Manager console."
---

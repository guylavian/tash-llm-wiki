...
type: reference
domain: sccm
slug: develop-server-runtime-requirements
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/reqs/server-runtime-requirements
family: develop
documentKind: "reference"
abstract: "Microsoft Configuration Manager server applications that are developed by using the Configuration Manager SDK, have the following runtime requirements."
---

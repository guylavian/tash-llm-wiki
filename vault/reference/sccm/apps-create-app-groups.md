...
type: reference
domain: sccm
slug: apps-create-app-groups
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/create-app-groups
family: apps
documentKind: "how-to"
abstract: "Create a group of applications that you can send to a user or device collection as a single deployment in Configuration Manager."
---

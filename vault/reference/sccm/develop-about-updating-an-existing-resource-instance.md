...
type: reference
domain: sccm
slug: develop-about-updating-an-existing-resource-instance
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/configure/about-updating-an-existing-resource-instance
family: develop
documentKind: "concept-article"
abstract: "When the Data Discovery Manager, in Configuration Manager, finds an existing resource that matches the data discovery record, the resource instance is updated; otherwise, a new instance is created."
---

...
type: reference
domain: sccm
slug: develop-site-configuration-server-wmi-classes
tier: reference
...
abstract: "The site configuration server WMI classes in Configuration Manager relate to an installation that consists of one or more computers running the Configuration Manager components."
---

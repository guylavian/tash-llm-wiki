...
type: reference
domain: sccm
slug: develop-sms-dpgroupdistributionstatusdetails-server-wmi-class
tier: reference
...
abstract: "The SMS_DPGroupDistributionStatusDetails WMI class is an SMS Provider server class, in Configuration Manager, that represents distribution point status details."
---

# SMS_DPGroupDistributionStatusDetails Class

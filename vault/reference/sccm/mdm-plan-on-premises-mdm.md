...
type: reference
domain: sccm
slug: mdm-plan-on-premises-mdm
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/mdm/plan-design/plan-on-premises-mdm
family: mdm
documentKind: "article"
abstract: "Plan for on-premises mobile device management to manage mobile devices in Configuration Manager"
---

# Plan on-premises MDM

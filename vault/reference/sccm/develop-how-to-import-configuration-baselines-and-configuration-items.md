...
type: reference
domain: sccm
slug: develop-how-to-import-configuration-baselines-and-configuration-items
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/how-to-import-configuration-baselines-and-configuration-items
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, importing a configuration baseline or configuration item by using the Configuration Manager SDK requires a properly formatted XML file."
---

# Import Configuration Baselines and Items

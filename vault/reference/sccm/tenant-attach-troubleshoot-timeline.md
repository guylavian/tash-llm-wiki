...
type: reference
domain: sccm
slug: tenant-attach-troubleshoot-timeline
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/tenant-attach/troubleshoot-timeline
family: tenant-attach
documentKind: "troubleshooting"
abstract: "Troubleshooting the device timeline for Intune tenant attach"
---

# Troubleshooting the device timeline
...
- The user account might need an [Intune role](../../fundamentals/role-based-access-control/overview.md) assigned. <!--7980141-->

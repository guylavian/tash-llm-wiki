...
type: reference
domain: sccm
slug: develop-configuration-manager-schema-sql-views
tier: reference
...
abstract: "Creates schema information views. These are particularly useful for determining the names for custom inventory resource type (architecture) tables."
---

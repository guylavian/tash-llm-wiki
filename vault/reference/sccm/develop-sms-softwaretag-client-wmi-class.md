...
type: reference
domain: sccm
slug: develop-sms-softwaretag-client-wmi-class
tier: reference
...
abstract: "Learn how to use SMS_SoftwareTag class to indicate the presence of a software application on a computer."
---

# SMS_SoftwareTag Class

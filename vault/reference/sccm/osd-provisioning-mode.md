...
type: reference
domain: sccm
slug: osd-provisioning-mode
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/understand/provisioning-mode
family: osd
documentKind: "troubleshooting"
abstract: "Learn about client provisioning mode during the Configuration Manager task sequence."
---

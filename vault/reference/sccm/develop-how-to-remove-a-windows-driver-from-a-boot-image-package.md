...
type: reference
domain: sccm
slug: develop-how-to-remove-a-windows-driver-from-a-boot-image-package
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-remove-a-windows-driver-from-a-boot-image-package
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you remove a Windows driver from an operating system deployment boot image package by removing it from the ReferencedDrivers property of the SMS_BootImagePackage Server WMI Class object."
---

# Remove a Windows Driver from a Boot Image Package

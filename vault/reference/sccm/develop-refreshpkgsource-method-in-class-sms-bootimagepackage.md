...
type: reference
domain: sccm
slug: develop-refreshpkgsource-method-in-class-sms-bootimagepackage
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/osd/refreshpkgsource-method-in-class-sms_bootimagepackage
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the RefreshPkgSource WMI class method refreshes the package source at all distribution points."
---

# RefreshPkgSource Method in SMS_BootImagePackage

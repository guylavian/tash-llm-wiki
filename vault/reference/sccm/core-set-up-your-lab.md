...
type: reference
domain: sccm
slug: core-set-up-your-lab
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/get-started/set-up-your-lab
family: core
documentKind: "install-set-up-deploy"
abstract: "Set up a lab for evaluating Configuration Manager with simulated real-life activities."
---

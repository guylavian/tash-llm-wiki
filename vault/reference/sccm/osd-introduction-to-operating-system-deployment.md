...
type: reference
domain: sccm
slug: osd-introduction-to-operating-system-deployment
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/understand/introduction-to-operating-system-deployment
family: osd
documentKind: "install-set-up-deploy"
abstract: "Understand the concepts before you deploy operating systems in your Configuration Manager environment."
---

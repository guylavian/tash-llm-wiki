...
type: reference
domain: sccm
slug: core-software-update-health-dashboard
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/software-update-health-dashboard
family: core
documentKind: "article"
abstract: "Use a dashboard in the console to view information about the software update health status of clients in your environment."
---

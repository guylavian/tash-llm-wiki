...
type: reference
domain: sccm
slug: protect-server-event-logs
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/tech-ref/bitlocker/server-event-logs
family: protect
documentKind: "reference"
abstract: "A technical reference for the possible BitLocker (MBAM) server entries in the Windows event log"
---

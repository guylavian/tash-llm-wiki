...
type: reference
domain: sccm
slug: develop-sms-dcmdeploymenterrorassetdetails-server-wmi-class
tier: reference
...
abstract: "Represents the asset details for deployment error."
---

# SMS_DCMDeploymentErrorAssetDetails Class

...
type: reference
domain: sccm
slug: develop-sms-sci-sitedefinition-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_SCI_SiteDefinition class which contains general definitions for the site and accounts used by Configuration Manager."
---

# SMS_SCI_SiteDefinition Class

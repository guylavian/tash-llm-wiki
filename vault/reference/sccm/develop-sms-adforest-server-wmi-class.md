...
type: reference
domain: sccm
slug: develop-sms-adforest-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/sms_adforest-server-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class that contains Active Directory forests discovered by Configuration Manager Forest Discovery."
---

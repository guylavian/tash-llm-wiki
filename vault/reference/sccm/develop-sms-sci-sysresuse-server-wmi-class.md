...
type: reference
domain: sccm
slug: develop-sms-sci-sysresuse-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class that represents a specific usage of a server or other network resource."
---

# SMS_SCI_SysResUse Class

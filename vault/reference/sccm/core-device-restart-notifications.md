...
type: reference
domain: sccm
slug: core-device-restart-notifications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/device-restart-notifications
family: core
documentKind: "article"
abstract: "Restart notification behavior for various client settings in Configuration Manager."
---

...
type: reference
domain: sccm
slug: develop-getpackagehash-method-in-class-sms-tasksequencepackage
tier: reference
...
abstract: "Learn how to get the hash of a Configuration Manager package using GetPackageHash class method in Configuration Manager."
---

# GetPackageHash Method

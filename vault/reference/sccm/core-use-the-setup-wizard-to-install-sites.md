...
type: reference
domain: sccm
slug: core-use-the-setup-wizard-to-install-sites
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/deploy/install/use-the-setup-wizard-to-install-sites
family: core
documentKind: "overview"
abstract: "Use the Configuration Manager setup wizard to install a new site."
---

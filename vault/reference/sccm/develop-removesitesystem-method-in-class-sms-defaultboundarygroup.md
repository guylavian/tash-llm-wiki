...
type: reference
domain: sccm
slug: develop-removesitesystem-method-in-class-sms-defaultboundarygroup
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/configure/removesitesystem-method-in-class-sms-defaultboundarygroup
family: develop
documentKind: "reference"
abstract: "Learn how to remove one or more site system servers from a default boundary group using the RemoveSiteSystem class."
---

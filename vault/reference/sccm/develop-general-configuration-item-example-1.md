...
type: reference
domain: sccm
slug: develop-general-configuration-item-example-1
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/compliance/general-configuration-item-example-1
family: develop
documentKind: "article"
abstract: "The following example is a general configuration item schema example that checks the registry to see whether, in this case, remote control is enabled in Configuration Manager."
---

...
type: reference
domain: sccm
slug: apps-deploy-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/deploy-applications
family: apps
documentKind: "how-to"
abstract: "Create or simulate a deployment of an application to a device or user collection"
---

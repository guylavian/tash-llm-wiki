...
type: reference
domain: sccm
slug: apps-plugin-config-xml
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/pcm/plugin-config-xml
family: apps
documentKind: "reference"
abstract: "Technical reference for the XML elements of the Package Conversion Manager plug-in."
---

# Plug-in configuration XML

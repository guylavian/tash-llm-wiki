...
type: reference
domain: sccm
slug: develop-sms-cicontentpackage-server-wmi-class
tier: reference
...
abstract: "The SMS_CIContentPackage WMI class represents the relationship between configuration item and associated content to SMS Package where the binary content is packaged and distributed."
---

# SMS_CIContentPackage Class

...
type: reference
domain: sccm
slug: develop-sms-categoryinstancebase-server-wmi-class
tier: reference
...
abstract: "Learn how to use the SMS_CategoryInstanceBase class which is an SMS Provider server class."
---

# SMS_CategoryInstanceBase Class

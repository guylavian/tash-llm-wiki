...
type: reference
domain: sccm
slug: develop-getfeaturestate-method-in-class-sms-site
tier: reference
...
abstract: "A Windows Management Instrumentation class method that gets the enabled and disabled state of a feature."
---

...
type: reference
domain: sccm
slug: develop-sms-cirelation-flat-server-wmi-class
tier: reference
...
abstract: "The SMS_CIRelation_Flat Windows Management Instrumentation (WMI) class is an SMS Provider server class, in Configuration Manager, that provides a flat list of relationship information for directly or indirectly related configuration items."
---

# SMS_CIRelation_Flat Class

...
type: reference
domain: sccm
slug: develop-sms-objectlock-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/misc/sms_objectlock-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_ObjectLock abstract WMI class represents methods for locking and unlocking global objects."
---

# SMS_ObjectLock Class

...
type: reference
domain: sccm
slug: protect-endpoint-protection-site-role
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/endpoint-protection-site-role
family: protect
documentKind: "how-to"
abstract: "Learn how to configure Endpoint Protection to manage security and malware on Configuration Manager client computers."
---

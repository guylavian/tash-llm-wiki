...
type: reference
domain: sccm
slug: develop-configuration-manager-object-security
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/configuration-manager-object-security
family: develop
documentKind: "article"
abstract: "The delegate verb in Configuration Manager provides administrators with a way of allowing users to assign to other users the instance permissions to an object in a very limited way."
---

...
type: reference
domain: sccm
slug: develop-updatedefaultimage-method-in-class-sms-bootimagepackage
tier: reference
...
abstract: "Creates a copy of the .wim image pointed to by the ImagePath property. This method expects an SMS_BootImagePackage instance with the ImagePath property being a valid .wim image."
---

# UpdateDefaultImage Method

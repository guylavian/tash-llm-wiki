...
type: reference
domain: sccm
slug: develop-about-configuration-manager-wmi-programming
tier: reference
...
abstract: "Programming the Configuration Manager client WMI provider differs according to the programming language you use."
---

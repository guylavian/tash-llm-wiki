...
type: reference
domain: sccm
slug: hotfix-32851084
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/hotfix/2503/32851084
family: hotfix
documentKind: "reference"
abstract: "Update rollup for Configuration Manager 2503"
---
...
- After installing this update, Cloud Management Gateway (CMG) may appear in "Error" status in Configuration Manager console with Status Description "Failed to perform maintenance". There is no impact to CMG functionality. The details are available in the following article:
  ...
  - [CMG maintenance task fails to update public IP resource after installing KB32851084](/troubleshoot/mem/configmgr/cloud-services/public-ip-creation-error)

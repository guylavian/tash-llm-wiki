...
type: reference
domain: sccm
slug: develop-importinventoryreport-method-in-class-sms-inventoryreport
tier: reference
...
abstract: "Learn how to import an inventory class from the MOF file content using ImportInventoryReport class in Configuration Manager."
---

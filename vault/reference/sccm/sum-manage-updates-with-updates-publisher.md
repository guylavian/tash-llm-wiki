...
type: reference
domain: sccm
slug: sum-manage-updates-with-updates-publisher
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/tools/manage-updates-with-updates-publisher
family: sum
documentKind: "how-to"
abstract: "Manage the updates you deploy and create with System Center Updates Publisher"
---

...
type: reference
domain: sccm
slug: protect-client-event-logs
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/tech-ref/bitlocker/client-event-logs
family: protect
documentKind: "reference"
abstract: "A technical reference for the possible BitLocker (MBAM) client entries in the Windows event log"
---

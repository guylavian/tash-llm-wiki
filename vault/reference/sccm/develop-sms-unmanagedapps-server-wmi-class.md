...
type: reference
domain: sccm
slug: develop-sms-unmanagedapps-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_unmanagedapps-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_UnManagedApps WMI class is an SMS Provider server class that represents unmanaged apps."
---

# SMS_UnManagedApps Class

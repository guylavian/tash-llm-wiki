...
type: reference
domain: sccm
slug: develop-sms-r-usergroup-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/manage/sms_r_usergroup-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_R_UserGroup class is an SMS Provider server class that is generated dynamically at SMS Provider run time and contains discovery data for user group objects."
---

# SMS_R_UserGroup Class

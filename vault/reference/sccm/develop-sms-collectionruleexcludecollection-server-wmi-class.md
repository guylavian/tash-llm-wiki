...
type: reference
domain: sccm
slug: develop-sms-collectionruleexcludecollection-server-wmi-class
tier: reference
...
abstract: "The SMS_CollectionRuleExcludeCollection class is an SMS Provider server class represents an exclusion rule that is added as a rule to the SMS_Collection instance."
---

# SMS_CollectionRuleExcludeCollection Class

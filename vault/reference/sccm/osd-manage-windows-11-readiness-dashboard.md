...
type: reference
domain: sccm
slug: osd-manage-windows-11-readiness-dashboard
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/manage-windows-11-readiness-dashboard
family: osd
documentKind: "article"
abstract: "View the state of Windows 11 readiness dashboard using Configuration Manager"
---

# Manage Windows 11 readiness dashboard

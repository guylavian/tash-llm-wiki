...
type: reference
domain: sccm
slug: develop-sms-appdependencydata-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/apps/sms_appdependencydata-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The `SMS_AppDependencyData` Windows Management Instrumentation (WMI) class is an SMS Provider server class, in Configuration Manager, that represents application deployment dependency data."
---

# SMS_AppDependencyData Class

...
type: reference
domain: sccm
slug: develop-how-to-set-the-restore-only-mode-for-a-state-migration-point
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/osd/how-to-set-the-restore-only-mode-for-a-state-migration-point
family: develop
documentKind: "how-to"
abstract: "In Configuration Manager, you configure the operating system deployment state migration point to reject new requests to store user data by setting the SMPQuiesceState embedded property."
---

# Set the Restore-Only Mode for a State Migration Point

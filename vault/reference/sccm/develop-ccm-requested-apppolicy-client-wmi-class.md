...
type: reference
domain: sccm
slug: develop-ccm-requested-apppolicy-client-wmi-class
tier: reference
...
abstract: "Learn how to represent an application policy request with CCM_RequestedAppPolicy in Configuration Manager."
---

# CCM_Requested AppPolicy Class

...
type: reference
domain: sccm
slug: protect-monitor-wifi-email-vpn-profiles
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/monitor-wifi-email-vpn-profiles
family: protect
documentKind: "how-to"
abstract: "Learn how to monitor the compliance status of email, Wi-Fi, and VPN profiles in Configuration Manager."
---

# Monitor Email, Wi-Fi and VPN profiles

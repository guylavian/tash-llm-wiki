...
type: reference
domain: sccm
slug: sum-automatically-deploy-software-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/automatically-deploy-software-updates
family: sum
documentKind: "install-set-up-deploy"
abstract: "Automatically deploy software updates by using automatic deployment rules (ADR)."
---

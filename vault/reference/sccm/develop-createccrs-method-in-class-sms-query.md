...
type: reference
domain: sccm
slug: develop-createccrs-method-in-class-sms-query
tier: reference
...
abstract: "Learn how to generate client configuration requests (CCRs) for the query in Configuration Manager using CreateCCRs."
---

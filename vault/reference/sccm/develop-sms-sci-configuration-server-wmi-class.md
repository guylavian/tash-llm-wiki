...
type: reference
domain: sccm
slug: develop-sms-sci-configuration-server-wmi-class
tier: reference
...
abstract: "In Configuration Manager, the SMS_SCI_Configuration Windows Management Instrumentation class is an SMS Provider server class that represents a configuration item, which is a generic named container of properties and property lists, for a site server component."
---

# SMS_SCI_Configuration Class

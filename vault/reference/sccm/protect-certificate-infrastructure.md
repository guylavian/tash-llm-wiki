...
type: reference
domain: sccm
slug: protect-certificate-infrastructure
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/protect/deploy-use/certificate-infrastructure
family: protect
documentKind: "how-to"
abstract: "Learn how to configure certificate enrollment in Configuration Manager."
---

...
type: reference
domain: sccm
slug: core-support-for-windows-adk
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/configs/support-for-windows-adk
family: core
documentKind: "article"
abstract: "Learn about the Windows Assessment and Deployment Kit (ADK) versions that are supported for OS deployment with Configuration Manager."
---

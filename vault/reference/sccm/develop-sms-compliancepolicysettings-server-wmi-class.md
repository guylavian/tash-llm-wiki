...
type: reference
domain: sccm
slug: develop-sms-compliancepolicysettings-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/compliance/sms_compliancepolicysettings-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent compliance policy settings using SMS_CompliancePolicySettings class in Configuration Manager."
---

# SMS_CompliancePolicySettings Class

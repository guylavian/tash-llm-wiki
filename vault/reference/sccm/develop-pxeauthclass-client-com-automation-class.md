...
type: reference
domain: sccm
slug: develop-pxeauthclass-client-com-automation-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/pxeauthclass-client-com-automation-class
family: develop
documentKind: "reference"
abstract: "PxeAuthClass is a COM automation class that supports PXE service point authorization in operating system deployment and implements the IPxeAuthClass interface."
---

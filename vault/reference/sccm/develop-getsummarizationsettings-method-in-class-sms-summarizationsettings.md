...
type: reference
domain: sccm
slug: develop-getsummarizationsettings-method-in-class-sms-summarizationsettings
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/getsummarizationsettings-method-in-class-sms_summarizationsettings
family: develop
documentKind: "reference"
abstract: "Learn how to get the summarization schedule using the GetSummarizationSettings class method in Configuration Manager."
---

# GetSummarizationSettings Method

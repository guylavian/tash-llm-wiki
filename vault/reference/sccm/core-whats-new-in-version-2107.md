...
type: reference
domain: sccm
slug: core-whats-new-in-version-2107
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/plan-design/changes/whats-new-in-version-2107
family: core
documentKind: "whats-new"
abstract: "Get details about changes and new capabilities introduced in version 2107 of Configuration Manager current branch."
---
...
For more information, see [What's new in Desktop Analytics](../../../../device-updates/windows/monitor-compatibility.md).

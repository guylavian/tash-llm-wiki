...
type: reference
domain: sccm
slug: compliance-common-tasks-for-creating-and-deploying-configuration-baselines
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/plan-design/common-tasks-for-creating-and-deploying-configuration-baselines
family: compliance
documentKind: "install-set-up-deploy"
abstract: "Learn about how to create and deploy Configuration Manager configuration baselines."
---

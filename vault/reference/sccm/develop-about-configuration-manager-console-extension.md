...
type: reference
domain: sccm
slug: develop-about-configuration-manager-console-extension
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/servers/console/about-configuration-manager-console-extension
family: develop
documentKind: "concept-article"
abstract: "Learn how the Configuration Manager console with an XML-based architecture can be easily extended."
---

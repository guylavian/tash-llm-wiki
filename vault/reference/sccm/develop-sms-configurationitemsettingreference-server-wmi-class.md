...
type: reference
domain: sccm
slug: develop-sms-configurationitemsettingreference-server-wmi-class
tier: reference
...
abstract: "Provides the rule relationship to the settings that are referenced from different configuration items."
---

# SMS_ConfigurationItemSettingReference Class

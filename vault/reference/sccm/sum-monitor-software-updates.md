...
type: reference
domain: sccm
slug: sum-monitor-software-updates
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/sum/deploy-use/monitor-software-updates
family: sum
documentKind: "how-to"
abstract: "The Configuration Manager console provides alerts and statuses to monitor updates and compliance."
---

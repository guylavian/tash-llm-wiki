...
type: reference
domain: sccm
slug: develop-sms-softwareupdatebase-server-wmi-class
tier: reference
...
abstract: "The SMS_SoftwareUpdateBase WMI class exposes software update information available on a site and serves as the core class for software updates."
---

# SMS_SoftwareUpdateBase Class

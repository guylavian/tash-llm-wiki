...
type: reference
domain: sccm
slug: osd-deploy-a-task-sequence
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/osd/deploy-use/deploy-a-task-sequence
family: osd
documentKind: "how-to"
abstract: "Use this information to deploy a task sequence to the computers in a collection."
---

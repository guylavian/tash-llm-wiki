...
type: reference
domain: sccm
slug: develop-sms-mobiledeviceagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_mobiledeviceagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to specify general settings for mobile devices in Configuration Manager using the SMS_MobileDeviceAgentConfig class."
---

# SMS_MobileDeviceAgentConfig Class

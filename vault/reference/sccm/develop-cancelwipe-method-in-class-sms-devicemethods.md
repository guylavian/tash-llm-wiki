...
type: reference
domain: sccm
slug: develop-cancelwipe-method-in-class-sms-devicemethods
tier: reference
...
abstract: "The CancelWipe Windows Management Instrumentation (WMI) class method cancels a pending wipe request on mobile devices or Exchange ActiveSync devices."
---

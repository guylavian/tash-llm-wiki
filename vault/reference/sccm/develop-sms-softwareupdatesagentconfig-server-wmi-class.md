...
type: reference
domain: sccm
slug: develop-sms-softwareupdatesagentconfig-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/config/sms_softwareupdatesagentconfig-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to represent the settings and properties used by the software updates client agent using SMS_SoftwareUpdatesAgentConfig class."
---

# SMS_SoftwareUpdatesAgentConfig Class

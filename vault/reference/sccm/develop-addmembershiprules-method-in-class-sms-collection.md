...
type: reference
domain: sccm
slug: develop-addmembershiprules-method-in-class-sms-collection
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/collections/addmembershiprules-method-in-class-sms_collection
family: develop
documentKind: "reference"
abstract: "In Configuration Manager, the AddMembershipRules WMI class method adds multiple new rules to the CollectionRules property of the SMS_Collection Server WMI Class object."
---

# AddMembershipRules Method

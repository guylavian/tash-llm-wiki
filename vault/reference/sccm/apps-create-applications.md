...
type: reference
domain: sccm
slug: apps-create-applications
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/create-applications
family: apps
documentKind: "how-to"
abstract: "Create applications with deployment types, detection methods, and requirements to install software."
---

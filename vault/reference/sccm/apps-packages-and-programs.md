...
type: reference
domain: sccm
slug: apps-packages-and-programs
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/apps/deploy-use/packages-and-programs
family: apps
documentKind: "article"
abstract: "Support deployments that use legacy packages and programs with Configuration Manager."
---

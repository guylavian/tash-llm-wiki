...
type: reference
domain: sccm
slug: develop-sms-provider-fundamentals
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/understand/sms-provider-fundamentals
family: develop
documentKind: "article"
abstract: "Use the SMS Provider to access and modify Configuration Manager data. It is a WMI provider that can be accessed through either WMI or managed classes."
---

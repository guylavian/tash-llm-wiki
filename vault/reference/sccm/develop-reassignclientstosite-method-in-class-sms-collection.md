...
type: reference
domain: sccm
slug: develop-reassignclientstosite-method-in-class-sms-collection
tier: reference
...
abstract: "Learn how to reassign the Configuration Manager site for clients in the list using ReassignClientsToSite class method."
---

# ReassignClientsToSite Method

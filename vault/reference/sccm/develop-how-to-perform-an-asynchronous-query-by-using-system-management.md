...
type: reference
domain: sccm
slug: develop-how-to-perform-an-asynchronous-query-by-using-system-management
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/core/clients/programming/how-to-perform-an-asynchronous-query-by-using-system.management
family: develop
documentKind: "how-to"
abstract: "To perform an asynchronous query on a Configuration Manager client Windows Instrumentation (WMI) namespace, create a ManagementObjectSearcher object that specifies a WQL query."
---

# Perform an Asynchronous Query by Using System.Management

...
type: reference
domain: sccm
slug: develop-sms-localmp-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/client-classes/sms_localmp-client-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_LocalMP class is a client Windows Management Instrumentation class, in Configuration Manager, that represents the local management point."
---

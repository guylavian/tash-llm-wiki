...
type: reference
domain: sccm
slug: compliance-create-user-data-and-profiles-configuration-items
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/compliance/deploy-use/create-user-data-and-profiles-configuration-items
family: compliance
documentKind: "how-to"
abstract: "Use data and profiles configuration items in Configuration Manager to manage folder redirection, offline files, and roaming profiles."
---

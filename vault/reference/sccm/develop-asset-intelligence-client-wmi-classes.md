...
type: reference
domain: sccm
slug: develop-asset-intelligence-client-wmi-classes
tier: reference
...
abstract: "Learn about the Asset Intelligence client Windows Management Instrumentation classes that query client computers for usage, software, and licensing data."
---

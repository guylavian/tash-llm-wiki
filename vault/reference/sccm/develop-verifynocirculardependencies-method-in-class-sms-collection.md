...
type: reference
domain: sccm
slug: develop-verifynocirculardependencies-method-in-class-sms-collection
tier: reference
...
abstract: "Learn how to take two collections as arguments and verify that no circular dependencies form using VerifyNoCircularDependencies."
---

# VerifyNoCircularDependencies Method

...
type: reference
domain: sccm
slug: develop-ccm-remotecontrolmanager-client-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/sdk/ccm_remotecontrolmanager-client-wmi-class
family: develop
documentKind: "reference"
abstract: "An SMS Provider server class, in Configuration Manager, that contains several methods to help manage client remote control settings."
---

# CCM_RemoteControlManager Class

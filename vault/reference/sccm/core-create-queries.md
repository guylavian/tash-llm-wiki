...
type: reference
domain: sccm
slug: core-create-queries
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/servers/manage/create-queries
family: core
documentKind: "how-to"
abstract: "Discover how to create and import queries in Configuration Manager. Includes example queries and tips."
---

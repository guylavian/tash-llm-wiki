...
type: reference
domain: sccm
slug: develop-sms-sitecontroldayschedule-server-wmi-class
tier: reference
...
abstract: "An SMS Provider server class, in Configuration Manager, that represents usage information for each hour of the day."
---

# SMS_SiteControlDaySchedule Class

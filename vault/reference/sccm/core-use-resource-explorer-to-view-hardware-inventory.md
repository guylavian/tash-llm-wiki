...
type: reference
domain: sccm
slug: core-use-resource-explorer-to-view-hardware-inventory
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/core/clients/manage/inventory/use-resource-explorer-to-view-hardware-inventory
family: core
documentKind: "how-to"
abstract: "Use Resource Explorer to view hardware inventory in Configuration Manager."
---

# How to use Resource Explorer

...
type: reference
domain: sccm
slug: develop-sms-secondarysitestatus-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/servers/manage/sms_secondarysitestatus-server-wmi-class
family: develop
documentKind: "reference"
abstract: "The SMS_SecondarySiteStatus WMI class is an SMS Provider server class, in Configuration Manager, that represents secondary site installation or uninstallation status."
---

# SMS_SecondarySiteStatus Class

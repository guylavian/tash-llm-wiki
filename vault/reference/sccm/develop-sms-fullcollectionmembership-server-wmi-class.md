...
type: reference
domain: sccm
slug: develop-sms-fullcollectionmembership-server-wmi-class
tier: reference
source: https://learn.microsoft.com/en-us/intune/configmgr/develop/reference/core/clients/collections/sms_fullcollectionmembership-server-wmi-class
family: develop
documentKind: "reference"
abstract: "Learn how to use the SMS_FullCollectionMembership class in Configuration Manager to list all member resources for a specific collection."
---

# SMS_FullCollectionMembership Class

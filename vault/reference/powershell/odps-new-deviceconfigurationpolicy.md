...
type: reference
domain: powershell
slug: odps-new-deviceconfigurationpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-DeviceConfigurationPolicy
family: odps
documentKind: "doc"
---
...
Use the New-DeviceConfigurationPolicy cmdlet to create mobile device configuration policies in Basic Mobility and Security in Microsoft 365.
...
```
New-DeviceConfigurationPolicy [-Name] <String>
 [-Comment <String>]
 [-Confirm]
 [-Enabled <Boolean>]
 [-Force]

...
type: reference
domain: powershell
slug: spps-sharepoint-server-sub-cmdlets
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/docs-conceptual/sharepoint-server/sharepoint-server-sub-cmdlets
family: spps
documentKind: "doc"
abstract: "Learn about the SharePointServer module, which contains cmdlets for managing SharePoint Server."
---

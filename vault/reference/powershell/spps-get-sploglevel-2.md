...
type: reference
domain: powershell
slug: spps-get-sploglevel-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Get-SPLogLevel
family: spps
documentKind: "doc"
---

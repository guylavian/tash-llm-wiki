...
type: reference
domain: powershell
slug: spps-sharepointserver
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/SharePointServer
family: spps
documentKind: "doc"
---
...
### [Get-SPCacheClusterHealth](Get-SPCacheClusterHealth.md)
...
### [Remove-SPCertificate](Remove-SPCertificate.md)
...
### [Remove-SPPeoplePickerServiceAccountDirectoryPath](Remove-SPPeoplePickerServiceAccountDirectoryPath.md)
...
### [Unregister-SPVssWriter](Unregister-SPVssWriter.md)
...
### [Use-SPCacheCluster](Use-SPCacheCluster.md)
Sets the context of your PowerShell session to a particular cache cluster.

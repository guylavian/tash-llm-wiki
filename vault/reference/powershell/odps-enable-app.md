...
type: reference
domain: powershell
slug: odps-enable-app
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-App
family: odps
documentKind: "doc"
---
...
```
Enable-App [-Identity] <AppIdParameter>
 [-Confirm]
...
## DESCRIPTION
The Enable-App cmdlet requires that the specified app has already been installed (for example, that it is installed with the New-App cmdlet, or that it's a default app for Microsoft Outlook).

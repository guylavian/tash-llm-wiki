...
type: reference
domain: powershell
slug: odps-search-adminauditlog
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Search-AdminAuditLog
family: odps
documentKind: "doc"
---
...
- $true: Only return audit log entries where the change was made by an external user. In use value to return audit log entries for changes that were made by Microsoft datacenter administrators.

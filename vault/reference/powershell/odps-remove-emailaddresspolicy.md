---
title: "Remove-EmailAddressPolicy"
type: reference
domain: powershell
slug: odps-remove-emailaddresspolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-EmailAddressPolicy
family: odps
documentKind: "doc"
---
...
Use the Remove-EmailAddressPolicy cmdlet to remove existing email address policies and update the affected recipients. In Exchange Online, email address policies are available only for Microsoft 365 Groups.
...
The Identity parameter specifies the email address policy that you want to remove. You can use any value that uniquely identifies the policy. For example:

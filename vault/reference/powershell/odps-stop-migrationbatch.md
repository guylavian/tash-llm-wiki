...
type: reference
domain: powershell
slug: odps-stop-migrationbatch
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Stop-MigrationBatch
family: odps
documentKind: "doc"
---
...
```
Stop-MigrationBatch [[-Identity] <MigrationBatchIdParameter>]
 [-Confirm]

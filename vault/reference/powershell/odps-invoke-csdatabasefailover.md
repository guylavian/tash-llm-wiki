...
type: reference
domain: powershell
slug: odps-invoke-csdatabasefailover
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/skype/skype-ps/SkypeForBusiness/Invoke-CsDatabaseFailover
family: odps
documentKind: "doc"
---

...
type: reference
domain: powershell
slug: odps-set-casmailboxplan
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-CASMailboxPlan
family: odps
documentKind: "doc"
---
...
- $true: ActiveSync access to the mailbox is enabled. This value is the default.
...
- $true: POP3 access to the mailbox is enabled. This value is the default.

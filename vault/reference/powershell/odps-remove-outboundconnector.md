---
title: "Remove-OutboundConnector"
type: reference
domain: powershell
slug: odps-remove-outboundconnector
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-OutboundConnector
family: odps
documentKind: "doc"
---
...
```
Remove-OutboundConnector [-Identity] <OutboundConnectorIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
The Identity parameter specifies the connector you want to remove.

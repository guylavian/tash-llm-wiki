...
type: reference
domain: powershell
slug: spps-get-splogevent-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Get-SPLogEvent
family: spps
documentKind: "doc"
---

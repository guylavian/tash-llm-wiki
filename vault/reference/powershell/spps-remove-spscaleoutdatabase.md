...
type: reference
domain: powershell
slug: spps-remove-spscaleoutdatabase
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-ps/Microsoft.SharePoint.Powershell/Remove-SPScaleOutDatabase
family: spps
documentKind: "doc"
---
...
## DESCRIPTION
Use the `Remove-SPScaleOutDatabase` cmdlet to remove a specific scale-out database from a specified service application.

...
type: reference
domain: powershell
slug: odps-remove-owamailboxpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-OwaMailboxPolicy
family: odps
documentKind: "doc"
---
...
```
Remove-OwaMailboxPolicy [-Identity] <MailboxPolicyIdParameter>
 [-Confirm]

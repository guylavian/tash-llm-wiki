...
type: reference
domain: powershell
slug: odps-remove-ldapdirectory
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-LdapDirectory
family: odps
documentKind: "doc"
---
...
Use the Remove-LdapDirectory cmdlet to remove LDAP directory configurations.
...
### Example 1
```powershell
Remove-LdapDirectory -Organization contoso.onmicrosoft.com -Id FabrikamLdap
```

This example removes the LDAP directory configuration named FabrikamLdap from the contoso.onmicrosoft.com organization configuration.
...
The Id parameter specifies the unique identifier of the LDAP directory configuration that you want to remove.

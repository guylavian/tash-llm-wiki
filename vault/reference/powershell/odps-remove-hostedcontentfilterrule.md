---
title: "Remove-HostedContentFilterRule"
type: reference
domain: powershell
slug: odps-remove-hostedcontentfilterrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-HostedContentFilterRule
family: odps
documentKind: "doc"
---
...
```
Remove-HostedContentFilterRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

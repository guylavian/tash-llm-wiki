...
type: reference
domain: powershell
slug: spps-set-sptimerjob-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Set-SPTimerJob
family: spps
documentKind: "doc"
---

---
title: "How to use this documentation — pages 2161-2200"
type: reference
domain: powershell
slug: powershell-powershell-scripting-powershell-7-6-p2161-2200
tier: reference
source: https://learn.microsoft.com/en-us/powershell/scripting/powershell-scripting-powershell-7-6-p2161-2200
family: powershell
documentKind: "doc"
abstract: "/// </summary> /// <param name=\"e\">The exception to display.</param> private void ReportException(Exception e) { if (e != null) { object error; IContainsErrorRecord icer = e as IContainsErrorRecord; if (icer != null) { error = icer.ErrorRecord; } else { error = (object)new Error"
---

# How to use this documentation — pages 2161-2200
...
the console. In addition, this sample uses the Tokenizer APIs to specify the color of the text that
...
Microsoft.Samples.PowerShell.Host.HostUtilities.GetProfileCommands("SampleHost06");

...
type: reference
domain: powershell
slug: odps-disable-serviceemailchannel
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Disable-ServiceEmailChannel
family: odps
documentKind: "doc"
---
...
```
Disable-ServiceEmailChannel [-Identity] <MailboxIdParameter>
 [-Confirm]

---
title: "Remove-GlobalAddressList"
type: reference
domain: powershell
slug: odps-remove-globaladdresslist
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-GlobalAddressList
family: odps
documentKind: "doc"
---
...
```
Remove-GlobalAddressList [-Identity] <GlobalAddressListIdParameter>
 [-Confirm]

...
type: reference
domain: powershell
slug: odps-remove-umipgateway
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-UMIPGateway
family: odps
documentKind: "doc"
---
...
```
Remove-UMIPGateway [-Identity] <UMIPGatewayIdParameter>
 [-Confirm]

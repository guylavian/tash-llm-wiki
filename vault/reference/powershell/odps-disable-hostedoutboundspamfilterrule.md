...
type: reference
domain: powershell
slug: odps-disable-hostedoutboundspamfilterrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Disable-HostedOutboundSpamFilterRule
family: odps
documentKind: "doc"
---
...
```
Disable-HostedOutboundSpamFilterRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

...
type: reference
domain: powershell
slug: odps-enable-outlookprotectionrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-OutlookProtectionRule
family: odps
documentKind: "doc"
---
...
```
Enable-OutlookProtectionRule [-Identity] <RuleIdParameter>
 [-Confirm]

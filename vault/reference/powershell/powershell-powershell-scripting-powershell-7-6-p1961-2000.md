---
title: "How to use this documentation — pages 1961-2000"
type: reference
domain: powershell
slug: powershell-powershell-scripting-powershell-7-6-p1961-2000
tier: reference
source: https://learn.microsoft.com/en-us/powershell/scripting/powershell-scripting-powershell-7-6-p1961-2000
family: powershell
documentKind: "doc"
abstract: "public class DatabaseTableInfo { /// <summary> /// Row from the \"tables\" schema /// </summary> public DataRow Data { get { return data; } set { data = value; } } private DataRow data; /// <summary> /// The table name. /// </summary> public string Name { get { return name; } set"
---

# How to use this documentation — pages 1961-2000
...
Join-Path cmdlets. These methods should be implemented when the user needs to move
...
This sample demonstrates the following:
     ...
     to change the behavior of the Move-Item cmdlet, allowing the user to move items from
...
<!-- p.1965 -->
      ...
      to change the behavior of the Join-Path cmdlet.
...
Example
This sample shows how to overwrite the methods needed to move items in a Microsoft Access
data base.

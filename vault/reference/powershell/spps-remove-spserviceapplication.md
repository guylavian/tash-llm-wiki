...
type: reference
domain: powershell
slug: spps-remove-spserviceapplication
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-ps/Microsoft.SharePoint.Powershell/Remove-SPServiceApplication
family: spps
documentKind: "doc"
---
...
You can run the `Get-SPServiceApplication` cmdlet to see the GUID of the service applications and then use the result from the `Get-SPServiceApplication` cmdlet for other SPServiceApplication cmdlets; for example, or `Publish-SPServiceApplication`.

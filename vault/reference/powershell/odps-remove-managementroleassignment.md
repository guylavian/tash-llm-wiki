...
type: reference
domain: powershell
slug: odps-remove-managementroleassignment
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-ManagementRoleAssignment
family: odps
documentKind: "doc"
---
...
```
Remove-ManagementRoleAssignment [-Identity] <RoleAssignmentIdParameter>
 [-Confirm]
...
## DESCRIPTION
When you remove a role assignment, the management role group, management role assignment, user, or universal security group (USG) that was assigned the associated role can no longer access the cmdlets or parameters made available by the role. For more information about management role assignments, see [Understanding management role assignments](https://learn.microsoft.com/exchange/understanding-management-role-assignments-exchange-2013-help).

...
type: reference
domain: powershell
slug: odps-remove-mobiledevicemailboxpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-MobileDeviceMailboxPolicy
family: odps
documentKind: "doc"
---
...
```
Remove-MobileDeviceMailboxPolicy [-Identity] <MailboxPolicyIdParameter>
 [-Confirm]

...
type: reference
domain: powershell
slug: odps-set-deviceconfigurationrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-DeviceConfigurationRule
family: odps
documentKind: "doc"
---
...
Use the Set-DeviceConfigurationRule cmdlet to modify mobile device configuration rules in Basic Mobility and Security in Microsoft 365.

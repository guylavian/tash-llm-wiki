...
type: reference
domain: powershell
slug: odps-filters-v2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/filters-v2
family: odps
documentKind: "article"
abstract: "Learn about how to use filtering for cmdlets in the Exchange Online V2 module and V3 module."
---

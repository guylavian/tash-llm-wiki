...
type: reference
domain: powershell
slug: odps-remove-deviceconfigurationrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-DeviceConfigurationRule
family: odps
documentKind: "doc"
---
...
```
Remove-DeviceConfigurationRule [-Identity] <PolicyIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

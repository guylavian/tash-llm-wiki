...
type: reference
domain: powershell
slug: odps-exchange-cmdlet-syntax
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/exchange-cmdlet-syntax
family: odps
documentKind: "article"
abstract: "Learn about the structure and syntax of cmdlets in Exchange PowerShell, Exchange Online PowerShell, and Security & Compliance PowerShell, and PowerShell for the Built-in security add-on for on-premises mailboxes."
---

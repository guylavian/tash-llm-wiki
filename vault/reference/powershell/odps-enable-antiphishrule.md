...
type: reference
domain: powershell
slug: odps-enable-antiphishrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-AntiPhishRule
family: odps
documentKind: "doc"
---
...
```
Enable-AntiPhishRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

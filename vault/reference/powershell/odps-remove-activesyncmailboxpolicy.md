...
type: reference
domain: powershell
slug: odps-remove-activesyncmailboxpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-ActiveSyncMailboxPolicy
family: odps
documentKind: "doc"
---
...
```
Remove-ActiveSyncMailboxPolicy [-Identity] <MailboxPolicyIdParameter>
 [-Confirm]

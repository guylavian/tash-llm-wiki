...
type: reference
domain: powershell
slug: odps-get-outboundconnector
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-OutboundConnector
family: odps
documentKind: "doc"
---

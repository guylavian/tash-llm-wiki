...
type: reference
domain: powershell
slug: odps-get-resourceconfig
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-ResourceConfig
family: odps
documentKind: "doc"
---
...
```
Get-ResourceConfig [[-Identity] <OrganizationIdParameter>]

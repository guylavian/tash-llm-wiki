...
type: reference
domain: powershell
slug: odps-update-storemailboxstate
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Update-StoreMailboxState
family: odps
documentKind: "doc"
---
...
In this scenario, Update-StoreMailboxState might not immediately update the DisconnectState and DisconnectReason properties in the output of Get-MailboxStatistics. The values update approximately 24 hours after the move.

---
title: "Remove-AntiPhishRule"
type: reference
domain: powershell
slug: odps-remove-antiphishrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-AntiPhishRule
family: odps
documentKind: "doc"
---
...
```
Remove-AntiPhishRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

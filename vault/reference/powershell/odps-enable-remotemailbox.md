...
type: reference
domain: powershell
slug: odps-enable-remotemailbox
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-RemoteMailbox
family: odps
documentKind: "doc"
---

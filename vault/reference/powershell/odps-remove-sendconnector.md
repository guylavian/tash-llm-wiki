---
title: "Remove-SendConnector"
type: reference
domain: powershell
slug: odps-remove-sendconnector
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-SendConnector
family: odps
documentKind: "doc"
---
...
```
Remove-SendConnector [-Identity] <SendConnectorIdParameter>
 [-Confirm]
...
Although a Send connector is configured locally in the Transport service on a Mailbox server or on an Edge server, deleting a Send connector might affect mail flow throughout the organization.

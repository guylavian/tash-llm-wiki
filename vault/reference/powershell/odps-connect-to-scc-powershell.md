...
type: reference
domain: powershell
slug: odps-connect-to-scc-powershell
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/connect-to-scc-powershell
family: odps
documentKind: "article"
abstract: "Learn how to use the Exchange Online PowerShell V3 module to connect to Security & Compliance PowerShell with modern authentication and/or multifactor authentication (MFA)."
---

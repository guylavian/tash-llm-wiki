...
type: reference
domain: powershell
slug: odps-enable-hostedcontentfilterrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-HostedContentFilterRule
family: odps
documentKind: "doc"
---
...
```
Enable-HostedContentFilterRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

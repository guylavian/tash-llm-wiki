...
type: reference
domain: powershell
slug: spps-invoke-spprojectactivedirectoryenterpriseresourcepoolsync-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Invoke-SPProjectActiveDirectoryEnterpriseResourcePoolSync
family: spps
documentKind: "doc"
---

...
type: reference
domain: powershell
slug: odps-find-exchange-cmdlet-permissions
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/find-exchange-cmdlet-permissions
family: odps
documentKind: "article"
abstract: "Admins can learn how to use PowerShell to find the permissions required to run any cmdlet in Exchange Server PowerShell or Exchange Online PowerShell."
---

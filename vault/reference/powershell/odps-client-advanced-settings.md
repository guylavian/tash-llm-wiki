...
type: reference
domain: powershell
slug: odps-client-advanced-settings
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/client-advanced-settings
family: odps
documentKind: "article"
abstract: "Security & Compliance PowerShell advanced settings for Microsoft Purview Information Protection client."
---

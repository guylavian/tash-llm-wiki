...
type: reference
domain: powershell
slug: odps-new-fileplanpropertyauthority
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-FilePlanPropertyAuthority
family: odps
documentKind: "doc"
---
...
```
New-FilePlanPropertyAuthority [-Name] <String>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
### Example 1
```powershell
New-FilePlanPropertyAuthority -Name "Contoso Authority"
```

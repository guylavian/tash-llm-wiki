...
type: reference
domain: powershell
slug: odps-new-moverequest
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-MoveRequest
family: odps
documentKind: "doc"
---
...
In Exchange 2010 or later, you need to use this switch if you set the BadItemLimit parameter to a value of 51 or higher. Otherwise, the command will fail.

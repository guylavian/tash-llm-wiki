...
type: reference
domain: powershell
slug: odps-import-dlppolicytemplate
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Import-DlpPolicyTemplate
family: odps
documentKind: "doc"
---
...
```
Import-DlpPolicyTemplate [-FileData] <Byte[]>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

...
type: reference
domain: powershell
slug: odps-remove-transportrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-TransportRule
family: odps
documentKind: "doc"
---
...
```
Remove-TransportRule [-Identity] <RuleIdParameter>
 [-Confirm]

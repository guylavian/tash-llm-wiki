---
title: "Remove-PartnerApplication"
type: reference
domain: powershell
slug: odps-remove-partnerapplication
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-PartnerApplication
family: odps
documentKind: "doc"
---
...
Use the Remove-PartnerApplication cmdlet to remove a partner application configuration.
...
```
Remove-PartnerApplication [-Identity] <PartnerApplicationIdParameter>
 [-Confirm]

...
type: reference
domain: powershell
slug: odps-new-ecpvirtualdirectory
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-EcpVirtualDirectory
family: odps
documentKind: "doc"
---
...
You can't create an ECP virtual directory remotely. You can only create an ECP virtual directory on the local computer.

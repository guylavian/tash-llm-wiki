...
type: reference
domain: powershell
slug: odps-disable-mailcontact
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Disable-MailContact
family: odps
documentKind: "doc"
---
...
```
Disable-MailContact [-Identity] <MailContactIdParameter>
 [-Confirm]

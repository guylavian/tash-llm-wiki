...
type: reference
domain: powershell
slug: odps-connect-to-exchange-servers-using-remote-powershell
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/connect-to-exchange-servers-using-remote-powershell
family: odps
documentKind: "article"
abstract: "Use Windows PowerShell on a local computer to connect to an Exchange Server."
---

...
type: reference
domain: powershell
slug: odps-remove-migrationendpoint
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-MigrationEndpoint
family: odps
documentKind: "doc"
---
...
The Identity parameter specifies the name of the migration endpoint you want to remove.

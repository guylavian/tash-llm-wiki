...
type: reference
domain: powershell
slug: odps-control-remote-powershell-access-to-exchange-servers
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/control-remote-powershell-access-to-exchange-servers
family: odps
documentKind: "article"
abstract: "Administrators can learn how to block or allow users' remote PowerShell access to Exchange servers."
---

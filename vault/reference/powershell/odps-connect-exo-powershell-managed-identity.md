...
type: reference
domain: powershell
slug: odps-connect-exo-powershell-managed-identity
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/connect-exo-powershell-managed-identity
family: odps
documentKind: "article"
abstract: "Learn about using the Exchange Online PowerShell V3 module and Azure managed identity to connect to Exchange Online PowerShell."
---

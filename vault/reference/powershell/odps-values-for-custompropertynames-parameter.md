...
type: reference
domain: powershell
slug: odps-values-for-custompropertynames-parameter
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/values-for-custompropertynames-parameter
family: odps
documentKind: "article"
abstract: "Learn about the valid values for the CustomPropertyNames parameter on the Get-CalendarDiagnosticsLog cmdlet in Exchange Online PowerShell."
---

# Values for the CustomPropertyNames parameter

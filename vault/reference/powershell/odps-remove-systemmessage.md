...
type: reference
domain: powershell
slug: odps-remove-systemmessage
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-SystemMessage
family: odps
documentKind: "doc"
---
...
```
Remove-SystemMessage [-Identity] <SystemMessageIdParameter>
 [-Confirm]

...
type: reference
domain: powershell
slug: spps-restore-spfarm-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Restore-SPFarm
family: spps
documentKind: "doc"
---

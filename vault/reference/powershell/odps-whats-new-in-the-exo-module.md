...
type: reference
domain: powershell
slug: odps-whats-new-in-the-exo-module
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/whats-new-in-the-exo-module
family: odps
documentKind: "article"
abstract: "Learn about the new features and functionality available in the latest release of the Exchange Online PowerShell module."
---
...
- [Version 3.10.0](https://www.powershellgallery.com/packages/ExchangeOnlineManagement/3.10.0)
  ...
  For information about what's in this release, see [Version 3.10.0](exchange-online-powershell-v2.md#version-3100).

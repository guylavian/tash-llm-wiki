...
type: reference
domain: powershell
slug: odps-remove-managedfolder
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-ManagedFolder
family: odps
documentKind: "doc"
---
...
Use the Remove-ManagedFolder cmdlet to remove a managed folder from Active Directory.
...
## DESCRIPTION
The Remove-ManagedFolder cmdlet accepts a managed folder object or a mailbox identity as pipelined input.
...
This example removes the managed folder MyManagedFolder.

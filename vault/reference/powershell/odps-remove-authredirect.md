---
title: "Remove-AuthRedirect"
type: reference
domain: powershell
slug: odps-remove-authredirect
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-AuthRedirect
family: odps
documentKind: "doc"
---
...
```
Remove-AuthRedirect [-Identity] <AuthRedirectIdParameter>
 [-Confirm]
...
### Example 1
```powershell
Remove-AuthRedirect -Identity AuthRedirect-Bearer-C0B7AC3F-FE64-4B4B-A907-9226F8027CCE
```

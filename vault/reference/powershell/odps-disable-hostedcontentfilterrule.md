...
type: reference
domain: powershell
slug: odps-disable-hostedcontentfilterrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Disable-HostedContentFilterRule
family: odps
documentKind: "doc"
---
...
```
Disable-HostedContentFilterRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

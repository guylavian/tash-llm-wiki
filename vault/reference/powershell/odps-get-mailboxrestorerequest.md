...
type: reference
domain: powershell
slug: odps-get-mailboxrestorerequest
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-MailboxRestoreRequest
family: odps
documentKind: "doc"
---
...
This example returns all restore requests that have the name RestoreToMBD01 where the restore request is suspended.

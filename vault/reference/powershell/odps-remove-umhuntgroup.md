...
type: reference
domain: powershell
slug: odps-remove-umhuntgroup
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-UMHuntGroup
family: odps
documentKind: "doc"
---
...
```
Remove-UMHuntGroup [-Identity] <UMHuntGroupIdParameter>
 [-Confirm]

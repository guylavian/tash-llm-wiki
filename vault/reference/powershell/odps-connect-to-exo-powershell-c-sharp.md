...
type: reference
domain: powershell
slug: odps-connect-to-exo-powershell-c-sharp
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/connect-to-exo-powershell-c-sharp
family: odps
documentKind: "article"
abstract: "Learn about using the Exchange Online PowerShell V3 module and C# to connect to Exchange Online."
---

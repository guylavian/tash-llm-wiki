...
type: reference
domain: powershell
slug: odps-new-csexternalusercommunicationpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/skype/skype-ps/SkypeForBusiness/New-CsExternalUserCommunicationPolicy
family: odps
documentKind: "doc"
---
...
This example creates a new policy to block external file transfer. Then you can use `Grant-CsExternalUserCommunicationPolicy` to assign it to a user account.

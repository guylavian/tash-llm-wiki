...
type: reference
domain: powershell
slug: odps-send-textmessagingverificationcode
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Send-TextMessagingVerificationCode
family: odps
documentKind: "doc"
---
...
Use the Send-TextMessagingVerificationCode cmdlet to send a text messaging verification as part of configuring text message notifications on the mailbox.
...
```
Send-TextMessagingVerificationCode [[-Identity] <MailboxIdParameter>]
 [-Confirm]

...
type: reference
domain: powershell
slug: odps-remove-routinggroupconnector
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-RoutingGroupConnector
family: odps
documentKind: "doc"
---
...
```
Remove-RoutingGroupConnector [-Identity] <RoutingGroupConnectorIdParameter>
 [-Confirm]

...
type: reference
domain: powershell
slug: spps-update-spdataretrievalserviceconfig
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Update-SPDataRetrievalServiceConfig
family: spps
documentKind: "doc"
---
...
For permissions and the most current information about Windows PowerShell for SharePoint Products, see the online documentation at [Windows PowerShell for SharePoint Server 2016 reference](/powershell/sharepoint/sharepoint-server/).

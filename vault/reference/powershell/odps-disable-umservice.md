...
type: reference
domain: powershell
slug: odps-disable-umservice
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Disable-UMService
family: odps
documentKind: "doc"
---
...
```
Disable-UMService [-Identity] <UMServerIdParameter>
 [-Confirm]

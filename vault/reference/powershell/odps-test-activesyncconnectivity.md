...
type: reference
domain: powershell
slug: odps-test-activesyncconnectivity
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Test-ActiveSyncConnectivity
family: odps
documentKind: "doc"
---
...
The AllowUnsecureAccess switch allows the test to continue over an unsecured channel that doesn't require Transport Layer Security (TLS). You don't need to specify a value with this switch.

...
type: reference
domain: powershell
slug: spps-merge-splogfile-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Merge-SPLogFile
family: spps
documentKind: "doc"
---

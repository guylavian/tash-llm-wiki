...
type: reference
domain: powershell
slug: spps-get-sptimerjob-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Get-SPTimerJob
family: spps
documentKind: "doc"
---

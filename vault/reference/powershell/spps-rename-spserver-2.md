...
type: reference
domain: powershell
slug: spps-rename-spserver-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Rename-SPServer
family: spps
documentKind: "doc"
---

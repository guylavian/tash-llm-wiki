...
type: reference
domain: powershell
slug: odps-exchange-online-powershell-v2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/exchange-online-powershell-v2
family: odps
documentKind: "article"
abstract: "Learn how to install, maintain, and use the Exchange Online PowerShell V3 module to connect to all Exchange cloud-related PowerShell environments."
---

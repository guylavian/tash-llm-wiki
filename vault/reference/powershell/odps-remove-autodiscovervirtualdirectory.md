...
type: reference
domain: powershell
slug: odps-remove-autodiscovervirtualdirectory
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-AutodiscoverVirtualDirectory
family: odps
documentKind: "doc"
---
...
Use the Remove-AutodiscoverVirtualDirectory cmdlet to remove an existing Autodiscover virtual directory from Internet Information Services (IIS).
...
The Identity parameter specifies the Autodiscover virtual directory that you want to remove. You can use any value that uniquely identifies the virtual directory. For example:

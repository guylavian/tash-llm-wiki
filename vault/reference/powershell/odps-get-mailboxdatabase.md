...
type: reference
domain: powershell
slug: odps-get-mailboxdatabase
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-MailboxDatabase
family: odps
documentKind: "doc"
---

...
type: reference
domain: powershell
slug: spps-new-spenterprisesearchqueryprocessingcomponent
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-ps/Microsoft.SharePoint.Powershell/New-SPEnterpriseSearchQueryProcessingComponent
family: spps
documentKind: "doc"
---
...
New-SPEnterpriseSearchQueryProcessingComponent -SearchTopology $topology -SearchServiceInstance $si -SearchApplication $ssa
```
This example adds a new Search Query Processing Component to the inactive topology for the existing Search Service Application.

...
type: reference
domain: powershell
slug: odps-set-holdcompliancerule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-HoldComplianceRule
family: odps
documentKind: "doc"
---

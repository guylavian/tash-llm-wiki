...
type: reference
domain: powershell
slug: odps-new-autodiscovervirtualdirectory
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-AutodiscoverVirtualDirectory
family: odps
documentKind: "doc"
---
...
When you're creating an Autodiscover virtual directory, we recommend that you enable Transport Layer Security (TLS) for the Autodiscover service.

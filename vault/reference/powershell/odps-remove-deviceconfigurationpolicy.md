...
type: reference
domain: powershell
slug: odps-remove-deviceconfigurationpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-DeviceConfigurationPolicy
family: odps
documentKind: "doc"
---
...
Use the Remove-DeviceConfigurationPolicy cmdlet to remove mobile device configuration policies from Basic Mobility and Security in Microsoft 365.

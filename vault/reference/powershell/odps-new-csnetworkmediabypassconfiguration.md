...
type: reference
domain: powershell
slug: odps-new-csnetworkmediabypassconfiguration
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/skype/skype-ps/SkypeForBusiness/New-CsNetworkMediaBypassConfiguration
family: odps
documentKind: "doc"
---
...
The following parameters are not applicable to Skype for Business Online: BypassID, EnableDefaultBypassID, EnabledForAudioVideoConferences, ExternalBypassMode, InternalBypassMode, PipelineVariable, and Tenant

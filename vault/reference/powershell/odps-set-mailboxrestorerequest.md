...
type: reference
domain: powershell
slug: odps-set-mailboxrestorerequest
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-MailboxRestoreRequest
family: odps
documentKind: "doc"
---
...
Use the Set-MailboxRestoreRequest cmdlet to change restore request options after the request is created. You can use this cmdlet to recover from failed restore requests.

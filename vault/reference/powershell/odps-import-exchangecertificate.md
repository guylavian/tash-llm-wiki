...
type: reference
domain: powershell
slug: odps-import-exchangecertificate
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Import-ExchangeCertificate
family: odps
documentKind: "doc"
---
...
- $false: The private key isn't exportable, so you can't export the certificate from this server. This value is the default.

...
type: reference
domain: powershell
slug: odps-set-safelinkspolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-SafeLinksPolicy
family: odps
documentKind: "doc"
---
...
- $true: User clicks are tracked. This value is the default.

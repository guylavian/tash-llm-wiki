...
type: reference
domain: powershell
slug: odps-new-publicfolderdatabaserepairrequest
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-PublicFolderDatabaseRepairRequest
family: odps
documentKind: "doc"
---
...
After you begin the repair request, it can't be stopped unless you dismount the database. For more information, see [Dismount a Database](https://learn.microsoft.com/previous-versions/office/exchange-server-2010/bb123903(v=exchg.141)).

---
title: "Remove-DeliveryAgentConnector"
type: reference
domain: powershell
slug: odps-remove-deliveryagentconnector
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-DeliveryAgentConnector
family: odps
documentKind: "doc"
---
...
The Remove-DeliveryAgentConnector cmdlet removes a specific delivery agent connector configured in your organization.
...
```
Remove-DeliveryAgentConnector [-Identity] <DeliveryAgentConnectorIdParameter>
 [-Confirm]

...
type: reference
domain: powershell
slug: odps-set-phishsimoverridepolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-PhishSimOverridePolicy
family: odps
documentKind: "doc"
---
...
```
Set-PhishSimOverridePolicy [-Identity] <PolicyIdParameter>
 [-Comment <String>]
 [-Confirm]

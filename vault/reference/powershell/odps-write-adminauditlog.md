...
type: reference
domain: powershell
slug: odps-write-adminauditlog
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Write-AdminAuditLog
family: odps
documentKind: "doc"
---

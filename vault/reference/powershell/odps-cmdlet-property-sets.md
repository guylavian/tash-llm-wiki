...
type: reference
domain: powershell
slug: odps-cmdlet-property-sets
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/cmdlet-property-sets
family: odps
documentKind: "article"
abstract: "Admins can lear about the property sets that are available in the nine exclusive Get-EXO cmdlets in the Exchange Online PowerShell V2 module and V3 module."
---

...
type: reference
domain: powershell
slug: odps-disable-distributiongroup
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Disable-DistributionGroup
family: odps
documentKind: "doc"
---
...
```
Disable-DistributionGroup [-Identity] <DistributionGroupIdParameter>
 [-Confirm]

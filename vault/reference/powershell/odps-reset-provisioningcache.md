...
type: reference
domain: powershell
slug: odps-reset-provisioningcache
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Reset-ProvisioningCache
family: odps
documentKind: "doc"
---
...
The Organizations parameter specifies the organizations where the provisioning cache is reset. Use this parameter in multi-tenant deployments.

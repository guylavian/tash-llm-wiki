...
type: reference
domain: powershell
slug: odps-new-edgesubscription
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-EdgeSubscription
family: odps
documentKind: "doc"
---
...
The AccountExpiryDuration parameter specifies how soon the EdgeSync bootstrap replication account (ESBRA) created by this command expires.

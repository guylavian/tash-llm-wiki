...
type: reference
domain: powershell
slug: odps-remove-edgesubscription
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-EdgeSubscription
family: odps
documentKind: "doc"
---
...
```
Remove-EdgeSubscription [-Identity] <TransportServerIdParameter>
 [-Confirm]

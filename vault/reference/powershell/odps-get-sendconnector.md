...
type: reference
domain: powershell
slug: odps-get-sendconnector
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-SendConnector
family: odps
documentKind: "doc"
---
...
```
Get-SendConnector [[-Identity] <SendConnectorIdParameter>]

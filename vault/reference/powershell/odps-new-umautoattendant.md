...
type: reference
domain: powershell
slug: odps-new-umautoattendant
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-UMAutoAttendant
family: odps
documentKind: "doc"
---
...
The Status parameter specifies whether the UM auto attendant is enabled. Valid values are:

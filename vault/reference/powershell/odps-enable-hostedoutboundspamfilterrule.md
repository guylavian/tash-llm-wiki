...
type: reference
domain: powershell
slug: odps-enable-hostedoutboundspamfilterrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-HostedOutboundSpamFilterRule
family: odps
documentKind: "doc"
---
...
```
Enable-HostedOutboundSpamFilterRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
### Example 1
```powershell
Enable-HostedOutboundSpamFilterRule "Contoso Executives"
```

This example enables the disabled outbound spam filter rule named Contoso Executives.

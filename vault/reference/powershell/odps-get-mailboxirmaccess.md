...
type: reference
domain: powershell
slug: odps-get-mailboxirmaccess
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-MailboxIRMAccess
family: odps
documentKind: "doc"
---

...
type: reference
domain: powershell
slug: odps-new-throttlingpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-ThrottlingPolicy
family: odps
documentKind: "doc"
---
...
For more information about how to control how resources are consumed by individual users, see [User workload management in Exchange Server](https://learn.microsoft.com/Exchange/server-health/workload-management).

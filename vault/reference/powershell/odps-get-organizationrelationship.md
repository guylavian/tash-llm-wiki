...
type: reference
domain: powershell
slug: odps-get-organizationrelationship
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-OrganizationRelationship
family: odps
documentKind: "doc"
---
...
Use the Get-OrganizationRelationship cmdlet to retrieve settings for an organization relationship that is created for federated sharing with other federated Exchange organizations or for hybrid deployments with Exchange Online.

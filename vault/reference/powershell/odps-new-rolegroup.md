...
type: reference
domain: powershell
slug: odps-new-rolegroup
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-RoleGroup
family: odps
documentKind: "doc"
---
...
This example uses variables to store information. For more information about variables, see [About Variables](https://learn.microsoft.com/powershell/module/microsoft.powershell.core/about/about_variables).

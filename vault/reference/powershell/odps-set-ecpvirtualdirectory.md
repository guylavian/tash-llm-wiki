...
type: reference
domain: powershell
slug: odps-set-ecpvirtualdirectory
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-EcpVirtualDirectory
family: odps
documentKind: "doc"
---
...
You need to specify a value for this parameter to allow the Autodiscover service to return the URL for the ECP virtual directory.
...
The OwaOptionsEnabled parameter specifies that Outlook on the web Options is enabled for end users. If this parameter is set to $false, users aren't able to access Outlook on the web Options. You might want to disable access if your organization uses non-Microsoft provider tools. This parameter accepts $true or $false.

...
type: reference
domain: powershell
slug: odps-filter-properties
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/filter-properties
family: odps
documentKind: "article"
abstract: "Learn about the filterable properties for the Filter parameter in Exchange Server, Exchange Online, and Security & Compliance PowerShell."
---

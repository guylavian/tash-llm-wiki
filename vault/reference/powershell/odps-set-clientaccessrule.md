...
type: reference
domain: powershell
slug: odps-set-clientaccessrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Set-ClientAccessRule
family: odps
documentKind: "doc"
---

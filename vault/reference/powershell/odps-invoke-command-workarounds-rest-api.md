...
type: reference
domain: powershell
slug: odps-invoke-command-workarounds-rest-api
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/invoke-command-workarounds-rest-api
family: odps
documentKind: "article"
abstract: "Learn about the alternatives to Invoke-Command commands in REST API connections using the EXO V3 module."
---

---
title: "Remove-AutoSensitivityLabelPolicy"
type: reference
domain: powershell
slug: odps-remove-autosensitivitylabelpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-AutoSensitivityLabelPolicy
family: odps
documentKind: "doc"
---
...
```
Remove-AutoSensitivityLabelPolicy [-Identity] <PolicyIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
### Example 1
```powershell
Remove-AutoSensitivityLabelPolicy -Identity "Marketing Group"
```
...
The Identity parameter specifies the auto-labeling policy that you want to remove. You can use any value that uniquely identifies the policy. For example:

...
type: reference
domain: powershell
slug: odps-get-maildetailatpreport
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-MailDetailATPReport
family: odps
documentKind: "doc"
---
...
Use the Get-MailDetailATPReport cmdlet to list details about Microsoft Defender for Office 365 detections in your cloud-based organization for the last 10 days.
...
This example returns the actions for the last 10 days in July, 2018.

Customers with Defender for Office 365 subscriptions can get up to 30 days of data.

...
type: reference
domain: powershell
slug: odps-enable-serviceemailchannel
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Enable-ServiceEmailChannel
family: odps
documentKind: "doc"
---
...
```
Enable-ServiceEmailChannel [-Identity] <MailboxIdParameter>
 [-Confirm]

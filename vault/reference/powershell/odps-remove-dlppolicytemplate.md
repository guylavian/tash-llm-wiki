...
type: reference
domain: powershell
slug: odps-remove-dlppolicytemplate
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-DlpPolicyTemplate
family: odps
documentKind: "doc"
---
...
```
Remove-DlpPolicyTemplate [[-Identity] <DlpPolicyIdParameter>]
 [-Confirm]

---
title: "Remove-ForeignConnector"
type: reference
domain: powershell
slug: odps-remove-foreignconnector
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-ForeignConnector
family: odps
documentKind: "doc"
---
...
```
Remove-ForeignConnector [-Identity] <ForeignConnectorIdParameter>
 [-Confirm]
...
The Identity parameter specifies the GUID or connector name of a specific Foreign connector. You can also include the server name by using the format ServerName\\ConnectorName.

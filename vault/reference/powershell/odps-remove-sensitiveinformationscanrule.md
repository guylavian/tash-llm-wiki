...
type: reference
domain: powershell
slug: odps-remove-sensitiveinformationscanrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-SensitiveInformationScanRule
family: odps
documentKind: "doc"
---
...
```
Remove-SensitiveInformationScanRule [-Identity] <ComplianceRuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
### Example 1
```powershell
Remove-SensitiveInformationScanRule -Identity "HR Department Rule"
```

This example removes the specified sensitive information scan rule.

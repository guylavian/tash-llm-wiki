...
type: reference
domain: powershell
slug: odps-new-secopsoverridepolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-SecOpsOverridePolicy
family: odps
documentKind: "doc"
---
...
The Name parameter specifies the name for the SecOps mailbox override policy. Regardless of the value you specify, the name is SecOpsOverridePolicy.

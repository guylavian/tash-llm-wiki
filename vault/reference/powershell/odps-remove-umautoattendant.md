...
type: reference
domain: powershell
slug: odps-remove-umautoattendant
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-UMAutoAttendant
family: odps
documentKind: "doc"
---
...
```
Remove-UMAutoAttendant [-Identity] <UMAutoAttendantIdParameter>
 [-Confirm]

...
type: reference
domain: powershell
slug: odps-open-the-exchange-management-shell
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/docs-conceptual/open-the-exchange-management-shell
family: odps
documentKind: "article"
abstract: "Find and open the shortcut for Exchange PowerShell (also known as the Exchange Management Shell) on Exchange servers or computers that have the Exchange management tools installed."
---

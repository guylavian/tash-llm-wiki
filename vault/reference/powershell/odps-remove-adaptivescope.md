---
title: "Remove-AdaptiveScope"
type: reference
domain: powershell
slug: odps-remove-adaptivescope
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-AdaptiveScope
family: odps
documentKind: "doc"
---
...
Use the Remove-AdaptiveScope cmdlet to remove adaptive scopes from your organization.
...
```
Remove-AdaptiveScope [-Identity] <PolicyIdParameter>
 [-Confirm]
 [-ForceDeletion]
 [-WhatIf]
 [<CommonParameters>]
...
This example removes the adaptive scope named Project X.
...
The Identity parameter specifies the adaptive scope that you want to remove. You can use any value that uniquely identifies the adaptive scope. For example:

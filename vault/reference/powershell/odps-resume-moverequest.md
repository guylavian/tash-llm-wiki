...
type: reference
domain: powershell
slug: odps-resume-moverequest
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Resume-MoveRequest
family: odps
documentKind: "doc"
---
...
Use the Resume-MoveRequest cmdlet to resume a move request that is suspended or has failed.
...
The SuspendWhenReadyToComplete switch suspends the move request before it reaches the status of CompletionInProgress. You don't need to specify a value with this switch.

Instead of this switch, we recommend using the Set-MoveRequest cmdlet with the CompleteAfter parameter.

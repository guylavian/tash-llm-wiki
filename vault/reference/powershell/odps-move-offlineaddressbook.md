...
type: reference
domain: powershell
slug: odps-move-offlineaddressbook
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Move-OfflineAddressBook
family: odps
documentKind: "doc"
---
...
```
Move-OfflineAddressBook [-Identity] <OfflineAddressBookIdParameter>
 [-Confirm]

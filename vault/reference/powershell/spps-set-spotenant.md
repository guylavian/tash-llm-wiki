...
type: reference
domain: powershell
slug: spps-set-spotenant
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-ps/Microsoft.Online.SharePoint.PowerShell/Set-SPOTenant
family: spps
documentKind: "doc"
abstract: "A PowerShell cmdlet used in SharePoint Online to configure organization-wide tenant settings."
---

...
type: reference
domain: powershell
slug: odps-remove-authserver
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-AuthServer
family: odps
documentKind: "doc"
---
...
```
Remove-AuthServer [-Identity] <AuthServerIdParameter>
 [-Confirm]

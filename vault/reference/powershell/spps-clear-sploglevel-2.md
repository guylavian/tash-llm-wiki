...
type: reference
domain: powershell
slug: spps-clear-sploglevel-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Clear-SPLogLevel
family: spps
documentKind: "doc"
---

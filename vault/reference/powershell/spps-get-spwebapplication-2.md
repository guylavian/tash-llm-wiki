...
type: reference
domain: powershell
slug: spps-get-spwebapplication-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Get-SPWebApplication
family: spps
documentKind: "doc"
---
...
### EXAMPLE 1
```powershell
$w = Get-SPWebApplication https://sitename
```

...
type: reference
domain: powershell
slug: odps-remove-inboxrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-InboxRule
family: odps
documentKind: "doc"
---
...
The Identity parameter specifies the Inbox rule that you want to remove. You can use any value that uniquely identifies the rule. For example:

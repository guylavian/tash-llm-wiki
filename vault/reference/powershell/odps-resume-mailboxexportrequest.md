...
type: reference
domain: powershell
slug: odps-resume-mailboxexportrequest
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Resume-MailboxExportRequest
family: odps
documentKind: "doc"
---
...
```
Resume-MailboxExportRequest [-Identity] <MailboxExportRequestIdParameter>
 [-Confirm]

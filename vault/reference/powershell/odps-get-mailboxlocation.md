...
type: reference
domain: powershell
slug: odps-get-mailboxlocation
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-MailboxLocation
family: odps
documentKind: "doc"
---

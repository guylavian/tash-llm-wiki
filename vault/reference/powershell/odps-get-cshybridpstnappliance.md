...
type: reference
domain: powershell
slug: odps-get-cshybridpstnappliance
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/skype/skype-ps/SkypeForBusiness/Get-CsHybridPSTNAppliance
family: odps
documentKind: "doc"
---
...
[-Tenant <Guid>] [-Filter <String>] [-SiteName <String>] [<CommonParameters>]
```

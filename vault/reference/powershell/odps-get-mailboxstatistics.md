...
type: reference
domain: powershell
slug: odps-get-mailboxstatistics
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Get-MailboxStatistics
family: odps
documentKind: "doc"
---

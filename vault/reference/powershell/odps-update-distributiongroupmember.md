...
type: reference
domain: powershell
slug: odps-update-distributiongroupmember
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Update-DistributionGroupMember
family: odps
documentKind: "doc"
---
...
The Members parameter specifies the recipients (mail-enabled objects) that replace the current group members. You can use any value that uniquely identifies the recipient. For example:

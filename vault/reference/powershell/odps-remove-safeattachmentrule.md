...
type: reference
domain: powershell
slug: odps-remove-safeattachmentrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-SafeAttachmentRule
family: odps
documentKind: "doc"
---
...
Use the Remove-SafeAttachmentRule cmdlet to remove safe attachment rules from your cloud-based organization.
...
```
Remove-SafeAttachmentRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
This examples removes the safe attachment rule named Research Department Attachment Rule.
...
The Identity parameter specifies the safe attachment rule that you want to remove.

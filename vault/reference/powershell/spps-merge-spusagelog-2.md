...
type: reference
domain: powershell
slug: spps-merge-spusagelog-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Merge-SPUsageLog
family: spps
documentKind: "doc"
---

...
type: reference
domain: powershell
slug: odps-new-receiveconnector
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/New-ReceiveConnector
family: odps
documentKind: "doc"
---
...
Parameter Sets: Custom, Internet, Partner, Internal, Client, UsageType
Aliases:
...
```yaml
Type: MultiValuedProperty
Parameter Sets: Custom, Partner, Internal, Client, Internet, UsageType
Aliases:

---
title: "Remove-SharingPolicy"
type: reference
domain: powershell
slug: odps-remove-sharingpolicy
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-SharingPolicy
family: odps
documentKind: "doc"
---
...
```
Remove-SharingPolicy [-Identity] <SharingPolicyIdParameter>
 [-Confirm]
...
The Identity parameter specifies the identity of the sharing policy that you want to remove. You can use one of the following values:

...
type: reference
domain: powershell
slug: odps-resume-mailboximportrequest
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Resume-MailboxImportRequest
family: odps
documentKind: "doc"
---
...
```
Resume-MailboxImportRequest [-Identity] <MailboxImportRequestIdParameter>
 [-Confirm]

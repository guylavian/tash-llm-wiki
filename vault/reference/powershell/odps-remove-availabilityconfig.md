...
type: reference
domain: powershell
slug: odps-remove-availabilityconfig
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-AvailabilityConfig
family: odps
documentKind: "doc"
---
...
```
Remove-AvailabilityConfig [[-Identity] <AvailabilityConfigIdParameter>]
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
This example removes the existing availability configuration.

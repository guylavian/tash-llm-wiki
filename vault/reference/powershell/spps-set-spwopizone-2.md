...
type: reference
domain: powershell
slug: spps-set-spwopizone-2
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Set-SPWOPIZone
family: spps
documentKind: "doc"
---

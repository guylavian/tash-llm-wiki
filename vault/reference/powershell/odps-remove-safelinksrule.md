...
type: reference
domain: powershell
slug: odps-remove-safelinksrule
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-SafeLinksRule
family: odps
documentKind: "doc"
---
...
```
Remove-SafeLinksRule [-Identity] <RuleIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```

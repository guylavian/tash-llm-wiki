...
type: reference
domain: powershell
slug: spps-set-spmachinekey
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/spps/sharepoint/sharepoint-server-ps/SharePointServer/Set-SPMachineKey
family: spps
documentKind: "doc"
---

---
title: "Remove-InboundConnector"
type: reference
domain: powershell
slug: odps-remove-inboundconnector
tier: reference
source: https://learn.microsoft.com/en-us/powershell/module/odps/exchange/exchange-ps/ExchangePowerShell/Remove-InboundConnector
family: odps
documentKind: "doc"
---
...
```
Remove-InboundConnector [-Identity] <InboundConnectorIdParameter>
 [-Confirm]
 [-WhatIf]
 [<CommonParameters>]
```
...
This example deletes the Inbound connector named Contoso Inbound Connector.
...
The Identity parameter specifies the Inbound connector you want to remove.

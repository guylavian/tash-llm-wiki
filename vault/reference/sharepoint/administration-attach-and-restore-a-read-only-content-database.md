...
type: reference
domain: sharepoint
slug: administration-attach-and-restore-a-read-only-content-database
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/attach-and-restore-a-read-only-content-database
family: administration
documentKind: "how-to"
abstract: "Learn how to attach and restore a read-only content database in SharePoint Server."
---

# Attach and restore read-only content databases in SharePoint Server - SharePoint Server

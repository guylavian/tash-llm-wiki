---
title: "Install SharePoint 2013 on a single server with SQL Server - SharePoint Server"
type: reference
domain: sharepoint
slug: install-single-server-with-sql-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/single-server-with-sql-server
family: install
documentKind: "install-set-up-deploy"
abstract: "Learn how to install SharePoint on a single server with SQL Server."
---

# Install SharePoint 2013 on a single server with SQL Server - SharePoint Server

---
title: "Plan for custom claims providers for People Picker in SharePoint - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-plan-for-custom-claims-providers-for-people-picker
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-for-custom-claims-providers-for-people-picker
family: administration
documentKind: "interactive-tutorial"
abstract: "Learn about how to plan for custom claims providers for the People Picker web control in SharePoint Server."
---

# Plan for custom claims providers for People Picker in SharePoint - SharePoint Server
...
The SPSystemClaimProvider class provides claims information related to the server farm where SharePoint Server is installed.
...
You can see a list of claims providers for a farm by using the Get-SPClaimProvider Microsoft PowerShell cmdlet.
...
For more information about zones and authentication, see Plan for user authentication methods in SharePoint Server.
...
You can also override the settings of the IsEnabled and IsUsedByDefault properties by using the Set-SPClaimProvider PowerShell cmdlet.
...
Perform a backup of the first farm. For information about how to back up a farm, see Back up farms in SharePoint Server.

Use the back up from the first farm to restore the other farms. For information about how to restore a farm, see Restore farms in SharePoint Server.
...
The SharePoint Server Content Publishing team wants to thank Steve Peschka for contributing to this article. Take a look at Steve Peschka's Share-n-dipity TechNet blog.

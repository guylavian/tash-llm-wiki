...
type: reference
domain: sharepoint
slug: search-how-to-display-values-from-custom-managed-properties-in-the-hover-panel
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/how-to-display-values-from-custom-managed-properties-in-the-hover-panel
family: search
documentKind: "how-to"
abstract: "Learn how to display values from custom managed properties in the hover panel in SharePoint Server."
---

# How to display values from custom managed properties in the hover panel in SharePoint Server - SharePoint Server

...
type: reference
domain: sharepoint
slug: administration-backup-and-recovery-overview
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/backup-and-recovery-overview
family: administration
documentKind: "overview"
abstract: "Know backup and recovery scenarios, backup architecture, and recovery processes before you plan to back up and restore SharePoint Server."
---

# Overview of backup and recovery in SharePoint Server - SharePoint Server

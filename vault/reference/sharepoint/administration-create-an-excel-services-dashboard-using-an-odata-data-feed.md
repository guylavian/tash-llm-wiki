...
type: reference
domain: sharepoint
slug: administration-create-an-excel-services-dashboard-using-an-odata-data-feed
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/create-an-excel-services-dashboard-using-an-odata-data-feed
family: administration
documentKind: "how-to"
abstract: "Learn how to create an Excel Services dashboard that can be published to a library in SharePoint Server 2013."
---

# Create an Excel Services dashboard using an OData data feed - SharePoint Server

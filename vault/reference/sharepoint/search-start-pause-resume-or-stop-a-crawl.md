---
title: "Start, pause, resume, or stop a crawl in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: search-start-pause-resume-or-stop-a-crawl
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/start-pause-resume-or-stop-a-crawl
family: search
documentKind: "article"
abstract: "Learn how to start, pause, resume or stop a full or incremental crawl for a content source."
---

# Start, pause, resume, or stop a crawl in SharePoint Server - SharePoint Server

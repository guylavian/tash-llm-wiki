---
title: "Records management in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: governance-records-management-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/records-management-in-sharepoint-server
family: governance
documentKind: "article"
abstract: "Learn about records management and the records management planning process in SharePoint Server."
---

# Records management in SharePoint Server - SharePoint Server
...
- **Identify records management roles** Successful records management requires specialized roles, such as the following:

...
type: reference
domain: sharepoint
slug: technical-reference-verify-each-user-profile-service-application-has-an-associated-managed-metadata
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/verify-each-user-profile-service-application-has-an-associated-managed-metadata
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Verify each User Profile Service Application has an associated Managed Metadata Service Connection, for SharePoint Server."
---

...
type: reference
domain: sharepoint
slug: technical-reference-one-or-more-categories-are-configured-with-verbose-trace-logging
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/one-or-more-categories-are-configured-with-verbose-trace-logging
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: One or more categories are configured with verbose trace logging, for SharePoint Server."
---

# One or more categories are configured with Verbose trace logging (SharePoint Server) - SharePoint Server

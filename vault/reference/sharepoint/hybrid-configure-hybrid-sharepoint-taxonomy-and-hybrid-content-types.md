---
title: "Configure hybrid SharePoint taxonomy and hybrid content types - SharePoint Server"
type: reference
domain: sharepoint
slug: hybrid-configure-hybrid-sharepoint-taxonomy-and-hybrid-content-types
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/hybrid/configure-hybrid-sharepoint-taxonomy-and-hybrid-content-types
family: hybrid
documentKind: "how-to"
abstract: "In this article, we look at how to configure hybrid SharePoint taxonomy and hybrid content types."
---

# Configure hybrid SharePoint taxonomy and hybrid content types - SharePoint Server
...
Select the link for the Managed Metadata service application.

Add the timer service account to the **Term Store Administrators** box, and then select **Save**.
...
Sign in a server in your SharePoint Server farm as the farm administrator.
...
Follow the wizard, and when prompted, select **Hybrid Taxonomy**.

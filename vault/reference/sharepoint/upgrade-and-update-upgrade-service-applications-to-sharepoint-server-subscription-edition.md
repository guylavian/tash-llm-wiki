...
type: reference
domain: sharepoint
slug: upgrade-and-update-upgrade-service-applications-to-sharepoint-server-subscription-edition
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/upgrade-and-update/upgrade-service-applications-to-sharepoint-server-subscription-edition
family: upgrade-and-update
documentKind: "landing-page"
abstract: "Upgrade service applications (Business Connectivity Services, Managed Metadata, Secure Store, and Search) to SharePoint Server Subscription Edition."
---

# Upgrade service applications to SharePoint Server Subscription Edition - SharePoint Server

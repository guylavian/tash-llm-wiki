...
type: reference
domain: sharepoint
slug: governance-update-to-spworkflow-manager-when-upgrading-farms
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/update-to-spworkflow-manager-when-upgrading-farms
family: governance
documentKind: "upgrade-and-migration-article"
abstract: "Learn how to upgrade from Workflow Manager to SharePoint Workflow Manager when upgrading older SharePoint Server farms."
---

# Upgrade from Workflow Manager to SharePoint Workflow Manager on a new farm - SharePoint Server

...
type: reference
domain: sharepoint
slug: administration-configure-automatic-password-change
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-automatic-password-change
family: administration
documentKind: "how-to"
abstract: "Learn about how to configure the automatic password changes in SharePoint Server."
---

# Configure automatic password change in SharePoint Server - SharePoint Server

...
type: reference
domain: sharepoint
slug: administration-move-site-collections-between-databases
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/move-site-collections-between-databases
family: administration
documentKind: "upgrade-and-migration-article"
abstract: "Learn how to prepare and move site collections between databases in SharePoint Server."
---

# Move site collections between databases in SharePoint Server - SharePoint Server

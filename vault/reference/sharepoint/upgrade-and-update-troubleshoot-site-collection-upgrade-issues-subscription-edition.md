---
title: "Troubleshoot site collection upgrade issues in SharePoint Server Subscription Edition - SharePoint Server"
type: reference
domain: sharepoint
slug: upgrade-and-update-troubleshoot-site-collection-upgrade-issues-subscription-edition
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/upgrade-and-update/troubleshoot-site-collection-upgrade-issues-subscription-edition
family: upgrade-and-update
documentKind: "troubleshooting"
abstract: "Learn how to address problems that may occur after you upgrade a site to SharePoint Server Subscription Edition."
---

# Troubleshoot site collection upgrade issues in SharePoint Server Subscription Edition - SharePoint Server

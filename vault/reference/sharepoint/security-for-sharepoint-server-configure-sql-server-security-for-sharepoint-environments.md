...
type: reference
domain: sharepoint
slug: security-for-sharepoint-server-configure-sql-server-security-for-sharepoint-environments
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/security-for-sharepoint-server/configure-sql-server-security-for-sharepoint-environments
family: security-for-sharepoint-server
documentKind: "how-to"
abstract: "Learn how to improve the security of SQL Server for SharePoint Server environments."
---

# Configure SQL Server security for SharePoint Server - SharePoint Server

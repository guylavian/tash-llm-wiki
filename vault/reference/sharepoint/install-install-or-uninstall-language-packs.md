---
title: "Install or uninstall language packs for SharePoint 2013 - SharePoint Server"
type: reference
domain: sharepoint
slug: install-install-or-uninstall-language-packs
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/install-or-uninstall-language-packs
family: install
documentKind: "install-set-up-deploy"
abstract: "Learn how to download, install, and uninstall language packs for SharePoint."
---

# Install or uninstall language packs for SharePoint 2013 - SharePoint Server
...
If users are accessing Project Server 2016 in the SharePoint farm and have to view their project data in another language, they'll also have to install a corresponding Project Server 2016 language pack. For more information about Project Server 2016 language packs, see Deploy language packs in Project Server 2013.
...
Rerun the SharePoint Products Configuration Wizard by using the default settings. If you don't run the SharePoint Products Configuration Wizard after you install a language pack, the language pack won't be installed correctly.
...
Click **Start**, point to **All Programs**, click **SharePoint 2013**, and then click **SharePoint 2013 Products Configuration Wizard**.
...
If the **Modify SharePoint Central Administration Web Administration Settings** page appears, don't change any of the default settings, and then click **Next**.

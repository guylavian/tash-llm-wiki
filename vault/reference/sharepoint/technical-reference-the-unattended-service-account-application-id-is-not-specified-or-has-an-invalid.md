...
type: reference
domain: sharepoint
slug: technical-reference-the-unattended-service-account-application-id-is-not-specified-or-has-an-invalid
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/the-unattended-service-account-application-id-is-not-specified-or-has-an-invalid
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: The Unattended Service Account Application ID is not specified or has an invalid value, for SharePoint Server."
---

# The unattended Service Account Application ID is not specified or has an invalid value (SharePoint Server) - SharePoint Server

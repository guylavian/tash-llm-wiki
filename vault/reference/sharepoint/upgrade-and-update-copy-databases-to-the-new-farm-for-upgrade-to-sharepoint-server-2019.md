...
type: reference
domain: sharepoint
slug: upgrade-and-update-copy-databases-to-the-new-farm-for-upgrade-to-sharepoint-server-2019
tier: reference
...
abstract: "How to copy SharePoint Server 2016 content and service databases to a SharePoint Server 2019 farm."
---

# Copy databases to the new farm for upgrade to SharePoint Server 2019 - SharePoint Server

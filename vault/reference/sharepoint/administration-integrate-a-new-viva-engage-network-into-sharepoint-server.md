...
type: reference
domain: sharepoint
slug: administration-integrate-a-new-viva-engage-network-into-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/integrate-a-new-viva-engage-network-into-sharepoint-server
family: administration
documentKind: "integration"
abstract: "Learn how to integrate a new Viva Engage network into an existing SharePoint Server environment."
---

# Integrate a new Viva Engage network into SharePoint Server - SharePoint Server

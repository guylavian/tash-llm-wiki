...
type: reference
domain: sharepoint
slug: search-how-to-change-the-text-that-is-displayed-in-the-search-box-web-part
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/how-to-change-the-text-that-is-displayed-in-the-search-box-web-part
family: search
documentKind: "how-to"
abstract: "Learn how to change the text that is displayed in the Search Box Web Part in SharePoint Server."
---

# How to change the text that is displayed in the Search Box Web Part in SharePoint Server - SharePoint Server

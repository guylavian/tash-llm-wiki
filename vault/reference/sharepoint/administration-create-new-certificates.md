---
title: "Create new certificates - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-create-new-certificates
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/create-new-certificates
family: administration
documentKind: "how-to"
abstract: "Learn how you to create new SSL certificate."
---

# Create new certificates - SharePoint Server
...
SharePoint Subscription Edition supports creating SSL certificate requests via the New-SPCertificate PowerShell cmdlet. This is the first step in a three-step process to install a new SSL certificate.

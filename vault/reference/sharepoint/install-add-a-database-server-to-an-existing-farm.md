...
type: reference
domain: sharepoint
slug: install-add-a-database-server-to-an-existing-farm
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/add-a-database-server-to-an-existing-farm
family: install
documentKind: "how-to"
abstract: "Learn how to add a new database server to an existing SharePoint farm."
---

# Add a database server to an existing farm in SharePoint 2013 - SharePoint Server

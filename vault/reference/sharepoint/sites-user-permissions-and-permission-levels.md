---
title: "On-premises SharePoint Server user permissions and permission levels - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-user-permissions-and-permission-levels
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/user-permissions-and-permission-levels
family: sites
documentKind: "article"
abstract: "Learn about the default permission levels and user permissions in SharePoint Server."
---

# On-premises SharePoint Server user permissions and permission levels - SharePoint Server
...
| View Only | Enables users to view application pages. The View Only permission level is used for the Excel Services Viewers group. 
 For SharePoint Server 2019 and Subscription Edition, the View Only permission level won't be provided until the “SharePoint Server Enterprise Site Collection features” is activated. | View Application Pages  
  View Items  
  View Versions  
  Create Alerts  
...
| Permission level | Description | Permissions included by default |
| --- | --- | --- |
| Restricted Read | View pages and documents. For publishing sites only. | View Items  
  Open Items  
  View Pages  
  Open |
| Approve | Edit and approve pages, list items, and documents. For publishing sites only. | Contribute permissions, plus:  
  Override List Behaviors  
  Approve Items |
| Manage Hierarchy | Create sites; edit pages, list items, and documents; and change site permissions. For Publishing sites only. | Design permissions minus the Approve Items, Apply Themes and Borders, and Apply Style Sheets permissions, plus:  
  Manage permissions  

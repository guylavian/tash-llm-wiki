...
type: reference
domain: sharepoint
slug: hybrid-configure-hybrid-federated-search-sharepoint-onlineroadmap
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/hybrid/configure-hybrid-federated-search-sharepoint-onlineroadmap
family: hybrid
documentKind: "article"
abstract: "Learn how to configure hybrid federated search from SharePoint in Microsoft 365 to SharePoint Server."
---

# Configure hybrid federated search from SharePoint in Microsoft 365 to SharePoint Server - roadmap - SharePoint Server

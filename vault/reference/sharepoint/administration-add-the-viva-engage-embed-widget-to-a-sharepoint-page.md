---
title: "Add the Viva Engage Embed widget to a SharePoint page - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-add-the-viva-engage-embed-widget-to-a-sharepoint-page
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/add-the-viva-engage-embed-widget-to-a-sharepoint-page
family: administration
documentKind: "how-to"
abstract: "Learn how to use the Viva Engage Embed widget to include Viva Engage feeds on SharePoint pages."
---

# Add the Viva Engage Embed widget to a SharePoint page - SharePoint Server
...
- Using Viva Engage in a web browser, select the icon or name of the person from anywhere in Viva Engage.
...
Select **Apply**. You see a preview of what will be embedded.

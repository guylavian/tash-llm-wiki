...
type: reference
domain: sharepoint
slug: administration-ssl-certificate-management-in-central-administration
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/ssl-certificate-management-in-central-administration
family: administration
documentKind: "article"
abstract: "Learn how you can use Secure Sockets Layer (SSL) certificate management supports managing your SSL certificates in Central Administration."
---

# SSL certificate management in central administration - SharePoint Server

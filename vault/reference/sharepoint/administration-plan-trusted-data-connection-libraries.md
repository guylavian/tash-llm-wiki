---
title: "Plan Trusted Data Connection Libraries in SharePoint Server 2013 - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-plan-trusted-data-connection-libraries
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-trusted-data-connection-libraries
family: administration
documentKind: "article"
abstract: "Use Excel Services trusted data connection libraries to manage and secure data connections for Excel Services in SharePoint Server."
---

# Plan Trusted Data Connection Libraries in SharePoint Server 2013 - SharePoint Server
...
For information about creating trusted data connection libraries, see Manage Excel Services trusted data connection libraries (SharePoint Server 2013).

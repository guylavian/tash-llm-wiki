...
type: reference
domain: sharepoint
slug: technical-reference-result-types-and-display-templates-that-are-used-to-display-search-results
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/result-types-and-display-templates-that-are-used-to-display-search-results
family: technical-reference
documentKind: "concept-article"
abstract: "Learn about the default result types and display templates that are used to display search results."
---

# Result types and display templates that are used to display classic search results in SharePoint Server - SharePoint Server

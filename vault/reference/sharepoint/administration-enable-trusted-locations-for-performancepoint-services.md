...
type: reference
domain: sharepoint
slug: administration-enable-trusted-locations-for-performancepoint-services
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/enable-trusted-locations-for-performancepoint-services
family: administration
documentKind: "how-to"
abstract: "Learn how to limit PerformancePoint Services features that use trusted locations by allowing only designated sites, lists or document libraries rather than the entire site collection."
---

# Enable trusted locations for PerformancePoint Services - SharePoint Server

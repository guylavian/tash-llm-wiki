...
type: reference
domain: sharepoint
slug: security-for-sharepoint-server-security-hardening
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/security-for-sharepoint-server/security-hardening
family: security-for-sharepoint-server
documentKind: "article"
abstract: "Learn about security hardening for SharePoint Server and database server roles, including specific hardening requirements for ports, protocols, and services."
---

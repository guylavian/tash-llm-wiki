...
type: reference
domain: sharepoint
slug: governance-configure-ediscovery-2019
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/configure-ediscovery-2019
family: governance
documentKind: "how-to"
abstract: "Learn the steps to set up and configure eDiscovery in SharePoint Server and Exchange Server."
---

# Configure eDiscovery in SharePoint Server - SharePoint Server

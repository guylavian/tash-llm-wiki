---
title: "Restore service applications in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-restore-a-service-application
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/restore-a-service-application
family: administration
documentKind: "how-to"
abstract: "Learn how to restore a service application in SharePoint Server."
---

# Restore service applications in SharePoint Server - SharePoint Server

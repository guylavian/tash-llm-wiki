...
type: reference
domain: sharepoint
slug: install-initial-deployment-administrative-and-service-accounts-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/initial-deployment-administrative-and-service-accounts-in-sharepoint-server
family: install
documentKind: "install-set-up-deploy"
abstract: "Learn about the administrative and service accounts you need to initially install SharePoint Server."
---

# Initial deployment administrative and service accounts in SharePoint Server - SharePoint Server

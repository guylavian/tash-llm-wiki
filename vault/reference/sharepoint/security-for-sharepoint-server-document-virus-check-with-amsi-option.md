...
type: reference
domain: sharepoint
slug: security-for-sharepoint-server-document-virus-check-with-amsi-option
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/security-for-sharepoint-server/document-virus-check-with-amsi-option
family: security-for-sharepoint-server
documentKind: "how-to"
abstract: "Learn how to configure the Document Antivirus feature with AMSI option in SharePoint Server."
---

# Enhance Document Antivirus with AMSI Option - SharePoint Server

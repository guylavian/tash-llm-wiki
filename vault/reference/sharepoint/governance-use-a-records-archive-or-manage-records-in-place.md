---
title: "Use a SharePoint Server records archive or manage records in place - SharePoint Server"
type: reference
domain: sharepoint
slug: governance-use-a-records-archive-or-manage-records-in-place
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/use-a-records-archive-or-manage-records-in-place
family: governance
documentKind: "article"
abstract: "Decide which records management approach to choose in SharePoint Server."
---

# Use a SharePoint Server records archive or manage records in place - SharePoint Server
...
| Ease of administration | Separate site or farm for records. | No additional site provisioning work beyond what is already needed for the sites that have active documents. |

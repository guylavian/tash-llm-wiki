---
title: "Restore customizations in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-restore-customizations
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/restore-customizations
family: administration
documentKind: "how-to"
abstract: "Learn how to restore customizations that are made to SharePoint Server sites."
---

# Restore customizations in SharePoint Server - SharePoint Server
...
On the Restore from Backup — Step 3 of 3: Select Restore Options page, in the **Restore Component** section, make sure that **Solution** appears in the **Restore the following component** list.

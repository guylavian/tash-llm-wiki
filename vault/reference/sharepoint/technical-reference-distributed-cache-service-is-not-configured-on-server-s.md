...
type: reference
domain: sharepoint
slug: technical-reference-distributed-cache-service-is-not-configured-on-server-s
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/distributed-cache-service-is-not-configured-on-server-s
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Distributed cache service is not configured on server(s), for SharePoint Server."
---

# Distributed cache service is not configured on server(s) (SharePoint Server 2016) - SharePoint Server

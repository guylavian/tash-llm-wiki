---
title: "Configure cross-site publishing in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-configure-cross-site-publishing
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-cross-site-publishing
family: administration
documentKind: "how-to"
abstract: "Learn to create and tag catalog content in authoring sites and configure search settings for cross-site publishing in SharePoint Server."
---

# Configure cross-site publishing in SharePoint Server - SharePoint Server
...
Before you configure cross-site publishing, make sure that you understand the concepts and terminology in Plan for cross-site publishing in SharePoint Server.
...
In the **Anonymous Access** section, if you don't want anonymous users to view and search this content, click **Disable anonymous access**.
...
In the **Term Set Move** dialog, click the global term set that you want to move the term set to, and then click **OK**.

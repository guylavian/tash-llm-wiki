...
type: reference
domain: sharepoint
slug: technical-reference-more-cache-hosts-are-running-in-this-deployment-than-are-registered-with-sharepo
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/more-cache-hosts-are-running-in-this-deployment-than-are-registered-with-sharepo
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: More Cache hosts are running in this deployment than are registered with SharePoint, for SharePoint Server."
---

# More cache hosts are running in this deployment than are registered with SharePoint (SharePoint Server) - SharePoint Server

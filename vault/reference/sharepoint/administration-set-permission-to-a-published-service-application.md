...
type: reference
domain: sharepoint
slug: administration-set-permission-to-a-published-service-application
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/set-permission-to-a-published-service-application
family: administration
documentKind: "how-to"
abstract: "Learn how to configure permissions to the Application Discovery and Load Balancing Service Application and published service applications for the consuming farm in SharePoint Server."
---

# Set permissions to published service applications in SharePoint Server - SharePoint Server

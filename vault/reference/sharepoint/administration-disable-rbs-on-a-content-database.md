...
type: reference
domain: sharepoint
slug: administration-disable-rbs-on-a-content-database
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/disable-rbs-on-a-content-database
family: administration
documentKind: "how-to"
abstract: "Learn how to disable Remote BLOB Storage (RBS) on any SharePoint Server content database."
---

# Disable RBS on content databases in SharePoint Server - SharePoint Server

---
title: "Create a site collection in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-create-a-site-collection
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/create-a-site-collection
family: sites
documentKind: "how-to"
abstract: "How to create a SharePoint Server site collection in an existing web application."
---

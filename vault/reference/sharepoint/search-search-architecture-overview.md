---
title: "Overview of search architecture in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: search-search-architecture-overview
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/search-architecture-overview
family: search
documentKind: "concept-article"
abstract: "Learn about SharePoint Server search architecture, SharePoint Server search components, SharePoint Server search databases, and the SharePoint Server search topology."
---

# Overview of search architecture in SharePoint Server - SharePoint Server
...
For information about search topologies for different use cases: see the technical diagrams Enterprise search architectures for SharePoint Server 2016 and Internet sites search architectures for SharePoint Server 2016.

Overview of search components and search databases

## Overview of search components and search databases

The following tables show an overview of all the available search components and search databases. For more information about how search components and databases interact, see the Search architectures for SharePoint Server 2016 technical diagram.

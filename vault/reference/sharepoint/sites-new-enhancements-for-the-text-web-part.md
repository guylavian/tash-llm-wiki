---
title: "New enhancements for the Text web part - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-new-enhancements-for-the-text-web-part
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/new-enhancements-for-the-text-web-part
family: sites
documentKind: "how-to"
abstract: "Learn about new enhancements for the Text web part including improved table accessibility features and enhanced image insertion capabilities."
---

# New enhancements for the Text web part - SharePoint Server
...
Create a page in SharePoint site, then text web part, then add table in the property pane. In the property pane, it displays the "Table accessibility" section.

Click the first row header, the first row of this table becomes bold.

Click the first column header, the first column of this table becomes bold.

Click the Alternative text, change the alternative text of this table.

Using screen readers like Narrator, it can accurately announce table headers and alternative text.

---
title: "Plan the logical architecture for cross-site publishing in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-plan-the-logical-architecture-for-cross-site-publishing
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-the-logical-architecture-for-cross-site-publishing
family: administration
documentKind: "article"
abstract: "Learn about components and typical architectures for SharePoint Server cross-site publishing sites."
---

# Plan the logical architecture for cross-site publishing in SharePoint Server - SharePoint Server

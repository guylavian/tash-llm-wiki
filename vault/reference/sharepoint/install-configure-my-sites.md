...
type: reference
domain: sharepoint
slug: install-configure-my-sites
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/configure-my-sites
family: install
documentKind: "how-to"
abstract: "Learn how to set up and configure My Sites in SharePoint Server."
---

# Configure My Sites in SharePoint Server - SharePoint Server

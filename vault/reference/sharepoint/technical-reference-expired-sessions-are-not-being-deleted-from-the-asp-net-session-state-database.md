...
type: reference
domain: sharepoint
slug: technical-reference-expired-sessions-are-not-being-deleted-from-the-asp-net-session-state-database
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/expired-sessions-are-not-being-deleted-from-the-asp-net-session-state-database
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Expired sessions are not being deleted from the ASP.NET Session State database, for SharePoint Server."
---

# Expired sessions are not being deleted from the ASP.NET Session State database (SharePoint Server) - SharePoint Server

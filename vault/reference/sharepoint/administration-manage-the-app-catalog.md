...
type: reference
domain: sharepoint
slug: administration-manage-the-app-catalog
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/manage-the-app-catalog
family: administration
documentKind: "how-to"
abstract: "Learn how to configure and manage an App Catalog for SharePoint Server environments to control access to available apps."
---

# Manage the App Catalog in SharePoint Server - SharePoint Server

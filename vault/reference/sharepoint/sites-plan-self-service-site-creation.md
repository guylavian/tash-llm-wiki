---
title: "Plan self-service site creation in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-plan-self-service-site-creation
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/plan-self-service-site-creation
family: sites
documentKind: "article"
abstract: "Learn the critical decisions that you need to make when preparing for Self Service Site creation and management in SharePoint Server."
---

# Plan self-service site creation in SharePoint Server - SharePoint Server
...
Keep in mind that none of these methods can control how much space each site takes up in your content databases. To control site sizes, you should use quotas and set a size limit for site collections. You cannot set individual size limits for subsites. For more information, see Quotas.
...
Consider requiring a retention policy. When users create a site or site collection, they must select a policy to apply. For more information on site policies see, Overview of site policies in SharePoint Server.

...
type: reference
domain: sharepoint
slug: technical-reference-the-paging-file-size-should-exceed-the-amount-of-physical-ram-in-the-system
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/the-paging-file-size-should-exceed-the-amount-of-physical-ram-in-the-system
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: The paging file size should exceed the amount of physical RAM in the system, for SharePoint Server."
---

# The paging file size should exceed the amount of physical RAM in the system (SharePoint Server) - SharePoint Server

...
type: reference
domain: sharepoint
slug: search-create-and-configure-a-search-service-application
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/create-and-configure-a-search-service-application
family: search
documentKind: "how-to"
abstract: "Learn how to create and configure a SharePoint Search service application so that you can crawl content and provide search results to users."
---

# Create and configure a Search service application in SharePoint Server - SharePoint Server

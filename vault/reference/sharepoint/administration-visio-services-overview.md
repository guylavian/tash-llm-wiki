---
title: "Overview of Visio Services in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-visio-services-overview
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/visio-services-overview
family: administration
documentKind: "concept-article"
abstract: "Visio Services lets users share and view Visio diagrams. It also enables data-connected Visio diagrams to be refreshed and updated from various data sources."
---

# Overview of Visio Services in SharePoint Server - SharePoint Server
...
To get started deploying Visio Services, see Configure Visio Services.

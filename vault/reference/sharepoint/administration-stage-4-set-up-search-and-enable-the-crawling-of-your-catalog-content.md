...
type: reference
domain: sharepoint
slug: administration-stage-4-set-up-search-and-enable-the-crawling-of-your-catalog-content
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/stage-4-set-up-search-and-enable-the-crawling-of-your-catalog-content
family: administration
documentKind: "install-set-up-deploy"
abstract: "Learn how to set up search and enable crawl of your catalog content in SharePoint Server 2016."
---

# Stage 4 Set up search and enable the crawling of your catalog content in SharePoint Server - SharePoint Server

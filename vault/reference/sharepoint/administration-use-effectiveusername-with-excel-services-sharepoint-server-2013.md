...
type: reference
domain: sharepoint
slug: administration-use-effectiveusername-with-excel-services-sharepoint-server-2013
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/use-effectiveusername-with-excel-services-sharepoint-server-2013
family: administration
documentKind: "how-to"
abstract: "Use the Analysis Services EffectiveUserName feature to refresh data-connected workbooks in Excel Services in SharePoint Server 2013 using the workbook viewer's Windows identity."
---

# Use EffectiveUserName with Excel Services (SharePoint Server 2013) - SharePoint Server

---
title: "Document farm configuration settings in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-document-farm-configuration-settings
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/document-farm-configuration-settings
family: administration
documentKind: "how-to"
abstract: "Learn how to document farm configuration settings in SharePoint Server."
---

# Document farm configuration settings in SharePoint Server - SharePoint Server

---
title: "Plan for information management policy in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: governance-information-management-policy-planning
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/information-management-policy-planning
family: governance
documentKind: "article"
abstract: "Learn how to use information management policies in SharePoint Server."
---

# Plan for information management policy in SharePoint Server - SharePoint Server
...
For the SharePoint in Microsoft 365 version of this article, see Create and apply information management policies.

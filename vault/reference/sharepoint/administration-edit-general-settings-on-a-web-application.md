---
title: "Edit general settings on a web application in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-edit-general-settings-on-a-web-application
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/edit-general-settings-on-a-web-application
family: administration
documentKind: "how-to"
abstract: "Illustrates how to make changes to general settings for a SharePoint Server web application in Central Administration."
---

# Edit general settings on a web application in SharePoint Server - SharePoint Server

...
type: reference
domain: sharepoint
slug: search-add-edit-or-delete-a-content-source
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/add-edit-or-delete-a-content-source
family: search
documentKind: "article"
abstract: "Learn how to create a content source to specify what type of content to crawl, schedules for crawling, start addresses, and crawl priority."
---

# Add, edit, or delete a content source in SharePoint Server - SharePoint Server

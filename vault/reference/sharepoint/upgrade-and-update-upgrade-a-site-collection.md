---
title: "Upgrade a site collection to SharePoint Server 2016 - SharePoint Server"
type: reference
domain: sharepoint
slug: upgrade-and-update-upgrade-a-site-collection
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/upgrade-and-update/upgrade-a-site-collection
family: upgrade-and-update
documentKind: "upgrade-and-migration-article"
abstract: "Learn how site collection administrators can upgrade their sites to SharePoint Server 2016 and then review site collections for issues."
---

# Upgrade a site collection to SharePoint Server 2016 - SharePoint Server
...
For additional information on how to troubleshoot error messages, see Troubleshoot site collection upgrade issues in SharePoint Server 2016.
...
| Theme choices are different in SharePoint 2016 - which theme do you want to use? | Your site's home page, or other pages on your site, may look different after the site is upgraded. You may have to re-create or revise a theme and reapply it. |

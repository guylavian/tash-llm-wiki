---
title: "eDiscovery and in-place holds in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: governance-ediscovery-and-in-place-holds-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/ediscovery-and-in-place-holds-in-sharepoint-server
family: governance
documentKind: "article"
abstract: "Learn about eDiscovery across SharePoint Server 2016 and Exchange Server 2016, or SharePoint Server 2013 and Exchange Server 2013, and the eDiscovery Center, eDiscovery cases, in-place holds, and exports."
---

# eDiscovery and in-place holds in SharePoint Server - SharePoint Server
...
To store all versions of content in a site, you have to enable document versioning for the document libraries in the site. For more information about versioning, see Enable and configure versioning for a list or library.
...
To discover content in Exchange mailboxes, you must first configure a trust relationship between SharePoint and Exchange. You must also grant specific Exchange permissions to the users of the eDiscovery Center. For more information about these tasks, see Configure eDiscovery in SharePoint Server.

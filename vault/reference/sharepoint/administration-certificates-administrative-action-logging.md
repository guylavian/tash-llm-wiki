---
title: "Certificates administrative action logging - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-certificates-administrative-action-logging
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/certificates-administrative-action-logging
family: administration
documentKind: "article"
abstract: "Learn how the major certificate actions are logged in the SharePoint."
---

# Certificates administrative action logging - SharePoint Server
...
For more information about administrative action logging, see Using Administrative Actions logging in SharePoint Server 2016.

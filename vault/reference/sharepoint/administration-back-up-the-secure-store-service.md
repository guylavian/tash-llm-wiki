...
type: reference
domain: sharepoint
slug: administration-back-up-the-secure-store-service
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/back-up-the-secure-store-service
family: administration
documentKind: "how-to"
abstract: "Learn how to back up the Secure Store Service Application in SharePoint Server."
---

# Back up the Secure Store Service in SharePoint Server - SharePoint Server

---
title: "Overview of site permissions in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-overview-of-site-permissions-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/overview-of-site-permissions-in-sharepoint-server
family: sites
documentKind: "concept-article"
abstract: "Learn about the concepts behind SharePoint Server access control at the site collection, site, subsite, and site content (list or library, folder, item or document) levels."
---

# Overview of site permissions in SharePoint Server - SharePoint Server
...
For more information about how to use groups to help manage permissions, see Overview of security groups in SharePoint Server.
...
For information about available permissions, see User permissions and permission levels (SharePoint Server 2010).
...
Permission levels are defined at the site collection level and can be customized by any user or group whose permission level includes the Manage Permissions permission. For more information about how to customize permission levels, see Configure custom permissions in SharePoint Server.

---
title: "Plan for multilingual sites in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-plan-for-multilingual-sites
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/plan-for-multilingual-sites
family: sites
documentKind: "how-to"
abstract: "Learn how to plan for multilingual sites in SharePoint Server and SharePoint in Microsoft 365."
---

# Plan for multilingual sites in SharePoint Server - SharePoint Server
...
For information about how to create multilingual sites, see Choose the languages you want to make available for a site's user interface and Create a multi-language website. For information about multilingual sites in SharePoint in Microsoft 365, see Create multilingual communication sites, pages, and news.
...
**You can create sites in languages different from the one that was used to install SharePoint.**
...
**You can use the multilingual user interface to enable users to view the site user interface in their preferred language.**
...
**You can use the variations feature to make publishing content available in different languages on different sites.**
...
For information about how to decide whether to use multilingual user interface features, the variations feature, or both, see Introduction to multilingual features.
...
For more information about what is supported by the multilingual user interface, see Plan for the multilingual user interface in SharePoint Server.
...
For information about how to install language packs, see Install or uninstall language packs for SharePoint Servers 2016 and 2019 and Install or uninstall language packs for SharePoint 2013.

---
title: "Account permissions and security settings in SharePoint 2013 - SharePoint Server"
type: reference
domain: sharepoint
slug: install-account-permissions-and-security-settings-in-sharepoint-2013
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/account-permissions-and-security-settings-in-sharepoint-2013
family: install
documentKind: "article"
abstract: "Learn what permissions and security settings to use with a deployment of SharePoint."
---

# Account permissions and security settings in SharePoint 2013 - SharePoint Server
...
| **Key name** | **Permissions** | **Inherit** | **Description** |
| --- | --- | --- | --- |
| HKEY_LOCAL_MACHINE\Software\Microsoft\Office Server\15.0\LauncherSettings | Read | No | This key contains settings for the document conversion service. Altering this key will break document conversion functionality.  
 This registry key applies only to SharePoint Server. |
| HKEY_LOCAL_MACHINE\Software\Microsoft\Shared Tools\Web Server Extensions\15.0\Secure | Full control | No | This key contains the connection string and the ID of the configuration database to which the machine is joined. If this key is altered, the SharePoint 2013 installation on the machine will not function. |

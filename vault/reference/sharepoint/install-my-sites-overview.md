---
title: "Overview of My Sites in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: install-my-sites-overview
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/my-sites-overview
family: install
documentKind: "concept-article"
abstract: "Learn about the benefits and uses of My Sites in SharePoint Server."
---

# Overview of My Sites in SharePoint Server - SharePoint Server
...
Learn about OneDrive in Microsoft 365.
...
| **Heading** | **Description** |
| --- | --- |
| **Start a conversation** | A text box in which the user can post to the newsfeed. The users can either choose to share with everyone, or with the members of a team site of which they are a member. |
| **Following** | Lists all the conversations, tags, groups, and documents that the user is following. |
| **Everyone** | Displays the recent conversations from everyone in the organization. |
| **Mentions** | Displays all the mentions other users have made of the user, tasks assigned to the user, and so on. |
| **Activities** | Displays all the activities by the user. |
| **Likes** | Displays all the items that the user has liked. |
| **I'm following** | Displays a number that indicates how many people, documents, sites, and tags the user is following. The users can click the numbers to get more details about any items that they follow. |
...
The user's OneDrive usually includes a private folder and a folder that is shared with everyone, or with specific people. For more information, see Overview of OneDrive in SharePoint Server.
...
| **Heading** | **Description** |
| --- | --- |
| **Activities** | Displays the user's recent activities on newsfeeds, who the user is following, colleagues the user has added, and so on. |
| **edit your profile** | By clicking **edit your profile** link, a user can change or update their display photo and information, and privacy settings for their individual profile properties that you allow them to override in the profile policy. The privacy settings are assigned to one of the following two privacy groups: **Only Me** or **Everyone**. For example, a user might decide to display more information, such as a personal phone number. |
| **In Common** | When a user views another user's profile, the user sees the lowest level manager that they share. |
| **Org Chart** | Displays an organization chart. The chart shows the user's position in the organization among management, peers, and direct reports. You can select other people from the chart to view their profiles. |
...
Overview of OneDrive in SharePoint Server

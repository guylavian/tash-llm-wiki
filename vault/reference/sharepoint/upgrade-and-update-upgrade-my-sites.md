---
title: "Upgrade My Sites to SharePoint Server 2016 - SharePoint Server"
type: reference
domain: sharepoint
slug: upgrade-and-update-upgrade-my-sites
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/upgrade-and-update/upgrade-my-sites
family: upgrade-and-update
documentKind: "upgrade-and-migration-article"
abstract: "Learn how to upgrade My Sites site collections in SharePoint Server 2016."
---

# Upgrade My Sites to SharePoint Server 2016 - SharePoint Server
...
Before upgrading the My Site Host and the personal site collections, you must upgrade the Managed Metadata service application, and then the User Profile Service application. For more information, see Services upgrade overview for SharePoint Server 2016
...
This list highlights some important things to consider when you perform an upgrade of My Sites. For a detailed discussion on upgrades, see Get started with upgrades to SharePoint Server 2016

Upgrade My Sites

## Upgrade My Sites

The following list summarizes some of the upgrade activities for a My Site upgrade only. For more information about upgrades, see Upgrade to SharePoint Server 2016
...
Install and configure a new SharePoint Server 2016 farm. For more information, see Create the SharePoint Server 2016 farm for a database attach upgrade.
...
Upgrade the My Site Host from a SharePoint Server 2013 My Site host to a SharePoint Server 2016 My Site Host (discussed in the section titled Upgrade the My Site Host site collection).

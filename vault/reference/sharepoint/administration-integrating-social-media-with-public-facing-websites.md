---
title: "Integrating social media with public-facing websites in SharePoint - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-integrating-social-media-with-public-facing-websites
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/integrating-social-media-with-public-facing-websites
family: administration
documentKind: "integration"
abstract: "Learn how to integrate social media with public-facing websites in SharePoint Server."
---

# Integrating social media with public-facing websites in SharePoint - SharePoint Server
...
Facebook offers several standard plugins that you can use to integrate with Facebook on your website. The overview of all available plugins is published at Facebook Social Plugins. The following is an overview of some plugins and how you can integrate them with your website.
...
More information, see Facebook Insights.
...
If your organization offers products or services to consumers, integrating with Facebook might be a wise choice. If your business is more based on knowledge and is targeted at other businesses, it might be worth the effort to integrate with Viva Engage also. To put it simple: Viva Engage is Facebook for enterprises. It helps organizations share their knowledge by allowing them to communicate within the boundaries of their organization. Making it easier for your visitors to share the content from your website with their Viva Engage networks might help you reach more of your business customers.

Although Viva Engage doesn't offer as many plugins as Facebook does, one thing that you could easily include in your website is a *Yam it* button. The Yam it button gives your visitors to share the page that they are currently visiting with their Viva Engage network with a single mouse click. The following is sample code of a *Yam it* button:

...
type: reference
domain: sharepoint
slug: security-for-sharepoint-server-set-up-oidc-auth-in-sharepoint-server-using-rsa
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/security-for-sharepoint-server/set-up-oidc-auth-in-sharepoint-server-using-rsa
family: security-for-sharepoint-server
documentKind: "install-set-up-deploy"
abstract: "Learn how to set up OIDC authentication in SharePoint Server using RSA public keys with Microsoft Entra ID."
---

# Set up OIDC authentication in SharePoint Server using RSA public keys - SharePoint Server

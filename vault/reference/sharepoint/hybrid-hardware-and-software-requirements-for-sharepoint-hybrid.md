...
type: reference
domain: sharepoint
slug: hybrid-hardware-and-software-requirements-for-sharepoint-hybrid
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/hybrid/hardware-and-software-requirements-for-sharepoint-hybrid
family: hybrid
documentKind: "article"
abstract: "Learn what prerequisites you need to configure hybrid for SharePoint Server."
---

# Hardware and software requirements for SharePoint hybrid - SharePoint Server

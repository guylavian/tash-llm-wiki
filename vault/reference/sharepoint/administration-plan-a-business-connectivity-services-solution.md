---
title: "Plan a Business Connectivity Services solution in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-plan-a-business-connectivity-services-solution
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-a-business-connectivity-services-solution
family: administration
documentKind: "article"
abstract: "Create a plan for your Microsoft Business Connectivity Services solution in SharePoint Server."
---

# Plan a Business Connectivity Services solution in SharePoint Server - SharePoint Server
...
**External system** Every external system will have a method for performing authentication and authorization. (For more information, see How is the data secured? earlier in this article.) You need to work with the external system administrator to identify how to grant access to the solution users according to the principle of least privileges. In general, you'll map a group of users from the Business Connectivity Services side to a single account on the external system side and use the single external system account to restrict access. Another way is to do a 1:1 mapping between individual accounts on each system. In either case, unless the external system can directly accept the credentials with which the user authenticates to SharePoint Server, you'll need to use the Secure Store Service. For more in-depth information about the authentication models that Business Connectivity Services supports, see Business Connectivity Services security overview (SharePoint 2010).

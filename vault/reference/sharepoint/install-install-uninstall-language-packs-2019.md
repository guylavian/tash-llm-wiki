---
title: "Install or uninstall language packs for SharePoint Servers 2016 and 2019 - SharePoint Server"
type: reference
domain: sharepoint
slug: install-install-uninstall-language-packs-2019
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/install-uninstall-language-packs-2019
family: install
documentKind: "install-set-up-deploy"
abstract: "Learn how to download, install, and uninstall language packs for SharePoint Server."
---

# Install or uninstall language packs for SharePoint Servers 2016 and 2019 - SharePoint Server
...
You can download language packs from the Microsoft Download Center for SharePoint Server 2016 and SharePoint Server 2019.
...
In the folder where you downloaded the language pack, run serverlanguagepack.exe.
...
Click **Start**, point to **Microsoft SharePoint 2019 Products** folder, click **SharePoint Products Configuration Wizard**.
...
After you install a new language pack and rerun the **SharePoint Products Configuration Wizard**, you must deactivate and then reactivate any language-specific features before you use the new language pack.

When you install language packs, the language-specific site templates are installed in the %COMMONPROGRAMFILES%\Microsoft Shared\Web Server Extensions\16\TEMPLATE\ *LanguageID* directory, where  *LanguageID* is the Language ID number for the language that you're installing. For example, the United States English language pack installs to the %COMMONPROGRAMFILES%\Microsoft Shared\Web Server Extensions\16\TEMPLATE\1033 directory. After you install a language pack, site owners and site collection administrators can create sites and site collections based on the language-specific site templates by specifying a language when they're creating a new SharePoint site or site collection.

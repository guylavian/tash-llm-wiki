...
type: reference
domain: sharepoint
slug: technical-reference-xliff-translations-for-the-machine-translation-service-is-disabled
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/xliff-translations-for-the-machine-translation-service-is-disabled
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: XLIFF translation for the Machine Translation Service is disabled, for SharePoint Server."
---

# XLIFF translations for the Machine Translation Service is disabled (SharePoint Server) - SharePoint Server

---
title: "Services upgrade overview for SharePoint Server 2016 - SharePoint Server"
type: reference
domain: sharepoint
slug: upgrade-and-update-overview-of-the-services-upgrade-process
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/upgrade-and-update/overview-of-the-services-upgrade-process
family: upgrade-and-update
documentKind: "concept-article"
abstract: "Create a plan to upgrade data for service applications when you upgrade from SharePoint Server 2013 to SharePoint Server 2016."
---

# Services upgrade overview for SharePoint Server 2016 - SharePoint Server

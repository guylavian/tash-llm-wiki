---
title: "Plan for apps for SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-plan-for-apps-for-sharepoint
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-for-apps-for-sharepoint
family: administration
documentKind: "article"
abstract: "Plan for apps for SharePoint, including the App Catalog and how to monitor and license apps."
---

# Plan for apps for SharePoint Server - SharePoint Server
...
Additionally, using apps for SharePoint requires a separate DNS domain configuration (discussed below), and the Subscription Settings and App Management service applications. We cover how to configure the separate app domain and the service applications in the apps for SharePoint configuration article.
...
The details of how to configure the app domain are covered in Configure an environment for apps for SharePoint Server.
...
See Manage the App Catalog in SharePoint Server to get started.
...
See Monitor apps for SharePoint for SharePoint Server to get started.
...
See Monitor and manage app licenses in SharePoint Server to get started.

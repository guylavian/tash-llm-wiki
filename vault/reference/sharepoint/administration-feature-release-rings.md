---
title: "Feature release rings - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-feature-release-rings
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/feature-release-rings
family: administration
documentKind: "how-to"
abstract: "Learn about the feature release rings."
---

# Feature release rings - SharePoint Server
...
- Click **Feature release preference**.

- Select either **Early release** or **Standard release (Default)** and then click **OK**.

- Run **SharePoint Products Configuration Wizard** on each server in your SharePoint farm to ensure all features recognize the new feature release preference.
...
- Launch the **SharePoint Management Shell** or a Windows PowerShell console.

- Run the **Set-SPFeatureReleasePreference** cmdlet with the **FeatureReleaseRing** parameter, specifying either **Early** or **Standard** for the parameter value. 

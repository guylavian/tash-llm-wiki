---
title: "Plan for site maintenance and management in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-plan-site-maintenance-and-management
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/plan-site-maintenance-and-management
family: sites
documentKind: "article"
abstract: "Learn how to control resource utilization through management of sites and site collections in SharePoint Server."
---

# Plan for site maintenance and management in SharePoint Server - SharePoint Server
...
Create a plan to back up site content often. Determine or discover how often backups will be made, and the process for restoring content when necessary. For more , see Plan for backup and recovery in SharePoint Server.

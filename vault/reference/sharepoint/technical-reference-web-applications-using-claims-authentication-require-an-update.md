---
title: "Web Applications using Claims authentication require an update (SharePoint Server) - SharePoint Server"
type: reference
domain: sharepoint
slug: technical-reference-web-applications-using-claims-authentication-require-an-update
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/web-applications-using-claims-authentication-require-an-update
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Web Applications using Claims authentication require an update, for SharePoint Server."
---

# Web Applications using Claims authentication require an update (SharePoint Server) - SharePoint Server

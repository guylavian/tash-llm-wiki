...
type: reference
domain: sharepoint
slug: search-manage-company-name-extraction
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/manage-company-name-extraction
family: search
documentKind: "how-to"
abstract: "Learn how to include company names to be extracted from content for classic search results, or how to exclude company names from being extracted."
---

# Manage company name extraction in SharePoint Server - SharePoint Server

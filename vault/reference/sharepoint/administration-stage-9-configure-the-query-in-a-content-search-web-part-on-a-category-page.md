...
type: reference
domain: sharepoint
slug: administration-stage-9-configure-the-query-in-a-content-search-web-part-on-a-category-page
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/stage-9-configure-the-query-in-a-content-search-web-part-on-a-category-page
family: administration
documentKind: "how-to"
abstract: "Learn how to configure the query in a Content Search Web Part on a category page in SharePoint Server 2016."
---

# Stage 9 Configure the query in a Content Search Web Part on a category page in SharePoint Server - SharePoint Server

...
type: reference
domain: sharepoint
slug: technical-reference-infopath-forms-services-forms-cannot-be-filled-out-in-a-web-browser-because-no-s
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/infopath-forms-services-forms-cannot-be-filled-out-in-a-web-browser-because-no-s
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: InfoPath Forms Services forms cannot be filled out in a Web browser because no State Service connection is configured."
---

# InfoPath Forms Services forms cannot be filled out in a Web browser because no State Service connection is configured (SharePoint Server) - SharePoint Server

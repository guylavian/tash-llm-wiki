...
type: reference
domain: sharepoint
slug: administration-use-a-sample-mim-solution-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/use-a-sample-mim-solution-in-sharepoint-server
family: administration
documentKind: "how-to"
abstract: "How to configure SharePoint Server profile synchronization with Microsoft Identity Manager (MIM)."
---

# Use a sample MIM solution in SharePoint Server - SharePoint Server

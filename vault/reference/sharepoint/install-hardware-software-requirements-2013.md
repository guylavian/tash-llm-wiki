...
type: reference
domain: sharepoint
slug: install-hardware-software-requirements-2013
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/hardware-software-requirements-2013
family: install
documentKind: "interactive-tutorial"
abstract: "Lists the minimum hardware and software requirements to install and run SharePoint."
---

# Hardware and software requirements for SharePoint 2013 - SharePoint Server

...
type: reference
domain: sharepoint
slug: administration-configure-refiners-and-faceted-navigation
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-refiners-and-faceted-navigation
family: administration
documentKind: "how-to"
abstract: "Learn how to map a crawled property to a refinable managed property, enable a managed property as a refiner, and configure refiners for faceted navigation."
---

# Configure refiners and faceted navigation in SharePoint Server - SharePoint Server

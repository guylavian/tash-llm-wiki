---
title: "Reset Certificate Generation Key for SharePoint Workflow Manager - SharePoint Server"
type: reference
domain: sharepoint
slug: governance-reset-certificate-generation-key-sharepoint-workflow-manager
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/reset-certificate-generation-key-sharepoint-workflow-manager
family: governance
documentKind: "how-to"
abstract: "Learn how to generate key for SharePoint Workflow Manger."
---

# Reset Certificate Generation Key for SharePoint Workflow Manager - SharePoint Server

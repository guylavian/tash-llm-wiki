---
title: "Plan server-to-server authentication - SharePoint Server"
type: reference
domain: sharepoint
slug: hybrid-plan-server-to-server-authentication-m365
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/hybrid/plan-server-to-server-authentication-m365
family: hybrid
documentKind: "article"
abstract: "Plan and prepare to configure server-to-server authentication from SharePoint Server to Microsoft 365 for SharePoint hybrid."
---

# Plan server-to-server authentication - SharePoint Server

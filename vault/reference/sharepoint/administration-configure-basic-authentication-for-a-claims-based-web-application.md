...
type: reference
domain: sharepoint
slug: administration-configure-basic-authentication-for-a-claims-based-web-application
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-basic-authentication-for-a-claims-based-web-application
family: administration
documentKind: "how-to"
abstract: "Learn how to configure basic authentication for a web application that uses claims-based authentication in SharePoint Server."
---

# Configure basic authentication for a claims-based web application in SharePoint Server - SharePoint Server

...
type: reference
domain: sharepoint
slug: administration-view-diagnostic-logs
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/view-diagnostic-logs
family: administration
documentKind: "how-to"
abstract: "Learn to view and filter log events by using Microsoft PowerShell, and view and export diagnostic logs by using the Out-GridView cmdlet."
---

# View diagnostic logs in SharePoint Server - SharePoint Server

...
type: reference
domain: sharepoint
slug: install-browser-support-planning-subscription-edition
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/browser-support-planning-subscription-edition
family: install
documentKind: "interactive-tutorial"
abstract: "Learn about how SharePoint Server Subscription Edition supports Internet Explorer, Google Chrome, Mozilla Firefox, Apple Safari, and Microsoft Edge."
---

# Plan browser support in SharePoint Server Subscription Edition - SharePoint Server

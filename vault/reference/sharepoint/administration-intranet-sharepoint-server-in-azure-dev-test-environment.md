...
type: reference
domain: sharepoint
slug: administration-intranet-sharepoint-server-in-azure-dev-test-environment
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/intranet-sharepoint-server-in-azure-dev-test-environment
family: administration
documentKind: "article"
abstract: "Create an intranet SharePoint Server farm running in Microsoft Azure as a dev/test environment."
---

# Intranet SharePoint Server in Azure dev/test environment - SharePoint Server

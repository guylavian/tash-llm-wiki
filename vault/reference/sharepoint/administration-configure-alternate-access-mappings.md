...
type: reference
domain: sharepoint
slug: administration-configure-alternate-access-mappings
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-alternate-access-mappings
family: administration
documentKind: "how-to"
abstract: "Learn how to configure alternate access mappings in SharePoint Server."
---

# Configure alternate access mappings for SharePoint Server - SharePoint Server

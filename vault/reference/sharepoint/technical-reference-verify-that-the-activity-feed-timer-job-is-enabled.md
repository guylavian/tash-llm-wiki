...
type: reference
domain: sharepoint
slug: technical-reference-verify-that-the-activity-feed-timer-job-is-enabled
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/verify-that-the-activity-feed-timer-job-is-enabled
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Verify that the Activity Feed Timer Job is enabled, for SharePoint Server."
---

# Verify that the Activity Feed Timer Job is enabled (SharePoint Server) - SharePoint Server

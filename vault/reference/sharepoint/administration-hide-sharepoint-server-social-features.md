...
type: reference
domain: sharepoint
slug: administration-hide-sharepoint-server-social-features
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/hide-sharepoint-server-social-features
family: administration
documentKind: "how-to"
abstract: "Learn how to remove Web Parts and hide user interface controls that provide social features and replace them with Viva Engage in SharePoint Server."
---

# Hide SharePoint Server social features - SharePoint Server

...
type: reference
domain: sharepoint
slug: administration-connect-a-publishing-site-to-a-catalog
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/connect-a-publishing-site-to-a-catalog
family: administration
documentKind: "how-to"
abstract: "Learn how to connect a publishing site collection to a library or list that is shared as a catalog."
---

# Connect a publishing site to a catalog in SharePoint Server - SharePoint Server

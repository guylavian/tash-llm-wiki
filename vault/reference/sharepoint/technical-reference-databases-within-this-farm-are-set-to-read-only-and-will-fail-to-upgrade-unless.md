...
type: reference
domain: sharepoint
slug: technical-reference-databases-within-this-farm-are-set-to-read-only-and-will-fail-to-upgrade-unless
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/databases-within-this-farm-are-set-to-read-only-and-will-fail-to-upgrade-unless
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Databases within this farm are set to read only and will fail to upgrade unless it's set to a read-write state, for SharePoint Server."
---

# Databases within this farm are set to read only and will fail to upgrade unless it's set to a read-write state (SharePoint Server) - SharePoint Server

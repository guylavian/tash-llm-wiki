---
title: "Monitor apps for SharePoint for SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-monitor-apps-for-sharepoint
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/monitor-apps-for-sharepoint
family: administration
documentKind: "how-to"
abstract: "Learn how administrators and site owners can monitor the health and usage details for apps for SharePoint in SharePoint Server."
---

# Monitor apps for SharePoint for SharePoint Server - SharePoint Server
...
You can use the SharePoint Central Administration website to monitor apps for SharePoint and check details and errors. Be sure you've configured your environment for apps for SharePoint and created an app catalog before you get started.
...
On the Site Contents page, click the icon next to the app you want to monitor and then click **Details** in the callout.

---
title: "Plan to use refiners on a search results page in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: search-plan-to-use-refiners-on-a-search-results-page
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/plan-to-use-refiners-on-a-search-results-page
family: search
documentKind: "article"
abstract: "Learn how to plan to use refiners on a search results page in SharePoint Server."
---

# Plan to use refiners on a search results page in SharePoint Server - SharePoint Server

...
type: reference
domain: sharepoint
slug: install-browser-support-planning
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/browser-support-planning
family: install
documentKind: "interactive-tutorial"
abstract: "Learn about how SharePoint supports Internet Explorer, Google Chrome, Mozilla Firefox, and Apple Safari."
---

# Plan browser support in SharePoint 2013 - SharePoint Server

...
type: reference
domain: sharepoint
slug: technical-reference-distributed-cache-service-is-not-enabled-in-this-deployment
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/distributed-cache-service-is-not-enabled-in-this-deployment
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Distributed cache service is not enabled in this deployment, for SharePoint Server."
---

# Distributed cache service is not enabled in this deployment (SharePoint Server) - SharePoint Server

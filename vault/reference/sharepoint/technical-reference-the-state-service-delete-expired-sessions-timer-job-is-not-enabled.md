...
type: reference
domain: sharepoint
slug: technical-reference-the-state-service-delete-expired-sessions-timer-job-is-not-enabled
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/the-state-service-delete-expired-sessions-timer-job-is-not-enabled
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: The State Service Delete Expired Sessions timer job is not enabled, for SharePoint Server."
---

# The State Service Delete Expired Sessions timer job is not enabled (SharePoint Server) - SharePoint Server

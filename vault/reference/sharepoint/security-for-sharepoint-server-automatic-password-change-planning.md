---
title: "Plan automatic password change in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: security-for-sharepoint-server-automatic-password-change-planning
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/security-for-sharepoint-server/automatic-password-change-planning
family: security-for-sharepoint-server
documentKind: "article"
abstract: "Learn about the automatic password changes and how to deploy them in SharePoint Server."
---

# Plan automatic password change in SharePoint Server - SharePoint Server

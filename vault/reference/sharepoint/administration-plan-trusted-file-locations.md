---
title: "Plan Trusted File Locations in SharePoint Server 2013 - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-plan-trusted-file-locations
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-trusted-file-locations
family: administration
documentKind: "article"
abstract: "Plan Excel Services trusted file location parameters, including session, workbook, calculation, memory, and external data settings."
---

# Plan Trusted File Locations in SharePoint Server 2013 - SharePoint Server

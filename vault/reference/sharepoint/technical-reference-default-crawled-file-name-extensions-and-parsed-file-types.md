---
title: "Default crawled file name extensions and parsed file types in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: technical-reference-default-crawled-file-name-extensions-and-parsed-file-types
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/default-crawled-file-name-extensions-and-parsed-file-types
family: technical-reference
documentKind: "reference"
abstract: "Learn which file name extensions SharePoint Server and SharePoint in Microsoft 365 crawl by default and which file types it parses by default."
---

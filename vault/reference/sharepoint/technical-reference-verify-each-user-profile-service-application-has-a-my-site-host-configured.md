...
type: reference
domain: sharepoint
slug: technical-reference-verify-each-user-profile-service-application-has-a-my-site-host-configured
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/verify-each-user-profile-service-application-has-a-my-site-host-configured
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Verify each User Profile service application has a My Site Host configured, for SharePoint Server."
---

# Verify each User Profile service application has a My Site host configured (SharePoint Server) - SharePoint Server

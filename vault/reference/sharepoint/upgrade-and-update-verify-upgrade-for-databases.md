---
title: "Verify database upgrades in SharePoint Server 2016 - SharePoint Server"
type: reference
domain: sharepoint
slug: upgrade-and-update-verify-upgrade-for-databases
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/upgrade-and-update/verify-upgrade-for-databases
family: upgrade-and-update
documentKind: "upgrade-and-migration-article"
abstract: "Learn how to verify when a database-attach upgrade to SharePoint Server 2016 has finished, and identify any problems that may have occurred."
---

# Verify database upgrades in SharePoint Server 2016 - SharePoint Server

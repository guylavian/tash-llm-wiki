...
type: reference
domain: sharepoint
slug: administration-use-analysis-services-effectiveusername-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/use-analysis-services-effectiveusername-in-sharepoint-server
family: administration
documentKind: "how-to"
abstract: "Use the EffectiveUserName option in Excel Services or PerformancePoint Services for per-user authentication with Analysis Services data sources."
---

# Use Analysis Services EffectiveUserName in SharePoint Server - SharePoint Server

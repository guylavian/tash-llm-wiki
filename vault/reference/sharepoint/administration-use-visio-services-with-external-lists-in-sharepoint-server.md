...
type: reference
domain: sharepoint
slug: administration-use-visio-services-with-external-lists-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/use-visio-services-with-external-lists-in-sharepoint-server
family: administration
documentKind: "how-to"
abstract: "Connect to an external list in Visio by using Microsoft Business Connectivity Services and render the diagram in a browser by using Visio Services."
---

# Use Visio Services with external lists in SharePoint Server - SharePoint Server

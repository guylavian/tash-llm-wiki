---
title: "Plan for least-privileged administration in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: security-for-sharepoint-server-plan-for-least-privileged-administration
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/security-for-sharepoint-server/plan-for-least-privileged-administration
family: security-for-sharepoint-server
documentKind: "article"
abstract: "Learn about how to use least-privileged administration to configure and maintain a SharePoint Server farm and enhance security."
---

# Plan for least-privileged administration in SharePoint Server - SharePoint Server
...
**New-SPContentDatabase** - When building a new SharePoint farm with a slipstreamed build of October 2022 CU+ or higher, ensure the SPFarm account is granted owner access when creating any new content databases via Powershell:

```
Get-SPContentDatabase -Identity <identity> | %{$_.GrantOwnerAccessToDatabaseAccount()}
```

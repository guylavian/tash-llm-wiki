...
type: reference
domain: sharepoint
slug: administration-stage-16-add-a-taxonomy-refinement-panel-web-part-to-a-publishing-site
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/stage-16-add-a-taxonomy-refinement-panel-web-part-to-a-publishing-site
family: administration
documentKind: "how-to"
abstract: "Learn how to add a taxonomy refinement panel web part to a publishing site in SharePoint Server 2016."
---

# Stage 16 Add a Taxonomy Refinement Panel Web Part to a publishing site in SharePoint Server - SharePoint Server

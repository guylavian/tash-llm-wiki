...
type: reference
domain: sharepoint
slug: administration-bi-capabilities-in-excel-and-excel-services
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/bi-capabilities-in-excel-and-excel-services
family: administration
documentKind: "article"
abstract: "Excel 2013 offers a wide range of business intelligence capabilities. Learn which capabilities are supported in Excel Services (on premises)."
---

# Business intelligence capabilities in Excel Service (SharePoint Server 2013) - SharePoint Server

...
type: reference
domain: sharepoint
slug: administration-performancepoint-services-application-settings
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/performancepoint-services-application-settings
family: administration
documentKind: "article"
abstract: "Learn how to customize PerformancePoint Services application settings to meet your business needs."
---

# PerformancePoint Services application settings - SharePoint Server

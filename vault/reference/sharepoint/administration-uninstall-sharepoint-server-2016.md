...
type: reference
domain: sharepoint
slug: administration-uninstall-sharepoint-server-2016
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/uninstall-sharepoint-server-2016
family: administration
documentKind: "install-set-up-deploy"
abstract: "Learn about the limited set of supported methods to uninstall SharePoint Server."
---

# Uninstall SharePoint Server 2016, 2019, or Subscription Edition - SharePoint Server

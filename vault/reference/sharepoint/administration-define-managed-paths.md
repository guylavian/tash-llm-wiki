...
type: reference
domain: sharepoint
slug: administration-define-managed-paths
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/define-managed-paths
family: administration
documentKind: "how-to"
abstract: "Learn how to add a managed path for a web application in SharePoint Server."
---

# Define managed paths in SharePoint Server - SharePoint Server

---
title: "Overview of site policies in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-site-policy-overview
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/site-policy-overview
family: sites
documentKind: "concept-article"
abstract: "Learn about SharePoint Server site closure and deletion policies and how they apply to SharePoint governance and self-service site creation."
---

# Overview of site policies in SharePoint Server - SharePoint Server

...
type: reference
domain: sharepoint
slug: search-scale-search-for-internet-sites
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/scale-search-for-internet-sites
family: search
documentKind: "article"
abstract: "Determine hardware requirements and review considerations to scale out SharePoint Server search topologies for Internet sites for performance and availability."
---

# Scale search for Internet sites in SharePoint Server - SharePoint Server

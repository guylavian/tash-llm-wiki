...
type: reference
domain: sharepoint
slug: administration-plan-for-disaster-recovery
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-for-disaster-recovery
family: administration
documentKind: "article"
abstract: "Understand the disaster recovery options and supported technologies for recovering a SharePoint Server farm if there is a disaster."
---

# Choose a disaster recovery strategy for SharePoint Server - SharePoint Server

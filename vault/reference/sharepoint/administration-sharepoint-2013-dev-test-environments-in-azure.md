---
title: "SharePoint 2013 dev/test environments in Azure - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-sharepoint-2013-dev-test-environments-in-azure
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/sharepoint-2013-dev-test-environments-in-azure
family: administration
documentKind: "landing-page"
abstract: "Create a basic or high-availability SharePoint dev/test farm in Microsoft Azure."
---

# SharePoint 2013 dev/test environments in Azure - SharePoint Server
...
Click **All services**, and then click **Marketplace** in the **General** list of services.

In the search box, type **SharePoint 2013**, and then click **SharePoint 2013 non-HA Farm**.

In the results, click **SharePoint 2013 non-HA Farm**.
...
In the search box, type **SharePoint 2013**, and then click **SharePoint 2013 HA Farm**.

In the results, click **SharePoint 2013 HA Farm**.

On the **SharePoint 2013 HA Farm** pane, click **Create**.

Specify settings on the steps of the **Create SharePoint 2013 HA Farm** pane, and then click **Create**.
...
Modify the **azuredeploy.parameters.json** file as needed for your basic SharePoint 2013 farm. You can use Visual Studio Code or the free Sublime Text editor. For example, you can specify:
...
For the virtual machine sizes, you must specify a size in the DS or GS series of virtual machines.
...
These commands use Azure PowerShell 1.0.0 and later.
...
Modify the **azuredeploy.parameters.json** file as needed for your high-availability SharePoint 2013 farm. You can use Visual Studio Code or the free Sublime Text editor. For example, you can specify:
...
You can administer the servers of these farms through Remote Desktop connections.
...
See the instructions in SharePoint Server dev/test environment in Azure to create the following single-server, SharePoint dev/test farm:.

...
type: reference
domain: sharepoint
slug: technical-reference-amsi-protection-may-not-be-working
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/amsi-protection-may-not-be-working
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn what to do, if AMSI protection isn't working."
---

# Antimalware Scan Interface (AMSI) protection may not be working (SharePoint Server) - SharePoint Server

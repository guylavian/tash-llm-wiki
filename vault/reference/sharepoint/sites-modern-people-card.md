...
type: reference
domain: sharepoint
slug: sites-modern-people-card
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/modern-people-card
family: sites
documentKind: "overview"
abstract: "Learn about the Modern People Card feature, which is one of the newly introduced features in SharePoint Server Subscription Edition Version 25H2."
---

# Modern People Card - SharePoint Server

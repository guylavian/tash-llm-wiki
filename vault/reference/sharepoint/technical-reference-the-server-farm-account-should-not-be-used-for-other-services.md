...
type: reference
domain: sharepoint
slug: technical-reference-the-server-farm-account-should-not-be-used-for-other-services
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/the-server-farm-account-should-not-be-used-for-other-services
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: The server farm account should not be used for the other services, for SharePoint Server."
---

# The server farm account should not be used for other services (SharePoint Server) - SharePoint Server

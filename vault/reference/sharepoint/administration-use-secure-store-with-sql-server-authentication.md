...
type: reference
domain: sharepoint
slug: administration-use-secure-store-with-sql-server-authentication
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/use-secure-store-with-sql-server-authentication
family: administration
documentKind: "how-to"
abstract: "Use Secure Store in SharePoint Server to store SQL Server credentials."
---

# Use Secure Store with SQL Server Authentication - SharePoint Server

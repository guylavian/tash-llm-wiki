---
title: "Plan incoming email for a SharePoint Server farm - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-incoming-email-planning
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/incoming-email-planning
family: administration
documentKind: "how-to"
abstract: "Learn how to configure incoming email for SharePoint Server."
---

# Plan incoming email for a SharePoint Server farm - SharePoint Server
...
| --- | --- | --- |
| **Enable Incoming E-mail** | Yes | Yes |

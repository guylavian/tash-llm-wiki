---
title: "Manage a connection to a document center or a records center in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-manage-a-connection-to-a-document-center-or-a-records-center
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/manage-a-connection-to-a-document-center-or-a-records-center
family: sites
documentKind: "how-to"
abstract: "How to connect a web application to a SharePoint Server document center or records center and how to modify and delete connections."
---

# Manage a connection to a document center or a records center in SharePoint Server - SharePoint Server
...
To create a connection, you must be a member of the Farm Administrators group.

On the SharePoint Central Administration website, click **General Application Settings** and in the **External Service Connections** section, select **Configure Send To Connections**.

On the **Configure Send To Connections** page, in the **Web Application** field, select the web application that hosts the site collections from which documents will be sent.

In the **Tenant Settings** section, select **Allow sites to send to connections outside their tenancy** if you want tenants on this farm to able to send content to other tenants on this farm.

In the **Send To Connections** list, select **New Connection**.
...
In the **Send To action** list, select one of the following values:
...
In the **Explanation** dialog, type the information to be added to the audit log when the user sends a document by using this connection. If you selected **Move and Leave a Link** in the previous step, the page that appears when the user clicks the link will also display the explanation.

Click **Add Connection** to create the connection, and then click **OK** when you are finished configuring connections.
...
To modify a connection, you must be a member of the Farm Administrators group.

On the Central Administration website, click **General Application Settings**, and select **Configure Send To Connections**.

On the **Configure Send To Connections** page, in the **Web Application** field, select the web application that contains the site collections that use this connection.

In the **Send To Connections** list, select the connection that you want to modify.

Modify any of the connection settings as described in the previous procedure.

Click **Update Connection** to modify the connection, and then click **OK** when you are finished configuring connections.
...
To delete a connection, you must be a member of the Farm Administrators group.

On the Central Administration website, click **General Application Settings**, and select **Configure Send To Connections**.

On the **Configure Send To Connections** page, in the **Web Application** field, select the web application that contains the site collections that use this connection.

In the **Send To Connections** list, select the connection that you want to delete.

Click **Remove Connection** to delete the connection, and then click **OK** when you are finished configuring connections.

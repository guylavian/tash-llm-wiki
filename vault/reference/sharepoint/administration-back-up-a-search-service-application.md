---
title: "Back up Search service applications in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-back-up-a-search-service-application
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/back-up-a-search-service-application
family: administration
documentKind: "how-to"
abstract: "Learn how to back up Search service applications in SharePoint Server."
---

# Back up Search service applications in SharePoint Server - SharePoint Server
...
Back up all the Search service application databases with SQL Server tools.

...
type: reference
domain: sharepoint
slug: administration-configure-the-unattended-service-account-for-performancepoint-services
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-the-unattended-service-account-for-performancepoint-services
family: administration
documentKind: "how-to"
abstract: "Learn how to configure the unattended service account for PerformancePoint Services."
---

# Configure the unattended service account for PerformancePoint Services - SharePoint Server

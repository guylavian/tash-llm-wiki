...
type: reference
domain: sharepoint
slug: technical-reference-one-or-more-servers-is-not-responding
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/one-or-more-servers-is-not-responding
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: One or more servers is not responding, for SharePoint Server."
---

# One or more servers is not responding (SharePoint Server) - SharePoint Server

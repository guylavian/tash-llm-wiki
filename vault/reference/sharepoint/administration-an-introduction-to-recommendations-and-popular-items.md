---
title: "An introduction to recommendations and popular items in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-an-introduction-to-recommendations-and-popular-items
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/an-introduction-to-recommendations-and-popular-items
family: administration
documentKind: "article"
abstract: "Get an introduction to recommendations and popular items features in SharePoint Server."
---

# An introduction to recommendations and popular items in SharePoint Server - SharePoint Server
...
Visitors do something on our website, for example, they view an item. This generates a **usage event**.

The usage event is recorded in the **Event store**.

The usage events are sent to the **Analytics Processing Component**, where they're analyzed. The result is sent to the **Search index**.

When visitors browse to a page that contains a **Recommendations** or **Popular Items Web Part**, a query is automatically issued and sent to the search index.
...
On the server where SharePoint Server is installed, open the **SharePoint 2016 Management Shell**.

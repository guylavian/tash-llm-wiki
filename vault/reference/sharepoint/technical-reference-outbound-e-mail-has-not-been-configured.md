...
type: reference
domain: sharepoint
slug: technical-reference-outbound-e-mail-has-not-been-configured
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/outbound-e-mail-has-not-been-configured
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Outbound email hasn't been configured, for SharePoint Server."
---

# Outbound e-mail hasn't been configured (SharePoint Server) - SharePoint Server

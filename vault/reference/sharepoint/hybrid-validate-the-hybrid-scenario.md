...
type: reference
domain: sharepoint
slug: hybrid-validate-the-hybrid-scenario
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/hybrid/validate-the-hybrid-scenario
family: hybrid
documentKind: "how-to"
abstract: "How to validate the Business Connectivity Services (BCS) hybrid solution is working."
---

# Validate the Business Connectivity Services hybrid scenario - SharePoint Server

...
type: reference
domain: sharepoint
slug: hybrid-configure-cloud-hybrid-searchroadmap
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/hybrid/configure-cloud-hybrid-searchroadmap
family: hybrid
documentKind: "how-to"
abstract: "Learn how to configure cloud hybrid search for SharePoint Server by setting up a cloud Search service application in your SharePoint Server environment and connecting it to your search index in Office 365."
---

# Configure cloud hybrid search - roadmap - SharePoint Server

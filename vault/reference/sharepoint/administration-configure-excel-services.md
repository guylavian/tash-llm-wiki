...
type: reference
domain: sharepoint
slug: administration-configure-excel-services
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-excel-services
family: administration
documentKind: "how-to"
abstract: "Deploy Excel Services to your SharePoint Server farm by creating an Excel Services service application by using Central Administration."
---

# Configure Excel Services (SharePoint Server 2013) - SharePoint Server

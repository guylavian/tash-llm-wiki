---
title: "High availability and disaster recovery concepts in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-high-availability-and-disaster-recovery-concepts
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/high-availability-and-disaster-recovery-concepts
family: administration
documentKind: "concept-article"
abstract: "Understand high availability and disaster recovery concepts in SharePoint Server so you can choose the best strategy for your farm."
---

# High availability and disaster recovery concepts in SharePoint Server - SharePoint Server
...
An example of business continuity management is Disaster recovery and protection for data and applications, which provides a snapshot of the business continuity program at Microsoft.

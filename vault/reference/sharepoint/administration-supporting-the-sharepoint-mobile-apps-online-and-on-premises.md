---
title: "Supporting the SharePoint mobile apps online and on-premises - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-supporting-the-sharepoint-mobile-apps-online-and-on-premises
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/supporting-the-sharepoint-mobile-apps-online-and-on-premises
family: administration
documentKind: "article"
abstract: "The SharePoint mobile app makes using your SharePoint sites from a phone and tablet easier than ever. Learn how to troubleshoot common issues when working with the SharePoint mobile app."
---

# Supporting the SharePoint mobile apps online and on-premises - SharePoint Server
...
If your SharePoint users are working on their files and data using mobile devices, they can leverage the SharePoint mobile app for iOS, Android and Windows 10 Mobile.
...
Microsoft Intune (on the Microsoft Trust Center site)

Microsoft 365 (on the Microsoft Trust Center site)

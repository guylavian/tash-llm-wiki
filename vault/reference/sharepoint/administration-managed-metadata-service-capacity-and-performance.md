...
type: reference
domain: sharepoint
slug: administration-managed-metadata-service-capacity-and-performance
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/managed-metadata-service-capacity-and-performance
family: administration
documentKind: "article"
abstract: "Learn how to plan to deploy a Managed Metadata Service application for SharePoint Server 2013 by using tested capacity and performance data."
---

# Estimate capacity and performance for Managed Metadata Service (SharePoint Server 2013) - SharePoint Server

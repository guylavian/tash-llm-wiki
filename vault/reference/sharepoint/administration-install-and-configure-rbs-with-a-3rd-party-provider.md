...
type: reference
domain: sharepoint
slug: administration-install-and-configure-rbs-with-a-3rd-party-provider
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/install-and-configure-rbs-with-a-3rd-party-provider
family: administration
documentKind: "install-set-up-deploy"
abstract: "Learn how to install and configure Remote BLOB Storage (RBS) that uses a third-party RBS Provider for SharePoint Server."
---

# Install and configure RBS with a 3rd party provider for SharePoint Server - SharePoint Server

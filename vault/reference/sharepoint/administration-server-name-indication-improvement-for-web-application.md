...
type: reference
domain: sharepoint
slug: administration-server-name-indication-improvement-for-web-application
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/server-name-indication-improvement-for-web-application
family: administration
documentKind: "article"
abstract: "Learn how to configure Server Name Indication (SNI) in SharePoint Central Administration."
---

# Server Name Indication improvement for web application - SharePoint Server

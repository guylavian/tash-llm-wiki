...
type: reference
domain: sharepoint
slug: upgrade-and-update-install-a-software-update
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/upgrade-and-update/install-a-software-update
family: upgrade-and-update
documentKind: "install-set-up-deploy"
abstract: "Install a software update to perform a build-to-build upgrade on servers in a SharePoint 2016 farm."
---

# Install a software update for SharePoint Server - SharePoint Server

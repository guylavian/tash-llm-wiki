---
title: "Create the SharePoint Server 2019 farm for a database attach upgrade - SharePoint Server"
type: reference
domain: sharepoint
slug: upgrade-and-update-create-the-sharepoint-server-2019-farm-for-a-database-attach-upgrade
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/upgrade-and-update/create-the-sharepoint-server-2019-farm-for-a-database-attach-upgrade
family: upgrade-and-update
documentKind: "upgrade-and-migration-article"
abstract: "Create and configure a SharePoint Server 2019 farm so that you can upgrade databases from SharePoint 2016."
---

# Create the SharePoint Server 2019 farm for a database attach upgrade - SharePoint Server
...
- Create the SharePoint Server 2019 farm for a database attach upgrade (this phase).
...
Make sure that the hardware and software that you are using meets the requirements in Hardware and software requirements for SharePoint Server 2019.
...
You must create the service applications on your new farm before you upgrade your content databases. There are some service applications that can be upgraded from SharePoint Server 2016 to SharePoint Server 2019. The steps in Install SharePoint Server 2019 describe how to use the Farm Configuration Wizard to enable all service applications. However, you should not use the Farm Configuration Wizard to enable the service applications that you want to upgrade.
...
|  |  |
| --- | --- |
|  | This is the first phase in the process to upgrade SharePoint Server 2016 data and sites to SharePoint Server 2019.  
  Next phase: Copy databases to the new farm for upgrade to SharePoint Server 2019 
  For an overview of the whole process, see Overview of the upgrade process to SharePoint Server 2019. |

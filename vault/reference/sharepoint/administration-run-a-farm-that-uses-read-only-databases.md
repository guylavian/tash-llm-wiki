...
type: reference
domain: sharepoint
slug: administration-run-a-farm-that-uses-read-only-databases
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/run-a-farm-that-uses-read-only-databases
family: administration
documentKind: "how-to"
abstract: "Learn how to run a read-only SharePoint Server farm with some or all databases set as read-only."
---

# Run a farm that uses read-only databases in SharePoint Server - SharePoint Server

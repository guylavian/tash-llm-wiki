...
type: reference
domain: sharepoint
slug: administration-sharepoint-server-dev-test-environment-in-azure
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/sharepoint-server-dev-test-environment-in-azure
family: administration
documentKind: "article"
abstract: "Create a single-server SharePoint 2016 dev/test farm in Microsoft Azure infrastructure services."
---

# SharePoint Server dev/test environment in Azure - SharePoint Server

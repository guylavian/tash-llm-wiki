...
type: reference
domain: sharepoint
slug: search-delete-items-from-the-search-index-or-from-search-results
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/delete-items-from-the-search-index-or-from-search-results
family: search
documentKind: "how-to"
abstract: "Learn how to remove an item from the search index or SharePoint Server search results by removing the URL."
---

# Delete items from the search index or from search results in SharePoint Server - SharePoint Server

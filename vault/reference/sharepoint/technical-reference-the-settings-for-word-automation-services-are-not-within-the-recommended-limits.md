...
type: reference
domain: sharepoint
slug: technical-reference-the-settings-for-word-automation-services-are-not-within-the-recommended-limits
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/the-settings-for-word-automation-services-are-not-within-the-recommended-limits
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer ruleThe settings for Word Automation Services are not within the recommended limits, in SharePoint Server."
---

# The settings for Word Automation Services are not within the recommended limits (SharePoint Server) - SharePoint Server

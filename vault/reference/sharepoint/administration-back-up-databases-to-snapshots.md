...
type: reference
domain: sharepoint
slug: administration-back-up-databases-to-snapshots
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/back-up-databases-to-snapshots
family: administration
documentKind: "how-to"
abstract: "Learn how to back up databases to snapshots in SharePoint Server by using SQL Server Enterprise."
---

# Back up databases to snapshots in SharePoint Server - SharePoint Server

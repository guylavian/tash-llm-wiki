...
type: reference
domain: sharepoint
slug: install-installing-sharepoint-subscription-edition-on-one-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/installing-sharepoint-subscription-edition-on-one-server
family: install
documentKind: "article"
abstract: "Learn how to install SharePoint Server Subscription Edition on one server."
---

# Installing SharePoint Server Subscription Edition on one server - SharePoint Server

---
title: "Overview of MinRole Server Roles in SharePoint Servers 2016, 2019, and Subscription Edition - SharePoint Server"
type: reference
domain: sharepoint
slug: install-overview-of-minrole-server-roles-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/install/overview-of-minrole-server-roles-in-sharepoint-server
family: install
documentKind: "concept-article"
abstract: "Learn about the new MinRole farm topology and its benefits in SharePoint Server."
---

# Overview of MinRole Server Roles in SharePoint Servers 2016, 2019, and Subscription Edition - SharePoint Server
...
Microsoft provides various recommended MinRole farm topologies for our customers, including small, medium, and large-sized farms. To review the recommended MinRole farm topologies, see Planning for a MinRole server deployment in SharePoint Servers 2016, 2019, and Subscription Edition.
...
Updated service instance assignments for each server role to ensure your farm is operating at optimal performance. For more information about the new service instance assignments, see Description of MinRole and associated services in SharePoint Servers 2016, 2019, and Subscription Edition.

...
type: reference
domain: sharepoint
slug: technical-reference-the-nonce-cookie-certificate-is-not-imported
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/the-nonce-cookie-certificate-is-not-imported
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn to ensure proper management and notification of the certificate expiration to avoid issues with the Web Application Pool account while enabling OIDC in a web application."
---

# Certificate Management is not managing the nonce cookie certificate (SharePoint Server) - SharePoint Server

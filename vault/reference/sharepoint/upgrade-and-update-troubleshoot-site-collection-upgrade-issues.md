---
title: "Troubleshoot site collection upgrade issues in SharePoint Server 2016 - SharePoint Server"
type: reference
domain: sharepoint
slug: upgrade-and-update-troubleshoot-site-collection-upgrade-issues
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/upgrade-and-update/troubleshoot-site-collection-upgrade-issues
family: upgrade-and-update
documentKind: "troubleshooting"
abstract: "Learn how to address problems that may occur after you upgrade a site to SharePoint Server 2016."
---

# Troubleshoot site collection upgrade issues in SharePoint Server 2016 - SharePoint Server

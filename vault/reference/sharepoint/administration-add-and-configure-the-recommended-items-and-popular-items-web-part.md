...
type: reference
domain: sharepoint
slug: administration-add-and-configure-the-recommended-items-and-popular-items-web-part
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/add-and-configure-the-recommended-items-and-popular-items-web-part
family: administration
documentKind: "how-to"
abstract: "Learn how to add and configure the Recommended Items and Popular Items Web Part in SharePoint Server."
---

# Add and configure the Recommended Items and Popular Items Web Part in SharePoint Server - SharePoint Server

---
title: "Maintain RBS in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-maintain-rbs
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/maintain-rbs
family: administration
documentKind: "how-to"
abstract: "Learn how to perform maintenance tasks that are associated with Remote BLOB Storage (RBS) in SharePoint Server."
---

# Maintain RBS in SharePoint Server - SharePoint Server
...
Verify that you have Write permissions for the folder where you installed RBS.

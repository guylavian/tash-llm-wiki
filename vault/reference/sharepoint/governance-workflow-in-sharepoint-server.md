---
title: "Workflow in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: governance-workflow-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/governance/workflow-in-sharepoint-server
family: governance
documentKind: "article"
abstract: "Workflows in SharePoint allow you to model and automate business processes. These business processes can range from simple to complex. But most importantly, workflow lets users focus on doing the work--rather than managing the workflow."
---

# Workflow in SharePoint Server - SharePoint Server

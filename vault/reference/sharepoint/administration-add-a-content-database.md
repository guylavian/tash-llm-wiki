...
type: reference
domain: sharepoint
slug: administration-add-a-content-database
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/add-a-content-database
family: administration
documentKind: "how-to"
abstract: "Learn how to add a content database to your SharePoint Server farm."
---

# Add content databases in SharePoint Server - SharePoint Server

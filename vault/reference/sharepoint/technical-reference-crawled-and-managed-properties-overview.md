---
title: "Overview of crawled and managed properties in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: technical-reference-crawled-and-managed-properties-overview
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/crawled-and-managed-properties-overview
family: technical-reference
documentKind: "concept-article"
abstract: "Learn about the default managed properties for SharePoint Server, their settings, and the default mapping between crawled and managed properties."
---

# Overview of crawled and managed properties in SharePoint Server - SharePoint Server
...
Learn about managing the search schema for SharePoint Online in Microsoft 365.

Managed properties overview

## Managed properties overview

For a list of default managed properties and their attributes for SharePoint Online see Overview of crawled and managed properties in SharePoint Server.

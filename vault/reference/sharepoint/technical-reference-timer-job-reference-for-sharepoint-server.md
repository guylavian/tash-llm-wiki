---
title: "Timer job reference for SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: technical-reference-timer-job-reference-for-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/timer-job-reference-for-sharepoint-server
family: technical-reference
documentKind: "reference"
abstract: "Learn about the timer jobs in SharePoint Server."
---

# Timer job reference for SharePoint Server - SharePoint Server

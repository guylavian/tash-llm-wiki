...
type: reference
domain: sharepoint
slug: search-configure-properties-of-the-search-navigation-web-part
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/search/configure-properties-of-the-search-navigation-web-part
family: search
documentKind: "how-to"
abstract: "Learn how to configure properties of the Search Navigation Web Part, and how to add a link to a new search vertical page."
---

# Configure properties of the Search Navigation Web Part in SharePoint Server - SharePoint Server

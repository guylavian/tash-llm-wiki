---
title: "Plan for Internet, intranet, and extranet publishing sites in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-plan-for-internet-intranet-and-extranet-publishing-sites
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/plan-for-internet-intranet-and-extranet-publishing-sites
family: administration
documentKind: "article"
abstract: "Learn how to plan SharePoint Server publishing sites, multilingual support, and SharePoint Server cross-site publishing or author-in-place."
---

# Plan for Internet, intranet, and extranet publishing sites in SharePoint Server - SharePoint Server
...
This article builds on the information in Overview of publishing to Internet, intranet, and extranet sites in SharePoint Server.
...
Plan information architecture for Web content management (SharePoint Server 2010) provides general recommendations for planning the information architecture for a Web content management solution.

Plan Web page authoring (SharePoint Server 2010) describes the steps that are involved in planning how Web pages are authored.

Plan content approval and scheduling (SharePoint Server 2010) contains general guidance about how to plan content approval and scheduling for use with SharePoint Server publishing sites.
...
Plan for variations in SharePoint Server provides information about important items that you should consider when you're using variations in publishing sites, and it describes the tasks that are involved in planning a solution that uses variations in SharePoint Server.

Plan navigation term sets in SharePoint Server provides information about how to create the navigation term set to provide site navigation for SharePoint Server publishing sites.

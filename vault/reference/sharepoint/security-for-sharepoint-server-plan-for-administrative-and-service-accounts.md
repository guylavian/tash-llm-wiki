---
title: "Plan for administrative and service accounts in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: security-for-sharepoint-server-plan-for-administrative-and-service-accounts
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/security-for-sharepoint-server/plan-for-administrative-and-service-accounts
family: security-for-sharepoint-server
documentKind: "article"
abstract: "Learn about the accounts to use to manage SharePoint Server deployment scenarios and services."
---

# Plan for administrative and service accounts in SharePoint Server - SharePoint Server
...
This article does not describe the account requirements for using Secure Store service in SharePoint Server. For more information, see Plan the Secure Store Service in SharePoint Server.

Learn About the SharePoint admin role in Microsoft 365.
...
| Farm administrator user account | The farm administrator user account is a uniquely identifiable account assigned to a SharePoint admin. It is used to run:  
  Setup  
...
| Farm service account | The farm service account is used to perform the following tasks:  
  ...
  More permissions are automatically granted for the server farm account on Web servers and application servers that are joined to a server farm.  
...
Modify farm service account will need to restart IIS server by using `iisreset.exe` command. |
...
For a list of account permissions for single-server environments, see Initial deployment administrative and service accounts in SharePoint Server.

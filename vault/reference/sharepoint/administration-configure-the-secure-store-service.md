...
type: reference
domain: sharepoint
slug: administration-configure-the-secure-store-service
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-the-secure-store-service
family: administration
documentKind: "how-to"
abstract: "Configure storage of authorization credentials in Secure Store Service on a SharePoint Server farm."
---

# Configure the Secure Store Service in SharePoint Server - SharePoint Server

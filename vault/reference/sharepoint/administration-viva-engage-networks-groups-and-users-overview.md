...
type: reference
domain: sharepoint
slug: administration-viva-engage-networks-groups-and-users-overview
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/viva-engage-networks-groups-and-users-overview
family: administration
documentKind: "concept-article"
abstract: "Learn about the roles of networks, groups, and users in Viva Engage."
---

# Viva Engage networks, groups, and users overview - SharePoint Server

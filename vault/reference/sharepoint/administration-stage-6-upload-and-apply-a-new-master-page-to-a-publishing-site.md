...
type: reference
domain: sharepoint
slug: administration-stage-6-upload-and-apply-a-new-master-page-to-a-publishing-site
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/stage-6-upload-and-apply-a-new-master-page-to-a-publishing-site
family: administration
documentKind: "how-to"
abstract: "Learn how to upload and apply a new master page to a publishing site in SharePoint Server 2016."
---

# Stage 6 Upload and apply a new master page to a publishing site in SharePoint Server - SharePoint Server

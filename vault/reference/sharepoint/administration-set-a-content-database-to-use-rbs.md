...
type: reference
domain: sharepoint
slug: administration-set-a-content-database-to-use-rbs
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/set-a-content-database-to-use-rbs
family: administration
documentKind: "how-to"
abstract: "Learn how to set a SharePoint Server content database to use Remote BLOB Storage (RBS) with FILESTREAM."
---

# Set a content database to use RBS with FILESTREAM in SharePoint Server - SharePoint Server

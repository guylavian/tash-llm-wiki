---
title: "Overview of RBS in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-rbs-overview
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/rbs-overview
family: administration
documentKind: "concept-article"
abstract: "Learn about how to use Remote BLOB Storage (RBS) in a SharePoint Server farm."
---

# Overview of RBS in SharePoint Server - SharePoint Server
...
Before you implement RBS, we highly recommend that you evaluate its potential costs and benefits. For more information and recommendations about how to use RBS in a SharePoint Server installation, see Deciding to use RBS in SharePoint Server.

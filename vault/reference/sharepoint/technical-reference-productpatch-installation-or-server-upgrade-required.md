...
type: reference
domain: sharepoint
slug: technical-reference-productpatch-installation-or-server-upgrade-required
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/technical-reference/productpatch-installation-or-server-upgrade-required
family: technical-reference
documentKind: "troubleshooting"
abstract: "Learn how to resolve the SharePoint Health Analyzer rule: Product / patch installation or server upgrade required for SharePoint Server."
---

# Product / patch installation or server upgrade required (SharePoint Server) - SharePoint Server

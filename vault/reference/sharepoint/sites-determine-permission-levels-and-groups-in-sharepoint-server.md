---
title: "Determine permission levels and groups in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: sites-determine-permission-levels-and-groups-in-sharepoint-server
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/sites/determine-permission-levels-and-groups-in-sharepoint-server
family: sites
documentKind: "article"
abstract: "Learn how to define the correct SharePoint Server permission levels at the site collection level."
---

# Determine permission levels and groups in SharePoint Server - SharePoint Server
...
Learn about Default SharePoint groups in Microsoft 365.
...
For more information about permissions that are included in the default permission levels, see User permissions and permission levels in SharePoint 2013.

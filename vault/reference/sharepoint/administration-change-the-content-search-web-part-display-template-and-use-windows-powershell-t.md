...
type: reference
domain: sharepoint
slug: administration-change-the-content-search-web-part-display-template-and-use-windows-powershell-t
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/change-the-content-search-web-part-display-template-and-use-windows-powershell-t
family: administration
documentKind: "how-to"
abstract: "Learn how to change the Content Search Web Part display template and use Microsoft PowerShell to start Usage analytics in SharePoint Server."
---

# Change the Content Search Web Part display template and use Windows PowerShell to start Usage analytics in SharePoint Server - SharePoint Server

---
title: "Configure site mailboxes in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-configure-site-mailboxes-in-sharepoint
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/configure-site-mailboxes-in-sharepoint
family: administration
documentKind: "how-to"
abstract: "Configure Exchange Server, SharePoint Server for team email by using the Site Mailboxes feature."
---

# Configure site mailboxes in SharePoint Server - SharePoint Server
...
Site Mailboxes feature requires that user profile synchronization is configured in the farm. For information about configuring user profile synchronization, see User profiles and identities, and Manage user profile synchronization in SharePoint Server.
...
Download EWSManagedAPI.msi from the Microsoft Download Center and save it to a folder on each web and application server.
...
On your instance of Exchange Server open the Exchange Management PowerShell window as Administrator and change to the "C:\Program Files\Microsoft\Exchange Server\V15\Scripts" directory.
...
| 5 | ServerBusy | Exchange timed out during AutoDiscovery. It should be intermittent, please retry, but if it's persistent, follow up with the Exchange Administrator. |

---
title: "Back up customizations in SharePoint Server - SharePoint Server"
type: reference
domain: sharepoint
slug: administration-back-up-customizations
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/back-up-customizations
family: administration
documentKind: "how-to"
abstract: "Learn how to back up customizations that are made to SharePoint Server sites."
---

# Back up customizations in SharePoint Server - SharePoint Server
...
At the PowerShell command prompt, type the following command to back up all of the solutions in the farm. To back up a single solution, add the name of the solution to the item path "farm\solutions".
...
| --- | --- |
| %PROGRAMFILES%\Common files\Microsoft Shared\Web Server Extensions\16 | Commonly updated files, custom assemblies, custom templates, custom site definitions |

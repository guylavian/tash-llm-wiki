...
type: reference
domain: sharepoint
slug: administration-remove-a-server-from-a-farm-in-sharepoint-2013
tier: reference
source: https://learn.microsoft.com/en-us/sharepoint/administration/remove-a-server-from-a-farm-in-sharepoint-2013
family: administration
documentKind: "how-to"
abstract: "Learn how to remove a web server, application server, or database server from a SharePoint 2013 farm."
---

# Remove a server from a farm in SharePoint 2013 - SharePoint Server

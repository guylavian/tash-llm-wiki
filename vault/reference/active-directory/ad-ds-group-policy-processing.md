...
slug: ad-ds-group-policy-processing
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/group-policy/group-policy-processing
family: ad-ds
documentKind: "concept-article"
abstract: "Learn about how Group Policy processing works in Active Directory Domain Services on Windows Server and Windows client computers."
---

...
slug: ad-ds-group-policy-management-console
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/group-policy/group-policy-management-console
family: ad-ds
documentKind: "how-to"
abstract: "Learn how to create, edit, link, and manage Group Policy Objects using the Group Policy Management Console."
---

# Group Policy Management Console in Windows

...
slug: ad-cs-network-device-enrollment-service-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/network-device-enrollment-service-overview
family: ad-cs
documentKind: "overview"
abstract: "Learn about the role of Network Device Enrollment Service and how it works with certificates based on Simple Certificate Enrollment Protocol"
---

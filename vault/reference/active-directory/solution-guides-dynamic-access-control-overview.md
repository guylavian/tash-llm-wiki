...
slug: solution-guides-dynamic-access-control-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/solution-guides/Dynamic-Access-Control-Overview
family: solution-guides
documentKind: "concept-article"
abstract: "Learn more about: Dynamic Access Control Overview"
---

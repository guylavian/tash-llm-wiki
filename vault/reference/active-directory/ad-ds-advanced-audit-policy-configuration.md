...
slug: ad-ds-advanced-audit-policy-configuration
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/plan/security-best-practices/advanced-audit-policy-configuration
family: ad-ds
documentKind: "concept-article"
abstract: "The Advanced Audit Policy Configuration settings in Group Policy allows admins to specify which security events are audited on Windows systems for tracking activities, security monitoring, and incident detection."
---

...
slug: laps-laps-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/laps/laps-overview
family: laps
documentKind: "overview"
abstract: "Get an overview of Windows Local Administrator Password Solution (Windows LAPS), including key scenarios and setup and management options."
---
...
> [!NOTE]
> The [Automatic Account Management](/windows/client-management/mdm/laps-csp#automaticaccountmanagementenabled) CSP settings require Windows 11 24H2 or later.

...
slug: laps-laps-management-user-interface
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/laps/laps-management-user-interface
family: laps
documentKind: "how-to"
abstract: "Learn how to use the LAPS properties dialog to configure Windows Local Administrator Password Solution (Windows LAPS) for Windows Server Active Directory."
---

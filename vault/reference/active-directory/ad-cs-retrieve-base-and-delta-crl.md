...
slug: ad-cs-retrieve-base-and-delta-crl
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/retrieve-base-and-delta-crl
family: ad-cs
documentKind: "how-to"
abstract: "Learn how to retrieve the current base and delta certificate revocation lists (CRLs) using Certification Authority Web Enrollment role service in Windows Server"
---

# Retrieve base & delta CRLs using Web Enrollment in AD CS

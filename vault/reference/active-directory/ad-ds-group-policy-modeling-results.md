...
slug: ad-ds-group-policy-modeling-results
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/group-policy/group-policy-modeling-results
family: ad-ds
documentKind: "how-to"
abstract: "Learn how to model group policy results and evaluate group policy settings using the Group Policy Management Console in Windows Server."
---

# Group Policy Modeling and Results in Windows

...
slug: laps-laps-scenarios-migration
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/laps/laps-scenarios-migration
family: laps
documentKind: "how-to"
abstract: "Prepare to deploy and migrate Windows Local Administrator Password Solution (Windows LAPS) with recommended scenarios. Start your migration today."
---

# Prepare for Windows Local Administrator Password Solution (LAPS) Deployment and Migration

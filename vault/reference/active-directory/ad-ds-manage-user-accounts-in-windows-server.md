...
slug: ad-ds-manage-user-accounts-in-windows-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage-user-accounts-in-windows-server
family: ad-ds
documentKind: "how-to"
abstract: "Create, delete, and manage user accounts in Active Directory Users and Computers. Learn how to manage user account properties, group memberships, and passwords."
---

# Manage User Accounts with Active Directory Users and Computers in Windows Server

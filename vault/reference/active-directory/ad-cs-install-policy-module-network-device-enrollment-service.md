...
slug: ad-cs-install-policy-module-network-device-enrollment-service
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/install-policy-module-network-device-enrollment-service
family: ad-cs
documentKind: "how-to"
abstract: "Learn how to install, configure, and uninstall a policy module with the Network Device Enrollment Service."
---

# Install a policy module with the Network Device Enrollment Service in Windows Server

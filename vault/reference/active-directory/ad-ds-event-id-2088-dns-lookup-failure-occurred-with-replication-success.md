...
slug: ad-ds-event-id-2088-dns-lookup-failure-occurred-with-replication-success
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/component-updates/Event-ID-2088--DNS-lookup-failure-occurred-with-replication-success
family: ad-ds
documentKind: "troubleshooting-error-codes"
abstract: "Learn more about: Event ID 2088: DNS lookup failure occurred with replication success"
---

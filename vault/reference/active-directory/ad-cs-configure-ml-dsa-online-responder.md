...
slug: ad-cs-configure-ml-dsa-online-responder
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/configure-ml-dsa-online-responder
family: ad-cs
documentKind: "how-to"
abstract: "Learn how to configure ML-DSA post-quantum OCSP response signing in Active Directory Certificate Services (AD CS) for certificate revocation checking."
---

# Configure Online Responders (OCSP) to use ML-DSA in Windows Server

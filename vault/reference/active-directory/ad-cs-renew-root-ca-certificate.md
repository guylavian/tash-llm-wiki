...
slug: ad-cs-renew-root-ca-certificate
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/renew-root-ca-certificate
family: ad-cs
documentKind: "how-to"
abstract: "This article describes how to renew a root CA certificate with existing key pair, and renew a CA certificate with new key pair."
---

# Renew root CA certificate in Windows Server

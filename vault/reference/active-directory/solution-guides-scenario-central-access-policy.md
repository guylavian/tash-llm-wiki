...
slug: solution-guides-scenario-central-access-policy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/solution-guides/Scenario--Central-Access-Policy
family: solution-guides
documentKind: "example-scenario"
abstract: "Learn more about: Scenario: Central Access Policy"
---

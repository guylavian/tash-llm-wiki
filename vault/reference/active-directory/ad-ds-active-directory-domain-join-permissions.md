...
slug: ad-ds-active-directory-domain-join-permissions
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/active-directory-domain-join-permissions
family: ad-ds
documentKind: "concept-article"
abstract: "This article describes the permissions required in Active Directory to successfully join computers to a Windows Server domain using a new computer account or an existing account."
---

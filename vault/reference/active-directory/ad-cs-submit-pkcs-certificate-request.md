...
slug: ad-cs-submit-pkcs-certificate-request
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/submit-pkcs-certificate-request
family: ad-cs
documentKind: "how-to"
abstract: "Learn how to submit a certificate in CA Web Enrollment role service by using a PKCS #10 file or a PKCS #7 file in Windows Server"
---

# Submit certificate requests to AD CS using a PKCS #10 or PKCS #7 file in Windows Server

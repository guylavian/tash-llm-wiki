...
slug: ad-ds-group-policy-backup-restore
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/group-policy/group-policy-backup-restore
family: ad-ds
documentKind: "how-to"
abstract: "Learn how to back up, restore, migrate, and copy Group Policy Objects by using the Group Policy Management Console in Windows."
---

# Back Up and Restore Group Policy in Windows

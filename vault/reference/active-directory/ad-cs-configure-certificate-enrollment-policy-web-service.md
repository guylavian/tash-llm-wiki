...
slug: ad-cs-configure-certificate-enrollment-policy-web-service
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/configure-certificate-enrollment-policy-web-service
family: ad-cs
documentKind: "how-to"
abstract: "Learn how to configure the Certificate Enrollment Policy Web Service so that users and computers can get certificate enrollment policy information."
---

# Configure the Certificate Enrollment Policy Web Service in Windows Server

...
slug: ad-ds-domain-wide-updates
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/deploy/Domain-Wide-Updates
family: ad-ds
documentKind: "concept-article"
abstract: "Domain-wide schema updates performed by adprep /domainprep when promoting a Domain Controller"
---

# Active Directory domain-wide schema updates

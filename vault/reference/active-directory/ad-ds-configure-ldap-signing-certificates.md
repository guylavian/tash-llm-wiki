...
slug: ad-ds-configure-ldap-signing-certificates
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/configure-ldap-signing-certificates
family: ad-ds
documentKind: "how-to"
abstract: "Learn how to create and install SSL/TLS certificates for LDAP over SSL (LDAPS) on domain controllers using Microsoft or third-party certification authorities."
---

...
slug: laps-laps-management-policy-settings
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/laps/laps-management-policy-settings
family: laps
documentKind: "concept-article"
abstract: "Learn how to configure policy settings for Windows Local Administrator Password Solution (Windows LAPS) to enhance security and automate local administrator password management."
---

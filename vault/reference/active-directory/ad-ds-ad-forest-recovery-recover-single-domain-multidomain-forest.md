...
slug: ad-ds-ad-forest-recovery-recover-single-domain-multidomain-forest
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/forest-recovery-guide/ad-forest-recovery-recover-single-domain-multidomain-forest
family: ad-ds
documentKind: "how-to"
abstract: "In certain scenarios, it may be necessary to recover only a single domain within a forest that has multiple domains, rather than a full forest recovery. This topic covers considerations for recovering a single domain and possible strategies for recovery."
---

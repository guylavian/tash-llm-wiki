...
slug: laps-laps-management-powershell
tier: reference
...
abstract: "Explore Windows LAPS PowerShell cmdlets to manage passwords securely. Learn key features, benefits, and usage."
---

# Windows LAPS PowerShell Cmdlets Overview

...
slug: ad-cs-create-domain-user-account-ndes-service-account
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/create-domain-user-account-ndes-service-account
family: ad-cs
documentKind: "how-to"
abstract: "Learn how to configure a service account for the Network Device Enrollment Service (NDES) as a role service with certificates based on Simple Certificate Enrollment Protocol (SCEP)"
---

# Configure Network Device Enrollment Service to use a domain user account for Active Directory Certificate Services

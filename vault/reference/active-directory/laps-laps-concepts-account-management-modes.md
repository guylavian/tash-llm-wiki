...
slug: laps-laps-concepts-account-management-modes
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/laps/laps-concepts-account-management-modes
family: laps
documentKind: "concept-article"
abstract: "Documents account management modes for Windows Local Administrator Password Solution (Windows LAPS)."
---

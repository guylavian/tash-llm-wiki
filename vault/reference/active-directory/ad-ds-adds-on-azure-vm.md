...
slug: ad-ds-adds-on-azure-vm
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/deploy/virtual-dc/adds-on-azure-vm
family: ad-ds
documentKind: "install-set-up-deploy"
abstract: "How to create a new Active Directory forest on a virtual machine (VM) on an Azure virtual machine."
---

# Install Active Directory Domain Services on an Azure virtual machine

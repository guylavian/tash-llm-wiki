...
slug: ad-ds-upgrade-domain-controllers
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/deploy/upgrade-domain-controllers
family: ad-ds
documentKind: "upgrade-and-migration-article"
abstract: "This article describes how to upgrade from an earlier version of Windows Server to a later version."
---

...
slug: ad-ds-raise-domain-forest-functional-levels
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/plan/raise-domain-forest-functional-levels
family: ad-ds
documentKind: "how-to"
abstract: "Learn how to raise domain and forest functional levels in Active Directory Domain Services on Windows Server."
---

# Raise Domain and Forest Functional Levels in AD DS on Windows Server

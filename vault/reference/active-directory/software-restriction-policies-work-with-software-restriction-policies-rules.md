...
slug: software-restriction-policies-work-with-software-restriction-policies-rules
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/software-restriction-policies/work-with-software-restriction-policies-rules
family: software-restriction-policies
documentKind: "how-to"
abstract: "Learn about procedures working with certificate, path, internet zone and hash rules using Software Restriction Policies."
---

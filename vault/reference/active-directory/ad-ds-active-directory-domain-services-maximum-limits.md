...
slug: ad-ds-active-directory-domain-services-maximum-limits
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/plan/active-directory-domain-services-maximum-limits
family: ad-ds
documentKind: "concept-article"
abstract: "Recommended limits for creating objects, entries, names, and more in your Active Directory deployment to ensure optimal performance."
---

...
slug: ad-ds-ldap-signing
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/ldap-signing
family: ad-ds
documentKind: "concept-article"
abstract: "Understand the role of LDAP signing and channel binding in verifying data integrity and preventing session hijacking in Active Directory."
---

...
slug: solution-guides-deploy-security-auditing-with-central-audit-policies-demonstration-steps
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/solution-guides/Deploy-Security-Auditing-with-Central-Audit-Policies--Demonstration-Steps-
family: solution-guides
documentKind: "how-to"
abstract: "Learn more about: Deploy Security Auditing with Central Audit Policies (Demonstration Steps)"
---

...
slug: ad-cs-configure-ml-dsa-certificate-templates
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/configure-ml-dsa-certificate-templates
family: ad-cs
documentKind: "how-to"
abstract: "Learn how to configure AD CS certificate templates to use ML-DSA post-quantum cryptography for code signing, TLS, and client authentication."
---

# Configure certificate templates for ML-DSA in Windows Server

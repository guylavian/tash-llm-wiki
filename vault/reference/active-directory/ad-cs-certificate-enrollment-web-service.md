...
slug: ad-cs-certificate-enrollment-web-service
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/certificate-enrollment-web-service
family: ad-cs
documentKind: "concept-article"
abstract: "Learn about the Certificate Enrollment Web Service, including authentication types, load balancing, and configuration options."
---

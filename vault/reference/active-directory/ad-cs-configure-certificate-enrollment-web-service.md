...
slug: ad-cs-configure-certificate-enrollment-web-service
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-cs/configure-certificate-enrollment-web-service
family: ad-cs
documentKind: "how-to"
abstract: "Learn how to configure the Certificate Enrollment Web Service role service to enable secure certificate enrollment over HTTPS."
---

# Configure the Certificate Enrollment Web Service role service

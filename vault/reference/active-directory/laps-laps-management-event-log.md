...
slug: laps-laps-management-event-log
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/laps/laps-management-event-log
family: laps
documentKind: "concept-article"
abstract: "Learn about key events in Windows Local Administrator Password Solution (Windows LAPS) and how to view the logs."
---

...
slug: networking-10-bc-client-by-scp
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/bc-hcm/10-Bc-Client-By-Scp
family: networking
documentKind: "how-to"
abstract: "Learn how to use Group Policy to enable and configure BranchCache hosted cache mode on domain-joined computers that are running the following BranchCache-capable Windows operating systems."
---

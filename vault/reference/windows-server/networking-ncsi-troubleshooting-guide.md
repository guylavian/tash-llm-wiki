...
slug: networking-ncsi-troubleshooting-guide
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/ncsi/ncsi-troubleshooting-guide
family: networking
documentKind: "troubleshooting-general"
abstract: "This guide demonstrates how to perform diagnostics using the Network Connectivity Status Indicator (NCSI) to troubleshoot and determine Internet connectivity."
---

# Network Connectivity Status Indicator troubleshooting guide for Windows

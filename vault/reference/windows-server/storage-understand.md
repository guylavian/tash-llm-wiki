...
| <a id="usage-type-backup"></a>Backup | Virtualized backup applications, such as [Microsoft Data Protection Manager (DPM)](/previous-versions/system-center/system-center-2012-R2/hh758173(v=sc.12)) | <ul><li>Priority optimization</li><li>Default optimization policy:<ul><li>Minimum file age = 0 days</li><li>Optimize in-use files = Yes</li><li>Optimize partial files = No</li></ul></li><li>"Under-the-hood" tweaks for interop with DPM/DPM-like solutions</li></ul> |

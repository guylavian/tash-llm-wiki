...
slug: administration-secedit-configure
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/secedit-configure
family: administration
documentKind: "reference"
abstract: "Reference article for the secedit configure command, which allows you to configure the current system settings using security settings stored in a database."
---

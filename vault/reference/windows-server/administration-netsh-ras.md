...
slug: administration-netsh-ras
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netsh-ras
family: administration
documentKind: "reference"
abstract: "The netsh ras command manages Remote Access Service (RAS) settings to configure, monitor, and troubleshoot remote access features in Windows."
---

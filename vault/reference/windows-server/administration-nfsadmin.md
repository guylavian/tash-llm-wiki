...
slug: administration-nfsadmin
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/nfsadmin
family: administration
documentKind: "reference"
abstract: "Reference article for the nfsadmin command, which manages both Server for NFS and Client for NFS."
---

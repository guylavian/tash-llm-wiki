...
slug: remote-rds-supported-config
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/rds-supported-config
family: remote
documentKind: "concept-article"
abstract: "Provides information about supported configurations for Remote Desktop Services (RDS) in Windows Server."
---

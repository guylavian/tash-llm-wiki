...
slug: storage-configure-smb-client-require-encryption
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/file-server/configure-smb-client-require-encryption
family: storage
documentKind: "how-to"
abstract: "Learn how to configure SMB encryption mandate in Windows and Windows Server using Group Policy and PowerShell."
---

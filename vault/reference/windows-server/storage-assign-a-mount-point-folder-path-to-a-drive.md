...
slug: storage-assign-a-mount-point-folder-path-to-a-drive
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/disk-management/assign-a-mount-point-folder-path-to-a-drive
family: storage
documentKind: "how-to"
abstract: "Mount point folder path lets you use a drive as a folder. Follow these steps to set up or remove a mounted drive in Windows."
---

# Assign a mount point folder path to a drive in Windows and Windows Server

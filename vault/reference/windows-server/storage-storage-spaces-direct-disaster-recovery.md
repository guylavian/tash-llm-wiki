...
slug: storage-storage-spaces-direct-disaster-recovery
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/Storage-Spaces-Direct-Disaster-Recovery
family: storage
documentKind: "example-scenario"
abstract: "This article describes the scenarios available today for disaster recovery of Storage Spaces Direct"
---

# Disaster Recovery Scenarios for Storage Spaces Direct in Windows Server

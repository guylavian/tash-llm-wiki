...
slug: administration-windows-server-backup-command-reference
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/windows-server-backup-command-reference
family: administration
documentKind: "reference"
abstract: "Reference article for backup command reference."
---

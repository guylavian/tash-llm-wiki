...
slug: administration-nslookup
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/nslookup
family: administration
documentKind: "reference"
abstract: "Reference article for the nslookup command, which displays information that you can use to diagnose Domain Name System (DNS) infrastructure."
---

...
slug: networking-reverse-lookup
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/reverse-lookup
family: networking
documentKind: "concept-article"
abstract: "Learn about DNS reverse lookups in Windows Server and how reverse lookup works with the in-addr.arpa domain."
---

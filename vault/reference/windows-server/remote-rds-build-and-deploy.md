...
slug: remote-rds-build-and-deploy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/rds-build-and-deploy
family: remote
documentKind: "install-set-up-deploy"
abstract: "Steps to build a Remote Desktop deployment"
---

# RDS - Build and deploy

...
slug: administration-bootcfg-raw
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/bootcfg-raw
family: administration
documentKind: "reference"
abstract: "Reference article for the bootcfg raw command, which adds operating system load options, specified as a string, to an operating system entry in the operating system section of the Boot.ini file."
---

...
slug: virtualization-host-hardware-requirements
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/host-hardware-requirements
family: virtualization
documentKind: "concept-article"
abstract: "Learn about the hardware and firmware requirements for Hyper-V in Windows and Windows Server."
---

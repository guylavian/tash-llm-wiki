...
slug: get-started-extended-security-updates-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/extended-security-updates-overview
family: get-started
documentKind: "concept-article"
abstract: "Extended Security Updates for Windows Server help you stay protected after end of support. Learn how to upgrade or migrate to Azure for continued security."
---

# Overview of Extended Security Updates for Windows Server 2012, and 2012 R2

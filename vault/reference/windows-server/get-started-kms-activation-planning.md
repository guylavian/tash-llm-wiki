...
slug: get-started-kms-activation-planning
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/kms-activation-planning
family: get-started
documentKind: "concept-article"
abstract: "Learn how to plan for Key Management Services (KMS) activation in Windows Server."
---

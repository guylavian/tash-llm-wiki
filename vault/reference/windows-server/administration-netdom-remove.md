...
slug: administration-netdom-remove
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netdom-remove
family: administration
documentKind: "reference"
abstract: "Netdom remove is a command-line utility that removes a workstation or server from a domain in Windows Server."
---

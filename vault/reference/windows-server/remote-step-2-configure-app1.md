...
slug: remote-step-2-configure-app1
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/tlg-otp-securid/STEP-2-Configure-APP1
family: remote
documentKind: "how-to"
abstract: "Learn how to create and deploy a certificate template used to sign OTP certificate requests and one used for OTP certificates issued by the corporate CA."
---

...
slug: storage-shrink-a-basic-volume
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/disk-management/shrink-a-basic-volume
family: storage
documentKind: "how-to"
abstract: "See how to decrease the space used by primary partitions and logical drives by shrinking them into adjacent, contiguous space on the same disk."
---

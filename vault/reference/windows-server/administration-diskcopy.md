...
slug: administration-diskcopy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/diskcopy
family: administration
documentKind: "reference"
abstract: "Reference article for the diskcopy command, which copies the contents of the floppy disk in the source drive to a formatted or unformatted floppy disk in the destination drive."
---

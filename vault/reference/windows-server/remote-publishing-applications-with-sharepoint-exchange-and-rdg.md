...
slug: remote-publishing-applications-with-sharepoint-exchange-and-rdg
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/web-application-proxy/Publishing-Applications-with-SharePoint,-Exchange-and-RDG
family: remote
documentKind: "how-to"
abstract: "Learn more about: Publishing Applications with SharePoint, Exchange and RDG"
---
...
> [!NOTE]
> This information is provided as-is.  Remote Desktop Services supports and recommends using [Azure App Proxy to provide secure remote access to on-premises applications](/entra/identity/app-proxy/application-proxy-add-on-premises-application).

...
slug: virtualization-supported-ubuntu-virtual-machines-on-hyper-v
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/Supported-Ubuntu-virtual-machines-on-Hyper-V
family: virtualization
documentKind: "concept-article"
abstract: "Lists the Ubuntu/Linux integration services and features included in each version of Windows Server."
---

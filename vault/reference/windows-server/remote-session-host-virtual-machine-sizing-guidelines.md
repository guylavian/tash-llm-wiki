...
slug: remote-session-host-virtual-machine-sizing-guidelines
tier: reference
...
abstract: "Learn about sizing for session host virtual machines based on different workload types when used with Azure Virtual Desktop or Remote Desktop Services."
---

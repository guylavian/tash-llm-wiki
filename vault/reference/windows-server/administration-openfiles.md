...
slug: administration-openfiles
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/openfiles
family: administration
documentKind: "reference"
abstract: "Reference article for the openfiles command, which enables an administrator to query, display, or disconnect files and directories that have been opened on a system."
---

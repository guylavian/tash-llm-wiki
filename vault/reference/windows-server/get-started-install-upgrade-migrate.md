...
slug: get-started-install-upgrade-migrate
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/install-upgrade-migrate
family: get-started
documentKind: "concept-article"
abstract: "Explore Windows Server upgrade options including in-place upgrade, clean install, migration, and cluster rolling upgrade. Find supported upgrade paths."
---

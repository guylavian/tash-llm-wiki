...
slug: get-started-activation-troubleshoot-kms-general
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/activation-troubleshoot-kms-general
family: get-started
documentKind: "troubleshooting"
abstract: "This guide provides information about the KMS service, and suggests tools and approaches for troubleshooting activation issues in Windows Server."
---

# Guidelines for troubleshooting KMS

...
slug: administration-bcdedit
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/bcdedit
family: administration
documentKind: "reference"
abstract: "Reference article for the bcdedit command, which creates new stores, modify existing stores, and add boot menu parameters."
---

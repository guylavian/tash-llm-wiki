...
slug: storage-preseed-dfsr-with-robocopy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/dfs-replication/preseed-dfsr-with-robocopy
family: storage
documentKind: "how-to"
abstract: "How to use Robocopy.exe to pre-seed files for DFS Replication."
---

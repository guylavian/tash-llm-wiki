...
slug: storage-folder-redirection-rup-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/folder-redirection/folder-redirection-rup-overview
family: storage
documentKind: "concept-article"
abstract: "Discover how Folder Redirection and Roaming User Profiles centralize user data and synchronize profiles across devices."
---

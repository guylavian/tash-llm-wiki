...
slug: administration-secedit-export
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/secedit-export
family: administration
documentKind: "reference"
abstract: "Reference article for the secedit export, which exports security settings stored in a database configured with security templates."
---

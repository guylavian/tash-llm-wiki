...
slug: storage-set-target-priority-to-override-referral-ordering
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/dfs-namespaces/set-target-priority-to-override-referral-ordering
family: storage
documentKind: "how-to"
abstract: "This article describes how to set the target priority to override referral ordering"
---

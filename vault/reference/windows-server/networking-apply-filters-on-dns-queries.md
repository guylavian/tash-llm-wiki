...
slug: networking-apply-filters-on-dns-queries
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/deploy/apply-filters-on-dns-queries
family: networking
documentKind: "how-to"
abstract: "Learn how to configure DNS policy in Windows Server 2016 to create query filters that are based on criteria that you supply."
---

...
slug: security-guarded-fabric-sample-unattend-xml-file
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-sample-unattend-xml-file
family: security
documentKind: "how-to"
abstract: "Learn more about: Create OS specialization answer file"
---

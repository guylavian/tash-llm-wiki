...
slug: administration-netsh-mbn
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netsh-mbn
family: administration
documentKind: "reference"
abstract: "The netsh mbn command manages Mobile Broadband (MBN) interfaces, cellular modems, and SIM-based network connections in Windows."
---

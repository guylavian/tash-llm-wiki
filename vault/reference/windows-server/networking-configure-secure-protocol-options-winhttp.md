...
slug: networking-configure-secure-protocol-options-winhttp
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/configure-secure-protocol-options-winhttp
family: networking
documentKind: "how-to"
abstract: "This article provides information about how to configure secure protocol options for Windows HTTP Services (WinHTTP)."
---

...
slug: storage-persistent-memory-health
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/persistent-memory-health
family: storage
documentKind: "how-to"
abstract: "This article provides information about error handling and health management specific to persistent memory (PMem) devices in Windows Server."
---

# Persistent memory health management for Storage Spaces Direct in Windows Server

...
slug: remote-upgrade-to-rds
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/upgrade-to-rds
family: remote
documentKind: "upgrade-and-migration-article"
abstract: "Learn about which Remote Desktop Services versions can be upgraded and the order to upgrade your Remote Desktop role services."
---

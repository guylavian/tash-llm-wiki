...
slug: manage-vm-conversion-extension-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/use/vm-conversion-extension-overview
family: manage
documentKind: "overview"
abstract: "Discover the VM Conversion extension for Windows Admin Center. Migrate VMware VMs to Hyper-V with ease, ensuring minimal downtime and seamless transitions."
---

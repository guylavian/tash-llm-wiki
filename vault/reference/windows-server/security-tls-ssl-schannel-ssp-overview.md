...
slug: security-tls-ssl-schannel-ssp-overview
tier: reference
...
abstract: "Learn about the TLS and SSL implementations in Windows using the Schannel Security Service Provider (SSP)."
---

...
slug: networking-update-backup-restore
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/manage/Update-Backup-Restore
family: networking
documentKind: "upgrade-and-migration-article"
abstract: "In this topic, you learn how to update, backup and restore an SDN infrastructure."
---

...
slug: administration-cscript
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/cscript
family: administration
documentKind: "reference"
abstract: "Reference article for the cscript command, which starts a script so that it runs in a command-line environment."
---

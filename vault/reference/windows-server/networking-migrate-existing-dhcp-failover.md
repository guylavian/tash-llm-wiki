...
slug: networking-migrate-existing-dhcp-failover
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/dhcp/migrate-existing-dhcp-failover
family: networking
documentKind: "how-to"
abstract: "This article serves as a guide for how to migrate a Dynamic Host Configuration Protocol (DHCP) failover relationship in Windows Server."
---

# Migrate existing DHCP failover deployment on Windows Server

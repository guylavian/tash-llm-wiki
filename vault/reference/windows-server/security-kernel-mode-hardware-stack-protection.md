...
slug: security-kernel-mode-hardware-stack-protection
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/kernel-mode-hardware-stack-protection
family: security
documentKind: "how-to"
abstract: "Learn how to enable stack protection, in order to prevent stacks from return-oriented programming-based attacks (ROP)."
---

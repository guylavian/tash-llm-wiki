...
slug: storage-checklist-tune-a-dfs-namespace
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/dfs-namespaces/checklist-tune-a-dfs-namespace
family: storage
documentKind: "checklist"
abstract: "This article describes how to optimize how the DFS Namespace handles referrals and polls AD DS for updated namespace data"
---

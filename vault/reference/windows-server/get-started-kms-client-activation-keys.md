...
slug: get-started-kms-client-activation-keys
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/kms-client-activation-keys
family: get-started
documentKind: "concept-article"
abstract: "Find the Generic Volume License Keys (GVLKs) required to activate Windows and Windows Server editions using a Key Management Services (KMS) host."
---

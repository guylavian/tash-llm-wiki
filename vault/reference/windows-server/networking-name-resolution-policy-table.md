...
slug: networking-name-resolution-policy-table
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/name-resolution-policy-table
family: networking
documentKind: "how-to"
abstract: "Configure the Name Resolution Policy Table (NRPT) in Windows Server and Windows client for DNSSEC deployment. Learn to enforce DNS security policies using Group Policy or PowerShell commands."
---

# Configure DNSSEC rules using the Name Resolution Policy Table in Windows

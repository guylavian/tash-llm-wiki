...
slug: administration-shutdown
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/shutdown
family: administration
documentKind: "reference"
abstract: "Reference article for the shutdown command, which enables you to shut down or restart local or remote computers, one at a time."
---

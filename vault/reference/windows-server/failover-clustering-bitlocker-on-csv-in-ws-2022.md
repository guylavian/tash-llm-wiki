...
slug: failover-clustering-bitlocker-on-csv-in-ws-2022
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/bitlocker-on-csv-in-ws-2022
family: failover-clustering
documentKind: "how-to"
abstract: "BitLocker on volumes within a cluster are managed based on how the cluster service \"views\" the volume to be protected. The volume can be a physical disk resource such as a logical unit number (LUN) on a storage area network (SAN) or network attached storage (NAS)."
---

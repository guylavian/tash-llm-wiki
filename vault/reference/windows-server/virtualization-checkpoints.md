...
slug: virtualization-checkpoints
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/checkpoints
family: virtualization
documentKind: "how-to"
abstract: "Using checkpoints"
---
...
1. Select the desired checkpoint type.
    ...
    ![Screenshot of the options for Checkpoints in the Management section of the Hyper V Manager.](./media/checkpoints/checkpoint-settings.png)

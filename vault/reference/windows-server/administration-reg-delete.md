...
slug: administration-reg-delete
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/reg-delete
family: administration
documentKind: "reference"
abstract: "Reference article for the reg delete command, which deletes a key, subkey, or entries from the registry."
---

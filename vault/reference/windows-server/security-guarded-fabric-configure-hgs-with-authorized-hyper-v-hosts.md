...
slug: security-guarded-fabric-configure-hgs-with-authorized-hyper-v-hosts
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-configure-hgs-with-authorized-hyper-v-hosts
family: security
documentKind: "install-set-up-deploy"
abstract: "Learn more about: Deploy guarded hosts"
---

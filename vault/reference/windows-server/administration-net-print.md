...
slug: administration-net-print
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/net-print
family: administration
documentKind: "reference"
abstract: "Reference article for the net print command. This command has been deprecated and isn't guaranteed to be supported in future releases of Windows."
---

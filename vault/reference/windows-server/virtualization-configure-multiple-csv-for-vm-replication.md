...
slug: virtualization-configure-multiple-csv-for-vm-replication
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/manage/configure-multiple-csv-for-vm-replication
family: virtualization
documentKind: "how-to"
abstract: "Configure multiple CSV for VM replication using Hyper-V Replica to increase scalability and fault tolerance in Windows Server."
---

# Configure multiple CSV for VM replication in Windows Server

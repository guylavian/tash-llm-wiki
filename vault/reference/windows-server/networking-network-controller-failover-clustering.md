...
slug: networking-network-controller-failover-clustering
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/technologies/network-controller/network-controller-failover-clustering
family: networking
documentKind: "concept-article"
abstract: "Learn about Network Controller high availability using Failover Clustering for Software Defined Networking (SDN) in Windows Server and Azure Local."
---

# Network Controller with Failover Clustering on Windows Server and Azure Local

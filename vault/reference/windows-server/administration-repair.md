...
slug: administration-repair
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/repair
family: administration
documentKind: "reference"
abstract: "Reference article for the repair command, which repairs RAID-5 volumes by replacing the failed disk region with a specified dynamic disk."
---

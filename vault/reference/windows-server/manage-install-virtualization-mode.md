...
slug: manage-install-virtualization-mode
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/install-virtualization-mode
family: manage
documentKind: "install-set-up-deploy"
abstract: "Discover how to set up Windows Admin Center Virtualization Mode for managing virtualization environments efficiently."
---

# Install Windows Admin Center Virtualization Mode (preview)

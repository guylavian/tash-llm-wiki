...
slug: security-guarded-fabric-create-a-shielded-vm-using-powershell
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-create-a-shielded-vm-using-powershell
family: security
documentKind: "how-to"
abstract: "Learn more about: Create a shielded VM using PowerShell"
---

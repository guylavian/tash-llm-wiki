...
slug: virtualization-configure-virtual-local-area-networks-for-hyper-v
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/deploy/configure-virtual-local-area-networks-for-hyper-v
family: virtualization
documentKind: "how-to"
abstract: "Learn how to configure a virtual local area network (VLAN) for use by virtual machines on a Hyper-V host."
---

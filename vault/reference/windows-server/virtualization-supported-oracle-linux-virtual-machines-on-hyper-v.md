...
slug: virtualization-supported-oracle-linux-virtual-machines-on-hyper-v
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/Supported-Oracle-Linux-virtual-machines-on-Hyper-V
family: virtualization
documentKind: "concept-article"
abstract: "Lists the Oracle Linux integration services and features included in each version"
---

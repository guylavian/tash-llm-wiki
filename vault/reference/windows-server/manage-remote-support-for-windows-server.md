...
slug: manage-remote-support-for-windows-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/azure-arc/remote-support-for-windows-server
family: manage
documentKind: "how-to"
abstract: "Learn how to configure, grant, and revoke remote support assistance for your Arc-enabled Windows server."
---

# How to configure remote support for Arc-enabled Windows servers (preview)

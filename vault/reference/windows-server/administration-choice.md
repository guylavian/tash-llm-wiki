...
slug: administration-choice
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/choice
family: administration
documentKind: "reference"
abstract: "Reference article for the choice command, which prompts the user to select one item from a list of single-character choices in a batch program, and then returns the index of the selected choice."
---

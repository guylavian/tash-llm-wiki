...
slug: networking-primary-geo-location
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/deploy/primary-geo-location
family: networking
documentKind: "how-to"
abstract: "Learn how to configure DNS Policy to allow primary DNS servers to respond to DNS client queries based on the geographical location of both the client and the resource to which the client is attempting to connect, providing the client with the IP address of the closest resource."
---

...
slug: storage-deploy-work-folders-adfs-step2
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/work-folders/deploy-work-folders-adfs-step2
family: storage
documentKind: "install-set-up-deploy"
abstract: "Learn more about: Deploy Work Folders with AD FS and Web Application Proxy: Step 2, AD FS Post-Configuration Work"
---

...
slug: remote-monitor-the-configuration-distribution-status-of-the-remote-access-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/monitoring-and-accounting/Monitor-the-configuration-distribution-status-of-the-Remote-Access-server
family: remote
documentKind: "how-to"
abstract: "Learn how to use the monitoring dashboard to monitor the configuration distribution status of the Remote Access server."
---

...
slug: networking-validate-dnssec-responses
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/validate-dnssec-responses
family: networking
documentKind: "concept-article"
abstract: "Learn how to use DNSSEC resource records to validate and secure DNS responses."
---

# Validate and secure DNS responses using DNSSEC on DNS Server in Windows Server

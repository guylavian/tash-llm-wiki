...
slug: remote-da-always-on-migration-deploy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/da-always-on-vpn-migration/da-always-on-migration-deploy
family: remote
documentKind: "upgrade-and-migration-article"
abstract: "Migrating from DirectAccess to Always On VPN requires a specific process to migrate clients, which helps minimize race conditions that arise from performing migration steps out of order."
---

# Migration from DirectAccess to Always On VPN

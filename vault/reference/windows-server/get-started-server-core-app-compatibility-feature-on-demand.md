...
slug: get-started-server-core-app-compatibility-feature-on-demand
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/server-core-app-compatibility-feature-on-demand
family: get-started
documentKind: "how-to"
abstract: "Learn how to install the Application Compatibility Feature on Demand to enhance the compatibility of applications with Server Core installations of Windows Server."
---

# Install Server Core Application Compatibility Feature on Demand

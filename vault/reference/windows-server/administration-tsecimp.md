...
slug: administration-tsecimp
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/tsecimp
family: administration
documentKind: "reference"
abstract: "Reference article for the tsecimp command, which imports assignment information from an Extensible Markup Language (XML) file into the TAPI server security file (Tsec.ini)."
---

...
slug: administration-call
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/call
family: administration
documentKind: "reference"
abstract: "Reference article for the call command, which calls one batch program from another without stopping the parent batch program."
---

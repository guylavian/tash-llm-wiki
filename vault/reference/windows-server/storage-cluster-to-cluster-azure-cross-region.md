...
slug: storage-cluster-to-cluster-azure-cross-region
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-replica/cluster-to-cluster-azure-cross-region
family: storage
documentKind: "how-to"
abstract: "Learn how to use cluster-to-cluster Storage Replica in Windows Server for cross-region storage replication in Azure."
---

# Cluster-to-Cluster Replication Cross-Region in Azure

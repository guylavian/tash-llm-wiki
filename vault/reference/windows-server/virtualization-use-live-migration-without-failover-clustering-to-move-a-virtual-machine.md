...
slug: virtualization-use-live-migration-without-failover-clustering-to-move-a-virtual-machine
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/manage/Use-live-migration-without-Failover-Clustering-to-move-a-virtual-machine
family: virtualization
documentKind: "how-to"
abstract: "Gives prerequisites and instructions for doing a virtual machine live migration in a standalone environment."
---

# Use live migration without Failover Clustering to move a VM

...
slug: administration-reg-unload
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/reg-unload
family: administration
documentKind: "reference"
abstract: "Reference article for the reg unload command, which removes a section of the registry loaded using the reg load operation."
---

...
slug: networking-dnssec-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/dnssec-overview
family: networking
documentKind: "overview"
abstract: "Learn about how Domain Name System Security Extensions (DNSSEC) adds security to the DNS protocol for DNS Server in Windows Server."
---

# What is DNSSEC on DNS Server in Windows Server?

...
slug: administration-defrag
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/defrag
family: administration
documentKind: "reference"
abstract: "Reference article for the defrag command, which locates and consolidates fragmented files on local volumes to improve system performance."
---

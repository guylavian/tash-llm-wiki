...
slug: failover-clustering-failover-cluster-manage-cluster-shared-volumes
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/failover-cluster-manage-cluster-shared-volumes
family: failover-clustering
documentKind: "how-to"
abstract: "Learn how to manage Cluster Shared Volumes (CSVs) in a failover cluster in Windows Server."
---

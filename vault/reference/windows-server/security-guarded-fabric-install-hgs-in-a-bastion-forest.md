...
slug: security-guarded-fabric-install-hgs-in-a-bastion-forest
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-install-hgs-in-a-bastion-forest
family: security
documentKind: "install-set-up-deploy"
abstract: "Learn more about: Install HGS in an existing bastion forest"
---

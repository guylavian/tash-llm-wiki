...
slug: networking-nps-np-configure
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-np-configure
family: networking
documentKind: "how-to"
abstract: "This topic provides an overview of network policy configuration for Network Policy Server in Windows Server 2016."
---

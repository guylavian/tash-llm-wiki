...
slug: storage-deploy-folder-redirection
tier: reference
...
abstract: "Learn how to deploy Folder Redirection and Offline Files together, including the steps needed to control access to the redirected files."
---

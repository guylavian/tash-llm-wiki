...
slug: networking-dns-tod-azure-cloud-app-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/deploy/dns-tod-azure-cloud-app-server
family: networking
documentKind: "how-to"
abstract: "Learn how to use DNS responses based on time of day with an Azure Cloud App Server."
---

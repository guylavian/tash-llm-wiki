...
slug: networking-b-wireless-access-deploy-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/wireless/b-wireless-access-deploy-overview
family: networking
documentKind: "concept-article"
abstract: "Learn about wireless access deployment components that are required to deploy 802.1X authenticated wireless access with PEAP-MS-CHAP v2."
---

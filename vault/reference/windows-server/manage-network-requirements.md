...
slug: manage-network-requirements
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/deploy/network-requirements
family: manage
documentKind: "concept-article"
abstract: "Networking requirements to use Windows Admin Center."
---

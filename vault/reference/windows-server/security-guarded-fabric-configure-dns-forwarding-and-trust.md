...
slug: security-guarded-fabric-configure-dns-forwarding-and-trust
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-configure-dns-forwarding-and-trust
family: security
documentKind: "how-to"
abstract: "Learn more about: Configure DNS forwarding in the HGS domain and a one-way trust with the fabric domain"
---

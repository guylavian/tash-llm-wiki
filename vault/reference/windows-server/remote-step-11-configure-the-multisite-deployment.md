...
slug: remote-step-11-configure-the-multisite-deployment
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/tlg-multisite/STEP-11-Configure-the-Multisite-Deployment
family: remote
documentKind: "how-to"
abstract: "Learn how to make changes to the current Remote Access configuration wizard on EDGE1, enable the multisite feature, and then add 2-EDGE1 as a second entry point."
---

...
slug: administration-change-user
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/change-user
family: administration
documentKind: "reference"
abstract: "Reference article for the change user command, which changes the install mode for the Remote Desktop Session Host server."
---

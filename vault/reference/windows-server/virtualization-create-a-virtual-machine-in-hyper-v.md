...
slug: virtualization-create-a-virtual-machine-in-hyper-v
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/get-started/Create-a-virtual-machine-in-Hyper-V
family: virtualization
documentKind: "how-to"
abstract: "Learn how to create a virtual machine in Hyper-V using Hyper-V Manager or PowerShell. Follow step-by-step instructions to get started quickly."
---

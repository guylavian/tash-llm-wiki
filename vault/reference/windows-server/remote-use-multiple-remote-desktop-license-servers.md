...
slug: remote-use-multiple-remote-desktop-license-servers
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/use-multiple-remote-desktop-license-servers
family: remote
documentKind: "how-to"
abstract: "Learn how to use multiple Remote Desktop (RD) license servers so that they communicate with one another."
---

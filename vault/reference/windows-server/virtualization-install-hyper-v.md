...
slug: virtualization-install-hyper-v
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/get-started/Install-Hyper-V
family: virtualization
documentKind: "how-to"
abstract: "Gives instructions for installing the Hyper-V role using Server Manager or Windows PowerShell. And gives instructions for enablings Hyper-V on Windows."
---

# Install Hyper-V in Windows and Windows Server

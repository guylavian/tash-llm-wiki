...
slug: virtualization-storage-architecture
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/storage-architecture
family: virtualization
documentKind: "concept-article"
abstract: "Learn how to use Windows Server with SAN, NAS, fiber channel, iSCSI, SMB storage for Hyper-V. Also learn about Hyper-V with hyperconverged and disaggregated storage."
---

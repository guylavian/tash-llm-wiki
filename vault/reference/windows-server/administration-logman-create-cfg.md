...
slug: administration-logman-create-cfg
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/logman-create-cfg
family: administration
documentKind: "reference"
abstract: "Reference article for the logman create cfg command, which creates a configuration data collector."
---

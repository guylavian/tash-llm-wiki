...
slug: administration-reg-copy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/reg-copy
family: administration
documentKind: "reference"
abstract: "Reference article for the reg copy command, which copies a registry entry to a specified location on the local or remote computer."
---

...
slug: administration-fsutil-8dot3name
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/fsutil-8dot3name
family: administration
documentKind: "reference"
abstract: "Reference article for the fsutil 8dot3name command, which queries or changes the settings for short name (8dot3 name) behavior."
---

...
slug: administration-server-core-memory-dump
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-core/server-core-memory-dump
family: administration
documentKind: "how-to"
abstract: "Learn how to configure memory dump files for a Server Core installation of Windows Server"
---

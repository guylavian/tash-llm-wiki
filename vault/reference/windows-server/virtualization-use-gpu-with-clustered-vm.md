...
slug: virtualization-use-gpu-with-clustered-vm
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/deploy/use-gpu-with-clustered-vm
family: virtualization
documentKind: "how-to"
abstract: "Learn how to use GPUs with clustered virtual machines (VMs) to provide GPU acceleration to workloads in the clustered VMs on Windows Server and Azure Local."
---

# Use GPUs with Discrete Device Assignment in clustered VMs on Windows Server and Azure Local

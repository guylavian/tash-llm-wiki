...
slug: failover-clustering-recover-failover-cluster-without-quorum
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/recover-failover-cluster-without-quorum
family: failover-clustering
documentKind: "how-to"
abstract: "How to recover a failover cluster without quorum in a disaster recovery scenario in Windows Server."
---

# Recover a failover cluster without quorum in Windows Server

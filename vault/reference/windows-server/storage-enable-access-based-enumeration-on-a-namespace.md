...
slug: storage-enable-access-based-enumeration-on-a-namespace
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/dfs-namespaces/enable-access-based-enumeration-on-a-namespace
family: storage
documentKind: "how-to"
abstract: "This article describes how to enable access-based enumeration on a namespace."
---

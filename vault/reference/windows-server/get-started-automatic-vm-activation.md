...
slug: get-started-automatic-vm-activation
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/automatic-vm-activation
family: get-started
documentKind: "concept-article"
abstract: "Learn about Automatic Virtual Machine Activation (AVMA) and how to enable seamless activation of Windows Server virtual machines on licensed Hyper-V hosts."
---

...
slug: remote-border-gateway-protocol-bgp
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/bgp/Border-Gateway-Protocol-BGP
family: remote
documentKind: "concept-article"
abstract: "You can use this topic to gain an understanding of Border Gateway Protocol (BGP) in Windows Server 2016, including BGP supported deployment topologies and BGP features and capabilities."
---

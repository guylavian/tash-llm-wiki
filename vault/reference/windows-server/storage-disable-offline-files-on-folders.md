...
slug: storage-disable-offline-files-on-folders
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/folder-redirection/disable-offline-files-on-folders
family: storage
documentKind: "how-to"
abstract: "How to disable Offline Files caching on individual folders that are redirected to network shares by using Folder Redirection."
---

...
slug: networking-quickstart-install-configure-dhcp-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/dhcp/quickstart-install-configure-dhcp-server
family: networking
documentKind: "quickstart"
abstract: "Install a Windows Server DHCP server to automatically provide IP addresses and DHCP options to clients connected to one or more subnets on your network."
---

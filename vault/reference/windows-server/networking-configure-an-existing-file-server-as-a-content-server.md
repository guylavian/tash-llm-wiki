...
slug: networking-configure-an-existing-file-server-as-a-content-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/branchcache/deploy/Configure-an-Existing-File-Server-as-a-Content-Server
family: networking
documentKind: "how-to"
abstract: "Learn how to install the BranchCache for Network Files role service of the File Services server role on a computer running Windows Server 2016."
---

...
slug: administration-add-servers-to-server-manager
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-manager/add-servers-to-server-manager
family: administration
documentKind: "how-to"
abstract: "Learn how to add servers to the Server Manager server pool."
---

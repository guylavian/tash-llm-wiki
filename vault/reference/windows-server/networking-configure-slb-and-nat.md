...
slug: networking-configure-slb-and-nat
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/manage/Configure-SLB-and-NAT
family: networking
documentKind: "how-to"
abstract: "Learn how to use the Software Defined Networking software load balancer to provide outbound network address translation, inbound NAT, or load balancing between multiple instances of an application."
---

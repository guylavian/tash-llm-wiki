...
slug: administration-netsh-wcn
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netsh-wcn
family: administration
documentKind: "reference"
abstract: "The netsh wcn command configures, manages, and troubleshoots Wireless Configuration Network (WCN) settings on Windows devices."
---

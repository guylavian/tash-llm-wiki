...
slug: networking-deploy-server-certificates-for-802-1x-wired-and-wireless-deployments
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/server-certs/Deploy-Server-Certificates-for-802.1X-Wired-and-Wireless-Deployments
family: networking
documentKind: "how-to"
abstract: "Learn how to deploy server certificates to your Remote Access and Network Policy Server (NPS) infrastructure servers."
---

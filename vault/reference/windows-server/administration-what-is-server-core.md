...
slug: administration-what-is-server-core
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-core/what-is-server-core
family: administration
documentKind: "concept-article"
abstract: "Discover the benefits of the Server Core installation option in Windows Server. Learn how it reduces the attack surface and optimizes performance for server roles."
---

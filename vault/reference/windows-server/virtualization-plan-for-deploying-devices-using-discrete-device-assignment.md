...
slug: virtualization-plan-for-deploying-devices-using-discrete-device-assignment
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/plan/Plan-for-Deploying-Devices-using-Discrete-Device-Assignment
family: virtualization
documentKind: "install-set-up-deploy"
abstract: "Learn how Discrete Device Assignment allows physical PCIe hardware to be directly accessible from within a virtual machine."
---

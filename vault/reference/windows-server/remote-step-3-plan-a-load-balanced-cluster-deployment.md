...
slug: remote-step-3-plan-a-load-balanced-cluster-deployment
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/cluster/plan/Step-3-Plan-a-Load-Balanced-Cluster-Deployment
family: remote
documentKind: "how-to"
abstract: "Learn how to plan the load-balancing configuration and cluster deployment."
---

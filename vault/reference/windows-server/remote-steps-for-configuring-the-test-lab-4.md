...
slug: remote-steps-for-configuring-the-test-lab-4
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/tlg-multisite/Steps-for-Configuring-the-Test-Lab-4
family: remote
documentKind: "how-to"
abstract: "Learn how to configure the Remote Access infrastructure, configure the Remote Access servers and clients and test DirectAccess connectivity from the Internet and Homenet subnets."
---

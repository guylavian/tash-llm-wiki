...
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/overview
family: get-started
documentKind: "overview"
abstract: "Learn about Windows Server capabilities, deployment options, and key features that help you modernize your infrastructure while maintaining security and performance."
---

...
slug: manage-dynamic-tool-display
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/extend/guides/dynamic-tool-display
family: manage
documentKind: "how-to"
abstract: "Control your tool's visibility in a solution Windows Admin Center SDK (Project Honolulu)"
---

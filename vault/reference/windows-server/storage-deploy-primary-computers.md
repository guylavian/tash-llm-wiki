...
slug: storage-deploy-primary-computers
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/folder-redirection/deploy-primary-computers
family: storage
documentKind: "install-set-up-deploy"
abstract: "How to enable primary computer support and designate primary computers for users with Folder Redirection and Roaming User Profiles."
---

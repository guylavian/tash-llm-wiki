...
slug: security-osconfig-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/osconfig/osconfig-overview
family: security
documentKind: "concept-article"
abstract: "OSConfig is a cross-platform scenario-based security tool to manage on-premises Windows Server and Azure Arc-connected devices."
---

# OSConfig Overview for Windows Server

...
slug: networking-pktmon
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/pktmon/pktmon
family: networking
documentKind: "overview"
abstract: "This article provides an overview of the Packet Monitor (Pktmon) network diagnostics tool and its uses."
---

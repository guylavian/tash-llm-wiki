...
slug: storage-using-inherited-permissions-with-access-based-enumeration
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/dfs-namespaces/using-inherited-permissions-with-access-based-enumeration
family: storage
documentKind: "how-to"
abstract: "This article describes how to use inherited permissions with access-based enumeration"
---

...
slug: networking-nps-concurrent-auth
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-concurrent-auth
family: networking
documentKind: "how-to"
abstract: "Learn how to improve NPS performance by increasing the number of concurrent authentications allowed between the NPS and the domain controller."
---

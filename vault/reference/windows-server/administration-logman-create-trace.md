...
slug: administration-logman-create-trace
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/logman-create-trace
family: administration
documentKind: "reference"
abstract: "Reference article for the logman create trace command, which creates an event trace data collector."
---

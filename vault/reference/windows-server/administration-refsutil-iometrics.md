...
slug: administration-refsutil-iometrics
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/refsutil-iometrics
family: administration
documentKind: "reference"
abstract: "Reference article for the refsutil iometrics tool, which tracks IO data to monitor performance and usage patterns on a Resilient File System (ReFS) volume in Windows."
---

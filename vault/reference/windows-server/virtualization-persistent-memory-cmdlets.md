...
slug: virtualization-persistent-memory-cmdlets
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/manage/persistent-memory-cmdlets
family: virtualization
documentKind: "how-to"
abstract: "How to configure persistent memory devices for Hyper-V VMs"
---
...
**Example:** `Add-VMHardDiskDrive -VMName "ProductionVM1" -ControllerType PMEM -ControllerLocation 1 -Path D:\VMPMEMDevice1.vhdpmem`

...
slug: remote-rds-vdi-supported-config
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/rds-vdi-supported-config
family: remote
documentKind: "concept-article"
abstract: "Provides information about supported configurations for Windows VDI with RDS in Windows Server."
---

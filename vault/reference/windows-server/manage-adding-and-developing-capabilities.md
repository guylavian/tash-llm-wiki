...
slug: manage-adding-and-developing-capabilities
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/system-insights/adding-and-developing-capabilities
family: manage
documentKind: "concept-article"
abstract: "System Insights enables you to add new predictive capabilities to System Insights, without requiring any OS updates. This enables developers, including Microsoft and third parties, to create and deliver new capabilities mid-release to address the scenarios you care about. New capabilities can specify custom data to collect and analyze, and they also integrate with the existing System Insights management planes."
---

...
slug: storage-deploy-persistent-memory
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/deploy-persistent-memory
family: storage
documentKind: "how-to"
abstract: "This article provides details on what persistent memory is and how to deploy it as storage in Azure Local and Windows Server."
---

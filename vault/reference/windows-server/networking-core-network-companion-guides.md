...
slug: networking-core-network-companion-guides
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/Core-Network-Companion-Guides
family: networking
documentKind: "concept-article"
abstract: "This topic provides an overview of the companion guides to the Windows Server 2016 Core Network Guide"
---

...
slug: administration-atmadm
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/atmadm
family: administration
documentKind: "reference"
abstract: "Reference article for the atmadm command, which monitors connections and addresses that are registered by the atM call Manager on an asynchronous transfer mode (atM) network."
---

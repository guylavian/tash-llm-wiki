...
slug: remote-monitor-the-existing-load-on-the-remote-access-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/monitoring-and-accounting/Monitor-the-existing-load-on-the-Remote-Access-server
family: remote
documentKind: "how-to"
abstract: "Learn how to use the monitoring dashboard to view the load statistics for the server, or you can use Performance Monitor counters to track the statistics."
---

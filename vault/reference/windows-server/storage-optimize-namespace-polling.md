...
slug: storage-optimize-namespace-polling
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/dfs-namespaces/optimize-namespace-polling
family: storage
documentKind: "how-to"
abstract: "This article describes how to optimize namespace polling to maintain a consistent domain-based namespace across namespace servers"
---

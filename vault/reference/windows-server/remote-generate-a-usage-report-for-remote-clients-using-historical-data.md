...
slug: remote-generate-a-usage-report-for-remote-clients-using-historical-data
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/monitoring-and-accounting/Generate-a-usage-report-for-remote-clients-using-historical-data
family: remote
documentKind: "how-to"
abstract: "Learn how to enable accounting on the Remote Access server so you can generate a usage report for the remote clients that are accessing the server."
---

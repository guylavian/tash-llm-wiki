...
slug: storage-persistent-memory-direct-access
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/persistent-memory-direct-access
family: storage
documentKind: "how-to"
abstract: "This article provides information on DAX and how to configure it with persistent memory modules."
---

# Understand Direct Access (DAX) and create DAX volumes with persistent memory devices

...
slug: networking-sign-dnssec-zone
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/sign-dnssec-zone
family: networking
documentKind: "how-to"
abstract: "Protect DNS zones from tampering with DNSSEC signing. Learn to configure signing keys, set validity periods, and manage key rollover using DNS Manager and PowerShell commands."
---

# Sign DNS Zones with DNSSEC on Windows Server

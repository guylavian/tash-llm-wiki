...
slug: administration-bitsadmin
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/bitsadmin
family: administration
documentKind: "reference"
abstract: "Reference article for the bitsadmin command, which is a command-line tool used to create, download, or upload jobs and monitor their progress."
---

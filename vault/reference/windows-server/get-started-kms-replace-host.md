...
slug: get-started-kms-replace-host
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/kms-replace-host
family: get-started
documentKind: "how-to"
abstract: "Learn how to replace your Key Management Services (KMS) host in Windows Server."
---

# Replace a KMS host in Windows Server

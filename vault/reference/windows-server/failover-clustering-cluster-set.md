...
slug: failover-clustering-cluster-set
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/cluster-set
family: failover-clustering
documentKind: "how-to"
abstract: "Learn how to deploy a cluster set"
---

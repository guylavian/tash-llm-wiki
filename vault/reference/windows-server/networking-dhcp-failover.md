...
slug: networking-dhcp-failover
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/dhcp/dhcp-failover
family: networking
documentKind: "overview"
abstract: "Learn how DHCP Failover replicates IP address leases and settings in DHCP scopes from a primary DHCP server to a failover partner server."
---

# DHCP failover in Windows Server

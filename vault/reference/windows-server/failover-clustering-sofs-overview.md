...
slug: failover-clustering-sofs-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/sofs-overview
family: failover-clustering
documentKind: "overview"
abstract: "How to plan for and deploy a Scale-Out File Server. This allows sharing the same folder from multiple nodes of the same cluster for file-based server application storage availability."
---

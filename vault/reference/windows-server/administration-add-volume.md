...
slug: administration-add-volume
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/add-volume
family: administration
documentKind: "reference"
abstract: "Reference article for the add volume command, which adds volumes to the shadow copy Set, which is the set of volumes to be shadow copied."
---

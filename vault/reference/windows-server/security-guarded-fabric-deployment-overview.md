...
slug: security-guarded-fabric-deployment-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-deployment-overview
family: security
documentKind: "quickstart"
abstract: "Learn more about: Quick start for guarded fabric deployment"
---

...
slug: administration-add-2
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/add_2
family: administration
documentKind: "reference"
abstract: "Reference article for the add command, which adds a disk or volume in an existing RAID configuration."
---

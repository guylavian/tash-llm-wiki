...
slug: storage-create-file-expiration-task
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/create-file-expiration-task
family: storage
documentKind: "how-to"
abstract: "This article describes the process of creating a file management task for files about to expire"
---

...
slug: networking-server-certificate-deployment-planning
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/server-certs/Server-Certificate-Deployment-Planning
family: networking
documentKind: "concept-article"
abstract: "Learn how to plan for your server certificate deployment."
---

...
slug: administration-repair-bde
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/repair-bde
family: administration
documentKind: "reference"
abstract: "Reference article for the repair-bde command, which can try to reconstruct critical parts of a severely damaged drive and salvage recoverable data if the drive was encrypted by using BitLocker."
---

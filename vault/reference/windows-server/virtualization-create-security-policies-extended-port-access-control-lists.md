...
slug: virtualization-create-security-policies-extended-port-access-control-lists
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/create-security-policies-extended-port-access-control-lists
family: virtualization
documentKind: "how-to"
abstract: "This topic provides information about extended port Access Control Lists (ACLs) in Windows Server 2016."
---

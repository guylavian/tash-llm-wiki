...
slug: storage-refs-boot-windows-server-unattend
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/refs/refs-boot-windows-server-unattend
family: storage
documentKind: "how-to"
abstract: "Deploy Windows Server Insider Preview on a ReFS boot volume by using a Setup unattend answer file, and learn how to pre-create the required NTFS WinRE partition."
---

# ReFS Boot Volume Setup for Windows Server (preview)

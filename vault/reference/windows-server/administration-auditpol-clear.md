...
slug: administration-auditpol-clear
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/auditpol-clear
family: administration
documentKind: "reference"
abstract: "Reference article for the auditpol clear command, which deletes the per-user audit policy for all users, resets (disables) the system audit policy for all subcategories, and sets all the auditing options to disabled."
---

...
slug: get-started-enable-hotpatch-azure-arc-enabled-servers
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/enable-hotpatch-azure-arc-enabled-servers
family: get-started
documentKind: "how-to"
abstract: "Learn how to enable Hotpatch for Windows Server 2025 installations on Azure Arc-enabled servers."
---

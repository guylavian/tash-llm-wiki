...
slug: administration-4-configure-group-policy-settings-for-automatic-updates
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-server-update-services/deploy/4-configure-group-policy-settings-for-automatic-updates
family: administration
documentKind: "how-to"
abstract: "See how to use Group Policy to specify how users and computers interact with Windows Update to get automatic updates from Windows Server Update Services (WSUS)."
---

...
slug: administration-query-termserver
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/query-termserver
family: administration
documentKind: "reference"
abstract: "Reference article for the query termserver command, which displays a list of all Remote Desktop Session Host servers on the network."
---

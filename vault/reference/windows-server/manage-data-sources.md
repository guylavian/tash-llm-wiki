...
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/system-insights/data-sources
family: manage
documentKind: "concept-article"
abstract: "When writing a new capability in System Insights, you can specify existing or new data sources to collect locally and analyze. This topic describes the data sources that you can choose when registering a new capability."
---

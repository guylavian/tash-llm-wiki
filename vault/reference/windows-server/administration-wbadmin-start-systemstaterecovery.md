...
slug: administration-wbadmin-start-systemstaterecovery
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wbadmin-start-systemstaterecovery
family: administration
documentKind: "reference"
abstract: "Reference article for the wbadmin start systemstaterecovery command, which performs a system state recovery to a location, and from a backup, that you specify."
---

...
slug: administration-server-core-servicing
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-core/server-core-servicing
family: administration
documentKind: "how-to"
abstract: "Learn how to configure Windows Server Core in updating the operating system automatically and manually through the command line."
---

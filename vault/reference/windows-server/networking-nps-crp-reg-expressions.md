...
slug: networking-nps-crp-reg-expressions
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-crp-reg-expressions
family: networking
documentKind: "concept-article"
abstract: "This topic explains the use of regular expressions for pattern matching in NPS in Windows Server. You can use this syntax to specify the conditions of network policy attributes and RADIUS realms."
---

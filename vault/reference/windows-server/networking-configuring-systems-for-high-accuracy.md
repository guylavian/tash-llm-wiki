...
slug: networking-configuring-systems-for-high-accuracy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/windows-time-service/configuring-systems-for-high-accuracy
family: networking
documentKind: "how-to"
abstract: "Improve Windows Time synchronization tuning under reasonable operating conditions where systems can be configured to maintain 1 ms (millisecond) accuracy or better with respect to UTC."
---

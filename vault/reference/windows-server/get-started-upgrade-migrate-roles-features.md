...
slug: get-started-upgrade-migrate-roles-features
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/upgrade-migrate-roles-features
family: get-started
documentKind: "upgrade-and-migration-article"
abstract: "Upgrade Windows Server with confidence. Learn about supported upgrade paths, and migration tools for a smooth transition."
---

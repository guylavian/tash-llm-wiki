...
slug: security-rpc-interface-restrict
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/rpc-interface-restrict
family: security
documentKind: "how-to"
abstract: "RPC Interface Restriction helps to prevent unauthorized access to system resources and data when enabled in group policy object editor or in the registry."
---

# RPC Interface Restriction for Windows Server

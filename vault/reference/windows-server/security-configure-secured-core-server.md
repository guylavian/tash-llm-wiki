...
slug: security-configure-secured-core-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/configure-secured-core-server
family: security
documentKind: "how-to"
abstract: "Learn how to configure Secured-core server in Windows Server using the Windows Security app, Group Policy and Windows Admin Center."
---

# Configure Secured-core server for Windows Server

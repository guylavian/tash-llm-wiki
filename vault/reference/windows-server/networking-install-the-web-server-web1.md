...
slug: networking-install-the-web-server-web1
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/server-certs/Install-the-Web-Server-WEB1
family: networking
documentKind: "tutorial"
abstract: "Learn how to install the Web Server (IIS) server role."
---

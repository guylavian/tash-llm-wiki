...
slug: virtualization-enable-nested-virtualization
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/enable-nested-virtualization
family: virtualization
documentKind: "how-to"
abstract: "Learn how to use nested virtualization to run Hyper-V in a virtual machine and emulate configurations that normally require multiple hosts."
---

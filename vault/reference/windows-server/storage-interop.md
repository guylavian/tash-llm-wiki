...
slug: storage-interop
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/data-deduplication/interop
family: storage
documentKind: "concept-article"
abstract: "Discover supported and unsupported scenarios to ensure compatibility and avoid configuration issues in your Windows Server environment."
---

# Data Deduplication interoperability in Windows Server

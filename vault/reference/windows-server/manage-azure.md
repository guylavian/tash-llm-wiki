...
slug: manage-azure
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/azure
family: manage
documentKind: "concept-article"
abstract: "You can extend on-premises deployments of Windows Server to the cloud by using Azure hybrid services."
---

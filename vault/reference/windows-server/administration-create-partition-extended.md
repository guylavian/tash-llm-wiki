...
slug: administration-create-partition-extended
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/create-partition-extended
family: administration
documentKind: "reference"
abstract: "Reference article for the create partition extended command, which creates an extended partition on the disk with focus."
---

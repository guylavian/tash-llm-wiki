...
slug: failover-clustering-failover-cluster-csvs
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/failover-cluster-csvs
family: failover-clustering
documentKind: "concept-article"
abstract: "Understand Cluster Shared Volumes (CSV) in Windows Server failover clusters, including features, requirements, and best practices for deployment and management."
---

...
slug: networking-use-windows-powershell-to-configure-non-domain-member-client-computers
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/branchcache/deploy/Use-Windows-PowerShell-to-Configure-Non-Domain-Member-Client-Computers
family: networking
documentKind: "how-to"
abstract: "Learn how to manually configure a BranchCache client computer for distributed cache mode or hosted cache mode."
---

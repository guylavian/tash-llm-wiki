...
slug: storage-checklist-apply-file-screen-to-volume-or-folder
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/checklist-apply-file-screen-to-volume-or-folder
family: storage
documentKind: "checklist"
abstract: "This article describes how to apply a file screen to a volume or folder"
---

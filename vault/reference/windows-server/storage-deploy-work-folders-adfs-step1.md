...
slug: storage-deploy-work-folders-adfs-step1
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/work-folders/deploy-work-folders-adfs-step1
family: storage
documentKind: "install-set-up-deploy"
abstract: "Learn more about: Deploy Work Folders with AD FS and Web Application Proxy: Step 1, Set-up AD FS"
---

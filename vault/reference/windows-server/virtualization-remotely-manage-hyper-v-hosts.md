...
slug: virtualization-remotely-manage-hyper-v-hosts
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/manage/Remotely-manage-Hyper-V-hosts
family: virtualization
documentKind: "how-to"
abstract: "Describes version compatibility between Hyper-V hosts and Hyper-V Manager and how to connect to remote hosts in different environments."
---

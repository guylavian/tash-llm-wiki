...
slug: administration-query-session
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/query-session
family: administration
documentKind: "reference"
abstract: "Reference article for the query session command, which displays information about sessions on a Remote Desktop Session Host server."
---

...
slug: administration-wdsutil-set-image
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wdsutil-set-image
family: administration
documentKind: "reference"
abstract: "Reference article for wdsutil set-image, which changes the attributes of an image."
---

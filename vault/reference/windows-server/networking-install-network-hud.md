...
slug: networking-install-network-hud
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/install-network-hud
family: networking
documentKind: "install-set-up-deploy"
abstract: "Install and enable Network HUD on Windows Server 2025 Datacenter clustered deployments."
---

# Install Network HUD for Windows Server (preview)

...
slug: networking-nps-crp-realm-names
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-crp-realm-names
family: networking
documentKind: "concept-article"
abstract: "This topic provides an overview of using realm names in Network Policy Server connection request processing in Windows Server 2016."
---

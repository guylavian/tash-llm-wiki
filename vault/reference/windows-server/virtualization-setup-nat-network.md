...
slug: virtualization-setup-nat-network
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/setup-nat-network
family: virtualization
documentKind: "how-to"
abstract: "Learn how to create a network address translation (NAT) virtual network using PowerShell, and then connect a virtual machine."
---

...
slug: networking-network-controller-service-fabric
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/technologies/network-controller/network-controller-service-fabric
family: networking
documentKind: "how-to"
abstract: "You can use this topic to learn about Network Controller high availability for Software Defined Networking (SDN) in Windows Server."
---

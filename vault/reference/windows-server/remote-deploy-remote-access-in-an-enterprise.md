...
slug: remote-deploy-remote-access-in-an-enterprise
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/Deploy-Remote-Access-in-an-Enterprise
family: remote
documentKind: "install-set-up-deploy"
abstract: "This topic provides an introduction to the DirectAccess scenario in Windows Server 2016 for the Enterprise."
---

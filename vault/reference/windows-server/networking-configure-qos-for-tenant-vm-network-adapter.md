...
slug: networking-configure-qos-for-tenant-vm-network-adapter
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/manage/Configure-QoS-for-Tenant-VM-Network-Adapter
family: networking
documentKind: "how-to"
abstract: "You can configure SDN QoS for a VM network adapter to limit bandwidth on a virtual interface to prevent a high-traffic VM from blocking other users."
---

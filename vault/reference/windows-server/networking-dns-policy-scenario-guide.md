...
slug: networking-dns-policy-scenario-guide
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/deploy/DNS-Policy-Scenario-Guide
family: networking
documentKind: "example-scenario"
abstract: "Learn how to use DNS policy to control how a DNS server processes name resolution queries based on different parameters that you define in policies."
---

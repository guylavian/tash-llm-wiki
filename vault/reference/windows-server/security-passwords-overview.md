...
slug: security-passwords-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/kerberos/passwords-overview
family: security
documentKind: "concept-article"
abstract: "Learn about passwords as they are used in the Windows operating systems, and find links to documentation and discussions about the use of passwords in a credential management strategy."
---

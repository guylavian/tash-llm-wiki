...
slug: security-guarded-fabric-install-trusted-tpm-root-certificates
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-install-trusted-tpm-root-certificates
family: security
documentKind: "install-set-up-deploy"
abstract: "Learn more about: Install trusted TPM root certificates"
---

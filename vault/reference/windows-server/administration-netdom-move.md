...
slug: administration-netdom-move
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netdom-move
family: administration
documentKind: "reference"
abstract: "Netdom move is a command-line utility moves a workstation or member server to a new domain in Windows Server."
---

...
slug: networking-migrate-to-dhcp-failover
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/dhcp/migrate-to-dhcp-failover
family: networking
documentKind: "how-to"
abstract: "Learn how to migrate DHCP failover relationships in Windows Server. This guide provides steps for migrating an existing DHCP failover deployment on Windows Server."
---

# Migrate to DHCP failover in Windows Server

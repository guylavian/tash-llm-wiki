...
slug: networking-manage-dns-zones
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/manage-dns-zones
family: networking
documentKind: "how-to"
abstract: "Learn how to create DNS zones and manage them with DNS server in Windows Server using PowerShell and the DNS Manager console."
---

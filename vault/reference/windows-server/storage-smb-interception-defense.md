...
slug: storage-smb-interception-defense
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/file-server/smb-interception-defense
family: storage
documentKind: "how-to"
abstract: "How to configure Windows Server to harden SMB protocol to defend against interception attacks."
---

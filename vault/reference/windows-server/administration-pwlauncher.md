...
slug: administration-pwlauncher
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/pwlauncher
family: administration
documentKind: "reference"
abstract: "Reference article for the pwlauncher command, which enables or disables the Windows To Go Startup Options (pwlauncher)."
---

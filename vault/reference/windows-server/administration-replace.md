...
slug: administration-replace
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/replace
family: administration
documentKind: "reference"
abstract: "Reference article for the replace command, which can replace existing or add new files to a directory."
---

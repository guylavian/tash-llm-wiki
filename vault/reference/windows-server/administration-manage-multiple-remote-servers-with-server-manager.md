...
slug: administration-manage-multiple-remote-servers-with-server-manager
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-manager/manage-multiple-remote-servers-with-server-manager
family: administration
documentKind: "how-to"
abstract: "Learn how to use features in the Server Manager console to manage multiple, remote servers."
---

...
slug: networking-dns-encryption-dns-over-https
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/dns-encryption-dns-over-https
family: networking
documentKind: "concept-article"
abstract: "Discover how DNS over HTTPS (DoH) in Windows enhances privacy and security by encrypting DNS queries and responses using HTTPS and TLS."
---

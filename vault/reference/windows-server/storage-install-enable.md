...
slug: storage-install-enable
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/data-deduplication/install-enable
family: storage
documentKind: "install-set-up-deploy"
abstract: "How to install Data Deduplication on Windows Server, determine whether a workload is a good candidate for deduplication, and enable deduplication on volumes."
---

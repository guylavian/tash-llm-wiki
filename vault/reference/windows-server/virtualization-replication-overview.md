...
slug: virtualization-replication-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/replication-overview
family: virtualization
documentKind: "concept-article"
abstract: "Replicate virtual machines between Hyper-V hosts using Hyper-V Replica as part of a business continuity and disaster recovery (BCDR) strategy."
---

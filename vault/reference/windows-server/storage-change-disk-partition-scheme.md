...
slug: storage-change-disk-partition-scheme
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/disk-management/change-disk-partition-scheme
family: storage
documentKind: "how-to"
abstract: "Learn how to convert a disk to GPT or MBR partition scheme (style) using Disk Management and the command line in Windows."
---

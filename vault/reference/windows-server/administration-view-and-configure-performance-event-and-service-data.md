...
slug: administration-view-and-configure-performance-event-and-service-data
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-manager/view-and-configure-performance-event-and-service-data
family: administration
documentKind: "how-to"
abstract: "Learn how to view and configure the event log entries, performance counters, and service alerts that are displayed for local and remote servers in Server Manager."
---

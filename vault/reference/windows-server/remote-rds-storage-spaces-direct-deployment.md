...
slug: remote-rds-storage-spaces-direct-deployment
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/rds-storage-spaces-direct-deployment
family: remote
documentKind: "install-set-up-deploy"
abstract: "Learn how to use Storage Spaces Direct with RDS."
---

# Deploy a two-node Storage Spaces Direct SOFS for UPD storage in Azure

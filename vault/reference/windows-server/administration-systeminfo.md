...
slug: administration-systeminfo
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/systeminfo
family: administration
documentKind: "reference"
abstract: "Reference article for the systeminfo command, which displays detailed configuration information about a computer and its operating system, including operating system configuration, security information, product ID, and hardware properties (such as RAM, disk space, and network cards)."
---

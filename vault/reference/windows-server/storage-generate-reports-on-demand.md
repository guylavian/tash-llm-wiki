...
slug: storage-generate-reports-on-demand
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/generate-reports-on-demand
family: storage
documentKind: "how-to"
abstract: "This article describes how to generate reports on demand to analyze disk usage in the Windows Server environment using FSRM (File Server Resource Manager)."
---

# Generate reports on demand in Windows Server

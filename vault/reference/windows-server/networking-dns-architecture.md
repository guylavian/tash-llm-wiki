...
slug: networking-dns-architecture
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/dns-architecture
family: networking
documentKind: "concept-article"
abstract: "Learn about the architecture of the Domain Name System (DNS) using Windows Server, including DNS domain names, DNS domain namespace, DNS resource records, and DNS zones."
---

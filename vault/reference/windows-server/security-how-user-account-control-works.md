...
slug: security-how-user-account-control-works
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/user-account-control/how-user-account-control-works
family: security
documentKind: "concept-article"
abstract: "Learn about User Account Control (UAC) and how it helps prevent malicious programs from damaging a computer and helps organizations deploy a better-managed desktop."
---

...
slug: virtualization-virtual-machine-connection
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/virtual-machine-connection
family: virtualization
documentKind: "concept-article"
abstract: "Describes Virtual Machine Connection, and includes details on how to do common tasks, such as send Ctrl-Alt-Delete to the virtual machine."
---

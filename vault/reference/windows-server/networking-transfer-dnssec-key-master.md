...
slug: networking-transfer-dnssec-key-master
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/transfer-dnssec-key-master
family: networking
documentKind: "how-to"
abstract: "Learn how to transfer the DNSSEC Key Master role in Windows DNS Server between authoritative servers, including online transfers and disaster recovery scenarios."
---

# Transfer the DNSSEC Key Master Role in Windows DNS Server

...
slug: administration-server-manager
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-manager/server-manager
family: administration
documentKind: "concept-article"
abstract: "Server Manager centralizes Windows Server management. Discover how to provision, monitor, and manage servers without Remote Desktop."
---

...
slug: failover-clustering-cluster-aware-updating-options
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/cluster-aware-updating-options
family: failover-clustering
documentKind: "how-to"
abstract: "How to configure advanced options and updating run profiles for Cluster-Aware Updating (CAU)"
---

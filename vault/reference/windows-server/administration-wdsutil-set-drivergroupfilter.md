...
slug: administration-wdsutil-set-drivergroupfilter
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wdsutil-set-drivergroupfilter
family: administration
documentKind: "reference"
abstract: "Reference article for Subcommand set-DriverGroupFilter, which adds or removes an existing driver group filter from a driver group."
---

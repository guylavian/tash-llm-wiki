...
slug: administration-tapicfg-show
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/tapicfg-show
family: administration
documentKind: "reference"
abstract: "Reference article for the tapicfg show command, which displays the names and locations of the TAPI application directory partitions in the domain."
---

...
slug: storage-fsrm-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/fsrm-overview
family: storage
documentKind: "how-to"
abstract: "Learn about File Server Resource Manager (FSRM), which is a tool that enables you to manage and classify data on a Windows Server file server."
---

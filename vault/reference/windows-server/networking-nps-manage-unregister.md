...
slug: networking-nps-manage-unregister
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-manage-unregister
family: networking
documentKind: "how-to"
abstract: "Learn how to unregister an NPS from an Active Directory Domain so you can move an NPS to another domain, replace an NPS, or retire an NPS."
---

...
slug: networking-5-bc-feature-scp
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/bc-hcm/5-Bc-Feature-Scp
family: networking
documentKind: "install-set-up-deploy"
abstract: "Learn how to install the BranchCache feature on your hosted cache server, HCS1, and to configure the server to register an SCP in AD DS."
---

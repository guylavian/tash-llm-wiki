...
slug: security-guarded-fabric-initialize-hgs-ad-mode
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-initialize-hgs-ad-mode
family: security
documentKind: "how-to"
abstract: "Learn more about: Initialize HGS using Admin-trusted attestation"
---

...
slug: administration-typeperf
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/typeperf
family: administration
documentKind: "reference"
abstract: "Reference article for the typeperf command, which writes performance data to the command window or to a log file."
---

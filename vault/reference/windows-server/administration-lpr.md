...
slug: administration-lpr
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/lpr
family: administration
documentKind: "reference"
abstract: "Reference article for the lpr command, which sends a file to a computer or printer sharing device running the Line printer Daemon (LPD) service in preparation for printing."
---

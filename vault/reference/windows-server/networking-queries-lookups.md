...
slug: networking-queries-lookups
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/queries-lookups
family: networking
documentKind: "concept-article"
abstract: "Learn about DNS queries and lookups in Windows and Windows Server, including recursion, iteration, and the DNS query process."
---

...
slug: administration-dtrace
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/dtrace
family: administration
documentKind: "reference"
abstract: "DTrace is a dynamic tracing framework that allows users to monitor and debug system performance for Windows and other operating systems."
---

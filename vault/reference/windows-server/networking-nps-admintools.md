...
slug: networking-nps-admintools
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-admintools
family: networking
documentKind: "how-to"
abstract: "You can use this topic to learn about the tools that you can use to manage Network Policy Server in Windows Server 2016."
---

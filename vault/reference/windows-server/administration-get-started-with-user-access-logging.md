...
slug: administration-get-started-with-user-access-logging
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/user-access-logging/get-started-with-user-access-logging
family: administration
documentKind: "get-started"
abstract: "Describes the User Access Logging feature and how to start using it."
---

...
slug: networking-hcn-json-document-schemas
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/hcn/hcn-json-document-schemas
family: networking
documentKind: "reference"
abstract: "Information about HCN JSON document schemas."
---

# Host Compute Network (HCN) JSON document schemas

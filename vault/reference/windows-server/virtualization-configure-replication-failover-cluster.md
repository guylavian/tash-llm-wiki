...
slug: virtualization-configure-replication-failover-cluster
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/configure-replication-failover-cluster
family: virtualization
documentKind: "how-to"
abstract: "Learn how to configure replication for virtual machines going to Hyper-V hosts in a failover cluster using Hyper-V Replica."
---

...
slug: get-started-servicing-channels-comparison
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/servicing-channels-comparison
family: get-started
documentKind: "concept-article"
abstract: "Discover how Windows Server LTSC and Annual Channel differ in release cycles, support, and installation options to meet your organization's needs."
---

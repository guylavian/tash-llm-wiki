...
slug: security-system-key-utility-technical-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/kerberos/system-key-utility-technical-overview
family: security
documentKind: "concept-article"
abstract: "Describes the system key utility (Syskey), which protects the Security Accounts Manager (SAM) database in Windows operating systems."
---

...
slug: administration-powershell
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/powershell
family: administration
documentKind: "reference"
abstract: "Reference article for the PowerShell command, which opens the PowerShell console from a command prompt."
---

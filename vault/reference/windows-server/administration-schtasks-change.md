...
slug: administration-schtasks-change
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/schtasks-change
family: administration
documentKind: "reference"
abstract: "Reference article for the schtasks change command, which schedules commands and programs to run periodically or at a specific time, adds and removes tasks from the schedule, starts and stops tasks on demand, and displays and changes scheduled tasks."
---

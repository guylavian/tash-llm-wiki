...
slug: administration-server-core-removed-roles
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-core/server-core-removed-roles
family: administration
documentKind: "concept-article"
abstract: "Learn about the roles and features not included in the Server Core installation option for Windows Server."
---

...
slug: virtualization-deploying-graphics-devices-using-dda
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/deploy/Deploying-graphics-devices-using-dda
family: virtualization
documentKind: "how-to"
abstract: "Learn how to use DDA to deploy graphics devices in Windows Server and how to mount a GPU to a virtual machine."
---

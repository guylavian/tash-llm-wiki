...
slug: remote-monitor-connected-remote-clients-for-activity-and-status
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/monitoring-and-accounting/Monitor-connected-remote-clients-for-activity-and-status
family: remote
documentKind: "how-to"
abstract: "Learn how to use the management console on the Remote Access server to monitor remote client activity and status."
---

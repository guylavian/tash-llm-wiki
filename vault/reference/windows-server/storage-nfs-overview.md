...
slug: storage-nfs-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/nfs/nfs-overview
family: storage
documentKind: "overview"
abstract: "Learn about Network File System (NFS) in Windows Server, supported versions, and how it enables file sharing across platforms. Discover deployment benefits."
---

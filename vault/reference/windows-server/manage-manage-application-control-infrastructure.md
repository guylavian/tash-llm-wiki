...
slug: manage-manage-application-control-infrastructure
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/use/manage-application-control-infrastructure
family: manage
documentKind: "concept-article"
abstract: "Learn about Windows Defender Application Control (WDAC) enforced servers and clusters in using Windows Admin Center including settings and requirements."
---

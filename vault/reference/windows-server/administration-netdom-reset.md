...
slug: administration-netdom-reset
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netdom-reset
family: administration
documentKind: "reference"
abstract: "Netdom reset is a command-line utility that resets the secure connection between a workstation and a domain controller in Windows Server."
---

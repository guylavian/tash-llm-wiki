...
slug: remote-use-remote-access-monitoring-and-accounting
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/monitoring-and-accounting/Use-Remote-Access-Monitoring-and-Accounting
family: remote
documentKind: "concept-article"
abstract: "Learn how to leverage the monitoring capabilities of Remote Access by using the DirectAccess management console and the corresponding Windows PowerShell cmdlets."
---

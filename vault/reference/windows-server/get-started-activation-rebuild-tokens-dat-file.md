...
slug: get-started-activation-rebuild-tokens-dat-file
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/activation-rebuild-tokens-dat-file
family: get-started
documentKind: "troubleshooting"
abstract: "Provides a list of steps for how to rebuild the Tokens.dat file when troubleshooting Windows activation issues."
---

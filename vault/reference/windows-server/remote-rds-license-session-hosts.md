...
slug: remote-rds-license-session-hosts
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/rds-license-session-hosts
family: remote
documentKind: "how-to"
abstract: "Learn how to install and configure licenses for Remote Desktop session hosts in Windows Server."
---

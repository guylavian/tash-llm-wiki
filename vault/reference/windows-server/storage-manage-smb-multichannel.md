...
slug: storage-manage-smb-multichannel
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/manage-smb-multichannel
family: storage
documentKind: "how-to"
abstract: "Use this topic to use SMB Multichannel for increased throughput and network fault tolerance."
---

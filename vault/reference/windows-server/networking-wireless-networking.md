...
slug: networking-wireless-networking
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/wlan/wireless-networking
family: networking
documentKind: "how-to"
abstract: "The WLAN service allows for wireless configuration, discovery, and connectivity using a wireless adapter in Windows devices."
---

# Wireless LAN overview in Windows Server

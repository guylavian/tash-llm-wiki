...
slug: networking-dhcp-deploy-relay-agent
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/dhcp/dhcp-deploy-relay-agent
family: networking
documentKind: "quickstart"
abstract: "Learn how to install a DHCP relay agent on a computer running the Windows Server operating system."
---

# Install DHCP relay agent for Windows Server

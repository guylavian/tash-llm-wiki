...
slug: get-started-activation-troubleshoot-kms-issues
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/activation-troubleshoot-kms-issues
family: get-started
documentKind: "troubleshooting"
abstract: "Describes common issues that may occur during the KMS activation process, and provides resolutions and guidance"
---

...
slug: administration-server-core-container-removed-roles
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-core/server-core-container-removed-roles
family: administration
documentKind: "concept-article"
abstract: "Learn about the roles and features we removed from the Server Core container image for Windows Server."
---

...
slug: networking-install-a-new-file-server-as-a-content-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/branchcache/deploy/Install-a-New-File-Server-as-a-Content-Server
family: networking
documentKind: "how-to"
abstract: "Learn how to install the File Services server role and the BranchCache for Network Files role service on a computer running Windows Server 2016."
---

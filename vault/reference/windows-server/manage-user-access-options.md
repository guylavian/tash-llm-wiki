...
slug: manage-user-access-options
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/plan/user-access-options
family: manage
documentKind: "concept-article"
abstract: "User access options and identity providers with Windows Admin Center (Project Honolulu)"
---

...
slug: administration-set-id
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/set-id
family: administration
documentKind: "reference"
abstract: "Reference article for the Diskpart set id command, which changes the partition type field for the partition with focus."
---

...
slug: networking-troubleshoot-dns-over-https-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/troubleshoot-dns-over-https-server
family: networking
documentKind: "troubleshooting-general"
abstract: "Learn how to troubleshoot DNS over HTTPS (DoH) issues on Windows DNS Server including service configuration, certificate binding, client connectivity, and query processing problems."
---

# Troubleshoot DNS over HTTPS in DNS Server on Windows Server

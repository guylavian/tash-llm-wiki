...
slug: administration-reg-restore
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/reg-restore
family: administration
documentKind: "reference"
abstract: "Reference article for the reg restore command, which writes saved subkeys and entries back to the registry."
---

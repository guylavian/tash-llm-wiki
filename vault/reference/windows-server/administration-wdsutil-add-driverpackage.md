...
slug: administration-wdsutil-add-driverpackage
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wdsutil-add-driverpackage
family: administration
documentKind: "reference"
abstract: "Reference article for the add-DriverPackage command, which adds a driver package to the server."
---

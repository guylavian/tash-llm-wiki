...
slug: storage-configure-smb-authentication-rate-limiter
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/file-server/configure-smb-authentication-rate-limiter
family: storage
documentKind: "how-to"
abstract: "Learn how SMB authentication rate limiter works and how to configure it for Windows Server and Windows client."
---

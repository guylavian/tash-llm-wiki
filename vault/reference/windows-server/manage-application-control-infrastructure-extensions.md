...
slug: manage-application-control-infrastructure-extensions
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/extend/guides/application-control-infrastructure-extensions
family: manage
documentKind: "best-practice"
abstract: "Develop an extension using Windows Admin Center SDK - Ensuring your extension can manage WDAC-enforced servers and clusters"
---

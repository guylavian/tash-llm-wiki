...
slug: remote-step-4-create-the-network-load-balanced-remote-access-cluster
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/tlg-cluster-nlb/STEP-4-Create-the-Network-Load-Balanced-Remote-Access-Cluster
family: remote
documentKind: "how-to"
abstract: "Learn how to create and test a network load balanced Remote Access cluster."
---

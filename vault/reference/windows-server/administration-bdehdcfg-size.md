...
slug: administration-bdehdcfg-size
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/bdehdcfg-size
family: administration
documentKind: "reference"
abstract: "Reference article for the bdehdcfg size command, which specifies the size of the system partition when a new system drive is being created."
---

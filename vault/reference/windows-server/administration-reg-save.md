...
slug: administration-reg-save
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/reg-save
family: administration
documentKind: "reference"
abstract: "Reference article for the reg save command, which saves a copy of specified subkeys, entries, and values of the registry in a specified file."
---

...
slug: networking-6-bc-move-resize-cache
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/bc-hcm/6-Bc-Move-Resize-Cache
family: networking
documentKind: "how-to"
abstract: "Learn how to move the hosted cache to the drive and folder that you prefer, and to specify the amount of disk space that the hosted cache server can use for the hosted cache."
---

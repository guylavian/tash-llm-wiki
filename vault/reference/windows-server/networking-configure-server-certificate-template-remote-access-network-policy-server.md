...
slug: networking-configure-server-certificate-template-remote-access-network-policy-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/server-certs/configure-server-certificate-template-remote-access-network-policy-server
family: networking
documentKind: "how-to"
abstract: "Learn how to configure the server certificate template in Active Directory Certificate Services for Remote Access and Network Policy Server."
---

# Configure the Server Certificate Template for Network Remote Access

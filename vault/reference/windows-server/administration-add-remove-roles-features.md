...
slug: administration-add-remove-roles-features
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-manager/add-remove-roles-features
family: administration
documentKind: "install-set-up-deploy"
abstract: "Learn how to add or remove roles and features in Windows Server on local, remote servers, or offline virtual hard disks (VHDs), including to multiple servers concurrently. Get step-by-step guidance."
---

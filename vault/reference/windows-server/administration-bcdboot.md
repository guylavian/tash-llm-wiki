...
slug: administration-bcdboot
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/bcdboot
family: administration
documentKind: "reference"
abstract: "Reference article for the bcdboot command, which quickly set up a system partition, or repair the boot environment located on the system partition."
---

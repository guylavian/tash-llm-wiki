...
slug: storage-add-namespace-servers-to-a-domain-based-dfs-namespace
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/dfs-namespaces/add-namespace-servers-to-a-domain-based-DFS-namespace
family: storage
documentKind: "how-to"
abstract: "This article describes how to specify additional namespace servers to host a namespace using DFS management."
---

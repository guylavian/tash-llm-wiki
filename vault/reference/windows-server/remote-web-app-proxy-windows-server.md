...
slug: remote-web-app-proxy-windows-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/web-application-proxy/web-app-proxy-windows-server
family: remote
documentKind: "concept-article"
abstract: "Learn more about: Web Application Proxy in Windows Server"
---

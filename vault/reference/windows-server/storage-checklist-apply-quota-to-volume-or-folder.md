...
slug: storage-checklist-apply-quota-to-volume-or-folder
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/checklist-apply-quota-to-volume-or-folder
family: storage
documentKind: "checklist"
abstract: "This article describes how to apply a storage quota to a volume or folder"
---

# Apply a quota to a volume or folder

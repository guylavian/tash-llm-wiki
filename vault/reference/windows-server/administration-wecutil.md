...
slug: administration-wecutil
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wecutil
family: administration
documentKind: "reference"
abstract: "Reference article for the wecutil command, which lets you create and manage subscriptions to events that are forwarded from remote computers."
---

...
slug: failover-clustering-configure-live-migration-smb-bandwidth
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/configure-live-migration-smb-bandwidth
family: failover-clustering
documentKind: "how-to"
abstract: "Learn how to configure cluster-wide SMB bandwidth limits for Live Migration in Windows Server and Azure Local to optimize network performance and reliability."
---

# Control Live Migration SMB Bandwidth Control Cluster-wide in Windows Server and Azure Local

...
slug: failover-clustering-file-share-witness
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/file-share-witness
family: failover-clustering
documentKind: "how-to"
abstract: "Configure cluster quorum as a file share witness in domain-joined and non-domain joined devices using Failover Cluster Manager."
---

# Configure a file share witness for Failover Clustering in Windows Server

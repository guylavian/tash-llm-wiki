...
slug: remote-da-always-on-migration-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/da-always-on-vpn-migration/da-always-on-migration-overview
family: remote
documentKind: "upgrade-and-migration-article"
abstract: "Always On VPN addresses the previous gaps between Windows VPNs and DirectAccess, and how to migrate from DirectAccess to Always On VPN."
---

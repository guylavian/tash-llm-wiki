...
slug: manage-extensibility-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/extend/extensibility-overview
family: manage
documentKind: "concept-article"
abstract: "Extensions for Windows Admin Center SDK (Project Honolulu)"
---
...
Getting started with Windows Admin Center development is easy!  Sample code can be found for [tool](develop-tool.md), [solution](develop-solution.md), and [gateway plugin](develop-gateway-plugin.md) extension types in our SDK documentation. There you will use the Windows Admin Center SDK to build a new extension project, then follow the individual guides to customize your project to meet your needs.

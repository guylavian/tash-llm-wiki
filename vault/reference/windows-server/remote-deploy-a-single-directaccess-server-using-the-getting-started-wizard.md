...
slug: remote-deploy-a-single-directaccess-server-using-the-getting-started-wizard
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/single-server-wizard/Deploy-a-Single-DirectAccess-Server-Using-the-Getting-Started-Wizard
family: remote
documentKind: "install-set-up-deploy"
abstract: "Learn about the DirectAccess scenario that uses a single DirectAccess server, and allows you to deploy DirectAccess in a few easy steps."
---

...
slug: storage-create-quota
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/create-quota
family: storage
documentKind: "how-to"
abstract: "This article describes how to create a quota based on a template"
---

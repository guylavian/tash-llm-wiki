...
slug: administration-ksetup-addenctypeattr
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/ksetup-addenctypeattr
family: administration
documentKind: "reference"
abstract: "Reference article for the ksetup addenctypeattr command, which adds the encryption type attribute to the list of possible types for the domain."
---

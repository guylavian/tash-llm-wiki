...
slug: networking-nps-top
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-top
family: networking
documentKind: "overview"
abstract: "Learn about using Network Policy Server (NPS) in Windows Server to manage network access authentication, authorization, and accounting."
---

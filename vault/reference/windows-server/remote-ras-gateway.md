...
slug: remote-ras-gateway
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras-gateway/RAS-Gateway
family: remote
documentKind: "concept-article"
abstract: "This topic, which is intended for Information Technology (IT) professionals, provides overview information about RAS Gateway, including RAS Gateway deployment modes and features in Windows Server 2016."
---

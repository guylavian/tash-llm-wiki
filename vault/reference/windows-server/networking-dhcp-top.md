...
slug: networking-dhcp-top
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/dhcp/dhcp-top
family: networking
documentKind: "overview"
abstract: "Discover how Windows Server DHCP simplifies automated IP management, reduces configuration errors, and enhances network efficiency with this powerful protocol."
---

# What is DHCP Server in Windows Server?

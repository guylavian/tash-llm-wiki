...
slug: administration-netsh
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netsh
family: administration
documentKind: "overview"
abstract: "Overview of Network shell (netsh), a command-line utility for displaying or modifying the network configuration of a local or remote Windows computer."
---

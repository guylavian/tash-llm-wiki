...
slug: remote-manage-directaccess-clients-remotely
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/manage-remote-clients/Manage-DirectAccess-Clients-Remotely
family: remote
documentKind: "concept-article"
abstract: "Learn how to leverage the monitoring capabilities of Remote Access by using the DirectAccess management console and the corresponding Windows PowerShell cmdlets, which are provided as part of the Remote Access server role."
---

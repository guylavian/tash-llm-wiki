...
slug: networking-pktmon-sdn-data-path-wac-extension
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/pktmon/pktmon-sdn-data-path-wac-extension
family: networking
documentKind: "how-to"
abstract: "Describes how to automate Packet Monitor-based packet captures with the SDN Data Path Diagnostics Extension in Windows Admin Center."
---

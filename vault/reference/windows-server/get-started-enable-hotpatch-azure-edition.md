...
slug: get-started-enable-hotpatch-azure-edition
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/enable-hotpatch-azure-edition
family: get-started
documentKind: "how-to"
abstract: "Learn how to enable Hotpatch for Windows Server Datacenter: Azure Edition when built using ISO installation media."
---

# Enable Hotpatch for Azure Edition virtual machines

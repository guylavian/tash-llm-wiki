...
slug: security-guarded-fabric-upgrade-to-2019
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-upgrade-to-2019
family: security
documentKind: "upgrade-and-migration-article"
abstract: "Learn more about: Upgrade a guarded fabric to Windows Server 2019"
---
...
5.  If you're using TPM attestation, you might need to [re-capture the TPM baseline or code integrity policy](guarded-fabric-add-host-information-for-tpm-trusted-attestation.md) after the upgrade to pass attestation.

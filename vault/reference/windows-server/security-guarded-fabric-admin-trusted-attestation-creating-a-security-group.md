...
slug: security-guarded-fabric-admin-trusted-attestation-creating-a-security-group
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-admin-trusted-attestation-creating-a-security-group
family: security
documentKind: "how-to"
abstract: "Learn more about: Create a security group for guarded hosts and register the group with HGS"
---

...
slug: manage-strings-localization
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/extend/guides/strings-localization
family: manage
documentKind: "concept-article"
abstract: "Learn about getting your strings ready for localization in Windows Admin Center SDK (Project Honolulu)"
---
...
For localization to other languages, a strings.resjson file needs to be created for each language. These files need to be placed in ```\loc\output\{!LanguageFolder}\strings.resjson```. The available languages with corresponding folders are:

...
slug: networking-network-hud-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/network-hud-overview
family: networking
documentKind: "overview"
abstract: "Learn what Network HUD is, how it works, and the core capabilities it provides for host networking diagnostics across Windows Server clusters."
---

# What is Network HUD (preview) for Windows Server?
...
| Aging or out‑of‑date drivers | Assesses driver package age and surfaces early maintenance needs. Warns when a driver is more than one year old so you can plan an update. |

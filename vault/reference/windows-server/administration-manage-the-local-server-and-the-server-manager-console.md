...
slug: administration-manage-the-local-server-and-the-server-manager-console
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-manager/manage-the-local-server-and-the-server-manager-console
family: administration
documentKind: "how-to"
abstract: "Learn how to manage both the local server and remote servers that are running Windows Server 2008 and newer releases of the Windows Server operating system."
---

...
slug: remote-step-2-configure-the-remote-access-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/manage-remote-clients/install/Step-2-Configure-the-Remote-Access-Server
family: remote
documentKind: "how-to"
abstract: "Learn how to configure the client and server settings that are required for remote management of DirectAccess clients."
---

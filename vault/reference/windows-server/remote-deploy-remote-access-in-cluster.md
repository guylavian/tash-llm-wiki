...
slug: remote-deploy-remote-access-in-cluster
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/cluster/Deploy-Remote-Access-In-Cluster
family: remote
documentKind: "install-set-up-deploy"
abstract: "Learn about the enterprise scenario for deploying multiple Remote Access servers in a cluster load balanced with Windows Network Load Balancing or with an external load balancer."
---

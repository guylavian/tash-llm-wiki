...
slug: storage-configure-smb-over-quic-client-access-control
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/file-server/configure-smb-over-quic-client-access-control
family: storage
documentKind: "how-to"
abstract: "Learn how to configure SMB over QUIC client access control using PowerShell in Windows and Windows Server."
---

# Configure SMB over QUIC client access control in Windows Server

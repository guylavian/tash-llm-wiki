...
slug: security-guarded-fabric-choose-where-to-install-hgs
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-choose-where-to-install-hgs
family: security
documentKind: "concept-article"
abstract: "Learn more about: Choose whether to install HGS in its own dedicated forest or in an existing bastion forest"
---

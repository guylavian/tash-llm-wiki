...
slug: administration-clip
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/clip
family: administration
documentKind: "reference"
abstract: "Reference article for the clip command, which redirects the command output from the command line to the Windows clipboard."
---

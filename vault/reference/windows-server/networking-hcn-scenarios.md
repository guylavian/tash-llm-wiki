...
slug: networking-hcn-scenarios
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/hcn/hcn-scenarios
family: networking
documentKind: "how-to"
abstract: "Sample showing how to use Host Compute Network Service API to create a Host Compute Network on the host that can be used to connect Virtual NICS to Virtual Machines or Containers."
---

# Host Compute Network (HCN) scenarios

...
slug: security-introducing-token-binding
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/token-binding/introducing-token-binding
family: security
documentKind: "concept-article"
abstract: "Learn more about: Introducing Token Binding"
---

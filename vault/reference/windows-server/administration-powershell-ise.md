...
slug: administration-powershell-ise
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/powershell_ise
family: administration
documentKind: "reference"
abstract: "Reference article for the PowerShell_ise command, which starts a Windows PowerShell Integrated Scripting Environment (ISE) session."
---

...
slug: networking-deploy-a-software-defined-network-infrastructure-using-scripts
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/deploy/Deploy-a-Software-Defined-Network-infrastructure-using-scripts
family: networking
documentKind: "how-to"
abstract: "This topic covers how to deploy a Microsoft Software Defined Network (SDN) infrastructure using scripts in Windows Server."
---

...
slug: administration-netdom-query
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netdom-query
family: administration
documentKind: "reference"
abstract: "Netdom query is a command-line utility that retrieves information from a domain about its membership and trust relationships in Windows Server."
---

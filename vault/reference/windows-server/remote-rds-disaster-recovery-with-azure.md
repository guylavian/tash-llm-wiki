...
slug: remote-rds-disaster-recovery-with-azure
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/rds-disaster-recovery-with-azure
family: remote
documentKind: "how-to"
abstract: "Learn how to use Azure Disaster Recovery for disaster recovery for an RDS deployment"
---

# Set up disaster recovery for RDS using Azure Disaster Recovery

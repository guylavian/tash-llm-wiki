...
slug: remote-step-3-configure-a-load-balanced-cluster
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/cluster/configure/Step-3-Configure-a-Load-Balanced-Cluster
family: remote
documentKind: "how-to"
abstract: "Learn how to configure load-balancing on the single server, configure the required certificates, and deploy the cluster."
---

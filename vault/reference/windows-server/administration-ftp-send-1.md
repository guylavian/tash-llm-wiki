...
slug: administration-ftp-send-1
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/ftp-send_1
family: administration
documentKind: "reference"
abstract: "Reference article for the ftp send command, which copies a local file to the remote computer using the current file transfer type."
---

...
slug: networking-delete-dns-resource-records
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/ipam/Delete-DNS-Resource-Records
family: networking
documentKind: "how-to"
abstract: "Learn how to delete one or more DNS resource records by using the IPAM client console."
---

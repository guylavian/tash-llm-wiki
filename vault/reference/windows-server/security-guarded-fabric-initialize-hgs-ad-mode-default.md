...
slug: security-guarded-fabric-initialize-hgs-ad-mode-default
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-initialize-hgs-ad-mode-default
family: security
documentKind: "how-to"
abstract: "Learn more about: Initialize the HGS cluster using AD mode in a new dedicated forest (default)"
---

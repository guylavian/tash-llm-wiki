...
slug: manage-azure-site-recovery-for-windows-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/azure-arc/azure-site-recovery-for-windows-server
family: manage
documentKind: "how-to"
abstract: "Learn how to deploy Azure Site Recovery to manage and orchestrate replication, failover, and failback for both on-premises Arc-enabled Windows servers and Azure VMs."
---

# How to configure Azure Site Recovery for Arc-enabled Windows servers

...
slug: networking-replicate-dhcp-failover
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/dhcp/replicate-dhcp-failover
family: networking
documentKind: "how-to"
abstract: "Follow the steps to replicate DHCP failover, using either the DHCP Console, or Windows PowerShell."
---

# Replicate DHCP failover in Windows Server

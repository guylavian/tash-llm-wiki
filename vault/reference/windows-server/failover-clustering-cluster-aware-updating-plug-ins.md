...
slug: failover-clustering-cluster-aware-updating-plug-ins
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/cluster-aware-updating-plug-ins
family: failover-clustering
documentKind: "how-to"
abstract: "How to use plug-ins to coordinate updates when using Cluster-Aware Updating in Windows Server to install updates on a cluster."
---

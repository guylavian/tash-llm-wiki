...
slug: virtualization-plan-hyper-v-security-in-windows-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/plan/plan-hyper-v-security-in-windows-server
family: virtualization
documentKind: "concept-article"
abstract: "Provides a list of security considerations for Hyper-V hosts and virtual machines"
---

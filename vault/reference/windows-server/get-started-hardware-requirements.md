...
slug: get-started-hardware-requirements
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/hardware-requirements
family: get-started
documentKind: "concept-article"
abstract: "Review the minimum hardware requirements for CPU, memory (RAM), storage, and network needed to install and run Windows Server."
---

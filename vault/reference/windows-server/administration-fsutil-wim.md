...
slug: administration-fsutil-wim
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/fsutil-wim
family: administration
documentKind: "reference"
abstract: "Reference article for the fsutil wim command, which provides functions to discover and manage Windows Image (WIM)-backed files."
---

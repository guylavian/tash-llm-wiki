...
slug: administration-wdsutil-set-device
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wdsutil-set-device
family: administration
documentKind: "reference"
abstract: "Reference article for wdsutil set-device, which changes the attributes of a prestaged computer."
---

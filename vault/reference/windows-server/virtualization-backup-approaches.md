...
slug: virtualization-backup-approaches
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/backup-approaches
family: virtualization
documentKind: "concept-article"
abstract: "Provides and describes the approaches for utilizing Hyper-V to create backup virtual machines."
---

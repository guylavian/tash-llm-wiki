...
slug: remote-fair-share-enabled-by-default-rds
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/fair-share-enabled-by-default-rds
family: remote
documentKind: "troubleshooting"
abstract: "Describes how an RDSH server uses Fair Share technology to balance CPU, disk, and network bandwidth resources among multiple Remote Desktop sessions."
---

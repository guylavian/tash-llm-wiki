...
slug: administration-netsh-rpc
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netsh-rpc
family: administration
documentKind: "reference"
abstract: "The netsh rpc command configures and manages Remote Procedure Call (RPC) service settings in Windows."
---

...
slug: remote-da-basic-plan-s2-deployment
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/single-server-wizard/da-basic-plan-s2-deployment
family: remote
documentKind: "how-to"
abstract: "Learn how to plan the settings for the Getting Started Wizard."
---

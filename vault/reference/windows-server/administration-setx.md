...
slug: administration-setx
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/setx
family: administration
documentKind: "reference"
abstract: "Reference article for the setx command, which creates or modifies environment variables in the user or system environment, without requiring programming or scripting."
---

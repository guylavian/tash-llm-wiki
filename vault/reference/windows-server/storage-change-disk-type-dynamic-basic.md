...
slug: storage-change-disk-type-dynamic-basic
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/disk-management/change-disk-type-dynamic-basic
family: storage
documentKind: "how-to"
abstract: "Learn how to convert a disk type to Dynamic or Basic using Disk Management and the command line in Windows."
---

# Convert a disk to Dynamic or Basic

...
slug: networking-configure-firewall-rules-for-non-domain-members-to-allow-branchcache-traffic
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/branchcache/deploy/Configure-Firewall-Rules-for-Non-Domain-Members-to-Allow-BranchCache-Traffic
family: networking
documentKind: "how-to"
abstract: "Learn how to configure third party firewall products and to manually configure a client computer with firewall rules that allow BranchCache to run in distributed cache mode."
---

...
slug: networking-nps-manage-register
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-manage-register
family: networking
documentKind: "how-to"
abstract: "Learn how to register a server running Network Policy Server in Windows Server 2016 in the NPS default domain or in another domain."
---

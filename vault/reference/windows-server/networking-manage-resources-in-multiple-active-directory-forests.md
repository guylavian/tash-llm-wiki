...
slug: networking-manage-resources-in-multiple-active-directory-forests
tier: reference
...
family: networking
documentKind: "how-to"
abstract: "Learn how to use IPAM to manage domain controllers, DHCP servers, and DNS servers in multiple Active Directory forests."
---

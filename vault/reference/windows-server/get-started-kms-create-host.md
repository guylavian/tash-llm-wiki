...
slug: get-started-kms-create-host
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/kms-create-host
family: get-started
documentKind: "how-to"
abstract: "See how to create a Key Management Services (KMS) activation host that you can use for volume activation on Windows Server and Windows KMS clients."
---

# Create a Key Management Services (KMS) Activation Host in Windows Server

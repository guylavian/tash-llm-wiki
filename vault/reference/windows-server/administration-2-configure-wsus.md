...
slug: administration-2-configure-wsus
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-server-update-services/deploy/2-configure-wsus
family: administration
documentKind: "how-to"
abstract: "See how to configure a Windows Server Update Services (WSUS) server and how to configure client computers to receive updates from the WSUS server."
---

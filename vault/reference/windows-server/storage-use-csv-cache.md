...
slug: storage-use-csv-cache
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/use-csv-cache
family: storage
documentKind: "how-to"
abstract: "This topic describes how to use system memory to boost performance."
---

# Use the CSV in-memory read cache with Azure Local and Windows Server clusters

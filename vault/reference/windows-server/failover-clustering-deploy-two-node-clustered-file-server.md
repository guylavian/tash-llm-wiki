...
slug: failover-clustering-deploy-two-node-clustered-file-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/deploy-two-node-clustered-file-server
family: failover-clustering
documentKind: "install-set-up-deploy"
abstract: "Deploy a highly available file server with a two-node failover cluster. Step-by-step instructions help you configure, validate, and manage your cluster."
---

...
slug: networking-move-file-servers-to-the-branchcache-file-servers-organizational-unit
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/branchcache/deploy/Move-File-Servers-to-the-BranchCache-File-Servers-Organizational-Unit
family: networking
documentKind: "how-to"
abstract: "Learn how to add BranchCache file servers to an organizational unit (OU) in Active Directory Domain Services (AD DS)."
---

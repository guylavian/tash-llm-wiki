...
slug: security-security-support-provider-interface-architecture
tier: reference
...
abstract: "Learn about the Windows authentication protocols that are used within the Security Support Provider Interface (SSPI) architecture."
---

...
slug: storage-add-nodes
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/add-nodes
family: storage
documentKind: "how-to"
abstract: "How to add servers or drives to a Storage Spaces Direct cluster"
---

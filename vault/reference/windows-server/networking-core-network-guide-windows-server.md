...
slug: networking-core-network-guide-windows-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/core-network-guide-windows-server
family: networking
documentKind: "concept-article"
abstract: "This topic provides an overview of the Core Network Guide, which allows you to plan and deploy the core components required for a fully functioning network and a new Active Directory domain in a new forest with Windows Server 2016"
---

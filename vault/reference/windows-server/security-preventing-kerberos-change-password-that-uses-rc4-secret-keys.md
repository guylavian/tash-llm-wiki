...
slug: security-preventing-kerberos-change-password-that-uses-rc4-secret-keys
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/kerberos/preventing-kerberos-change-password-that-uses-rc4-secret-keys
family: security
documentKind: "concept-article"
abstract: "Learn more about: Preventing Kerberos change password that uses RC4 secret keys"
---

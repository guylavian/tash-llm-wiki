...
slug: storage-create-automatic-classification-rule
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/create-automatic-classification-rule
family: storage
documentKind: "how-to"
abstract: "This article describes how to create a classification rule for a property."
---

...
slug: manage-get-started
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/use/get-started
family: manage
documentKind: "get-started"
abstract: "Get started with Windows Admin Center after you download and install it on a Windows PC."
---

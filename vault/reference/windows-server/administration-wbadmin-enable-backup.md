...
slug: administration-wbadmin-enable-backup
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wbadmin-enable-backup
family: administration
documentKind: "reference"
abstract: "Reference article for the wbadmin enable backup command, which creates and enables a daily backup schedule or modifies an existing backup schedule."
---

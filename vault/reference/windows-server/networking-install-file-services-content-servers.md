...
slug: networking-install-file-services-content-servers
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/branchcache/deploy/Install-File-Services-Content-Servers
family: networking
documentKind: "how-to"
abstract: "Learn how to install the BranchCache for network files role service of the File Services server role and enable BranchCache on file shares according to your requirements."
---

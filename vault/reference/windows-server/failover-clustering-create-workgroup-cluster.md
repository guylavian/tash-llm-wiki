...
slug: failover-clustering-create-workgroup-cluster
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/create-workgroup-cluster
family: failover-clustering
documentKind: "how-to"
abstract: "Learn how-to create Failover Clusters without Active Directory using the Failover Cluster Manager or PowerShell."
---

# Create a workgroup cluster in Windows Server

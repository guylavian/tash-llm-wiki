...
slug: security-guarded-fabric-hoster-sets-up-windows-azure-pack
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-hoster-sets-up-windows-azure-pack
family: security
documentKind: "how-to"
abstract: "Learn more about: Shielded VMs - Hosting service provider sets up Windows Azure Pack"
---

...
slug: storage-storage-replica-enhanced-log
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-replica/storage-replica-enhanced-log
family: storage
documentKind: "how-to"
abstract: "Learn how to use Enhanced Log in Storage Replica and about the performance improvements it delivers to your replication groups."
---

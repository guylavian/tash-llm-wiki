...
slug: virtualization-nested-virtualization
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/nested-virtualization
family: virtualization
documentKind: "concept-article"
abstract: "Nested virtualization in Hyper-V lets you run Hyper-V inside a VM. Learn how it works, supported scenarios, and when to use it in your environment."
---

# What is Nested Virtualization for Hyper-V?

...
slug: virtualization-non-uniform-memory-access
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/manage/non-uniform-memory-access
family: virtualization
documentKind: "concept-article"
abstract: "Learn how NUMA in Hyper-V can optimize memory access and performance of virtual machines running on NUMA-enabled hardware."
---

# NUMA and Virtual Machines in Hyper-V

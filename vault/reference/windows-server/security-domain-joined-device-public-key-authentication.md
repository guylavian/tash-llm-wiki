...
slug: security-domain-joined-device-public-key-authentication
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/kerberos/domain-joined-device-public-key-authentication
family: security
documentKind: "concept-article"
abstract: "Learn more about: Domain-joined Device Public Key Authentication"
---

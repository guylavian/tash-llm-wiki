...
slug: administration-label
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/label
family: administration
documentKind: "reference"
abstract: "Reference article for the label command, which creates, changes, or deletes the volume label (that is, the name) of a disk."
---

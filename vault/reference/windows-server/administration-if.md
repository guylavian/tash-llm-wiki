...
slug: administration-if
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/if
family: administration
documentKind: "reference"
abstract: "Reference article for the if command, which performs conditional processing in batch programs."
---

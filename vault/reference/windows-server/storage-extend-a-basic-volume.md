...
slug: storage-extend-a-basic-volume
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/disk-management/extend-a-basic-volume
family: storage
documentKind: "how-to"
abstract: "Extend a basic or dynamic volume in Windows or Windows Server. Use Disk Management or PowerShell to add unallocated space to a volume."
---

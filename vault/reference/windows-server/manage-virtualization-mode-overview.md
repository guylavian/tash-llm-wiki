...
slug: manage-virtualization-mode-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/virtualization-mode-overview
family: manage
documentKind: "overview"
abstract: "Learn what Windows Admin Center Virtualization Mode is. See how it differs from administration mode, the scale it supports, setup needs, upkeep, and built-in tools for large environments."
---

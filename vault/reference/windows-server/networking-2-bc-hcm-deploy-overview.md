...
slug: networking-2-bc-hcm-deploy-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/bc-hcm/2-Bc-Hcm-Deploy-Overview
family: networking
documentKind: "concept-article"
abstract: "Learn how to deploy a BranchCache hosted cache server in a branch office where computers are joined to a domain."
---

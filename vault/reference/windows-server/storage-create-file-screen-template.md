...
slug: storage-create-file-screen-template
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/fsrm/create-file-screen-template
family: storage
documentKind: "how-to"
abstract: "This article describes how to create a file screen template"
---

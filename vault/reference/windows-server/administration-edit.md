...
slug: administration-edit
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/edit
family: administration
documentKind: "reference"
abstract: "Reference article for the edit command, which starts the MS-DOS Editor, so you can create and change ASCII text files."
---

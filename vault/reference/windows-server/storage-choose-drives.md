...
slug: storage-choose-drives
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/choose-drives
family: storage
documentKind: "concept-article"
abstract: "How to choose drives for Azure Local and Windows Server clusters to meet performance and capacity requirements."
---

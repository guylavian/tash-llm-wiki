...
slug: manage-create-connection-provider
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/extend/guides/create-connection-provider
family: manage
documentKind: "how-to"
abstract: "Develop a solution extension Windows Admin Center SDK (Project Honolulu) - create a connection provider"
---

...
slug: get-started-extended-security-updates-deploy
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/extended-security-updates-deploy
family: get-started
documentKind: "how-to"
abstract: "Learn how to get Extended Security Updates (ESU) for Windows Server 2012, and Windows Server 2012 R2 after the end of their support lifecycle."
---

# How to get Extended Security Updates (ESU) for Windows Server 2012, and 2012 R2

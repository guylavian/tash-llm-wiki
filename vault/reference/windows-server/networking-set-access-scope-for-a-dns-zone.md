...
slug: networking-set-access-scope-for-a-dns-zone
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/ipam/Set-Access-Scope-for-a-DNS-Zone
family: networking
documentKind: "how-to"
abstract: "Learn how to set the access scope for a DNS zone by using the IPAM client console."
---

...
slug: administration-create-volume-stripe
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/create-volume-stripe
family: administration
documentKind: "reference"
abstract: "Reference article for the create volume stripe command, which creates a striped volume using two or more specified dynamic disks."
---

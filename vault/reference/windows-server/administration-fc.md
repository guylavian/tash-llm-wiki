...
slug: administration-fc
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/fc
family: administration
documentKind: "reference"
abstract: "Reference article for the fc command, which compares two files or sets of files and displays the differences between them."
---

...
slug: get-started-windows-server-pay-as-you-go
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/get-started/windows-server-pay-as-you-go
family: get-started
documentKind: "how-to"
abstract: "Set up usage-based licensing for Windows Server with Pay-as-you-go licensing with Azure Arc billed through your Azure subscription."
---

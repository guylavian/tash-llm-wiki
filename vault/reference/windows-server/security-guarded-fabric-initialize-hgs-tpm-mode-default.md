...
slug: security-guarded-fabric-initialize-hgs-tpm-mode-default
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-initialize-hgs-tpm-mode-default
family: security
documentKind: "how-to"
abstract: "Learn more about: Initialize the HGS cluster using TPM mode in a new dedicated forest (default)"
---

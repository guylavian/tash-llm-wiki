...
slug: virtualization-use-local-resources-virtual-machine-connection
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/use-local-resources-virtual-machine-connection
family: virtualization
documentKind: "how-to"
abstract: "Describes the requirements for using local resources with Virtual Machine Connection (VMConnect) on Hyper-V."
---

# Use local resources on Hyper-V with VMConnect

...
slug: networking-verify-client-computer-settings
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/branchcache/deploy/Verify-Client-Computer-Settings
family: networking
documentKind: "how-to"
abstract: "Learn how to verify that the client computer is correctly configured for BranchCache."
---

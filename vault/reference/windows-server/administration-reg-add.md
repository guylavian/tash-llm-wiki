...
slug: administration-reg-add
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/reg-add
family: administration
documentKind: "reference"
abstract: "Reference article for the reg add command, which adds a new subkey or entry to the registry."
---

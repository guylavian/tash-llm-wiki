...
slug: remote-remote-desktop-connection-single-sign-on
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/remotepc/remote-desktop-connection-single-sign-on
family: remote
documentKind: "how-to"
abstract: "Learn how to connect to remote PCs seamlessly with Microsoft Entra single sign-on authentication using Remote Desktop Connection (MSTSC). Follow our step-by-step guide."
---

# Connect to a Remote PC with Single Sign-On Using Microsoft Entra Authentication

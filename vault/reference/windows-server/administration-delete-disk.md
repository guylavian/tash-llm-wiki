...
slug: administration-delete-disk
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/delete-disk
family: administration
documentKind: "reference"
abstract: "Reference article for the delete disk command, which deletes a missing dynamic disk from the list of disks."
---

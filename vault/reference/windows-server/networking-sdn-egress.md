...
slug: networking-sdn-egress
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/sdn/manage/sdn-egress
family: networking
documentKind: "how-to"
abstract: "A fundamental aspect of cloud networking monetization is network bandwidth egress, for example, outbound data transfers in the Microsoft Azure business model. Outbound data is charged based on the total amount of data moving out of the Azure datacenters via the internet in a given billing cycle."
---

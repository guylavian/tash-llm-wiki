...
slug: networking-dns-logging-and-diagnostics
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/dns-logging-and-diagnostics
family: networking
documentKind: "how-to"
abstract: "Learn how to enable enhanced DNS logging, auditing, and analytic events for the DNS Server role in Windows Server."
---

# Enable DNS Logging and Diagnostics in Windows Server

...
slug: networking-windows-server-2016-improvements
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/windows-time-service/windows-server-2016-improvements
family: networking
documentKind: "how-to"
abstract: "Windows Server 2016 has improved the algorithms it uses to correct time and condition the local clock to synchronize with UTC."
---

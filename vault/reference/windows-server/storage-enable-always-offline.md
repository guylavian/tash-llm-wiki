...
slug: storage-enable-always-offline
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/folder-redirection/enable-always-offline
family: storage
documentKind: "how-to"
abstract: "Step-by-step guide to enable Always Offline mode of Offline Files to provide faster access to cached files and redirected folders."
---

# Enable Always Offline mode for faster access to files in Windows and Windows Server

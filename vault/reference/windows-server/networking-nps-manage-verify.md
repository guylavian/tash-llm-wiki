...
slug: networking-nps-manage-verify
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-manage-verify
family: networking
documentKind: "how-to"
abstract: "You can use this topic to verify Windows Server 2016 Network Policy Server configuration after an IP address or name change to the server."
---

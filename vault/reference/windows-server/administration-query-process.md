...
slug: administration-query-process
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/query-process
family: administration
documentKind: "reference"
abstract: "Reference article for the query process command, which displays information about processes that are running on a Remote Desktop Session Host server."
---

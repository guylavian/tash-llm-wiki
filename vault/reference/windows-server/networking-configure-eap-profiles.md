...
slug: networking-configure-eap-profiles
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/extensible-authentication-protocol/configure-eap-profiles
family: networking
documentKind: "concept-article"
abstract: "This article presents information about different ways to configure Extensible Authentication Protocol (EAP) settings."
---
...
Selecting **Add** and then selecting **Infrastructure** opens the **New Profile properties** dialog:

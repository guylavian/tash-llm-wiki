...
slug: manage-azure-update-management
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/azure/azure-update-management
family: manage
documentKind: "how-to"
abstract: "Use Windows Admin Center (Project Honolulu) to set up Azure Update Management to manage OS updates."
---

...
slug: networking-nps-firewalls-configure
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-firewalls-configure
family: networking
documentKind: "how-to"
abstract: "This topic provides an overview of how to configure firewalls to allow RADIUS traffic for Network Policy Server in Windows Server 2016."
---

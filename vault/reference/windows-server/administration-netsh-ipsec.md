...
slug: administration-netsh-ipsec
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netsh-ipsec
family: administration
documentKind: "reference"
abstract: "The netsh ipsec command is a suite of commands that configures and manages Internet Protocol Security (IPsec) policies and settings in Windows."
---

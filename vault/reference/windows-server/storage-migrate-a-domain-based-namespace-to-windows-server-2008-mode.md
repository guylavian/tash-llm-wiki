...
slug: storage-migrate-a-domain-based-namespace-to-windows-server-2008-mode
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/dfs-namespaces/migrate-a-domain-based-namespace-to-windows-server-2008-mode
family: storage
documentKind: "upgrade-and-migration-article"
abstract: "This article describes how to migrate a domain-based namespace to Windows Server 2008 mode"
---

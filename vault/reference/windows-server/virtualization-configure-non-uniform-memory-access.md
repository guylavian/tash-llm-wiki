...
slug: virtualization-configure-non-uniform-memory-access
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/manage/configure-non-uniform-memory-access
family: virtualization
documentKind: "how-to"
abstract: "Learn how to configure NUMA in Hyper-V to optimize memory access and performance of virtual machines running on NUMA-enabled hardware."
---

# Configure NUMA to Optimize Hyper-V Memory

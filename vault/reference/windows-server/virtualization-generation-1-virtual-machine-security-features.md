...
slug: virtualization-generation-1-virtual-machine-security-features
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/generation-1-virtual-machine-security-features
family: virtualization
documentKind: "concept-article"
abstract: "Describes the security settings available in Hyper-V Manager for generation 1 virtual machines"
---

# Generation 1 virtual machine security settings for Hyper-V

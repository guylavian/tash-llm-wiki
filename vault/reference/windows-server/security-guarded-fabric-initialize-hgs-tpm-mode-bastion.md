...
slug: security-guarded-fabric-initialize-hgs-tpm-mode-bastion
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-initialize-hgs-tpm-mode-bastion
family: security
documentKind: "how-to"
abstract: "Learn more about: Initialize the HGS cluster using TPM mode in an existing bastion forest"
---

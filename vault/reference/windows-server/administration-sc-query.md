...
slug: administration-sc-query
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/sc-query
family: administration
documentKind: "reference"
abstract: "Reference article for the sc.exe query command, which obtains and displays information about the specified service, driver, type of service, or type of driver."
---

...
slug: manage-using-extensions
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/configure/using-extensions
family: manage
documentKind: "install-set-up-deploy"
abstract: "Install and Manage Extensions in Windows Admin Center (Project Honolulu)"
---
...
> [!IMPORTANT]
> If outbound connectivity is restricted by your firewall or proxy server, make sure your [network URLs are configured properly](/windows-server/manage/windows-admin-center/deploy/network-requirements). If your network isn't configured properly, you won't receive extension updates.

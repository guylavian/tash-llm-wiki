...
slug: networking-set-access-scope-for-dns-resource-records
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/ipam/Set-Access-Scope-for-DNS-Resource-Records
family: networking
documentKind: "how-to"
abstract: "Learn how to set the access scope for a DNS resource records by using the IPAM client console."
---

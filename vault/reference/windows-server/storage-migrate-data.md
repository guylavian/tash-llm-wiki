...
slug: storage-migrate-data
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-migration-service/migrate-data
family: storage
documentKind: "upgrade-and-migration-article"
abstract: "Learn how to install Storage Migration Service, and use the service and Windows Admin Center to migrate to a Windows server or Windows Failover Cluster."
---

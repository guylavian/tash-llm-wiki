...
slug: remote-vpn-device-tunnel-config
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/vpn/vpn-device-tunnel-config
family: remote
documentKind: "how-to"
abstract: "Learn how to create a VPN device tunnel in Windows client."
---

...
slug: storage-quorum
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/quorum
family: storage
documentKind: "concept-article"
abstract: "Understanding cluster and pool quorum in Storage Spaces Direct on Azure Local and Windows Server clusters, with specific examples to go over the intricacies."
---

# Understand cluster and pool quorum on Azure Local and Windows Server clusters

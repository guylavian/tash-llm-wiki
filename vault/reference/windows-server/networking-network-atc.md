...
slug: networking-network-atc
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/network-atc/network-atc
family: networking
documentKind: "how-to"
abstract: "Learn how to deploy host networking with Network ATC for Windows Server and Azure Local clusters. Simplify network configuration management using intent-based automation for compute, storage, and management networks."
---

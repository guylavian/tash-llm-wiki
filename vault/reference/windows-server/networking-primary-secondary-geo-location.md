...
slug: networking-primary-secondary-geo-location
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/deploy/primary-secondary-geo-location
family: networking
documentKind: "how-to"
abstract: "Learn how to create DNS policy for geo-location based traffic management when your DNS deployment includes both primary and secondary DNS servers."
---

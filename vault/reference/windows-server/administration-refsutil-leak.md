...
slug: administration-refsutil-leak
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/refsutil-leak
family: administration
documentKind: "reference"
abstract: "Reference article for the refsutil leak tool, which detects and diagnoses storage leaks, revealing their location and size to optimize storage usage on a specified Resilient File System (ReFS) volume in Windows."
---

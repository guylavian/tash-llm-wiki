...
slug: administration-query-user
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/query-user
family: administration
documentKind: "reference"
abstract: "Reference article for the query user command, which displays information about user sessions on a Remote Desktop Session Host server."
---

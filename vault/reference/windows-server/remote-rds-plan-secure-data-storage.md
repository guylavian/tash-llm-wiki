...
slug: remote-rds-plan-secure-data-storage
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/rds-plan-secure-data-storage
family: remote
documentKind: "concept-article"
abstract: "Planning information for securely storing data by using user profile disks (UPDs) in RDS."
---

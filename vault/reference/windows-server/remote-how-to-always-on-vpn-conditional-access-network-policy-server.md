...
slug: remote-how-to-always-on-vpn-conditional-access-network-policy-server
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/how-to-always-on-vpn-conditional-access-network-policy-server
family: remote
documentKind: "how-to"
abstract: "Learn how to configure VPN conditional access on the Network Policy Server (NPS)"
---

# Configure VPN conditional access on the Network Policy Server (NPS) on Windows Server

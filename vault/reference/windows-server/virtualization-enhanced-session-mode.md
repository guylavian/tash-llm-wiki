...
slug: virtualization-enhanced-session-mode
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/enhanced-session-mode
family: virtualization
documentKind: "how-to"
abstract: "See how to share devices with Hyper-V virtual machines. Find out how to give a virtual machine access to USB devices, audio, microphones, and mounted drives."
---

# Share devices with Hyper-V Windows virtual machines

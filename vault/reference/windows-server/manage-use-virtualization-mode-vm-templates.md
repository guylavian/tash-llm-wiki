...
slug: manage-use-virtualization-mode-vm-templates
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/use-virtualization-mode-vm-templates
family: manage
documentKind: "how-to"
abstract: "Learn how to convert VMs to templates, deploy new VMs from templates, and convert templates back to VMs in Windows Admin Center Virtualization Mode."
---

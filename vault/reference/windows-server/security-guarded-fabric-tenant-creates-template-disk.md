...
slug: security-guarded-fabric-tenant-creates-template-disk
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/guarded-fabric-shielded-vm/guarded-fabric-tenant-creates-template-disk
family: security
documentKind: "how-to"
abstract: "Learn more about: Shielded VMs for tenants - Creating a template disk (optional)"
---

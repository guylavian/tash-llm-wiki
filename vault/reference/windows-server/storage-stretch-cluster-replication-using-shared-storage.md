...
slug: storage-stretch-cluster-replication-using-shared-storage
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-replica/Stretch-Cluster-Replication-Using-Shared-Storage
family: storage
documentKind: "how-to"
abstract: "Stretch cluster replication using shared storage"
---

# Configure Stretch Cluster Replication using shared storage in Windows Server

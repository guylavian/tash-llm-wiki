...
slug: administration-sc-create
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/sc-create
family: administration
documentKind: "reference"
abstract: "Reference article for the sc.exe create command, which creates a subkey and entries for a service in the registry and in the Service Control Manager database."
---

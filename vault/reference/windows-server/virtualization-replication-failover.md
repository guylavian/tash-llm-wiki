...
slug: virtualization-replication-failover
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/replication-failover
family: virtualization
documentKind: "how-to"
abstract: "Learn how to fail over a replicated virtual machine between Hyper-V hosts using Hyper-V Replica."
---

# Fail over a virtual machine with Hyper-V Replica

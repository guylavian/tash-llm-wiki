...
slug: administration-set-option
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/set-option
family: administration
documentKind: "reference"
abstract: "Reference article for the set option command, which sets the options for shadow copy creation."
---

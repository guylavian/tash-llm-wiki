...
slug: storage-create-volumes
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/create-volumes
family: storage
documentKind: "how-to"
abstract: "How to create volumes on Azure Local and Windows Server clusters by using Windows Admin Center and PowerShell."
---

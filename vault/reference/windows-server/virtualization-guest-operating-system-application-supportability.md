...
slug: virtualization-guest-operating-system-application-supportability
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/plan/guest-operating-system-application-supportability
family: virtualization
documentKind: "concept-article"
abstract: "Understand which versions of Windows Server or Azure Local are compatible products for a guest operating system or application that has been validated for Hyper-V."
---

...
slug: administration-netdom-add
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netdom-add
family: administration
documentKind: "reference"
abstract: "Netdom add is a command-line utility that adds a workstation or server account to a domain in Windows Server."
---

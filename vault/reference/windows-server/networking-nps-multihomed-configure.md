...
slug: networking-nps-multihomed-configure
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/nps/nps-multihomed-configure
family: networking
documentKind: "how-to"
abstract: "This topic provides instructions on configuring a server with multiple network adapters that is running Network Policy Server in Windows Server 2016."
---

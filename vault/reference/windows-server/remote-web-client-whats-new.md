...
slug: remote-web-client-whats-new
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/web-client-whats-new
family: remote
documentKind: "whats-new"
abstract: "Learn about recent changes to the Remote Desktop web client, including new features, improvements, and fixes. Discover what's new and stay updated."
---

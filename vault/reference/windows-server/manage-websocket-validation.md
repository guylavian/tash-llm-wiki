...
slug: manage-websocket-validation
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/configure/websocket-validation
family: manage
documentKind: "concept-article"
abstract: "Learn how administrators can customize the WebSocket validation for their Windows Admin Center (Project Honolulu) instance."
---

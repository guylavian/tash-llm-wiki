...
slug: administration-select-disk
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/select-disk
family: administration
documentKind: "reference"
abstract: "Reference article for the select disk command, which selects the specified disk and then shifts focus to it."
---

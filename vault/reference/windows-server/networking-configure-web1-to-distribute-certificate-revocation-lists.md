...
slug: networking-configure-web1-to-distribute-certificate-revocation-lists
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/server-certs/Configure-WEB1-to-Distribute-Certificate-Revocation-Lists
family: networking
documentKind: "how-to"
abstract: "Learn how to configure the web server WEB1 to distribute CRLs."
---

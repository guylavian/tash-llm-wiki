...
slug: administration-wbadmin-start-backup
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/wbadmin-start-backup
family: administration
documentKind: "reference"
abstract: "Reference article for the wbadmin start backup command, which creates a backup using specified parameters."
---

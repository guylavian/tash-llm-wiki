...
slug: administration-verifier
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/verifier
family: administration
documentKind: "reference"
abstract: "Reference article for the verifier command, which runs the Driver Verifier manager utility."
---
...
| /flags `<volatileoptions>` | Specifies the Driver Verifier utility options that are changed immediately without rebooting.This number can be entered in decimal or in hexadecimal (with an 0x prefix) format. Any combination of the following values is allowed:<ul><li>**Value: 1 or 0x1 (bit 0)** - Special pool</li><li>**Value: 2 or 0x2 (bit 1)** - Force IRQL Checking</li><li>**Value: 4 or 0x4 (bit 2)** - Low Resources Simulation</li></ul> |

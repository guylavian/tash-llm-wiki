...
slug: administration-whoami
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/whoami
family: administration
documentKind: "reference"
abstract: "Reference article for whoami, which displays user, group and privileges information for the user who is currently logged on to the local system."
---

...
slug: storage-understand-storage-resync
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/understand-storage-resync
family: storage
documentKind: "concept-article"
abstract: "This article provides information on when storage resync happens and how to monitor it in Windows Server."
---

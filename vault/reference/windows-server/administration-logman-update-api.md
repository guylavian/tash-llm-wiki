...
slug: administration-logman-update-api
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/logman-update-api
family: administration
documentKind: "reference"
abstract: "Reference article for the logman update api command, which updates the properties of an existing API tracking data collector."
---

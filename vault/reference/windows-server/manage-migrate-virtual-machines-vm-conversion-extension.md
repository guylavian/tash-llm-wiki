...
slug: manage-migrate-virtual-machines-vm-conversion-extension
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/use/migrate-virtual-machines-vm-conversion-extension
family: manage
documentKind: "how-to"
abstract: "Discover how to install and use the VM Conversion extension to seamlessly migrate VMware VMs to Hyper-V with Windows Admin Center."
---

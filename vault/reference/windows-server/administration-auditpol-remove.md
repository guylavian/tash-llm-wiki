...
slug: administration-auditpol-remove
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/auditpol-remove
family: administration
documentKind: "reference"
abstract: "Reference article for the auditpol remove command; auditpol removes the per-user audit policy for a specified account or all accounts."
---

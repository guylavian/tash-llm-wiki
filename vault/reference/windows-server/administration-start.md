...
slug: administration-start
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/start
family: administration
documentKind: "reference"
abstract: "Reference article for the start command, which starts a separate Command Prompt window to run a specified program or command."
---

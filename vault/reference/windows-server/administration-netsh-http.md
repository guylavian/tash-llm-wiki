...
slug: administration-netsh-http
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/netsh-http
family: administration
documentKind: "reference"
abstract: "The netsh http command configures and manages HTTP traffic for applications and system components for the HTTP Service in Windows."
---

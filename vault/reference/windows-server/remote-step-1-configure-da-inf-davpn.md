...
slug: remote-step-1-configure-da-inf-davpn
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/directaccess/add-to-existing-vpn/step-1-configure-da-inf-davpn
family: remote
documentKind: "how-to"
abstract: "Learn how to configure the infrastructure required for enabling DirectAccess in an existing VPN deployment."
---

...
slug: administration-windows-server-container
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/performance-tuning/role/windows-server-container
family: administration
documentKind: "best-practice"
abstract: "Performance tuning recommendations for containers on Windows Server 2022"
---
...
Windows Server Containers and Hyper-V Containers offer support for Server Core, learn more about the [container base image options](/virtualization/windowscontainers/manage-containers/container-base-images).

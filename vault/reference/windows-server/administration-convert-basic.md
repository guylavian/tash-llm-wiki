...
slug: administration-convert-basic
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/convert-basic
family: administration
documentKind: "reference"
abstract: "Reference article for the convert basic command, which converts an empty dynamic disk to a basic disk."
---

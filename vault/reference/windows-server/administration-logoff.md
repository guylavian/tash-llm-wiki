...
slug: administration-logoff
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/logoff
family: administration
documentKind: "reference"
abstract: "Reference article for the logoff command, which logs off a user from a session on a Remote Desktop Session Host server and deletes the session."
---

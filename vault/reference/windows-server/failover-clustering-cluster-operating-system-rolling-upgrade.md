...
slug: failover-clustering-cluster-operating-system-rolling-upgrade
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/failover-clustering/Cluster-Operating-System-Rolling-Upgrade
family: failover-clustering
documentKind: "how-to"
abstract: "Manually upgrade the operating system of a Windows Server failover cluster without stopping workloads by upgrading one node at a time in a rolling OS upgrade. This article describes the stages of the rolling upgrade process, limitations, and frequently asked questions (FAQs)."
---

# Upgrade the OS of a Windows Server failover cluster by performing a cluster OS rolling upgrade

...
slug: virtualization-features-terminology
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/features-terminology
family: virtualization
documentKind: "how-to"
abstract: "Discover key Hyper-V features and terminology for Windows Server and Windows. Learn about virtual machine generations, processor compatibility, memory management, security features, storage options, networking capabilities, and more."
---

# Hyper-V Features and Terminology Overview

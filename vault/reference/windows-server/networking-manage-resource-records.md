...
slug: networking-manage-resource-records
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/dns/manage-resource-records
family: networking
documentKind: "quickstart"
abstract: "Learn more about how to manage DNS resource records on Windows Server."
---

# Manage DNS resource records using DNS server on Windows Server

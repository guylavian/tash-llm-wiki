...
slug: security-user-account-control-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/user-account-control/user-account-control-overview
family: security
documentKind: "concept-article"
abstract: "Learn about User Account Control, how it is a fundamental component of Microsoft's overall security vision, and how it helps mitigate the impact of a malicious program."
---

...
slug: administration-change-logon
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/change-logon
family: administration
documentKind: "reference"
abstract: "Reference article for the change logon command, which enables or disables logons from client sessions, or displays current logon status."
---

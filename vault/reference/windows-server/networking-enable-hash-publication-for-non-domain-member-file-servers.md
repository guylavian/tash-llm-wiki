...
slug: networking-enable-hash-publication-for-non-domain-member-file-servers
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/branchcache/deploy/Enable-Hash-Publication-for-Non-Domain-Member-File-Servers
family: networking
documentKind: "how-to"
abstract: "Learn how to configure hash publication for BranchCache using local computer Group Policy on a file server with the BranchCache for Network Files role service of the File Services server role installed."
---

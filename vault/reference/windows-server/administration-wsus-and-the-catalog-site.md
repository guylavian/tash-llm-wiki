...
slug: administration-wsus-and-the-catalog-site
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-server-update-services/manage/wsus-and-the-catalog-site
family: administration
documentKind: "how-to"
abstract: "Windows Server Update Service (WSUS) article - How to import updates into WSUS using PowerShell and the Microsoft Update Catalog."
---

...
slug: remote-monitor-the-operations-status-of-the-remote-access-server-and-its-components
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/remote/remote-access/ras/monitoring-and-accounting/Monitor-the-operations-status-of-the-Remote-Access-server-and-its-components
family: remote
documentKind: "how-to"
abstract: "Learn how to use the management console in the Remote Access server to monitor its operations status."
---

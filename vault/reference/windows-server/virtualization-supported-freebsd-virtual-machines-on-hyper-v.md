...
slug: virtualization-supported-freebsd-virtual-machines-on-hyper-v
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/Supported-FreeBSD-virtual-machines-on-Hyper-V
family: virtualization
documentKind: "concept-article"
abstract: "Lists the FreeBSD/Linux integration services and features included in each version"
---

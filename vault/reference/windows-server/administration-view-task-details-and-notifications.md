...
slug: administration-view-task-details-and-notifications
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/server-manager/view-task-details-and-notifications
family: administration
documentKind: "how-to"
abstract: "Learn how to view the status of user tasks or requests, see if a task failed, and troubleshoot problems by accessing detailed error messages about task failures."
---

...
slug: virtualization-maximum-scale-limits
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/maximum-scale-limits
family: virtualization
documentKind: "limits-and-quotas"
abstract: "View Hyper-V maximum scale limits for virtual machines and hosts in Windows Server. Use them to plan capacity and support demanding workloads."
---

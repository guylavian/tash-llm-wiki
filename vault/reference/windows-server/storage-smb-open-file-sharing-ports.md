...
slug: storage-smb-open-file-sharing-ports
tier: reference
...
family: storage
documentKind: "troubleshooting-problem-resolution"
abstract: "Learn how to keep file and printer sharing ports open for Server Message Block (SMB)-based network services and resolve the Best Practices Analyzer scan issue."
---

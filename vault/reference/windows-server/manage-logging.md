...
slug: manage-logging
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/manage/windows-admin-center/use/logging
family: manage
documentKind: "concept-article"
abstract: "Learn about event logging in Windows Admin Center."
---

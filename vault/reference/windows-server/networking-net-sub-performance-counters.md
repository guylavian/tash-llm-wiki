...
slug: networking-net-sub-performance-counters
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/technologies/network-subsystem/net-sub-performance-counters
family: networking
documentKind: "concept-article"
abstract: "Learn about the counters that are relevant to managing network performance."
---

...
slug: storage-manage-virtual-hard-disks
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/disk-management/manage-virtual-hard-disks
family: storage
documentKind: "how-to"
abstract: "Manage virtual hard disks (VHDs) with the Disk Management utility in Windows, where you can view, create, attach, and detach a VHD."
---

...
slug: security-ntlm-overview
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/security/kerberos/ntlm-overview
family: security
documentKind: "concept-article"
abstract: "Learn about NTLM, and find links to technical resources to Windows Authentication and NTLM for Windows Server."
---

# NTLM overview in Windows Server

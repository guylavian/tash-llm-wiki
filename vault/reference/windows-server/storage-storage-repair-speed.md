...
slug: storage-storage-repair-speed
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/storage-repair-speed
family: storage
documentKind: "how-to"
abstract: "How to adjust storage repair speed in Azure Local and Windows Server clusters by using Windows Admin Center or PowerShell."
---

# Adjust storage repair speed in Azure Local and Windows Server clusters

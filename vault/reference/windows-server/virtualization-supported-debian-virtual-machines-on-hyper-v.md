...
slug: virtualization-supported-debian-virtual-machines-on-hyper-v
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/Supported-Debian-virtual-machines-on-Hyper-V
family: virtualization
documentKind: "concept-article"
abstract: "Learn about the Debian and Linux integration services and features included in each version and known issues and workarounds for each distribution."
---

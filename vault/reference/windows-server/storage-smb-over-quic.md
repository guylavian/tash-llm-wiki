...
slug: storage-smb-over-quic
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/file-server/smb-over-quic
family: storage
documentKind: "how-to"
abstract: "Learn about SMB over QUIC, a secure alternative to TCP for file sharing in Windows and Windows Server that enables encrypted access to file servers over untrusted networks."
---

...
slug: administration-nbtstat
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/nbtstat
family: administration
documentKind: "reference"
abstract: "Reference article for the nbtstat command, which displays NetBIOS over TCP/IP (NetBT) protocol statistics, NetBIOS name tables for both the local computer and remote computers, and the NetBIOS name cache."
---

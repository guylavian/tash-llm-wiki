...
slug: networking-configure-server-certificate-auto-enrollment
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/networking/core-network-guide/cncg/server-certs/configure-server-certificate-auto-enrollment
family: networking
documentKind: "how-to"
abstract: "Learn how to configure server and user certificate auto-enrollment for NPS using Group Policy. Ensure secure, automated certificate management."
---

# Configure Certificate Auto-Enrollment for Network Policy Server

...
slug: administration-nslookup-set-type
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/nslookup-set-type
family: administration
documentKind: "reference"
abstract: "Reference article for the nslookup set type command, which changes the resource record type for the query."
---

...
slug: storage-smb-ntlm-blocking
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/file-server/smb-ntlm-blocking
family: storage
documentKind: "how-to"
abstract: "Learn how to make SMB more secure by blocking NTLM."
---

# Block NTLM connections on SMB in Windows Server 2025

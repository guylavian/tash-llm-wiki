...
slug: storage-server-to-server-storage-replication
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-replica/server-to-server-storage-replication
family: storage
documentKind: "how-to"
abstract: "Learn how to set up and use Storage Replica for server-to-server replication in Windows Server by using Windows Admin Center or PowerShell."
---

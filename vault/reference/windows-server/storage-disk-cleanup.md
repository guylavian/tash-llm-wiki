...
slug: storage-disk-cleanup
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/file-server/disk-cleanup
family: storage
documentKind: "how-to"
abstract: "Learn how to use command-line options to configure the Disk Cleanup tool (Cleanmgr.exe) to automatically clear certain files."
---

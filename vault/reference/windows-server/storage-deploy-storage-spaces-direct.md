...
slug: storage-deploy-storage-spaces-direct
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/storage/storage-spaces/deploy-storage-spaces-direct
family: storage
documentKind: "how-to"
abstract: "Step-by-step instructions to deploy software-defined storage with Storage Spaces Direct in Windows Server as either hyperconverged infrastructure or converged (also known as disaggregated) infrastructure."
---

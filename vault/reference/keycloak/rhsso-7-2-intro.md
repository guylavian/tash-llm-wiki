---
title: "Chapter 1. Introduction - Red Hat Single Sign-On 7.2 Upgrading Guide"
type: reference
domain: keycloak
slug: rhsso-7-2-intro
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.2/html/upgrading_guide/intro
...
The purpose of this guide is to document the steps that are required to successfully upgrade from Red Hat Single Sign-On 7.1 to Red Hat Single Sign-On 7.2.
1.1. About Upgrades

---
title: "Chapter 7. Evaluating and testing policies - Red Hat build of Keycloak 26.4 Authorization Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-policy-evaluation-overview
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/authorization_services_guide/policy_evaluation_overview
...
# Chapter 7. Evaluating and testing policies - Red Hat build of Keycloak 26.4 Authorization Services Guide

---
title: "Chapter 1. Preface - Red Hat build of Keycloak 26.6 Server Developer Guide"
type: reference
domain: keycloak
slug: rhbk-26-6-preface
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.6/html/server_developer_guide/preface
...
The official Red Hat build of Keycloak container image uses OpenJDK {jdk_version_container} as the Java runtime environment. Consider this when writing custom extensions.
1.2. Example Listings

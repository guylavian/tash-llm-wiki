---
title: "Chapter 3. Themes - Red Hat Single Sign-On 7.0 Server Developer Guide"
type: reference
domain: keycloak
slug: rhsso-7-0-themes
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.0/html/server_developer_guide/themes
...
# Chapter 3. Themes - Red Hat Single Sign-On 7.0 Server Developer Guide
...
3.2. Configure Theme
All theme types, except welcome, is configured through the Admin Console
...
To change the welcome theme you need to edit keycloak-server.json
(in standalone/configuration
or domain/servers/{server name}/configuration
...
directory without restarting Red Hat Single Sign-On. To do this edit standalone/configuration/keycloak-server.json
for theme
set staticMaxAge
to -1
...
You also need to register the module with Red Hat Single Sign-On. This is done by editing keycloak-server.json
(in standalone/configuration
or domain/servers/{server name}/configuration

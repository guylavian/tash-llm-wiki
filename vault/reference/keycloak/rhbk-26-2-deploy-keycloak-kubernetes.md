---
title: "Chapter 10. Deploying Red Hat build of Keycloak for HA with the Operator - Red Hat build of Keycloak 26.2 High Availability Guide"
type: reference
domain: keycloak
slug: rhbk-26-2-deploy-keycloak-kubernetes
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.2/html/high_availability_guide/deploy-keycloak-kubernetes-
...
further because multiple concurrent threads will lead to throttling by Kubernetes once the requested CPU limit is reached.

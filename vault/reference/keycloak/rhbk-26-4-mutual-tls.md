---
title: "Chapter 13. Configuring trusted certificates for mTLS - Red Hat build of Keycloak 26.4 Server Configuration Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-mutual-tls
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/server_configuration_guide/mutual-tls-
...
# Chapter 13. Configuring trusted certificates for mTLS - Red Hat build of Keycloak 26.4 Server Configuration Guide
...
, and.pem
for a pem file
If your truststore does not have an extension matching its file type, you will also need to set the https-key-store-type
option.

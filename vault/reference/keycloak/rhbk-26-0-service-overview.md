---
title: "Chapter 8. Authorization services - Red Hat build of Keycloak 26.0 Authorization Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-0-service-overview
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.0/html/authorization_services_guide/service_overview
...
Where ${host}:${port}
is the hostname (or IP address) and port where Red Hat build of Keycloak is running and ${realm}

---
title: "Chapter 2. Migrating a Red Hat Single Sign-On 7.6 server - Red Hat build of Keycloak 26.2 Migration Guide"
type: reference
domain: keycloak
slug: rhbk-26-2-migrating-server
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.2/html/migration_guide/migrating-server
guide: migration_guide
version: 26.2
family: rhbk
documentKind: "Documentation"
abstract: "This section provides instructions for migrating a standalone server deployed from the ZIP distribution. Red Hat build of Keycloak 26.2 is built with Quarkus, which replaces the Red Hat JBoss Enterprise Application Platform (JBoss EAP) that was used by Red Hat Single Sign-On 7.6. The main changes to the server are the following: A revamped configuration experience, which is streamlined and support…"
---

# Chapter 2. Migrating a Red Hat Single Sign-On 7.6 server - Red Hat build of Keycloak 26.2 Migration Guide

Chapter 2. Migrating a Red Hat Single Sign-On 7.6 server
This section provides instructions for migrating a standalone server deployed from the ZIP distribution. Red Hat build of Keycloak 26.2 is built with Quarkus, which replaces the Red Hat JBoss Enterprise Application Platform (JBoss EAP) that was used by Red Hat Single Sign-On 7.6.
...
- You reviewed the Version 26.2 Release Notes.
...
All other transport stacks except kubernetes
are deprecated in 26.2. As of 26.4, kubernetes
is also deprecated. You should migrate your cache configuration to jdbc-ping
.
We recommend to set the jgroups.bind.address
system property to ensure that Red Hat build of Keycloak binds to the correct interface. In environments without transparent networking, set the system properties jgroups.external_port

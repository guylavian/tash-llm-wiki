---
title: "Chapter 12. Identity Brokering - Red Hat Single Sign-On 7.3 Server Administration Guide"
type: reference
domain: keycloak
slug: rhsso-7-3-identity-broker
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.3/html/server_administration_guide/identity_broker
...
# Chapter 12. Identity Brokering - Red Hat Single Sign-On 7.3 Server Administration Guide
...
page.
+ +Find the values of client ID
and secret
on this page and enter them into the Red Hat Single Sign-On Add Identity Provider page. Click Save
.
12.4.2. Facebook
...
12.4.11. StackOverflow
There are a number of steps you have to complete to be able to enable login with StackOverflow. First, go to the Identity Providers

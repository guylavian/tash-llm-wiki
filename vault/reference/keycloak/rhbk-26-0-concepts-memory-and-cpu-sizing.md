---
title: "Chapter 6. Concepts for sizing CPU and memory resources - Red Hat build of Keycloak 26.0 High Availability Guide"
type: reference
domain: keycloak
slug: rhbk-26-0-concepts-memory-and-cpu-sizing
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.0/html/high_availability_guide/concepts-memory-and-cpu-sizing-
...
6.1.1. Calculation example (single site)
Target size:
...
6.1.2. Sizing a multi-site setup

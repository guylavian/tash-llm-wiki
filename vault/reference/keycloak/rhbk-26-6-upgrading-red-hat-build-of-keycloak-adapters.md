---
title: "Chapter 4. Upgrading Red Hat build of Keycloak adapters - Red Hat build of Keycloak 26.6 Upgrading Guide"
type: reference
domain: keycloak
slug: rhbk-26-6-upgrading-red-hat-build-of-keycloak-adapters
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.6/html/upgrading_guide/upgrading_red_hat_build_of_keycloak_adapters
...
For this release of Red Hat build of Keycloak, the supported version of this adapter is 26.2.x. To upgrade a JavaScript adapter that has been copied to your web application, perform the following procedure.
Procedure
- Remove the previous version of the JavaScript adapter.
Use these NPM commands to install the 26.2.x version of the adapter:
npm config set @redhat:registry https://npm.registry.redhat.com npm install @redhat/keycloak-js@latest
4.4. Upgrading the Node.js adapter
For this release of Red Hat build of Keycloak, the supported version of this adapter is 26.1.1. To upgrade a Node.js adapter that has been copied to your web application, perform the following procedure.
Procedure

---
title: "Chapter 2. OpenID Connect - Red Hat Single Sign-On 7.1 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhsso-7-1-openid-connect-3
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.1/html/securing_applications_and_services_guide/openid_connect_3
...
# Chapter 2. OpenID Connect - Red Hat Single Sign-On 7.1 Securing Applications and Services Guide
...
Start JBoss Fuse 6.3.0 Rollup 2; then in the Karaf terminal type:
features:addurl mvn:org.keycloak/keycloak-osgi-features/2.5.5.Final-redhat-1/xml/features features:install keycloak
...
. However, upgrading to JBoss Fuse 6.3.0 Rollup 2 is recommended.- Ensure that the features were installed:
...
system
directory. You can overwrite all existing jar files.Use this for JBoss Fuse 6.3.0 Rollup 2:
cd /path-to-fuse/jboss-fuse-6.3.0.redhat-254 unzip -q /path-to-adapter-zip/rh-sso-7.1.0-fuse-adapter.zip
...
org.keycloak.adapters.jetty;version="2.5.5.Final-redhat-1", org.keycloak.adapters;version="2.5.5.Final-redhat-1", org.keycloak.constants;version="2.5.5.Final-redhat-1", org.keycloak.util;version="2.5.5.Final-redhat-1", org.keycloak.*;version="2.5.5.Final-redhat-1", *;resolution:=optional
...
must contain at least these imports:org.keycloak.adapters.jetty;version="2.5.5.Final-redhat-1", org.keycloak.adapters;version="2.5.5.Final-redhat-1", org.keycloak.constants;version="2.5.5.Final-redhat-1", org.keycloak.util;version="2.5.5.Final-redhat-1", org.keycloak.*;version="2.5.5.Final-redhat-1", *;resolution:=optional
...
JAAS realm with higher ranking. For details see the https:access.redhat.com/documentation/en-us/red_hat_jboss_fuse/6.3/html-single/security_guide/#ESBSecureContainer[JBoss Fuse documentation].Use these commands in the Fuse terminal:
features:addurl mvn:org.keycloak/keycloak-osgi-features/2.5.5.Final-redhat-1/xml/features features:install keycloak-jaas
Log in using SSH as
admin
...
algorithm, by default. However, by default, it is currently used in JBoss Fuse 6.3.0 Rollup 2.
...
file:hawtio.keycloakEnabled=true hawtio.realm=keycloak hawtio.keycloakClientConfig=${karaf.base}/etc/keycloak-hawtio-client.json hawtio.rolePrincipalClasses=org.keycloak.adapters.jaas.RolePrincipal,org.apache.karaf.jaas.boot.principal.RolePrincipal
-
...
Start JBoss Fuse 6.3.0 Rollup 2 and install the keycloak feature if you have not already done so. The commands in Karaf terminal are similar to this example:
features:addurl mvn:org.keycloak/keycloak-osgi-features/2.5.5.Final-redhat-1/xml/features features:install keycloak

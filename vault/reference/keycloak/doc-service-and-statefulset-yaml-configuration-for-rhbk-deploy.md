---
title: "Appendix C. Service and StatefulSet YAML configuration for Red Hat build of Keycloak - Red Hat Trusted Artifact Signer 1.1 Deployment Guide"
type: reference
domain: keycloak
slug: doc-service-and-statefulset-yaml-configuration-for-rhbk-deploy
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_trusted_artifact_signer/1.1/html/deployment_guide/service-and-statefulset-yaml-configuration-for-rhbk_deploy
guide: deployment_guide
documentKind: "Documentation"
abstract: "The Service and StatefulSet YAML resource configuration used when configuring Red Hat’s build of Keycloak (RHBK) for Red Hat’s Trusted Artifact Signer (RHTAS) service. --- apiVersion: v1 kind: Service metadata: name: postgresql-db namespace: keycloak-system spec: internalTrafficPolicy: Cluster ipFamilies: - IPv4 ipFamilyPolicy: SingleStack ports: - port: 5432 selector: app: postgresql-db --- apiVe…"
---

# Appendix C. Service and StatefulSet YAML configuration for Red Hat build of Keycloak - Red Hat Trusted Artifact Signer 1.1 Deployment Guide

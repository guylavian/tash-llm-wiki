---
title: "Configuring application pods before updating your {product-title} cluster"
type: reference
domain: openshift
slug: post-installation-configuration-4-22-update-cnf-update-prep
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/post_installation_configuration/update-cnf-update-prep
version: 4.22
...
In OpenShift Container Platform, processes can be automatically duplicated in separate pods in a deployment.

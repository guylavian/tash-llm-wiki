---
title: "Load balancing on {rh-openstack}"
type: reference
domain: openshift
slug: networking-4-22-load-balancing-openstack
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/networking/load-balancing-openstack
version: 4.22
family: networking
...
[role="_abstract"]
OpenShift Container Platform clusters on {rh-openstack-first} use Octavia to handle load balancer services. As a result of this choice, such clusters might have functional limitations.

OpenShift Container Platform clusters on {rh-openstack-first} use Octavia to handle load balancer services. As a result, your cluster has several functional limitations.
...
[role="_abstract"]
To establish external access to your OpenShift Container Platform cluster on {rh-openstack-first}, use the automatically assigned floating IP address. The floating IP address is associated with your Ingress port.
...
. Continue with creating your OpenShift Container Platform cluster.

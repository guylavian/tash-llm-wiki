...
type: reference
domain: openshift
slug: applications-4-22-installing-helm
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/applications/installing-helm
version: 4.22
family: applications
...
. Download the Helm binary: `.exe` file.

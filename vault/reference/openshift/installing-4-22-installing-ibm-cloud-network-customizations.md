---
title: "Installing a cluster on {ibm-cloud-title} with network customizations"
type: reference
domain: openshift
slug: installing-4-22-installing-ibm-cloud-network-customizations
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-ibm-cloud-network-customizations
version: 4.22
family: installing
...
In OpenShift Container Platform version , you can install a cluster with a

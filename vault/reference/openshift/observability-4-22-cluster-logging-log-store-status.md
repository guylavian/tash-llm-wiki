---
title: "Viewing the status of the Elasticsearch log store"
type: reference
domain: openshift
slug: observability-4-22-cluster-logging-log-store-status
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/cluster-logging-log-store-status
version: 4.22

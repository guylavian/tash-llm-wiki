...
type: reference
domain: openshift
slug: applications-4-22-what-deployments-are
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/applications/what-deployments-are
version: 4.22
family: applications

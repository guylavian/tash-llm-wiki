...
type: reference
domain: openshift
slug: reference-kubeadm-join-phase-wait-control-plane
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_join/kubeadm_join_phase_wait-control-plane
family: reference
documentKind: "doc"
---

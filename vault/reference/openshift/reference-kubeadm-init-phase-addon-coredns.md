...
type: reference
domain: openshift
slug: reference-kubeadm-init-phase-addon-coredns
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_init/kubeadm_init_phase_addon_coredns
family: reference
documentKind: "doc"
---

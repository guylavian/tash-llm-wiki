...
type: reference
domain: openshift
slug: osd-architecture-4-22-osd-life-cycle
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/osd_architecture/osd-life-cycle
version: 4.22
...
[role="_abstract"]
Review the life cycle policy for OpenShift Container Platform versions, including definitions of major, minor, and patch versions, as well as support timelines and upgrade requirements.

...
type: reference
domain: openshift
slug: installing-4-22-installing-openstack-cloud-config-reference
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-openstack-cloud-config-reference
version: 4.22
family: installing

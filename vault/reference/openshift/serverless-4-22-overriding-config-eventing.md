---
title: "Overriding Knative Eventing system deployment configurations"
type: reference
domain: openshift
slug: serverless-4-22-overriding-config-eventing
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/overriding-config-eventing
version: 4.22
family: serverless

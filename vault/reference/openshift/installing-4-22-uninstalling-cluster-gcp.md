---
title: "Uninstalling a cluster on {gcp-short}"
type: reference
domain: openshift
slug: installing-4-22-uninstalling-cluster-gcp
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/uninstalling-cluster-gcp
version: 4.22
family: installing

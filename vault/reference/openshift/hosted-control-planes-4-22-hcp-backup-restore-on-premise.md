---
title: "Backing up and restoring etcd in an on-premise environment"
type: reference
domain: openshift
slug: hosted-control-planes-4-22-hcp-backup-restore-on-premise
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/hosted_control_planes/hcp-backup-restore-on-premise
version: 4.22

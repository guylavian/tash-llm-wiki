---
title: "Installing a cluster on {ibm-cloud-title} in a disconnected environment"
type: reference
domain: openshift
slug: installing-4-22-installing-ibm-cloud-restricted
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-ibm-cloud-restricted
version: 4.22
family: installing
...
In OpenShift Container Platform , you can install a cluster in a restricted network by creating an internal mirror of the installation release content that is accessible to an existing Virtual Private Cloud (VPC) on {ibm-cloud-name}.

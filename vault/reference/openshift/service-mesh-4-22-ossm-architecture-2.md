...
type: reference
domain: openshift
slug: service-mesh-4-22-ossm-architecture-2
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/service_mesh/ossm-architecture
version: 4.22
family: service_mesh
...
{SMProductName} also uses the *istio-operator* to manage the installation of the control plane. An _Operator_ is a piece of software that enables you to implement and automate common activities in your OpenShift Container Platform cluster. It acts as a controller, allowing you to set or change the desired state of objects in your cluster.
...
You can combine {DTShortName} with other relevant components of the OpenShift Container Platform:
...
The {JaegerShortName} is based on the open source Jaeger project. The {JaegerShortName} is made up of several components that work together to collect, store, and display tracing data.
...
* Prepare to install {SMProductName} in your OpenShift Container Platform environment.

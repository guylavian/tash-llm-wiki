...
type: reference
domain: openshift
slug: reference-kubeadm-join-phase-preflight
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_join/kubeadm_join_phase_preflight
family: reference
documentKind: "doc"
---

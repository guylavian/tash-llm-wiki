...
type: reference
domain: openshift
slug: reference-match-condition-v1-admissionregistration
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/definitions/match-condition-v1-admissionregistration
family: reference
documentKind: "doc"

...
type: reference
domain: openshift
slug: extensions-4-22-index
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/extensions/index
version: 4.22
family: extensions
...
{olm-first} has been included with OpenShift Container Platform 4 since its initial release. OpenShift Container Platform  includes components for a next-generation iteration of {olm} as a Generally Available (GA) feature, known during this phase as _{olmv1}_. This updated framework evolves many of the concepts that have been part of previous versions of {olm} and adds new capabilities.
...
[NOTE]
====
Earlier Technology Preview phases of {olmv1} introduced a new `Operator` API; this API is renamed `ClusterExtension` in OpenShift Container Platform 4.16 to address the following improvements:

...
type: reference
domain: openshift
slug: installing-4-22-installing-using-iscsi
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-using-iscsi
version: 4.22
family: installing
...
The assets you create in these procedures deploy a single-node OpenShift Container Platform installation.

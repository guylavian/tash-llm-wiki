---
title: "Control plane configuration options for {azure-full}"
type: reference
domain: openshift
slug: machine-management-4-22-cpmso-config-options-azure
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/machine_management/cpmso-config-options-azure
version: 4.22
...
The control plane machine set concept of a failure domain is analogous to the {azure-short} concept of an _Azure availability zone_.

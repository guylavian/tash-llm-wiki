...
type: reference
domain: openshift
slug: reference-config-map-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/core/config-map-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "config-map-v1#ConfigMap" >}}">ConfigMap array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "config-map-v1#ConfigMap" >}}">ConfigMap</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "config-map-v1#ConfigMapList" >}}">ConfigMapList</a></em></td>
    </tr>
  </tbody>
</table>

---
title: "{sandboxed-containers-first} {sandboxed-containers-version} release notes"
type: reference
domain: openshift
slug: sandboxed-containers-4-22-sandboxed-containers-1-3-release-notes
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/sandboxed_containers/sandboxed-containers-1.3-release-notes
version: 4.22
...
These release notes track the development of {sandboxed-containers-first} {sandboxed-containers-version} alongside Red Hat OpenShift Container Platform .
...
For more information about kata-specific metrics, see About {sandboxed-containers-first} metrics.
...
* If you are using {sandboxed-containers-first}, you might receive SELinux denials when accessing files or directories mounted from the `hostPath` volume in an OpenShift Container Platform cluster. These denials can occur even when running privileged sandboxed containers because privileged sandboxed containers do not disable SELinux checks.
+
...
Security, bug fix, and enhancement updates for {sandboxed-containers-first}  are released as asynchronous errata through the Red Hat Network. All OpenShift Container Platform  errata are available on the https://access.redhat.com/downloads/content/290/[Red Hat Customer Portal]. For more information about asynchronous errata, see the https://access.redhat.com/support/policy/updates/openshift[OpenShift Container Platform Life Cycle].

...
type: reference
domain: openshift
slug: edge-computing-4-22-ztp-migrate-clusterinstance
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/edge_computing/ztp-migrate-clusterinstance
version: 4.22
...
It provides a single, central definition of the OpenShift Container Platform release image to use when provisioning clusters.
...
----
podman pull registry.redhat.io/openshift4/ztp-site-generate-rhel8:
----
...
[source,bash]
----
$ podman run -v "${PWD}":/resources:Z,U -it registry.redhat.io/openshift4/ztp-site-generate-rhel8: siteconfig-converter -d /resources/<output_folder> /resources/<path_to_siteconfig_resource>
----
+

---
title: "{PM-title-c} release notes"
type: reference
domain: openshift
slug: observability-4-22-power-monitoring-release-notes
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/power-monitoring-release-notes
version: 4.22
...
* With this release, FIPS mode is now enabled for {PM-title}. When installed on an OpenShift Container Platform cluster in FIPS mode, {PM-operator} ensures compatibility without affecting the FIPS support status of the cluster.

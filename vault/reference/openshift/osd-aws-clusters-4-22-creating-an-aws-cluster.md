...
type: reference
domain: openshift
slug: osd-aws-clusters-4-22-creating-an-aws-cluster
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/osd_aws_clusters/creating-an-aws-cluster
version: 4.22
...
[role="_abstract"]
OpenShift Container Platform on {AWS} gives you a managed container platform for deploying your applications. Use the Customer Cloud Subscription (CCS) model to keep ownership of your AWS account while letting Red{nbsp}Hat manage the cluster lifecycle. With the architecture and infrastructure for AWS clusters, you can optimize your cloud environment for performance and security.
...
* OpenShift Container Platform cloud deployment options

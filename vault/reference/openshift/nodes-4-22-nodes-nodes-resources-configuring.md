---
title: "Allocating resources for nodes in an {product-title} cluster"
type: reference
domain: openshift
slug: nodes-4-22-nodes-nodes-resources-configuring
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-nodes-resources-configuring
version: 4.22
family: nodes

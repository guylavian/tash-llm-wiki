...
type: reference
domain: openshift
slug: reference-kubeadm-init-phase-certs-etcd-server
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_init/kubeadm_init_phase_certs_etcd-server
family: reference
documentKind: "doc"
---

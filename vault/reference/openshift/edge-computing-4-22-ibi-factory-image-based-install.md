...
type: reference
domain: openshift
slug: edge-computing-4-22-ibi-factory-image-based-install
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/edge_computing/ibi-factory-image-based-install
version: 4.22

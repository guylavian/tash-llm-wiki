...
type: reference
domain: openshift
slug: reference-named-rule-with-operations-v1-admissionregistration
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/definitions/named-rule-with-operations-v1-admissionregistration
family: reference
documentKind: "doc"

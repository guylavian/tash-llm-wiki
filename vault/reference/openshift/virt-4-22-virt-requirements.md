...
type: reference
domain: openshift
slug: virt-4-22-virt-requirements
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/virt/virt-requirements
version: 4.22
family: virt
...
[role="_abstract"]
{VirtProductName} requires OpenShift Container Platform-supported storage with specific configuration for VM workloads and snapshots.
...
* Storage must be supported by OpenShift Container Platform.
* You must create a default {VirtProductName} or OpenShift Container Platform storage class. The purpose of this is to address the unique storage needs of VM workloads and offer optimized performance, reliability, and user experience. If both {VirtProductName} and OpenShift Container Platform default storage classes exist, the {VirtProductName} class takes precedence when creating VM disks.
+
[NOTE]
====
...
[role="_abstract"]
{VirtProductName} is an add-on to OpenShift Container Platform and imposes additional overhead that you must account for when planning a cluster.
...
* Using a dedicated network for live migration
* Run strategies
* OpenShift Container Platform object maximums
* {VirtProductName} supported limits
* Installer-provisioned infrastructure installation overview

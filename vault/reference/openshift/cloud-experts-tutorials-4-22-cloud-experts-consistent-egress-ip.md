---
title: "Tutorial: Assigning a consistent egress IP for external traffic"
type: reference
domain: openshift
slug: cloud-experts-tutorials-4-22-cloud-experts-consistent-egress-ip
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/cloud_experts_tutorials/cloud-experts-consistent-egress-ip
version: 4.22
...
By default, OpenShift Container Platform uses the OVN-Kubernetes container network interface (CNI) to assign random IP addresses from a pool. This can make configuring security lockdowns unpredictable or open.
...
* A OpenShift Container Platform cluster deployed with OVN-Kubernetes

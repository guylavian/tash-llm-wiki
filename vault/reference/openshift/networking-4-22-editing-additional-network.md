...
type: reference
domain: openshift
slug: networking-4-22-editing-additional-network
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/networking/editing-additional-network
version: 4.22
family: networking

...
type: reference
domain: openshift
slug: reference-priority-class-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/scheduling/priority-class-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "priority-class-v1#PriorityClass" >}}">PriorityClass array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "priority-class-v1#PriorityClass" >}}">PriorityClass</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "priority-class-v1#PriorityClassList" >}}">PriorityClassList</a></em></td>
    </tr>
  </tbody>
</table>

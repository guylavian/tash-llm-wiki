...
type: reference
domain: openshift
slug: microshift-cli-ref-4-22-microshift-oc-cli-install
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/microshift_cli_ref/microshift-oc-cli-install
version: 4.22

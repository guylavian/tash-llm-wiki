...
type: reference
domain: openshift
slug: security-4-22-replacing-default-ingress-certificate
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/replacing-default-ingress-certificate
version: 4.22
family: security

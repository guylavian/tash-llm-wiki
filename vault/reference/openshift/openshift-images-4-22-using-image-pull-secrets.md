...
type: reference
domain: openshift
slug: openshift-images-4-22-using-image-pull-secrets
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/openshift_images/using-image-pull-secrets
version: 4.22

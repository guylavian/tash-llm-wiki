...
type: reference
domain: openshift
slug: reference-service-account-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/core/service-account-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>imagePullSecrets</code><br/><em><a href="{{< ref "../definitions/local-object-reference-v1#LocalObjectReference" >}}">LocalObjectReference array</a></em></td>
    ...
    <tr>
      <td><code>secrets</code><br/><em><a href="{{< ref "../definitions/object-reference-v1#ObjectReference" >}}">ObjectReference array</a></em><br/><em>patch strategy: merge on key <code>name</code></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "service-account-v1#ServiceAccount" >}}">ServiceAccount array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "service-account-v1#ServiceAccount" >}}">ServiceAccount</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "service-account-v1#ServiceAccountList" >}}">ServiceAccountList</a></em></td>
    </tr>
  </tbody>
</table>

---
title: "Securing routes with the {cert-manager-operator}"
type: reference
domain: openshift
slug: security-4-22-cert-manager-securing-routes
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/cert-manager-securing-routes
version: 4.22
family: security

...
type: reference
domain: openshift
slug: osd-architecture-4-22-policy-responsibility-matrix
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/osd_architecture/policy-responsibility-matrix
version: 4.22
...
[role="_abstract"]
While Red{nbsp}Hat manages the OpenShift Container Platform service, the customer shares responsibility with respect to certain aspects. The OpenShift Container Platform services are accessed remotely, hosted on public cloud resources, created in either Red{nbsp}Hat or customer-owned cloud service provider accounts, and have underlying platform and data security that is owned by Red{nbsp}Hat.
...
[role="_abstract"]
The customer and Red{nbsp}Hat share responsibility for the monitoring and maintenance of an OpenShift Container Platform cluster. This documentation illustrates the delineation of responsibilities by area and task.
...
|===
1. Applies to OpenShift Container Platform on {GCP} clusters with PSC only.
...
[role="_abstract"]
The customer is responsible for the applications, workloads, and data that they deploy to OpenShift Container Platform. However, Red Hat provides various tools to help the customer manage data and applications on the platform.

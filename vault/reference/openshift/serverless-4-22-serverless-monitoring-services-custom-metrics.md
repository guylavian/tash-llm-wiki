---
title: "Knative service with custom application metrics"
type: reference
domain: openshift
slug: serverless-4-22-serverless-monitoring-services-custom-metrics
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/serverless-monitoring-services-custom-metrics
version: 4.22
family: serverless

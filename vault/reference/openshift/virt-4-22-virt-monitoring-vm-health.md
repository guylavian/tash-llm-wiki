...
type: reference
domain: openshift
slug: virt-4-22-virt-monitoring-vm-health
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/virt/virt-monitoring-vm-health
version: 4.22
family: virt

---
title: "Configuring Knative broker for Apache Kafka"
type: reference
domain: openshift
slug: serverless-4-22-serverless-kafka-admin
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/serverless-kafka-admin
version: 4.22
family: serverless

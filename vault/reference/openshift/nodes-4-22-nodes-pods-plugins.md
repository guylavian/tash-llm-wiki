...
type: reference
domain: openshift
slug: nodes-4-22-nodes-pods-plugins
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-pods-plugins
version: 4.22
family: nodes
...
and setup) in your OpenShift Container Platform pod without needing to write custom code.

...
type: reference
domain: openshift
slug: storage-4-22-persistent-storage-nfs
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/storage/persistent-storage-nfs
version: 4.22
family: storage
...
OpenShift Container Platform NFS plugin mounts the container's NFS directory with the same POSIX ownership and permissions found on the exported NFS directory.
...
NFS implements the OpenShift Container Platform `Recyclable` plugin interface. Automatic

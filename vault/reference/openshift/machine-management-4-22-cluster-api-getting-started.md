...
type: reference
domain: openshift
slug: machine-management-4-22-cluster-api-getting-started
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/machine_management/cluster-api-getting-started
version: 4.22
...
You can use these API groups to automate the management of infrastructure resources on your OpenShift Container Platform cluster.

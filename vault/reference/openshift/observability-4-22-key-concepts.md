---
title: "Understanding the monitoring stack - key concepts"
type: reference
domain: openshift
slug: observability-4-22-key-concepts
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/key-concepts
version: 4.22
...
By default, Prometheus collects metrics exposed by all default metrics targets in OpenShift Container Platform components.
...
As an administrator, you can access dashboards for the core OpenShift Container Platform components, including the following items:
...
* *Alerts*. An alert is fired when the conditions defined in an alerting rule are true. Alerts provide a notification that a set of circumstances are apparent within your OpenShift Container Platform cluster.
...
The OpenShift Container Platform monitoring includes a large set of default alerting rules for platform metrics.
...
Therefore, any dropped alerts still appear in the OpenShift Container Platform web console even though they are no longer forwarded to Alertmanager.
...
[IMPORTANT]
====
Managing alerting rules for user-defined projects is only available in OpenShift Container Platform version 4.11 and later.
====
...
The *Alerts* page in the Alerting UI provides details about alerts relating to default OpenShift Container Platform and user-defined projects. The page includes a summary of severity, state, and source for each alert. The time at which an alert went into its current state is also shown.
...
The *Silences* page in the Alerting UI provides details about silences applied to alerts in default OpenShift Container Platform and user-defined projects. The page includes a summary of the state of each silence and the time at which a silence ends.
...
The *Alerting rules* page in the Alerting UI provides details about alerting rules relating to default OpenShift Container Platform and user-defined projects. The page includes a summary of the state, severity, and source for each alerting rule.

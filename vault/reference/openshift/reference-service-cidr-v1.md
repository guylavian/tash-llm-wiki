...
type: reference
domain: openshift
slug: reference-service-cidr-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/networking/service-cidr-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>status</code><br/><em><a href="{{< ref "#ServiceCIDRStatus" >}}">ServiceCIDRStatus</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "service-cidr-v1#ServiceCIDR" >}}">ServiceCIDR array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "service-cidr-v1#ServiceCIDR" >}}">ServiceCIDR</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "service-cidr-v1#ServiceCIDRList" >}}">ServiceCIDRList</a></em></td>
    </tr>
  </tbody>
</table>

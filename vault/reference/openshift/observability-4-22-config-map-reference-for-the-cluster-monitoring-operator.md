---
title: "Config map reference for the Cluster Monitoring Operator"
type: reference
domain: openshift
slug: observability-4-22-config-map-reference-for-the-cluster-monitoring-operator
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/config-map-reference-for-the-cluster-monitoring-operator
version: 4.22
...
[role="_abstract"]
Parts of OpenShift Container Platform cluster monitoring are configurable.

...
type: reference
domain: openshift
slug: reference-kubeadm-certs-renew-admin-conf
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_certs/kubeadm_certs_renew_admin.conf
family: reference
documentKind: "doc"
---

...
type: reference
domain: openshift
slug: extensions-4-22-fbc
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/extensions/fbc
version: 4.22
family: extensions
...
{olmv1-first} in OpenShift Container Platform supports _file-based catalogs_ for discovering and sourcing cluster extensions, including Operators, on a cluster.

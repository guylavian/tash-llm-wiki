...
type: reference
domain: openshift
slug: reference-event-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/core/event-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>eventTime</code><br/><em><a href="{{< ref "../definitions/micro-time-v1-meta#MicroTime" >}}">MicroTime</a></em></td>
      <td>Time when this Event was first observed.</td>
    </tr>
    <tr>
      <td><code>firstTimestamp</code><br/><em><a href="{{< ref "../definitions/time-v1-meta#Time" >}}">Time</a></em></td>
      <td>The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)</td>
    </tr>
    <tr>
      <td><code>involvedObject</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "../definitions/object-reference-v1#ObjectReference" >}}">ObjectReference</a></em></td>
    ...
    <tr>
      <td><code>lastTimestamp</code><br/><em><a href="{{< ref "../definitions/time-v1-meta#Time" >}}">Time</a></em></td>
    ...
    <tr>
      <td><code>source</code><br/><em><a href="{{< ref "../definitions/event-source-v1#EventSource" >}}">EventSource</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "event-v1#Event" >}}">Event array</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>lastObservedTime</code><br/><em><a href="{{< ref "../definitions/micro-time-v1-meta#MicroTime" >}}">MicroTime</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "event-v1#Event" >}}">Event</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "event-v1#EventList" >}}">EventList</a></em></td>
    </tr>
  </tbody>
</table>

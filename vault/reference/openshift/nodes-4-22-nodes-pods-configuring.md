---
title: "Configuring an {product-title} cluster for pods"
type: reference
domain: openshift
slug: nodes-4-22-nodes-pods-configuring
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-pods-configuring
version: 4.22
family: nodes
...
If an entire pod fails, OpenShift Container Platform starts a new pod. Developers must address the possibility that applications might be restarted in a new pod. In particular,
...
* Unhealthy Pod Eviction Policy (Kubernetes documentation)
...
[role="_abstract"]
You can mark pods on a worker node as _critical_ to prevent OpenShift Container Platform from evicting those pods. Pods marked as critical are not allowed to be evicted.
...
* Enabling features using feature gates
* Unhealthy Pod Eviction Policy (Kubernetes documentation)
* Example States (Kubernetes documentation)

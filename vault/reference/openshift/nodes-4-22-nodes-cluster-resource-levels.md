---
title: "Estimating the number of pods your {product-title} nodes can hold"
type: reference
domain: openshift
slug: nodes-4-22-nodes-cluster-resource-levels
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-cluster-resource-levels
version: 4.22
family: nodes

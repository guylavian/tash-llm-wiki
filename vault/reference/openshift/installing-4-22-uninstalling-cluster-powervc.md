...
type: reference
domain: openshift
slug: installing-4-22-uninstalling-cluster-powervc
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/uninstalling-cluster-powervc
version: 4.22
family: installing

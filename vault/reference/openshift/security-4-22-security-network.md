...
type: reference
domain: openshift
slug: security-4-22-security-network
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/security-network
version: 4.22
family: security
...
OpenShift Container Platform uses software-defined networking (SDN) to provide a unified
...
OpenShift Container Platform enables you to segment network traffic on a single cluster to
...
OpenShift Container Platform provides the ability to control egress traffic using either
...
going outside of an OpenShift Container Platform cluster using an egress firewall.

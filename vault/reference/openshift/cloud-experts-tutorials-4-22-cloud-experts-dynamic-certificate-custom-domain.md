---
title: "Tutorial: Dynamically issuing certificates using the cert-manager Operator on {product-title}"
type: reference
domain: openshift
slug: cloud-experts-tutorials-4-22-cloud-experts-dynamic-certificate-custom-domain
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/cloud_experts_tutorials/cloud-experts-dynamic-certificate-custom-domain
version: 4.22
...
= Tutorial: Dynamically issuing certificates using the cert-manager Operator on OpenShift Container Platform
...
Learn how to use the cert-manager Operator for Red{nbsp}Hat OpenShift and Let's Encrypt to dynamically issue certificates for routes created using a custom domain.
...
The public hosted zone that is used in this tutorial is in the same AWS account as the OpenShift Container Platform cluster. If your public hosted zone is in a different account, a few additional steps for Cross Account Access are required.

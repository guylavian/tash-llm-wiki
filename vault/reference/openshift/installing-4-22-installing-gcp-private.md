---
title: "Installing a private cluster on {gcp-short}"
type: reference
domain: openshift
slug: installing-4-22-installing-gcp-private
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-gcp-private
version: 4.22
family: installing
...
In OpenShift Container Platform version , you can install a private cluster into an existing VPC on {gcp-first}. The installation program provisions the rest of the required infrastructure, which you can further customize. To customize the installation, you modify
...
In OpenShift Container Platform , you can deploy a cluster into an existing VPC in {gcp-first}. If you do, you must also use existing subnets within the VPC and routing rules.

By deploying OpenShift Container Platform into an existing {gcp-short} VPC, you might be able to avoid limit constraints in new accounts or more easily abide by the operational constraints that your company's guidelines set. This is a good option to use if you cannot obtain the infrastructure creation permissions that are required to create the VPC yourself.
...
* The VPC must be in the same {gcp-short} project that you deploy the OpenShift Container Platform cluster to.

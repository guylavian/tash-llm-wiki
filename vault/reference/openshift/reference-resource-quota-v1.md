...
type: reference
domain: openshift
slug: reference-resource-quota-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/core/resource-quota-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>spec</code><br/><em><a href="{{< ref "#ResourceQuotaSpec" >}}">ResourceQuotaSpec</a></em></td>
    ...
    <tr>
      <td><code>status</code><br/><em><a href="{{< ref "#ResourceQuotaStatus" >}}">ResourceQuotaStatus</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>scopeSelector</code><br/><em><a href="{{< ref "#ScopeSelector" >}}">ScopeSelector</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "resource-quota-v1#ResourceQuota" >}}">ResourceQuota array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>matchExpressions</code><br/><em><a href="{{< ref "#ScopedResourceSelectorRequirement" >}}">ScopedResourceSelectorRequirement array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "resource-quota-v1#ResourceQuota" >}}">ResourceQuota</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "resource-quota-v1#ResourceQuotaList" >}}">ResourceQuotaList</a></em></td>
    </tr>
  </tbody>
</table>

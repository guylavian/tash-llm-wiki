...
type: reference
domain: openshift
slug: operators-4-22-olm-understanding-operatorgroups
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/operators/olm-understanding-operatorgroups
version: 4.22
family: operators

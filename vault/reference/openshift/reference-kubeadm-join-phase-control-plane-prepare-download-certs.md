...
type: reference
domain: openshift
slug: reference-kubeadm-join-phase-control-plane-prepare-download-certs
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_join/kubeadm_join_phase_control-plane-prepare_download-certs
family: reference
documentKind: "doc"
---

...
type: reference
domain: openshift
slug: updating-4-22-kmm-preflight-validation
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/updating/kmm-preflight-validation
version: 4.22
family: updating

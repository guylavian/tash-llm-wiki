...
type: reference
domain: openshift
slug: installing-4-22-agent-based-installer-postinstallation
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/agent-based-installer-postinstallation
version: 4.22
family: installing

---
title: "Configuration for scraping custom metrics"
type: reference
domain: openshift
slug: serverless-4-22-serverless-monitoring-services-configuration-scraping
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/serverless-monitoring-services-configuration-scraping
version: 4.22
family: serverless

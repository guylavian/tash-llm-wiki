...
type: reference
domain: openshift
slug: observability-4-22-observing-network-traffic
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/observing-network-traffic
version: 4.22

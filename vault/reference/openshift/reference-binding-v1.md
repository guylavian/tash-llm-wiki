...
type: reference
domain: openshift
slug: reference-binding-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/definitions/binding-v1
family: reference
documentKind: "doc"
abstract: "Binding ties one object to another; for example, a pod is bound to a node by a scheduler."
---

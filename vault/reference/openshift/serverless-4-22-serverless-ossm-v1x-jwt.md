---
title: "Using JSON Web Token authentication with {SMProductShortName} 1.x"
type: reference
domain: openshift
slug: serverless-4-22-serverless-ossm-v1x-jwt
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/serverless-ossm-v1x-jwt
version: 4.22
family: serverless

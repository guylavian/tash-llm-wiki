---
title: "Tutorial: Using Source-to-Image (S2I) webhooks for automated deployment"
type: reference
domain: openshift
slug: cloud-experts-tutorials-4-22-cloud-experts-deploying-s2i-webhook-cicd
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/cloud_experts_tutorials/cloud-experts-deploying-s2i-webhook-cicd
version: 4.22
...
//
// * cloud_experts_tutorials/cloud-experts-deploying-application/cloud-experts-deploying-s2i-webhook-cicd.adoc

[id="cloud-experts-deploying-s2i-webhook-cicd-procedure_{context}"]
= Setting up S2I webhooks for automated deployment

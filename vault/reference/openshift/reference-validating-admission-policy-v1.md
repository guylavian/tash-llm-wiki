...
type: reference
domain: openshift
slug: reference-validating-admission-policy-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/admissionregistration/validating-admission-policy-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>variables</code><br/><em><a href="{{< ref "../definitions/variable-v1-admissionregistration#Variable" >}}">Variable array</a></em><br/><em>patch strategy: merge on key <code>name</code></em></td>

...
type: reference
domain: openshift
slug: reference-server-address-by-client-cidr-v1-meta
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/definitions/server-address-by-client-cidr-v1-meta
family: reference
documentKind: "doc"

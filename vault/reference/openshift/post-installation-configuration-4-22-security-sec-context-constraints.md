...
type: reference
domain: openshift
slug: post-installation-configuration-4-22-security-sec-context-constraints
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/post_installation_configuration/security-sec-context-constraints
version: 4.22

...
type: reference
domain: openshift
slug: hardware-enablement-4-22-kmm-release-notes
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/hardware_enablement/kmm-release-notes
version: 4.22
...
+
For more information, see Specifying files to sign.

---
title: "Tutorial: AWS Load Balancer Operator on {product-title}"
type: reference
domain: openshift
slug: cloud-experts-tutorials-4-22-cloud-experts-aws-load-balancer-operator
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/cloud_experts_tutorials/cloud-experts-aws-load-balancer-operator
version: 4.22
...
= Tutorial: AWS Load Balancer Operator on OpenShift Container Platform
...
[role="_abstract"]
The AWS Load Balancer Controller manages AWS Elastic Load Balancers for a OpenShift Container Platform cluster. The controller provisions AWS Application Load Balancers (ALB) when you create Kubernetes Ingress resources and AWS Network Load Balancers (NLB) when implementing Kubernetes Service resources with a type of LoadBalancer.
...
The AWS Load Balancer Operator is used to used to install, manage and configure an instance of `aws-load-balancer-controller` in a OpenShift Container Platform cluster.
...
* A multi-AZ OpenShift Container Platform cluster
* A multi-AZ OpenShift Container Platform cluster
* BYO VPC cluster
* AWS CLI
* OC CLI

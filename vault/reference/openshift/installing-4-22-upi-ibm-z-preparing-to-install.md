---
title: "Preparing to install a cluster on {ibm-z-title} and {ibm-linuxone-title} using user-provisioned infrastructure"
type: reference
domain: openshift
slug: installing-4-22-upi-ibm-z-preparing-to-install
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/upi-ibm-z-preparing-to-install
version: 4.22
family: installing
...
You prepare to install an OpenShift Container Platform cluster on {ibm-z-name} and {ibm-linuxone-name} by completing the following steps:

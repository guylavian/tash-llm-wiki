...
type: reference
domain: openshift
slug: virt-4-22-virt-creating-vms-from-instance-types
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/virt/virt-creating-vms-from-instance-types
version: 4.22
family: virt
...
[NOTE]
====
Creating a VM from an instance type in {VirtProductName} 4.15 and higher is supported on OpenShift Container Platform clusters. In {VirtProductName} 4.14, creating a VM from an instance type is a Technology Preview feature and is not supported on OpenShift Container Platform clusters.
====
...
You can use the OpenShift Container Platform web console or the {oc-first} to change the instance type for an existing VM.

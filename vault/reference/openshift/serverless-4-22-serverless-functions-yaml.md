---
title: "Function project configuration in func.yaml"
type: reference
domain: openshift
slug: serverless-4-22-serverless-functions-yaml
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/serverless-functions-yaml
version: 4.22
family: serverless

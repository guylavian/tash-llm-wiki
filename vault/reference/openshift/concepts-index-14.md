...
type: reference
domain: openshift
slug: concepts-index-14
tier: reference
source: https://kubernetes.io/docs/concepts/containers/_index
family: concepts
documentKind: "doc"
abstract: "Technology for packaging an application along with its runtime dependencies."
---

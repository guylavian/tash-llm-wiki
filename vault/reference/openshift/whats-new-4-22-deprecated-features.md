...
type: reference
domain: openshift
slug: whats-new-4-22-deprecated-features
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/whats_new/deprecated-features
version: 4.22
family: whats_new
...
applied in OpenShift Container Platform v4, and many features from OpenShift Container Platform v3 are
now deprecated.

[id="deprecated"]
== Features deprecated in OpenShift Container Platform v4
...
|CRI-O is the default container runtime for OpenShift Container Platform v4 on Fedora.

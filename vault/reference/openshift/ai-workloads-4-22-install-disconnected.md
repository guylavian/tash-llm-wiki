---
title: "Installing {kueue-name} in a disconnected environment"
type: reference
domain: openshift
slug: ai-workloads-4-22-install-disconnected
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/ai_workloads/install-disconnected
version: 4.22
family: ai_workloads
...
Before you can install {kueue-name} on a disconnected OpenShift Container Platform cluster, you must enable {olm-first} in disconnected environments by completing the following steps:

...
type: reference
domain: openshift
slug: reference-kubeadm-join-phase-control-plane-prepare-control-plane
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_join/kubeadm_join_phase_control-plane-prepare_control-plane
family: reference
documentKind: "doc"
---

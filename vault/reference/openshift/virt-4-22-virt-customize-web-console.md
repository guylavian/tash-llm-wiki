...
type: reference
domain: openshift
slug: virt-4-22-virt-customize-web-console
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/virt/virt-customize-web-console
version: 4.22
family: virt

...
type: reference
domain: openshift
slug: reference-replication-controller-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/core/replication-controller-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>spec</code><br/><em><a href="{{< ref "#ReplicationControllerSpec" >}}">ReplicationControllerSpec</a></em></td>
    ...
    <tr>
      <td><code>status</code><br/><em><a href="{{< ref "#ReplicationControllerStatus" >}}">ReplicationControllerStatus</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>template</code><br/><em><a href="{{< ref "pod-template-v1#PodTemplateSpec" >}}">PodTemplateSpec</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>conditions</code><br/><em><a href="{{< ref "#ReplicationControllerCondition" >}}">ReplicationControllerCondition array</a></em><br/><em>patch strategy: merge on key <code>type</code></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "replication-controller-v1#ReplicationController" >}}">ReplicationController array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "replication-controller-v1#ReplicationController" >}}">ReplicationController</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "replication-controller-v1#ReplicationControllerList" >}}">ReplicationControllerList</a></em></td>
    </tr>
  </tbody>
</table>

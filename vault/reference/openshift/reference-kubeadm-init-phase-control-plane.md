...
type: reference
domain: openshift
slug: reference-kubeadm-init-phase-control-plane
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_init/kubeadm_init_phase_control-plane
family: reference
documentKind: "doc"
---

---
title: "DNS Operator in {product-title}"
type: reference
domain: openshift
slug: networking-4-22-dns-operator
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/networking/dns-operator
version: 4.22
family: networking
...
. Change `managementState` to `Unmanaged` in the DNS Operator by running the following command:
+
[source,terminal]
----

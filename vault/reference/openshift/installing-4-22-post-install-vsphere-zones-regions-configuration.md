...
type: reference
domain: openshift
slug: installing-4-22-post-install-vsphere-zones-regions-configuration
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/post-install-vsphere-zones-regions-configuration
version: 4.22
family: installing

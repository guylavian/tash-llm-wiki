...
type: reference
domain: openshift
slug: reference-kubeadm-init-phase-certs-sa
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_init/kubeadm_init_phase_certs_sa
family: reference
documentKind: "doc"
---

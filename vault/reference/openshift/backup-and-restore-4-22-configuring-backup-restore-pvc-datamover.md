...
type: reference
domain: openshift
slug: backup-and-restore-4-22-configuring-backup-restore-pvc-datamover
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/backup_and_restore/configuring-backup-restore-pvc-datamover
version: 4.22

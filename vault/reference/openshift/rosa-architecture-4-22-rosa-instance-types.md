---
title: "{product-title} instance types"
type: reference
domain: openshift
slug: rosa-architecture-4-22-rosa-instance-types
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/rosa_architecture/rosa-instance-types
version: 4.22
...
[role="_abstract"]
OpenShift Container Platform offers the following worker node instance types and sizes.

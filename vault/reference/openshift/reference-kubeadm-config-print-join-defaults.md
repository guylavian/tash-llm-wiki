...
type: reference
domain: openshift
slug: reference-kubeadm-config-print-join-defaults
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_config/kubeadm_config_print_join-defaults
family: reference
documentKind: "doc"
---

...
type: reference
domain: openshift
slug: installing-4-22-vsphere-post-installation-encryption
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/vsphere-post-installation-encryption
version: 4.22
family: installing
...
You can encrypt your virtual machines after installing OpenShift Container Platform  on vSphere by draining and shutting down your nodes one at a time. While each virtual machine is shutdown, you can enable encryption in the vCenter web interface.

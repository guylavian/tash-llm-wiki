...
type: reference
domain: openshift
slug: applications-4-22-using-templates
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/applications/using-templates
version: 4.22
family: applications
...
//OpenShift ImageStreams and Templates
//library.

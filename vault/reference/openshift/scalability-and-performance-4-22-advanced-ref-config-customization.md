...
type: reference
domain: openshift
slug: scalability-and-performance-4-22-advanced-ref-config-customization
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/scalability_and_performance/advanced-ref-config-customization
version: 4.22

...
type: reference
domain: openshift
slug: security-4-22-compliance-operator-tailor
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/compliance-operator-tailor
version: 4.22
family: security

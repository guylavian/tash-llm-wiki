...
type: reference
domain: openshift
slug: hardware-accelerators-4-22-amd-gpu-operator
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/hardware_accelerators/amd-gpu-operator
version: 4.22

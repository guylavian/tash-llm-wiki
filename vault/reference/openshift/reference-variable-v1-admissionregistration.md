...
type: reference
domain: openshift
slug: reference-variable-v1-admissionregistration
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/definitions/variable-v1-admissionregistration
family: reference
documentKind: "doc"

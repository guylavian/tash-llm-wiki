...
type: reference
domain: openshift
slug: nodes-4-22-nodes-cma-autoscaling-custom-audit-log
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-cma-autoscaling-custom-audit-log
version: 4.22
family: nodes

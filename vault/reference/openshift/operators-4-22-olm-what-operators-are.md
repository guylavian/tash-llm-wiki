...
type: reference
domain: openshift
slug: operators-4-22-olm-what-operators-are
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/operators/olm-what-operators-are
version: 4.22
family: operators

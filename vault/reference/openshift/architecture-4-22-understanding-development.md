---
title: "Understanding {product-title} development"
type: reference
domain: openshift
slug: architecture-4-22-understanding-development
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/architecture/understanding-development
version: 4.22
family: architecture
...
When you ultimately run your containers in OpenShift Container Platform, you use the
...
a standalone runtime outside of OpenShift Container Platform.
...
image::developer-catalog.png[OpenShift Container Platform Developer Catalog]
...
If you want your own, private container registry, OpenShift Container Platform itself
...
basis from OpenShift Container Platform, while other credentials can be assigned to individuals.
...
* The software catalog, which is available in each OpenShift Container Platform 

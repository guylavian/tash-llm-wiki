...
type: reference
domain: openshift
slug: microshift-networking-4-22-microshift-creating-network-policy
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/microshift_networking/microshift-creating-network-policy
version: 4.22

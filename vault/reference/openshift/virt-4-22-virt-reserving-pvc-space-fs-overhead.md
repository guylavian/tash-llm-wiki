...
type: reference
domain: openshift
slug: virt-4-22-virt-reserving-pvc-space-fs-overhead
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/virt/virt-reserving-pvc-space-fs-overhead
version: 4.22
family: virt

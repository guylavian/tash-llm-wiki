...
type: reference
domain: openshift
slug: nodes-4-22-nodes-nodes-garbage-collection
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-nodes-garbage-collection
version: 4.22
family: nodes
...
[role="_abstract"]
As an administrator, you can use OpenShift Container Platform to ensure that your nodes are running efficiently

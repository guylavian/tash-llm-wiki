...
type: reference
domain: openshift
slug: applications-4-22-managing-deployment-processes
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/applications/managing-deployment-processes
version: 4.22
family: applications

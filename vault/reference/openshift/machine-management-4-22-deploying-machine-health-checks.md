...
type: reference
domain: openshift
slug: machine-management-4-22-deploying-machine-health-checks
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/machine_management/deploying-machine-health-checks
version: 4.22

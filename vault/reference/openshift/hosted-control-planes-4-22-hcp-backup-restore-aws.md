...
type: reference
domain: openshift
slug: hosted-control-planes-4-22-hcp-backup-restore-aws
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/hosted_control_planes/hcp-backup-restore-aws
version: 4.22

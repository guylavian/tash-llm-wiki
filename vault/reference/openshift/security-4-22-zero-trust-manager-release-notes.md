...
type: reference
domain: openshift
slug: security-4-22-zero-trust-manager-release-notes
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/zero-trust-manager-release-notes
version: 4.22
family: security

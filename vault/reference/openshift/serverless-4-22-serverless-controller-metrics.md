---
title: "{ServerlessProductShortName} controller metrics"
type: reference
domain: openshift
slug: serverless-4-22-serverless-controller-metrics
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/serverless-controller-metrics
version: 4.22
family: serverless

...
type: reference
domain: openshift
slug: tasks-update-api-object-kubectl-patch
tier: reference
source: https://kubernetes.io/docs/tasks/manage-kubernetes-objects/update-api-object-kubectl-patch
family: tasks
documentKind: "doc"
abstract: "Use kubectl patch to update Kubernetes API objects in place. Do a strategic merge patch or a JSON merge patch."
---

...
type: reference
domain: openshift
slug: reference-subject-rules-review-status-v1-authorization
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/definitions/subject-rules-review-status-v1-authorization
family: reference
documentKind: "doc"

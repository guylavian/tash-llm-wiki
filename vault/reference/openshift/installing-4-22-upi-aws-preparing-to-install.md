...
type: reference
domain: openshift
slug: installing-4-22-upi-aws-preparing-to-install
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/upi-aws-preparing-to-install
version: 4.22
family: installing

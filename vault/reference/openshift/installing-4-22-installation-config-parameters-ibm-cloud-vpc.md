---
title: "Installation configuration parameters for {ibm-cloud-title}"
type: reference
domain: openshift
slug: installing-4-22-installation-config-parameters-ibm-cloud-vpc
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installation-config-parameters-ibm-cloud-vpc
version: 4.22
family: installing
...
Before you deploy an OpenShift Container Platform cluster on {ibm-cloud-name}, you provide parameters to customize your cluster and the platform that hosts it. When you create the `install-config.yaml` file, you provide values for the required parameters through the command line. You can then modify the `install-config.yaml` file to customize your cluster further.

---
title: "Finding logs for Knative Serving services"
type: reference
domain: openshift
slug: serverless-4-22-finding-serving-logs-services
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/finding-serving-logs-services
version: 4.22
family: serverless

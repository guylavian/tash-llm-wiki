---
title: "Using JSON Web Token authentication with {SMProductShortName} 2.x"
type: reference
domain: openshift
slug: serverless-4-22-serverless-ossm-v2x-jwt
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/serverless-ossm-v2x-jwt
version: 4.22
family: serverless

---
title: "5.7 Logging API reference"
type: reference
domain: openshift
slug: observability-4-22-logging-5-7-reference
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/logging-5-7-reference
version: 4.22
...
// * For more information about highly available {hcp} topology, see Distributing hosted cluster workloads.
...
* For more information about supported identity providers, see Configuring the maximum number of pods per node in _Managing the maximum number of pods per node_.

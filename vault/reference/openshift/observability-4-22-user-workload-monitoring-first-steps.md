---
title: "User workload monitoring first steps"
type: reference
domain: openshift
slug: observability-4-22-user-workload-monitoring-first-steps
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/user-workload-monitoring-first-steps
version: 4.22

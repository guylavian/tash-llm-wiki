---
title: "Working with resource quotas for virtual machines"
type: reference
domain: openshift
slug: virt-4-22-virt-working-with-resource-quotas-for-vms
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/virt/virt-working-with-resource-quotas-for-vms
version: 4.22
family: virt
...
. In the OpenShift Container Platform web console, click *Virtualization* -> *Quotas*.
...
* Resource quotas across many projects
* Understanding the Application Aware Quota operator
* Enabling the Application Aware Quota operator
* Creating virtual machine quotas using the web console
* Managing virtual machine quotas using the list view

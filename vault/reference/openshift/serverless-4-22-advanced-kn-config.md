---
title: "Configuring the Knative CLI"
type: reference
domain: openshift
slug: serverless-4-22-advanced-kn-config
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/advanced-kn-config
version: 4.22
family: serverless

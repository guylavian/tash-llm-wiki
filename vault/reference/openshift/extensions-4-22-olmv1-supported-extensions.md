...
type: reference
domain: openshift
slug: extensions-4-22-olmv1-supported-extensions
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/extensions/olmv1-supported-extensions
version: 4.22
family: extensions
...
* Validating admission webhooks (Kubernetes documentation)
* Mutating admission webhooks (Kubernetes documentation)
* Conversion webhooks (Kubernetes documentation)

...
type: reference
domain: openshift
slug: cicd-4-22-custom-builds-buildah
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/cicd/custom-builds-buildah
version: 4.22
family: cicd
...
With OpenShift Container Platform , a docker socket will not be present on the host

...
type: reference
domain: openshift
slug: service-mesh-4-22-ossm-gateway-migration
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/service_mesh/ossm-gateway-migration
version: 4.22
family: service_mesh

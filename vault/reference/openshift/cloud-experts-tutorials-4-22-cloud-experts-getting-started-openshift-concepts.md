---
title: "Tutorial: OpenShift concepts"
type: reference
domain: openshift
slug: cloud-experts-tutorials-4-22-cloud-experts-getting-started-openshift-concepts
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/cloud_experts_tutorials/cloud-experts-getting-started-openshift-concepts
version: 4.22
...
* Source-to-Image (S2I) upstream project
* Route-specific annotations
* Red Hat Blog: How to Simplify Container Image Management in Kubernetes with OpenShift Image Streams

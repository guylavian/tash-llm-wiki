---
title: "Configuring {FunctionsProductName}"
type: reference
domain: openshift
slug: serverless-4-22-configuring-serverless-functions
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/configuring-serverless-functions
version: 4.22
family: serverless

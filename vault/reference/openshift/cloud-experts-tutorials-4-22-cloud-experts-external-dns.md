---
title: "Tutorial: Deploying the External DNS Operator on {product-title}"
type: reference
domain: openshift
slug: cloud-experts-tutorials-4-22-cloud-experts-external-dns
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/cloud_experts_tutorials/cloud-experts-external-dns
version: 4.22
...
= Tutorial: Deploying the External DNS Operator on OpenShift Container Platform

[role="_abstract"]
The External DNS Operator deploys and manages `ExternalDNS` to provide the name resolution for services and routes from the external DNS provider, like Amazon Route 53, to OpenShift Container Platform clusters. In this tutorial, we will deploy and configure the External DNS Operator with a secondary ingress controller to manage DNS records in Amazon Route 53.

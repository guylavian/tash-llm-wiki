...
type: reference
domain: openshift
slug: installing-4-22-deploying-openstack-with-rootvolume-etcd-on-local-disk
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/deploying-openstack-with-rootVolume-etcd-on-local-disk
version: 4.22
family: installing

...
type: reference
domain: openshift
slug: reference-webhook-client-config-v1-admissionregistration
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/definitions/webhook-client-config-v1-admissionregistration
family: reference
documentKind: "doc"

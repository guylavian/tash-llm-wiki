---
title: "Installation configuration parameters for {gcp-short}"
type: reference
domain: openshift
slug: installing-4-22-installation-config-parameters-gcp
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installation-config-parameters-gcp
version: 4.22
family: installing

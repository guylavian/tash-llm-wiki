...
type: reference
domain: openshift
slug: reference-kubeadm-upgrade-node-phase-addon-all
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_upgrade/kubeadm_upgrade_node_phase_addon_all
family: reference
documentKind: "doc"
---

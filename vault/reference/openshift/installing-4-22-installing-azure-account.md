---
title: "Configuring an {azure-short} account"
type: reference
domain: openshift
slug: installing-4-22-installing-azure-account
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-azure-account
version: 4.22
family: installing
...
Before you can install OpenShift Container Platform, you must configure a {azure-first} account to meet installation requirements.
...
To set roles on the {azure-short} portal, see Assign {azure-short} roles using the {azure-short} portal in the {azure-short} documentation.
...
+
For more information about assigning roles, see the {azure-short} documentation for managing access to Azure resources using the Azure portal.
...
The following permissions are required for creating an OpenShift Container Platform cluster on {azure-first}.
...
[NOTE]
====
The following permissions are not required to create the private OpenShift Container Platform cluster on {azure-short}.
...
The following permissions are required for deleting an OpenShift Container Platform cluster on {azure-full}. You can use the same permissions to delete a private OpenShift Container Platform cluster on {azure-short}.
...
[NOTE]
====
The following permissions are not required to delete a private OpenShift Container Platform cluster on {azure-short}.
...
[NOTE]
====
To install OpenShift Container Platform on {azure-short}, you must scope the permissions to your subscription. You can re-scope these permissions to the resource group created by installation program. If the public DNS zone is present in a different resource group, then the network DNS zone related permissions must always be applied to your subscription. By default, the OpenShift Container Platform installation program assigns the {azure-short} identity the `Contributor` role.
...
While the offer must be purchased in North America or EMEA, you can deploy the cluster to any of the {azure-short} public partitions that OpenShift Container Platform supports.
...
* Install an OpenShift Container Platform cluster on Azure. You can

---
title: "Managing alerts as an Administrator"
type: reference
domain: openshift
slug: observability-4-22-managing-alerts-as-an-administrator
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/managing-alerts-as-an-administrator
version: 4.22
...
you can list alerting rules for core OpenShift Container Platform and user-defined projects together in a single view.
...
. In the OpenShift Container Platform web console, go to *Observe* -> *Alerting* -> *Alerting rules*.

---
title: "Viewing and listing the nodes in your {product-title} cluster"
type: reference
domain: openshift
slug: nodes-4-22-nodes-nodes-viewing
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-nodes-viewing
version: 4.22
family: nodes

...
type: reference
domain: openshift
slug: updating-4-22-updating-cluster-web-console
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/updating/updating-cluster-web-console
version: 4.22
family: updating
...
[NOTE]
====
Use the web console or `oc adm upgrade channel _<channel>_` to change the update channel. You can follow the steps in Updating a cluster using the CLI to complete the update after you change to a  channel.
====
...
. For production clusters, ensure that the *Channel* is set to the correct channel for the version that you want to update to, such as `stable-`.
+
[IMPORTANT]
====

...
type: reference
domain: openshift
slug: serverless-4-22-create-domain-mapping
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/create-domain-mapping
version: 4.22
family: serverless

...
type: reference
domain: openshift
slug: rosa-cluster-admin-4-22-nodes-cluster-resource-configure
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/rosa_cluster_admin/nodes-cluster-resource-configure
version: 4.22

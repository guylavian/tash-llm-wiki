...
type: reference
domain: openshift
slug: windows-containers-4-22-creating-windows-machineset-aws
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/windows_containers/creating-windows-machineset-aws
version: 4.22
...
* Install the latest version of EC2Launch v2 (AWS documentation)

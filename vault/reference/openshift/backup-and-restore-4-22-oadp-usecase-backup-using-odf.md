---
title: "Backup using {oadp-full} and {odf-first}"
type: reference
domain: openshift
slug: backup-and-restore-4-22-oadp-usecase-backup-using-odf
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/backup_and_restore/oadp-usecase-backup-using-odf
version: 4.22

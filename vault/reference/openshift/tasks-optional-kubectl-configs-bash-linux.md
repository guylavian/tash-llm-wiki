...
type: reference
domain: openshift
slug: tasks-optional-kubectl-configs-bash-linux
tier: reference
source: https://kubernetes.io/docs/tasks/tools/included/optional-kubectl-configs-bash-linux
family: tasks
documentKind: "doc"
abstract: "Some optional configuration for bash auto-completion on Linux."
---

...
type: reference
domain: openshift
slug: installing-4-22-installation-config-parameters-agent
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installation-config-parameters-agent
version: 4.22
family: installing
...
For more information, see "Preparing PXE assets for OpenShift Container Platform".
...
* Declarative Network API (nmstate documentation)
* Root device hints

...
type: reference
domain: openshift
slug: security-4-22-security-build
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/security-build
version: 4.22
family: security
...
OpenShift Container Platform can be integrated with trusted code repositories (such as GitHub)
...
*Topology* view of the OpenShift Container Platform web console.

---
name: wiki-lint
description: Health-check the multi-domain wiki/ (all domains in wiki/vault/taxonomy.md) — broken/wanted links, orphans, missing summary/sources/provenance, provenance drift, auto-seeded summaries, link hubs, and stale pages. Use after a batch ingest or before shipping wiki changes.
---

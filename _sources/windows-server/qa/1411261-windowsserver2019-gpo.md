...
type: source
tier: community-qa
source: https://learn.microsoft.com/en-us/answers/questions/1411261/windowsserver2019-gpo
question_id: 1411261
fetched: 2026-07-25
answer_count: 0
...
> `web:https://learn.microsoft.com/en-us/answers/questions/1411261/windowsserver2019-gpo (fetched 2026-07-25)` and verify against vendor documentation before relying on it.

## Question

例えば、設定ファイルに以下の拡張子pdfに対して複数行追記した場合の挙動は、

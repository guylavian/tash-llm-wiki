...
type: source
tier: community-qa
source: https://learn.microsoft.com/en-us/answers/questions/587581/bitlocker-encrypted-all-computers-by-cmd-and-gpo
question_id: 587581
fetched: 2026-07-25
answer_count: 1
...
> `web:https://learn.microsoft.com/en-us/answers/questions/587581/bitlocker-encrypted-all-computers-by-cmd-and-gpo (fetched 2026-07-25)` and verify against vendor documentation before relying on it.
...
I normally do it with the next script:    

$Pass = 'Password' | ConvertTo-SecureString -AsPlainText -Force    

Enable-BitLocker -MountPoint "F:" -EncryptionMethod Aes256 Add-BitLockerKeyProtector -Password $Pass -RecoveryKeyPath "\shareserver\blkeys" -RecoveryKeyProtector    
...
https://learn.microsoft.com/en-us/powershell/module/bitlocker/enable-bitlocker?view=windowsserver2019-ps    

https://learn.microsoft.com/en-us/powershell/module/bitlocker/add-bitlockerkeyprotector?view=windowsserver2019-ps    

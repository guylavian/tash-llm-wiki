...
slug: ad-ds-how-to-configure-spn
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/how-to-configure-spn
family: ad-ds
documentKind: "how-to"
abstract: "Learn how to configure Service Principal Names (SPN) for Active Directory service accounts in Windows Server."
---

# How to configure SPN for Windows Server

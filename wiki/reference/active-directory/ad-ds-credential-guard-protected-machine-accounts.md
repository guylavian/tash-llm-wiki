...
slug: ad-ds-credential-guard-protected-machine-accounts
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/delegated-managed-service-accounts/credential-guard-protected-machine-accounts
family: ad-ds
documentKind: "concept-article"
abstract: "Learn how to enhance machine accounts security in Windows Server 2025 through Credential Guard machine protected identity isolation group policy settings."
---

# Credential Guard protected machine accounts in Windows Server 2025

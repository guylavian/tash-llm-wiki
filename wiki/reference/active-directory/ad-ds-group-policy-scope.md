...
slug: ad-ds-group-policy-scope
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/manage/group-policy/group-policy-scope
family: ad-ds
documentKind: "concept-article"
abstract: "Learn about how Group Policy scope defines specific users, computers, and organizational units within an Active Directory environment in Windows."
---

# Group Policy scope in Windows

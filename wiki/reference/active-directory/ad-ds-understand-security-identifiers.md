...
slug: ad-ds-understand-security-identifiers
tier: reference
...
abstract: "Become familiar with unique identifiers for Windows Server accounts and groups, such as security identifiers (SIDs). See tables of well-known SIDs."
---

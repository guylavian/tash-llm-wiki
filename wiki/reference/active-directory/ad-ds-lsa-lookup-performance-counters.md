...
slug: ad-ds-lsa-lookup-performance-counters
tier: reference
source: https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/lsa-lookup-performance-counters
family: ad-ds
documentKind: "concept-article"
abstract: "Learn about Local Security Authority (LSA) Lookups performance counters"
---

# LSA Lookup performance counters in Windows and Windows Server

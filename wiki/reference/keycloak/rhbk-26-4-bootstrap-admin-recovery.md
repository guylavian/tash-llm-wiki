---
title: "Chapter 3. Bootstrapping and recovering an admin account - Red Hat build of Keycloak 26.4 Server Configuration Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-bootstrap-admin-recovery
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/server_configuration_guide/bootstrap-admin-recovery-
...
# Chapter 3. Bootstrapping and recovering an admin account - Red Hat build of Keycloak 26.4 Server Configuration Guide

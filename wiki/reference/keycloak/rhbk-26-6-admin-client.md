---
title: "Chapter 18. Red Hat build of Keycloak admin client - Red Hat build of Keycloak 26.6 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-6-admin-client
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.6/html/securing_applications_and_services_guide/admin-client-
...
# Chapter 18. Red Hat build of Keycloak admin client - Red Hat build of Keycloak 26.6 Securing Applications and Services Guide

Chapter 18. Red Hat build of Keycloak admin client
...
18.1. Compatibility with Red Hat build of Keycloak server

---
title: "Chapter 11. Configuring outgoing HTTP requests - Red Hat build of Keycloak 26.4 Server Configuration Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-outgoinghttp
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/server_configuration_guide/outgoinghttp-
...
# Chapter 11. Configuring outgoing HTTP requests - Red Hat build of Keycloak 26.4 Server Configuration Guide
...
- allow-redirects
-
Whether to allow following HTTP redirects. Default: false. This option is deprecated, only provided for backwards compatibility, and will be removed in a future release. It is recommended to be
false
to avoid redirects that could lead for example to server-side request forgery (SSRF). - client-keystore

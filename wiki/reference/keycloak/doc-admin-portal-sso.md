---
title: "Chapter 2. Red Hat single sign-on and Red Hat build of Keycloak for the 3scale API Management Admin Portal - Red Hat 3scale API Management 2.16 Admin Portal Guide"
type: reference
domain: keycloak
slug: doc-admin-portal-sso
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_3scale_api_management/2.16/html/admin_portal_guide/admin-portal-sso
...
# Chapter 2. Red Hat single sign-on and Red Hat build of Keycloak for the 3scale API Management Admin Portal - Red Hat 3scale API Management 2.16 Admin Portal Guide

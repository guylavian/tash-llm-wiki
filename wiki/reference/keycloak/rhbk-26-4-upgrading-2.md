---
title: "Chapter 17. Upgrading the Red Hat build of Keycloak Client Libraries - Red Hat build of Keycloak 26.4 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-upgrading-2
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/securing_applications_and_services_guide/upgrading-
...
# Chapter 17. Upgrading the Red Hat build of Keycloak Client Libraries - Red Hat build of Keycloak 26.4 Securing Applications and Services Guide

Chapter 17. Upgrading the Red Hat build of Keycloak Client Libraries

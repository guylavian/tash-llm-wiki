---
title: "Chapter 8. Migrating upstream Keycloak to Red Hat build of Keycloak 26.2 - Red Hat build of Keycloak 26.2 Migration Guide"
type: reference
domain: keycloak
slug: rhbk-26-2-migrating-keycloak
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.2/html/migration_guide/migrating-keycloak
...
# Chapter 8. Migrating upstream Keycloak to Red Hat build of Keycloak 26.2 - Red Hat build of Keycloak 26.2 Migration Guide

Chapter 8. Migrating upstream Keycloak to Red Hat build of Keycloak 26.2

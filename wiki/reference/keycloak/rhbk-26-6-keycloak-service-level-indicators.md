---
title: "Chapter 5. Monitoring performance with Service Level Indicators - Red Hat build of Keycloak 26.6 Observability Guide"
type: reference
domain: keycloak
slug: rhbk-26-6-keycloak-service-level-indicators
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.6/html/observability_guide/keycloak-service-level-indicators-
...
# Chapter 5. Monitoring performance with Service Level Indicators - Red Hat build of Keycloak 26.6 Observability Guide

Chapter 5. Monitoring performance with Service Level Indicators
...
5.2. Definition of the service delivered
...
5.4.2. Latency of authentication requests
...
5.4.3. Errors for authentication requests

---
title: "Chapter 8. Configuring a reverse proxy - Red Hat build of Keycloak 26.4 Server Configuration Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-reverseproxy
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/server_configuration_guide/reverseproxy-
...
# Chapter 8. Configuring a reverse proxy - Red Hat build of Keycloak 26.4 Server Configuration Guide
...
If you configured a http-relative-path
on the server, proceed as follows to use discovery wih RFC8414: Configure a reverse proxy to map the /.well-known/
path without the prefix to the path with the prefix on the server.
8.6. Trusted Proxies

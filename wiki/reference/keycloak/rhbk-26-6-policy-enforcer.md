---
title: "Chapter 20. Red Hat build of Keycloak policy enforcer - Red Hat build of Keycloak 26.6 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-6-policy-enforcer
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.6/html/securing_applications_and_services_guide/policy-enforcer-
...
# Chapter 20. Red Hat build of Keycloak policy enforcer - Red Hat build of Keycloak 26.6 Securing Applications and Services Guide

Chapter 20. Red Hat build of Keycloak policy enforcer
Using the Red Hat build of Keycloak policy enforcer in Java applications.
...
20.2.1. Obtaining information from the HTTP request
...
20.2.2. Obtaining information from an external HTTP service
...
20.2.4. Claim information provider SPI
...
20.3. Obtaining the authorization context
...
would be changed.
20.4. Using the AuthorizationContext to obtain an Authorization Client Instance
The

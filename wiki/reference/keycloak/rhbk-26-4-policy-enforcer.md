---
title: "Chapter 16. Red Hat build of Keycloak policy enforcer - Red Hat build of Keycloak 26.4 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-policy-enforcer
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/securing_applications_and_services_guide/policy-enforcer-
...
# Chapter 16. Red Hat build of Keycloak policy enforcer - Red Hat build of Keycloak 26.4 Securing Applications and Services Guide

Chapter 16. Red Hat build of Keycloak policy enforcer
...
16.2.1. Obtaining information from the HTTP request
...
16.2.2. Obtaining information from an external HTTP service
...
16.2.4. Claim information provider SPI
...
16.3. Obtaining the authorization context
...
would be changed.
16.4. Using the AuthorizationContext to obtain an Authorization Client Instance
The

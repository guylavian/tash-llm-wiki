---
title: "Chapter 6. Red Hat build of Keycloak SAML Galleon feature pack for WildFly and EAP - Red Hat build of Keycloak 26.4 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-saml-galleon-layers
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/securing_applications_and_services_guide/saml-galleon-layers-
...
# Chapter 6. Red Hat build of Keycloak SAML Galleon feature pack for WildFly and EAP - Red Hat build of Keycloak 26.4 Securing Applications and Services Guide

Chapter 6. Red Hat build of Keycloak SAML Galleon feature pack for WildFly and EAP
Using Red Hat build of Keycloak SAML Galleon feature pack to secure applications in WildFly and EAP.
...
6.4.2. Logout in multi-cluster deployments

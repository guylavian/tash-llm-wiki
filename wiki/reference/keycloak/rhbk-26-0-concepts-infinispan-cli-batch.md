---
title: "Chapter 7. Concepts to automate Data Grid CLI commands - Red Hat build of Keycloak 26.0 High Availability Guide"
type: reference
domain: keycloak
slug: rhbk-26-0-concepts-infinispan-cli-batch
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.0/html/high_availability_guide/concepts-infinispan-cli-batch-
...
7.2. Example
The following Batch
CR takes a site offline as described in the operational procedure Take site offline.

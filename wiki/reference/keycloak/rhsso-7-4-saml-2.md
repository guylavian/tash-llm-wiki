---
title: "Chapter 3. SAML - Red Hat Single Sign-On 7.4 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhsso-7-4-saml-2
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.4/html/securing_applications_and_services_guide/saml_2
...
# Chapter 3. SAML - Red Hat Single Sign-On 7.4 Securing Applications and Services Guide
...
It is possible to use the legacy non-Elytron adapter on JBoss EAP 7.1 or newer as well, meaning you can use adapter-install-saml.cli

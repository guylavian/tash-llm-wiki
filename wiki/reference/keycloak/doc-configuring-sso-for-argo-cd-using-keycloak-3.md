---
title: "Chapter 3. Configuring SSO for Argo CD using Keycloak - Red Hat OpenShift GitOps 1.14 Access control and user management"
type: reference
domain: keycloak
slug: doc-configuring-sso-for-argo-cd-using-keycloak-3
tier: reference
...
CR. Use this feature to support advanced routing use cases, such as balancing incoming traffic load among multiple Ingress Controller shards.Add a
host

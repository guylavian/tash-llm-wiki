---
title: "Chapter 3. Choosing an Operating Mode - Red Hat Single Sign-On 7.2 Server Installation and Configuration Guide"
type: reference
domain: keycloak
slug: rhsso-7-2-operating-mode
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.2/html/server_installation_and_configuration_guide/operating-mode
...
# Chapter 3. Choosing an Operating Mode - Red Hat Single Sign-On 7.2 Server Installation and Configuration Guide
...
This config defines the default port mappings for various connectors that are opened with each Red Hat Single Sign-On server instance. Any value that contains ${…}
is a value that can be overriden on the command line with the -D
switch, i.e.
...
When running the boot script you will need pass in the host controlling configuration file you are going to use via the --host-config
switch.

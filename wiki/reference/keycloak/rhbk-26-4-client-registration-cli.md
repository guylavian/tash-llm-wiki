---
title: "Chapter 11. Automating client registration with the CLI - Red Hat build of Keycloak 26.4 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-client-registration-cli
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/securing_applications_and_services_guide/client-registration-cli-
...
# Chapter 11. Automating client registration with the CLI - Red Hat build of Keycloak 26.4 Securing Applications and Services Guide

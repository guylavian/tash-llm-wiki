---
title: "Chapter 8. Configuring authentication - Red Hat Single Sign-On 7.5 Server Administration Guide"
type: reference
domain: keycloak
slug: rhsso-7-5-configuring-authentication
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.5/html/server_administration_guide/configuring_authentication
...
# Chapter 8. Configuring authentication - Red Hat Single Sign-On 7.5 Server Administration Guide
...
must be available in the LDAP under an LDAP DN such as uid=john,ou=People,dc=example,dc=com
...
org.keycloak
in the logging section ofstandalone/configuration/standalone.xml
to receive more information instandalone/log/server.log
-
...
Red Hat Single Sign-On provides limited support for W3C Web Authentication (WebAuthn). Red Hat Single Sign-On works as a WebAuthn’s Relying Party (RP).
...
8.6.8. Explicitly deny/allow access in conditional flows

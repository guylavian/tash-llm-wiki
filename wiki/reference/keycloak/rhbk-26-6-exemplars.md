---
title: "Chapter 9. Analyzing outliers and errors with exemplars - Red Hat build of Keycloak 26.6 Observability Guide"
type: reference
domain: keycloak
slug: rhbk-26-6-exemplars
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.6/html/observability_guide/exemplars-
...
# Chapter 9. Analyzing outliers and errors with exemplars - Red Hat build of Keycloak 26.6 Observability Guide

Chapter 9. Analyzing outliers and errors with exemplars
...
Figure 9.1. Heatmap diagram with exemplar
9.1. Setting up exemplars
...
protocol, which is not enabled by default in Prometheus.If you are using a
ServiceMonitor
or similar in a Kubernetes environment, this can be achieved by adding it to the spec of the custom resource:apiVersion: monitoring.coreos.com/v1 kind: ServiceMonitor metadata: ... spec: scrapeProtocols: - OpenMetricsText1.0.0
...
9.2. Verifying that exemplars work as expected

---
title: "Chapter 12. Using token exchange - Red Hat build of Keycloak 26.0 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-0-token-exchange
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.0/html/securing_applications_and_services_guide/token-exchange-
...
Chapter 12. Using token exchange
...
12.1.2. Responses from a token exchange request
...
12.2. Internal token to internal token exchange
...
12.2.1. Granting permission for the exchange
...
Figure 12.4. Client Policy Creation
...
Figure 12.5. Apply Client Policy
...
12.3. Internal token to external token exchange
...
12.3.1. Granting permission for the exchange
...
Figure 12.6. Identity Provider Permission
Procedure
Toggle Permissions Enabled to On.
Figure 12.7. Identity Provider Permission
The page displays token-exchange link.
Click the link to start defining the permission.
This setup page appears.
Figure 12.8. Identity Provider Exchange Permission Setup
- Click Client details in the breadcrumbs at the top of the screen.
Click Policies tab to create a client policy.
Figure 12.9. Client Policy Creation
...
Figure 12.10. Apply Client Policy
Your client now has permission to invoke. If you do not do this correctly, you will get a 403 Forbidden response if you try to make an exchange.
12.3.2. Making the request
...
12.4. External token to internal token exchange
...
12.4.1. Granting permission for the exchange
...
12.5.1. Granting permission for the exchange
...
12.6.1. Granting permission for the exchange
If the audience
...
Figure 12.11. User Permissions
Toggle Permissions Enabled to On.
Figure 12.12. Identity Provider Permission
The page displays an impersonate link.
Click that link to start defining the permission.
This setup page displays.
Figure 12.13. Users Impersonation Permission Setup
- Click Client details in the breadcrumbs at the top of the screen.
- Define a policy for this permission.
Go to the Policies tab and create a client policy.
Figure 12.14. Client Policy Creation
- Enter the starting client that is the authenticated client that is requesting a token exchange.
Return to the users' impersonation permission and add the client policy you just defined.
Figure 12.15. Apply Client Policy
...
-d "requested_subject=wburke" \
http://localhost:8080/realms/myrealm/protocol/openid-connect/token
12.7. Expand permission model with service accounts

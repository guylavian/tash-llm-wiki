---
title: "Chapter 4. Red Hat build of Keycloak Node.js adapter - Red Hat build of Keycloak 26.2 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-2-nodejs-adapter
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.2/html/securing_applications_and_services_guide/nodejs-adapter-
...
# Chapter 4. Red Hat build of Keycloak Node.js adapter - Red Hat build of Keycloak 26.2 Securing Applications and Services Guide
...
4.1. Supported Node.js versions
The Node.js adapter strives to be compatible with the versions that are actively supported by the Node.js project. Support for versions of Node.js that are considered end-of-life can be dropped in future releases, and will not be considered a breaking change that requires a major version bump.
4.2. Installation
...
In that case, a Red Hat build of Keycloak deployment is necessary so you can access the Red Hat build of Keycloak Admin Console.
Once the Admin Console is deployed, we are ready to obtain the keycloak.json
...
4.9. Upgrading the Node.js adapter

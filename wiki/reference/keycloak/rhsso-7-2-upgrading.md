---
title: "Chapter 3. Upgrading Red Hat Single Sign-On Server - Red Hat Single Sign-On 7.2 Upgrading Guide"
type: reference
domain: keycloak
slug: rhsso-7-2-upgrading
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.2/html/upgrading_guide/upgrading
...
3.1.4.1. Theme changes RH-SSO 7.2
Templates
- Account: account.ftl
...
- Account: account.css
- Login: login.css
3.1.4.2. Theme changes RH-SSO 7.1
Templates
- Account: account.ftl
- Account: federatedIdentity.ftl
- Account: totp.ftl

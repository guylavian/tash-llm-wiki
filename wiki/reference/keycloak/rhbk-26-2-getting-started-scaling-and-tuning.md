---
title: "Chapter 2. Scaling - Red Hat build of Keycloak 26.2 Getting Started Guide"
type: reference
domain: keycloak
slug: rhbk-26-2-getting-started-scaling-and-tuning
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.2/html/getting_started_guide/getting-started-scaling-and-tuning-
...
# Chapter 2. Scaling - Red Hat build of Keycloak 26.2 Getting Started Guide
...
as desired to horizontally scale. For more details, see Deploying Red Hat build of Keycloak for HA with the Operator.

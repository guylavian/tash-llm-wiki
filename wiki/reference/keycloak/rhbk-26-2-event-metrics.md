---
title: "Chapter 3. Monitoring user activities with event metrics - Red Hat build of Keycloak 26.2 Observability Guide"
type: reference
domain: keycloak
slug: rhbk-26-2-event-metrics
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.2/html/observability_guide/event-metrics-
...
# Chapter 3. Monitoring user activities with event metrics - Red Hat build of Keycloak 26.2 Observability Guide

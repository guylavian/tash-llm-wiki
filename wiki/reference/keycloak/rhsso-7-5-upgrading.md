---
title: "Chapter 3. Upgrading the Red Hat Single Sign-On server - Red Hat Single Sign-On 7.5 Upgrading Guide"
type: reference
domain: keycloak
slug: rhsso-7-5-upgrading
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.5/html/upgrading_guide/upgrading
...
- If you are migrating from Keycloak 15.0.2, follow the steps in Minor Upgrades.
...
Procedure
Subscribe to the proper repositories containing JBOSS EAP and Red Hat Single Sign-On.
...
Disable older product repositories for both JBOSS EAP and Red Hat Single Sign-On:
...
Normally the old packages are removed by
dnf upgrade
. However, the RH-SSO 7.5 packages use a format that conflicts with files handled by the JBoss EAP 7.3 package. Therefore, the RH-SSO 7.4 and JBoss EAP 7.3 packages must be removed.dnf remove --exclude java-1.8.0-openjdk rh-sso7-keycloak

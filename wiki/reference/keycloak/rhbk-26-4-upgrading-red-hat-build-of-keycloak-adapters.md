---
title: "Chapter 4. Upgrading Red Hat build of Keycloak adapters - Red Hat build of Keycloak 26.4 Upgrading Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-upgrading-red-hat-build-of-keycloak-adapters
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/upgrading_guide/upgrading_red_hat_build_of_keycloak_adapters
...
# Chapter 4. Upgrading Red Hat build of Keycloak adapters - Red Hat build of Keycloak 26.4 Upgrading Guide
...
For this release of Red Hat build of Keycloak, the supported version of this adapter is 26.2.1. To upgrade a JavaScript adapter that has been copied to your web application, perform the following procedure.
Procedure
- Remove the previous version of the JavaScript adapter.
Use these NPM commands to install the 26.2.1 version of the adapter:

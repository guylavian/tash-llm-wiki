---
title: "Chapter 2. Using OpenID Connect to secure applications and services - Red Hat Single Sign-On 7.5 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhsso-7-5-oidc
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.5/html/securing_applications_and_services_guide/oidc
...
# Chapter 2. Using OpenID Connect to secure applications and services - Red Hat Single Sign-On 7.5 Securing Applications and Services Guide
...
must contain at least these imports:org.keycloak.adapters.jetty;version="15.0.8.redhat-00001", org.keycloak.adapters;version="15.0.8.redhat-00001", org.keycloak.constants;version="15.0.8.redhat-00001", org.keycloak.util;version="15.0.8.redhat-00001", org.keycloak.*;version="15.0.8.redhat-00001", *;resolution:=optional
...
All features are supported if SSL / TLS connection is configured on the Red Hat Single Sign-On side as well as on the application side. See configuring the SSL / TLS. Affected is for example Chrome starting with version 84.

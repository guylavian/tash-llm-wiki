---
title: "Chapter 8. Network Setup - Red Hat Single Sign-On 7.4 Server Installation and Configuration Guide"
type: reference
domain: keycloak
slug: rhsso-7-4-network
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.4/html/server_installation_and_configuration_guide/network
...
# Chapter 8. Network Setup - Red Hat Single Sign-On 7.4 Server Installation and Configuration Guide
...
, which is a child element of subsystem xmlns="urn:jboss:domain:undertow:10.0"

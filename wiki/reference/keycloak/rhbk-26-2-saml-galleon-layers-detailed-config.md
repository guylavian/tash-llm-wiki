---
title: "Chapter 7. Red Hat build of Keycloak SAML Galleon feature pack detailed configuration - Red Hat build of Keycloak 26.2 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-2-saml-galleon-layers-detailed-config
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.2/html/securing_applications_and_services_guide/saml-galleon-layers-detailed-config-
...
# Chapter 7. Red Hat build of Keycloak SAML Galleon feature pack detailed configuration - Red Hat build of Keycloak 26.2 Securing Applications and Services Guide

---
title: "Chapter 5. Managing Policies - Red Hat Single Sign-On 7.3 Authorization Services Guide"
type: reference
domain: keycloak
slug: rhsso-7-3-policy-overview
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.3/html/authorization_services_guide/policy_overview
...
# Chapter 5. Managing Policies - Red Hat Single Sign-On 7.3 Authorization Services Guide
...
Drools Policy is Technology Preview and is not fully supported. This feature is disabled by default.
To enable start the server with -Dkeycloak.profile=preview
or -Dkeycloak.profile.feature.authz_drools_policy=enabled

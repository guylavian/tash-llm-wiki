...
abstract: "- when a user try to reset a password that doesn't meet the user policy then getting the error ~~~ 'Could not modify attribute for DN' ~~~ We would be looking to give a generic message to users when it fails to change the password.- The error could be better if this more generic to the user just say something along lines of 'Unable to update password, talk with your administrator'. Does it possibl…"
---

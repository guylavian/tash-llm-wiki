---
title: "Chapter 18. Configuring the Management Interface - Red Hat build of Keycloak 26.4 Server Configuration Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-management-interface
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/server_configuration_guide/management-interface-
...
If you do not want the management interface to use HTTPS, you may set the http-management-scheme
option to http
.

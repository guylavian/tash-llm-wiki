---
title: "Chapter 4. Configuring a Docker registry to use Red Hat Single Sign-On - Red Hat Single Sign-On 7.5 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhsso-7-5-configuring-a-docker-registry-to-use-red-hat-single-sign-on
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.5/html/securing_applications_and_services_guide/configuring_a_docker_registry_to_use_red_hat_single_sign_on
...
# Chapter 4. Configuring a Docker registry to use Red Hat Single Sign-On - Red Hat Single Sign-On 7.5 Securing Applications and Services Guide

Chapter 4. Configuring a Docker registry to use Red Hat Single Sign-On
...
field with the location of the Red Hat Single Sign-On realm’s public certificate. The auth configuration will not work without this argument.
...
override with the location of the Red Hat Single Sign-On realm’s public certificate. The auth configuration will not work without this argument.

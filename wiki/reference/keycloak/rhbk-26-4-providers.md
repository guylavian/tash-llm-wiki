---
title: "Chapter 4. Service Provider Interfaces (SPI) - Red Hat build of Keycloak 26.4 Server Developer Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-providers
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/server_developer_guide/providers
...
# Chapter 4. Service Provider Interfaces (SPI) - Red Hat build of Keycloak 26.4 Server Developer Guide

Chapter 4. Service Provider Interfaces (SPI)
...
The pom.xml file for your SPI requires a dependencyManagement
section with an import reference to the Red Hat build of Keycloak version that is intended for the SPI. In this example, replace the occurrence of VERSION
with 26.4.11.redhat-00001, which is the current version of Red Hat build of Keycloak.
...
- Replace
VERSION
with the current version of Red Hat build of Keycloak
4.1.1. Override built-in providers
...
4.1.2. Show info from your SPI implementation in the Admin Console
...
4.3. Registering provider implementations
...
4.4.1.1. Where to add script authenticator
...
4.4.2. OpenID Connect Protocol Mapper
...
4.4.3. Create a JAR with the scripts to deploy
...
.
4.5. Available SPIs
If you want to see list of all available SPIs at runtime, you can check Provider Info

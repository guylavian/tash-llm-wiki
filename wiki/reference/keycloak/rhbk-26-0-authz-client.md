---
title: "Chapter 14. Red Hat build of Keycloak authorization client - Red Hat build of Keycloak 26.0 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-0-authz-client
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.0/html/securing_applications_and_services_guide/authz-client-
guide: securing_applications_and_services_guide
version: 26.0
family: rhbk
documentKind: "Documentation"
abstract: "Depending on your requirements, a resource server should be able to manage resources remotely or even check for permissions programmatically. If you are using Java, you can access the Red Hat build of Keycloak Authorization Services using the Authorization Client API. It is targeted for resource servers that want to access the different endpoints provided by the server such as the Token Endpoint, …"
---

# Chapter 14. Red Hat build of Keycloak authorization client - Red Hat build of Keycloak 26.0 Securing Applications and Services Guide

Chapter 14. Red Hat build of Keycloak authorization client
...
file.
keycloak.json
14.3. Creating the authorization client
...
14.4. Obtaining user entitlements
...
System.out.println("You got an RPT: " + rpt);
// now you can use the RPT to access protected resources on the resource server
14.5. Creating a resource using the protection API
// create a new instance based on the configuration defined in keycloak.json
AuthzClient authzClient = AuthzClient.create();
...
14.7.1. Client ID and Client Secret
...
14.7.2. Client authentication with Signed JWT
...
14.7.3. Client authentication with Signed JWT using client secret
...
file.
14.7.4. Add your own client authentication method

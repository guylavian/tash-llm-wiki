---
title: "Chapter 5. Enabling and configuring the Nexus Repository Manager plugin - Red Hat Developer Hub 1.7 Configuring dynamic plugins"
type: reference
domain: keycloak
slug: doc-assembly-enabling-configuring-the-nexus-plugin-assembly-installing-configuring-keycloak-3
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.7/html/configuring_dynamic_plugins/assembly-enabling-configuring-the-nexus-plugin_assembly-installing-configuring-keycloak
guide: configuring_dynamic_plugins
documentKind: "Documentation"
---

# Chapter 5. Enabling and configuring the Nexus Repository Manager plugin - Red Hat Developer Hub 1.7 Configuring dynamic plugins

---
title: "Chapter 7. Network Setup - Red Hat Single Sign-On 7.2 Server Installation and Configuration Guide"
type: reference
domain: keycloak
slug: rhsso-7-2-network
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.2/html/server_installation_and_configuration_guide/network
...
# Chapter 7. Network Setup - Red Hat Single Sign-On 7.2 Server Installation and Configuration Guide
...
(it’s a child element of subsystem xmlns="urn:jboss:domain:undertow:4.0"
) and add:

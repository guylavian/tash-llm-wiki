---
title: "Chapter 4. Migrating Templates deployments on Openshift - Red Hat build of Keycloak 26.6 Migration Guide"
type: reference
domain: keycloak
slug: rhbk-26-6-migrating-openshift
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.6/html/migration_guide/migrating-openshift
...
| Red Hat Single Sign-On 7.6 | Red Hat build of Keycloak 26.6 |
|---|---|

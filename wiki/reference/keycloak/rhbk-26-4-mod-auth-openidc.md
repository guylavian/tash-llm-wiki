---
title: "Chapter 5. Configuring the mod_auth_openidc Apache HTTPD Module - Red Hat build of Keycloak 26.4 Securing Applications and Services Guide"
type: reference
domain: keycloak
slug: rhbk-26-4-mod-auth-openidc
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.4/html/securing_applications_and_services_guide/mod-auth-openidc-
...
# Chapter 5. Configuring the mod_auth_openidc Apache HTTPD Module - Red Hat build of Keycloak 26.4 Securing Applications and Services Guide

---
title: "Chapter 7. Migrating custom themes - Red Hat build of Keycloak 26.6 Migration Guide"
type: reference
domain: keycloak
slug: rhbk-26-6-migrating-themes
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_build_of_keycloak/26.6/html/migration_guide/migrating-themes
...
# Chapter 7. Migrating custom themes - Red Hat build of Keycloak 26.6 Migration Guide
...
directory. In both cases, see Working with themes for more details about the file and directory structure expected by the server.

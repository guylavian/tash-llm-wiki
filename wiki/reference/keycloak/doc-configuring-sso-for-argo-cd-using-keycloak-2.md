---
title: "Chapter 3. Configuring SSO for Argo CD using Keycloak - Red Hat OpenShift GitOps 1.15 Access control and user management"
type: reference
domain: keycloak
slug: doc-configuring-sso-for-argo-cd-using-keycloak-2
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_openshift_gitops/1.15/html/access_control_and_user_management/configuring-sso-for-argo-cd-using-keycloak
guide: access_control_and_user_management
documentKind: "Documentation"
---

# Chapter 3. Configuring SSO for Argo CD using Keycloak - Red Hat OpenShift GitOps 1.15 Access control and user management
...
The
DeploymentConfig
API is available in the cluster. For more information, see "DeploymentConfig [apps.openshift.io/v1]".
...
Keycloak created by the Red Hat OpenShift GitOps only persists the changes that are made by the operator. If the Keycloak restarts, any additional configuration created by the Admin in Keycloak is deleted.

---
title: "Chapter 4. Using external storage - Red Hat Single Sign-On 7.5 Server Administration Guide"
type: reference
domain: keycloak
slug: rhsso-7-5-user-storage-federation
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.5/html/server_administration_guide/user-storage-federation
...
# Chapter 4. Using external storage - Red Hat Single Sign-On 7.5 Server Administration Guide
...
. You increase this level in the logging
It is useful to increase the logging level to TRACE for the category org.keycloak.storage.ldap
. You increase this level in the logging subsystem in the standalone(-ha).xml
file. With this setting, many logging messages are sent to the server.log
file in the TRACE

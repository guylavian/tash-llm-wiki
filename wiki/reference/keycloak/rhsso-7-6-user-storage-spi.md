---
title: "Chapter 7. User Storage SPI - Red Hat Single Sign-On 7.6 Server Developer Guide"
type: reference
domain: keycloak
slug: rhsso-7-6-user-storage-spi
tier: reference
source: https://docs.redhat.com/en/documentation/red_hat_single_sign-on/7.6/html/server_developer_guide/user-storage-spi
...
# Chapter 7. User Storage SPI - Red Hat Single Sign-On 7.6 Server Developer Guide
...
To deploy this jar, just copy it to the standalone/deployments/
directory. === Simple read-only, lookup example
...
7.4.1.1. UserLookupProvider implementation
@Override
...
method returns null.
7.4.1.2. CredentialInputValidator implementation
...
7.4.1.3. CredentialInputUpdater implementation
...
is thrown.
7.4.2. Provider factory implementation
...
7.4.3. Packaging and deployment
...
To deploy this jar, just copy it to the standalone/deployments/
directory.
7.4.4. Enabling the provider in the Admin Console
...
7.6.2. Implementing UserQueryProvider
...
7.7. Augmenting external storage
...
7.8. Import implementation strategy
...
7.8.1. ImportedUserValidation interface
...
7.8.2. ImportSynchronization interface
...
7.9.2. OnUserCache callback interface
...
7.12. Migrating from an earlier user federation SPI
...
7.12.1. Import versus non-import
...
interface.
7.12.4. Upgrading to a new model

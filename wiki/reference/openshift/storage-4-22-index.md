---
title: "{product-title} storage overview"
type: reference
domain: openshift
slug: storage-4-22-index
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/storage/index
version: 4.22
family: storage
...
OpenShift Container Platform supports Amazon Elastic Block Store (Amazon EBS) and Amazon Elastic File System (Amazon EFS) storage. You can manage container storage for persistent and non-persistent data in an OpenShift Container Platform cluster.
...
+
Do _not_ use nested mount points because OpenShift Container Platform does not guarantee the order in which mount points are created. Such usage is prone to race conditions and undefined behavior.
...
Pod::
One or more containers with shared resources, such as volume and IP addresses, running in your OpenShift Container Platform cluster.
...
Storage:: OpenShift Container Platform supports many types of storage, both for on-premise and cloud providers. You can manage container storage for persistent and non-persistent data in

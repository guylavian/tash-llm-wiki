...
type: reference
domain: openshift
slug: architecture-4-22-nvidia-gpu-architecture-overview
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/architecture/nvidia-gpu-architecture-overview
version: 4.22
family: architecture

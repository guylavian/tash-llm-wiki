...
type: reference
domain: openshift
slug: authentication-4-22-understanding-authentication
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/authentication/understanding-authentication
version: 4.22
...
For users to interact with OpenShift Container Platform, they must first authenticate
...
A _user_ in OpenShift Container Platform is an entity that can make requests to the
OpenShift Container Platform API. An OpenShift Container Platform `User` object represents an actor which
...
administrator that is interacting with OpenShift Container Platform.
...
|`Regular users`
|This is the way most interactive OpenShift Container Platform users are
...
Requests to the OpenShift Container Platform API are authenticated using the following
methods:
...
created when starting the OpenShift Container Platform API:
...
OpenShift Container Platform supports authenticating using a `WWW-Authenticate`

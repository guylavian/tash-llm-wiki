...
type: reference
domain: openshift
slug: reference-kubeadm-init-phase-kubeconfig-all
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_init/kubeadm_init_phase_kubeconfig_all
family: reference
documentKind: "doc"
---

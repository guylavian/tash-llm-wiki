---
title: "Installing a cluster in an LPAR on {ibm-z-title} and {ibm-linuxone-title}"
type: reference
domain: openshift
slug: installing-4-22-installing-ibm-z-lpar
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-ibm-z-lpar
version: 4.22
family: installing
...
[role="_abstract"]
In OpenShift Container Platform version , you can install a cluster in a logical partition (LPAR) on {ibm-z-name} or {ibm-linuxone-name} infrastructure that you provision.

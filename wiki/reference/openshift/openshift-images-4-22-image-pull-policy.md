...
type: reference
domain: openshift
slug: openshift-images-4-22-image-pull-policy
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/openshift_images/image-pull-policy
version: 4.22

...
type: reference
domain: openshift
slug: virt-4-22-virt-configuring-shared-volumes-for-vms
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/virt/virt-configuring-shared-volumes-for-vms
version: 4.22
family: virt

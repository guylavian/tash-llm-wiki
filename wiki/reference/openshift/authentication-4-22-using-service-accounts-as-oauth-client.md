...
type: reference
domain: openshift
slug: authentication-4-22-using-service-accounts-as-oauth-client
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/authentication/using-service-accounts-as-oauth-client
version: 4.22

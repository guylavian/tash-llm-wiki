...
type: reference
domain: openshift
slug: service-mesh-4-22-ossm-profiles-users
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/service_mesh/ossm-profiles-users
version: 4.22
family: service_mesh
...
. Log in to the OpenShift Container Platform CLI as a `cluster-admin`. If you use {product-dedicated}, you must have an account with the `dedicated-admin` role.

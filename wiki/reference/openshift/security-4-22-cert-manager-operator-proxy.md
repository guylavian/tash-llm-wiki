---
title: "Configuring the egress proxy for the {cert-manager-operator}"
type: reference
domain: openshift
slug: security-4-22-cert-manager-operator-proxy
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/security/cert-manager-operator-proxy
version: 4.22
family: security
...
[role="_abstract"]
If your OpenShift Container Platform cluster has the cluster-wide proxy enabled, you can inject any CA certificates that are required for proxying HTTPS connections into the {cert-manager-operator}.

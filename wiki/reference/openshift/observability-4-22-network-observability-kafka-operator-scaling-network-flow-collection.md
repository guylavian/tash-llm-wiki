...
type: reference
domain: openshift
slug: observability-4-22-network-observability-kafka-operator-scaling-network-flow-collection
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/network-observability-kafka-operator-scaling-network-flow-collection
version: 4.22

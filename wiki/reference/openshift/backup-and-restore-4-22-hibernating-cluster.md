---
title: "Hibernating an {product-title} cluster"
type: reference
domain: openshift
slug: backup-and-restore-4-22-hibernating-cluster
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/backup_and_restore/hibernating-cluster
version: 4.22

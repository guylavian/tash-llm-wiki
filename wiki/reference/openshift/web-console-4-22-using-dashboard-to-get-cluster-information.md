---
title: "Using the {product-title} dashboard to get cluster information"
type: reference
domain: openshift
slug: web-console-4-22-using-dashboard-to-get-cluster-information
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/web_console/using-dashboard-to-get-cluster-information
version: 4.22
family: web_console
...
[role="_abstract"]
Access the OpenShift Container Platform dashboard, which captures high-level information
about the cluster, by navigating to *Home* -> *Overview* from the OpenShift Container Platform web console.

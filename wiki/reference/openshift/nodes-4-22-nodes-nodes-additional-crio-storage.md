...
type: reference
domain: openshift
slug: nodes-4-22-nodes-nodes-additional-crio-storage
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-nodes-additional-crio-storage
version: 4.22
family: nodes

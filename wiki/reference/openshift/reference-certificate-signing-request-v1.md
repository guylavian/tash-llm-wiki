...
type: reference
domain: openshift
slug: reference-certificate-signing-request-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/certificates/certificate-signing-request-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>spec</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "#CertificateSigningRequestSpec" >}}">CertificateSigningRequestSpec</a></em></td>
    ...
    <tr>
      <td><code>status</code><br/><em><a href="{{< ref "#CertificateSigningRequestStatus" >}}">CertificateSigningRequestStatus</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>conditions</code><br/><em><a href="{{< ref "#CertificateSigningRequestCondition" >}}">CertificateSigningRequestCondition array</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "certificate-signing-request-v1#CertificateSigningRequest" >}}">CertificateSigningRequest array</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>lastUpdateTime</code><br/><em><a href="{{< ref "../definitions/time-v1-meta#Time" >}}">Time</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "certificate-signing-request-v1#CertificateSigningRequest" >}}">CertificateSigningRequest</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "certificate-signing-request-v1#CertificateSigningRequestList" >}}">CertificateSigningRequestList</a></em></td>
    </tr>
  </tbody>
</table>

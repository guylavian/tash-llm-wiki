...
type: reference
domain: openshift
slug: installing-4-22-scaling-a-user-provisioned-cluster-with-the-bare-metal-operator
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/scaling-a-user-provisioned-cluster-with-the-bare-metal-operator
version: 4.22
family: installing
...
[NOTE]
====
OpenShift Container Platform  does not support enabling a provisioning network when you scale a user-provisioned cluster by using the Bare Metal Operator.
====

...
type: reference
domain: openshift
slug: observability-4-22-6x-cluster-logging-collector-6-2
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/6x-cluster-logging-collector-6.2
version: 4.22

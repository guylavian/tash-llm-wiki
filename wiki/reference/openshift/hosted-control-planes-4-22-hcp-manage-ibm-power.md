---
title: "Managing {hcp} on {ibm-power-title}"
type: reference
domain: openshift
slug: hosted-control-planes-4-22-hcp-manage-ibm-power
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/hosted_control_planes/hcp-manage-ibm-power
version: 4.22

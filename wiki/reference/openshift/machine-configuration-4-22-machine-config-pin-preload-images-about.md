...
type: reference
domain: openshift
slug: machine-configuration-4-22-machine-config-pin-preload-images-about
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/machine_configuration/machine-config-pin-preload-images-about
version: 4.22

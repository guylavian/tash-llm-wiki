...
type: reference
domain: openshift
slug: edge-computing-4-22-cnf-image-based-upgrade-base
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/edge_computing/cnf-image-based-upgrade-base
version: 4.22
...
The {lcao} reboots the cluster with the previously installed version of OpenShift Container Platform and restores the applications.
--

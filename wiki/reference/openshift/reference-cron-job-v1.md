...
type: reference
domain: openshift
slug: reference-cron-job-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/batch/cron-job-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>spec</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "#CronJobSpec" >}}">CronJobSpec</a></em></td>
    ...
    <tr>
      <td><code>status</code><br/><em><a href="{{< ref "#CronJobStatus" >}}">CronJobStatus</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>jobTemplate</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "#JobTemplateSpec" >}}">JobTemplateSpec</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>active</code><br/><em><a href="{{< ref "../definitions/object-reference-v1#ObjectReference" >}}">ObjectReference array</a></em></td>
      <td>A list of pointers to currently running jobs.</td>
    </tr>
    <tr>
      <td><code>lastScheduleTime</code><br/><em><a href="{{< ref "../definitions/time-v1-meta#Time" >}}">Time</a></em></td>
      <td>Information when was the last time the job was successfully scheduled.</td>
    </tr>
    <tr>
      <td><code>lastSuccessfulTime</code><br/><em><a href="{{< ref "../definitions/time-v1-meta#Time" >}}">Time</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "cron-job-v1#CronJob" >}}">CronJob array</a></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>spec</code><br/><em><a href="{{< ref "job-v1#JobSpec" >}}">JobSpec</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "cron-job-v1#CronJob" >}}">CronJob</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "cron-job-v1#CronJobList" >}}">CronJobList</a></em></td>
    </tr>
  </tbody>
</table>

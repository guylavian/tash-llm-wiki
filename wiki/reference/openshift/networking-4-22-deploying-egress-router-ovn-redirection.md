...
type: reference
domain: openshift
slug: networking-4-22-deploying-egress-router-ovn-redirection
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/networking/deploying-egress-router-ovn-redirection
version: 4.22
family: networking

...
type: reference
domain: openshift
slug: networking-4-22-k8s-nmstate-updating-node-network-config
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/networking/k8s-nmstate-updating-node-network-config
version: 4.22
family: networking
...
You can create an NNCP by using either the {oc-first} or the OpenShift Container Platform web console. As a postinstallation task you can create an NNCP or edit an existing NNCP.
...
For more information about the NVIDIA Operator, see Getting Started with Red{nbsp}Hat OpenShift (NVIDIA Docs Hub).
====

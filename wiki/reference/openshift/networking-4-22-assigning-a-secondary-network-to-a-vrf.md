...
type: reference
domain: openshift
slug: networking-4-22-assigning-a-secondary-network-to-a-vrf
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/networking/assigning-a-secondary-network-to-a-vrf
version: 4.22
family: networking

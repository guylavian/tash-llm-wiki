...
type: reference
domain: openshift
slug: etcd-4-22-etcd-overview
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/etcd/etcd-overview
version: 4.22
family: etcd
...
The OpenShift Container Platform console provides dashboards to visualize the various etcd metrics. In the console, click *Observe* -> *Dashboards*.  From the dropdown list, select *etcd*.

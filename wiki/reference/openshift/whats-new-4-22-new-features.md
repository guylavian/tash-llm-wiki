...
type: reference
domain: openshift
slug: whats-new-4-22-new-features
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/whats_new/new-features
version: 4.22
family: whats_new
...
OpenShift Container Platform) and using its current state to make decisions in real time.
...
See
Understanding the Operator Lifecycle Manager (OLM) for more information.
...
See
Understanding the software catalog for more information.
...
Use the OpenShift Container Platform
...
The
Node
Tuning Operator is now part of a standard OpenShift Container Platform installation in
OpenShift v4.
...
if OpenShift Container Platform ships an out-of-the-box custom metrics adapter.

[id="ocp-cluster-monitoring-alerting-UI"]
=== New alerting user interface

An alerting UI is now natively integrated into the OpenShift Container Platform web console.
...
customers with their OpenShift Container Platform clusters. This helps:
...
SR-IOV hardware on OpenShift Container Platform nodes, which enables the user to
...
F5 router plugin is no longer supported as part of OpenShift Container Platform directly.

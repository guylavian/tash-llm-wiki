---
title: "Traffic splitting using the Knative CLI"
type: reference
domain: openshift
slug: serverless-4-22-traffic-splitting-using-cli
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/traffic-splitting-using-cli
version: 4.22
family: serverless

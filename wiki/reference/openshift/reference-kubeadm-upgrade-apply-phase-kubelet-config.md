...
type: reference
domain: openshift
slug: reference-kubeadm-upgrade-apply-phase-kubelet-config
tier: reference
source: https://kubernetes.io/docs/reference/setup-tools/kubeadm/generated/kubeadm_upgrade/kubeadm_upgrade_apply_phase_kubelet-config
family: reference
documentKind: "doc"
---

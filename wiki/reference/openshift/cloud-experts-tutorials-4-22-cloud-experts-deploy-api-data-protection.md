---
title: "Tutorial: Deploying OpenShift API for Data Protection on a {product-title} cluster"
type: reference
domain: openshift
slug: cloud-experts-tutorials-4-22-cloud-experts-deploy-api-data-protection
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/cloud_experts_tutorials/cloud-experts-deploy-api-data-protection
version: 4.22
...
= Tutorial: Deploying OpenShift API for Data Protection on a OpenShift Container Platform cluster

[role="_abstract"]
The following tutorial shows you how to deploy the OpenShift API for data protection on your OpenShift Container Platform cluster.
...
[NOTE]
====
Change the cluster name to match your OpenShift Container Platform cluster and ensure you are logged into the cluster as an Administrator.
...
[NOTE]
====
* In OADP 1.1.x OpenShift Container Platform STS environments, the container image backup and restore (`spec.backupImages`) value must be set to `false` as it is not supported.
* The Restic feature (`restic.enable=false`) is disabled and not supported in OpenShift Container Platform STS environments.
* The DataMover feature (`dataMover.enable=false`) is disabled and not supported in OpenShift Container Platform STS environments.
====
// Module included in the following assemblies:
//
// * cloud_experts_tutorials/cloud-experts-deploy-api-data-protection.adoc
...
* OADP team's troubleshooting documentation

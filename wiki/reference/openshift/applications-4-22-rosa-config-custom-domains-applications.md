...
type: reference
domain: openshift
slug: applications-4-22-rosa-config-custom-domains-applications
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/applications/rosa-config-custom-domains-applications
version: 4.22
family: applications

...
type: reference
domain: openshift
slug: reference-disableallocatordualwrite
tier: reference
source: https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/DisableAllocatorDualWrite
family: reference
documentKind: "doc"
---

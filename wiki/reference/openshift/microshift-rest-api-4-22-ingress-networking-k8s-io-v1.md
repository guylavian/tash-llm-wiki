...
type: reference
domain: openshift
slug: microshift-rest-api-4-22-ingress-networking-k8s-io-v1
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/microshift_rest_api/ingress-networking-k8s-io-v1
version: 4.22

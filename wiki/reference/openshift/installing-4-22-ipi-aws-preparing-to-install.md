...
type: reference
domain: openshift
slug: installing-4-22-ipi-aws-preparing-to-install
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/ipi-aws-preparing-to-install
version: 4.22
family: installing
...
[role="_abstract"]
To install an OpenShift Container Platform cluster on {aws-first}, you must verify your internet connectivity, download the installation program, install the {oc-first}, and generate an SSH key pair.
...
The following list outlines in detail the steps to prepare to install an OpenShift Container Platform cluster on {aws-short}:

---
title: "Configuring the default broker class"
type: reference
domain: openshift
slug: serverless-4-22-serverless-global-config-broker-class-default
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/serverless-global-config-broker-class-default
version: 4.22
family: serverless

...
type: reference
domain: openshift
slug: updating-4-22-gathering-data-cluster-update
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/updating/gathering-data-cluster-update
version: 4.22
family: updating
...
You can view the ClusterVersion history by using the OpenShift Container Platform web console or by using the {oc-first}.

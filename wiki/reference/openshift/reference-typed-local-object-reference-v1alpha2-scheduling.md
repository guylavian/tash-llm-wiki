...
type: reference
domain: openshift
slug: reference-typed-local-object-reference-v1alpha2-scheduling
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/definitions/typed-local-object-reference-v1alpha2-scheduling
family: reference
documentKind: "doc"

---
title: "Network Observability Operator in {product-title}"
type: reference
domain: openshift
slug: observability-4-22-understanding-network-observability-operator
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/understanding-network-observability-operator
version: 4.22

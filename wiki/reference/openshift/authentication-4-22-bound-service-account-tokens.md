...
type: reference
domain: openshift
slug: authentication-4-22-bound-service-account-tokens
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/authentication/bound-service-account-tokens
version: 4.22
...
You can use bound service account tokens, which improves the ability to integrate with cloud provider identity access management (IAM) services, such as OpenShift Container Platform on AWS IAM or {gcp-full} IAM.

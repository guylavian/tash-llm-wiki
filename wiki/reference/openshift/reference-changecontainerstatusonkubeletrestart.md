...
type: reference
domain: openshift
slug: reference-changecontainerstatusonkubeletrestart
tier: reference
source: https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/ChangeContainerStatusOnKubeletRestart
family: reference
documentKind: "doc"
---

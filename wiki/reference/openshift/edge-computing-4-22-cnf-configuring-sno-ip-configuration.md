...
type: reference
domain: openshift
slug: edge-computing-4-22-cnf-configuring-sno-ip-configuration
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/edge_computing/cnf-configuring-sno-ip-configuration
version: 4.22

---
title: "Copying files to or from {product-title} containers"
type: reference
domain: openshift
slug: nodes-4-22-nodes-containers-copying-files
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-containers-copying-files
version: 4.22
family: nodes
...
= Copying files to or from OpenShift Container Platform containers

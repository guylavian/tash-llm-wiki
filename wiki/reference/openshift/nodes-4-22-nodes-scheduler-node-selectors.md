...
type: reference
domain: openshift
slug: nodes-4-22-nodes-scheduler-node-selectors
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/nodes/nodes-scheduler-node-selectors
version: 4.22
family: nodes

...
type: reference
domain: openshift
slug: web-console-4-22-installing-web-terminal
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/web_console/installing-web-terminal
version: 4.22
family: web_console
...
[role="_abstract"]
You can install the web terminal by using the {web-terminal-op} listed in the OpenShift Container Platform software catalog. When you install the {web-terminal-op}, the custom resource definitions (CRDs) that are required for the command line configuration, such as the `DevWorkspace` CRD, are automatically installed. The web console creates the required resources when you open the web terminal.

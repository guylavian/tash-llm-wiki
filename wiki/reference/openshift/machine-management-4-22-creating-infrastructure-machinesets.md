...
type: reference
domain: openshift
slug: machine-management-4-22-creating-infrastructure-machinesets
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/machine_management/creating-infrastructure-machinesets
version: 4.22
...
`<instance_profile>`:: Specifies the {ibm-cloud-name} instance profile.
`<region>`:: Specifies the region to place machines on.
...
== Additional resources
* OpenShift sizing and subscription guide for enterprise Kubernetes
* Create an infrastructure machine set
* Label an infrastructure node
* Use a machine config pool

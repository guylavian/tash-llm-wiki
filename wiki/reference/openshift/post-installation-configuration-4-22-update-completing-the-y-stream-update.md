...
type: reference
domain: openshift
slug: post-installation-configuration-4-22-update-completing-the-y-stream-update
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/post_installation_configuration/update-completing-the-y-stream-update
version: 4.22

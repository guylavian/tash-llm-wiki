---
title: "Finding logs for Knative Serving components"
type: reference
domain: openshift
slug: serverless-4-22-finding-serving-logs-components
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/serverless/finding-serving-logs-components
version: 4.22
family: serverless

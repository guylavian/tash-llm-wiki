---
title: "Installing a private cluster on {ibm-cloud-title}"
type: reference
domain: openshift
slug: installing-4-22-installing-ibm-cloud-private
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-ibm-cloud-private
version: 4.22
family: installing
...
In OpenShift Container Platform version , you can install a private cluster into an existing VPC. The installation program provisions the rest of the required infrastructure, which you can further customize. To customize the installation, you modify parameters in the `install-config.yaml` file before you install the cluster.

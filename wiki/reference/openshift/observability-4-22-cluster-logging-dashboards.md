---
title: "Viewing cluster dashboards"
type: reference
domain: openshift
slug: observability-4-22-cluster-logging-dashboards
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/cluster-logging-dashboards
version: 4.22
...
. In the OpenShift Container Platform {hybrid-console}, click *Observe* -> *Dashboards*.

...
type: reference
domain: openshift
slug: virt-4-22-virt-supported-limits
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/virt/virt-supported-limits
version: 4.22
family: virt
...
The following maximums apply to the OpenShift Container Platform hosts used for {VirtProductName}.

...
type: reference
domain: openshift
slug: applications-4-22-creating-applications-using-cli
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/applications/creating-applications-using-cli
version: 4.22
family: applications
...
You can create an OpenShift Container Platform application from components that include

---
title: "Embedding applications for offline use"
type: reference
domain: openshift
slug: microshift-running-apps-4-22-microshift-embed-apps-offline-use
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/microshift_running_apps/microshift-embed-apps-offline-use
version: 4.22
...
* Options for embedding OpenShift Container Platform applications in a {op-system-ostree} image
...
* Upgrading {op-system-ostree} systems

...
type: reference
domain: openshift
slug: reference-kubeletcgroupdriverfromcri
tier: reference
source: https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/KubeletCgroupDriverFromCRI
family: reference
documentKind: "doc"
---

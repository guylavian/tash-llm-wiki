...
type: reference
domain: openshift
slug: reference-mutating-webhook-configuration-v1
tier: reference
source: https://kubernetes.io/docs/reference/kubernetes-api/admissionregistration/mutating-webhook-configuration-v1
family: reference
documentKind: "doc"
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>webhooks</code><br/><em><a href="{{< ref "#MutatingWebhook" >}}">MutatingWebhook array</a></em><br/><em>patch strategy: merge on key <code>name</code></em></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>items</code>&nbsp;<strong>*</strong><br/><em><a href="{{< ref "mutating-webhook-configuration-v1#MutatingWebhookConfiguration" >}}">MutatingWebhookConfiguration array</a></em></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><em><a href="{{< ref "mutating-webhook-configuration-v1#MutatingWebhookConfiguration" >}}">MutatingWebhookConfiguration</a></em></td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>200</td>
      <td>OK</td>
      <td><em><a href="{{< ref "mutating-webhook-configuration-v1#MutatingWebhookConfigurationList" >}}">MutatingWebhookConfigurationList</a></em></td>
    </tr>
  </tbody>
</table>

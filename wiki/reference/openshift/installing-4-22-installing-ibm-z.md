---
title: "Installing a cluster with z/VM on {ibm-z-title} and {ibm-linuxone-title}"
type: reference
domain: openshift
slug: installing-4-22-installing-ibm-z
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/installing/installing-ibm-z
version: 4.22
family: installing

...
type: reference
domain: openshift
slug: hardware-accelerators-4-22-nvidia-gpu-architecture
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/hardware_accelerators/nvidia-gpu-architecture
version: 4.22
...
= GPUs and OpenShift Container Platform

You can deploy OpenShift Container Platform to one of the major cloud service providers (CSPs): {aws-first}, {gcp-full}, or Microsoft Azure.
...
You can deploy OpenShift Container Platform on NVIDIA GPU instance types.
...
Red{nbsp}Hat and NVIDIA have developed GPU concurrency and sharing mechanisms to simplify GPU-accelerated computing on an enterprise-level OpenShift Container Platform cluster.
...
// NVIDIA GPU Operator::
// The NVIDIA GPU Operator is a Kubernetes Operator that enables OpenShift Container Platform {VirtProductName} to expose GPUs to virtualized workloads running on OpenShift Container Platform.

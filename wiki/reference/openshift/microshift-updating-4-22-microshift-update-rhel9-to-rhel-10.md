---
title: "Upgrading the host operating system from {op-system-version} to {op-system-version-10}"
type: reference
domain: openshift
slug: microshift-updating-4-22-microshift-update-rhel9-to-rhel-10
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/microshift_updating/microshift-update-rhel9-to-rhel-10
version: 4.22

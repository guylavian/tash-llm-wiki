...
type: reference
domain: openshift
slug: backup-and-restore-4-22-scenario-3-expired-certs
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/backup_and_restore/scenario-3-expired-certs
version: 4.22

...
type: reference
domain: openshift
slug: tasks-optional-kubectl-configs-bash-mac
tier: reference
source: https://kubernetes.io/docs/tasks/tools/included/optional-kubectl-configs-bash-mac
family: tasks
documentKind: "doc"
abstract: "Some optional configuration for bash auto-completion on macOS."
---

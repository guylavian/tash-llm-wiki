...
type: reference
domain: openshift
slug: migrating-from-ocp-3-to-4-4-22-planning-considerations-3-4
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/migrating_from_ocp_3_to_4/planning-considerations-3-4
version: 4.22

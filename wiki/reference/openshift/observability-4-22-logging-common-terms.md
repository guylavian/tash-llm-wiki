...
type: reference
domain: openshift
slug: observability-4-22-logging-common-terms
tier: reference
source: https://docs.redhat.com/en/documentation/openshift_container_platform/4.22/html/observability/logging-common-terms
version: 4.22
...
{es-op}::
The {es-op} is used to run an Elasticsearch cluster on OpenShift Container Platform. The {es-op} provides self-service for the Elasticsearch cluster operations and is used by the {logging}.
...
The web console for OpenShift Container Platform can be found at https://console.redhat.com/openshift.

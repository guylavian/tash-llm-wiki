...
| Tune dampening for the environment; don't ship the defaults blindly | Default suppress 2000 / reuse 750 / 15-min half-life on a clean network | Stable routes suppressed after a single reset/maintenance | [[bgp]], [[bgp-route-dampening]] |
...
| Stable routes suppressed after one reset | BGP dampening defaults too aggressive | [[bgp]], [[bgp-route-dampening]] |

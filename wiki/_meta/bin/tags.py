...
Usage:
    python3 wiki/_meta/bin/tags.py validate
    python3 wiki/_meta/bin/tags.py normalize --apply
    python3 wiki/_meta/bin/tags.py backfill            # dry-run
    python3 wiki/_meta/bin/tags.py backfill --apply
"""
import argparse
import os
import re
...
TAXONOMY = os.path.join(META, "taxonomy.md")

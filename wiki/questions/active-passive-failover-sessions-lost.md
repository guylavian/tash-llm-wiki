...
sources:
  ...
  - kb:configuring-distributed-caches
...
- **kb:configuring-distributed-caches** (rhbk-26-4-caching) — Chapter 10. Configuring distributed caches, RHBK 26.4 Server Configuration Guide: volatile sessions vs persistent sessions, "Disabling persistent-user-sessions is not possible when multi-site feature is enabled" (lines 105-107), 4 caches that cannot have max-count set
